...
import com.nbp.pharmaceutical.application.form.service.service.PharmaManufacturerInfoLocalService;
...
/**
 * Provides the base implementation for the pharma manufacturer info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaManufacturerInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaManufacturerInfoLocalServiceImpl
 * @generated
 */
public abstract class PharmaManufacturerInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaManufacturerInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaManufacturerInfoLocalServiceUtil</code>.
	 */
	...
	public PharmaManufacturerInfo addPharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.update(pharmaManufacturerInfo);
	}
	...
	public PharmaManufacturerInfo createPharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.create(
	...
	public PharmaManufacturerInfo deletePharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.remove(
			pharmaManufacturerInfoId);
	}
	...
	public PharmaManufacturerInfo deletePharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.remove(pharmaManufacturerInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pharmaManufacturerInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PharmaManufacturerInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pharmaManufacturerInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pharmaManufacturerInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PharmaManufacturerInfo fetchPharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.fetchByPrimaryKey(
			pharmaManufacturerInfoId);
	}
	...
	public PharmaManufacturerInfo getPharmaManufacturerInfo(
		...
		return pharmaManufacturerInfoPersistence.findByPrimaryKey(
			pharmaManufacturerInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PharmaManufacturerInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PharmaManufacturerInfoLocalServiceImpl#deletePharmaManufacturerInfo(PharmaManufacturerInfo) to avoid orphaned data");
		}

		return pharmaManufacturerInfoLocalService.deletePharmaManufacturerInfo(
			(PharmaManufacturerInfo)persistedModel);
	}

	@Override
	public BasePersistence<PharmaManufacturerInfo> getBasePersistence() {
		return pharmaManufacturerInfoPersistence;
	}
	...
	public List<PharmaManufacturerInfo> getPharmaManufacturerInfos(
		...
		return pharmaManufacturerInfoPersistence.findAll(start, end);
	}
	...
	public int getPharmaManufacturerInfosCount() {
		return pharmaManufacturerInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		pharmaManufacturerInfoLocalService =
			(PharmaManufacturerInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaManufacturerInfoLocalService.class.getName();
	}
	...
	protected PharmaManufacturerInfoLocalService
		pharmaManufacturerInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaManufacturerInfoLocalServiceBaseImpl.class);
