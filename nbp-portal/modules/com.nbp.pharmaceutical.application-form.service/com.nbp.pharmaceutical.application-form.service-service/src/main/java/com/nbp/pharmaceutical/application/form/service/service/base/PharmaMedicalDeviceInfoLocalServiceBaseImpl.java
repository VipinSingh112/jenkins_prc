...
import com.nbp.pharmaceutical.application.form.service.service.PharmaMedicalDeviceInfoLocalService;
...
/**
 * Provides the base implementation for the pharma medical device info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaMedicalDeviceInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaMedicalDeviceInfoLocalServiceImpl
 * @generated
 */
public abstract class PharmaMedicalDeviceInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaMedicalDeviceInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaMedicalDeviceInfoLocalServiceUtil</code>.
	 */
	...
	public PharmaMedicalDeviceInfo addPharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.update(
	...
	public PharmaMedicalDeviceInfo createPharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.create(pharmaMedicalDeviceId);
	}
	...
	public PharmaMedicalDeviceInfo deletePharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.remove(pharmaMedicalDeviceId);
	}
	...
	public PharmaMedicalDeviceInfo deletePharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.remove(
			pharmaMedicalDeviceInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pharmaMedicalDeviceInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PharmaMedicalDeviceInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pharmaMedicalDeviceInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pharmaMedicalDeviceInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PharmaMedicalDeviceInfo fetchPharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.fetchByPrimaryKey(
	...
	public PharmaMedicalDeviceInfo getPharmaMedicalDeviceInfo(
		...
		return pharmaMedicalDeviceInfoPersistence.findByPrimaryKey(
			pharmaMedicalDeviceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PharmaMedicalDeviceInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return pharmaMedicalDeviceInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PharmaMedicalDeviceInfoLocalServiceImpl#deletePharmaMedicalDeviceInfo(PharmaMedicalDeviceInfo) to avoid orphaned data");
		}

		return pharmaMedicalDeviceInfoLocalService.
			deletePharmaMedicalDeviceInfo(
				(PharmaMedicalDeviceInfo)persistedModel);
	}

	@Override
	public BasePersistence<PharmaMedicalDeviceInfo> getBasePersistence() {
		return pharmaMedicalDeviceInfoPersistence;
	}
	...
	public List<PharmaMedicalDeviceInfo> getPharmaMedicalDeviceInfos(
		...
		return pharmaMedicalDeviceInfoPersistence.findAll(start, end);
	}
	...
	public int getPharmaMedicalDeviceInfosCount() {
		return pharmaMedicalDeviceInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		pharmaMedicalDeviceInfoLocalService =
			(PharmaMedicalDeviceInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaMedicalDeviceInfoLocalService.class.getName();
	}
	...
	protected PharmaMedicalDeviceInfoLocalService
		pharmaMedicalDeviceInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaMedicalDeviceInfoLocalServiceBaseImpl.class);
