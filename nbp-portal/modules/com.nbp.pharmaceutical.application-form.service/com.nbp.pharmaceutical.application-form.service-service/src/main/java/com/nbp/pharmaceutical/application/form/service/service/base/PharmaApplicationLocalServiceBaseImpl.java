...
import com.nbp.pharmaceutical.application.form.service.service.PharmaApplicationLocalService;
...
/**
 * Provides the base implementation for the pharma application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationLocalServiceImpl
 * @generated
 */
public abstract class PharmaApplicationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PharmaApplicationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaApplicationLocalServiceUtil</code>.
	 */
	...
	public PharmaApplication addPharmaApplication(
		...
		return pharmaApplicationPersistence.update(pharmaApplication);
	}
	...
	public PharmaApplication createPharmaApplication(long pharmaApplicationId) {
		return pharmaApplicationPersistence.create(pharmaApplicationId);
	}
	...
	public PharmaApplication deletePharmaApplication(long pharmaApplicationId)
		...
		return pharmaApplicationPersistence.remove(pharmaApplicationId);
	}
	...
	public PharmaApplication deletePharmaApplication(
		...
		return pharmaApplicationPersistence.remove(pharmaApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pharmaApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PharmaApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pharmaApplicationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return pharmaApplicationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pharmaApplicationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return pharmaApplicationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PharmaApplication fetchPharmaApplication(long pharmaApplicationId) {
		return pharmaApplicationPersistence.fetchByPrimaryKey(
			pharmaApplicationId);
	}
	...
	public PharmaApplication getPharmaApplication(long pharmaApplicationId)
		...
		return pharmaApplicationPersistence.findByPrimaryKey(
			pharmaApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PharmaApplication.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("pharmaApplicationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PharmaApplication.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return pharmaApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PharmaApplicationLocalServiceImpl#deletePharmaApplication(PharmaApplication) to avoid orphaned data");
		}

		return pharmaApplicationLocalService.deletePharmaApplication(
			(PharmaApplication)persistedModel);
	}

	@Override
	public BasePersistence<PharmaApplication> getBasePersistence() {
		return pharmaApplicationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return pharmaApplicationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PharmaApplication> getPharmaApplications(int start, int end) {
		return pharmaApplicationPersistence.findAll(start, end);
	}
	...
	public int getPharmaApplicationsCount() {
		return pharmaApplicationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaApplicationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		pharmaApplicationLocalService = (PharmaApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				pharmaApplicationPersistence.getDataSource();
	...
	protected PharmaApplicationLocalService pharmaApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaApplicationLocalServiceBaseImpl.class);
