...
import com.nbp.pharmaceutical.application.form.service.service.PharmaApplicationService;
...
/**
 * Provides the base implementation for the pharma application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationServiceImpl
 * @generated
 */
public abstract class PharmaApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PharmaApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		pharmaApplicationService = (PharmaApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaApplicationService.class.getName();
	}
	...
	protected PharmaApplicationService pharmaApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaApplicationServiceBaseImpl.class);
