...
import com.nbp.pharmaceutical.application.form.service.service.PharmaCancellationFormService;
...
/**
 * Provides the base implementation for the pharma cancellation form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaCancellationFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaCancellationFormServiceImpl
 * @generated
 */
public abstract class PharmaCancellationFormServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PharmaCancellationFormService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaCancellationFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaCancellationFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaCancellationFormService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		pharmaCancellationFormService = (PharmaCancellationFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaCancellationFormService.class.getName();
	}
	...
	protected PharmaCancellationFormService pharmaCancellationFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaCancellationFormServiceBaseImpl.class);
