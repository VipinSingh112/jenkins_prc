...
import com.nbp.pharmaceutical.application.form.service.service.PharmaCurrentStageService;
...
/**
 * Provides the base implementation for the pharma current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.application.form.service.service.impl.PharmaCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.application.form.service.service.impl.PharmaCurrentStageServiceImpl
 * @generated
 */
public abstract class PharmaCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PharmaCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.application.form.service.service.PharmaCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		pharmaCurrentStageService = (PharmaCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaCurrentStageService.class.getName();
	}
	...
	protected PharmaCurrentStageService pharmaCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaCurrentStageServiceBaseImpl.class);
