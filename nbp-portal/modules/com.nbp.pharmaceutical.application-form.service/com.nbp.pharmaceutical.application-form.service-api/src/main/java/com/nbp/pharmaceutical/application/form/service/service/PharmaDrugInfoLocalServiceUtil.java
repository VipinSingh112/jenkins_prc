...
/**
 * Provides the local service utility for PharmaDrugInfo. This utility wraps
 * <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaDrugInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PharmaDrugInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaDrugInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PharmaDrugInfo addPharmaDrugInfo(
		PharmaDrugInfo pharmaDrugInfo) {

		return getService().addPharmaDrugInfo(pharmaDrugInfo);
	}
	 ...
	 */
	public static PharmaDrugInfo createPharmaDrugInfo(long pharmaDrugInfoId) {
		return getService().createPharmaDrugInfo(pharmaDrugInfoId);
	}
	 ...
	 */
	public static PharmaDrugInfo deletePharmaDrugInfo(long pharmaDrugInfoId)
		throws PortalException {

		return getService().deletePharmaDrugInfo(pharmaDrugInfoId);
	}
	 ...
	 * @return the pharma drug info that was removed
	 */
	public static PharmaDrugInfo deletePharmaDrugInfo(
		PharmaDrugInfo pharmaDrugInfo) {

		return getService().deletePharmaDrugInfo(pharmaDrugInfo);
	}
	...
	public static PharmaDrugInfo fetchPharmaDrugInfo(long pharmaDrugInfoId) {
		return getService().fetchPharmaDrugInfo(pharmaDrugInfoId);
	}
	...
	public static PharmaDrugInfo findBygetPharmaByAppId(
		...
		return getService().findBygetPharmaByAppId(pharmaApplicationId);
	}
	...
	public static List<PharmaDrugInfo> getPA_DI_PAI(long applicationId) {
		return getService().getPA_DI_PAI(applicationId);
	}
	 ...
	 * @throws PortalException if a pharma drug info with the primary key could not be found
	 */
	public static PharmaDrugInfo getPharmaDrugInfo(long pharmaDrugInfoId)
		throws PortalException {

		return getService().getPharmaDrugInfo(pharmaDrugInfoId);
	}
	 ...
	 */
	public static List<PharmaDrugInfo> getPharmaDrugInfos(int start, int end) {
		return getService().getPharmaDrugInfos(start, end);
	}
	 ...
	 */
	public static int getPharmaDrugInfosCount() {
		return getService().getPharmaDrugInfosCount();
	}
	 ...
	 */
	public static PharmaDrugInfo updatePharmaDrugInfo(
		PharmaDrugInfo pharmaDrugInfo) {

		return getService().updatePharmaDrugInfo(pharmaDrugInfo);
	}

	public static PharmaDrugInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<PharmaDrugInfoLocalService> _serviceSnapshot =
		new Snapshot<>(
			PharmaDrugInfoLocalServiceUtil.class,
			PharmaDrugInfoLocalService.class);
