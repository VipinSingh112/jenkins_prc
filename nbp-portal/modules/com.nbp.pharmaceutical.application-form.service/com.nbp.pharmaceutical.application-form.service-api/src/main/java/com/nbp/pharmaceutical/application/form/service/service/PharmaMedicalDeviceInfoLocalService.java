...
/**
 * Provides the local service interface for PharmaMedicalDeviceInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaMedicalDeviceInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaMedicalDeviceInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaMedicalDeviceInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma medical device info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaMedicalDeviceInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PharmaMedicalDeviceInfo addPharmaMedicalDeviceInfo(
	...
	public PharmaMedicalDeviceInfo createPharmaMedicalDeviceInfo(
	...
	public PharmaMedicalDeviceInfo deletePharmaMedicalDeviceInfo(
			long pharmaMedicalDeviceId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaMedicalDeviceInfo fetchPharmaMedicalDeviceInfo(
		long pharmaMedicalDeviceId);

	public PharmaMedicalDeviceInfo findBygetPharmaByAppId(long applicationId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaMedicalDeviceInfo> getPA_ND_PAI(long applicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaMedicalDeviceInfo getPharmaMedicalDeviceInfo(
			long pharmaMedicalDeviceId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaMedicalDeviceInfo> getPharmaMedicalDeviceInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PharmaMedicalDeviceInfo updatePharmaMedicalDeviceInfo(
		PharmaMedicalDeviceInfo pharmaMedicalDeviceInfo);
