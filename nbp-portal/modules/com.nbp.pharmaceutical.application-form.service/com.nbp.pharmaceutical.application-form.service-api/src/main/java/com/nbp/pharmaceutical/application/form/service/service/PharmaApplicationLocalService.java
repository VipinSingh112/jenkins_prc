...
/**
 * Provides the local service interface for PharmaApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PharmaApplication addPharmaApplication(
	...
	public PharmaApplication createPharmaApplication(long pharmaApplicationId);
	...
	public PharmaApplication deletePharmaApplication(long pharmaApplicationId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PharmaApplication deletePharmaApplication(
		PharmaApplication pharmaApplication);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplication fetchPharmaApplication(long pharmaApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplication getPharmaApplication(long pharmaApplicationId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaApplication> getPharmaApplications(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplication getPharmaByAppNum(String applicationNumber)
		throws NoSuchPharmaApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplication getPharmaByAT_AppNo(
			String applicationType, String appNumber)
		throws NoSuchPharmaApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplication getPharmaByCaseId(String caseId)
		throws NoSuchPharmaApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaApplication> getPharmaByS_U(int status, long userId)
		throws NoSuchPharmaApplicationException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PharmaApplication updatePharmaApplication(
		PharmaApplication pharmaApplication);
