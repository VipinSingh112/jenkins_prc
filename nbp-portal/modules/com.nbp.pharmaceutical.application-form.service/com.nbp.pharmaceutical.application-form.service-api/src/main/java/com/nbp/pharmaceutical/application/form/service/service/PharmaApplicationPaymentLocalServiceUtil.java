...
/**
 * Provides the local service utility for PharmaApplicationPayment. This utility wraps
 * <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationPaymentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PharmaApplicationPaymentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaApplicationPaymentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PharmaApplicationPayment addPharmaApplicationPayment(
		PharmaApplicationPayment pharmaApplicationPayment) {

		return getService().addPharmaApplicationPayment(
	 ...
	 */
	public static PharmaApplicationPayment createPharmaApplicationPayment(
		long pharmaApplicationPaymentId) {

		return getService().createPharmaApplicationPayment(
	 ...
	 */
	public static PharmaApplicationPayment deletePharmaApplicationPayment(
			long pharmaApplicationPaymentId)
		throws PortalException {

		return getService().deletePharmaApplicationPayment(
			pharmaApplicationPaymentId);
	}
	...
	public static PharmaApplicationPayment fetchPharmaApplicationPayment(
		long pharmaApplicationPaymentId) {

		return getService().fetchPharmaApplicationPayment(
			pharmaApplicationPaymentId);
	}
	 ...
	 * @throws PortalException if a pharma application payment with the primary key could not be found
	 */
	public static PharmaApplicationPayment getPharmaApplicationPayment(
			long pharmaApplicationPaymentId)
		throws PortalException {

		return getService().getPharmaApplicationPayment(
			pharmaApplicationPaymentId);
	}

	public static PharmaApplicationPayment
		...
		return getService().getPharmaApplicationPaymentbyPharmaApplicationId(
			pharmaApplicationId);
	}
	 ...
	 */
	public static List<PharmaApplicationPayment> getPharmaApplicationPayments(
		int start, int end) {

		return getService().getPharmaApplicationPayments(start, end);
	}
	 ...
	 */
	public static int getPharmaApplicationPaymentsCount() {
		return getService().getPharmaApplicationPaymentsCount();
	}
	 ...
	 */
	public static PharmaApplicationPayment updatePharmaApplicationPayment(
		PharmaApplicationPayment pharmaApplicationPayment) {

		return getService().updatePharmaApplicationPayment(
			pharmaApplicationPayment);
	}

	public static PharmaApplicationPaymentLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<PharmaApplicationPaymentLocalService>
		_serviceSnapshot = new Snapshot<>(
			PharmaApplicationPaymentLocalServiceUtil.class,
