...
/**
 * Provides the local service interface for PharmaManufacturerInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaManufacturerInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaManufacturerInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaManufacturerInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma manufacturer info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaManufacturerInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PharmaManufacturerInfo addPharmaManufacturerInfo(
	...
	public PharmaManufacturerInfo createPharmaManufacturerInfo(
	...
	public PharmaManufacturerInfo deletePharmaManufacturerInfo(
			long pharmaManufacturerInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaManufacturerInfo fetchPharmaManufacturerInfo(
		long pharmaManufacturerInfoId);

	public PharmaManufacturerInfo findBygetPharmaByAppId(long applicationId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaManufacturerInfo> getPA_MI_PAI(long applicaitonnId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaManufacturerInfo getPharmaManufacturerInfo(
			long pharmaManufacturerInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaManufacturerInfo> getPharmaManufacturerInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PharmaManufacturerInfo updatePharmaManufacturerInfo(
		PharmaManufacturerInfo pharmaManufacturerInfo);
