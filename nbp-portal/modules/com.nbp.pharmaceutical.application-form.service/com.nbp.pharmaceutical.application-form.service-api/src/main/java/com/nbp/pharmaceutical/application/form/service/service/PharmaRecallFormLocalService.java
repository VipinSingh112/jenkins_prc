...
/**
 * Provides the local service interface for PharmaRecallForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaRecallFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaRecallFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaRecallFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma recall form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaRecallFormLocalServiceUtil} if injection and service tracking are not available.
	 */
