...
/**
 * Provides the local service utility for PharmaRecallForm. This utility wraps
 * <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaRecallFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PharmaRecallFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.pharmaceutical.application.form.service.service.impl.PharmaRecallFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PharmaRecallForm addPharmaRecallForm(
		PharmaRecallForm pharmaRecallForm) {

		return getService().addPharmaRecallForm(pharmaRecallForm);
	}
	 ...
	 */
	public static PharmaRecallForm createPharmaRecallForm(
		long pharmaRecallFormId) {

		return getService().createPharmaRecallForm(pharmaRecallFormId);
	}
	 ...
	 */
	public static PharmaRecallForm deletePharmaRecallForm(
			long pharmaRecallFormId)
		throws PortalException {

		return getService().deletePharmaRecallForm(pharmaRecallFormId);
	}
	...
	public static PharmaRecallForm deletePharmaRecallForm(
		...
		return getService().deletePharmaRecallForm(pharmaRecallForm);
	}
	...
	public static PharmaRecallForm fetchPharmaRecallForm(
		long pharmaRecallFormId) {

		return getService().fetchPharmaRecallForm(pharmaRecallFormId);
	}
	 ...
	 * @throws PortalException if a pharma recall form with the primary key could not be found
	 */
	public static PharmaRecallForm getPharmaRecallForm(long pharmaRecallFormId)
		throws PortalException {

		return getService().getPharmaRecallForm(pharmaRecallFormId);
	}
	 ...
	 */
	public static List<PharmaRecallForm> getPharmaRecallForms(
		int start, int end) {

		return getService().getPharmaRecallForms(start, end);
	}
	 ...
	 */
	public static int getPharmaRecallFormsCount() {
		return getService().getPharmaRecallFormsCount();
	}
	 ...
	 */
	public static PharmaRecallForm updatePharmaRecallForm(
		PharmaRecallForm pharmaRecallForm) {

		return getService().updatePharmaRecallForm(pharmaRecallForm);
	}

	public static PharmaRecallFormLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<PharmaRecallFormLocalService>
		_serviceSnapshot = new Snapshot<>(
			PharmaRecallFormLocalServiceUtil.class,
			PharmaRecallFormLocalService.class);
