...
/**
 * The base model interface for the FireBrigadeAppliCurrentStage service. Represents a row in the &quot;nbp_fire_app_stage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.fire.brigade.application.form.service.model.impl.FireBrigadeAppliCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.fire.brigade.application.form.service.model.impl.FireBrigadeAppliCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FireBrigadeAppliCurrentStageModel
	extends BaseModel<FireBrigadeAppliCurrentStage>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a fire brigade appli current stage model instance should use the {@link FireBrigadeAppliCurrentStage} interface instead.
	 */
