...
/**
 * The persistence utility for the fire brigade pro equipment info service. This utility wraps <code>com.nbp.fire.brigade.application.form.service.service.persistence.impl.FireBrigadeProEquipmentInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FireBrigadeProEquipmentInfoPersistence
 * @generated
 */
public class FireBrigadeProEquipmentInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(fireBrigadeProEquipmentInfo);
	}
	 ...
	 */
	public static Map<Serializable, FireBrigadeProEquipmentInfo>
	 ...
	 */
	public static List<FireBrigadeProEquipmentInfo> findWithDynamicQuery(
	 ...
	 */
	public static FireBrigadeProEquipmentInfo update(
		FireBrigadeProEquipmentInfo fireBrigadeProEquipmentInfo) {

		return getPersistence().update(fireBrigadeProEquipmentInfo);
	}
	...
	public static FireBrigadeProEquipmentInfo update(
		...
		return getPersistence().update(
			fireBrigadeProEquipmentInfo, serviceContext);
	}
	 ...
	 */
	public static FireBrigadeProEquipmentInfo findBygetFireBrigadeByAppId(
	 ...
	 */
	public static FireBrigadeProEquipmentInfo fetchBygetFireBrigadeByAppId(
		long fireBrigadeApplicationId) {
	 ...
	 */
	public static FireBrigadeProEquipmentInfo removeBygetFireBrigadeByAppId(
			long fireBrigadeApplicationId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeProEquipmentInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeProEquipmentInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeProEquipmentInfos);
	}
	 ...
	 */
	public static FireBrigadeProEquipmentInfo create(
		long fireBrigadeProEquipmentInfoId) {

		return getPersistence().create(fireBrigadeProEquipmentInfoId);
	}
	 ...
	 */
	public static FireBrigadeProEquipmentInfo remove(
			long fireBrigadeProEquipmentInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeProEquipmentInfoException {

		return getPersistence().remove(fireBrigadeProEquipmentInfoId);
	}

	public static FireBrigadeProEquipmentInfo updateImpl(
		FireBrigadeProEquipmentInfo fireBrigadeProEquipmentInfo) {

		return getPersistence().updateImpl(fireBrigadeProEquipmentInfo);
	}
	 ...
	 * @throws NoSuchFireBrigadeProEquipmentInfoException if a fire brigade pro equipment info with the primary key could not be found
	 */
	public static FireBrigadeProEquipmentInfo findByPrimaryKey(
			long fireBrigadeProEquipmentInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeProEquipmentInfoException {

		return getPersistence().findByPrimaryKey(fireBrigadeProEquipmentInfoId);
	}
	 ...
	 */
	public static FireBrigadeProEquipmentInfo fetchByPrimaryKey(
		long fireBrigadeProEquipmentInfoId) {
	 ...
	 */
	public static List<FireBrigadeProEquipmentInfo> findAll() {
	...
	public static FireBrigadeProEquipmentInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FireBrigadeProEquipmentInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FireBrigadeProEquipmentInfoPersistence _persistence;
