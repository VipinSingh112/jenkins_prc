...
/**
 * The persistence utility for the fire brigade premises info service. This utility wraps <code>com.nbp.fire.brigade.application.form.service.service.persistence.impl.FireBrigadePremisesInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FireBrigadePremisesInfoPersistence
 * @generated
 */
public class FireBrigadePremisesInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(fireBrigadePremisesInfo);
	}
	 ...
	 */
	public static Map<Serializable, FireBrigadePremisesInfo> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FireBrigadePremisesInfo> findWithDynamicQuery(
	 ...
	 */
	public static FireBrigadePremisesInfo update(
		FireBrigadePremisesInfo fireBrigadePremisesInfo) {

		return getPersistence().update(fireBrigadePremisesInfo);
	}
	...
	public static FireBrigadePremisesInfo update(
		...
		return getPersistence().update(fireBrigadePremisesInfo, serviceContext);
	}
	 ...
	 */
	public static FireBrigadePremisesInfo findBygetFireBrigadeByAppId(
	 ...
	 */
	public static FireBrigadePremisesInfo fetchBygetFireBrigadeByAppId(
		long fireBrigadeApplicationId) {
	 ...
	 */
	public static FireBrigadePremisesInfo removeBygetFireBrigadeByAppId(
			long fireBrigadeApplicationId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadePremisesInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadePremisesInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadePremisesInfos);
	}
	 ...
	 */
	public static FireBrigadePremisesInfo create(
		long fireBrigadePremisesInfoId) {

		return getPersistence().create(fireBrigadePremisesInfoId);
	}
	 ...
	 */
	public static FireBrigadePremisesInfo remove(long fireBrigadePremisesInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadePremisesInfoException {

		return getPersistence().remove(fireBrigadePremisesInfoId);
	}

	public static FireBrigadePremisesInfo updateImpl(
		FireBrigadePremisesInfo fireBrigadePremisesInfo) {

		return getPersistence().updateImpl(fireBrigadePremisesInfo);
	}
	 ...
	 * @throws NoSuchFireBrigadePremisesInfoException if a fire brigade premises info with the primary key could not be found
	 */
	public static FireBrigadePremisesInfo findByPrimaryKey(
			long fireBrigadePremisesInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadePremisesInfoException {

		return getPersistence().findByPrimaryKey(fireBrigadePremisesInfoId);
	}
	 ...
	 */
	public static FireBrigadePremisesInfo fetchByPrimaryKey(
		long fireBrigadePremisesInfoId) {

		return getPersistence().fetchByPrimaryKey(fireBrigadePremisesInfoId);
	}
	 ...
	 */
	public static List<FireBrigadePremisesInfo> findAll() {
	 ...
	 */
	public static List<FireBrigadePremisesInfo> findAll(int start, int end) {
	...
	public static FireBrigadePremisesInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FireBrigadePremisesInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FireBrigadePremisesInfoPersistence _persistence;
