...
/**
 * Provides the local service utility for FireBrigadeSignatureInfo. This utility wraps
 * <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeSignatureInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FireBrigadeSignatureInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeSignatureInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FireBrigadeSignatureInfo addFireBrigadeSignatureInfo(
		FireBrigadeSignatureInfo fireBrigadeSignatureInfo) {

		return getService().addFireBrigadeSignatureInfo(
	 ...
	 */
	public static FireBrigadeSignatureInfo createFireBrigadeSignatureInfo(
		long fireBrigadeSignatureInfoId) {

		return getService().createFireBrigadeSignatureInfo(
	 ...
	 */
	public static FireBrigadeSignatureInfo deleteFireBrigadeSignatureInfo(
		FireBrigadeSignatureInfo fireBrigadeSignatureInfo) {

		return getService().deleteFireBrigadeSignatureInfo(
			fireBrigadeSignatureInfo);
	}
	...
	public static FireBrigadeSignatureInfo fetchFireBrigadeSignatureInfo(
		long fireBrigadeSignatureInfoId) {

		return getService().fetchFireBrigadeSignatureInfo(
			fireBrigadeSignatureInfoId);
	}
	...
	public static FireBrigadeSignatureInfo getFireBrigadeByAppId(
	 ...
	 * @throws PortalException if a fire brigade signature info with the primary key could not be found
	 */
	public static FireBrigadeSignatureInfo getFireBrigadeSignatureInfo(
			long fireBrigadeSignatureInfoId)
		throws PortalException {

		return getService().getFireBrigadeSignatureInfo(
			fireBrigadeSignatureInfoId);
	}
	 ...
	 */
	public static List<FireBrigadeSignatureInfo> getFireBrigadeSignatureInfos(
		int start, int end) {

		return getService().getFireBrigadeSignatureInfos(start, end);
	}
	 ...
	 */
	public static int getFireBrigadeSignatureInfosCount() {
		return getService().getFireBrigadeSignatureInfosCount();
	}
	 ...
	 */
	public static FireBrigadeSignatureInfo updateFireBrigadeSignatureInfo(
		FireBrigadeSignatureInfo fireBrigadeSignatureInfo) {

		return getService().updateFireBrigadeSignatureInfo(
			fireBrigadeSignatureInfo);
	}

	public static FireBrigadeSignatureInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FireBrigadeSignatureInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			FireBrigadeSignatureInfoLocalServiceUtil.class,
