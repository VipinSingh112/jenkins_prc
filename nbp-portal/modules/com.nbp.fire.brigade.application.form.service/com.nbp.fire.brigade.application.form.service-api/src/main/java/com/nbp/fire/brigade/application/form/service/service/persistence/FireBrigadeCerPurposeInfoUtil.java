...
/**
 * The persistence utility for the fire brigade cer purpose info service. This utility wraps <code>com.nbp.fire.brigade.application.form.service.service.persistence.impl.FireBrigadeCerPurposeInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FireBrigadeCerPurposeInfoPersistence
 * @generated
 */
public class FireBrigadeCerPurposeInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(fireBrigadeCerPurposeInfo);
	}
	 ...
	 */
	public static Map<Serializable, FireBrigadeCerPurposeInfo>
	 ...
	 */
	public static List<FireBrigadeCerPurposeInfo> findWithDynamicQuery(
	 ...
	 */
	public static FireBrigadeCerPurposeInfo update(
		FireBrigadeCerPurposeInfo fireBrigadeCerPurposeInfo) {

		return getPersistence().update(fireBrigadeCerPurposeInfo);
	}
	...
	public static FireBrigadeCerPurposeInfo update(
		...
		return getPersistence().update(
			fireBrigadeCerPurposeInfo, serviceContext);
	}
	 ...
	 */
	public static FireBrigadeCerPurposeInfo findBygetFireBrigadeByAppId(
	 ...
	 */
	public static FireBrigadeCerPurposeInfo fetchBygetFireBrigadeByAppId(
		long fireBrigadeApplicationId) {
	 ...
	 */
	public static FireBrigadeCerPurposeInfo removeBygetFireBrigadeByAppId(
			long fireBrigadeApplicationId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeCerPurposeInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeCerPurposeInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeCerPurposeInfos);
	}
	 ...
	 */
	public static FireBrigadeCerPurposeInfo create(
		long fireBrigadeCerPurposeInfoId) {

		return getPersistence().create(fireBrigadeCerPurposeInfoId);
	}
	 ...
	 */
	public static FireBrigadeCerPurposeInfo remove(
			long fireBrigadeCerPurposeInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeCerPurposeInfoException {

		return getPersistence().remove(fireBrigadeCerPurposeInfoId);
	}

	public static FireBrigadeCerPurposeInfo updateImpl(
		FireBrigadeCerPurposeInfo fireBrigadeCerPurposeInfo) {

		return getPersistence().updateImpl(fireBrigadeCerPurposeInfo);
	}
	 ...
	 * @throws NoSuchFireBrigadeCerPurposeInfoException if a fire brigade cer purpose info with the primary key could not be found
	 */
	public static FireBrigadeCerPurposeInfo findByPrimaryKey(
			long fireBrigadeCerPurposeInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeCerPurposeInfoException {

		return getPersistence().findByPrimaryKey(fireBrigadeCerPurposeInfoId);
	}
	 ...
	 */
	public static FireBrigadeCerPurposeInfo fetchByPrimaryKey(
		long fireBrigadeCerPurposeInfoId) {

		return getPersistence().fetchByPrimaryKey(fireBrigadeCerPurposeInfoId);
	}
	 ...
	 */
	public static List<FireBrigadeCerPurposeInfo> findAll() {
	 ...
	 */
	public static List<FireBrigadeCerPurposeInfo> findAll(int start, int end) {
	...
	public static FireBrigadeCerPurposeInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FireBrigadeCerPurposeInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FireBrigadeCerPurposeInfoPersistence _persistence;
