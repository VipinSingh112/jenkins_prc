...
/**
 * The persistence utility for the fire brigade hazardous sub info service. This utility wraps <code>com.nbp.fire.brigade.application.form.service.service.persistence.impl.FireBrigadeHazardousSubInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FireBrigadeHazardousSubInfoPersistence
 * @generated
 */
public class FireBrigadeHazardousSubInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(fireBrigadeHazardousSubInfo);
	}
	 ...
	 */
	public static Map<Serializable, FireBrigadeHazardousSubInfo>
	 ...
	 */
	public static List<FireBrigadeHazardousSubInfo> findWithDynamicQuery(
	 ...
	 */
	public static FireBrigadeHazardousSubInfo update(
		FireBrigadeHazardousSubInfo fireBrigadeHazardousSubInfo) {

		return getPersistence().update(fireBrigadeHazardousSubInfo);
	}
	...
	public static FireBrigadeHazardousSubInfo update(
		...
		return getPersistence().update(
			fireBrigadeHazardousSubInfo, serviceContext);
	}
	 ...
	 */
	public static FireBrigadeHazardousSubInfo findBygetFireBrigadeByAppId(
	 ...
	 */
	public static FireBrigadeHazardousSubInfo fetchBygetFireBrigadeByAppId(
		long fireBrigadeApplicationId) {
	 ...
	 */
	public static FireBrigadeHazardousSubInfo removeBygetFireBrigadeByAppId(
			long fireBrigadeApplicationId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeHazardousSubInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeHazardousSubInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fireBrigadeHazardousSubInfos);
	}
	 ...
	 */
	public static FireBrigadeHazardousSubInfo create(
		long fireBrigadeHazardousSubInfoId) {

		return getPersistence().create(fireBrigadeHazardousSubInfoId);
	}
	 ...
	 */
	public static FireBrigadeHazardousSubInfo remove(
			long fireBrigadeHazardousSubInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeHazardousSubInfoException {

		return getPersistence().remove(fireBrigadeHazardousSubInfoId);
	}

	public static FireBrigadeHazardousSubInfo updateImpl(
		FireBrigadeHazardousSubInfo fireBrigadeHazardousSubInfo) {

		return getPersistence().updateImpl(fireBrigadeHazardousSubInfo);
	}
	 ...
	 * @throws NoSuchFireBrigadeHazardousSubInfoException if a fire brigade hazardous sub info with the primary key could not be found
	 */
	public static FireBrigadeHazardousSubInfo findByPrimaryKey(
			long fireBrigadeHazardousSubInfoId)
		throws com.nbp.fire.brigade.application.form.service.exception.
			NoSuchFireBrigadeHazardousSubInfoException {

		return getPersistence().findByPrimaryKey(fireBrigadeHazardousSubInfoId);
	}
	 ...
	 */
	public static FireBrigadeHazardousSubInfo fetchByPrimaryKey(
		long fireBrigadeHazardousSubInfoId) {
	 ...
	 */
	public static List<FireBrigadeHazardousSubInfo> findAll() {
	...
	public static FireBrigadeHazardousSubInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FireBrigadeHazardousSubInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FireBrigadeHazardousSubInfoPersistence _persistence;
