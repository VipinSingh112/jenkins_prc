...
/**
 * Provides the local service utility for FireBrigadeCerPurposeInfo. This utility wraps
 * <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeCerPurposeInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FireBrigadeCerPurposeInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeCerPurposeInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FireBrigadeCerPurposeInfo addFireBrigadeCerPurposeInfo(
		FireBrigadeCerPurposeInfo fireBrigadeCerPurposeInfo) {

		return getService().addFireBrigadeCerPurposeInfo(
	 ...
	 */
	public static FireBrigadeCerPurposeInfo createFireBrigadeCerPurposeInfo(
		long fireBrigadeCerPurposeInfoId) {

		return getService().createFireBrigadeCerPurposeInfo(
	 ...
	 */
	public static FireBrigadeCerPurposeInfo deleteFireBrigadeCerPurposeInfo(
		FireBrigadeCerPurposeInfo fireBrigadeCerPurposeInfo) {

		return getService().deleteFireBrigadeCerPurposeInfo(
			fireBrigadeCerPurposeInfo);
	}
	...
	public static FireBrigadeCerPurposeInfo fetchFireBrigadeCerPurposeInfo(
		long fireBrigadeCerPurposeInfoId) {

		return getService().fetchFireBrigadeCerPurposeInfo(
			fireBrigadeCerPurposeInfoId);
	}
	...
	public static FireBrigadeCerPurposeInfo getFireBrigadeByAppId(
	 ...
	 * @throws PortalException if a fire brigade cer purpose info with the primary key could not be found
	 */
	public static FireBrigadeCerPurposeInfo getFireBrigadeCerPurposeInfo(
			long fireBrigadeCerPurposeInfoId)
		throws PortalException {

		return getService().getFireBrigadeCerPurposeInfo(
			fireBrigadeCerPurposeInfoId);
	}
	 ...
	 */
	public static List<FireBrigadeCerPurposeInfo> getFireBrigadeCerPurposeInfos(
		int start, int end) {

		return getService().getFireBrigadeCerPurposeInfos(start, end);
	}
	 ...
	 */
	public static int getFireBrigadeCerPurposeInfosCount() {
		return getService().getFireBrigadeCerPurposeInfosCount();
	}
	 ...
	 */
	public static FireBrigadeCerPurposeInfo updateFireBrigadeCerPurposeInfo(
		FireBrigadeCerPurposeInfo fireBrigadeCerPurposeInfo) {

		return getService().updateFireBrigadeCerPurposeInfo(
			fireBrigadeCerPurposeInfo);
	}

	public static FireBrigadeCerPurposeInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FireBrigadeCerPurposeInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			FireBrigadeCerPurposeInfoLocalServiceUtil.class,
