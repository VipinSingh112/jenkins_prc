...
/**
 * Provides the local service utility for FireBrigadeMultFloorInfo. This utility wraps
 * <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeMultFloorInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FireBrigadeMultFloorInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeMultFloorInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FireBrigadeMultFloorInfo addFireBrigadeMultFloorInfo(
		FireBrigadeMultFloorInfo fireBrigadeMultFloorInfo) {

		return getService().addFireBrigadeMultFloorInfo(
	 ...
	 */
	public static FireBrigadeMultFloorInfo createFireBrigadeMultFloorInfo(
		long fireBrigadeMultFloorInfoId) {

		return getService().createFireBrigadeMultFloorInfo(
	 ...
	 */
	public static FireBrigadeMultFloorInfo deleteFireBrigadeMultFloorInfo(
		FireBrigadeMultFloorInfo fireBrigadeMultFloorInfo) {

		return getService().deleteFireBrigadeMultFloorInfo(
			fireBrigadeMultFloorInfo);
	}
	...
	public static FireBrigadeMultFloorInfo fetchFireBrigadeMultFloorInfo(
		long fireBrigadeMultFloorInfoId) {

		return getService().fetchFireBrigadeMultFloorInfo(
			fireBrigadeMultFloorInfoId);
	}
	...
	public static FireBrigadeMultFloorInfo getFireBrigadeByAppId(
	 ...
	 * @throws PortalException if a fire brigade mult floor info with the primary key could not be found
	 */
	public static FireBrigadeMultFloorInfo getFireBrigadeMultFloorInfo(
			long fireBrigadeMultFloorInfoId)
		throws PortalException {

		return getService().getFireBrigadeMultFloorInfo(
			fireBrigadeMultFloorInfoId);
	}
	 ...
	 */
	public static List<FireBrigadeMultFloorInfo> getFireBrigadeMultFloorInfos(
		int start, int end) {

		return getService().getFireBrigadeMultFloorInfos(start, end);
	}
	 ...
	 */
	public static int getFireBrigadeMultFloorInfosCount() {
		return getService().getFireBrigadeMultFloorInfosCount();
	}
	 ...
	 */
	public static FireBrigadeMultFloorInfo updateFireBrigadeMultFloorInfo(
		FireBrigadeMultFloorInfo fireBrigadeMultFloorInfo) {

		return getService().updateFireBrigadeMultFloorInfo(
			fireBrigadeMultFloorInfo);
	}

	public static FireBrigadeMultFloorInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FireBrigadeMultFloorInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			FireBrigadeMultFloorInfoLocalServiceUtil.class,
