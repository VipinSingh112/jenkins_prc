...
import com.nbp.fire.brigade.application.form.service.service.FireBrigadeAppPaymentService;
...
/**
 * Provides the base implementation for the fire brigade app payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeAppPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeAppPaymentServiceImpl
 * @generated
 */
public abstract class FireBrigadeAppPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FireBrigadeAppPaymentService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FireBrigadeAppPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.fire.brigade.application.form.service.service.FireBrigadeAppPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FireBrigadeAppPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fireBrigadeAppPaymentService = (FireBrigadeAppPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FireBrigadeAppPaymentService.class.getName();
	}
	...
	protected FireBrigadeAppPaymentService fireBrigadeAppPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FireBrigadeAppPaymentServiceBaseImpl.class);
