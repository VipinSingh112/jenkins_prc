...
import com.nbp.fire.brigade.application.form.service.service.FireBrigadeProEquipmentInfoLocalService;
...
/**
 * Provides the base implementation for the fire brigade pro equipment info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeProEquipmentInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeProEquipmentInfoLocalServiceImpl
 * @generated
 */
public abstract class FireBrigadeProEquipmentInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FireBrigadeProEquipmentInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FireBrigadeProEquipmentInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.fire.brigade.application.form.service.service.FireBrigadeProEquipmentInfoLocalServiceUtil</code>.
	 */
	...
	public FireBrigadeProEquipmentInfo addFireBrigadeProEquipmentInfo(
		...
		return fireBrigadeProEquipmentInfoPersistence.update(
	...
	public FireBrigadeProEquipmentInfo createFireBrigadeProEquipmentInfo(
		...
		return fireBrigadeProEquipmentInfoPersistence.create(
	...
	public FireBrigadeProEquipmentInfo deleteFireBrigadeProEquipmentInfo(
		...
		return fireBrigadeProEquipmentInfoPersistence.remove(
			fireBrigadeProEquipmentInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fireBrigadeProEquipmentInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FireBrigadeProEquipmentInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fireBrigadeProEquipmentInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fireBrigadeProEquipmentInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FireBrigadeProEquipmentInfo fetchFireBrigadeProEquipmentInfo(
		...
		return fireBrigadeProEquipmentInfoPersistence.fetchByPrimaryKey(
			fireBrigadeProEquipmentInfoId);
	}
	...
	public FireBrigadeProEquipmentInfo getFireBrigadeProEquipmentInfo(
		...
		return fireBrigadeProEquipmentInfoPersistence.findByPrimaryKey(
			fireBrigadeProEquipmentInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FireBrigadeProEquipmentInfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			FireBrigadeProEquipmentInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FireBrigadeProEquipmentInfoLocalServiceImpl#deleteFireBrigadeProEquipmentInfo(FireBrigadeProEquipmentInfo) to avoid orphaned data");
		}

		return fireBrigadeProEquipmentInfoLocalService.
			deleteFireBrigadeProEquipmentInfo(
				(FireBrigadeProEquipmentInfo)persistedModel);
	}

	@Override
	public BasePersistence<FireBrigadeProEquipmentInfo> getBasePersistence() {
		return fireBrigadeProEquipmentInfoPersistence;
	}
	...
	public List<FireBrigadeProEquipmentInfo> getFireBrigadeProEquipmentInfos(
		...
		return fireBrigadeProEquipmentInfoPersistence.findAll(start, end);
	}
	...
	public int getFireBrigadeProEquipmentInfosCount() {
		return fireBrigadeProEquipmentInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		fireBrigadeProEquipmentInfoLocalService =
			(FireBrigadeProEquipmentInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FireBrigadeProEquipmentInfoLocalService.class.getName();
	}
	...
	protected FireBrigadeProEquipmentInfoLocalService
		fireBrigadeProEquipmentInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FireBrigadeProEquipmentInfoLocalServiceBaseImpl.class);
