...
import com.nbp.fire.brigade.application.form.service.service.FireBrigadeSignatureInfoService;
...
/**
 * Provides the base implementation for the fire brigade signature info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeSignatureInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeSignatureInfoServiceImpl
 * @generated
 */
public abstract class FireBrigadeSignatureInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FireBrigadeSignatureInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FireBrigadeSignatureInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.fire.brigade.application.form.service.service.FireBrigadeSignatureInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FireBrigadeSignatureInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fireBrigadeSignatureInfoService =
			(FireBrigadeSignatureInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FireBrigadeSignatureInfoService.class.getName();
	}
	...
	protected FireBrigadeSignatureInfoService fireBrigadeSignatureInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FireBrigadeSignatureInfoServiceBaseImpl.class);
