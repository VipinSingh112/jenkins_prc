...
import com.nbp.fire.brigade.application.form.service.service.FireBrigadeApplicationService;
...
/**
 * Provides the base implementation for the fire brigade application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.fire.brigade.application.form.service.service.impl.FireBrigadeApplicationServiceImpl
 * @generated
 */
public abstract class FireBrigadeApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FireBrigadeApplicationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FireBrigadeApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.fire.brigade.application.form.service.service.FireBrigadeApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FireBrigadeApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fireBrigadeApplicationService = (FireBrigadeApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FireBrigadeApplicationService.class.getName();
	}
	...
	protected FireBrigadeApplicationService fireBrigadeApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FireBrigadeApplicationServiceBaseImpl.class);
