...
if(Validator.isNotNull(request.getAttribute("explosivesApplicationId"))){
	explosivesAppId= String.valueOf(request.getAttribute("explosivesApplicationId"));
}
...
<%counterOfDocuments++;	  
counterOfReqDoc = counterOfDocuments;
