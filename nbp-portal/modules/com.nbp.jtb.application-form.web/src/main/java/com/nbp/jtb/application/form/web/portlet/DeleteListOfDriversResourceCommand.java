...
property = {
	...
	"mvc.command.name=/list/of/driver/delete" }, 
service = MVCResourceCommand.class)

public class DeleteListOfDriversResourceCommand implements MVCResourceCommand{
	private static Log _log=LogFactoryUtil.getLog(DeleteListOfDriversResourceCommand.class.getName());
	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		JtbAddListDriverInfo driverList=null;
		  try {
			  driverList= JtbAddListDriverInfoLocalServiceUtil.deleteJtbAddListDriverInfo(contractDriverListDetailId);
		  } catch (Exception e) {}
