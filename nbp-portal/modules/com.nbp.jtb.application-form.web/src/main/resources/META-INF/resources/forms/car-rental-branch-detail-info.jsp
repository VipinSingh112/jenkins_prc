<%
String carRentalBranchDetailVal="";
carRentalBranchDetailVal = (String)request.getAttribute("carRentalBranchDetailVal");
%>
<tr class="branch-detail-row<%=carRentalBranchDetailVal%>">
	<td class="sub_heading_content carRentalOfficeLocation<%=carRentalBranchDetailVal%>"></td>
	<td class="sub_heading_content carRentalBranchTelephoneNo<%=carRentalBranchDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="carRentalBranchDetailId<%=carRentalBranchDetailVal%>" name="carRentalBranchDetailId<%=carRentalBranchDetailVal%>" value="">
</tr>