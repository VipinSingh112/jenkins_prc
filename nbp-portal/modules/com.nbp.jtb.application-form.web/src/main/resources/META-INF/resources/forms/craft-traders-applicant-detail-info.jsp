<%
String craftTradersApplicantDetailVal="";
craftTradersApplicantDetailVal = (String)request.getAttribute("craftTradersApplicantDetailVal");
%>
<tr class="craft-applicant-detail-row<%=craftTradersApplicantDetailVal%>">
	<td class="sub_heading_content  craftTradersApplicantLocation<%=craftTradersApplicantDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="craftTradersApplicantDetailId<%=craftTradersApplicantDetailVal%>" name="craftTradersApplicantDetailId<%=craftTradersApplicantDetailVal%>" value="">
</tr>