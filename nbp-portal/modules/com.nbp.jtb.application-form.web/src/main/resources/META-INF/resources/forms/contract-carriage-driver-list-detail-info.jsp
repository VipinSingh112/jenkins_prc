<%
String contractDriverListDetailVal="";
contractDriverListDetailVal = (String)request.getAttribute("contractDriverListDetailVal");
%>
<tr class="contract-driver-list-detail-row<%=contractDriverListDetailVal%>">
	<td class="sub_heading_content contractDriverListName<%=contractDriverListDetailVal%>"></td>
	<td class="sub_heading_content contractDriverListLicence<%=contractDriverListDetailVal%>"></td>
	<td class="sub_heading_content contractDriverListExpiryDate<%=contractDriverListDetailVal%>"></td>
	<td class="sub_heading_content driverSignature<%=contractDriverListDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="contractDriverListDetailId<%=contractDriverListDetailVal%>" name="contractDriverListDetailId<%=contractDriverListDetailVal%>" value="">
</tr>