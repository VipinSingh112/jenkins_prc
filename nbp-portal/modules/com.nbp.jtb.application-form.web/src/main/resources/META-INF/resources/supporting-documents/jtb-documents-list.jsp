...
if(Validator.isNotNull(request.getAttribute("jtbApplicationId"))){
sezAppId= String.valueOf(request.getAttribute("jtbApplicationId"));
}
if(Validator.isNotNull(request.getAttribute("waterBasedDocument"))){
	waterBased= String.valueOf(request.getAttribute("waterBasedDocument"));
}
		...
		<div class="row">
			...
			<div class="uploaded-info" id="unpload-info-card<%=fileEntryId%>">
				...
				<div class="right">
					...
					<a class="uploaded-actionlink" href="<%=fileUrl %>" id="doc-download-btn"> 
						<span class="mr-2">
							<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<input type="text" hidden id="fileUrl<%=counterOfDocuments%>" value="<%=fileEntryIdNR %>">
<% counterOfDocuments++;
}
}%>	
