<%
String operatorManagerVal="";
operatorManagerVal = (String)request.getAttribute("operatorManagerVal");
%>
<tr class="operator-manager-detail-row<%=operatorManagerVal%>">
	<td class="sub_heading_content newAttractionsOperatorName<%=operatorManagerVal%>"></td>
	<td class="sub_heading_content newAttractionsLocation<%=operatorManagerVal%>"></td>
	<td class="sub_heading_content newAttractionsEmailAddress<%=operatorManagerVal%>"></td>
	<td class="sub_heading_content newAttractionsTelephone<%=operatorManagerVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="operatorManagerDetailId<%=operatorManagerVal%>" name="operatorManagerDetailId<%=operatorManagerVal%>" value="">
</tr>