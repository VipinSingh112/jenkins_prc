<%
String craftTradersEmployeeDetailVal="";
craftTradersEmployeeDetailVal = (String)request.getAttribute("craftTradersEmployeeDetailVal");
%>
<tr class="carft-employee-detail-row<%=craftTradersEmployeeDetailVal%>">
	<td class="sub_heading_content  craftTradersEmployeeName<%=craftTradersEmployeeDetailVal%>"></td>
	<td class="sub_heading_content  craftTradersEmployeeAddress<%=craftTradersEmployeeDetailVal%>"></td>
	<td class="sub_heading_content  craftTradersEmployeePhoneNo<%=craftTradersEmployeeDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="craftTradersEmployeeDetailId<%=craftTradersEmployeeDetailVal%>" name="craftTradersEmployeeDetailId<%=craftTradersEmployeeDetailVal%>" value="">
</tr>