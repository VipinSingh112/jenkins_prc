<%
String domesticTourBranchDetailVal="";
domesticTourBranchDetailVal = (String)request.getAttribute("domesticTourBranchDetailVal");
%>
<tr class="domestic-branch-detail-row<%=domesticTourBranchDetailVal%>">
	<td class="sub_heading_content domesticTourOfficeLocation<%=domesticTourBranchDetailVal%>"></td>
	<td class="sub_heading_content domesticTourBranchTelephoneNo<%=domesticTourBranchDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="domesticTourBranchDetailId<%=domesticTourBranchDetailVal%>" name="domesticTourBranchDetailId<%=domesticTourBranchDetailVal%>" value="">
</tr>