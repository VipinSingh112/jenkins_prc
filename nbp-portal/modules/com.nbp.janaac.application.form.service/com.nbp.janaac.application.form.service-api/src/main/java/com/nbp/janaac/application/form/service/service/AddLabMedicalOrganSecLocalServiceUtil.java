...
/**
 * Provides the local service utility for AddLabMedicalOrganSec. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganSecLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddLabMedicalOrganSecLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganSecLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddLabMedicalOrganSec addAddLabMedicalOrganSec(
		AddLabMedicalOrganSec addLabMedicalOrganSec) {

		return getService().addAddLabMedicalOrganSec(addLabMedicalOrganSec);
	}
	 ...
	 */
	public static AddLabMedicalOrganSec createAddLabMedicalOrganSec(
		long addLabMedicalOrganSecId) {

		return getService().createAddLabMedicalOrganSec(
	 ...
	 */
	public static AddLabMedicalOrganSec deleteAddLabMedicalOrganSec(
		AddLabMedicalOrganSec addLabMedicalOrganSec) {

		return getService().deleteAddLabMedicalOrganSec(addLabMedicalOrganSec);
	}
	...
	public static AddLabMedicalOrganSec deleteAddLabMedicalOrganSec(
		...
		return getService().deleteAddLabMedicalOrganSec(
			addLabMedicalOrganSecId);
	}
	...
	public static AddLabMedicalOrganSec fetchAddLabMedicalOrganSec(
		long addLabMedicalOrganSecId) {

		return getService().fetchAddLabMedicalOrganSec(addLabMedicalOrganSecId);
	}
	 ...
	 * @throws PortalException if a add lab medical organ sec with the primary key could not be found
	 */
	public static AddLabMedicalOrganSec getAddLabMedicalOrganSec(
			long addLabMedicalOrganSecId)
		throws PortalException {

		return getService().getAddLabMedicalOrganSec(addLabMedicalOrganSecId);
	}
	 ...
	 */
	public static List<AddLabMedicalOrganSec> getAddLabMedicalOrganSecs(
		int start, int end) {

		return getService().getAddLabMedicalOrganSecs(start, end);
	}
	 ...
	 */
	public static int getAddLabMedicalOrganSecsCount() {
		return getService().getAddLabMedicalOrganSecsCount();
	}
	...
	public static List<AddLabMedicalOrganSec> getJanaacById(
	 ...
	 */
	public static AddLabMedicalOrganSec updateAddLabMedicalOrganSec(
		AddLabMedicalOrganSec addLabMedicalOrganSec) {

		return getService().updateAddLabMedicalOrganSec(addLabMedicalOrganSec);
	}

	public static AddLabMedicalOrganSecLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddLabMedicalOrganSecLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddLabMedicalOrganSecLocalServiceUtil.class,
			AddLabMedicalOrganSecLocalService.class);
