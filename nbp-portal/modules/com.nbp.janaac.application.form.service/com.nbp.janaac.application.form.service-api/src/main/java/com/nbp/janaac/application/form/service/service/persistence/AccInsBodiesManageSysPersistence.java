...
/**
 * The persistence interface for the acc ins bodies manage sys service.
 *
 * <p>
 ...
 * @see AccInsBodiesManageSysUtil
 * @generated
 */
@ProviderType
public interface AccInsBodiesManageSysPersistence
	extends BasePersistence<AccInsBodiesManageSys> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccInsBodiesManageSysUtil} to access the acc ins bodies manage sys persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<AccInsBodiesManageSys> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<AccInsBodiesManageSys> findByUuid(
	...
	public java.util.List<AccInsBodiesManageSys> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AccInsBodiesManageSys>
			orderByComparator);
	 ...
	 * @return the matching acc ins bodies manage syses
	 */
	public java.util.List<AccInsBodiesManageSys> findByUuid_C(
	...
	public void cacheResult(
		java.util.List<AccInsBodiesManageSys> accInsBodiesManageSyses);
	 ...
	 */
	public java.util.List<AccInsBodiesManageSys> findAll();
	 ...
	 */
	public java.util.List<AccInsBodiesManageSys> findAll(int start, int end);
