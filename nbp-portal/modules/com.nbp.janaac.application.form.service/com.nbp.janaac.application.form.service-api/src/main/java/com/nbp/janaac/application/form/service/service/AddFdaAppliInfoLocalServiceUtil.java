...
/**
 * Provides the local service utility for AddFdaAppliInfo. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddFdaAppliInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddFdaAppliInfo addAddFdaAppliInfo(
		AddFdaAppliInfo addFdaAppliInfo) {

		return getService().addAddFdaAppliInfo(addFdaAppliInfo);
	}
	 ...
	 */
	public static AddFdaAppliInfo createAddFdaAppliInfo(
		long addFdaAppliInfoId) {

		return getService().createAddFdaAppliInfo(addFdaAppliInfoId);
	}
	 ...
	 */
	public static AddFdaAppliInfo deleteAddFdaAppliInfo(
		AddFdaAppliInfo addFdaAppliInfo) {

		return getService().deleteAddFdaAppliInfo(addFdaAppliInfo);
	}
	 ...
	 */
	public static AddFdaAppliInfo deleteAddFdaAppliInfo(long addFdaAppliInfoId)
		throws PortalException {

		return getService().deleteAddFdaAppliInfo(addFdaAppliInfoId);
	}
	...
	public static AddFdaAppliInfo fetchAddFdaAppliInfo(long addFdaAppliInfoId) {
		return getService().fetchAddFdaAppliInfo(addFdaAppliInfoId);
	}
	 ...
	 * @throws PortalException if a add fda appli info with the primary key could not be found
	 */
	public static AddFdaAppliInfo getAddFdaAppliInfo(long addFdaAppliInfoId)
		throws PortalException {

		return getService().getAddFdaAppliInfo(addFdaAppliInfoId);
	}
	 ...
	 */
	public static List<AddFdaAppliInfo> getAddFdaAppliInfos(
		int start, int end) {

		return getService().getAddFdaAppliInfos(start, end);
	}
	 ...
	 */
	public static int getAddFdaAppliInfosCount() {
		return getService().getAddFdaAppliInfosCount();
	}
	...
	public static List<AddFdaAppliInfo> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddFdaAppliInfo updateAddFdaAppliInfo(
		AddFdaAppliInfo addFdaAppliInfo) {

		return getService().updateAddFdaAppliInfo(addFdaAppliInfo);
	}

	public static AddFdaAppliInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddFdaAppliInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddFdaAppliInfoLocalServiceUtil.class,
			AddFdaAppliInfoLocalService.class);
