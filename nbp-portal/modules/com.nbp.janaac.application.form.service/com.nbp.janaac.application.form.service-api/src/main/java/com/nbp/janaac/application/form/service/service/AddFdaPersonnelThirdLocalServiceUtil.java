...
/**
 * Provides the local service utility for AddFdaPersonnelThird. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelThirdLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddFdaPersonnelThirdLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelThirdLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddFdaPersonnelThird addAddFdaPersonnelThird(
		AddFdaPersonnelThird addFdaPersonnelThird) {

		return getService().addAddFdaPersonnelThird(addFdaPersonnelThird);
	}
	 ...
	 */
	public static AddFdaPersonnelThird createAddFdaPersonnelThird(
		long addFdaPersonnelThirdId) {

		return getService().createAddFdaPersonnelThird(addFdaPersonnelThirdId);
	}
	 ...
	 */
	public static AddFdaPersonnelThird deleteAddFdaPersonnelThird(
		AddFdaPersonnelThird addFdaPersonnelThird) {

		return getService().deleteAddFdaPersonnelThird(addFdaPersonnelThird);
	}
	...
	public static AddFdaPersonnelThird deleteAddFdaPersonnelThird(
		...
		return getService().deleteAddFdaPersonnelThird(addFdaPersonnelThirdId);
	}
	...
	public static AddFdaPersonnelThird fetchAddFdaPersonnelThird(
		long addFdaPersonnelThirdId) {

		return getService().fetchAddFdaPersonnelThird(addFdaPersonnelThirdId);
	}
	 ...
	 * @throws PortalException if a add fda personnel third with the primary key could not be found
	 */
	public static AddFdaPersonnelThird getAddFdaPersonnelThird(
			long addFdaPersonnelThirdId)
		throws PortalException {

		return getService().getAddFdaPersonnelThird(addFdaPersonnelThirdId);
	}
	 ...
	 */
	public static List<AddFdaPersonnelThird> getAddFdaPersonnelThirds(
		int start, int end) {

		return getService().getAddFdaPersonnelThirds(start, end);
	}
	 ...
	 */
	public static int getAddFdaPersonnelThirdsCount() {
		return getService().getAddFdaPersonnelThirdsCount();
	}
	...
	public static List<AddFdaPersonnelThird> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddFdaPersonnelThird updateAddFdaPersonnelThird(
		AddFdaPersonnelThird addFdaPersonnelThird) {

		return getService().updateAddFdaPersonnelThird(addFdaPersonnelThird);
	}

	public static AddFdaPersonnelThirdLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddFdaPersonnelThirdLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddFdaPersonnelThirdLocalServiceUtil.class,
