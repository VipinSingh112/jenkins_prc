...
/**
 * Provides the local service utility for AddInsApplicationInfo. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddInsApplicationInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddInsApplicationInfo addAddInsApplicationInfo(
		AddInsApplicationInfo addInsApplicationInfo) {

		return getService().addAddInsApplicationInfo(addInsApplicationInfo);
	}
	 ...
	 */
	public static AddInsApplicationInfo createAddInsApplicationInfo(
		long addInsApplicationInfoId) {

		return getService().createAddInsApplicationInfo(
	 ...
	 */
	public static AddInsApplicationInfo deleteAddInsApplicationInfo(
		AddInsApplicationInfo addInsApplicationInfo) {

		return getService().deleteAddInsApplicationInfo(addInsApplicationInfo);
	}
	...
	public static AddInsApplicationInfo deleteAddInsApplicationInfo(
		...
		return getService().deleteAddInsApplicationInfo(
			addInsApplicationInfoId);
	}
	...
	public static AddInsApplicationInfo fetchAddInsApplicationInfo(
		long addInsApplicationInfoId) {

		return getService().fetchAddInsApplicationInfo(addInsApplicationInfoId);
	}
	 ...
	 * @throws PortalException if a add ins application info with the primary key could not be found
	 */
	public static AddInsApplicationInfo getAddInsApplicationInfo(
			long addInsApplicationInfoId)
		throws PortalException {

		return getService().getAddInsApplicationInfo(addInsApplicationInfoId);
	}
	 ...
	 */
	public static List<AddInsApplicationInfo> getAddInsApplicationInfos(
		int start, int end) {

		return getService().getAddInsApplicationInfos(start, end);
	}
	 ...
	 */
	public static int getAddInsApplicationInfosCount() {
		return getService().getAddInsApplicationInfosCount();
	}
	...
	public static List<AddInsApplicationInfo> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddInsApplicationInfo updateAddInsApplicationInfo(
		AddInsApplicationInfo addInsApplicationInfo) {

		return getService().updateAddInsApplicationInfo(addInsApplicationInfo);
	}

	public static AddInsApplicationInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddInsApplicationInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddInsApplicationInfoLocalServiceUtil.class,
