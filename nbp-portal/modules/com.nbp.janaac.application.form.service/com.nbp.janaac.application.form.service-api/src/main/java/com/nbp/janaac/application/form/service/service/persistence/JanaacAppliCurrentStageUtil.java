...
/**
 * The persistence utility for the janaac appli current stage service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.JanaacAppliCurrentStagePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see JanaacAppliCurrentStagePersistence
 * @generated
 */
public class JanaacAppliCurrentStageUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(janaacAppliCurrentStage);
	}
	 ...
	 */
	public static Map<Serializable, JanaacAppliCurrentStage> fetchByPrimaryKeys(
	 ...
	 */
	public static List<JanaacAppliCurrentStage> findWithDynamicQuery(
	 ...
	 */
	public static JanaacAppliCurrentStage update(
		JanaacAppliCurrentStage janaacAppliCurrentStage) {

		return getPersistence().update(janaacAppliCurrentStage);
	}
	...
	public static JanaacAppliCurrentStage update(
		...
		return getPersistence().update(janaacAppliCurrentStage, serviceContext);
	}
	 ...
	 */
	public static JanaacAppliCurrentStage findBygetJanaac_Stage_JAI(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchJanaacAppliCurrentStageException {

		return getPersistence().findBygetJanaac_Stage_JAI(janaacApplicationId);
	}
	 ...
	 */
	public static JanaacAppliCurrentStage fetchBygetJanaac_Stage_JAI(
		long janaacApplicationId) {

		return getPersistence().fetchBygetJanaac_Stage_JAI(janaacApplicationId);
	}
	...
	public static JanaacAppliCurrentStage fetchBygetJanaac_Stage_JAI(
		...
		return getPersistence().fetchBygetJanaac_Stage_JAI(
	 ...
	 */
	public static JanaacAppliCurrentStage removeBygetJanaac_Stage_JAI(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchJanaacAppliCurrentStageException {

		return getPersistence().removeBygetJanaac_Stage_JAI(
			janaacApplicationId);
	}
	 ...
	 */
	public static int countBygetJanaac_Stage_JAI(long janaacApplicationId) {
		return getPersistence().countBygetJanaac_Stage_JAI(janaacApplicationId);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(janaacAppliCurrentStage);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(janaacAppliCurrentStages);
	}
	 ...
	 */
	public static JanaacAppliCurrentStage create(
		long janaacAppliCurrentStageId) {

		return getPersistence().create(janaacAppliCurrentStageId);
	}
	 ...
	 */
	public static JanaacAppliCurrentStage remove(long janaacAppliCurrentStageId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchJanaacAppliCurrentStageException {

		return getPersistence().remove(janaacAppliCurrentStageId);
	}

	public static JanaacAppliCurrentStage updateImpl(
		JanaacAppliCurrentStage janaacAppliCurrentStage) {

		return getPersistence().updateImpl(janaacAppliCurrentStage);
	}
	 ...
	 * @throws NoSuchJanaacAppliCurrentStageException if a janaac appli current stage with the primary key could not be found
	 */
	public static JanaacAppliCurrentStage findByPrimaryKey(
			long janaacAppliCurrentStageId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchJanaacAppliCurrentStageException {

		return getPersistence().findByPrimaryKey(janaacAppliCurrentStageId);
	}
	 ...
	 */
	public static JanaacAppliCurrentStage fetchByPrimaryKey(
		long janaacAppliCurrentStageId) {

		return getPersistence().fetchByPrimaryKey(janaacAppliCurrentStageId);
	}
	 ...
	 */
	public static List<JanaacAppliCurrentStage> findAll() {
	 ...
	 */
	public static List<JanaacAppliCurrentStage> findAll(int start, int end) {
	...
	public static JanaacAppliCurrentStagePersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		JanaacAppliCurrentStagePersistence persistence) {

		_persistence = persistence;
	}

	private static volatile JanaacAppliCurrentStagePersistence _persistence;
