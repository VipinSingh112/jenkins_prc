...
/**
 * The persistence interface for the add cer application info service.
 *
 * <p>
 ...
 * @see AddCerApplicationInfoUtil
 * @generated
 */
@ProviderType
public interface AddCerApplicationInfoPersistence
	extends BasePersistence<AddCerApplicationInfo> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddCerApplicationInfoUtil} to access the add cer application info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<AddCerApplicationInfo> findBygetJanaacById(
	...
	public java.util.List<AddCerApplicationInfo> findBygetJanaacById(
		long janaacApplicationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AddCerApplicationInfo>
			orderByComparator);
	...
	public AddCerApplicationInfo findBygetJanaacById_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<AddCerApplicationInfo> orderByComparator)
	...
	public void cacheResult(
		java.util.List<AddCerApplicationInfo> addCerApplicationInfos);
	 ...
	 */
	public java.util.List<AddCerApplicationInfo> findAll();
	 ...
	 */
	public java.util.List<AddCerApplicationInfo> findAll(int start, int end);
