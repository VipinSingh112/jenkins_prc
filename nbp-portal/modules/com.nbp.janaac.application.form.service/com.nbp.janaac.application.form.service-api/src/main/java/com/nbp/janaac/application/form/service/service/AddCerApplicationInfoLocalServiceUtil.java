...
/**
 * Provides the local service utility for AddCerApplicationInfo. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddCerApplicationInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddCerApplicationInfo addAddCerApplicationInfo(
		AddCerApplicationInfo addCerApplicationInfo) {

		return getService().addAddCerApplicationInfo(addCerApplicationInfo);
	}
	 ...
	 */
	public static AddCerApplicationInfo createAddCerApplicationInfo(
		long addCerApplicationInfoId) {

		return getService().createAddCerApplicationInfo(
	 ...
	 */
	public static AddCerApplicationInfo deleteAddCerApplicationInfo(
		AddCerApplicationInfo addCerApplicationInfo) {

		return getService().deleteAddCerApplicationInfo(addCerApplicationInfo);
	}
	...
	public static AddCerApplicationInfo deleteAddCerApplicationInfo(
		...
		return getService().deleteAddCerApplicationInfo(
			addCerApplicationInfoId);
	}
	...
	public static AddCerApplicationInfo fetchAddCerApplicationInfo(
		long addCerApplicationInfoId) {

		return getService().fetchAddCerApplicationInfo(addCerApplicationInfoId);
	}
	 ...
	 * @throws PortalException if a add cer application info with the primary key could not be found
	 */
	public static AddCerApplicationInfo getAddCerApplicationInfo(
			long addCerApplicationInfoId)
		throws PortalException {

		return getService().getAddCerApplicationInfo(addCerApplicationInfoId);
	}
	 ...
	 */
	public static List<AddCerApplicationInfo> getAddCerApplicationInfos(
		int start, int end) {

		return getService().getAddCerApplicationInfos(start, end);
	}
	 ...
	 */
	public static int getAddCerApplicationInfosCount() {
		return getService().getAddCerApplicationInfosCount();
	}
	...
	public static List<AddCerApplicationInfo> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddCerApplicationInfo updateAddCerApplicationInfo(
		AddCerApplicationInfo addCerApplicationInfo) {

		return getService().updateAddCerApplicationInfo(addCerApplicationInfo);
	}

	public static AddCerApplicationInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddCerApplicationInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddCerApplicationInfoLocalServiceUtil.class,
