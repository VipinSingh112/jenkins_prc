...
/**
 * The persistence utility for the acc medi lab activities desc service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AccMediLabActivitiesDescPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AccMediLabActivitiesDescPersistence
 * @generated
 */
public class AccMediLabActivitiesDescUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(accMediLabActivitiesDesc);
	}
	 ...
	 */
	public static Map<Serializable, AccMediLabActivitiesDesc>
	 ...
	 */
	public static List<AccMediLabActivitiesDesc> findWithDynamicQuery(
	 ...
	 */
	public static AccMediLabActivitiesDesc update(
		AccMediLabActivitiesDesc accMediLabActivitiesDesc) {

		return getPersistence().update(accMediLabActivitiesDesc);
	}
	...
	public static AccMediLabActivitiesDesc update(
		...
		return getPersistence().update(
			accMediLabActivitiesDesc, serviceContext);
	}
	 ...
	 */
	public static List<AccMediLabActivitiesDesc> findByUuid(String uuid) {
	 ...
	 */
	public static List<AccMediLabActivitiesDesc> findByUuid(
	 ...
	 */
	public static AccMediLabActivitiesDesc findByUuid_First(
			String uuid,
			OrderByComparator<AccMediLabActivitiesDesc> orderByComparator)
	 ...
	 */
	public static AccMediLabActivitiesDesc fetchByUuid_First(
		String uuid,
		OrderByComparator<AccMediLabActivitiesDesc> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc findByUuid_Last(
			String uuid,
			OrderByComparator<AccMediLabActivitiesDesc> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {
	 ...
	 */
	public static AccMediLabActivitiesDesc fetchByUuid_Last(
		String uuid,
		OrderByComparator<AccMediLabActivitiesDesc> orderByComparator) {
	 ...
	 */
	public static AccMediLabActivitiesDesc[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			accMediLabActivitiesDescId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc findByUUID_G(
	 ...
	 */
	public static AccMediLabActivitiesDesc fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static AccMediLabActivitiesDesc removeByUUID_G(
			String uuid, long groupId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {
	 ...
	 * @return the matching acc medi lab activities descs
	 */
	public static List<AccMediLabActivitiesDesc> findByUuid_C(
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AccMediLabActivitiesDesc> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {
	 ...
	 * @return the first matching acc medi lab activities desc, or <code>null</code> if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AccMediLabActivitiesDesc> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AccMediLabActivitiesDesc> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {
	 ...
	 * @return the last matching acc medi lab activities desc, or <code>null</code> if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AccMediLabActivitiesDesc> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a acc medi lab activities desc with the primary key could not be found
	 */
	public static AccMediLabActivitiesDesc[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			accMediLabActivitiesDescId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc findBygetJANAAC_ByApplicationId(
	 ...
	 * @return the matching acc medi lab activities desc, or <code>null</code> if a matching acc medi lab activities desc could not be found
	 */
	public static AccMediLabActivitiesDesc fetchBygetJANAAC_ByApplicationId(
		long janaacApplicationId) {
	 ...
	 * @return the acc medi lab activities desc that was removed
	 */
	public static AccMediLabActivitiesDesc removeBygetJANAAC_ByApplicationId(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabActivitiesDesc);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabActivitiesDescs);
	}
	 ...
	 */
	public static AccMediLabActivitiesDesc create(
		long accMediLabActivitiesDescId) {

		return getPersistence().create(accMediLabActivitiesDescId);
	}
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a acc medi lab activities desc with the primary key could not be found
	 */
	public static AccMediLabActivitiesDesc remove(
			long accMediLabActivitiesDescId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {

		return getPersistence().remove(accMediLabActivitiesDescId);
	}

	public static AccMediLabActivitiesDesc updateImpl(
		AccMediLabActivitiesDesc accMediLabActivitiesDesc) {

		return getPersistence().updateImpl(accMediLabActivitiesDesc);
	}
	 ...
	 * @throws NoSuchAccMediLabActivitiesDescException if a acc medi lab activities desc with the primary key could not be found
	 */
	public static AccMediLabActivitiesDesc findByPrimaryKey(
			long accMediLabActivitiesDescId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabActivitiesDescException {

		return getPersistence().findByPrimaryKey(accMediLabActivitiesDescId);
	}
	 ...
	 */
	public static AccMediLabActivitiesDesc fetchByPrimaryKey(
		long accMediLabActivitiesDescId) {

		return getPersistence().fetchByPrimaryKey(accMediLabActivitiesDescId);
	}
	 ...
	 */
	public static List<AccMediLabActivitiesDesc> findAll() {
	 ...
	 */
	public static List<AccMediLabActivitiesDesc> findAll(int start, int end) {
	...
	public static AccMediLabActivitiesDescPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AccMediLabActivitiesDescPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AccMediLabActivitiesDescPersistence _persistence;
