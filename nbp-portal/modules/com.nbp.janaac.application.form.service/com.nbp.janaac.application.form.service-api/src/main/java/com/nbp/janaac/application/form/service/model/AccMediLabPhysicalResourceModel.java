...
/**
 * The base model interface for the AccMediLabPhysicalResource service. Represents a row in the &quot;nbp_janaac_acc_medi_physical&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.janaac.application.form.service.model.impl.AccMediLabPhysicalResourceModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.janaac.application.form.service.model.impl.AccMediLabPhysicalResourceImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface AccMediLabPhysicalResourceModel
	extends BaseModel<AccMediLabPhysicalResource>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a acc medi lab physical resource model instance should use the {@link AccMediLabPhysicalResource} interface instead.
	 */
