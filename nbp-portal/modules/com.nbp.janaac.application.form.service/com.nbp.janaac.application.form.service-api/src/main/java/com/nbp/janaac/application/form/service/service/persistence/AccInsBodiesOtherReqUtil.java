...
/**
 * The persistence utility for the acc ins bodies other req service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AccInsBodiesOtherReqPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AccInsBodiesOtherReqPersistence
 * @generated
 */
public class AccInsBodiesOtherReqUtil {
	 ...
	 */
	public static void clearCache(AccInsBodiesOtherReq accInsBodiesOtherReq) {
		getPersistence().clearCache(accInsBodiesOtherReq);
	}
	 ...
	 */
	public static Map<Serializable, AccInsBodiesOtherReq> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AccInsBodiesOtherReq> findWithDynamicQuery(
	 ...
	 */
	public static AccInsBodiesOtherReq update(
		AccInsBodiesOtherReq accInsBodiesOtherReq) {

		return getPersistence().update(accInsBodiesOtherReq);
	}
	...
	public static AccInsBodiesOtherReq update(
		...
		return getPersistence().update(accInsBodiesOtherReq, serviceContext);
	}
	 ...
	 */
	public static List<AccInsBodiesOtherReq> findByUuid(String uuid) {
	 ...
	 */
	public static List<AccInsBodiesOtherReq> findByUuid(
	 ...
	 */
	public static AccInsBodiesOtherReq findByUuid_First(
			String uuid,
			OrderByComparator<AccInsBodiesOtherReq> orderByComparator)
	 ...
	 */
	public static AccInsBodiesOtherReq fetchByUuid_First(
		String uuid,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq findByUuid_Last(
			String uuid,
			OrderByComparator<AccInsBodiesOtherReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 */
	public static AccInsBodiesOtherReq fetchByUuid_Last(
		String uuid,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator) {
	 ...
	 */
	public static AccInsBodiesOtherReq[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			accInsBodiesOtherReqId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq findByUUID_G(String uuid, long groupId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 */
	public static AccInsBodiesOtherReq fetchByUUID_G(
	 ...
	 */
	public static AccInsBodiesOtherReq removeByUUID_G(String uuid, long groupId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 * @return the matching acc ins bodies other reqs
	 */
	public static List<AccInsBodiesOtherReq> findByUuid_C(
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AccInsBodiesOtherReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 * @return the first matching acc ins bodies other req, or <code>null</code> if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AccInsBodiesOtherReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 * @return the last matching acc ins bodies other req, or <code>null</code> if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a acc ins bodies other req with the primary key could not be found
	 */
	public static AccInsBodiesOtherReq[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			accInsBodiesOtherReqId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq findBygetJANAAC_ByApplicationId(
	 ...
	 * @return the matching acc ins bodies other req, or <code>null</code> if a matching acc ins bodies other req could not be found
	 */
	public static AccInsBodiesOtherReq fetchBygetJANAAC_ByApplicationId(
		long janaacApplicationId) {
	 ...
	 * @return the acc ins bodies other req that was removed
	 */
	public static AccInsBodiesOtherReq removeBygetJANAAC_ByApplicationId(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {
	 ...
	 */
	public static void cacheResult(AccInsBodiesOtherReq accInsBodiesOtherReq) {
		getPersistence().cacheResult(accInsBodiesOtherReq);
	}
	...
	public static void cacheResult(
		List<AccInsBodiesOtherReq> accInsBodiesOtherReqs) {

		getPersistence().cacheResult(accInsBodiesOtherReqs);
	}
	 ...
	 */
	public static AccInsBodiesOtherReq create(long accInsBodiesOtherReqId) {
		return getPersistence().create(accInsBodiesOtherReqId);
	}
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a acc ins bodies other req with the primary key could not be found
	 */
	public static AccInsBodiesOtherReq remove(long accInsBodiesOtherReqId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {

		return getPersistence().remove(accInsBodiesOtherReqId);
	}

	public static AccInsBodiesOtherReq updateImpl(
		AccInsBodiesOtherReq accInsBodiesOtherReq) {

		return getPersistence().updateImpl(accInsBodiesOtherReq);
	}
	 ...
	 * @throws NoSuchAccInsBodiesOtherReqException if a acc ins bodies other req with the primary key could not be found
	 */
	public static AccInsBodiesOtherReq findByPrimaryKey(
			long accInsBodiesOtherReqId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccInsBodiesOtherReqException {

		return getPersistence().findByPrimaryKey(accInsBodiesOtherReqId);
	}
	 ...
	 */
	public static AccInsBodiesOtherReq fetchByPrimaryKey(
		long accInsBodiesOtherReqId) {

		return getPersistence().fetchByPrimaryKey(accInsBodiesOtherReqId);
	}
	 ...
	 */
	public static List<AccInsBodiesOtherReq> findAll() {
	 ...
	 */
	public static List<AccInsBodiesOtherReq> findAll(int start, int end) {
	...
	public static AccInsBodiesOtherReqPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AccInsBodiesOtherReqPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AccInsBodiesOtherReqPersistence _persistence;
