...
/**
 * Provides the local service utility for AddCerScopeServiceThird. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceThirdLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddCerScopeServiceThirdLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceThirdLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddCerScopeServiceThird addAddCerScopeServiceThird(
		AddCerScopeServiceThird addCerScopeServiceThird) {

		return getService().addAddCerScopeServiceThird(addCerScopeServiceThird);
	}
	 ...
	 */
	public static AddCerScopeServiceThird createAddCerScopeServiceThird(
		long addCerScopeServiceThirdId) {

		return getService().createAddCerScopeServiceThird(
	 ...
	 */
	public static AddCerScopeServiceThird deleteAddCerScopeServiceThird(
		AddCerScopeServiceThird addCerScopeServiceThird) {

		return getService().deleteAddCerScopeServiceThird(
	...
	public static AddCerScopeServiceThird fetchAddCerScopeServiceThird(
		long addCerScopeServiceThirdId) {

		return getService().fetchAddCerScopeServiceThird(
			addCerScopeServiceThirdId);
	}
	 ...
	 * @throws PortalException if a add cer scope service third with the primary key could not be found
	 */
	public static AddCerScopeServiceThird getAddCerScopeServiceThird(
			long addCerScopeServiceThirdId)
		throws PortalException {

		return getService().getAddCerScopeServiceThird(
			addCerScopeServiceThirdId);
	}
	 ...
	 */
	public static List<AddCerScopeServiceThird> getAddCerScopeServiceThirds(
		int start, int end) {

		return getService().getAddCerScopeServiceThirds(start, end);
	}
	 ...
	 */
	public static int getAddCerScopeServiceThirdsCount() {
		return getService().getAddCerScopeServiceThirdsCount();
	}
	...
	public static List<AddCerScopeServiceThird> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddCerScopeServiceThird updateAddCerScopeServiceThird(
		AddCerScopeServiceThird addCerScopeServiceThird) {

		return getService().updateAddCerScopeServiceThird(
			addCerScopeServiceThird);
	}

	public static AddCerScopeServiceThirdLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddCerScopeServiceThirdLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddCerScopeServiceThirdLocalServiceUtil.class,
