...
/**
 * Provides the local service utility for AddLabMedicalPhysicalSec. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalSecLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddLabMedicalPhysicalSecLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalSecLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddLabMedicalPhysicalSec addAddLabMedicalPhysicalSec(
		AddLabMedicalPhysicalSec addLabMedicalPhysicalSec) {

		return getService().addAddLabMedicalPhysicalSec(
	 ...
	 */
	public static AddLabMedicalPhysicalSec createAddLabMedicalPhysicalSec(
		long addLabMedicalPhysicalSecId) {

		return getService().createAddLabMedicalPhysicalSec(
	 ...
	 */
	public static AddLabMedicalPhysicalSec deleteAddLabMedicalPhysicalSec(
		AddLabMedicalPhysicalSec addLabMedicalPhysicalSec) {

		return getService().deleteAddLabMedicalPhysicalSec(
			addLabMedicalPhysicalSec);
	}
	...
	public static AddLabMedicalPhysicalSec fetchAddLabMedicalPhysicalSec(
		long addLabMedicalPhysicalSecId) {

		return getService().fetchAddLabMedicalPhysicalSec(
			addLabMedicalPhysicalSecId);
	}
	 ...
	 * @throws PortalException if a add lab medical physical sec with the primary key could not be found
	 */
	public static AddLabMedicalPhysicalSec getAddLabMedicalPhysicalSec(
			long addLabMedicalPhysicalSecId)
		throws PortalException {

		return getService().getAddLabMedicalPhysicalSec(
			addLabMedicalPhysicalSecId);
	}
	 ...
	 */
	public static List<AddLabMedicalPhysicalSec> getAddLabMedicalPhysicalSecs(
		int start, int end) {

		return getService().getAddLabMedicalPhysicalSecs(start, end);
	}
	 ...
	 */
	public static int getAddLabMedicalPhysicalSecsCount() {
		return getService().getAddLabMedicalPhysicalSecsCount();
	}
	...
	public static List<AddLabMedicalPhysicalSec> getJanaacById(
	 ...
	 */
	public static AddLabMedicalPhysicalSec updateAddLabMedicalPhysicalSec(
		AddLabMedicalPhysicalSec addLabMedicalPhysicalSec) {

		return getService().updateAddLabMedicalPhysicalSec(
			addLabMedicalPhysicalSec);
	}

	public static AddLabMedicalPhysicalSecLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddLabMedicalPhysicalSecLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddLabMedicalPhysicalSecLocalServiceUtil.class,
			AddLabMedicalPhysicalSecLocalService.class);
