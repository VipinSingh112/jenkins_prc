...
/**
 * Provides the local service utility for AddLabAppliInfo. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddLabAppliInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddLabAppliInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabAppliInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddLabAppliInfo addAddLabAppliInfo(
		AddLabAppliInfo addLabAppliInfo) {

		return getService().addAddLabAppliInfo(addLabAppliInfo);
	}
	 ...
	 */
	public static AddLabAppliInfo createAddLabAppliInfo(
		long addLabAppliInfoId) {

		return getService().createAddLabAppliInfo(addLabAppliInfoId);
	}
	 ...
	 */
	public static AddLabAppliInfo deleteAddLabAppliInfo(
		AddLabAppliInfo addLabAppliInfo) {

		return getService().deleteAddLabAppliInfo(addLabAppliInfo);
	}
	 ...
	 */
	public static AddLabAppliInfo deleteAddLabAppliInfo(long addLabAppliInfoId)
		throws PortalException {

		return getService().deleteAddLabAppliInfo(addLabAppliInfoId);
	}
	...
	public static AddLabAppliInfo fetchAddLabAppliInfo(long addLabAppliInfoId) {
		return getService().fetchAddLabAppliInfo(addLabAppliInfoId);
	}
	 ...
	 * @throws PortalException if a add lab appli info with the primary key could not be found
	 */
	public static AddLabAppliInfo getAddLabAppliInfo(long addLabAppliInfoId)
		throws PortalException {

		return getService().getAddLabAppliInfo(addLabAppliInfoId);
	}
	 ...
	 */
	public static List<AddLabAppliInfo> getAddLabAppliInfos(
		int start, int end) {

		return getService().getAddLabAppliInfos(start, end);
	}
	 ...
	 */
	public static int getAddLabAppliInfosCount() {
		return getService().getAddLabAppliInfosCount();
	}
	...
	public static List<AddLabAppliInfo> getJanaacById(
	 ...
	 */
	public static AddLabAppliInfo updateAddLabAppliInfo(
		AddLabAppliInfo addLabAppliInfo) {

		return getService().updateAddLabAppliInfo(addLabAppliInfo);
	}

	public static AddLabAppliInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddLabAppliInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddLabAppliInfoLocalServiceUtil.class,
			AddLabAppliInfoLocalService.class);
