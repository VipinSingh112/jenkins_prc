...
/**
 * The persistence interface for the add lab calibra struc req sec service.
 *
 * <p>
 ...
 * @see AddLabCalibraStrucReqSecUtil
 * @generated
 */
@ProviderType
public interface AddLabCalibraStrucReqSecPersistence
	extends BasePersistence<AddLabCalibraStrucReqSec> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddLabCalibraStrucReqSecUtil} to access the add lab calibra struc req sec persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<AddLabCalibraStrucReqSec> findBygetJanaacById(
	...
	public java.util.List<AddLabCalibraStrucReqSec> findBygetJanaacById(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<AddLabCalibraStrucReqSec> orderByComparator);
	...
	public void cacheResult(
		java.util.List<AddLabCalibraStrucReqSec> addLabCalibraStrucReqSecs);
	 ...
	 */
	public java.util.List<AddLabCalibraStrucReqSec> findAll();
	 ...
	 */
	public java.util.List<AddLabCalibraStrucReqSec> findAll(int start, int end);
