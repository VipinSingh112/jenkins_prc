...
/**
 * The persistence utility for the add fda scope client service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AddFdaScopeClientPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AddFdaScopeClientPersistence
 * @generated
 */
public class AddFdaScopeClientUtil {
	 ...
	 */
	public static void clearCache(AddFdaScopeClient addFdaScopeClient) {
		getPersistence().clearCache(addFdaScopeClient);
	}
	 ...
	 */
	public static Map<Serializable, AddFdaScopeClient> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AddFdaScopeClient> findWithDynamicQuery(
	 ...
	 */
	public static AddFdaScopeClient update(
		AddFdaScopeClient addFdaScopeClient) {

		return getPersistence().update(addFdaScopeClient);
	}
	 ...
	 */
	public static AddFdaScopeClient update(
		AddFdaScopeClient addFdaScopeClient, ServiceContext serviceContext) {

		return getPersistence().update(addFdaScopeClient, serviceContext);
	}
	 ...
	 */
	public static List<AddFdaScopeClient> findBygetJanaacById(
	 ...
	 */
	public static AddFdaScopeClient findBygetJanaacById_First(
			long janaacApplicationId,
			OrderByComparator<AddFdaScopeClient> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaScopeClientException {
	 ...
	 */
	public static AddFdaScopeClient fetchBygetJanaacById_First(
		long janaacApplicationId,
		OrderByComparator<AddFdaScopeClient> orderByComparator) {
	 ...
	 * @throws NoSuchAddFdaScopeClientException if a matching add fda scope client could not be found
	 */
	public static AddFdaScopeClient findBygetJanaacById_Last(
			long janaacApplicationId,
			OrderByComparator<AddFdaScopeClient> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaScopeClientException {
	 ...
	 */
	public static AddFdaScopeClient fetchBygetJanaacById_Last(
		long janaacApplicationId,
		OrderByComparator<AddFdaScopeClient> orderByComparator) {
	 ...
	 */
	public static AddFdaScopeClient[] findBygetJanaacById_PrevAndNext(
		...
		return getPersistence().findBygetJanaacById_PrevAndNext(
			addFdaScopeClientId, janaacApplicationId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(AddFdaScopeClient addFdaScopeClient) {
		getPersistence().cacheResult(addFdaScopeClient);
	}
	 ...
	 */
	public static void cacheResult(List<AddFdaScopeClient> addFdaScopeClients) {
		getPersistence().cacheResult(addFdaScopeClients);
	}
	 ...
	 */
	public static AddFdaScopeClient create(long addFdaScopeClientId) {
		return getPersistence().create(addFdaScopeClientId);
	}
	 ...
	 * @throws NoSuchAddFdaScopeClientException if a add fda scope client with the primary key could not be found
	 */
	public static AddFdaScopeClient remove(long addFdaScopeClientId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaScopeClientException {

		return getPersistence().remove(addFdaScopeClientId);
	}

	public static AddFdaScopeClient updateImpl(
		AddFdaScopeClient addFdaScopeClient) {

		return getPersistence().updateImpl(addFdaScopeClient);
	}
	 ...
	 * @throws NoSuchAddFdaScopeClientException if a add fda scope client with the primary key could not be found
	 */
	public static AddFdaScopeClient findByPrimaryKey(long addFdaScopeClientId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaScopeClientException {

		return getPersistence().findByPrimaryKey(addFdaScopeClientId);
	}
	 ...
	 */
	public static AddFdaScopeClient fetchByPrimaryKey(
		long addFdaScopeClientId) {

		return getPersistence().fetchByPrimaryKey(addFdaScopeClientId);
	}
	 ...
	 */
	public static List<AddFdaScopeClient> findAll() {
	 ...
	 */
	public static List<AddFdaScopeClient> findAll(int start, int end) {
	...
	public static AddFdaScopeClientPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AddFdaScopeClientPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AddFdaScopeClientPersistence _persistence;
