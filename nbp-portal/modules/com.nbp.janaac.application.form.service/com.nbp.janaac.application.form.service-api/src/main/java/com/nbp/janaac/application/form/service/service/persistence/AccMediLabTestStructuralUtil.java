...
/**
 * The persistence utility for the acc medi lab test structural service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AccMediLabTestStructuralPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AccMediLabTestStructuralPersistence
 * @generated
 */
public class AccMediLabTestStructuralUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(accMediLabTestStructural);
	}
	 ...
	 */
	public static Map<Serializable, AccMediLabTestStructural>
	 ...
	 */
	public static List<AccMediLabTestStructural> findWithDynamicQuery(
	 ...
	 */
	public static AccMediLabTestStructural update(
		AccMediLabTestStructural accMediLabTestStructural) {

		return getPersistence().update(accMediLabTestStructural);
	}
	...
	public static AccMediLabTestStructural update(
		...
		return getPersistence().update(
			accMediLabTestStructural, serviceContext);
	}
	 ...
	 */
	public static List<AccMediLabTestStructural> findByUuid(String uuid) {
	 ...
	 */
	public static List<AccMediLabTestStructural> findByUuid(
	 ...
	 */
	public static AccMediLabTestStructural findByUuid_First(
			String uuid,
			OrderByComparator<AccMediLabTestStructural> orderByComparator)
	 ...
	 */
	public static AccMediLabTestStructural fetchByUuid_First(
		String uuid,
		OrderByComparator<AccMediLabTestStructural> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural findByUuid_Last(
			String uuid,
			OrderByComparator<AccMediLabTestStructural> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {
	 ...
	 */
	public static AccMediLabTestStructural fetchByUuid_Last(
		String uuid,
		OrderByComparator<AccMediLabTestStructural> orderByComparator) {
	 ...
	 */
	public static AccMediLabTestStructural[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			accMediLabTestStructuralId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural findByUUID_G(
	 ...
	 */
	public static AccMediLabTestStructural fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static AccMediLabTestStructural removeByUUID_G(
			String uuid, long groupId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {
	 ...
	 * @return the matching acc medi lab test structurals
	 */
	public static List<AccMediLabTestStructural> findByUuid_C(
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AccMediLabTestStructural> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {
	 ...
	 * @return the first matching acc medi lab test structural, or <code>null</code> if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestStructural> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AccMediLabTestStructural> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {
	 ...
	 * @return the last matching acc medi lab test structural, or <code>null</code> if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestStructural> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a acc medi lab test structural with the primary key could not be found
	 */
	public static AccMediLabTestStructural[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			accMediLabTestStructuralId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural findBygetJANAAC_ByApplicationId(
	 ...
	 * @return the matching acc medi lab test structural, or <code>null</code> if a matching acc medi lab test structural could not be found
	 */
	public static AccMediLabTestStructural fetchBygetJANAAC_ByApplicationId(
		long janaacApplicationId) {
	 ...
	 * @return the acc medi lab test structural that was removed
	 */
	public static AccMediLabTestStructural removeBygetJANAAC_ByApplicationId(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabTestStructural);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabTestStructurals);
	}
	 ...
	 */
	public static AccMediLabTestStructural create(
		long accMediLabTestStructuralId) {

		return getPersistence().create(accMediLabTestStructuralId);
	}
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a acc medi lab test structural with the primary key could not be found
	 */
	public static AccMediLabTestStructural remove(
			long accMediLabTestStructuralId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {

		return getPersistence().remove(accMediLabTestStructuralId);
	}

	public static AccMediLabTestStructural updateImpl(
		AccMediLabTestStructural accMediLabTestStructural) {

		return getPersistence().updateImpl(accMediLabTestStructural);
	}
	 ...
	 * @throws NoSuchAccMediLabTestStructuralException if a acc medi lab test structural with the primary key could not be found
	 */
	public static AccMediLabTestStructural findByPrimaryKey(
			long accMediLabTestStructuralId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestStructuralException {

		return getPersistence().findByPrimaryKey(accMediLabTestStructuralId);
	}
	 ...
	 */
	public static AccMediLabTestStructural fetchByPrimaryKey(
		long accMediLabTestStructuralId) {

		return getPersistence().fetchByPrimaryKey(accMediLabTestStructuralId);
	}
	 ...
	 */
	public static List<AccMediLabTestStructural> findAll() {
	 ...
	 */
	public static List<AccMediLabTestStructural> findAll(int start, int end) {
	...
	public static AccMediLabTestStructuralPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AccMediLabTestStructuralPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AccMediLabTestStructuralPersistence _persistence;
