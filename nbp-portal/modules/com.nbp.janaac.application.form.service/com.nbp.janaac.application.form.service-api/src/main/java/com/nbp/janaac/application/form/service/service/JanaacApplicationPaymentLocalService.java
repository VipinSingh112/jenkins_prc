...
/**
 * Provides the local service interface for JanaacApplicationPayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JanaacApplicationPaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JanaacApplicationPaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.JanaacApplicationPaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the janaac application payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JanaacApplicationPaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public JanaacApplicationPayment addJanaacApplicationPayment(
	...
	public JanaacApplicationPayment createJanaacApplicationPayment(
	...
	public JanaacApplicationPayment deleteJanaacApplicationPayment(
		JanaacApplicationPayment janaacApplicationPayment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JanaacApplicationPayment fetchJanaacApplicationPayment(
		long janaacApplicationPaymentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JanaacApplicationPayment getJanaacApplicationPayment(
			long janaacApplicationPaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JanaacApplicationPayment> getJanaacApplicationPayments(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JanaacApplicationPayment getJanaacById(long janaacApplicationId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public JanaacApplicationPayment updateJanaacApplicationPayment(
		JanaacApplicationPayment janaacApplicationPayment);
