 ...
 * @see AccMediLabTestManageReqPersistence
 * @generated
 */
public class AccMediLabTestManageReqUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(accMediLabTestManageReq);
	}
	 ...
	 */
	public static Map<Serializable, AccMediLabTestManageReq> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AccMediLabTestManageReq> findWithDynamicQuery(
	 ...
	 */
	public static AccMediLabTestManageReq update(
		AccMediLabTestManageReq accMediLabTestManageReq) {

		return getPersistence().update(accMediLabTestManageReq);
	}
	...
	public static AccMediLabTestManageReq update(
		...
		return getPersistence().update(accMediLabTestManageReq, serviceContext);
	}
	 ...
	 */
	public static List<AccMediLabTestManageReq> findByUuid(String uuid) {
	 ...
	 */
	public static List<AccMediLabTestManageReq> findByUuid(
	 ...
	 */
	public static AccMediLabTestManageReq findByUuid_First(
			String uuid,
			OrderByComparator<AccMediLabTestManageReq> orderByComparator)
	 ...
	 */
	public static AccMediLabTestManageReq fetchByUuid_First(
		String uuid,
		OrderByComparator<AccMediLabTestManageReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq findByUuid_Last(
			String uuid,
			OrderByComparator<AccMediLabTestManageReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {
	 ...
	 */
	public static AccMediLabTestManageReq fetchByUuid_Last(
		String uuid,
		OrderByComparator<AccMediLabTestManageReq> orderByComparator) {
	 ...
	 */
	public static AccMediLabTestManageReq[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			accMediLabTestManageReqId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq findByUUID_G(
	 ...
	 */
	public static AccMediLabTestManageReq fetchByUUID_G(
		String uuid, long groupId) {
	 ...
	 */
	public static AccMediLabTestManageReq removeByUUID_G(
			String uuid, long groupId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {
	 ...
	 * @return the matching acc medi lab test manage reqs
	 */
	public static List<AccMediLabTestManageReq> findByUuid_C(
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AccMediLabTestManageReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {
	 ...
	 * @return the first matching acc medi lab test manage req, or <code>null</code> if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestManageReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AccMediLabTestManageReq> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {
	 ...
	 * @return the last matching acc medi lab test manage req, or <code>null</code> if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestManageReq> orderByComparator) {
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a acc medi lab test manage req with the primary key could not be found
	 */
	public static AccMediLabTestManageReq[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			accMediLabTestManageReqId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq findBygetJANAAC_ByApplicationId(
	 ...
	 * @return the matching acc medi lab test manage req, or <code>null</code> if a matching acc medi lab test manage req could not be found
	 */
	public static AccMediLabTestManageReq fetchBygetJANAAC_ByApplicationId(
		long janaacApplicationId) {
	 ...
	 * @return the acc medi lab test manage req that was removed
	 */
	public static AccMediLabTestManageReq removeBygetJANAAC_ByApplicationId(
			long janaacApplicationId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabTestManageReq);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(accMediLabTestManageReqs);
	}
	 ...
	 */
	public static AccMediLabTestManageReq create(
		long accMediLabTestManageReqId) {

		return getPersistence().create(accMediLabTestManageReqId);
	}
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a acc medi lab test manage req with the primary key could not be found
	 */
	public static AccMediLabTestManageReq remove(long accMediLabTestManageReqId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {

		return getPersistence().remove(accMediLabTestManageReqId);
	}

	public static AccMediLabTestManageReq updateImpl(
		AccMediLabTestManageReq accMediLabTestManageReq) {

		return getPersistence().updateImpl(accMediLabTestManageReq);
	}
	 ...
	 * @throws NoSuchAccMediLabTestManageReqException if a acc medi lab test manage req with the primary key could not be found
	 */
	public static AccMediLabTestManageReq findByPrimaryKey(
			long accMediLabTestManageReqId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAccMediLabTestManageReqException {

		return getPersistence().findByPrimaryKey(accMediLabTestManageReqId);
	}
	 ...
	 */
	public static AccMediLabTestManageReq fetchByPrimaryKey(
		long accMediLabTestManageReqId) {

		return getPersistence().fetchByPrimaryKey(accMediLabTestManageReqId);
	}
	 ...
	 */
	public static List<AccMediLabTestManageReq> findAll() {
	 ...
	 */
	public static List<AccMediLabTestManageReq> findAll(int start, int end) {
	...
	public static AccMediLabTestManageReqPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AccMediLabTestManageReqPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AccMediLabTestManageReqPersistence _persistence;
