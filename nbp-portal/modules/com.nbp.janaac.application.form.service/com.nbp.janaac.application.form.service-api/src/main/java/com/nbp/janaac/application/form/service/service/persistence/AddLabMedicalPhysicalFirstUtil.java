...
/**
 * The persistence utility for the add lab medical physical first service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AddLabMedicalPhysicalFirstPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AddLabMedicalPhysicalFirstPersistence
 * @generated
 */
public class AddLabMedicalPhysicalFirstUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(addLabMedicalPhysicalFirst);
	}
	 ...
	 */
	public static Map<Serializable, AddLabMedicalPhysicalFirst>
	 ...
	 */
	public static List<AddLabMedicalPhysicalFirst> findWithDynamicQuery(
	 ...
	 */
	public static AddLabMedicalPhysicalFirst update(
		AddLabMedicalPhysicalFirst addLabMedicalPhysicalFirst) {

		return getPersistence().update(addLabMedicalPhysicalFirst);
	}
	...
	public static AddLabMedicalPhysicalFirst update(
		...
		return getPersistence().update(
			addLabMedicalPhysicalFirst, serviceContext);
	}
	 ...
	 */
	public static List<AddLabMedicalPhysicalFirst> findBygetJanaacById(
	 ...
	 */
	public static AddLabMedicalPhysicalFirst findBygetJanaacById_First(
			long janaacApplicationId,
			OrderByComparator<AddLabMedicalPhysicalFirst> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabMedicalPhysicalFirstException {
	 ...
	 */
	public static AddLabMedicalPhysicalFirst fetchBygetJanaacById_First(
		long janaacApplicationId,
		OrderByComparator<AddLabMedicalPhysicalFirst> orderByComparator) {
	 ...
	 * @throws NoSuchAddLabMedicalPhysicalFirstException if a matching add lab medical physical first could not be found
	 */
	public static AddLabMedicalPhysicalFirst findBygetJanaacById_Last(
			long janaacApplicationId,
			OrderByComparator<AddLabMedicalPhysicalFirst> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabMedicalPhysicalFirstException {
	 ...
	 */
	public static AddLabMedicalPhysicalFirst fetchBygetJanaacById_Last(
		long janaacApplicationId,
		OrderByComparator<AddLabMedicalPhysicalFirst> orderByComparator) {
	 ...
	 */
	public static AddLabMedicalPhysicalFirst[] findBygetJanaacById_PrevAndNext(
		...
		return getPersistence().findBygetJanaacById_PrevAndNext(
			addLabMedicalPhysicalFirstId, janaacApplicationId,
			orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addLabMedicalPhysicalFirst);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addLabMedicalPhysicalFirsts);
	}
	 ...
	 */
	public static AddLabMedicalPhysicalFirst create(
		long addLabMedicalPhysicalFirstId) {

		return getPersistence().create(addLabMedicalPhysicalFirstId);
	}
	 ...
	 * @throws NoSuchAddLabMedicalPhysicalFirstException if a add lab medical physical first with the primary key could not be found
	 */
	public static AddLabMedicalPhysicalFirst remove(
			long addLabMedicalPhysicalFirstId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabMedicalPhysicalFirstException {

		return getPersistence().remove(addLabMedicalPhysicalFirstId);
	}

	public static AddLabMedicalPhysicalFirst updateImpl(
		AddLabMedicalPhysicalFirst addLabMedicalPhysicalFirst) {

		return getPersistence().updateImpl(addLabMedicalPhysicalFirst);
	}
	 ...
	 * @throws NoSuchAddLabMedicalPhysicalFirstException if a add lab medical physical first with the primary key could not be found
	 */
	public static AddLabMedicalPhysicalFirst findByPrimaryKey(
			long addLabMedicalPhysicalFirstId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabMedicalPhysicalFirstException {

		return getPersistence().findByPrimaryKey(addLabMedicalPhysicalFirstId);
	}
	 ...
	 */
	public static AddLabMedicalPhysicalFirst fetchByPrimaryKey(
		long addLabMedicalPhysicalFirstId) {

		return getPersistence().fetchByPrimaryKey(addLabMedicalPhysicalFirstId);
	}
	 ...
	 */
	public static List<AddLabMedicalPhysicalFirst> findAll() {
	 ...
	 */
	public static List<AddLabMedicalPhysicalFirst> findAll(int start, int end) {
	...
	public static AddLabMedicalPhysicalFirstPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AddLabMedicalPhysicalFirstPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AddLabMedicalPhysicalFirstPersistence _persistence;
