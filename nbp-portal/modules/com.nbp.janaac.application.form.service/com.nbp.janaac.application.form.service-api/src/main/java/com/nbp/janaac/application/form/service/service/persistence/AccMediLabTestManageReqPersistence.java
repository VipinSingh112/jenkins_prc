...
/**
 * The persistence interface for the acc medi lab test manage req service.
 *
 * <p>
 ...
 * @see AccMediLabTestManageReqUtil
 * @generated
 */
@ProviderType
public interface AccMediLabTestManageReqPersistence
	extends BasePersistence<AccMediLabTestManageReq> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccMediLabTestManageReqUtil} to access the acc medi lab test manage req persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<AccMediLabTestManageReq> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<AccMediLabTestManageReq> findByUuid(
	 ...
	 * @return the matching acc medi lab test manage reqs
	 */
	public java.util.List<AccMediLabTestManageReq> findByUuid_C(
	...
	public void cacheResult(
		java.util.List<AccMediLabTestManageReq> accMediLabTestManageReqs);
	 ...
	 */
	public java.util.List<AccMediLabTestManageReq> findAll();
	 ...
	 */
	public java.util.List<AccMediLabTestManageReq> findAll(int start, int end);
