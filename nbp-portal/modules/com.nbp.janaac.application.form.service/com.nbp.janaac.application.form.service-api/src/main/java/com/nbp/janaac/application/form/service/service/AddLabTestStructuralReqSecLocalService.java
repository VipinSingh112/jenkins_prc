...
/**
 * Provides the local service interface for AddLabTestStructuralReqSec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AddLabTestStructuralReqSecLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AddLabTestStructuralReqSecLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabTestStructuralReqSecLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the add lab test structural req sec local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AddLabTestStructuralReqSecLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AddLabTestStructuralReqSec> getJanaacById(
