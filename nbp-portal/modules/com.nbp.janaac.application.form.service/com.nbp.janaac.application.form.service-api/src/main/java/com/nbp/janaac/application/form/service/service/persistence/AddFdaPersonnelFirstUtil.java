...
/**
 * The persistence utility for the add fda personnel first service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AddFdaPersonnelFirstPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AddFdaPersonnelFirstPersistence
 * @generated
 */
public class AddFdaPersonnelFirstUtil {
	 ...
	 */
	public static void clearCache(AddFdaPersonnelFirst addFdaPersonnelFirst) {
		getPersistence().clearCache(addFdaPersonnelFirst);
	}
	 ...
	 */
	public static Map<Serializable, AddFdaPersonnelFirst> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AddFdaPersonnelFirst> findWithDynamicQuery(
	 ...
	 */
	public static AddFdaPersonnelFirst update(
		AddFdaPersonnelFirst addFdaPersonnelFirst) {

		return getPersistence().update(addFdaPersonnelFirst);
	}
	...
	public static AddFdaPersonnelFirst update(
		...
		return getPersistence().update(addFdaPersonnelFirst, serviceContext);
	}
	 ...
	 */
	public static List<AddFdaPersonnelFirst> findBygetJanaacById(
	 ...
	 */
	public static AddFdaPersonnelFirst findBygetJanaacById_First(
			long janaacApplicationId,
			OrderByComparator<AddFdaPersonnelFirst> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaPersonnelFirstException {
	 ...
	 */
	public static AddFdaPersonnelFirst fetchBygetJanaacById_First(
		long janaacApplicationId,
		OrderByComparator<AddFdaPersonnelFirst> orderByComparator) {
	 ...
	 * @throws NoSuchAddFdaPersonnelFirstException if a matching add fda personnel first could not be found
	 */
	public static AddFdaPersonnelFirst findBygetJanaacById_Last(
			long janaacApplicationId,
			OrderByComparator<AddFdaPersonnelFirst> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaPersonnelFirstException {
	 ...
	 */
	public static AddFdaPersonnelFirst fetchBygetJanaacById_Last(
		long janaacApplicationId,
		OrderByComparator<AddFdaPersonnelFirst> orderByComparator) {
	 ...
	 */
	public static AddFdaPersonnelFirst[] findBygetJanaacById_PrevAndNext(
		...
		return getPersistence().findBygetJanaacById_PrevAndNext(
			addFdaPersonnelFirstId, janaacApplicationId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(AddFdaPersonnelFirst addFdaPersonnelFirst) {
		getPersistence().cacheResult(addFdaPersonnelFirst);
	}
	...
	public static void cacheResult(
		List<AddFdaPersonnelFirst> addFdaPersonnelFirsts) {

		getPersistence().cacheResult(addFdaPersonnelFirsts);
	}
	 ...
	 */
	public static AddFdaPersonnelFirst create(long addFdaPersonnelFirstId) {
		return getPersistence().create(addFdaPersonnelFirstId);
	}
	 ...
	 * @throws NoSuchAddFdaPersonnelFirstException if a add fda personnel first with the primary key could not be found
	 */
	public static AddFdaPersonnelFirst remove(long addFdaPersonnelFirstId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaPersonnelFirstException {

		return getPersistence().remove(addFdaPersonnelFirstId);
	}

	public static AddFdaPersonnelFirst updateImpl(
		AddFdaPersonnelFirst addFdaPersonnelFirst) {

		return getPersistence().updateImpl(addFdaPersonnelFirst);
	}
	 ...
	 * @throws NoSuchAddFdaPersonnelFirstException if a add fda personnel first with the primary key could not be found
	 */
	public static AddFdaPersonnelFirst findByPrimaryKey(
			long addFdaPersonnelFirstId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddFdaPersonnelFirstException {

		return getPersistence().findByPrimaryKey(addFdaPersonnelFirstId);
	}
	 ...
	 */
	public static AddFdaPersonnelFirst fetchByPrimaryKey(
		long addFdaPersonnelFirstId) {

		return getPersistence().fetchByPrimaryKey(addFdaPersonnelFirstId);
	}
	 ...
	 */
	public static List<AddFdaPersonnelFirst> findAll() {
	 ...
	 */
	public static List<AddFdaPersonnelFirst> findAll(int start, int end) {
	...
	public static AddFdaPersonnelFirstPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AddFdaPersonnelFirstPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AddFdaPersonnelFirstPersistence _persistence;
