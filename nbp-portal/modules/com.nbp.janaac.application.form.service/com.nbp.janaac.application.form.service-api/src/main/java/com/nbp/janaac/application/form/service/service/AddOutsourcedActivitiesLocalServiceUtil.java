...
/**
 * Provides the local service utility for AddOutsourcedActivities. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddOutsourcedActivitiesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddOutsourcedActivitiesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddOutsourcedActivitiesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddOutsourcedActivities addAddOutsourcedActivities(
		AddOutsourcedActivities addOutsourcedActivities) {

		return getService().addAddOutsourcedActivities(addOutsourcedActivities);
	}
	 ...
	 */
	public static AddOutsourcedActivities createAddOutsourcedActivities(
		long addOutsourcedActivitiesId) {

		return getService().createAddOutsourcedActivities(
	 ...
	 */
	public static AddOutsourcedActivities deleteAddOutsourcedActivities(
		AddOutsourcedActivities addOutsourcedActivities) {

		return getService().deleteAddOutsourcedActivities(
	...
	public static AddOutsourcedActivities fetchAddOutsourcedActivities(
		long addOutsourcedActivitiesId) {

		return getService().fetchAddOutsourcedActivities(
			addOutsourcedActivitiesId);
	}
	 ...
	 * @throws PortalException if a add outsourced activities with the primary key could not be found
	 */
	public static AddOutsourcedActivities getAddOutsourcedActivities(
			long addOutsourcedActivitiesId)
		throws PortalException {

		return getService().getAddOutsourcedActivities(
			addOutsourcedActivitiesId);
	}
	 ...
	 */
	public static List<AddOutsourcedActivities> getAddOutsourcedActivitieses(
		int start, int end) {

		return getService().getAddOutsourcedActivitieses(start, end);
	}
	 ...
	 */
	public static int getAddOutsourcedActivitiesesCount() {
		return getService().getAddOutsourcedActivitiesesCount();
	}
	...
	public static List<AddOutsourcedActivities> getJanaac_OutSrc_Id(
		long janaacApplicationId) {

		return getService().getJanaac_OutSrc_Id(janaacApplicationId);
	}
	 ...
	 */
	public static AddOutsourcedActivities updateAddOutsourcedActivities(
		AddOutsourcedActivities addOutsourcedActivities) {

		return getService().updateAddOutsourcedActivities(
			addOutsourcedActivities);
	}

	public static AddOutsourcedActivitiesLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddOutsourcedActivitiesLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddOutsourcedActivitiesLocalServiceUtil.class,
