...
/**
 * Provides the local service utility for AddInsOrgInfoSecond. This utility wraps
 * <code>com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoSecondLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AddInsOrgInfoSecondLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoSecondLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AddInsOrgInfoSecond addAddInsOrgInfoSecond(
		AddInsOrgInfoSecond addInsOrgInfoSecond) {

		return getService().addAddInsOrgInfoSecond(addInsOrgInfoSecond);
	}
	 ...
	 */
	public static AddInsOrgInfoSecond createAddInsOrgInfoSecond(
		long addInsOrgInfoSecondId) {

		return getService().createAddInsOrgInfoSecond(addInsOrgInfoSecondId);
	}
	 ...
	 */
	public static AddInsOrgInfoSecond deleteAddInsOrgInfoSecond(
		AddInsOrgInfoSecond addInsOrgInfoSecond) {

		return getService().deleteAddInsOrgInfoSecond(addInsOrgInfoSecond);
	}
	...
	public static AddInsOrgInfoSecond deleteAddInsOrgInfoSecond(
		...
		return getService().deleteAddInsOrgInfoSecond(addInsOrgInfoSecondId);
	}
	...
	public static AddInsOrgInfoSecond fetchAddInsOrgInfoSecond(
		long addInsOrgInfoSecondId) {

		return getService().fetchAddInsOrgInfoSecond(addInsOrgInfoSecondId);
	}
	 ...
	 * @throws PortalException if a add ins org info second with the primary key could not be found
	 */
	public static AddInsOrgInfoSecond getAddInsOrgInfoSecond(
			long addInsOrgInfoSecondId)
		throws PortalException {

		return getService().getAddInsOrgInfoSecond(addInsOrgInfoSecondId);
	}
	 ...
	 */
	public static List<AddInsOrgInfoSecond> getAddInsOrgInfoSeconds(
		int start, int end) {

		return getService().getAddInsOrgInfoSeconds(start, end);
	}
	 ...
	 */
	public static int getAddInsOrgInfoSecondsCount() {
		return getService().getAddInsOrgInfoSecondsCount();
	}
	...
	public static List<AddInsOrgInfoSecond> getJANAAC_ByApplicationId(
	 ...
	 */
	public static AddInsOrgInfoSecond updateAddInsOrgInfoSecond(
		AddInsOrgInfoSecond addInsOrgInfoSecond) {

		return getService().updateAddInsOrgInfoSecond(addInsOrgInfoSecond);
	}

	public static AddInsOrgInfoSecondLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AddInsOrgInfoSecondLocalService>
		_serviceSnapshot = new Snapshot<>(
			AddInsOrgInfoSecondLocalServiceUtil.class,
			AddInsOrgInfoSecondLocalService.class);
