...
/**
 * <p>
 * This class is a wrapper for {@link AddFdaAppliInfo}.
 * </p>
 *
 ...
 * @generated
 */
public class AddFdaAppliInfoWrapper
	extends BaseModelWrapper<AddFdaAppliInfo>
	implements AddFdaAppliInfo, ModelWrapper<AddFdaAppliInfo> {

	public AddFdaAppliInfoWrapper(AddFdaAppliInfo addFdaAppliInfo) {
		super(addFdaAppliInfo);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("addFdaAppliInfoId", getAddFdaAppliInfoId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Long addFdaAppliInfoId = (Long)attributes.get("addFdaAppliInfoId");

		if (addFdaAppliInfoId != null) {
			setAddFdaAppliInfoId(addFdaAppliInfoId);
		}
	...
	public long getAddFdaAppliInfoId() {
		return model.getAddFdaAppliInfoId();
	}
	...
	public void setAddFdaAppliInfoId(long addFdaAppliInfoId) {
		model.setAddFdaAppliInfoId(addFdaAppliInfoId);
	}
	...
	@Override
	protected AddFdaAppliInfoWrapper wrap(AddFdaAppliInfo addFdaAppliInfo) {
		return new AddFdaAppliInfoWrapper(addFdaAppliInfo);
	}
