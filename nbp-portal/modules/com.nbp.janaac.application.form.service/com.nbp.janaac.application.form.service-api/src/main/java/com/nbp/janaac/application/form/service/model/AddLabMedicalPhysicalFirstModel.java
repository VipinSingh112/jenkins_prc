...
/**
 * The base model interface for the AddLabMedicalPhysicalFirst service. Represents a row in the &quot;nbp_janaac_add_medi_phy_first&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.janaac.application.form.service.model.impl.AddLabMedicalPhysicalFirstModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.janaac.application.form.service.model.impl.AddLabMedicalPhysicalFirstImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface AddLabMedicalPhysicalFirstModel
	extends BaseModel<AddLabMedicalPhysicalFirst>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a add lab medical physical first model instance should use the {@link AddLabMedicalPhysicalFirst} interface instead.
	 */
