...
/**
 * Provides the local service interface for AddLabMedicalPhysicalSec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AddLabMedicalPhysicalSecLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AddLabMedicalPhysicalSecLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalSecLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the add lab medical physical sec local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AddLabMedicalPhysicalSecLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AddLabMedicalPhysicalSec addAddLabMedicalPhysicalSec(
	...
	public AddLabMedicalPhysicalSec createAddLabMedicalPhysicalSec(
	...
	public AddLabMedicalPhysicalSec deleteAddLabMedicalPhysicalSec(
		AddLabMedicalPhysicalSec addLabMedicalPhysicalSec);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AddLabMedicalPhysicalSec fetchAddLabMedicalPhysicalSec(
		long addLabMedicalPhysicalSecId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AddLabMedicalPhysicalSec getAddLabMedicalPhysicalSec(
			long addLabMedicalPhysicalSecId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AddLabMedicalPhysicalSec> getAddLabMedicalPhysicalSecs(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AddLabMedicalPhysicalSec> getJanaacById(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AddLabMedicalPhysicalSec updateAddLabMedicalPhysicalSec(
		AddLabMedicalPhysicalSec addLabMedicalPhysicalSec);
