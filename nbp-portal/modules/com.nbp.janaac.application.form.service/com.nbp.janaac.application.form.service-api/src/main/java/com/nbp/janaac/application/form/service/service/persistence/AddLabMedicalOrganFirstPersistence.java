...
/**
 * The persistence interface for the add lab medical organ first service.
 *
 * <p>
 ...
 * @see AddLabMedicalOrganFirstUtil
 * @generated
 */
@ProviderType
public interface AddLabMedicalOrganFirstPersistence
	extends BasePersistence<AddLabMedicalOrganFirst> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AddLabMedicalOrganFirstUtil} to access the add lab medical organ first persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<AddLabMedicalOrganFirst> findBygetJanaacById(
	...
	public java.util.List<AddLabMedicalOrganFirst> findBygetJanaacById(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<AddLabMedicalOrganFirst> orderByComparator);
	...
	public void cacheResult(
		java.util.List<AddLabMedicalOrganFirst> addLabMedicalOrganFirsts);
	 ...
	 */
	public java.util.List<AddLabMedicalOrganFirst> findAll();
	 ...
	 */
	public java.util.List<AddLabMedicalOrganFirst> findAll(int start, int end);
