...
/**
 * Provides the local service interface for AddLabMedicalOrganSec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AddLabMedicalOrganSecLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AddLabMedicalOrganSecLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganSecLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the add lab medical organ sec local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AddLabMedicalOrganSecLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AddLabMedicalOrganSec addAddLabMedicalOrganSec(
	...
	public AddLabMedicalOrganSec createAddLabMedicalOrganSec(
	...
	public AddLabMedicalOrganSec deleteAddLabMedicalOrganSec(
		AddLabMedicalOrganSec addLabMedicalOrganSec);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AddLabMedicalOrganSec fetchAddLabMedicalOrganSec(
		long addLabMedicalOrganSecId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AddLabMedicalOrganSec getAddLabMedicalOrganSec(
			long addLabMedicalOrganSecId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AddLabMedicalOrganSec> getAddLabMedicalOrganSecs(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AddLabMedicalOrganSec> getJanaacById(long janaacApplicationId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AddLabMedicalOrganSec updateAddLabMedicalOrganSec(
		AddLabMedicalOrganSec addLabMedicalOrganSec);
