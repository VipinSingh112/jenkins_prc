...
/**
 * The persistence utility for the add lab calibra struc req sec service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AddLabCalibraStrucReqSecPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AddLabCalibraStrucReqSecPersistence
 * @generated
 */
public class AddLabCalibraStrucReqSecUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(addLabCalibraStrucReqSec);
	}
	 ...
	 */
	public static Map<Serializable, AddLabCalibraStrucReqSec>
	 ...
	 */
	public static List<AddLabCalibraStrucReqSec> findWithDynamicQuery(
	 ...
	 */
	public static AddLabCalibraStrucReqSec update(
		AddLabCalibraStrucReqSec addLabCalibraStrucReqSec) {

		return getPersistence().update(addLabCalibraStrucReqSec);
	}
	...
	public static AddLabCalibraStrucReqSec update(
		...
		return getPersistence().update(
			addLabCalibraStrucReqSec, serviceContext);
	}
	 ...
	 */
	public static List<AddLabCalibraStrucReqSec> findBygetJanaacById(
	 ...
	 */
	public static AddLabCalibraStrucReqSec findBygetJanaacById_First(
			long janaacApplicationId,
			OrderByComparator<AddLabCalibraStrucReqSec> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabCalibraStrucReqSecException {
	 ...
	 */
	public static AddLabCalibraStrucReqSec fetchBygetJanaacById_First(
		long janaacApplicationId,
		OrderByComparator<AddLabCalibraStrucReqSec> orderByComparator) {
	 ...
	 * @throws NoSuchAddLabCalibraStrucReqSecException if a matching add lab calibra struc req sec could not be found
	 */
	public static AddLabCalibraStrucReqSec findBygetJanaacById_Last(
			long janaacApplicationId,
			OrderByComparator<AddLabCalibraStrucReqSec> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabCalibraStrucReqSecException {
	 ...
	 */
	public static AddLabCalibraStrucReqSec fetchBygetJanaacById_Last(
		long janaacApplicationId,
		OrderByComparator<AddLabCalibraStrucReqSec> orderByComparator) {
	 ...
	 */
	public static AddLabCalibraStrucReqSec[] findBygetJanaacById_PrevAndNext(
		...
		return getPersistence().findBygetJanaacById_PrevAndNext(
			addLabCalibraStrucReqSecId, janaacApplicationId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addLabCalibraStrucReqSec);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addLabCalibraStrucReqSecs);
	}
	 ...
	 */
	public static AddLabCalibraStrucReqSec create(
		long addLabCalibraStrucReqSecId) {

		return getPersistence().create(addLabCalibraStrucReqSecId);
	}
	 ...
	 * @throws NoSuchAddLabCalibraStrucReqSecException if a add lab calibra struc req sec with the primary key could not be found
	 */
	public static AddLabCalibraStrucReqSec remove(
			long addLabCalibraStrucReqSecId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabCalibraStrucReqSecException {

		return getPersistence().remove(addLabCalibraStrucReqSecId);
	}

	public static AddLabCalibraStrucReqSec updateImpl(
		AddLabCalibraStrucReqSec addLabCalibraStrucReqSec) {

		return getPersistence().updateImpl(addLabCalibraStrucReqSec);
	}
	 ...
	 * @throws NoSuchAddLabCalibraStrucReqSecException if a add lab calibra struc req sec with the primary key could not be found
	 */
	public static AddLabCalibraStrucReqSec findByPrimaryKey(
			long addLabCalibraStrucReqSecId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddLabCalibraStrucReqSecException {

		return getPersistence().findByPrimaryKey(addLabCalibraStrucReqSecId);
	}
	 ...
	 */
	public static AddLabCalibraStrucReqSec fetchByPrimaryKey(
		long addLabCalibraStrucReqSecId) {

		return getPersistence().fetchByPrimaryKey(addLabCalibraStrucReqSecId);
	}
	 ...
	 */
	public static List<AddLabCalibraStrucReqSec> findAll() {
	 ...
	 */
	public static List<AddLabCalibraStrucReqSec> findAll(int start, int end) {
	...
	public static AddLabCalibraStrucReqSecPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AddLabCalibraStrucReqSecPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AddLabCalibraStrucReqSecPersistence _persistence;
