...
/**
 * The persistence utility for the add cer personnel second service. This utility wraps <code>com.nbp.janaac.application.form.service.service.persistence.impl.AddCerPersonnelSecondPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AddCerPersonnelSecondPersistence
 * @generated
 */
public class AddCerPersonnelSecondUtil {
	 ...
	 */
	public static void clearCache(AddCerPersonnelSecond addCerPersonnelSecond) {
		getPersistence().clearCache(addCerPersonnelSecond);
	}
	 ...
	 */
	public static Map<Serializable, AddCerPersonnelSecond> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AddCerPersonnelSecond> findWithDynamicQuery(
	 ...
	 */
	public static AddCerPersonnelSecond update(
		AddCerPersonnelSecond addCerPersonnelSecond) {

		return getPersistence().update(addCerPersonnelSecond);
	}
	...
	public static AddCerPersonnelSecond update(
		...
		return getPersistence().update(addCerPersonnelSecond, serviceContext);
	}
	 ...
	 */
	public static List<AddCerPersonnelSecond> findBygetJanaacById(
	 ...
	 */
	public static AddCerPersonnelSecond findBygetJanaacById_First(
			long janaacApplicationId,
			OrderByComparator<AddCerPersonnelSecond> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddCerPersonnelSecondException {
	 ...
	 */
	public static AddCerPersonnelSecond fetchBygetJanaacById_First(
		long janaacApplicationId,
		OrderByComparator<AddCerPersonnelSecond> orderByComparator) {
	 ...
	 * @throws NoSuchAddCerPersonnelSecondException if a matching add cer personnel second could not be found
	 */
	public static AddCerPersonnelSecond findBygetJanaacById_Last(
			long janaacApplicationId,
			OrderByComparator<AddCerPersonnelSecond> orderByComparator)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddCerPersonnelSecondException {
	 ...
	 */
	public static AddCerPersonnelSecond fetchBygetJanaacById_Last(
		long janaacApplicationId,
		OrderByComparator<AddCerPersonnelSecond> orderByComparator) {
	 ...
	 */
	public static AddCerPersonnelSecond[] findBygetJanaacById_PrevAndNext(
		...
		return getPersistence().findBygetJanaacById_PrevAndNext(
			addCerPersonnelSecondId, janaacApplicationId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addCerPersonnelSecond);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(addCerPersonnelSeconds);
	}
	 ...
	 */
	public static AddCerPersonnelSecond create(long addCerPersonnelSecondId) {
		return getPersistence().create(addCerPersonnelSecondId);
	}
	 ...
	 * @throws NoSuchAddCerPersonnelSecondException if a add cer personnel second with the primary key could not be found
	 */
	public static AddCerPersonnelSecond remove(long addCerPersonnelSecondId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddCerPersonnelSecondException {

		return getPersistence().remove(addCerPersonnelSecondId);
	}

	public static AddCerPersonnelSecond updateImpl(
		AddCerPersonnelSecond addCerPersonnelSecond) {

		return getPersistence().updateImpl(addCerPersonnelSecond);
	}
	 ...
	 * @throws NoSuchAddCerPersonnelSecondException if a add cer personnel second with the primary key could not be found
	 */
	public static AddCerPersonnelSecond findByPrimaryKey(
			long addCerPersonnelSecondId)
		throws com.nbp.janaac.application.form.service.exception.
			NoSuchAddCerPersonnelSecondException {

		return getPersistence().findByPrimaryKey(addCerPersonnelSecondId);
	}
	 ...
	 */
	public static AddCerPersonnelSecond fetchByPrimaryKey(
		long addCerPersonnelSecondId) {

		return getPersistence().fetchByPrimaryKey(addCerPersonnelSecondId);
	}
	 ...
	 */
	public static List<AddCerPersonnelSecond> findAll() {
	 ...
	 */
	public static List<AddCerPersonnelSecond> findAll(int start, int end) {
	...
	public static AddCerPersonnelSecondPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AddCerPersonnelSecondPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AddCerPersonnelSecondPersistence _persistence;
