...
import com.nbp.janaac.application.form.service.service.AccMediLabPhysicalResourceLocalService;
...
/**
 * Provides the base implementation for the acc medi lab physical resource local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabPhysicalResourceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabPhysicalResourceLocalServiceImpl
 * @generated
 */
public abstract class AccMediLabPhysicalResourceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccMediLabPhysicalResourceLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabPhysicalResourceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabPhysicalResourceLocalServiceUtil</code>.
	 */
	...
	public AccMediLabPhysicalResource addAccMediLabPhysicalResource(
		...
		return accMediLabPhysicalResourcePersistence.update(
	...
	public AccMediLabPhysicalResource createAccMediLabPhysicalResource(
		...
		return accMediLabPhysicalResourcePersistence.create(
	...
	public AccMediLabPhysicalResource deleteAccMediLabPhysicalResource(
		...
		return accMediLabPhysicalResourcePersistence.remove(
			accMediLabPhysicalResourceId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accMediLabPhysicalResourcePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccMediLabPhysicalResource.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accMediLabPhysicalResourcePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accMediLabPhysicalResourcePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AccMediLabPhysicalResource fetchAccMediLabPhysicalResource(
		...
		return accMediLabPhysicalResourcePersistence.fetchByPrimaryKey(
			accMediLabPhysicalResourceId);
	}
	...
	public AccMediLabPhysicalResource
		...
		return accMediLabPhysicalResourcePersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public AccMediLabPhysicalResource getAccMediLabPhysicalResource(
		...
		return accMediLabPhysicalResourcePersistence.findByPrimaryKey(
			accMediLabPhysicalResourceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccMediLabPhysicalResource.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AccMediLabPhysicalResource.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accMediLabPhysicalResource);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccMediLabPhysicalResourceLocalServiceImpl#deleteAccMediLabPhysicalResource(AccMediLabPhysicalResource) to avoid orphaned data");
		}

		return accMediLabPhysicalResourceLocalService.
			deleteAccMediLabPhysicalResource(
				(AccMediLabPhysicalResource)persistedModel);
	}

	@Override
	public BasePersistence<AccMediLabPhysicalResource> getBasePersistence() {
		return accMediLabPhysicalResourcePersistence;
	}
	...
	public List<AccMediLabPhysicalResource>
		...
		return accMediLabPhysicalResourcePersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public AccMediLabPhysicalResource
		...
		return accMediLabPhysicalResourcePersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<AccMediLabPhysicalResource> getAccMediLabPhysicalResources(
		...
		return accMediLabPhysicalResourcePersistence.findAll(start, end);
	}
	...
	public int getAccMediLabPhysicalResourcesCount() {
		return accMediLabPhysicalResourcePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabPhysicalResourceLocalService =
			(AccMediLabPhysicalResourceLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabPhysicalResourceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accMediLabPhysicalResourcePersistence.getDataSource();
	...
	protected AccMediLabPhysicalResourceLocalService
		accMediLabPhysicalResourceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabPhysicalResourceLocalServiceBaseImpl.class);
