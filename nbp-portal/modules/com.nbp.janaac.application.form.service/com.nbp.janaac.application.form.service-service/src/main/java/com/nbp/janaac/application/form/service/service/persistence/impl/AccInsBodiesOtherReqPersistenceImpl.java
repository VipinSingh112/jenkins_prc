...
import com.nbp.janaac.application.form.service.model.AccInsBodiesOtherReqTable;
import com.nbp.janaac.application.form.service.model.impl.AccInsBodiesOtherReqImpl;
import com.nbp.janaac.application.form.service.model.impl.AccInsBodiesOtherReqModelImpl;
import com.nbp.janaac.application.form.service.service.persistence.AccInsBodiesOtherReqPersistence;
import com.nbp.janaac.application.form.service.service.persistence.AccInsBodiesOtherReqUtil;
...
/**
 * The persistence implementation for the acc ins bodies other req service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccInsBodiesOtherReqPersistence.class)
public class AccInsBodiesOtherReqPersistenceImpl
	extends BasePersistenceImpl<AccInsBodiesOtherReq>
	implements AccInsBodiesOtherReqPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccInsBodiesOtherReqUtil</code> to access the acc ins bodies other req persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccInsBodiesOtherReqImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccInsBodiesOtherReq> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccInsBodiesOtherReq> findByUuid(
	...
	public List<AccInsBodiesOtherReq> findByUuid(
		...
		List<AccInsBodiesOtherReq> list = null;

		if (useFinderCache) {
			list = (List<AccInsBodiesOtherReq>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccInsBodiesOtherReq accInsBodiesOtherReq : list) {
					if (!uuid.equals(accInsBodiesOtherReq.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCINSBODIESOTHERREQ_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccInsBodiesOtherReqModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccInsBodiesOtherReq>)QueryUtil.list(
	...
	public AccInsBodiesOtherReq findByUuid_First(
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByUuid_First(
			uuid, orderByComparator);

		if (accInsBodiesOtherReq != null) {
			return accInsBodiesOtherReq;
		}
		...
		throw new NoSuchAccInsBodiesOtherReqException(sb.toString());
	}
	...
	public AccInsBodiesOtherReq fetchByUuid_First(
		...
		List<AccInsBodiesOtherReq> list = findByUuid(
	...
	public AccInsBodiesOtherReq findByUuid_Last(
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccInsBodiesOtherReq[] findByUuid_PrevAndNext(
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = findByPrimaryKey(
		...
		try {
			...
			AccInsBodiesOtherReq[] array = new AccInsBodiesOtherReqImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accInsBodiesOtherReq, uuid, orderByComparator, true);

			array[1] = accInsBodiesOtherReq;

			array[2] = getByUuid_PrevAndNext(
				session, accInsBodiesOtherReq, uuid, orderByComparator, false);
	...
	protected AccInsBodiesOtherReq getByUuid_PrevAndNext(
		Session session, AccInsBodiesOtherReq accInsBodiesOtherReq, String uuid,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator,
		boolean previous) {
		...
		List<AccInsBodiesOtherReq> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccInsBodiesOtherReq accInsBodiesOtherReq :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accInsBodiesOtherReq);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCINSBODIESOTHERREQ_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accInsBodiesOtherReq.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accInsBodiesOtherReq.uuid IS NULL OR accInsBodiesOtherReq.uuid = '')";
	...
	public AccInsBodiesOtherReq findByUUID_G(String uuid, long groupId)
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByUUID_G(
			uuid, groupId);
	...
	public AccInsBodiesOtherReq fetchByUUID_G(
		...
		if (result instanceof AccInsBodiesOtherReq) {
			AccInsBodiesOtherReq accInsBodiesOtherReq =
				(AccInsBodiesOtherReq)result;

			if (!Objects.equals(uuid, accInsBodiesOtherReq.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AccInsBodiesOtherReq accInsBodiesOtherReq = list.get(0);

					result = accInsBodiesOtherReq;

					cacheResult(accInsBodiesOtherReq);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccInsBodiesOtherReq)result;
		}
	}
	...
	public AccInsBodiesOtherReq removeByUUID_G(String uuid, long groupId)
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = findByUUID_G(uuid, groupId);

		return remove(accInsBodiesOtherReq);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accInsBodiesOtherReq.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accInsBodiesOtherReq.uuid IS NULL OR accInsBodiesOtherReq.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accInsBodiesOtherReq.groupId = ?";
	 ...
	 */
	@Override
	public List<AccInsBodiesOtherReq> findByUuid_C(
	...
	public AccInsBodiesOtherReq findByUuid_C_First(
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByUuid_C_First(
	...
	public AccInsBodiesOtherReq fetchByUuid_C_First(
		...
		List<AccInsBodiesOtherReq> list = findByUuid_C(
	...
	public AccInsBodiesOtherReq findByUuid_C_Last(
		...
		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccInsBodiesOtherReq[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accInsBodiesOtherReq, uuid, companyId,
	...
	protected AccInsBodiesOtherReq getByUuid_C_PrevAndNext(
		Session session, AccInsBodiesOtherReq accInsBodiesOtherReq, String uuid,
		long companyId,
		OrderByComparator<AccInsBodiesOtherReq> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accInsBodiesOtherReq.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccInsBodiesOtherReqPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accInsBodiesOtherReq.janaacApplicationId = ?";

	public AccInsBodiesOtherReqPersistenceImpl() {
		...
		setModelClass(AccInsBodiesOtherReq.class);

		setModelImplClass(AccInsBodiesOtherReqImpl.class);
		setModelPKClass(long.class);

		setTable(AccInsBodiesOtherReqTable.INSTANCE);
	}
	...
	public void cacheResult(AccInsBodiesOtherReq accInsBodiesOtherReq) {
		entityCache.putResult(
			AccInsBodiesOtherReqImpl.class,
			accInsBodiesOtherReq.getPrimaryKey(), accInsBodiesOtherReq);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accInsBodiesOtherReq.getUuid(),
				accInsBodiesOtherReq.getGroupId()
			},
			accInsBodiesOtherReq);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accInsBodiesOtherReq.getJanaacApplicationId()},
			accInsBodiesOtherReq);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<AccInsBodiesOtherReq> accInsBodiesOtherReqs) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accInsBodiesOtherReqs.size() >
		...
		for (AccInsBodiesOtherReq accInsBodiesOtherReq :
				accInsBodiesOtherReqs) {

			if (entityCache.getResult(
					AccInsBodiesOtherReqImpl.class,
					accInsBodiesOtherReq.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc ins bodies other reqs.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccInsBodiesOtherReqImpl.class);

		finderCache.clearCache(AccInsBodiesOtherReqImpl.class);
	}

	/**
	 * Clears the cache for the acc ins bodies other req.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccInsBodiesOtherReq accInsBodiesOtherReq) {
		entityCache.removeResult(
			AccInsBodiesOtherReqImpl.class, accInsBodiesOtherReq);
	}

	@Override
	public void clearCache(List<AccInsBodiesOtherReq> accInsBodiesOtherReqs) {
		for (AccInsBodiesOtherReq accInsBodiesOtherReq :
				accInsBodiesOtherReqs) {
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccInsBodiesOtherReqImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		AccInsBodiesOtherReqModelImpl accInsBodiesOtherReqModelImpl) {

		Object[] args = new Object[] {
			accInsBodiesOtherReqModelImpl.getUuid(),
			accInsBodiesOtherReqModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accInsBodiesOtherReqModelImpl);

		args = new Object[] {
			accInsBodiesOtherReqModelImpl.getJanaacApplicationId()
		};
	...
	public AccInsBodiesOtherReq create(long accInsBodiesOtherReqId) {
		...
		accInsBodiesOtherReq.setNew(true);
		accInsBodiesOtherReq.setPrimaryKey(accInsBodiesOtherReqId);

		String uuid = PortalUUIDUtil.generate();

		accInsBodiesOtherReq.setUuid(uuid);

		accInsBodiesOtherReq.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public AccInsBodiesOtherReq remove(long accInsBodiesOtherReqId)
		...
		return remove((Serializable)accInsBodiesOtherReqId);
	}

	/**
	 * Removes the acc ins bodies other req with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc ins bodies other req
	 * @return the acc ins bodies other req that was removed
	 * @throws NoSuchAccInsBodiesOtherReqException if a acc ins bodies other req with the primary key could not be found
	 */
	@Override
	public AccInsBodiesOtherReq remove(Serializable primaryKey)
		throws NoSuchAccInsBodiesOtherReqException {
		...
		try {
			...
			AccInsBodiesOtherReq accInsBodiesOtherReq =
				(AccInsBodiesOtherReq)session.get(
					AccInsBodiesOtherReqImpl.class, primaryKey);
			...
			if (accInsBodiesOtherReq == null) {
				...
				throw new NoSuchAccInsBodiesOtherReqException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accInsBodiesOtherReq);
		}
		catch (NoSuchAccInsBodiesOtherReqException noSuchEntityException) {
	...
	@Override
	protected AccInsBodiesOtherReq removeImpl(
		AccInsBodiesOtherReq accInsBodiesOtherReq) {
		...
		try {
			...
			if (!session.contains(accInsBodiesOtherReq)) {
				accInsBodiesOtherReq = (AccInsBodiesOtherReq)session.get(
					AccInsBodiesOtherReqImpl.class,
					accInsBodiesOtherReq.getPrimaryKeyObj());
			}

			if (accInsBodiesOtherReq != null) {
				session.delete(accInsBodiesOtherReq);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accInsBodiesOtherReq != null) {
			clearCache(accInsBodiesOtherReq);
		}
	...
	public AccInsBodiesOtherReq updateImpl(
		...
		boolean isNew = accInsBodiesOtherReq.isNew();

		if (!(accInsBodiesOtherReq instanceof AccInsBodiesOtherReqModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accInsBodiesOtherReq.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accInsBodiesOtherReq);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accInsBodiesOtherReq proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccInsBodiesOtherReq implementation " +
					accInsBodiesOtherReq.getClass());
		}

		AccInsBodiesOtherReqModelImpl accInsBodiesOtherReqModelImpl =
			(AccInsBodiesOtherReqModelImpl)accInsBodiesOtherReq;

		if (Validator.isNull(accInsBodiesOtherReq.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accInsBodiesOtherReq.getCreateDate() == null)) {
			if (serviceContext == null) {
				accInsBodiesOtherReq.setCreateDate(date);
			}
			else {
		...
		if (!accInsBodiesOtherReqModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accInsBodiesOtherReq.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accInsBodiesOtherReq);
			}
			else {
				accInsBodiesOtherReq = (AccInsBodiesOtherReq)session.merge(
					accInsBodiesOtherReq);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccInsBodiesOtherReqImpl.class, accInsBodiesOtherReqModelImpl,
			false, true);

		cacheUniqueFindersCache(accInsBodiesOtherReqModelImpl);

		if (isNew) {
			accInsBodiesOtherReq.setNew(false);
		}

		accInsBodiesOtherReq.resetOriginalValues();

		return accInsBodiesOtherReq;
	}

	/**
	 * Returns the acc ins bodies other req with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc ins bodies other req
	 ...
	 */
	@Override
	public AccInsBodiesOtherReq findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccInsBodiesOtherReqException {

		AccInsBodiesOtherReq accInsBodiesOtherReq = fetchByPrimaryKey(
			primaryKey);
	...
	public AccInsBodiesOtherReq findByPrimaryKey(long accInsBodiesOtherReqId)
		...
		return findByPrimaryKey((Serializable)accInsBodiesOtherReqId);
	}
	...
	public AccInsBodiesOtherReq fetchByPrimaryKey(long accInsBodiesOtherReqId) {
		return fetchByPrimaryKey((Serializable)accInsBodiesOtherReqId);
	}
	 ...
	 */
	@Override
	public List<AccInsBodiesOtherReq> findAll() {
	 ...
	 */
	@Override
	public List<AccInsBodiesOtherReq> findAll(int start, int end) {
	...
	public List<AccInsBodiesOtherReq> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCINSBODIESOTHERREQ);
				...
				sql = _SQL_SELECT_ACCINSBODIESOTHERREQ;

				sql = sql.concat(AccInsBodiesOtherReqModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccInsBodiesOtherReq accInsBodiesOtherReq : findAll()) {
			remove(accInsBodiesOtherReq);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCINSBODIESOTHERREQ);
	...
	protected String getPKDBName() {
		return "accInsBodiesOtherReqId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCINSBODIESOTHERREQ;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccInsBodiesOtherReqModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc ins bodies other req persistence.
	 */
	@Activate
	public void activate() {
		...
		AccInsBodiesOtherReqUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccInsBodiesOtherReqUtil.setPersistence(null);

		entityCache.removeCache(AccInsBodiesOtherReqImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCINSBODIESOTHERREQ =
		"SELECT accInsBodiesOtherReq FROM AccInsBodiesOtherReq accInsBodiesOtherReq";

	private static final String _SQL_SELECT_ACCINSBODIESOTHERREQ_WHERE =
		"SELECT accInsBodiesOtherReq FROM AccInsBodiesOtherReq accInsBodiesOtherReq WHERE ";

	private static final String _SQL_COUNT_ACCINSBODIESOTHERREQ =
		"SELECT COUNT(accInsBodiesOtherReq) FROM AccInsBodiesOtherReq accInsBodiesOtherReq";

	private static final String _SQL_COUNT_ACCINSBODIESOTHERREQ_WHERE =
		"SELECT COUNT(accInsBodiesOtherReq) FROM AccInsBodiesOtherReq accInsBodiesOtherReq WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accInsBodiesOtherReq.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccInsBodiesOtherReq exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccInsBodiesOtherReq exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesOtherReqPersistenceImpl.class);
