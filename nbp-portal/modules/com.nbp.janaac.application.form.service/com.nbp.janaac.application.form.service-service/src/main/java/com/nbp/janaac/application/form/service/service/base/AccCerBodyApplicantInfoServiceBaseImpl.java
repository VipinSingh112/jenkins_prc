...
import com.nbp.janaac.application.form.service.service.AccCerBodyApplicantInfoService;
...
/**
 * Provides the base implementation for the acc cer body applicant info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyApplicantInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyApplicantInfoServiceImpl
 * @generated
 */
public abstract class AccCerBodyApplicantInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyApplicantInfoService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyApplicantInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyApplicantInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyApplicantInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyApplicantInfoService =
			(AccCerBodyApplicantInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyApplicantInfoService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AccCerBodyApplicantInfoLocalService accCerBodyApplicantInfoLocalService;

	protected AccCerBodyApplicantInfoService accCerBodyApplicantInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyApplicantInfoServiceBaseImpl.class);
