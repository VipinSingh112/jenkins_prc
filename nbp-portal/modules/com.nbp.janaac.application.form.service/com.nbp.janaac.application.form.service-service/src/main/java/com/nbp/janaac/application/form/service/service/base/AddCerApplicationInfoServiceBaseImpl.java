...
import com.nbp.janaac.application.form.service.service.AddCerApplicationInfoService;
...
/**
 * Provides the base implementation for the add cer application info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoServiceImpl
 * @generated
 */
public abstract class AddCerApplicationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerApplicationInfoService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerApplicationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerApplicationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerApplicationInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerApplicationInfoService = (AddCerApplicationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerApplicationInfoService.class.getName();
	}
	...
	protected AddCerApplicationInfoService addCerApplicationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerApplicationInfoServiceBaseImpl.class);
