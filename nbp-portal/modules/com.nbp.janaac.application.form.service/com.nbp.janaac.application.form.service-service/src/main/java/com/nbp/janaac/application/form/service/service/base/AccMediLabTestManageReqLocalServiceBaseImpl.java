...
import com.nbp.janaac.application.form.service.service.AccMediLabTestManageReqLocalService;
...
/**
 * Provides the base implementation for the acc medi lab test manage req local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestManageReqLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestManageReqLocalServiceImpl
 * @generated
 */
public abstract class AccMediLabTestManageReqLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccMediLabTestManageReqLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestManageReqLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestManageReqLocalServiceUtil</code>.
	 */
	...
	@Override
	public AccMediLabTestManageReq addAccMediLabTestManageReq(
		AccMediLabTestManageReq accMediLabTestManageReq) {

		accMediLabTestManageReq.setNew(true);

		return accMediLabTestManageReqPersistence.update(
	...
	public AccMediLabTestManageReq createAccMediLabTestManageReq(
		long accMediLabTestManageReqId) {

		return accMediLabTestManageReqPersistence.create(
	...
	@Override
	public AccMediLabTestManageReq deleteAccMediLabTestManageReq(
			long accMediLabTestManageReqId)
		throws PortalException {

		return accMediLabTestManageReqPersistence.remove(
			accMediLabTestManageReqId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accMediLabTestManageReqPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccMediLabTestManageReq.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accMediLabTestManageReqPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accMediLabTestManageReqPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AccMediLabTestManageReq fetchAccMediLabTestManageReq(
		long accMediLabTestManageReqId) {

		return accMediLabTestManageReqPersistence.fetchByPrimaryKey(
			accMediLabTestManageReqId);
	}
	 ...
	 */
	@Override
	public AccMediLabTestManageReq fetchAccMediLabTestManageReqByUuidAndGroupId(
		String uuid, long groupId) {

		return accMediLabTestManageReqPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public AccMediLabTestManageReq getAccMediLabTestManageReq(
			long accMediLabTestManageReqId)
		throws PortalException {

		return accMediLabTestManageReqPersistence.findByPrimaryKey(
			accMediLabTestManageReqId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccMediLabTestManageReq.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accMediLabTestManageReq);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					AccMediLabTestManageReq.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccMediLabTestManageReqLocalServiceImpl#deleteAccMediLabTestManageReq(AccMediLabTestManageReq) to avoid orphaned data");
		}

		return accMediLabTestManageReqLocalService.
			deleteAccMediLabTestManageReq(
				(AccMediLabTestManageReq)persistedModel);
	}

	@Override
	public BasePersistence<AccMediLabTestManageReq> getBasePersistence() {
		return accMediLabTestManageReqPersistence;
	}
	 ...
	 */
	@Override
	public List<AccMediLabTestManageReq>
		getAccMediLabTestManageReqsByUuidAndCompanyId(
			String uuid, long companyId) {

		return accMediLabTestManageReqPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccMediLabTestManageReq>
		...
		return accMediLabTestManageReqPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public AccMediLabTestManageReq getAccMediLabTestManageReqByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return accMediLabTestManageReqPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<AccMediLabTestManageReq> getAccMediLabTestManageReqs(
		int start, int end) {

		return accMediLabTestManageReqPersistence.findAll(start, end);
	}
	...
	public int getAccMediLabTestManageReqsCount() {
		return accMediLabTestManageReqPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccMediLabTestManageReq updateAccMediLabTestManageReq(
		AccMediLabTestManageReq accMediLabTestManageReq) {
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabTestManageReqLocalService =
			(AccMediLabTestManageReqLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestManageReqLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accMediLabTestManageReqPersistence.getDataSource();
	...
	protected AccMediLabTestManageReqLocalService
		accMediLabTestManageReqLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestManageReqLocalServiceBaseImpl.class);
