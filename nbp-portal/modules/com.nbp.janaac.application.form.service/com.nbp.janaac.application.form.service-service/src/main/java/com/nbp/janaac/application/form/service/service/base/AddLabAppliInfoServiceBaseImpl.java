...
import com.nbp.janaac.application.form.service.service.AddLabAppliInfoService;
...
/**
 * Provides the base implementation for the add lab appli info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabAppliInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabAppliInfoServiceImpl
 * @generated
 */
public abstract class AddLabAppliInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabAppliInfoService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabAppliInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabAppliInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabAppliInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabAppliInfoService = (AddLabAppliInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabAppliInfoService.class.getName();
	}
	...
	protected AddLabAppliInfoService addLabAppliInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabAppliInfoServiceBaseImpl.class);
