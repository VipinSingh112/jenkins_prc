...
import com.nbp.janaac.application.form.service.service.AccCerBodyScopeService;
...
/**
 * Provides the base implementation for the acc cer body scope remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyScopeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyScopeServiceImpl
 * @generated
 */
public abstract class AccCerBodyScopeServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyScopeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyScopeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyScopeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyScopeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyScopeService = (AccCerBodyScopeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyScopeService.class.getName();
	}
	...
	protected AccCerBodyScopeService accCerBodyScopeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyScopeServiceBaseImpl.class);
