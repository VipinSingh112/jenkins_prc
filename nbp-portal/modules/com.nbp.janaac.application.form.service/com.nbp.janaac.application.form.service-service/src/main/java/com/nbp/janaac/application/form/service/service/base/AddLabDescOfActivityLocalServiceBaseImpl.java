...
import com.nbp.janaac.application.form.service.service.AddLabDescOfActivityLocalService;
...
/**
 * Provides the base implementation for the add lab desc of activity local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabDescOfActivityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabDescOfActivityLocalServiceImpl
 * @generated
 */
public abstract class AddLabDescOfActivityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabDescOfActivityLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabDescOfActivityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabDescOfActivityLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabDescOfActivity addAddLabDescOfActivity(
		AddLabDescOfActivity addLabDescOfActivity) {

		addLabDescOfActivity.setNew(true);

		return addLabDescOfActivityPersistence.update(addLabDescOfActivity);
	}
	...
	public AddLabDescOfActivity createAddLabDescOfActivity(
		long addLabDescOfActivityId) {

		return addLabDescOfActivityPersistence.create(addLabDescOfActivityId);
	}
	...
	@Override
	public AddLabDescOfActivity deleteAddLabDescOfActivity(
			long addLabDescOfActivityId)
		throws PortalException {

		return addLabDescOfActivityPersistence.remove(addLabDescOfActivityId);
	}
	...
	public AddLabDescOfActivity deleteAddLabDescOfActivity(
		...
		return addLabDescOfActivityPersistence.remove(addLabDescOfActivity);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabDescOfActivityPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabDescOfActivity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabDescOfActivityPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabDescOfActivityPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabDescOfActivity fetchAddLabDescOfActivity(
		long addLabDescOfActivityId) {

		return addLabDescOfActivityPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddLabDescOfActivity getAddLabDescOfActivity(
			long addLabDescOfActivityId)
		throws PortalException {

		return addLabDescOfActivityPersistence.findByPrimaryKey(
			addLabDescOfActivityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addLabDescOfActivityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddLabDescOfActivity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addLabDescOfActivityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabDescOfActivityLocalServiceImpl#deleteAddLabDescOfActivity(AddLabDescOfActivity) to avoid orphaned data");
		}

		return addLabDescOfActivityLocalService.deleteAddLabDescOfActivity(
			(AddLabDescOfActivity)persistedModel);
	}

	@Override
	public BasePersistence<AddLabDescOfActivity> getBasePersistence() {
		return addLabDescOfActivityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addLabDescOfActivityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddLabDescOfActivity> getAddLabDescOfActivities(
		int start, int end) {

		return addLabDescOfActivityPersistence.findAll(start, end);
	}
	...
	public int getAddLabDescOfActivitiesCount() {
		return addLabDescOfActivityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabDescOfActivity updateAddLabDescOfActivity(
		AddLabDescOfActivity addLabDescOfActivity) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabDescOfActivityLocalService =
			(AddLabDescOfActivityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabDescOfActivityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabDescOfActivityPersistence.getDataSource();
	...
	protected AddLabDescOfActivityLocalService addLabDescOfActivityLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabDescOfActivityLocalServiceBaseImpl.class);
