...
import com.nbp.janaac.application.form.service.service.AccInsBodiesManageSysService;
...
/**
 * Provides the base implementation for the acc ins bodies manage sys remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccInsBodiesManageSysServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccInsBodiesManageSysServiceImpl
 * @generated
 */
public abstract class AccInsBodiesManageSysServiceBaseImpl
	extends BaseServiceImpl
	implements AccInsBodiesManageSysService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccInsBodiesManageSysService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccInsBodiesManageSysServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccInsBodiesManageSysService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accInsBodiesManageSysService = (AccInsBodiesManageSysService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccInsBodiesManageSysService.class.getName();
	}
	...
	protected AccInsBodiesManageSysService accInsBodiesManageSysService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesManageSysServiceBaseImpl.class);
