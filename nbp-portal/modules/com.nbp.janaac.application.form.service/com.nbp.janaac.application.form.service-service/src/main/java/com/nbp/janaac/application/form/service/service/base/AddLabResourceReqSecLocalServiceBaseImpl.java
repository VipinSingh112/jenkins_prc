...
import com.nbp.janaac.application.form.service.service.AddLabResourceReqSecLocalService;
...
/**
 * Provides the base implementation for the add lab resource req sec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqSecLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqSecLocalServiceImpl
 * @generated
 */
public abstract class AddLabResourceReqSecLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabResourceReqSecLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabResourceReqSecLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabResourceReqSecLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabResourceReqSec addAddLabResourceReqSec(
		AddLabResourceReqSec addLabResourceReqSec) {

		addLabResourceReqSec.setNew(true);

		return addLabResourceReqSecPersistence.update(addLabResourceReqSec);
	}
	...
	public AddLabResourceReqSec createAddLabResourceReqSec(
		long addLabResourceReqSecId) {

		return addLabResourceReqSecPersistence.create(addLabResourceReqSecId);
	}
	...
	@Override
	public AddLabResourceReqSec deleteAddLabResourceReqSec(
			long addLabResourceReqSecId)
		throws PortalException {

		return addLabResourceReqSecPersistence.remove(addLabResourceReqSecId);
	}
	...
	public AddLabResourceReqSec deleteAddLabResourceReqSec(
		...
		return addLabResourceReqSecPersistence.remove(addLabResourceReqSec);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabResourceReqSecPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabResourceReqSec.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabResourceReqSecPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabResourceReqSecPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabResourceReqSec fetchAddLabResourceReqSec(
		long addLabResourceReqSecId) {

		return addLabResourceReqSecPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddLabResourceReqSec getAddLabResourceReqSec(
			long addLabResourceReqSecId)
		throws PortalException {

		return addLabResourceReqSecPersistence.findByPrimaryKey(
			addLabResourceReqSecId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addLabResourceReqSecLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddLabResourceReqSec.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addLabResourceReqSecPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabResourceReqSecLocalServiceImpl#deleteAddLabResourceReqSec(AddLabResourceReqSec) to avoid orphaned data");
		}

		return addLabResourceReqSecLocalService.deleteAddLabResourceReqSec(
			(AddLabResourceReqSec)persistedModel);
	}

	@Override
	public BasePersistence<AddLabResourceReqSec> getBasePersistence() {
		return addLabResourceReqSecPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addLabResourceReqSecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddLabResourceReqSec> getAddLabResourceReqSecs(
		int start, int end) {

		return addLabResourceReqSecPersistence.findAll(start, end);
	}
	...
	public int getAddLabResourceReqSecsCount() {
		return addLabResourceReqSecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabResourceReqSec updateAddLabResourceReqSec(
		AddLabResourceReqSec addLabResourceReqSec) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabResourceReqSecLocalService =
			(AddLabResourceReqSecLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabResourceReqSecLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabResourceReqSecPersistence.getDataSource();
	...
	protected AddLabResourceReqSecLocalService addLabResourceReqSecLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabResourceReqSecLocalServiceBaseImpl.class);
