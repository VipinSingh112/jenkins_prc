...
import com.nbp.janaac.application.form.service.service.AddLabMedicalOrganFirstService;
...
/**
 * Provides the base implementation for the add lab medical organ first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganFirstServiceImpl
 * @generated
 */
public abstract class AddLabMedicalOrganFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabMedicalOrganFirstService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalOrganFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalOrganFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabMedicalOrganFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabMedicalOrganFirstService =
			(AddLabMedicalOrganFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalOrganFirstService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AddLabMedicalOrganFirstLocalService addLabMedicalOrganFirstLocalService;

	protected AddLabMedicalOrganFirstService addLabMedicalOrganFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalOrganFirstServiceBaseImpl.class);
