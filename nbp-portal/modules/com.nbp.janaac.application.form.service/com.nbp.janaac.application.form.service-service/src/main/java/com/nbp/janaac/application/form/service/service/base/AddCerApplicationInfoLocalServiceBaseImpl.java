...
import com.nbp.janaac.application.form.service.service.AddCerApplicationInfoLocalService;
...
/**
 * Provides the base implementation for the add cer application info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerApplicationInfoLocalServiceImpl
 * @generated
 */
public abstract class AddCerApplicationInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddCerApplicationInfoLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerApplicationInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerApplicationInfoLocalServiceUtil</code>.
	 */
	...
	public AddCerApplicationInfo addAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.update(addCerApplicationInfo);
	}
	...
	public AddCerApplicationInfo createAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.create(addCerApplicationInfoId);
	}
	...
	public AddCerApplicationInfo deleteAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.remove(addCerApplicationInfoId);
	}
	...
	public AddCerApplicationInfo deleteAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.remove(addCerApplicationInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addCerApplicationInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddCerApplicationInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addCerApplicationInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addCerApplicationInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddCerApplicationInfo fetchAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.fetchByPrimaryKey(
	...
	public AddCerApplicationInfo getAddCerApplicationInfo(
		...
		return addCerApplicationInfoPersistence.findByPrimaryKey(
			addCerApplicationInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addCerApplicationInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddCerApplicationInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addCerApplicationInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddCerApplicationInfoLocalServiceImpl#deleteAddCerApplicationInfo(AddCerApplicationInfo) to avoid orphaned data");
		}

		return addCerApplicationInfoLocalService.deleteAddCerApplicationInfo(
			(AddCerApplicationInfo)persistedModel);
	}

	@Override
	public BasePersistence<AddCerApplicationInfo> getBasePersistence() {
		return addCerApplicationInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addCerApplicationInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddCerApplicationInfo> getAddCerApplicationInfos(
		...
		return addCerApplicationInfoPersistence.findAll(start, end);
	}
	...
	public int getAddCerApplicationInfosCount() {
		return addCerApplicationInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerApplicationInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addCerApplicationInfoLocalService =
			(AddCerApplicationInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerApplicationInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addCerApplicationInfoPersistence.getDataSource();
	...
	protected AddCerApplicationInfoLocalService
		addCerApplicationInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerApplicationInfoLocalServiceBaseImpl.class);
