...
import com.nbp.janaac.application.form.service.service.AddOutsourcedActivitiesService;
...
/**
 * Provides the base implementation for the add outsourced activities remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddOutsourcedActivitiesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddOutsourcedActivitiesServiceImpl
 * @generated
 */
public abstract class AddOutsourcedActivitiesServiceBaseImpl
	extends BaseServiceImpl
	implements AddOutsourcedActivitiesService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddOutsourcedActivitiesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddOutsourcedActivitiesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddOutsourcedActivitiesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addOutsourcedActivitiesService =
			(AddOutsourcedActivitiesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddOutsourcedActivitiesService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AddOutsourcedActivitiesLocalService addOutsourcedActivitiesLocalService;

	protected AddOutsourcedActivitiesService addOutsourcedActivitiesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddOutsourcedActivitiesServiceBaseImpl.class);
