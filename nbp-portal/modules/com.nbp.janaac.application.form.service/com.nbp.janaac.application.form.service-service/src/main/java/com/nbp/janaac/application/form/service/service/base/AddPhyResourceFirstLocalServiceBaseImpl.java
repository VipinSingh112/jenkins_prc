...
import com.nbp.janaac.application.form.service.service.AddPhyResourceFirstLocalService;
...
/**
 * Provides the base implementation for the add phy resource first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddPhyResourceFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddPhyResourceFirstLocalServiceImpl
 * @generated
 */
public abstract class AddPhyResourceFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddPhyResourceFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddPhyResourceFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddPhyResourceFirstLocalServiceUtil</code>.
	 */
	...
	public AddPhyResourceFirst addAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.update(addPhyResourceFirst);
	}
	...
	public AddPhyResourceFirst createAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.create(addPhyResourceFirstId);
	}
	...
	public AddPhyResourceFirst deleteAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.remove(addPhyResourceFirstId);
	}
	...
	public AddPhyResourceFirst deleteAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.remove(addPhyResourceFirst);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addPhyResourceFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddPhyResourceFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addPhyResourceFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addPhyResourceFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddPhyResourceFirst fetchAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.fetchByPrimaryKey(
	...
	public AddPhyResourceFirst getAddPhyResourceFirst(
		...
		return addPhyResourceFirstPersistence.findByPrimaryKey(
			addPhyResourceFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addPhyResourceFirstLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddPhyResourceFirst.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addPhyResourceFirstPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddPhyResourceFirstLocalServiceImpl#deleteAddPhyResourceFirst(AddPhyResourceFirst) to avoid orphaned data");
		}

		return addPhyResourceFirstLocalService.deleteAddPhyResourceFirst(
			(AddPhyResourceFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddPhyResourceFirst> getBasePersistence() {
		return addPhyResourceFirstPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addPhyResourceFirstPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddPhyResourceFirst> getAddPhyResourceFirsts(
		...
		return addPhyResourceFirstPersistence.findAll(start, end);
	}
	...
	public int getAddPhyResourceFirstsCount() {
		return addPhyResourceFirstPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		addPhyResourceFirstLocalService =
			(AddPhyResourceFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddPhyResourceFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addPhyResourceFirstPersistence.getDataSource();
	...
	protected AddPhyResourceFirstLocalService addPhyResourceFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddPhyResourceFirstLocalServiceBaseImpl.class);
