...
import com.nbp.janaac.application.form.service.service.persistence.AccMediLabTestDescriptionUtil;
...
/**
 * The persistence implementation for the acc medi lab test description service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccMediLabTestDescriptionPersistence.class)
public class AccMediLabTestDescriptionPersistenceImpl
	extends BasePersistenceImpl<AccMediLabTestDescription>
	implements AccMediLabTestDescriptionPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccMediLabTestDescriptionUtil</code> to access the acc medi lab test description persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccMediLabTestDescriptionImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccMediLabTestDescription> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccMediLabTestDescription> findByUuid(
	...
	public List<AccMediLabTestDescription> findByUuid(
		...
		List<AccMediLabTestDescription> list = null;

		if (useFinderCache) {
			list = (List<AccMediLabTestDescription>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccMediLabTestDescription accMediLabTestDescription :
						list) {

					if (!uuid.equals(accMediLabTestDescription.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCMEDILABTESTDESCRIPTION_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccMediLabTestDescriptionModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccMediLabTestDescription>)QueryUtil.list(
	...
	public AccMediLabTestDescription findByUuid_First(
		...
		AccMediLabTestDescription accMediLabTestDescription = fetchByUuid_First(
			uuid, orderByComparator);

		if (accMediLabTestDescription != null) {
		...
		throw new NoSuchAccMediLabTestDescriptionException(sb.toString());
	}
	...
	public AccMediLabTestDescription fetchByUuid_First(
		...
		List<AccMediLabTestDescription> list = findByUuid(
	...
	public AccMediLabTestDescription findByUuid_Last(
		...
		AccMediLabTestDescription accMediLabTestDescription = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccMediLabTestDescription[] findByUuid_PrevAndNext(
		...
		AccMediLabTestDescription accMediLabTestDescription = findByPrimaryKey(
		...
		try {
			...
			AccMediLabTestDescription[] array =
				new AccMediLabTestDescriptionImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accMediLabTestDescription, uuid, orderByComparator,
				true);

			array[1] = accMediLabTestDescription;
	...
	protected AccMediLabTestDescription getByUuid_PrevAndNext(
		Session session, AccMediLabTestDescription accMediLabTestDescription,
		String uuid,
		OrderByComparator<AccMediLabTestDescription> orderByComparator,
		boolean previous) {
		...
		List<AccMediLabTestDescription> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccMediLabTestDescription accMediLabTestDescription :
			...
			remove(accMediLabTestDescription);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCMEDILABTESTDESCRIPTION_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accMediLabTestDescription.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accMediLabTestDescription.uuid IS NULL OR accMediLabTestDescription.uuid = '')";
	...
	public AccMediLabTestDescription findByUUID_G(String uuid, long groupId)
		...
		AccMediLabTestDescription accMediLabTestDescription = fetchByUUID_G(
			uuid, groupId);
	...
	public AccMediLabTestDescription fetchByUUID_G(
		...
		if (result instanceof AccMediLabTestDescription) {
			AccMediLabTestDescription accMediLabTestDescription =
				(AccMediLabTestDescription)result;

			if (!Objects.equals(uuid, accMediLabTestDescription.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = accMediLabTestDescription;

					cacheResult(accMediLabTestDescription);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccMediLabTestDescription)result;
		}
	}
	...
	public AccMediLabTestDescription removeByUUID_G(String uuid, long groupId)
		...
		AccMediLabTestDescription accMediLabTestDescription = findByUUID_G(
			uuid, groupId);

		return remove(accMediLabTestDescription);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accMediLabTestDescription.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accMediLabTestDescription.uuid IS NULL OR accMediLabTestDescription.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accMediLabTestDescription.groupId = ?";
	 ...
	 */
	@Override
	public List<AccMediLabTestDescription> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AccMediLabTestDescription accMediLabTestDescription :
					...
					if (!uuid.equals(accMediLabTestDescription.getUuid()) ||
						(companyId !=
							accMediLabTestDescription.getCompanyId())) {
	...
	public AccMediLabTestDescription fetchByUuid_C_First(
		...
		List<AccMediLabTestDescription> list = findByUuid_C(
	...
	public AccMediLabTestDescription[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accMediLabTestDescription, uuid, companyId,
	...
	protected AccMediLabTestDescription getByUuid_C_PrevAndNext(
		Session session, AccMediLabTestDescription accMediLabTestDescription,
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestDescription> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accMediLabTestDescription.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccMediLabTestDescriptionPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accMediLabTestDescription.janaacApplicationId = ?";

	public AccMediLabTestDescriptionPersistenceImpl() {
		...
		setModelClass(AccMediLabTestDescription.class);

		setModelImplClass(AccMediLabTestDescriptionImpl.class);
		setModelPKClass(long.class);

		setTable(AccMediLabTestDescriptionTable.INSTANCE);
	}
	...
	public void cacheResult(
		...
		entityCache.putResult(
			AccMediLabTestDescriptionImpl.class,
			accMediLabTestDescription.getPrimaryKey(),
			accMediLabTestDescription);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accMediLabTestDescription.getUuid(),
				accMediLabTestDescription.getGroupId()
			},
			accMediLabTestDescription);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accMediLabTestDescription.getJanaacApplicationId()},
			accMediLabTestDescription);
	}
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accMediLabTestDescriptions.size() >
		...
		for (AccMediLabTestDescription accMediLabTestDescription :
				accMediLabTestDescriptions) {

			if (entityCache.getResult(
					AccMediLabTestDescriptionImpl.class,
					accMediLabTestDescription.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc medi lab test descriptions.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccMediLabTestDescriptionImpl.class);

		finderCache.clearCache(AccMediLabTestDescriptionImpl.class);
	}

	/**
	 * Clears the cache for the acc medi lab test description.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(
		...
		entityCache.removeResult(
			AccMediLabTestDescriptionImpl.class, accMediLabTestDescription);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccMediLabTestDescriptionImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			accMediLabTestDescriptionModelImpl.getUuid(),
			accMediLabTestDescriptionModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accMediLabTestDescriptionModelImpl);

		args = new Object[] {
			accMediLabTestDescriptionModelImpl.getJanaacApplicationId()
		};
		...
		finderCache.putResult(
			...
			accMediLabTestDescriptionModelImpl);
	}
	...
	public AccMediLabTestDescription create(long accMediLabTestDescriptionId) {
		...
		accMediLabTestDescription.setNew(true);
		accMediLabTestDescription.setPrimaryKey(accMediLabTestDescriptionId);

		String uuid = PortalUUIDUtil.generate();

		accMediLabTestDescription.setUuid(uuid);
	...
	public AccMediLabTestDescription remove(long accMediLabTestDescriptionId)
		...
		return remove((Serializable)accMediLabTestDescriptionId);
	}

	/**
	 * Removes the acc medi lab test description with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc medi lab test description
	 * @return the acc medi lab test description that was removed
	 * @throws NoSuchAccMediLabTestDescriptionException if a acc medi lab test description with the primary key could not be found
	 */
	@Override
	public AccMediLabTestDescription remove(Serializable primaryKey)
		throws NoSuchAccMediLabTestDescriptionException {
		...
		try {
			...
			AccMediLabTestDescription accMediLabTestDescription =
				(AccMediLabTestDescription)session.get(
					AccMediLabTestDescriptionImpl.class, primaryKey);
			...
			if (accMediLabTestDescription == null) {
				...
				throw new NoSuchAccMediLabTestDescriptionException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accMediLabTestDescription);
		}
		catch (NoSuchAccMediLabTestDescriptionException noSuchEntityException) {
	...
	@Override
	protected AccMediLabTestDescription removeImpl(
		AccMediLabTestDescription accMediLabTestDescription) {
		...
		try {
			...
			if (!session.contains(accMediLabTestDescription)) {
				accMediLabTestDescription =
					(AccMediLabTestDescription)session.get(
						AccMediLabTestDescriptionImpl.class,
						accMediLabTestDescription.getPrimaryKeyObj());
			}

			if (accMediLabTestDescription != null) {
				session.delete(accMediLabTestDescription);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accMediLabTestDescription != null) {
			clearCache(accMediLabTestDescription);
		}
	...
	public AccMediLabTestDescription updateImpl(
		...
		boolean isNew = accMediLabTestDescription.isNew();

		if (!(accMediLabTestDescription instanceof
				AccMediLabTestDescriptionModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accMediLabTestDescription.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accMediLabTestDescription);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accMediLabTestDescription proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccMediLabTestDescription implementation " +
					accMediLabTestDescription.getClass());
		}

		AccMediLabTestDescriptionModelImpl accMediLabTestDescriptionModelImpl =
			(AccMediLabTestDescriptionModelImpl)accMediLabTestDescription;

		if (Validator.isNull(accMediLabTestDescription.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accMediLabTestDescription.getCreateDate() == null)) {
			if (serviceContext == null) {
				accMediLabTestDescription.setCreateDate(date);
			}
			else {
		...
		if (!accMediLabTestDescriptionModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accMediLabTestDescription.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accMediLabTestDescription);
			}
			else {
				accMediLabTestDescription =
					(AccMediLabTestDescription)session.merge(
						accMediLabTestDescription);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccMediLabTestDescriptionImpl.class,
			accMediLabTestDescriptionModelImpl, false, true);

		cacheUniqueFindersCache(accMediLabTestDescriptionModelImpl);

		if (isNew) {
			accMediLabTestDescription.setNew(false);
		}

		accMediLabTestDescription.resetOriginalValues();

		return accMediLabTestDescription;
	}

	/**
	 * Returns the acc medi lab test description with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc medi lab test description
	 ...
	 */
	@Override
	public AccMediLabTestDescription findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccMediLabTestDescriptionException {

		AccMediLabTestDescription accMediLabTestDescription = fetchByPrimaryKey(
			primaryKey);
	...
	public AccMediLabTestDescription findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)accMediLabTestDescriptionId);
	}
	...
	public AccMediLabTestDescription fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)accMediLabTestDescriptionId);
	}
	 ...
	 */
	@Override
	public List<AccMediLabTestDescription> findAll() {
	 ...
	 */
	@Override
	public List<AccMediLabTestDescription> findAll(int start, int end) {
	...
	public List<AccMediLabTestDescription> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCMEDILABTESTDESCRIPTION);
				...
				sql = _SQL_SELECT_ACCMEDILABTESTDESCRIPTION;

				sql = sql.concat(
					AccMediLabTestDescriptionModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccMediLabTestDescription accMediLabTestDescription : findAll()) {
			remove(accMediLabTestDescription);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCMEDILABTESTDESCRIPTION);
	...
	protected String getPKDBName() {
		return "accMediLabTestDescriptionId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCMEDILABTESTDESCRIPTION;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccMediLabTestDescriptionModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc medi lab test description persistence.
	 */
	@Activate
	public void activate() {
		...
		AccMediLabTestDescriptionUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccMediLabTestDescriptionUtil.setPersistence(null);

		entityCache.removeCache(AccMediLabTestDescriptionImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCMEDILABTESTDESCRIPTION =
		"SELECT accMediLabTestDescription FROM AccMediLabTestDescription accMediLabTestDescription";

	private static final String _SQL_SELECT_ACCMEDILABTESTDESCRIPTION_WHERE =
		"SELECT accMediLabTestDescription FROM AccMediLabTestDescription accMediLabTestDescription WHERE ";

	private static final String _SQL_COUNT_ACCMEDILABTESTDESCRIPTION =
		"SELECT COUNT(accMediLabTestDescription) FROM AccMediLabTestDescription accMediLabTestDescription";

	private static final String _SQL_COUNT_ACCMEDILABTESTDESCRIPTION_WHERE =
		"SELECT COUNT(accMediLabTestDescription) FROM AccMediLabTestDescription accMediLabTestDescription WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accMediLabTestDescription.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccMediLabTestDescription exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccMediLabTestDescription exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestDescriptionPersistenceImpl.class);
