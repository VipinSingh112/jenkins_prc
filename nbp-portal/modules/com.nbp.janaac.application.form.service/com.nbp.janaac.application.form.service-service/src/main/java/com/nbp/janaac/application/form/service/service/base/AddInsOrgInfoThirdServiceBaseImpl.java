...
import com.nbp.janaac.application.form.service.service.AddInsOrgInfoThirdService;
...
/**
 * Provides the base implementation for the add ins org info third remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoThirdServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoThirdServiceImpl
 * @generated
 */
public abstract class AddInsOrgInfoThirdServiceBaseImpl
	extends BaseServiceImpl
	implements AddInsOrgInfoThirdService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsOrgInfoThirdService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsOrgInfoThirdServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsOrgInfoThirdService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addInsOrgInfoThirdService = (AddInsOrgInfoThirdService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsOrgInfoThirdService.class.getName();
	}
	...
	protected AddInsOrgInfoThirdService addInsOrgInfoThirdService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsOrgInfoThirdServiceBaseImpl.class);
