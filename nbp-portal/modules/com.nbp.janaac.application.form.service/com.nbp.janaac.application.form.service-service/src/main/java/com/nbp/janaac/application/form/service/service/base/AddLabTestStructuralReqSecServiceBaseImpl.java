...
import com.nbp.janaac.application.form.service.service.AddLabTestStructuralReqSecService;
...
/**
 * Provides the base implementation for the add lab test structural req sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabTestStructuralReqSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabTestStructuralReqSecServiceImpl
 * @generated
 */
public abstract class AddLabTestStructuralReqSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabTestStructuralReqSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabTestStructuralReqSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabTestStructuralReqSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		addLabTestStructuralReqSecService =
			(AddLabTestStructuralReqSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabTestStructuralReqSecService.class.getName();
	}
	...
	protected AddLabTestStructuralReqSecService
		addLabTestStructuralReqSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabTestStructuralReqSecServiceBaseImpl.class);
