...
import com.nbp.janaac.application.form.service.service.AccMediLabActivitiesDescLocalService;
...
/**
 * Provides the base implementation for the acc medi lab activities desc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabActivitiesDescLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabActivitiesDescLocalServiceImpl
 * @generated
 */
public abstract class AccMediLabActivitiesDescLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccMediLabActivitiesDescLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabActivitiesDescLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabActivitiesDescLocalServiceUtil</code>.
	 */
	...
	@Override
	public AccMediLabActivitiesDesc addAccMediLabActivitiesDesc(
		AccMediLabActivitiesDesc accMediLabActivitiesDesc) {

		accMediLabActivitiesDesc.setNew(true);

		return accMediLabActivitiesDescPersistence.update(
	...
	public AccMediLabActivitiesDesc createAccMediLabActivitiesDesc(
		long accMediLabActivitiesDescId) {

		return accMediLabActivitiesDescPersistence.create(
	...
	@Override
	public AccMediLabActivitiesDesc deleteAccMediLabActivitiesDesc(
			long accMediLabActivitiesDescId)
		throws PortalException {

		return accMediLabActivitiesDescPersistence.remove(
			accMediLabActivitiesDescId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accMediLabActivitiesDescPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccMediLabActivitiesDesc.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accMediLabActivitiesDescPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accMediLabActivitiesDescPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AccMediLabActivitiesDesc fetchAccMediLabActivitiesDesc(
		long accMediLabActivitiesDescId) {

		return accMediLabActivitiesDescPersistence.fetchByPrimaryKey(
			accMediLabActivitiesDescId);
	}
	 ...
	 */
	@Override
	public AccMediLabActivitiesDesc
		fetchAccMediLabActivitiesDescByUuidAndGroupId(
			String uuid, long groupId) {

		return accMediLabActivitiesDescPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public AccMediLabActivitiesDesc getAccMediLabActivitiesDesc(
			long accMediLabActivitiesDescId)
		throws PortalException {

		return accMediLabActivitiesDescPersistence.findByPrimaryKey(
			accMediLabActivitiesDescId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccMediLabActivitiesDesc.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AccMediLabActivitiesDesc.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accMediLabActivitiesDesc);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccMediLabActivitiesDescLocalServiceImpl#deleteAccMediLabActivitiesDesc(AccMediLabActivitiesDesc) to avoid orphaned data");
		}

		return accMediLabActivitiesDescLocalService.
			deleteAccMediLabActivitiesDesc(
				(AccMediLabActivitiesDesc)persistedModel);
	}

	@Override
	public BasePersistence<AccMediLabActivitiesDesc> getBasePersistence() {
		return accMediLabActivitiesDescPersistence;
	}
	 ...
	 */
	@Override
	public List<AccMediLabActivitiesDesc>
		getAccMediLabActivitiesDescsByUuidAndCompanyId(
			String uuid, long companyId) {

		return accMediLabActivitiesDescPersistence.findByUuid_C(
			uuid, companyId);
	}
	 ...
	 */
	@Override
	public AccMediLabActivitiesDesc getAccMediLabActivitiesDescByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return accMediLabActivitiesDescPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<AccMediLabActivitiesDesc> getAccMediLabActivitiesDescs(
		int start, int end) {

		return accMediLabActivitiesDescPersistence.findAll(start, end);
	}
	...
	public int getAccMediLabActivitiesDescsCount() {
		return accMediLabActivitiesDescPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccMediLabActivitiesDesc updateAccMediLabActivitiesDesc(
		AccMediLabActivitiesDesc accMediLabActivitiesDesc) {
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabActivitiesDescLocalService =
			(AccMediLabActivitiesDescLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabActivitiesDescLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accMediLabActivitiesDescPersistence.getDataSource();
	...
	protected AccMediLabActivitiesDescLocalService
		accMediLabActivitiesDescLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabActivitiesDescLocalServiceBaseImpl.class);
