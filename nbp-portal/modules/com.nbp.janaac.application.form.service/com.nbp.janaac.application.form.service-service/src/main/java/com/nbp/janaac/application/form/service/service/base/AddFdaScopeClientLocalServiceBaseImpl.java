...
import com.nbp.janaac.application.form.service.service.AddFdaScopeClientLocalService;
...
/**
 * Provides the base implementation for the add fda scope client local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaScopeClientLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaScopeClientLocalServiceImpl
 * @generated
 */
public abstract class AddFdaScopeClientLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddFdaScopeClientLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaScopeClientLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaScopeClientLocalServiceUtil</code>.
	 */
	...
	public AddFdaScopeClient addAddFdaScopeClient(
		...
		return addFdaScopeClientPersistence.update(addFdaScopeClient);
	}
	...
	public AddFdaScopeClient createAddFdaScopeClient(long addFdaScopeClientId) {
		return addFdaScopeClientPersistence.create(addFdaScopeClientId);
	}
	...
	public AddFdaScopeClient deleteAddFdaScopeClient(long addFdaScopeClientId)
		...
		return addFdaScopeClientPersistence.remove(addFdaScopeClientId);
	}
	...
	public AddFdaScopeClient deleteAddFdaScopeClient(
		...
		return addFdaScopeClientPersistence.remove(addFdaScopeClient);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addFdaScopeClientPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddFdaScopeClient.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addFdaScopeClientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addFdaScopeClientPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addFdaScopeClientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return addFdaScopeClientPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AddFdaScopeClient fetchAddFdaScopeClient(long addFdaScopeClientId) {
		return addFdaScopeClientPersistence.fetchByPrimaryKey(
			addFdaScopeClientId);
	}
	...
	public AddFdaScopeClient getAddFdaScopeClient(long addFdaScopeClientId)
		...
		return addFdaScopeClientPersistence.findByPrimaryKey(
			addFdaScopeClientId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addFdaScopeClientLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddFdaScopeClient.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("addFdaScopeClientId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddFdaScopeClient.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaScopeClientPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddFdaScopeClientLocalServiceImpl#deleteAddFdaScopeClient(AddFdaScopeClient) to avoid orphaned data");
		}

		return addFdaScopeClientLocalService.deleteAddFdaScopeClient(
			(AddFdaScopeClient)persistedModel);
	}

	@Override
	public BasePersistence<AddFdaScopeClient> getBasePersistence() {
		return addFdaScopeClientPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaScopeClientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddFdaScopeClient> getAddFdaScopeClients(int start, int end) {
		return addFdaScopeClientPersistence.findAll(start, end);
	}
	...
	public int getAddFdaScopeClientsCount() {
		return addFdaScopeClientPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaScopeClientLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addFdaScopeClientLocalService = (AddFdaScopeClientLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaScopeClientLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addFdaScopeClientPersistence.getDataSource();
	...
	protected AddFdaScopeClientLocalService addFdaScopeClientLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaScopeClientLocalServiceBaseImpl.class);
