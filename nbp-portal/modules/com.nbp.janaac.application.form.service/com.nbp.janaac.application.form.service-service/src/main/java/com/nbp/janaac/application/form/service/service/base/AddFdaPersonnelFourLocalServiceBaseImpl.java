...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelFourLocalService;
...
/**
 * Provides the base implementation for the add fda personnel four local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFourLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFourLocalServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelFourLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddFdaPersonnelFourLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelFourLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelFourLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddFdaPersonnelFour addAddFdaPersonnelFour(
		AddFdaPersonnelFour addFdaPersonnelFour) {

		addFdaPersonnelFour.setNew(true);

		return addFdaPersonnelFourPersistence.update(addFdaPersonnelFour);
	}
	...
	public AddFdaPersonnelFour createAddFdaPersonnelFour(
		long addFdaPersonnelFourId) {

		return addFdaPersonnelFourPersistence.create(addFdaPersonnelFourId);
	}
	...
	@Override
	public AddFdaPersonnelFour deleteAddFdaPersonnelFour(
			long addFdaPersonnelFourId)
		throws PortalException {

		return addFdaPersonnelFourPersistence.remove(addFdaPersonnelFourId);
	}
	...
	public AddFdaPersonnelFour deleteAddFdaPersonnelFour(
		...
		return addFdaPersonnelFourPersistence.remove(addFdaPersonnelFour);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addFdaPersonnelFourPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddFdaPersonnelFour.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addFdaPersonnelFourPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addFdaPersonnelFourPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddFdaPersonnelFour fetchAddFdaPersonnelFour(
		long addFdaPersonnelFourId) {

		return addFdaPersonnelFourPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddFdaPersonnelFour getAddFdaPersonnelFour(
			long addFdaPersonnelFourId)
		throws PortalException {

		return addFdaPersonnelFourPersistence.findByPrimaryKey(
			addFdaPersonnelFourId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addFdaPersonnelFourLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddFdaPersonnelFour.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaPersonnelFourPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddFdaPersonnelFourLocalServiceImpl#deleteAddFdaPersonnelFour(AddFdaPersonnelFour) to avoid orphaned data");
		}

		return addFdaPersonnelFourLocalService.deleteAddFdaPersonnelFour(
			(AddFdaPersonnelFour)persistedModel);
	}

	@Override
	public BasePersistence<AddFdaPersonnelFour> getBasePersistence() {
		return addFdaPersonnelFourPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaPersonnelFourPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddFdaPersonnelFour> getAddFdaPersonnelFours(
		int start, int end) {

		return addFdaPersonnelFourPersistence.findAll(start, end);
	}
	...
	public int getAddFdaPersonnelFoursCount() {
		return addFdaPersonnelFourPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddFdaPersonnelFour updateAddFdaPersonnelFour(
		AddFdaPersonnelFour addFdaPersonnelFour) {
	...
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelFourLocalService =
			(AddFdaPersonnelFourLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelFourLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addFdaPersonnelFourPersistence.getDataSource();
	...
	protected AddFdaPersonnelFourLocalService addFdaPersonnelFourLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelFourLocalServiceBaseImpl.class);
