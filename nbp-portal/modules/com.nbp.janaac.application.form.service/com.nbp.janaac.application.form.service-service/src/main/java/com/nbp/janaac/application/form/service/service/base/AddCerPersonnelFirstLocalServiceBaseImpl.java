...
import com.nbp.janaac.application.form.service.service.AddCerPersonnelFirstLocalService;
...
/**
 * Provides the base implementation for the add cer personnel first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelFirstLocalServiceImpl
 * @generated
 */
public abstract class AddCerPersonnelFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddCerPersonnelFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerPersonnelFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerPersonnelFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddCerPersonnelFirst addAddCerPersonnelFirst(
		AddCerPersonnelFirst addCerPersonnelFirst) {

		addCerPersonnelFirst.setNew(true);

		return addCerPersonnelFirstPersistence.update(addCerPersonnelFirst);
	}
	...
	public AddCerPersonnelFirst createAddCerPersonnelFirst(
		long addCerPersonnelFirstId) {

		return addCerPersonnelFirstPersistence.create(addCerPersonnelFirstId);
	}
	...
	@Override
	public AddCerPersonnelFirst deleteAddCerPersonnelFirst(
			long addCerPersonnelFirstId)
		throws PortalException {

		return addCerPersonnelFirstPersistence.remove(addCerPersonnelFirstId);
	}
	...
	public AddCerPersonnelFirst deleteAddCerPersonnelFirst(
		...
		return addCerPersonnelFirstPersistence.remove(addCerPersonnelFirst);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addCerPersonnelFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddCerPersonnelFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addCerPersonnelFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addCerPersonnelFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddCerPersonnelFirst fetchAddCerPersonnelFirst(
		long addCerPersonnelFirstId) {

		return addCerPersonnelFirstPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddCerPersonnelFirst getAddCerPersonnelFirst(
			long addCerPersonnelFirstId)
		throws PortalException {

		return addCerPersonnelFirstPersistence.findByPrimaryKey(
			addCerPersonnelFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addCerPersonnelFirstLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddCerPersonnelFirst.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addCerPersonnelFirstPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddCerPersonnelFirstLocalServiceImpl#deleteAddCerPersonnelFirst(AddCerPersonnelFirst) to avoid orphaned data");
		}

		return addCerPersonnelFirstLocalService.deleteAddCerPersonnelFirst(
			(AddCerPersonnelFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddCerPersonnelFirst> getBasePersistence() {
		return addCerPersonnelFirstPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addCerPersonnelFirstPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddCerPersonnelFirst> getAddCerPersonnelFirsts(
		int start, int end) {

		return addCerPersonnelFirstPersistence.findAll(start, end);
	}
	...
	public int getAddCerPersonnelFirstsCount() {
		return addCerPersonnelFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddCerPersonnelFirst updateAddCerPersonnelFirst(
		AddCerPersonnelFirst addCerPersonnelFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		addCerPersonnelFirstLocalService =
			(AddCerPersonnelFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerPersonnelFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addCerPersonnelFirstPersistence.getDataSource();
	...
	protected AddCerPersonnelFirstLocalService addCerPersonnelFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerPersonnelFirstLocalServiceBaseImpl.class);
