...
import com.nbp.janaac.application.form.service.service.AddCerPersonnelThirdService;
...
/**
 * Provides the base implementation for the add cer personnel third remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelThirdServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelThirdServiceImpl
 * @generated
 */
public abstract class AddCerPersonnelThirdServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerPersonnelThirdService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerPersonnelThirdService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerPersonnelThirdServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerPersonnelThirdService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerPersonnelThirdService = (AddCerPersonnelThirdService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerPersonnelThirdService.class.getName();
	}
	...
	protected AddCerPersonnelThirdService addCerPersonnelThirdService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerPersonnelThirdServiceBaseImpl.class);
