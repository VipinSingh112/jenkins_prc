...
import com.nbp.janaac.application.form.service.service.AccMediLabTestManageReqService;
...
/**
 * Provides the base implementation for the acc medi lab test manage req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestManageReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestManageReqServiceImpl
 * @generated
 */
public abstract class AccMediLabTestManageReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabTestManageReqService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestManageReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestManageReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabTestManageReqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabTestManageReqService =
			(AccMediLabTestManageReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestManageReqService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AccMediLabTestManageReqLocalService accMediLabTestManageReqLocalService;

	protected AccMediLabTestManageReqService accMediLabTestManageReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestManageReqServiceBaseImpl.class);
