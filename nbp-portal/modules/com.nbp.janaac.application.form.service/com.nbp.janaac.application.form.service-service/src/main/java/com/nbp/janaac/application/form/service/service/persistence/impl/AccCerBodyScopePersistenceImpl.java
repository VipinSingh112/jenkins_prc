...
import com.nbp.janaac.application.form.service.service.persistence.AccCerBodyScopeUtil;
...
/**
 * The persistence implementation for the acc cer body scope service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccCerBodyScopePersistence.class)
public class AccCerBodyScopePersistenceImpl
	extends BasePersistenceImpl<AccCerBodyScope>
	implements AccCerBodyScopePersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccCerBodyScopeUtil</code> to access the acc cer body scope persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccCerBodyScopeImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findByUuid(
	...
	public List<AccCerBodyScope> findByUuid(
		...
		List<AccCerBodyScope> list = null;

		if (useFinderCache) {
			list = (List<AccCerBodyScope>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccCerBodyScope accCerBodyScope : list) {
					if (!uuid.equals(accCerBodyScope.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCCERBODYSCOPE_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccCerBodyScopeModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccCerBodyScope>)QueryUtil.list(
	...
	public AccCerBodyScope findByUuid_First(
		...
		AccCerBodyScope accCerBodyScope = fetchByUuid_First(
			uuid, orderByComparator);

		if (accCerBodyScope != null) {
			return accCerBodyScope;
		}
		...
		throw new NoSuchAccCerBodyScopeException(sb.toString());
	}
	...
	public AccCerBodyScope fetchByUuid_First(
		...
		List<AccCerBodyScope> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public AccCerBodyScope findByUuid_Last(
		...
		AccCerBodyScope accCerBodyScope = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccCerBodyScope fetchByUuid_Last(
		...
		List<AccCerBodyScope> list = findByUuid(
	...
	public AccCerBodyScope[] findByUuid_PrevAndNext(
		...
		AccCerBodyScope accCerBodyScope = findByPrimaryKey(accCerBodyScopeId);
		...
		try {
			...
			AccCerBodyScope[] array = new AccCerBodyScopeImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accCerBodyScope, uuid, orderByComparator, true);

			array[1] = accCerBodyScope;

			array[2] = getByUuid_PrevAndNext(
				session, accCerBodyScope, uuid, orderByComparator, false);
	...
	protected AccCerBodyScope getByUuid_PrevAndNext(
		Session session, AccCerBodyScope accCerBodyScope, String uuid,
		OrderByComparator<AccCerBodyScope> orderByComparator,
		boolean previous) {
		...
		List<AccCerBodyScope> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccCerBodyScope accCerBodyScope :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accCerBodyScope);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCCERBODYSCOPE_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accCerBodyScope.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accCerBodyScope.uuid IS NULL OR accCerBodyScope.uuid = '')";
	...
	public AccCerBodyScope findByUUID_G(String uuid, long groupId)
		...
		AccCerBodyScope accCerBodyScope = fetchByUUID_G(uuid, groupId);
	...
	public AccCerBodyScope fetchByUUID_G(
		...
		if (result instanceof AccCerBodyScope) {
			AccCerBodyScope accCerBodyScope = (AccCerBodyScope)result;

			if (!Objects.equals(uuid, accCerBodyScope.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AccCerBodyScope accCerBodyScope = list.get(0);

					result = accCerBodyScope;

					cacheResult(accCerBodyScope);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
	...
	public AccCerBodyScope removeByUUID_G(String uuid, long groupId)
		...
		AccCerBodyScope accCerBodyScope = findByUUID_G(uuid, groupId);

		return remove(accCerBodyScope);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accCerBodyScope.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accCerBodyScope.uuid IS NULL OR accCerBodyScope.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accCerBodyScope.groupId = ?";
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findByUuid_C(
	...
	public AccCerBodyScope findByUuid_C_First(
		...
		AccCerBodyScope accCerBodyScope = fetchByUuid_C_First(
	...
	public AccCerBodyScope fetchByUuid_C_First(
		...
		List<AccCerBodyScope> list = findByUuid_C(
	...
	public AccCerBodyScope findByUuid_C_Last(
		...
		AccCerBodyScope accCerBodyScope = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccCerBodyScope[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accCerBodyScope, uuid, companyId, orderByComparator,
				true);
	...
	protected AccCerBodyScope getByUuid_C_PrevAndNext(
		Session session, AccCerBodyScope accCerBodyScope, String uuid,
		long companyId, OrderByComparator<AccCerBodyScope> orderByComparator,
		boolean previous) {
	...
	public AccCerBodyScope findBygetJANAAC_ByApplicationId(
		...
		AccCerBodyScope accCerBodyScope = fetchBygetJANAAC_ByApplicationId(
			janaacApplicationId);
	...
	public AccCerBodyScope fetchBygetJANAAC_ByApplicationId(
		...
		if (result instanceof AccCerBodyScope) {
			...
			if (janaacApplicationId !=
					accCerBodyScope.getJanaacApplicationId()) {
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccCerBodyScopePersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	public AccCerBodyScope removeBygetJANAAC_ByApplicationId(
		...
		AccCerBodyScope accCerBodyScope = findBygetJANAAC_ByApplicationId(
			janaacApplicationId);
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accCerBodyScope.janaacApplicationId = ?";

	public AccCerBodyScopePersistenceImpl() {
		...
		setModelClass(AccCerBodyScope.class);

		setModelImplClass(AccCerBodyScopeImpl.class);
		setModelPKClass(long.class);

		setTable(AccCerBodyScopeTable.INSTANCE);
	}
	...
	public void cacheResult(AccCerBodyScope accCerBodyScope) {
		entityCache.putResult(
			AccCerBodyScopeImpl.class, accCerBodyScope.getPrimaryKey(),
			accCerBodyScope);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accCerBodyScope.getUuid(), accCerBodyScope.getGroupId()
			},
			accCerBodyScope);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accCerBodyScope.getJanaacApplicationId()},
			accCerBodyScope);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<AccCerBodyScope> accCerBodyScopes) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accCerBodyScopes.size() >
				 _valueObjectFinderCacheListThreshold))) {

			return;
		}

		for (AccCerBodyScope accCerBodyScope : accCerBodyScopes) {
			if (entityCache.getResult(
					AccCerBodyScopeImpl.class,
					accCerBodyScope.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc cer body scopes.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccCerBodyScopeImpl.class);

		finderCache.clearCache(AccCerBodyScopeImpl.class);
	}

	/**
	 * Clears the cache for the acc cer body scope.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccCerBodyScope accCerBodyScope) {
		entityCache.removeResult(AccCerBodyScopeImpl.class, accCerBodyScope);
	}

	@Override
	public void clearCache(List<AccCerBodyScope> accCerBodyScopes) {
		for (AccCerBodyScope accCerBodyScope : accCerBodyScopes) {
			entityCache.removeResult(
				AccCerBodyScopeImpl.class, accCerBodyScope);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(AccCerBodyScopeImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			accCerBodyScopeModelImpl.getUuid(),
			accCerBodyScopeModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accCerBodyScopeModelImpl);

		args = new Object[] {accCerBodyScopeModelImpl.getJanaacApplicationId()};

		finderCache.putResult(
			_finderPathCountBygetJANAAC_ByApplicationId, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId, args,
			accCerBodyScopeModelImpl);
	}
	...
	public AccCerBodyScope create(long accCerBodyScopeId) {
		AccCerBodyScope accCerBodyScope = new AccCerBodyScopeImpl();

		accCerBodyScope.setNew(true);
		accCerBodyScope.setPrimaryKey(accCerBodyScopeId);

		String uuid = PortalUUIDUtil.generate();

		accCerBodyScope.setUuid(uuid);

		accCerBodyScope.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public AccCerBodyScope remove(long accCerBodyScopeId)
		...
		return remove((Serializable)accCerBodyScopeId);
	}

	/**
	 * Removes the acc cer body scope with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc cer body scope
	 * @return the acc cer body scope that was removed
	 * @throws NoSuchAccCerBodyScopeException if a acc cer body scope with the primary key could not be found
	 */
	@Override
	public AccCerBodyScope remove(Serializable primaryKey)
		throws NoSuchAccCerBodyScopeException {
		...
		try {
			...
			AccCerBodyScope accCerBodyScope = (AccCerBodyScope)session.get(
				AccCerBodyScopeImpl.class, primaryKey);
			...
			if (accCerBodyScope == null) {
				...
				throw new NoSuchAccCerBodyScopeException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accCerBodyScope);
		}
		catch (NoSuchAccCerBodyScopeException noSuchEntityException) {
	...
	@Override
	protected AccCerBodyScope removeImpl(AccCerBodyScope accCerBodyScope) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(accCerBodyScope)) {
				accCerBodyScope = (AccCerBodyScope)session.get(
					AccCerBodyScopeImpl.class,
					accCerBodyScope.getPrimaryKeyObj());
			}

			if (accCerBodyScope != null) {
				session.delete(accCerBodyScope);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
	...
	public AccCerBodyScope updateImpl(AccCerBodyScope accCerBodyScope) {
		boolean isNew = accCerBodyScope.isNew();

		if (!(accCerBodyScope instanceof AccCerBodyScopeModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accCerBodyScope.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accCerBodyScope);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accCerBodyScope proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccCerBodyScope implementation " +
					accCerBodyScope.getClass());
		}

		AccCerBodyScopeModelImpl accCerBodyScopeModelImpl =
			(AccCerBodyScopeModelImpl)accCerBodyScope;

		if (Validator.isNull(accCerBodyScope.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accCerBodyScope.getCreateDate() == null)) {
			if (serviceContext == null) {
				accCerBodyScope.setCreateDate(date);
			}
			else {
		...
		if (!accCerBodyScopeModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accCerBodyScope.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accCerBodyScope);
			}
			else {
				accCerBodyScope = (AccCerBodyScope)session.merge(
					accCerBodyScope);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccCerBodyScopeImpl.class, accCerBodyScopeModelImpl, false, true);

		cacheUniqueFindersCache(accCerBodyScopeModelImpl);

		if (isNew) {
			accCerBodyScope.setNew(false);
		}

		accCerBodyScope.resetOriginalValues();

		return accCerBodyScope;
	}

	/**
	 * Returns the acc cer body scope with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc cer body scope
	 ...
	 */
	@Override
	public AccCerBodyScope findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccCerBodyScopeException {

		AccCerBodyScope accCerBodyScope = fetchByPrimaryKey(primaryKey);
	...
	public AccCerBodyScope findByPrimaryKey(long accCerBodyScopeId)
		...
		return findByPrimaryKey((Serializable)accCerBodyScopeId);
	}
	...
	public AccCerBodyScope fetchByPrimaryKey(long accCerBodyScopeId) {
		return fetchByPrimaryKey((Serializable)accCerBodyScopeId);
	}
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findAll() {
	 ...
	 */
	@Override
	public List<AccCerBodyScope> findAll(int start, int end) {
	...
	public List<AccCerBodyScope> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCCERBODYSCOPE);
				...
				sql = _SQL_SELECT_ACCCERBODYSCOPE;

				sql = sql.concat(AccCerBodyScopeModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccCerBodyScope accCerBodyScope : findAll()) {
			remove(accCerBodyScope);
		}
	}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ACCCERBODYSCOPE);
	...
	protected String getPKDBName() {
		return "accCerBodyScopeId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCCERBODYSCOPE;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccCerBodyScopeModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc cer body scope persistence.
	 */
	@Activate
	public void activate() {
		...
		AccCerBodyScopeUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccCerBodyScopeUtil.setPersistence(null);

		entityCache.removeCache(AccCerBodyScopeImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCCERBODYSCOPE =
		"SELECT accCerBodyScope FROM AccCerBodyScope accCerBodyScope";

	private static final String _SQL_SELECT_ACCCERBODYSCOPE_WHERE =
		"SELECT accCerBodyScope FROM AccCerBodyScope accCerBodyScope WHERE ";

	private static final String _SQL_COUNT_ACCCERBODYSCOPE =
		"SELECT COUNT(accCerBodyScope) FROM AccCerBodyScope accCerBodyScope";

	private static final String _SQL_COUNT_ACCCERBODYSCOPE_WHERE =
		"SELECT COUNT(accCerBodyScope) FROM AccCerBodyScope accCerBodyScope WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "accCerBodyScope.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccCerBodyScope exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccCerBodyScope exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyScopePersistenceImpl.class);
