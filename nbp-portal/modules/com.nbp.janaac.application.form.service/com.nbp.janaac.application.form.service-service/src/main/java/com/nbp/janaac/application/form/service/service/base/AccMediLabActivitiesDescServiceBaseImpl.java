...
import com.nbp.janaac.application.form.service.service.AccMediLabActivitiesDescService;
...
/**
 * Provides the base implementation for the acc medi lab activities desc remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabActivitiesDescServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabActivitiesDescServiceImpl
 * @generated
 */
public abstract class AccMediLabActivitiesDescServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabActivitiesDescService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabActivitiesDescService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabActivitiesDescServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabActivitiesDescService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabActivitiesDescService =
			(AccMediLabActivitiesDescService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabActivitiesDescService.class.getName();
	}
	...
	protected AccMediLabActivitiesDescService accMediLabActivitiesDescService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabActivitiesDescServiceBaseImpl.class);
