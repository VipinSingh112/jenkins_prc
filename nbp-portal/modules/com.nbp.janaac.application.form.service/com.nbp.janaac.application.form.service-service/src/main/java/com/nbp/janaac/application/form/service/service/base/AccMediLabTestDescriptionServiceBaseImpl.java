...
import com.nbp.janaac.application.form.service.service.AccMediLabTestDescriptionService;
...
/**
 * Provides the base implementation for the acc medi lab test description remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestDescriptionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestDescriptionServiceImpl
 * @generated
 */
public abstract class AccMediLabTestDescriptionServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabTestDescriptionService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestDescriptionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestDescriptionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabTestDescriptionService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabTestDescriptionService =
			(AccMediLabTestDescriptionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestDescriptionService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accMediLabTestDescriptionPersistence.getDataSource();
	...
	protected AccMediLabTestDescriptionService accMediLabTestDescriptionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestDescriptionServiceBaseImpl.class);
