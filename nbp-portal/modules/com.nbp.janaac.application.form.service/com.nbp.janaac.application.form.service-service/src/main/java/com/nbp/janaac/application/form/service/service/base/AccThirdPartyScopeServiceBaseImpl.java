...
import com.nbp.janaac.application.form.service.service.AccThirdPartyScopeService;
...
/**
 * Provides the base implementation for the acc third party scope remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccThirdPartyScopeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccThirdPartyScopeServiceImpl
 * @generated
 */
public abstract class AccThirdPartyScopeServiceBaseImpl
	extends BaseServiceImpl
	implements AccThirdPartyScopeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccThirdPartyScopeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccThirdPartyScopeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccThirdPartyScopeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accThirdPartyScopeService = (AccThirdPartyScopeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccThirdPartyScopeService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accThirdPartyScopePersistence.getDataSource();
	...
	protected AccThirdPartyScopeService accThirdPartyScopeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccThirdPartyScopeServiceBaseImpl.class);
