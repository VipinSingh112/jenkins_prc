...
import com.nbp.janaac.application.form.service.service.AddLabResourceReqFirstService;
...
/**
 * Provides the base implementation for the add lab resource req first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqFirstServiceImpl
 * @generated
 */
public abstract class AddLabResourceReqFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabResourceReqFirstService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabResourceReqFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabResourceReqFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabResourceReqFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabResourceReqFirstService = (AddLabResourceReqFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabResourceReqFirstService.class.getName();
	}
	...
	protected AddLabResourceReqFirstService addLabResourceReqFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabResourceReqFirstServiceBaseImpl.class);
