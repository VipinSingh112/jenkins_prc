...
import com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalFirstService;
...
/**
 * Provides the base implementation for the add lab medical physical first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalFirstServiceImpl
 * @generated
 */
public abstract class AddLabMedicalPhysicalFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabMedicalPhysicalFirstService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalPhysicalFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabMedicalPhysicalFirstService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addLabMedicalPhysicalFirstService =
			(AddLabMedicalPhysicalFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalPhysicalFirstService.class.getName();
	}
	...
	protected AddLabMedicalPhysicalFirstService
		addLabMedicalPhysicalFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalPhysicalFirstServiceBaseImpl.class);
