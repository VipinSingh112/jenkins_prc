...
import com.nbp.janaac.application.form.service.service.AddFdaScopeClientService;
...
/**
 * Provides the base implementation for the add fda scope client remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaScopeClientServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaScopeClientServiceImpl
 * @generated
 */
public abstract class AddFdaScopeClientServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaScopeClientService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaScopeClientService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaScopeClientServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaScopeClientService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaScopeClientService = (AddFdaScopeClientService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaScopeClientService.class.getName();
	}
	...
	protected AddFdaScopeClientService addFdaScopeClientService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaScopeClientServiceBaseImpl.class);
