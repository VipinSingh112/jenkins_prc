...
import com.nbp.janaac.application.form.service.service.AddLabTestStructuralReqSecLocalService;
...
/**
 * Provides the base implementation for the add lab test structural req sec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabTestStructuralReqSecLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabTestStructuralReqSecLocalServiceImpl
 * @generated
 */
public abstract class AddLabTestStructuralReqSecLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabTestStructuralReqSecLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabTestStructuralReqSecLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabTestStructuralReqSecLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabTestStructuralReqSec addAddLabTestStructuralReqSec(
		AddLabTestStructuralReqSec addLabTestStructuralReqSec) {

		addLabTestStructuralReqSec.setNew(true);

		return addLabTestStructuralReqSecPersistence.update(
	...
	public AddLabTestStructuralReqSec createAddLabTestStructuralReqSec(
		long addLabTestStructuralReqSecId) {

		return addLabTestStructuralReqSecPersistence.create(
	...
	@Override
	public AddLabTestStructuralReqSec deleteAddLabTestStructuralReqSec(
			long addLabTestStructuralReqSecId)
		throws PortalException {

		return addLabTestStructuralReqSecPersistence.remove(
			addLabTestStructuralReqSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabTestStructuralReqSecPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabTestStructuralReqSec.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabTestStructuralReqSecPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabTestStructuralReqSecPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabTestStructuralReqSec fetchAddLabTestStructuralReqSec(
		long addLabTestStructuralReqSecId) {

		return addLabTestStructuralReqSecPersistence.fetchByPrimaryKey(
			addLabTestStructuralReqSecId);
	}
	 ...
	 */
	@Override
	public AddLabTestStructuralReqSec getAddLabTestStructuralReqSec(
			long addLabTestStructuralReqSecId)
		throws PortalException {

		return addLabTestStructuralReqSecPersistence.findByPrimaryKey(
			addLabTestStructuralReqSecId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addLabTestStructuralReqSecLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddLabTestStructuralReqSec.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AddLabTestStructuralReqSec.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabTestStructuralReqSecLocalServiceImpl#deleteAddLabTestStructuralReqSec(AddLabTestStructuralReqSec) to avoid orphaned data");
		}

		return addLabTestStructuralReqSecLocalService.
			deleteAddLabTestStructuralReqSec(
				(AddLabTestStructuralReqSec)persistedModel);
	}

	@Override
	public BasePersistence<AddLabTestStructuralReqSec> getBasePersistence() {
		return addLabTestStructuralReqSecPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabTestStructuralReqSec> getAddLabTestStructuralReqSecs(
		int start, int end) {

		return addLabTestStructuralReqSecPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAddLabTestStructuralReqSecsCount() {
		return addLabTestStructuralReqSecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabTestStructuralReqSec updateAddLabTestStructuralReqSec(
		AddLabTestStructuralReqSec addLabTestStructuralReqSec) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabTestStructuralReqSecLocalService =
			(AddLabTestStructuralReqSecLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabTestStructuralReqSecLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabTestStructuralReqSecPersistence.getDataSource();
	...
	protected AddLabTestStructuralReqSecLocalService
		addLabTestStructuralReqSecLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabTestStructuralReqSecLocalServiceBaseImpl.class);
