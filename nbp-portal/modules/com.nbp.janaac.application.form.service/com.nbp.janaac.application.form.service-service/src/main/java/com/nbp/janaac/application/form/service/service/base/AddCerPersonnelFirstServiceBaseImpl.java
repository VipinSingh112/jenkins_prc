...
import com.nbp.janaac.application.form.service.service.AddCerPersonnelFirstService;
...
/**
 * Provides the base implementation for the add cer personnel first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelFirstServiceImpl
 * @generated
 */
public abstract class AddCerPersonnelFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerPersonnelFirstService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerPersonnelFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerPersonnelFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerPersonnelFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerPersonnelFirstService = (AddCerPersonnelFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerPersonnelFirstService.class.getName();
	}
	...
	protected AddCerPersonnelFirstService addCerPersonnelFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerPersonnelFirstServiceBaseImpl.class);
