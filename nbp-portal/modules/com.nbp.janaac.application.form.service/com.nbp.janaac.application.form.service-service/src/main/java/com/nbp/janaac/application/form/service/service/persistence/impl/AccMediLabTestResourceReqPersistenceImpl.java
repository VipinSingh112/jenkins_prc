...
import com.nbp.janaac.application.form.service.model.AccMediLabTestResourceReqTable;
import com.nbp.janaac.application.form.service.model.impl.AccMediLabTestResourceReqImpl;
import com.nbp.janaac.application.form.service.model.impl.AccMediLabTestResourceReqModelImpl;
import com.nbp.janaac.application.form.service.service.persistence.AccMediLabTestResourceReqPersistence;
import com.nbp.janaac.application.form.service.service.persistence.AccMediLabTestResourceReqUtil;
...
/**
 * The persistence implementation for the acc medi lab test resource req service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccMediLabTestResourceReqPersistence.class)
public class AccMediLabTestResourceReqPersistenceImpl
	extends BasePersistenceImpl<AccMediLabTestResourceReq>
	implements AccMediLabTestResourceReqPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccMediLabTestResourceReqUtil</code> to access the acc medi lab test resource req persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccMediLabTestResourceReqImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccMediLabTestResourceReq> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccMediLabTestResourceReq> findByUuid(
	...
	public List<AccMediLabTestResourceReq> findByUuid(
		...
		List<AccMediLabTestResourceReq> list = null;

		if (useFinderCache) {
			list = (List<AccMediLabTestResourceReq>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccMediLabTestResourceReq accMediLabTestResourceReq :
						list) {

					if (!uuid.equals(accMediLabTestResourceReq.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCMEDILABTESTRESOURCEREQ_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccMediLabTestResourceReqModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccMediLabTestResourceReq>)QueryUtil.list(
	...
	public AccMediLabTestResourceReq findByUuid_First(
		...
		AccMediLabTestResourceReq accMediLabTestResourceReq = fetchByUuid_First(
			uuid, orderByComparator);

		if (accMediLabTestResourceReq != null) {
			return accMediLabTestResourceReq;
		}
		...
		throw new NoSuchAccMediLabTestResourceReqException(sb.toString());
	}
	...
	public AccMediLabTestResourceReq fetchByUuid_First(
		...
		List<AccMediLabTestResourceReq> list = findByUuid(
	...
	public AccMediLabTestResourceReq findByUuid_Last(
		...
		AccMediLabTestResourceReq accMediLabTestResourceReq = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccMediLabTestResourceReq[] findByUuid_PrevAndNext(
		...
		AccMediLabTestResourceReq accMediLabTestResourceReq = findByPrimaryKey(
		...
		try {
			...
			AccMediLabTestResourceReq[] array =
				new AccMediLabTestResourceReqImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accMediLabTestResourceReq, uuid, orderByComparator,
				true);

			array[1] = accMediLabTestResourceReq;
	...
	protected AccMediLabTestResourceReq getByUuid_PrevAndNext(
		Session session, AccMediLabTestResourceReq accMediLabTestResourceReq,
		String uuid,
		OrderByComparator<AccMediLabTestResourceReq> orderByComparator,
		boolean previous) {
		...
		List<AccMediLabTestResourceReq> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccMediLabTestResourceReq accMediLabTestResourceReq :
			...
			remove(accMediLabTestResourceReq);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCMEDILABTESTRESOURCEREQ_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accMediLabTestResourceReq.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accMediLabTestResourceReq.uuid IS NULL OR accMediLabTestResourceReq.uuid = '')";
	...
	public AccMediLabTestResourceReq findByUUID_G(String uuid, long groupId)
		...
		AccMediLabTestResourceReq accMediLabTestResourceReq = fetchByUUID_G(
			uuid, groupId);
	...
	public AccMediLabTestResourceReq fetchByUUID_G(
		...
		if (result instanceof AccMediLabTestResourceReq) {
			AccMediLabTestResourceReq accMediLabTestResourceReq =
				(AccMediLabTestResourceReq)result;

			if (!Objects.equals(uuid, accMediLabTestResourceReq.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = accMediLabTestResourceReq;

					cacheResult(accMediLabTestResourceReq);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccMediLabTestResourceReq)result;
		}
	}
	...
	public AccMediLabTestResourceReq removeByUUID_G(String uuid, long groupId)
		...
		AccMediLabTestResourceReq accMediLabTestResourceReq = findByUUID_G(
			uuid, groupId);

		return remove(accMediLabTestResourceReq);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accMediLabTestResourceReq.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accMediLabTestResourceReq.uuid IS NULL OR accMediLabTestResourceReq.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accMediLabTestResourceReq.groupId = ?";
	 ...
	 */
	@Override
	public List<AccMediLabTestResourceReq> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AccMediLabTestResourceReq accMediLabTestResourceReq :
					...
					if (!uuid.equals(accMediLabTestResourceReq.getUuid()) ||
						(companyId !=
							accMediLabTestResourceReq.getCompanyId())) {
	...
	public AccMediLabTestResourceReq fetchByUuid_C_First(
		...
		List<AccMediLabTestResourceReq> list = findByUuid_C(
	...
	public AccMediLabTestResourceReq[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accMediLabTestResourceReq, uuid, companyId,
	...
	protected AccMediLabTestResourceReq getByUuid_C_PrevAndNext(
		Session session, AccMediLabTestResourceReq accMediLabTestResourceReq,
		String uuid, long companyId,
		OrderByComparator<AccMediLabTestResourceReq> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accMediLabTestResourceReq.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccMediLabTestResourceReqPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accMediLabTestResourceReq.janaacApplicationId = ?";

	public AccMediLabTestResourceReqPersistenceImpl() {
		...
		setModelClass(AccMediLabTestResourceReq.class);

		setModelImplClass(AccMediLabTestResourceReqImpl.class);
		setModelPKClass(long.class);

		setTable(AccMediLabTestResourceReqTable.INSTANCE);
	}
	...
	public void cacheResult(
		...
		entityCache.putResult(
			AccMediLabTestResourceReqImpl.class,
			accMediLabTestResourceReq.getPrimaryKey(),
			accMediLabTestResourceReq);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accMediLabTestResourceReq.getUuid(),
				accMediLabTestResourceReq.getGroupId()
			},
			accMediLabTestResourceReq);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accMediLabTestResourceReq.getJanaacApplicationId()},
			accMediLabTestResourceReq);
	}
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accMediLabTestResourceReqs.size() >
		...
		for (AccMediLabTestResourceReq accMediLabTestResourceReq :
				accMediLabTestResourceReqs) {

			if (entityCache.getResult(
					AccMediLabTestResourceReqImpl.class,
					accMediLabTestResourceReq.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc medi lab test resource reqs.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccMediLabTestResourceReqImpl.class);

		finderCache.clearCache(AccMediLabTestResourceReqImpl.class);
	}

	/**
	 * Clears the cache for the acc medi lab test resource req.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(
		...
		entityCache.removeResult(
			AccMediLabTestResourceReqImpl.class, accMediLabTestResourceReq);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccMediLabTestResourceReqImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		AccMediLabTestResourceReqModelImpl accMediLabTestResourceReqModelImpl) {

		Object[] args = new Object[] {
			accMediLabTestResourceReqModelImpl.getUuid(),
			accMediLabTestResourceReqModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accMediLabTestResourceReqModelImpl);

		args = new Object[] {
			accMediLabTestResourceReqModelImpl.getJanaacApplicationId()
		};
		...
		finderCache.putResult(
			...
			accMediLabTestResourceReqModelImpl);
	}
	...
	public AccMediLabTestResourceReq create(long accMediLabTestResourceReqId) {
		...
		accMediLabTestResourceReq.setPrimaryKey(accMediLabTestResourceReqId);

		String uuid = PortalUUIDUtil.generate();

		accMediLabTestResourceReq.setUuid(uuid);
	...
	public AccMediLabTestResourceReq remove(long accMediLabTestResourceReqId)
		...
		return remove((Serializable)accMediLabTestResourceReqId);
	}

	/**
	 * Removes the acc medi lab test resource req with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc medi lab test resource req
	 * @return the acc medi lab test resource req that was removed
	 * @throws NoSuchAccMediLabTestResourceReqException if a acc medi lab test resource req with the primary key could not be found
	 */
	@Override
	public AccMediLabTestResourceReq remove(Serializable primaryKey)
		throws NoSuchAccMediLabTestResourceReqException {
		...
		try {
			...
			AccMediLabTestResourceReq accMediLabTestResourceReq =
				(AccMediLabTestResourceReq)session.get(
					AccMediLabTestResourceReqImpl.class, primaryKey);
			...
			if (accMediLabTestResourceReq == null) {
				...
				throw new NoSuchAccMediLabTestResourceReqException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accMediLabTestResourceReq);
		}
		catch (NoSuchAccMediLabTestResourceReqException noSuchEntityException) {
	...
	@Override
	protected AccMediLabTestResourceReq removeImpl(
		AccMediLabTestResourceReq accMediLabTestResourceReq) {
		...
		try {
			...
			if (!session.contains(accMediLabTestResourceReq)) {
				accMediLabTestResourceReq =
					(AccMediLabTestResourceReq)session.get(
						AccMediLabTestResourceReqImpl.class,
						accMediLabTestResourceReq.getPrimaryKeyObj());
			}

			if (accMediLabTestResourceReq != null) {
				session.delete(accMediLabTestResourceReq);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accMediLabTestResourceReq != null) {
			clearCache(accMediLabTestResourceReq);
		}
	...
	public AccMediLabTestResourceReq updateImpl(
		...
		boolean isNew = accMediLabTestResourceReq.isNew();

		if (!(accMediLabTestResourceReq instanceof
				AccMediLabTestResourceReqModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accMediLabTestResourceReq.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accMediLabTestResourceReq);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accMediLabTestResourceReq proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccMediLabTestResourceReq implementation " +
					accMediLabTestResourceReq.getClass());
		}

		AccMediLabTestResourceReqModelImpl accMediLabTestResourceReqModelImpl =
			(AccMediLabTestResourceReqModelImpl)accMediLabTestResourceReq;

		if (Validator.isNull(accMediLabTestResourceReq.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accMediLabTestResourceReq.getCreateDate() == null)) {
			if (serviceContext == null) {
				accMediLabTestResourceReq.setCreateDate(date);
			}
			else {
		...
		if (!accMediLabTestResourceReqModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accMediLabTestResourceReq.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accMediLabTestResourceReq);
			}
			else {
				accMediLabTestResourceReq =
					(AccMediLabTestResourceReq)session.merge(
						accMediLabTestResourceReq);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccMediLabTestResourceReqImpl.class,
			accMediLabTestResourceReqModelImpl, false, true);

		cacheUniqueFindersCache(accMediLabTestResourceReqModelImpl);

		if (isNew) {
			accMediLabTestResourceReq.setNew(false);
		}

		accMediLabTestResourceReq.resetOriginalValues();

		return accMediLabTestResourceReq;
	}

	/**
	 * Returns the acc medi lab test resource req with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc medi lab test resource req
	 ...
	 */
	@Override
	public AccMediLabTestResourceReq findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccMediLabTestResourceReqException {

		AccMediLabTestResourceReq accMediLabTestResourceReq = fetchByPrimaryKey(
			primaryKey);
	...
	public AccMediLabTestResourceReq findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)accMediLabTestResourceReqId);
	}
	...
	public AccMediLabTestResourceReq fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)accMediLabTestResourceReqId);
	}
	 ...
	 */
	@Override
	public List<AccMediLabTestResourceReq> findAll() {
	 ...
	 */
	@Override
	public List<AccMediLabTestResourceReq> findAll(int start, int end) {
	...
	public List<AccMediLabTestResourceReq> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCMEDILABTESTRESOURCEREQ);
				...
				sql = _SQL_SELECT_ACCMEDILABTESTRESOURCEREQ;

				sql = sql.concat(
					AccMediLabTestResourceReqModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccMediLabTestResourceReq accMediLabTestResourceReq : findAll()) {
			remove(accMediLabTestResourceReq);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCMEDILABTESTRESOURCEREQ);
	...
	protected String getPKDBName() {
		return "accMediLabTestResourceReqId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCMEDILABTESTRESOURCEREQ;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccMediLabTestResourceReqModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc medi lab test resource req persistence.
	 */
	@Activate
	public void activate() {
		...
		AccMediLabTestResourceReqUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccMediLabTestResourceReqUtil.setPersistence(null);

		entityCache.removeCache(AccMediLabTestResourceReqImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCMEDILABTESTRESOURCEREQ =
		"SELECT accMediLabTestResourceReq FROM AccMediLabTestResourceReq accMediLabTestResourceReq";

	private static final String _SQL_SELECT_ACCMEDILABTESTRESOURCEREQ_WHERE =
		"SELECT accMediLabTestResourceReq FROM AccMediLabTestResourceReq accMediLabTestResourceReq WHERE ";

	private static final String _SQL_COUNT_ACCMEDILABTESTRESOURCEREQ =
		"SELECT COUNT(accMediLabTestResourceReq) FROM AccMediLabTestResourceReq accMediLabTestResourceReq";

	private static final String _SQL_COUNT_ACCMEDILABTESTRESOURCEREQ_WHERE =
		"SELECT COUNT(accMediLabTestResourceReq) FROM AccMediLabTestResourceReq accMediLabTestResourceReq WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accMediLabTestResourceReq.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccMediLabTestResourceReq exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccMediLabTestResourceReq exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestResourceReqPersistenceImpl.class);
