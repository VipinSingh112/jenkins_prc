...
import com.nbp.janaac.application.form.service.service.AddInsApplicationInfoLocalService;
...
/**
 * Provides the base implementation for the add ins application info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoLocalServiceImpl
 * @generated
 */
public abstract class AddInsApplicationInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddInsApplicationInfoLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsApplicationInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsApplicationInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddInsApplicationInfo addAddInsApplicationInfo(
		AddInsApplicationInfo addInsApplicationInfo) {

		addInsApplicationInfo.setNew(true);

		return addInsApplicationInfoPersistence.update(addInsApplicationInfo);
	}
	...
	public AddInsApplicationInfo createAddInsApplicationInfo(
		long addInsApplicationInfoId) {

		return addInsApplicationInfoPersistence.create(addInsApplicationInfoId);
	}
	...
	@Override
	public AddInsApplicationInfo deleteAddInsApplicationInfo(
			long addInsApplicationInfoId)
		throws PortalException {

		return addInsApplicationInfoPersistence.remove(addInsApplicationInfoId);
	}
	...
	public AddInsApplicationInfo deleteAddInsApplicationInfo(
		...
		return addInsApplicationInfoPersistence.remove(addInsApplicationInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addInsApplicationInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddInsApplicationInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addInsApplicationInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addInsApplicationInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddInsApplicationInfo fetchAddInsApplicationInfo(
		long addInsApplicationInfoId) {

		return addInsApplicationInfoPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddInsApplicationInfo getAddInsApplicationInfo(
			long addInsApplicationInfoId)
		throws PortalException {

		return addInsApplicationInfoPersistence.findByPrimaryKey(
			addInsApplicationInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addInsApplicationInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddInsApplicationInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addInsApplicationInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddInsApplicationInfoLocalServiceImpl#deleteAddInsApplicationInfo(AddInsApplicationInfo) to avoid orphaned data");
		}

		return addInsApplicationInfoLocalService.deleteAddInsApplicationInfo(
			(AddInsApplicationInfo)persistedModel);
	}

	@Override
	public BasePersistence<AddInsApplicationInfo> getBasePersistence() {
		return addInsApplicationInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addInsApplicationInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddInsApplicationInfo> getAddInsApplicationInfos(
		int start, int end) {

		return addInsApplicationInfoPersistence.findAll(start, end);
	}
	...
	public int getAddInsApplicationInfosCount() {
		return addInsApplicationInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddInsApplicationInfo updateAddInsApplicationInfo(
		AddInsApplicationInfo addInsApplicationInfo) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsApplicationInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addInsApplicationInfoLocalService =
			(AddInsApplicationInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsApplicationInfoLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return AddInsApplicationInfo.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addInsApplicationInfoPersistence.getDataSource();
	...
	protected AddInsApplicationInfoLocalService
		addInsApplicationInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsApplicationInfoLocalServiceBaseImpl.class);
