...
import com.nbp.janaac.application.form.service.model.AccInsBodiesOrganizationTable;
import com.nbp.janaac.application.form.service.model.impl.AccInsBodiesOrganizationImpl;
import com.nbp.janaac.application.form.service.model.impl.AccInsBodiesOrganizationModelImpl;
import com.nbp.janaac.application.form.service.service.persistence.AccInsBodiesOrganizationPersistence;
import com.nbp.janaac.application.form.service.service.persistence.AccInsBodiesOrganizationUtil;
...
/**
 * The persistence implementation for the acc ins bodies organization service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccInsBodiesOrganizationPersistence.class)
public class AccInsBodiesOrganizationPersistenceImpl
	extends BasePersistenceImpl<AccInsBodiesOrganization>
	implements AccInsBodiesOrganizationPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccInsBodiesOrganizationUtil</code> to access the acc ins bodies organization persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccInsBodiesOrganizationImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> findByUuid(
	...
	public List<AccInsBodiesOrganization> findByUuid(
		...
		List<AccInsBodiesOrganization> list = null;

		if (useFinderCache) {
			list = (List<AccInsBodiesOrganization>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccInsBodiesOrganization accInsBodiesOrganization : list) {
					if (!uuid.equals(accInsBodiesOrganization.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCINSBODIESORGANIZATION_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccInsBodiesOrganizationModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccInsBodiesOrganization>)QueryUtil.list(
	...
	public AccInsBodiesOrganization findByUuid_First(
		...
		AccInsBodiesOrganization accInsBodiesOrganization = fetchByUuid_First(
			uuid, orderByComparator);

		if (accInsBodiesOrganization != null) {
		...
		throw new NoSuchAccInsBodiesOrganizationException(sb.toString());
	}
	...
	public AccInsBodiesOrganization fetchByUuid_First(
		...
		List<AccInsBodiesOrganization> list = findByUuid(
	...
	public AccInsBodiesOrganization findByUuid_Last(
		...
		AccInsBodiesOrganization accInsBodiesOrganization = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccInsBodiesOrganization[] findByUuid_PrevAndNext(
		...
		AccInsBodiesOrganization accInsBodiesOrganization = findByPrimaryKey(
		...
		try {
			...
			AccInsBodiesOrganization[] array =
				new AccInsBodiesOrganizationImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accInsBodiesOrganization, uuid, orderByComparator,
				true);

			array[1] = accInsBodiesOrganization;
	...
	protected AccInsBodiesOrganization getByUuid_PrevAndNext(
		Session session, AccInsBodiesOrganization accInsBodiesOrganization,
		String uuid,
		OrderByComparator<AccInsBodiesOrganization> orderByComparator,
		boolean previous) {
		...
		List<AccInsBodiesOrganization> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccInsBodiesOrganization accInsBodiesOrganization :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accInsBodiesOrganization);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCINSBODIESORGANIZATION_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accInsBodiesOrganization.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accInsBodiesOrganization.uuid IS NULL OR accInsBodiesOrganization.uuid = '')";
	...
	public AccInsBodiesOrganization findByUUID_G(String uuid, long groupId)
		...
		AccInsBodiesOrganization accInsBodiesOrganization = fetchByUUID_G(
			uuid, groupId);
	...
	public AccInsBodiesOrganization fetchByUUID_G(
		...
		if (result instanceof AccInsBodiesOrganization) {
			AccInsBodiesOrganization accInsBodiesOrganization =
				(AccInsBodiesOrganization)result;

			if (!Objects.equals(uuid, accInsBodiesOrganization.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = accInsBodiesOrganization;

					cacheResult(accInsBodiesOrganization);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccInsBodiesOrganization)result;
		}
	}
	...
	public AccInsBodiesOrganization removeByUUID_G(String uuid, long groupId)
		...
		AccInsBodiesOrganization accInsBodiesOrganization = findByUUID_G(
			uuid, groupId);

		return remove(accInsBodiesOrganization);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accInsBodiesOrganization.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accInsBodiesOrganization.uuid IS NULL OR accInsBodiesOrganization.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accInsBodiesOrganization.groupId = ?";
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AccInsBodiesOrganization accInsBodiesOrganization : list) {
					if (!uuid.equals(accInsBodiesOrganization.getUuid()) ||
						(companyId !=
							accInsBodiesOrganization.getCompanyId())) {
	...
	public AccInsBodiesOrganization findByUuid_C_First(
		...
		AccInsBodiesOrganization accInsBodiesOrganization = fetchByUuid_C_First(
	...
	public AccInsBodiesOrganization fetchByUuid_C_First(
		...
		List<AccInsBodiesOrganization> list = findByUuid_C(
	...
	public AccInsBodiesOrganization findByUuid_C_Last(
		...
		AccInsBodiesOrganization accInsBodiesOrganization = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccInsBodiesOrganization[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accInsBodiesOrganization, uuid, companyId,
	...
	protected AccInsBodiesOrganization getByUuid_C_PrevAndNext(
		Session session, AccInsBodiesOrganization accInsBodiesOrganization,
		String uuid, long companyId,
		OrderByComparator<AccInsBodiesOrganization> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accInsBodiesOrganization.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccInsBodiesOrganizationPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accInsBodiesOrganization.janaacApplicationId = ?";

	public AccInsBodiesOrganizationPersistenceImpl() {
		...
		setModelClass(AccInsBodiesOrganization.class);

		setModelImplClass(AccInsBodiesOrganizationImpl.class);
		setModelPKClass(long.class);

		setTable(AccInsBodiesOrganizationTable.INSTANCE);
	}
	...
	public void cacheResult(AccInsBodiesOrganization accInsBodiesOrganization) {
		entityCache.putResult(
			AccInsBodiesOrganizationImpl.class,
			accInsBodiesOrganization.getPrimaryKey(), accInsBodiesOrganization);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accInsBodiesOrganization.getUuid(),
				accInsBodiesOrganization.getGroupId()
			},
			accInsBodiesOrganization);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accInsBodiesOrganization.getJanaacApplicationId()},
			accInsBodiesOrganization);
	}
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accInsBodiesOrganizations.size() >
		...
		for (AccInsBodiesOrganization accInsBodiesOrganization :
				accInsBodiesOrganizations) {

			if (entityCache.getResult(
					AccInsBodiesOrganizationImpl.class,
					accInsBodiesOrganization.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc ins bodies organizations.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccInsBodiesOrganizationImpl.class);

		finderCache.clearCache(AccInsBodiesOrganizationImpl.class);
	}

	/**
	 * Clears the cache for the acc ins bodies organization.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccInsBodiesOrganization accInsBodiesOrganization) {
		entityCache.removeResult(
			AccInsBodiesOrganizationImpl.class, accInsBodiesOrganization);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccInsBodiesOrganizationImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		AccInsBodiesOrganizationModelImpl accInsBodiesOrganizationModelImpl) {

		Object[] args = new Object[] {
			accInsBodiesOrganizationModelImpl.getUuid(),
			accInsBodiesOrganizationModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accInsBodiesOrganizationModelImpl);

		args = new Object[] {
			accInsBodiesOrganizationModelImpl.getJanaacApplicationId()
		};
		...
		finderCache.putResult(
			...
			accInsBodiesOrganizationModelImpl);
	}
	...
	public AccInsBodiesOrganization create(long accInsBodiesOrganizationId) {
		...
		accInsBodiesOrganization.setNew(true);
		accInsBodiesOrganization.setPrimaryKey(accInsBodiesOrganizationId);

		String uuid = PortalUUIDUtil.generate();

		accInsBodiesOrganization.setUuid(uuid);
	...
	public AccInsBodiesOrganization remove(long accInsBodiesOrganizationId)
		...
		return remove((Serializable)accInsBodiesOrganizationId);
	}

	/**
	 * Removes the acc ins bodies organization with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc ins bodies organization
	 * @return the acc ins bodies organization that was removed
	 * @throws NoSuchAccInsBodiesOrganizationException if a acc ins bodies organization with the primary key could not be found
	 */
	@Override
	public AccInsBodiesOrganization remove(Serializable primaryKey)
		throws NoSuchAccInsBodiesOrganizationException {
		...
		try {
			...
			AccInsBodiesOrganization accInsBodiesOrganization =
				(AccInsBodiesOrganization)session.get(
					AccInsBodiesOrganizationImpl.class, primaryKey);
			...
			if (accInsBodiesOrganization == null) {
				...
				throw new NoSuchAccInsBodiesOrganizationException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accInsBodiesOrganization);
		}
		catch (NoSuchAccInsBodiesOrganizationException noSuchEntityException) {
	...
	@Override
	protected AccInsBodiesOrganization removeImpl(
		AccInsBodiesOrganization accInsBodiesOrganization) {
		...
		try {
			...
			if (!session.contains(accInsBodiesOrganization)) {
				accInsBodiesOrganization =
					(AccInsBodiesOrganization)session.get(
						AccInsBodiesOrganizationImpl.class,
						accInsBodiesOrganization.getPrimaryKeyObj());
			}

			if (accInsBodiesOrganization != null) {
				session.delete(accInsBodiesOrganization);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accInsBodiesOrganization != null) {
			clearCache(accInsBodiesOrganization);
		}
	...
	public AccInsBodiesOrganization updateImpl(
		...
		boolean isNew = accInsBodiesOrganization.isNew();

		if (!(accInsBodiesOrganization instanceof
				AccInsBodiesOrganizationModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accInsBodiesOrganization.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accInsBodiesOrganization);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accInsBodiesOrganization proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccInsBodiesOrganization implementation " +
					accInsBodiesOrganization.getClass());
		}

		AccInsBodiesOrganizationModelImpl accInsBodiesOrganizationModelImpl =
			(AccInsBodiesOrganizationModelImpl)accInsBodiesOrganization;

		if (Validator.isNull(accInsBodiesOrganization.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accInsBodiesOrganization.getCreateDate() == null)) {
			if (serviceContext == null) {
				accInsBodiesOrganization.setCreateDate(date);
			}
			else {
		...
		if (!accInsBodiesOrganizationModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accInsBodiesOrganization.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accInsBodiesOrganization);
			}
			else {
				accInsBodiesOrganization =
					(AccInsBodiesOrganization)session.merge(
						accInsBodiesOrganization);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccInsBodiesOrganizationImpl.class,
			accInsBodiesOrganizationModelImpl, false, true);

		cacheUniqueFindersCache(accInsBodiesOrganizationModelImpl);

		if (isNew) {
			accInsBodiesOrganization.setNew(false);
		}

		accInsBodiesOrganization.resetOriginalValues();

		return accInsBodiesOrganization;
	}

	/**
	 * Returns the acc ins bodies organization with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc ins bodies organization
	 ...
	 */
	@Override
	public AccInsBodiesOrganization findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccInsBodiesOrganizationException {

		AccInsBodiesOrganization accInsBodiesOrganization = fetchByPrimaryKey(
			primaryKey);
	...
	public AccInsBodiesOrganization findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)accInsBodiesOrganizationId);
	}
	...
	public AccInsBodiesOrganization fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)accInsBodiesOrganizationId);
	}
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> findAll() {
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> findAll(int start, int end) {
	...
	public List<AccInsBodiesOrganization> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCINSBODIESORGANIZATION);
				...
				sql = _SQL_SELECT_ACCINSBODIESORGANIZATION;

				sql = sql.concat(
					AccInsBodiesOrganizationModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccInsBodiesOrganization accInsBodiesOrganization : findAll()) {
			remove(accInsBodiesOrganization);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCINSBODIESORGANIZATION);
	...
	protected String getPKDBName() {
		return "accInsBodiesOrganizationId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCINSBODIESORGANIZATION;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccInsBodiesOrganizationModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc ins bodies organization persistence.
	 */
	@Activate
	public void activate() {
		...
		AccInsBodiesOrganizationUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccInsBodiesOrganizationUtil.setPersistence(null);

		entityCache.removeCache(AccInsBodiesOrganizationImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCINSBODIESORGANIZATION =
		"SELECT accInsBodiesOrganization FROM AccInsBodiesOrganization accInsBodiesOrganization";

	private static final String _SQL_SELECT_ACCINSBODIESORGANIZATION_WHERE =
		"SELECT accInsBodiesOrganization FROM AccInsBodiesOrganization accInsBodiesOrganization WHERE ";

	private static final String _SQL_COUNT_ACCINSBODIESORGANIZATION =
		"SELECT COUNT(accInsBodiesOrganization) FROM AccInsBodiesOrganization accInsBodiesOrganization";

	private static final String _SQL_COUNT_ACCINSBODIESORGANIZATION_WHERE =
		"SELECT COUNT(accInsBodiesOrganization) FROM AccInsBodiesOrganization accInsBodiesOrganization WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accInsBodiesOrganization.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccInsBodiesOrganization exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccInsBodiesOrganization exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesOrganizationPersistenceImpl.class);
