...
import com.nbp.janaac.application.form.service.service.persistence.AccCerBodyApplicantInfoUtil;
...
/**
 * The persistence implementation for the acc cer body applicant info service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccCerBodyApplicantInfoPersistence.class)
public class AccCerBodyApplicantInfoPersistenceImpl
	extends BasePersistenceImpl<AccCerBodyApplicantInfo>
	implements AccCerBodyApplicantInfoPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccCerBodyApplicantInfoUtil</code> to access the acc cer body applicant info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccCerBodyApplicantInfoImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccCerBodyApplicantInfo> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccCerBodyApplicantInfo> findByUuid(
	...
	public List<AccCerBodyApplicantInfo> findByUuid(
		...
		List<AccCerBodyApplicantInfo> list = null;

		if (useFinderCache) {
			list = (List<AccCerBodyApplicantInfo>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccCerBodyApplicantInfo accCerBodyApplicantInfo : list) {
					if (!uuid.equals(accCerBodyApplicantInfo.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCCERBODYAPPLICANTINFO_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccCerBodyApplicantInfoModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccCerBodyApplicantInfo>)QueryUtil.list(
	...
	public AccCerBodyApplicantInfo findByUuid_First(
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByUuid_First(
			uuid, orderByComparator);

		if (accCerBodyApplicantInfo != null) {
		...
		throw new NoSuchAccCerBodyApplicantInfoException(sb.toString());
	}
	...
	public AccCerBodyApplicantInfo fetchByUuid_First(
		...
		List<AccCerBodyApplicantInfo> list = findByUuid(
	...
	public AccCerBodyApplicantInfo findByUuid_Last(
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccCerBodyApplicantInfo[] findByUuid_PrevAndNext(
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = findByPrimaryKey(
		...
		try {
			...
			AccCerBodyApplicantInfo[] array =
				new AccCerBodyApplicantInfoImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accCerBodyApplicantInfo, uuid, orderByComparator,
				true);

			array[1] = accCerBodyApplicantInfo;
	...
	protected AccCerBodyApplicantInfo getByUuid_PrevAndNext(
		Session session, AccCerBodyApplicantInfo accCerBodyApplicantInfo,
		String uuid,
		OrderByComparator<AccCerBodyApplicantInfo> orderByComparator,
		boolean previous) {
		...
		List<AccCerBodyApplicantInfo> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccCerBodyApplicantInfo accCerBodyApplicantInfo :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accCerBodyApplicantInfo);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCCERBODYAPPLICANTINFO_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accCerBodyApplicantInfo.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accCerBodyApplicantInfo.uuid IS NULL OR accCerBodyApplicantInfo.uuid = '')";
	...
	public AccCerBodyApplicantInfo findByUUID_G(String uuid, long groupId)
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByUUID_G(
			uuid, groupId);
	...
	public AccCerBodyApplicantInfo fetchByUUID_G(
		...
		if (result instanceof AccCerBodyApplicantInfo) {
			AccCerBodyApplicantInfo accCerBodyApplicantInfo =
				(AccCerBodyApplicantInfo)result;

			if (!Objects.equals(uuid, accCerBodyApplicantInfo.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AccCerBodyApplicantInfo accCerBodyApplicantInfo = list.get(
						0);

					result = accCerBodyApplicantInfo;

					cacheResult(accCerBodyApplicantInfo);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccCerBodyApplicantInfo)result;
		}
	}
	...
	public AccCerBodyApplicantInfo removeByUUID_G(String uuid, long groupId)
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = findByUUID_G(
			uuid, groupId);

		return remove(accCerBodyApplicantInfo);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accCerBodyApplicantInfo.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accCerBodyApplicantInfo.uuid IS NULL OR accCerBodyApplicantInfo.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accCerBodyApplicantInfo.groupId = ?";
	 ...
	 */
	@Override
	public List<AccCerBodyApplicantInfo> findByUuid_C(
	...
	public AccCerBodyApplicantInfo findByUuid_C_First(
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByUuid_C_First(
	...
	public AccCerBodyApplicantInfo fetchByUuid_C_First(
		...
		List<AccCerBodyApplicantInfo> list = findByUuid_C(
	...
	public AccCerBodyApplicantInfo findByUuid_C_Last(
		...
		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccCerBodyApplicantInfo[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accCerBodyApplicantInfo, uuid, companyId,
	...
	protected AccCerBodyApplicantInfo getByUuid_C_PrevAndNext(
		Session session, AccCerBodyApplicantInfo accCerBodyApplicantInfo,
		String uuid, long companyId,
		OrderByComparator<AccCerBodyApplicantInfo> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accCerBodyApplicantInfo.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccCerBodyApplicantInfoPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accCerBodyApplicantInfo.janaacApplicationId = ?";

	public AccCerBodyApplicantInfoPersistenceImpl() {
		...
		setModelClass(AccCerBodyApplicantInfo.class);

		setModelImplClass(AccCerBodyApplicantInfoImpl.class);
		setModelPKClass(long.class);

		setTable(AccCerBodyApplicantInfoTable.INSTANCE);
	}
	...
	public void cacheResult(AccCerBodyApplicantInfo accCerBodyApplicantInfo) {
		entityCache.putResult(
			AccCerBodyApplicantInfoImpl.class,
			accCerBodyApplicantInfo.getPrimaryKey(), accCerBodyApplicantInfo);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accCerBodyApplicantInfo.getUuid(),
				accCerBodyApplicantInfo.getGroupId()
			},
			accCerBodyApplicantInfo);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accCerBodyApplicantInfo.getJanaacApplicationId()},
			accCerBodyApplicantInfo);
	}
	...
	public void cacheResult(
		...
		for (AccCerBodyApplicantInfo accCerBodyApplicantInfo :
				accCerBodyApplicantInfos) {

			if (entityCache.getResult(
					AccCerBodyApplicantInfoImpl.class,
					accCerBodyApplicantInfo.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc cer body applicant infos.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccCerBodyApplicantInfoImpl.class);

		finderCache.clearCache(AccCerBodyApplicantInfoImpl.class);
	}

	/**
	 * Clears the cache for the acc cer body applicant info.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccCerBodyApplicantInfo accCerBodyApplicantInfo) {
		entityCache.removeResult(
			AccCerBodyApplicantInfoImpl.class, accCerBodyApplicantInfo);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccCerBodyApplicantInfoImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			accCerBodyApplicantInfoModelImpl.getUuid(),
			accCerBodyApplicantInfoModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accCerBodyApplicantInfoModelImpl);

		args = new Object[] {
			accCerBodyApplicantInfoModelImpl.getJanaacApplicationId()
		};
		...
		finderCache.putResult(
			...
			accCerBodyApplicantInfoModelImpl);
	}
	...
	public AccCerBodyApplicantInfo create(long accCerBodyApplicantInfoId) {
		...
		accCerBodyApplicantInfo.setNew(true);
		accCerBodyApplicantInfo.setPrimaryKey(accCerBodyApplicantInfoId);

		String uuid = PortalUUIDUtil.generate();

		accCerBodyApplicantInfo.setUuid(uuid);

		accCerBodyApplicantInfo.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public AccCerBodyApplicantInfo remove(long accCerBodyApplicantInfoId)
		...
		return remove((Serializable)accCerBodyApplicantInfoId);
	}

	/**
	 * Removes the acc cer body applicant info with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc cer body applicant info
	 * @return the acc cer body applicant info that was removed
	 * @throws NoSuchAccCerBodyApplicantInfoException if a acc cer body applicant info with the primary key could not be found
	 */
	@Override
	public AccCerBodyApplicantInfo remove(Serializable primaryKey)
		throws NoSuchAccCerBodyApplicantInfoException {
		...
		try {
			...
			AccCerBodyApplicantInfo accCerBodyApplicantInfo =
				(AccCerBodyApplicantInfo)session.get(
					AccCerBodyApplicantInfoImpl.class, primaryKey);
			...
			if (accCerBodyApplicantInfo == null) {
				...
				throw new NoSuchAccCerBodyApplicantInfoException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accCerBodyApplicantInfo);
		}
		catch (NoSuchAccCerBodyApplicantInfoException noSuchEntityException) {
	...
	@Override
	protected AccCerBodyApplicantInfo removeImpl(
		AccCerBodyApplicantInfo accCerBodyApplicantInfo) {
		...
		try {
			...
			if (!session.contains(accCerBodyApplicantInfo)) {
				accCerBodyApplicantInfo = (AccCerBodyApplicantInfo)session.get(
					AccCerBodyApplicantInfoImpl.class,
					accCerBodyApplicantInfo.getPrimaryKeyObj());
			}

			if (accCerBodyApplicantInfo != null) {
				session.delete(accCerBodyApplicantInfo);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accCerBodyApplicantInfo != null) {
			clearCache(accCerBodyApplicantInfo);
		}
	...
	public AccCerBodyApplicantInfo updateImpl(
		...
		boolean isNew = accCerBodyApplicantInfo.isNew();

		if (!(accCerBodyApplicantInfo instanceof
				AccCerBodyApplicantInfoModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accCerBodyApplicantInfo.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accCerBodyApplicantInfo);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accCerBodyApplicantInfo proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccCerBodyApplicantInfo implementation " +
					accCerBodyApplicantInfo.getClass());
		}

		AccCerBodyApplicantInfoModelImpl accCerBodyApplicantInfoModelImpl =
			(AccCerBodyApplicantInfoModelImpl)accCerBodyApplicantInfo;

		if (Validator.isNull(accCerBodyApplicantInfo.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accCerBodyApplicantInfo.getCreateDate() == null)) {
			if (serviceContext == null) {
				accCerBodyApplicantInfo.setCreateDate(date);
			}
			else {
		...
		if (!accCerBodyApplicantInfoModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accCerBodyApplicantInfo.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accCerBodyApplicantInfo);
			}
			else {
				accCerBodyApplicantInfo =
					(AccCerBodyApplicantInfo)session.merge(
						accCerBodyApplicantInfo);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccCerBodyApplicantInfoImpl.class, accCerBodyApplicantInfoModelImpl,
			false, true);

		cacheUniqueFindersCache(accCerBodyApplicantInfoModelImpl);

		if (isNew) {
			accCerBodyApplicantInfo.setNew(false);
		}

		accCerBodyApplicantInfo.resetOriginalValues();

		return accCerBodyApplicantInfo;
	}

	/**
	 * Returns the acc cer body applicant info with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc cer body applicant info
	 ...
	 */
	@Override
	public AccCerBodyApplicantInfo findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccCerBodyApplicantInfoException {

		AccCerBodyApplicantInfo accCerBodyApplicantInfo = fetchByPrimaryKey(
			primaryKey);
	...
	public AccCerBodyApplicantInfo findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)accCerBodyApplicantInfoId);
	}
	...
	public AccCerBodyApplicantInfo fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)accCerBodyApplicantInfoId);
	}
	 ...
	 */
	@Override
	public List<AccCerBodyApplicantInfo> findAll() {
	 ...
	 */
	@Override
	public List<AccCerBodyApplicantInfo> findAll(int start, int end) {
	...
	public List<AccCerBodyApplicantInfo> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCCERBODYAPPLICANTINFO);
				...
				sql = _SQL_SELECT_ACCCERBODYAPPLICANTINFO;

				sql = sql.concat(
					AccCerBodyApplicantInfoModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccCerBodyApplicantInfo accCerBodyApplicantInfo : findAll()) {
			remove(accCerBodyApplicantInfo);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCCERBODYAPPLICANTINFO);
	...
	protected String getPKDBName() {
		return "accCerBodyApplicantInfoId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCCERBODYAPPLICANTINFO;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccCerBodyApplicantInfoModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc cer body applicant info persistence.
	 */
	@Activate
	public void activate() {
		...
		AccCerBodyApplicantInfoUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccCerBodyApplicantInfoUtil.setPersistence(null);

		entityCache.removeCache(AccCerBodyApplicantInfoImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCCERBODYAPPLICANTINFO =
		"SELECT accCerBodyApplicantInfo FROM AccCerBodyApplicantInfo accCerBodyApplicantInfo";

	private static final String _SQL_SELECT_ACCCERBODYAPPLICANTINFO_WHERE =
		"SELECT accCerBodyApplicantInfo FROM AccCerBodyApplicantInfo accCerBodyApplicantInfo WHERE ";

	private static final String _SQL_COUNT_ACCCERBODYAPPLICANTINFO =
		"SELECT COUNT(accCerBodyApplicantInfo) FROM AccCerBodyApplicantInfo accCerBodyApplicantInfo";

	private static final String _SQL_COUNT_ACCCERBODYAPPLICANTINFO_WHERE =
		"SELECT COUNT(accCerBodyApplicantInfo) FROM AccCerBodyApplicantInfo accCerBodyApplicantInfo WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accCerBodyApplicantInfo.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccCerBodyApplicantInfo exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccCerBodyApplicantInfo exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyApplicantInfoPersistenceImpl.class);
