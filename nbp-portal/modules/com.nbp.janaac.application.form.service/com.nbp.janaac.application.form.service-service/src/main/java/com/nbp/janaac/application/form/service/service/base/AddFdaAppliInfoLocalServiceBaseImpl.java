...
import com.nbp.janaac.application.form.service.service.AddFdaAppliInfoLocalService;
...
/**
 * Provides the base implementation for the add fda appli info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoLocalServiceImpl
 * @generated
 */
public abstract class AddFdaAppliInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddFdaAppliInfoLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaAppliInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaAppliInfoLocalServiceUtil</code>.
	 */
	...
	public AddFdaAppliInfo addAddFdaAppliInfo(AddFdaAppliInfo addFdaAppliInfo) {
		...
		return addFdaAppliInfoPersistence.update(addFdaAppliInfo);
	}
	...
	public AddFdaAppliInfo createAddFdaAppliInfo(long addFdaAppliInfoId) {
		return addFdaAppliInfoPersistence.create(addFdaAppliInfoId);
	}
	...
	public AddFdaAppliInfo deleteAddFdaAppliInfo(long addFdaAppliInfoId)
		...
		return addFdaAppliInfoPersistence.remove(addFdaAppliInfoId);
	}
	...
	public AddFdaAppliInfo deleteAddFdaAppliInfo(
		...
		return addFdaAppliInfoPersistence.remove(addFdaAppliInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addFdaAppliInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddFdaAppliInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addFdaAppliInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addFdaAppliInfoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addFdaAppliInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return addFdaAppliInfoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AddFdaAppliInfo fetchAddFdaAppliInfo(long addFdaAppliInfoId) {
		return addFdaAppliInfoPersistence.fetchByPrimaryKey(addFdaAppliInfoId);
	}
	...
	public AddFdaAppliInfo getAddFdaAppliInfo(long addFdaAppliInfoId)
		...
		return addFdaAppliInfoPersistence.findByPrimaryKey(addFdaAppliInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(addFdaAppliInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddFdaAppliInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("addFdaAppliInfoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			addFdaAppliInfoLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AddFdaAppliInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaAppliInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddFdaAppliInfoLocalServiceImpl#deleteAddFdaAppliInfo(AddFdaAppliInfo) to avoid orphaned data");
		}

		return addFdaAppliInfoLocalService.deleteAddFdaAppliInfo(
			(AddFdaAppliInfo)persistedModel);
	}

	@Override
	public BasePersistence<AddFdaAppliInfo> getBasePersistence() {
		return addFdaAppliInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaAppliInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddFdaAppliInfo> getAddFdaAppliInfos(int start, int end) {
		return addFdaAppliInfoPersistence.findAll(start, end);
	}
	...
	public int getAddFdaAppliInfosCount() {
		return addFdaAppliInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaAppliInfoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addFdaAppliInfoLocalService = (AddFdaAppliInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaAppliInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = addFdaAppliInfoPersistence.getDataSource();
	...
	protected AddFdaAppliInfoLocalService addFdaAppliInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaAppliInfoLocalServiceBaseImpl.class);
