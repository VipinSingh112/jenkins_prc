...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelSecondService;
...
/**
 * Provides the base implementation for the add fda personnel second remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelSecondServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelSecondServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelSecondServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaPersonnelSecondService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelSecondService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelSecondServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaPersonnelSecondService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelSecondService = (AddFdaPersonnelSecondService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelSecondService.class.getName();
	}
	...
	protected AddFdaPersonnelSecondService addFdaPersonnelSecondService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelSecondServiceBaseImpl.class);
