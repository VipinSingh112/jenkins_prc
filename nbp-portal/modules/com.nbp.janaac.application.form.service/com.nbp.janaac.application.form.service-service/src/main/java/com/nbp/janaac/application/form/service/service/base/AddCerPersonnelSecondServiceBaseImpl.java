...
import com.nbp.janaac.application.form.service.service.AddCerPersonnelSecondService;
...
/**
 * Provides the base implementation for the add cer personnel second remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelSecondServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelSecondServiceImpl
 * @generated
 */
public abstract class AddCerPersonnelSecondServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerPersonnelSecondService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerPersonnelSecondService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerPersonnelSecondServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerPersonnelSecondService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerPersonnelSecondService = (AddCerPersonnelSecondService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerPersonnelSecondService.class.getName();
	}
	...
	protected AddCerPersonnelSecondService addCerPersonnelSecondService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerPersonnelSecondServiceBaseImpl.class);
