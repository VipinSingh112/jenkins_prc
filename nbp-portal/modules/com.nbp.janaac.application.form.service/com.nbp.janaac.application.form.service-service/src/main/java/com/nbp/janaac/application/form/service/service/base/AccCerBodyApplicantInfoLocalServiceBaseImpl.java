...
import com.nbp.janaac.application.form.service.service.AccCerBodyApplicantInfoLocalService;
...
/**
 * Provides the base implementation for the acc cer body applicant info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyApplicantInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyApplicantInfoLocalServiceImpl
 * @generated
 */
public abstract class AccCerBodyApplicantInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccCerBodyApplicantInfoLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyApplicantInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyApplicantInfoLocalServiceUtil</code>.
	 */
	...
	public AccCerBodyApplicantInfo addAccCerBodyApplicantInfo(
		...
		return accCerBodyApplicantInfoPersistence.update(
	...
	public AccCerBodyApplicantInfo createAccCerBodyApplicantInfo(
		...
		return accCerBodyApplicantInfoPersistence.create(
	...
	public AccCerBodyApplicantInfo deleteAccCerBodyApplicantInfo(
		...
		return accCerBodyApplicantInfoPersistence.remove(
			accCerBodyApplicantInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accCerBodyApplicantInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccCerBodyApplicantInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accCerBodyApplicantInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accCerBodyApplicantInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AccCerBodyApplicantInfo fetchAccCerBodyApplicantInfo(
		...
		return accCerBodyApplicantInfoPersistence.fetchByPrimaryKey(
			accCerBodyApplicantInfoId);
	}
	...
	public AccCerBodyApplicantInfo fetchAccCerBodyApplicantInfoByUuidAndGroupId(
		...
		return accCerBodyApplicantInfoPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AccCerBodyApplicantInfo getAccCerBodyApplicantInfo(
		...
		return accCerBodyApplicantInfoPersistence.findByPrimaryKey(
			accCerBodyApplicantInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccCerBodyApplicantInfo.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accCerBodyApplicantInfo);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					AccCerBodyApplicantInfo.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccCerBodyApplicantInfoLocalServiceImpl#deleteAccCerBodyApplicantInfo(AccCerBodyApplicantInfo) to avoid orphaned data");
		}

		return accCerBodyApplicantInfoLocalService.
			deleteAccCerBodyApplicantInfo(
				(AccCerBodyApplicantInfo)persistedModel);
	}

	@Override
	public BasePersistence<AccCerBodyApplicantInfo> getBasePersistence() {
		return accCerBodyApplicantInfoPersistence;
	}
	...
	public List<AccCerBodyApplicantInfo>
		...
		return accCerBodyApplicantInfoPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccCerBodyApplicantInfo>
		...
		return accCerBodyApplicantInfoPersistence.findByUuid_C(
	...
	public AccCerBodyApplicantInfo getAccCerBodyApplicantInfoByUuidAndGroupId(
		...
		return accCerBodyApplicantInfoPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AccCerBodyApplicantInfo> getAccCerBodyApplicantInfos(
		...
		return accCerBodyApplicantInfoPersistence.findAll(start, end);
	}
	...
	public int getAccCerBodyApplicantInfosCount() {
		return accCerBodyApplicantInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		accCerBodyApplicantInfoLocalService =
			(AccCerBodyApplicantInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyApplicantInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accCerBodyApplicantInfoPersistence.getDataSource();
	...
	protected AccCerBodyApplicantInfoLocalService
		accCerBodyApplicantInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyApplicantInfoLocalServiceBaseImpl.class);
