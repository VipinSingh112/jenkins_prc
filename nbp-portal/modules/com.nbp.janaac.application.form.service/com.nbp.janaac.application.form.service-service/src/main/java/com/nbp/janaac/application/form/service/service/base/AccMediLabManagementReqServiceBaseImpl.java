...
import com.nbp.janaac.application.form.service.service.AccMediLabManagementReqService;
...
/**
 * Provides the base implementation for the acc medi lab management req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabManagementReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabManagementReqServiceImpl
 * @generated
 */
public abstract class AccMediLabManagementReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabManagementReqService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabManagementReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabManagementReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabManagementReqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabManagementReqService =
			(AccMediLabManagementReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabManagementReqService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AccMediLabManagementReqLocalService accMediLabManagementReqLocalService;

	protected AccMediLabManagementReqService accMediLabManagementReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabManagementReqServiceBaseImpl.class);
