...
import com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalSecService;
...
/**
 * Provides the base implementation for the add lab medical physical sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalSecServiceImpl
 * @generated
 */
public abstract class AddLabMedicalPhysicalSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabMedicalPhysicalSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalPhysicalSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabMedicalPhysicalSecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabMedicalPhysicalSecService =
			(AddLabMedicalPhysicalSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalPhysicalSecService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabMedicalPhysicalSecPersistence.getDataSource();
	...
	protected AddLabMedicalPhysicalSecService addLabMedicalPhysicalSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalPhysicalSecServiceBaseImpl.class);
