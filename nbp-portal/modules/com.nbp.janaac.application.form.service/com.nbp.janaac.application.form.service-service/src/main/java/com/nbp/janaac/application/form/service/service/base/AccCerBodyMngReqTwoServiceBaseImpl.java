...
import com.nbp.janaac.application.form.service.service.AccCerBodyMngReqTwoService;
...
/**
 * Provides the base implementation for the acc cer body mng req two remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyMngReqTwoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyMngReqTwoServiceImpl
 * @generated
 */
public abstract class AccCerBodyMngReqTwoServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyMngReqTwoService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyMngReqTwoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyMngReqTwoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyMngReqTwoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyMngReqTwoService = (AccCerBodyMngReqTwoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyMngReqTwoService.class.getName();
	}
	...
	protected AccCerBodyMngReqTwoService accCerBodyMngReqTwoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyMngReqTwoServiceBaseImpl.class);
