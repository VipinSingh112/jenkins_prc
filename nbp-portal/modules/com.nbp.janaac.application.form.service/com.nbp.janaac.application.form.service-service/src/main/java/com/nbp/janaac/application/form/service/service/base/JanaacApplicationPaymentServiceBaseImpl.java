...
import com.nbp.janaac.application.form.service.service.JanaacApplicationPaymentService;
...
/**
 * Provides the base implementation for the janaac application payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.JanaacApplicationPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.JanaacApplicationPaymentServiceImpl
 * @generated
 */
public abstract class JanaacApplicationPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   JanaacApplicationPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JanaacApplicationPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.JanaacApplicationPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JanaacApplicationPaymentService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		janaacApplicationPaymentService =
			(JanaacApplicationPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JanaacApplicationPaymentService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				janaacApplicationPaymentPersistence.getDataSource();
	...
	protected JanaacApplicationPaymentService janaacApplicationPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JanaacApplicationPaymentServiceBaseImpl.class);
