...
import com.nbp.janaac.application.form.service.service.AddCerScopeServiceThirdService;
...
/**
 * Provides the base implementation for the add cer scope service third remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceThirdServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceThirdServiceImpl
 * @generated
 */
public abstract class AddCerScopeServiceThirdServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerScopeServiceThirdService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerScopeServiceThirdService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerScopeServiceThirdServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerScopeServiceThirdService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerScopeServiceThirdService =
			(AddCerScopeServiceThirdService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerScopeServiceThirdService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		AddCerScopeServiceThirdLocalService addCerScopeServiceThirdLocalService;

	protected AddCerScopeServiceThirdService addCerScopeServiceThirdService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerScopeServiceThirdServiceBaseImpl.class);
