...
import com.nbp.janaac.application.form.service.service.JanaacApplicationPaymentLocalService;
...
/**
 * Provides the base implementation for the janaac application payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.JanaacApplicationPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.JanaacApplicationPaymentLocalServiceImpl
 * @generated
 */
public abstract class JanaacApplicationPaymentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JanaacApplicationPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.JanaacApplicationPaymentLocalServiceUtil</code>.
	 */
	...
	public JanaacApplicationPayment addJanaacApplicationPayment(
		...
		return janaacApplicationPaymentPersistence.update(
	...
	public JanaacApplicationPayment createJanaacApplicationPayment(
		...
		return janaacApplicationPaymentPersistence.create(
	...
	public JanaacApplicationPayment deleteJanaacApplicationPayment(
		...
		return janaacApplicationPaymentPersistence.remove(
			janaacApplicationPaymentId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return janaacApplicationPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JanaacApplicationPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return janaacApplicationPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return janaacApplicationPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public JanaacApplicationPayment fetchJanaacApplicationPayment(
		...
		return janaacApplicationPaymentPersistence.fetchByPrimaryKey(
			janaacApplicationPaymentId);
	}
	...
	public JanaacApplicationPayment getJanaacApplicationPayment(
		...
		return janaacApplicationPaymentPersistence.findByPrimaryKey(
			janaacApplicationPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(JanaacApplicationPayment.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			JanaacApplicationPayment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement JanaacApplicationPaymentLocalServiceImpl#deleteJanaacApplicationPayment(JanaacApplicationPayment) to avoid orphaned data");
		}

		return janaacApplicationPaymentLocalService.
			deleteJanaacApplicationPayment(
				(JanaacApplicationPayment)persistedModel);
	}

	@Override
	public BasePersistence<JanaacApplicationPayment> getBasePersistence() {
		return janaacApplicationPaymentPersistence;
	}
	...
	public List<JanaacApplicationPayment> getJanaacApplicationPayments(
		...
		return janaacApplicationPaymentPersistence.findAll(start, end);
	}
	...
	public int getJanaacApplicationPaymentsCount() {
		return janaacApplicationPaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		janaacApplicationPaymentLocalService =
			(JanaacApplicationPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JanaacApplicationPaymentLocalService.class.getName();
	}
	...
	protected JanaacApplicationPaymentLocalService
		janaacApplicationPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JanaacApplicationPaymentLocalServiceBaseImpl.class);
