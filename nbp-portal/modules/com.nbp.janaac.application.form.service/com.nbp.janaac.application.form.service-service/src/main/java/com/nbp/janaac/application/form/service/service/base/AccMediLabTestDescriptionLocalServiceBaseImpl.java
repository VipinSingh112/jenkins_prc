...
import com.nbp.janaac.application.form.service.service.AccMediLabTestDescriptionLocalService;
...
/**
 * Provides the base implementation for the acc medi lab test description local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestDescriptionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestDescriptionLocalServiceImpl
 * @generated
 */
public abstract class AccMediLabTestDescriptionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccMediLabTestDescriptionLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestDescriptionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestDescriptionLocalServiceUtil</code>.
	 */
	...
	public AccMediLabTestDescription addAccMediLabTestDescription(
		...
		return accMediLabTestDescriptionPersistence.update(
	...
	public AccMediLabTestDescription createAccMediLabTestDescription(
		...
		return accMediLabTestDescriptionPersistence.create(
	...
	public AccMediLabTestDescription deleteAccMediLabTestDescription(
		...
		return accMediLabTestDescriptionPersistence.remove(
			accMediLabTestDescriptionId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accMediLabTestDescriptionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccMediLabTestDescription.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accMediLabTestDescriptionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accMediLabTestDescriptionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AccMediLabTestDescription fetchAccMediLabTestDescription(
		...
		return accMediLabTestDescriptionPersistence.fetchByPrimaryKey(
			accMediLabTestDescriptionId);
	}
	...
	public AccMediLabTestDescription
		...
		return accMediLabTestDescriptionPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public AccMediLabTestDescription getAccMediLabTestDescription(
		...
		return accMediLabTestDescriptionPersistence.findByPrimaryKey(
			accMediLabTestDescriptionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccMediLabTestDescription.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AccMediLabTestDescription.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accMediLabTestDescription);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccMediLabTestDescriptionLocalServiceImpl#deleteAccMediLabTestDescription(AccMediLabTestDescription) to avoid orphaned data");
		}

		return accMediLabTestDescriptionLocalService.
			deleteAccMediLabTestDescription(
				(AccMediLabTestDescription)persistedModel);
	}

	@Override
	public BasePersistence<AccMediLabTestDescription> getBasePersistence() {
		return accMediLabTestDescriptionPersistence;
	}
	...
	public List<AccMediLabTestDescription>
		...
		return accMediLabTestDescriptionPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public AccMediLabTestDescription
		...
		return accMediLabTestDescriptionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AccMediLabTestDescription> getAccMediLabTestDescriptions(
		...
		return accMediLabTestDescriptionPersistence.findAll(start, end);
	}
	...
	public int getAccMediLabTestDescriptionsCount() {
		return accMediLabTestDescriptionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabTestDescriptionLocalService =
			(AccMediLabTestDescriptionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestDescriptionLocalService.class.getName();
	}
	...
	protected AccMediLabTestDescriptionLocalService
		accMediLabTestDescriptionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestDescriptionLocalServiceBaseImpl.class);
