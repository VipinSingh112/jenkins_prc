...
import com.nbp.janaac.application.form.service.service.AddLaboratoryPartOfOrgService;
...
/**
 * Provides the base implementation for the add laboratory part of org remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLaboratoryPartOfOrgServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLaboratoryPartOfOrgServiceImpl
 * @generated
 */
public abstract class AddLaboratoryPartOfOrgServiceBaseImpl
	extends BaseServiceImpl
	implements AddLaboratoryPartOfOrgService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLaboratoryPartOfOrgService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLaboratoryPartOfOrgServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLaboratoryPartOfOrgService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLaboratoryPartOfOrgService = (AddLaboratoryPartOfOrgService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLaboratoryPartOfOrgService.class.getName();
	}
	...
	protected AddLaboratoryPartOfOrgService addLaboratoryPartOfOrgService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLaboratoryPartOfOrgServiceBaseImpl.class);
