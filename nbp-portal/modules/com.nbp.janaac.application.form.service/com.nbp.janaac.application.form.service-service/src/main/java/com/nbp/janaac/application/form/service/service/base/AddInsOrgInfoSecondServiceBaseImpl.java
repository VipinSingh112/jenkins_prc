...
import com.nbp.janaac.application.form.service.service.AddInsOrgInfoSecondService;
...
/**
 * Provides the base implementation for the add ins org info second remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoSecondServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoSecondServiceImpl
 * @generated
 */
public abstract class AddInsOrgInfoSecondServiceBaseImpl
	extends BaseServiceImpl
	implements AddInsOrgInfoSecondService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsOrgInfoSecondService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsOrgInfoSecondServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsOrgInfoSecondService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addInsOrgInfoSecondService = (AddInsOrgInfoSecondService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsOrgInfoSecondService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addInsOrgInfoSecondPersistence.getDataSource();
	...
	protected AddInsOrgInfoSecondService addInsOrgInfoSecondService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsOrgInfoSecondServiceBaseImpl.class);
