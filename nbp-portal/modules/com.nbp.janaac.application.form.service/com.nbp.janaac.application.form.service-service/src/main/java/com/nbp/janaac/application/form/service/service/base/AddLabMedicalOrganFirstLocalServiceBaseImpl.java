...
import com.nbp.janaac.application.form.service.service.AddLabMedicalOrganFirstLocalService;
...
/**
 * Provides the base implementation for the add lab medical organ first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganFirstLocalServiceImpl
 * @generated
 */
public abstract class AddLabMedicalOrganFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabMedicalOrganFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalOrganFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalOrganFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabMedicalOrganFirst addAddLabMedicalOrganFirst(
		AddLabMedicalOrganFirst addLabMedicalOrganFirst) {

		addLabMedicalOrganFirst.setNew(true);

		return addLabMedicalOrganFirstPersistence.update(
	...
	public AddLabMedicalOrganFirst createAddLabMedicalOrganFirst(
		long addLabMedicalOrganFirstId) {

		return addLabMedicalOrganFirstPersistence.create(
	...
	@Override
	public AddLabMedicalOrganFirst deleteAddLabMedicalOrganFirst(
			long addLabMedicalOrganFirstId)
		throws PortalException {

		return addLabMedicalOrganFirstPersistence.remove(
			addLabMedicalOrganFirstId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabMedicalOrganFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabMedicalOrganFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabMedicalOrganFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabMedicalOrganFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabMedicalOrganFirst fetchAddLabMedicalOrganFirst(
		long addLabMedicalOrganFirstId) {

		return addLabMedicalOrganFirstPersistence.fetchByPrimaryKey(
			addLabMedicalOrganFirstId);
	}
	 ...
	 */
	@Override
	public AddLabMedicalOrganFirst getAddLabMedicalOrganFirst(
			long addLabMedicalOrganFirstId)
		throws PortalException {

		return addLabMedicalOrganFirstPersistence.findByPrimaryKey(
			addLabMedicalOrganFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabMedicalOrganFirst.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabMedicalOrganFirstLocalServiceImpl#deleteAddLabMedicalOrganFirst(AddLabMedicalOrganFirst) to avoid orphaned data");
		}

		return addLabMedicalOrganFirstLocalService.
			deleteAddLabMedicalOrganFirst(
				(AddLabMedicalOrganFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddLabMedicalOrganFirst> getBasePersistence() {
		return addLabMedicalOrganFirstPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabMedicalOrganFirst> getAddLabMedicalOrganFirsts(
		int start, int end) {

		return addLabMedicalOrganFirstPersistence.findAll(start, end);
	}
	...
	public int getAddLabMedicalOrganFirstsCount() {
		return addLabMedicalOrganFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabMedicalOrganFirst updateAddLabMedicalOrganFirst(
		AddLabMedicalOrganFirst addLabMedicalOrganFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabMedicalOrganFirstLocalService =
			(AddLabMedicalOrganFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalOrganFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabMedicalOrganFirstPersistence.getDataSource();
	...
	protected AddLabMedicalOrganFirstLocalService
		addLabMedicalOrganFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalOrganFirstLocalServiceBaseImpl.class);
