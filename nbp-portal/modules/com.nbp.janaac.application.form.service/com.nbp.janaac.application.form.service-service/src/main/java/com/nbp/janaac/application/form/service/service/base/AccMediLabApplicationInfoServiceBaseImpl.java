...
import com.nbp.janaac.application.form.service.service.AccMediLabApplicationInfoService;
...
/**
 * Provides the base implementation for the acc medi lab application info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabApplicationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabApplicationInfoServiceImpl
 * @generated
 */
public abstract class AccMediLabApplicationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabApplicationInfoService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabApplicationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabApplicationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabApplicationInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabApplicationInfoService =
			(AccMediLabApplicationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabApplicationInfoService.class.getName();
	}
	...
	protected AccMediLabApplicationInfoService accMediLabApplicationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabApplicationInfoServiceBaseImpl.class);
