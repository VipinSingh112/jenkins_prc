...
import com.nbp.janaac.application.form.service.service.JanaacApplicationService;
...
/**
 * Provides the base implementation for the janaac application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.JanaacApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.JanaacApplicationServiceImpl
 * @generated
 */
public abstract class JanaacApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JanaacApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JanaacApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.JanaacApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JanaacApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		janaacApplicationService = (JanaacApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JanaacApplicationService.class.getName();
	}
	...
	protected JanaacApplicationService janaacApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JanaacApplicationServiceBaseImpl.class);
