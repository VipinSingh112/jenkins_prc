...
import com.nbp.janaac.application.form.service.service.AddLabCalibraStrucReqSecLocalService;
...
/**
 * Provides the base implementation for the add lab calibra struc req sec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabCalibraStrucReqSecLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabCalibraStrucReqSecLocalServiceImpl
 * @generated
 */
public abstract class AddLabCalibraStrucReqSecLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabCalibraStrucReqSecLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabCalibraStrucReqSecLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabCalibraStrucReqSecLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabCalibraStrucReqSec addAddLabCalibraStrucReqSec(
		AddLabCalibraStrucReqSec addLabCalibraStrucReqSec) {

		addLabCalibraStrucReqSec.setNew(true);

		return addLabCalibraStrucReqSecPersistence.update(
	...
	public AddLabCalibraStrucReqSec createAddLabCalibraStrucReqSec(
		long addLabCalibraStrucReqSecId) {

		return addLabCalibraStrucReqSecPersistence.create(
	...
	@Override
	public AddLabCalibraStrucReqSec deleteAddLabCalibraStrucReqSec(
			long addLabCalibraStrucReqSecId)
		throws PortalException {

		return addLabCalibraStrucReqSecPersistence.remove(
			addLabCalibraStrucReqSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabCalibraStrucReqSecPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabCalibraStrucReqSec.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabCalibraStrucReqSecPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabCalibraStrucReqSecPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabCalibraStrucReqSec fetchAddLabCalibraStrucReqSec(
		long addLabCalibraStrucReqSecId) {

		return addLabCalibraStrucReqSecPersistence.fetchByPrimaryKey(
			addLabCalibraStrucReqSecId);
	}
	 ...
	 */
	@Override
	public AddLabCalibraStrucReqSec getAddLabCalibraStrucReqSec(
			long addLabCalibraStrucReqSecId)
		throws PortalException {

		return addLabCalibraStrucReqSecPersistence.findByPrimaryKey(
			addLabCalibraStrucReqSecId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabCalibraStrucReqSec.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AddLabCalibraStrucReqSec.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabCalibraStrucReqSecLocalServiceImpl#deleteAddLabCalibraStrucReqSec(AddLabCalibraStrucReqSec) to avoid orphaned data");
		}

		return addLabCalibraStrucReqSecLocalService.
			deleteAddLabCalibraStrucReqSec(
				(AddLabCalibraStrucReqSec)persistedModel);
	}

	@Override
	public BasePersistence<AddLabCalibraStrucReqSec> getBasePersistence() {
		return addLabCalibraStrucReqSecPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabCalibraStrucReqSec> getAddLabCalibraStrucReqSecs(
		int start, int end) {

		return addLabCalibraStrucReqSecPersistence.findAll(start, end);
	}
	...
	public int getAddLabCalibraStrucReqSecsCount() {
		return addLabCalibraStrucReqSecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabCalibraStrucReqSec updateAddLabCalibraStrucReqSec(
		AddLabCalibraStrucReqSec addLabCalibraStrucReqSec) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabCalibraStrucReqSecLocalService =
			(AddLabCalibraStrucReqSecLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabCalibraStrucReqSecLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return AddLabCalibraStrucReqSec.class;
	}

	protected String getModelClassName() {
		return AddLabCalibraStrucReqSec.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabCalibraStrucReqSecPersistence.getDataSource();
	...
	protected AddLabCalibraStrucReqSecLocalService
		addLabCalibraStrucReqSecLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabCalibraStrucReqSecLocalServiceBaseImpl.class);
