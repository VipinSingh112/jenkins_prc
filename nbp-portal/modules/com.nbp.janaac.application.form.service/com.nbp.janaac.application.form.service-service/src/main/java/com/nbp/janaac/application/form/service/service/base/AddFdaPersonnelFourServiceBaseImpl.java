...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelFourService;
...
/**
 * Provides the base implementation for the add fda personnel four remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFourServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFourServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelFourServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaPersonnelFourService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelFourService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelFourServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaPersonnelFourService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelFourService = (AddFdaPersonnelFourService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelFourService.class.getName();
	}
	...
	protected AddFdaPersonnelFourService addFdaPersonnelFourService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelFourServiceBaseImpl.class);
