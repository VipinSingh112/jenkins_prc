...
import com.nbp.janaac.application.form.service.service.AccCerBodyScopeLocalService;
...
/**
 * Provides the base implementation for the acc cer body scope local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyScopeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyScopeLocalServiceImpl
 * @generated
 */
public abstract class AccCerBodyScopeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccCerBodyScopeLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyScopeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyScopeLocalServiceUtil</code>.
	 */
	...
	public AccCerBodyScope addAccCerBodyScope(AccCerBodyScope accCerBodyScope) {
		...
		return accCerBodyScopePersistence.update(accCerBodyScope);
	}
	...
	public AccCerBodyScope createAccCerBodyScope(long accCerBodyScopeId) {
		return accCerBodyScopePersistence.create(accCerBodyScopeId);
	}
	...
	public AccCerBodyScope deleteAccCerBodyScope(long accCerBodyScopeId)
		...
		return accCerBodyScopePersistence.remove(accCerBodyScopeId);
	}
	...
	public AccCerBodyScope deleteAccCerBodyScope(
		...
		return accCerBodyScopePersistence.remove(accCerBodyScope);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accCerBodyScopePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccCerBodyScope.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accCerBodyScopePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return accCerBodyScopePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accCerBodyScopePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return accCerBodyScopePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AccCerBodyScope fetchAccCerBodyScope(long accCerBodyScopeId) {
		return accCerBodyScopePersistence.fetchByPrimaryKey(accCerBodyScopeId);
	}
	...
	public AccCerBodyScope fetchAccCerBodyScopeByUuidAndGroupId(
		...
		return accCerBodyScopePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AccCerBodyScope getAccCerBodyScope(long accCerBodyScopeId)
		...
		return accCerBodyScopePersistence.findByPrimaryKey(accCerBodyScopeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accCerBodyScopeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccCerBodyScope.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accCerBodyScopeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			accCerBodyScopeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccCerBodyScope.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AccCerBodyScope>() {

				@Override
				public void performAction(AccCerBodyScope accCerBodyScope)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accCerBodyScope);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyScopePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccCerBodyScopeLocalServiceImpl#deleteAccCerBodyScope(AccCerBodyScope) to avoid orphaned data");
		}

		return accCerBodyScopeLocalService.deleteAccCerBodyScope(
			(AccCerBodyScope)persistedModel);
	}

	@Override
	public BasePersistence<AccCerBodyScope> getBasePersistence() {
		return accCerBodyScopePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyScopePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccCerBodyScope> getAccCerBodyScopesByUuidAndCompanyId(
		...
		return accCerBodyScopePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccCerBodyScope> getAccCerBodyScopesByUuidAndCompanyId(
		...
		return accCerBodyScopePersistence.findByUuid_C(
	...
	public AccCerBodyScope getAccCerBodyScopeByUuidAndGroupId(
		...
		return accCerBodyScopePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AccCerBodyScope> getAccCerBodyScopes(int start, int end) {
		return accCerBodyScopePersistence.findAll(start, end);
	}
	...
	public int getAccCerBodyScopesCount() {
		return accCerBodyScopePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyScopeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accCerBodyScopeLocalService = (AccCerBodyScopeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyScopeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accCerBodyScopePersistence.getDataSource();
	...
	protected AccCerBodyScopeLocalService accCerBodyScopeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyScopeLocalServiceBaseImpl.class);
