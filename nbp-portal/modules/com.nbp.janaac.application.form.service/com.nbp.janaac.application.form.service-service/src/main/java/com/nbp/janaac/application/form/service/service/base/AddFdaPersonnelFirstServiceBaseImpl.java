...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelFirstService;
...
/**
 * Provides the base implementation for the add fda personnel first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFirstServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaPersonnelFirstService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaPersonnelFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelFirstService = (AddFdaPersonnelFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelFirstService.class.getName();
	}
	...
	protected AddFdaPersonnelFirstService addFdaPersonnelFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelFirstServiceBaseImpl.class);
