...
import com.nbp.janaac.application.form.service.service.AddInsApplicationInfoService;
...
/**
 * Provides the base implementation for the add ins application info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsApplicationInfoServiceImpl
 * @generated
 */
public abstract class AddInsApplicationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AddInsApplicationInfoService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsApplicationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsApplicationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsApplicationInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addInsApplicationInfoService = (AddInsApplicationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsApplicationInfoService.class.getName();
	}
	...
	protected AddInsApplicationInfoService addInsApplicationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsApplicationInfoServiceBaseImpl.class);
