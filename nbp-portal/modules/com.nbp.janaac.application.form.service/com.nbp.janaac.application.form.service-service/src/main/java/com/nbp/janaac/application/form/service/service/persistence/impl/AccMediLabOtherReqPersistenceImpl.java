...
import com.nbp.janaac.application.form.service.model.AccMediLabOtherReqTable;
import com.nbp.janaac.application.form.service.model.impl.AccMediLabOtherReqImpl;
import com.nbp.janaac.application.form.service.model.impl.AccMediLabOtherReqModelImpl;
import com.nbp.janaac.application.form.service.service.persistence.AccMediLabOtherReqPersistence;
import com.nbp.janaac.application.form.service.service.persistence.AccMediLabOtherReqUtil;
...
/**
 * The persistence implementation for the acc medi lab other req service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccMediLabOtherReqPersistence.class)
public class AccMediLabOtherReqPersistenceImpl
	extends BasePersistenceImpl<AccMediLabOtherReq>
	implements AccMediLabOtherReqPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccMediLabOtherReqUtil</code> to access the acc medi lab other req persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccMediLabOtherReqImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findByUuid(
	...
	public List<AccMediLabOtherReq> findByUuid(
		...
		List<AccMediLabOtherReq> list = null;

		if (useFinderCache) {
			list = (List<AccMediLabOtherReq>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccMediLabOtherReq accMediLabOtherReq : list) {
					if (!uuid.equals(accMediLabOtherReq.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCMEDILABOTHERREQ_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccMediLabOtherReqModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccMediLabOtherReq>)QueryUtil.list(
	...
	public AccMediLabOtherReq findByUuid_First(
		...
		AccMediLabOtherReq accMediLabOtherReq = fetchByUuid_First(
			uuid, orderByComparator);

		if (accMediLabOtherReq != null) {
			return accMediLabOtherReq;
		}
		...
		throw new NoSuchAccMediLabOtherReqException(sb.toString());
	}
	...
	public AccMediLabOtherReq fetchByUuid_First(
		...
		List<AccMediLabOtherReq> list = findByUuid(
	...
	public AccMediLabOtherReq findByUuid_Last(
		...
		AccMediLabOtherReq accMediLabOtherReq = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccMediLabOtherReq[] findByUuid_PrevAndNext(
		...
		AccMediLabOtherReq accMediLabOtherReq = findByPrimaryKey(
		...
		try {
			...
			AccMediLabOtherReq[] array = new AccMediLabOtherReqImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accMediLabOtherReq, uuid, orderByComparator, true);

			array[1] = accMediLabOtherReq;

			array[2] = getByUuid_PrevAndNext(
				session, accMediLabOtherReq, uuid, orderByComparator, false);
	...
	protected AccMediLabOtherReq getByUuid_PrevAndNext(
		Session session, AccMediLabOtherReq accMediLabOtherReq, String uuid,
		OrderByComparator<AccMediLabOtherReq> orderByComparator,
		boolean previous) {
		...
		List<AccMediLabOtherReq> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccMediLabOtherReq accMediLabOtherReq :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accMediLabOtherReq);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCMEDILABOTHERREQ_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accMediLabOtherReq.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accMediLabOtherReq.uuid IS NULL OR accMediLabOtherReq.uuid = '')";
	...
	public AccMediLabOtherReq findByUUID_G(String uuid, long groupId)
		...
		AccMediLabOtherReq accMediLabOtherReq = fetchByUUID_G(uuid, groupId);
	...
	public AccMediLabOtherReq fetchByUUID_G(
		...
		if (result instanceof AccMediLabOtherReq) {
			AccMediLabOtherReq accMediLabOtherReq = (AccMediLabOtherReq)result;

			if (!Objects.equals(uuid, accMediLabOtherReq.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AccMediLabOtherReq accMediLabOtherReq = list.get(0);

					result = accMediLabOtherReq;

					cacheResult(accMediLabOtherReq);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccMediLabOtherReq)result;
		}
	}
	...
	public AccMediLabOtherReq removeByUUID_G(String uuid, long groupId)
		...
		AccMediLabOtherReq accMediLabOtherReq = findByUUID_G(uuid, groupId);

		return remove(accMediLabOtherReq);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accMediLabOtherReq.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accMediLabOtherReq.uuid IS NULL OR accMediLabOtherReq.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accMediLabOtherReq.groupId = ?";
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findByUuid_C(
	...
	public AccMediLabOtherReq findByUuid_C_First(
		...
		AccMediLabOtherReq accMediLabOtherReq = fetchByUuid_C_First(
	...
	public AccMediLabOtherReq fetchByUuid_C_First(
		...
		List<AccMediLabOtherReq> list = findByUuid_C(
	...
	public AccMediLabOtherReq findByUuid_C_Last(
		...
		AccMediLabOtherReq accMediLabOtherReq = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccMediLabOtherReq[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accMediLabOtherReq, uuid, companyId, orderByComparator,
				true);
	...
	protected AccMediLabOtherReq getByUuid_C_PrevAndNext(
		Session session, AccMediLabOtherReq accMediLabOtherReq, String uuid,
		long companyId, OrderByComparator<AccMediLabOtherReq> orderByComparator,
		boolean previous) {
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccMediLabOtherReqPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	public AccMediLabOtherReq removeBygetJANAAC_ByApplicationId(
		...
		AccMediLabOtherReq accMediLabOtherReq = findBygetJANAAC_ByApplicationId(
			janaacApplicationId);
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accMediLabOtherReq.janaacApplicationId = ?";

	public AccMediLabOtherReqPersistenceImpl() {
		...
		setModelClass(AccMediLabOtherReq.class);

		setModelImplClass(AccMediLabOtherReqImpl.class);
		setModelPKClass(long.class);

		setTable(AccMediLabOtherReqTable.INSTANCE);
	}
	...
	public void cacheResult(AccMediLabOtherReq accMediLabOtherReq) {
		entityCache.putResult(
			AccMediLabOtherReqImpl.class, accMediLabOtherReq.getPrimaryKey(),
			accMediLabOtherReq);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accMediLabOtherReq.getUuid(), accMediLabOtherReq.getGroupId()
			},
			accMediLabOtherReq);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accMediLabOtherReq.getJanaacApplicationId()},
			accMediLabOtherReq);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<AccMediLabOtherReq> accMediLabOtherReqs) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (accMediLabOtherReqs.size() >
				 _valueObjectFinderCacheListThreshold))) {

			return;
		}

		for (AccMediLabOtherReq accMediLabOtherReq : accMediLabOtherReqs) {
			if (entityCache.getResult(
					AccMediLabOtherReqImpl.class,
					accMediLabOtherReq.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc medi lab other reqs.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccMediLabOtherReqImpl.class);

		finderCache.clearCache(AccMediLabOtherReqImpl.class);
	}

	/**
	 * Clears the cache for the acc medi lab other req.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccMediLabOtherReq accMediLabOtherReq) {
		entityCache.removeResult(
			AccMediLabOtherReqImpl.class, accMediLabOtherReq);
	}

	@Override
	public void clearCache(List<AccMediLabOtherReq> accMediLabOtherReqs) {
		for (AccMediLabOtherReq accMediLabOtherReq : accMediLabOtherReqs) {
			entityCache.removeResult(
				AccMediLabOtherReqImpl.class, accMediLabOtherReq);
		}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(AccMediLabOtherReqImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		AccMediLabOtherReqModelImpl accMediLabOtherReqModelImpl) {

		Object[] args = new Object[] {
			accMediLabOtherReqModelImpl.getUuid(),
			accMediLabOtherReqModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accMediLabOtherReqModelImpl);

		args = new Object[] {
			accMediLabOtherReqModelImpl.getJanaacApplicationId()
		};
	...
	public AccMediLabOtherReq create(long accMediLabOtherReqId) {
		AccMediLabOtherReq accMediLabOtherReq = new AccMediLabOtherReqImpl();

		accMediLabOtherReq.setNew(true);
		accMediLabOtherReq.setPrimaryKey(accMediLabOtherReqId);

		String uuid = PortalUUIDUtil.generate();

		accMediLabOtherReq.setUuid(uuid);

		accMediLabOtherReq.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public AccMediLabOtherReq remove(long accMediLabOtherReqId)
		...
		return remove((Serializable)accMediLabOtherReqId);
	}

	/**
	 * Removes the acc medi lab other req with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc medi lab other req
	 * @return the acc medi lab other req that was removed
	 * @throws NoSuchAccMediLabOtherReqException if a acc medi lab other req with the primary key could not be found
	 */
	@Override
	public AccMediLabOtherReq remove(Serializable primaryKey)
		throws NoSuchAccMediLabOtherReqException {
		...
		try {
			...
			AccMediLabOtherReq accMediLabOtherReq =
				(AccMediLabOtherReq)session.get(
					AccMediLabOtherReqImpl.class, primaryKey);
			...
			if (accMediLabOtherReq == null) {
				...
				throw new NoSuchAccMediLabOtherReqException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accMediLabOtherReq);
		}
		catch (NoSuchAccMediLabOtherReqException noSuchEntityException) {
	...
	@Override
	protected AccMediLabOtherReq removeImpl(
		AccMediLabOtherReq accMediLabOtherReq) {
		...
		try {
			...
			if (!session.contains(accMediLabOtherReq)) {
				accMediLabOtherReq = (AccMediLabOtherReq)session.get(
					AccMediLabOtherReqImpl.class,
					accMediLabOtherReq.getPrimaryKeyObj());
			}

			if (accMediLabOtherReq != null) {
				session.delete(accMediLabOtherReq);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
	...
	@Override
	public AccMediLabOtherReq updateImpl(
		AccMediLabOtherReq accMediLabOtherReq) {

		boolean isNew = accMediLabOtherReq.isNew();

		if (!(accMediLabOtherReq instanceof AccMediLabOtherReqModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accMediLabOtherReq.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accMediLabOtherReq);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accMediLabOtherReq proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccMediLabOtherReq implementation " +
					accMediLabOtherReq.getClass());
		}

		AccMediLabOtherReqModelImpl accMediLabOtherReqModelImpl =
			(AccMediLabOtherReqModelImpl)accMediLabOtherReq;

		if (Validator.isNull(accMediLabOtherReq.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accMediLabOtherReq.getCreateDate() == null)) {
			if (serviceContext == null) {
				accMediLabOtherReq.setCreateDate(date);
			}
			else {
		...
		if (!accMediLabOtherReqModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accMediLabOtherReq.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accMediLabOtherReq);
			}
			else {
				accMediLabOtherReq = (AccMediLabOtherReq)session.merge(
					accMediLabOtherReq);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccMediLabOtherReqImpl.class, accMediLabOtherReqModelImpl, false,
			true);

		cacheUniqueFindersCache(accMediLabOtherReqModelImpl);

		if (isNew) {
			accMediLabOtherReq.setNew(false);
		}

		accMediLabOtherReq.resetOriginalValues();

		return accMediLabOtherReq;
	}

	/**
	 * Returns the acc medi lab other req with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc medi lab other req
	 ...
	 */
	@Override
	public AccMediLabOtherReq findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccMediLabOtherReqException {

		AccMediLabOtherReq accMediLabOtherReq = fetchByPrimaryKey(primaryKey);
	...
	public AccMediLabOtherReq findByPrimaryKey(long accMediLabOtherReqId)
		...
		return findByPrimaryKey((Serializable)accMediLabOtherReqId);
	}
	...
	public AccMediLabOtherReq fetchByPrimaryKey(long accMediLabOtherReqId) {
		return fetchByPrimaryKey((Serializable)accMediLabOtherReqId);
	}
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findAll() {
	 ...
	 */
	@Override
	public List<AccMediLabOtherReq> findAll(int start, int end) {
	...
	public List<AccMediLabOtherReq> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCMEDILABOTHERREQ);
				...
				sql = _SQL_SELECT_ACCMEDILABOTHERREQ;

				sql = sql.concat(AccMediLabOtherReqModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccMediLabOtherReq accMediLabOtherReq : findAll()) {
			remove(accMediLabOtherReq);
		}
	}
	...
	protected String getPKDBName() {
		return "accMediLabOtherReqId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCMEDILABOTHERREQ;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccMediLabOtherReqModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc medi lab other req persistence.
	 */
	@Activate
	public void activate() {
		...
		AccMediLabOtherReqUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccMediLabOtherReqUtil.setPersistence(null);

		entityCache.removeCache(AccMediLabOtherReqImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCMEDILABOTHERREQ =
		"SELECT accMediLabOtherReq FROM AccMediLabOtherReq accMediLabOtherReq";

	private static final String _SQL_SELECT_ACCMEDILABOTHERREQ_WHERE =
		"SELECT accMediLabOtherReq FROM AccMediLabOtherReq accMediLabOtherReq WHERE ";

	private static final String _SQL_COUNT_ACCMEDILABOTHERREQ =
		"SELECT COUNT(accMediLabOtherReq) FROM AccMediLabOtherReq accMediLabOtherReq";

	private static final String _SQL_COUNT_ACCMEDILABOTHERREQ_WHERE =
		"SELECT COUNT(accMediLabOtherReq) FROM AccMediLabOtherReq accMediLabOtherReq WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "accMediLabOtherReq.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccMediLabOtherReq exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccMediLabOtherReq exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabOtherReqPersistenceImpl.class);
