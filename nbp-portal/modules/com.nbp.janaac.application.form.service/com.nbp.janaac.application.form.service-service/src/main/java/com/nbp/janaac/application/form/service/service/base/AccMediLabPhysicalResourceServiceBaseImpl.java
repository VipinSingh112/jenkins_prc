...
import com.nbp.janaac.application.form.service.service.AccMediLabPhysicalResourceService;
...
/**
 * Provides the base implementation for the acc medi lab physical resource remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabPhysicalResourceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabPhysicalResourceServiceImpl
 * @generated
 */
public abstract class AccMediLabPhysicalResourceServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabPhysicalResourceService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabPhysicalResourceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabPhysicalResourceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabPhysicalResourceService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabPhysicalResourceService =
			(AccMediLabPhysicalResourceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabPhysicalResourceService.class.getName();
	}
	...
	protected AccMediLabPhysicalResourceService
		accMediLabPhysicalResourceService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabPhysicalResourceServiceBaseImpl.class);
