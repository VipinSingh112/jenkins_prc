...
import com.nbp.janaac.application.form.service.service.AccInsBodiesOrganizationService;
...
/**
 * Provides the base implementation for the acc ins bodies organization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOrganizationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOrganizationServiceImpl
 * @generated
 */
public abstract class AccInsBodiesOrganizationServiceBaseImpl
	extends BaseServiceImpl
	implements AccInsBodiesOrganizationService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccInsBodiesOrganizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccInsBodiesOrganizationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccInsBodiesOrganizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accInsBodiesOrganizationService =
			(AccInsBodiesOrganizationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccInsBodiesOrganizationService.class.getName();
	}
	...
	protected AccInsBodiesOrganizationService accInsBodiesOrganizationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesOrganizationServiceBaseImpl.class);
