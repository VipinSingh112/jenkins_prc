...
import com.nbp.janaac.application.form.service.service.AccMediLabTestStructuralService;
...
/**
 * Provides the base implementation for the acc medi lab test structural remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestStructuralServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestStructuralServiceImpl
 * @generated
 */
public abstract class AccMediLabTestStructuralServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabTestStructuralService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestStructuralService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestStructuralServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabTestStructuralService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabTestStructuralService =
			(AccMediLabTestStructuralService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestStructuralService.class.getName();
	}
	...
	protected AccMediLabTestStructuralService accMediLabTestStructuralService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestStructuralServiceBaseImpl.class);
