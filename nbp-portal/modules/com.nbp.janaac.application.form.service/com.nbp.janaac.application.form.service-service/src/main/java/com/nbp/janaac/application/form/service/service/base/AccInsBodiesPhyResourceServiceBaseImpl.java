...
import com.nbp.janaac.application.form.service.service.AccInsBodiesPhyResourceService;
...
/**
 * Provides the base implementation for the acc ins bodies phy resource remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccInsBodiesPhyResourceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccInsBodiesPhyResourceServiceImpl
 * @generated
 */
public abstract class AccInsBodiesPhyResourceServiceBaseImpl
	extends BaseServiceImpl
	implements AccInsBodiesPhyResourceService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccInsBodiesPhyResourceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccInsBodiesPhyResourceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccInsBodiesPhyResourceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accInsBodiesPhyResourceService =
			(AccInsBodiesPhyResourceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccInsBodiesPhyResourceService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accInsBodiesPhyResourcePersistence.getDataSource();
	...
	protected com.nbp.janaac.application.form.service.service.
		AccInsBodiesPhyResourceLocalService accInsBodiesPhyResourceLocalService;

	protected AccInsBodiesPhyResourceService accInsBodiesPhyResourceService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesPhyResourceServiceBaseImpl.class);
