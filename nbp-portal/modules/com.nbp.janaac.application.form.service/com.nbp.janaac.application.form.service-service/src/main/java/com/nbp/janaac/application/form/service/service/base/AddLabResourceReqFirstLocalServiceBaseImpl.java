...
import com.nbp.janaac.application.form.service.service.AddLabResourceReqFirstLocalService;
...
/**
 * Provides the base implementation for the add lab resource req first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqFirstLocalServiceImpl
 * @generated
 */
public abstract class AddLabResourceReqFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabResourceReqFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabResourceReqFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabResourceReqFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabResourceReqFirst addAddLabResourceReqFirst(
		AddLabResourceReqFirst addLabResourceReqFirst) {

		addLabResourceReqFirst.setNew(true);

		return addLabResourceReqFirstPersistence.update(addLabResourceReqFirst);
	}
	...
	public AddLabResourceReqFirst createAddLabResourceReqFirst(
		long addLabResourceReqFirstId) {

		return addLabResourceReqFirstPersistence.create(
	...
	@Override
	public AddLabResourceReqFirst deleteAddLabResourceReqFirst(
			long addLabResourceReqFirstId)
		throws PortalException {

		return addLabResourceReqFirstPersistence.remove(
			addLabResourceReqFirstId);
	}
	...
	public AddLabResourceReqFirst deleteAddLabResourceReqFirst(
		...
		return addLabResourceReqFirstPersistence.remove(addLabResourceReqFirst);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabResourceReqFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabResourceReqFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabResourceReqFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabResourceReqFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabResourceReqFirst fetchAddLabResourceReqFirst(
		long addLabResourceReqFirstId) {

		return addLabResourceReqFirstPersistence.fetchByPrimaryKey(
			addLabResourceReqFirstId);
	}
	 ...
	 */
	@Override
	public AddLabResourceReqFirst getAddLabResourceReqFirst(
			long addLabResourceReqFirstId)
		throws PortalException {

		return addLabResourceReqFirstPersistence.findByPrimaryKey(
			addLabResourceReqFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabResourceReqFirst.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabResourceReqFirstLocalServiceImpl#deleteAddLabResourceReqFirst(AddLabResourceReqFirst) to avoid orphaned data");
		}

		return addLabResourceReqFirstLocalService.deleteAddLabResourceReqFirst(
			(AddLabResourceReqFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddLabResourceReqFirst> getBasePersistence() {
		return addLabResourceReqFirstPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabResourceReqFirst> getAddLabResourceReqFirsts(
		int start, int end) {

		return addLabResourceReqFirstPersistence.findAll(start, end);
	}
	...
	public int getAddLabResourceReqFirstsCount() {
		return addLabResourceReqFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabResourceReqFirst updateAddLabResourceReqFirst(
		AddLabResourceReqFirst addLabResourceReqFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabResourceReqFirstLocalService =
			(AddLabResourceReqFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabResourceReqFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabResourceReqFirstPersistence.getDataSource();
	...
	protected AddLabResourceReqFirstLocalService
		addLabResourceReqFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabResourceReqFirstLocalServiceBaseImpl.class);
