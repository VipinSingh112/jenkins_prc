...
import com.nbp.janaac.application.form.service.service.AddPhyResourceSecService;
...
/**
 * Provides the base implementation for the add phy resource sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddPhyResourceSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddPhyResourceSecServiceImpl
 * @generated
 */
public abstract class AddPhyResourceSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddPhyResourceSecService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddPhyResourceSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddPhyResourceSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddPhyResourceSecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addPhyResourceSecService = (AddPhyResourceSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddPhyResourceSecService.class.getName();
	}
	...
	protected AddPhyResourceSecService addPhyResourceSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddPhyResourceSecServiceBaseImpl.class);
