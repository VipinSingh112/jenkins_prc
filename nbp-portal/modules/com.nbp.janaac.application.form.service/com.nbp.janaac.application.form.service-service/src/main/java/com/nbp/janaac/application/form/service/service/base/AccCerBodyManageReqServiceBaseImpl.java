...
import com.nbp.janaac.application.form.service.service.AccCerBodyManageReqService;
...
/**
 * Provides the base implementation for the acc cer body manage req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyManageReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyManageReqServiceImpl
 * @generated
 */
public abstract class AccCerBodyManageReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyManageReqService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyManageReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyManageReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyManageReqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyManageReqService = (AccCerBodyManageReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyManageReqService.class.getName();
	}
	...
	protected AccCerBodyManageReqService accCerBodyManageReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyManageReqServiceBaseImpl.class);
