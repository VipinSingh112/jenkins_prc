...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelFirstLocalService;
...
/**
 * Provides the base implementation for the add fda personnel first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelFirstLocalServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddFdaPersonnelFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddFdaPersonnelFirst addAddFdaPersonnelFirst(
		AddFdaPersonnelFirst addFdaPersonnelFirst) {

		addFdaPersonnelFirst.setNew(true);

		return addFdaPersonnelFirstPersistence.update(addFdaPersonnelFirst);
	}
	...
	public AddFdaPersonnelFirst createAddFdaPersonnelFirst(
		long addFdaPersonnelFirstId) {

		return addFdaPersonnelFirstPersistence.create(addFdaPersonnelFirstId);
	}
	...
	@Override
	public AddFdaPersonnelFirst deleteAddFdaPersonnelFirst(
			long addFdaPersonnelFirstId)
		throws PortalException {

		return addFdaPersonnelFirstPersistence.remove(addFdaPersonnelFirstId);
	}
	...
	public AddFdaPersonnelFirst deleteAddFdaPersonnelFirst(
		...
		return addFdaPersonnelFirstPersistence.remove(addFdaPersonnelFirst);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addFdaPersonnelFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddFdaPersonnelFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addFdaPersonnelFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addFdaPersonnelFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddFdaPersonnelFirst fetchAddFdaPersonnelFirst(
		long addFdaPersonnelFirstId) {

		return addFdaPersonnelFirstPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddFdaPersonnelFirst getAddFdaPersonnelFirst(
			long addFdaPersonnelFirstId)
		throws PortalException {

		return addFdaPersonnelFirstPersistence.findByPrimaryKey(
			addFdaPersonnelFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addFdaPersonnelFirstLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddFdaPersonnelFirst.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaPersonnelFirstPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddFdaPersonnelFirstLocalServiceImpl#deleteAddFdaPersonnelFirst(AddFdaPersonnelFirst) to avoid orphaned data");
		}

		return addFdaPersonnelFirstLocalService.deleteAddFdaPersonnelFirst(
			(AddFdaPersonnelFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddFdaPersonnelFirst> getBasePersistence() {
		return addFdaPersonnelFirstPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addFdaPersonnelFirstPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddFdaPersonnelFirst> getAddFdaPersonnelFirsts(
		int start, int end) {

		return addFdaPersonnelFirstPersistence.findAll(start, end);
	}
	...
	public int getAddFdaPersonnelFirstsCount() {
		return addFdaPersonnelFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddFdaPersonnelFirst updateAddFdaPersonnelFirst(
		AddFdaPersonnelFirst addFdaPersonnelFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelFirstLocalService =
			(AddFdaPersonnelFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addFdaPersonnelFirstPersistence.getDataSource();
	...
	protected AddFdaPersonnelFirstLocalService addFdaPersonnelFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelFirstLocalServiceBaseImpl.class);
