...
import com.nbp.janaac.application.form.service.service.AccMediLabOtherReqService;
...
/**
 * Provides the base implementation for the acc medi lab other req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabOtherReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabOtherReqServiceImpl
 * @generated
 */
public abstract class AccMediLabOtherReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabOtherReqService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabOtherReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabOtherReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabOtherReqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabOtherReqService = (AccMediLabOtherReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabOtherReqService.class.getName();
	}
	...
	protected AccMediLabOtherReqService accMediLabOtherReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabOtherReqServiceBaseImpl.class);
