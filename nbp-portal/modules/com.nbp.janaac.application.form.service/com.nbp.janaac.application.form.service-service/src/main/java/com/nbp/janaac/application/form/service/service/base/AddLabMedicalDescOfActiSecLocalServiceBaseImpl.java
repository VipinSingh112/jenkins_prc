...
import com.nbp.janaac.application.form.service.service.AddLabMedicalDescOfActiSecLocalService;
...
/**
 * Provides the base implementation for the add lab medical desc of acti sec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalDescOfActiSecLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalDescOfActiSecLocalServiceImpl
 * @generated
 */
public abstract class AddLabMedicalDescOfActiSecLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabMedicalDescOfActiSecLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalDescOfActiSecLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalDescOfActiSecLocalServiceUtil</code>.
	 */
	...
	public AddLabMedicalDescOfActiSec addAddLabMedicalDescOfActiSec(
		...
		return addLabMedicalDescOfActiSecPersistence.update(
	...
	public AddLabMedicalDescOfActiSec createAddLabMedicalDescOfActiSec(
		...
		return addLabMedicalDescOfActiSecPersistence.create(
	...
	public AddLabMedicalDescOfActiSec deleteAddLabMedicalDescOfActiSec(
		...
		return addLabMedicalDescOfActiSecPersistence.remove(
			addLabMedicalDescOfActiSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabMedicalDescOfActiSecPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabMedicalDescOfActiSec.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabMedicalDescOfActiSecPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabMedicalDescOfActiSecPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddLabMedicalDescOfActiSec fetchAddLabMedicalDescOfActiSec(
		...
		return addLabMedicalDescOfActiSecPersistence.fetchByPrimaryKey(
			addLabMedicalDescOfActiSecId);
	}
	...
	public AddLabMedicalDescOfActiSec getAddLabMedicalDescOfActiSec(
		...
		return addLabMedicalDescOfActiSecPersistence.findByPrimaryKey(
			addLabMedicalDescOfActiSecId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabMedicalDescOfActiSec.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AddLabMedicalDescOfActiSec.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabMedicalDescOfActiSecLocalServiceImpl#deleteAddLabMedicalDescOfActiSec(AddLabMedicalDescOfActiSec) to avoid orphaned data");
		}

		return addLabMedicalDescOfActiSecLocalService.
			deleteAddLabMedicalDescOfActiSec(
				(AddLabMedicalDescOfActiSec)persistedModel);
	}

	@Override
	public BasePersistence<AddLabMedicalDescOfActiSec> getBasePersistence() {
		return addLabMedicalDescOfActiSecPersistence;
	}
	...
	public List<AddLabMedicalDescOfActiSec> getAddLabMedicalDescOfActiSecs(
		...
		return addLabMedicalDescOfActiSecPersistence.findAll(start, end);
	}
	...
	public int getAddLabMedicalDescOfActiSecsCount() {
		return addLabMedicalDescOfActiSecPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		addLabMedicalDescOfActiSecLocalService =
			(AddLabMedicalDescOfActiSecLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalDescOfActiSecLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return AddLabMedicalDescOfActiSec.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabMedicalDescOfActiSecPersistence.getDataSource();
	...
	protected AddLabMedicalDescOfActiSecLocalService
		addLabMedicalDescOfActiSecLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalDescOfActiSecLocalServiceBaseImpl.class);
