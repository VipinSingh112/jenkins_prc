...
import com.nbp.janaac.application.form.service.service.AccMediLabManagementReqLocalService;
...
/**
 * Provides the base implementation for the acc medi lab management req local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabManagementReqLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabManagementReqLocalServiceImpl
 * @generated
 */
public abstract class AccMediLabManagementReqLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccMediLabManagementReqLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabManagementReqLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabManagementReqLocalServiceUtil</code>.
	 */
	...
	public AccMediLabManagementReq addAccMediLabManagementReq(
		...
		return accMediLabManagementReqPersistence.update(
	...
	public AccMediLabManagementReq createAccMediLabManagementReq(
		...
		return accMediLabManagementReqPersistence.create(
	...
	public AccMediLabManagementReq deleteAccMediLabManagementReq(
		...
		return accMediLabManagementReqPersistence.remove(
			accMediLabManagementReqId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accMediLabManagementReqPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccMediLabManagementReq.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accMediLabManagementReqPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accMediLabManagementReqPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AccMediLabManagementReq fetchAccMediLabManagementReq(
		...
		return accMediLabManagementReqPersistence.fetchByPrimaryKey(
			accMediLabManagementReqId);
	}
	...
	public AccMediLabManagementReq fetchAccMediLabManagementReqByUuidAndGroupId(
		...
		return accMediLabManagementReqPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AccMediLabManagementReq getAccMediLabManagementReq(
		...
		return accMediLabManagementReqPersistence.findByPrimaryKey(
			accMediLabManagementReqId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccMediLabManagementReq.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accMediLabManagementReq);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					AccMediLabManagementReq.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccMediLabManagementReqLocalServiceImpl#deleteAccMediLabManagementReq(AccMediLabManagementReq) to avoid orphaned data");
		}

		return accMediLabManagementReqLocalService.
			deleteAccMediLabManagementReq(
				(AccMediLabManagementReq)persistedModel);
	}

	@Override
	public BasePersistence<AccMediLabManagementReq> getBasePersistence() {
		return accMediLabManagementReqPersistence;
	}
	...
	public List<AccMediLabManagementReq>
		...
		return accMediLabManagementReqPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccMediLabManagementReq>
		...
		return accMediLabManagementReqPersistence.findByUuid_C(
	...
	public AccMediLabManagementReq getAccMediLabManagementReqByUuidAndGroupId(
		...
		return accMediLabManagementReqPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AccMediLabManagementReq> getAccMediLabManagementReqs(
		...
		return accMediLabManagementReqPersistence.findAll(start, end);
	}
	...
	public int getAccMediLabManagementReqsCount() {
		return accMediLabManagementReqPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabManagementReqLocalService =
			(AccMediLabManagementReqLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabManagementReqLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accMediLabManagementReqPersistence.getDataSource();
	...
	protected AccMediLabManagementReqLocalService
		accMediLabManagementReqLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabManagementReqLocalServiceBaseImpl.class);
