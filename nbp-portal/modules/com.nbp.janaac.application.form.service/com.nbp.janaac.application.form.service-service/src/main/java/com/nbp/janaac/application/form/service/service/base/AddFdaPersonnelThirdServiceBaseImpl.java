...
import com.nbp.janaac.application.form.service.service.AddFdaPersonnelThirdService;
...
/**
 * Provides the base implementation for the add fda personnel third remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelThirdServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaPersonnelThirdServiceImpl
 * @generated
 */
public abstract class AddFdaPersonnelThirdServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaPersonnelThirdService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaPersonnelThirdService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaPersonnelThirdServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaPersonnelThirdService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaPersonnelThirdService = (AddFdaPersonnelThirdService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaPersonnelThirdService.class.getName();
	}
	...
	protected AddFdaPersonnelThirdService addFdaPersonnelThirdService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaPersonnelThirdServiceBaseImpl.class);
