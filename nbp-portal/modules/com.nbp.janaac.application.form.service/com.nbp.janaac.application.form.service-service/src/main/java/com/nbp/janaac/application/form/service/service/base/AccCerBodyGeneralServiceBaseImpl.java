...
import com.nbp.janaac.application.form.service.service.AccCerBodyGeneralService;
...
/**
 * Provides the base implementation for the acc cer body general remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyGeneralServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyGeneralServiceImpl
 * @generated
 */
public abstract class AccCerBodyGeneralServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyGeneralService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyGeneralService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyGeneralServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyGeneralService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyGeneralService = (AccCerBodyGeneralService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyGeneralService.class.getName();
	}
	...
	protected AccCerBodyGeneralService accCerBodyGeneralService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyGeneralServiceBaseImpl.class);
