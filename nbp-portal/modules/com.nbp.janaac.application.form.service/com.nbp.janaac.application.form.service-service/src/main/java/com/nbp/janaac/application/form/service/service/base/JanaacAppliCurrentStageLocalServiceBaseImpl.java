...
import com.nbp.janaac.application.form.service.service.JanaacAppliCurrentStageLocalService;
...
/**
 * Provides the base implementation for the janaac appli current stage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.JanaacAppliCurrentStageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.JanaacAppliCurrentStageLocalServiceImpl
 * @generated
 */
public abstract class JanaacAppliCurrentStageLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JanaacAppliCurrentStageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.JanaacAppliCurrentStageLocalServiceUtil</code>.
	 */
	...
	public JanaacAppliCurrentStage addJanaacAppliCurrentStage(
		...
		return janaacAppliCurrentStagePersistence.update(
	...
	public JanaacAppliCurrentStage createJanaacAppliCurrentStage(
		...
		return janaacAppliCurrentStagePersistence.create(
	...
	public JanaacAppliCurrentStage deleteJanaacAppliCurrentStage(
		...
		return janaacAppliCurrentStagePersistence.remove(
			janaacAppliCurrentStageId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return janaacAppliCurrentStagePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JanaacAppliCurrentStage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return janaacAppliCurrentStagePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return janaacAppliCurrentStagePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public JanaacAppliCurrentStage fetchJanaacAppliCurrentStage(
		...
		return janaacAppliCurrentStagePersistence.fetchByPrimaryKey(
			janaacAppliCurrentStageId);
	}
	...
	public JanaacAppliCurrentStage getJanaacAppliCurrentStage(
		...
		return janaacAppliCurrentStagePersistence.findByPrimaryKey(
			janaacAppliCurrentStageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(JanaacAppliCurrentStage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement JanaacAppliCurrentStageLocalServiceImpl#deleteJanaacAppliCurrentStage(JanaacAppliCurrentStage) to avoid orphaned data");
		}

		return janaacAppliCurrentStageLocalService.
			deleteJanaacAppliCurrentStage(
				(JanaacAppliCurrentStage)persistedModel);
	}

	@Override
	public BasePersistence<JanaacAppliCurrentStage> getBasePersistence() {
		return janaacAppliCurrentStagePersistence;
	}
	...
	public List<JanaacAppliCurrentStage> getJanaacAppliCurrentStages(
		...
		return janaacAppliCurrentStagePersistence.findAll(start, end);
	}
	...
	public int getJanaacAppliCurrentStagesCount() {
		return janaacAppliCurrentStagePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		janaacAppliCurrentStageLocalService =
			(JanaacAppliCurrentStageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JanaacAppliCurrentStageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				janaacAppliCurrentStagePersistence.getDataSource();
	...
	protected JanaacAppliCurrentStageLocalService
		janaacAppliCurrentStageLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JanaacAppliCurrentStageLocalServiceBaseImpl.class);
