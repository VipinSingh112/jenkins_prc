...
import com.nbp.janaac.application.form.service.service.AddLabDescOfActivityService;
...
/**
 * Provides the base implementation for the add lab desc of activity remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabDescOfActivityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabDescOfActivityServiceImpl
 * @generated
 */
public abstract class AddLabDescOfActivityServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabDescOfActivityService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabDescOfActivityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabDescOfActivityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabDescOfActivityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabDescOfActivityService = (AddLabDescOfActivityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabDescOfActivityService.class.getName();
	}
	...
	protected AddLabDescOfActivityService addLabDescOfActivityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabDescOfActivityServiceBaseImpl.class);
