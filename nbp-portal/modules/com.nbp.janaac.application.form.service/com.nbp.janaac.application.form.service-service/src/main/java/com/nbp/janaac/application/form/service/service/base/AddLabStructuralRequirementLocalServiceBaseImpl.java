...
import com.nbp.janaac.application.form.service.service.AddLabStructuralRequirementLocalService;
...
/**
 * Provides the base implementation for the add lab structural requirement local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabStructuralRequirementLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabStructuralRequirementLocalServiceImpl
 * @generated
 */
public abstract class AddLabStructuralRequirementLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabStructuralRequirementLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabStructuralRequirementLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabStructuralRequirementLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabStructuralRequirement addAddLabStructuralRequirement(
		AddLabStructuralRequirement addLabStructuralRequirement) {

		addLabStructuralRequirement.setNew(true);

		return addLabStructuralRequirementPersistence.update(
	...
	public AddLabStructuralRequirement createAddLabStructuralRequirement(
		long addLabStructuralRequirementId) {

		return addLabStructuralRequirementPersistence.create(
	...
	@Override
	public AddLabStructuralRequirement deleteAddLabStructuralRequirement(
			long addLabStructuralRequirementId)
		throws PortalException {

		return addLabStructuralRequirementPersistence.remove(
			addLabStructuralRequirementId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabStructuralRequirementPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabStructuralRequirement.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabStructuralRequirementPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabStructuralRequirementPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabStructuralRequirement fetchAddLabStructuralRequirement(
		long addLabStructuralRequirementId) {

		return addLabStructuralRequirementPersistence.fetchByPrimaryKey(
			addLabStructuralRequirementId);
	}
	 ...
	 */
	@Override
	public AddLabStructuralRequirement getAddLabStructuralRequirement(
			long addLabStructuralRequirementId)
		throws PortalException {

		return addLabStructuralRequirementPersistence.findByPrimaryKey(
			addLabStructuralRequirementId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabStructuralRequirement.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AddLabStructuralRequirement.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabStructuralRequirementLocalServiceImpl#deleteAddLabStructuralRequirement(AddLabStructuralRequirement) to avoid orphaned data");
		}

		return addLabStructuralRequirementLocalService.
			deleteAddLabStructuralRequirement(
				(AddLabStructuralRequirement)persistedModel);
	}

	@Override
	public BasePersistence<AddLabStructuralRequirement> getBasePersistence() {
		return addLabStructuralRequirementPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabStructuralRequirement> getAddLabStructuralRequirements(
		int start, int end) {

		return addLabStructuralRequirementPersistence.findAll(start, end);
	}
	...
	public int getAddLabStructuralRequirementsCount() {
		return addLabStructuralRequirementPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabStructuralRequirement updateAddLabStructuralRequirement(
		AddLabStructuralRequirement addLabStructuralRequirement) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabStructuralRequirementLocalService =
			(AddLabStructuralRequirementLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabStructuralRequirementLocalService.class.getName();
	}
	...
	protected AddLabStructuralRequirementLocalService
		addLabStructuralRequirementLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabStructuralRequirementLocalServiceBaseImpl.class);
