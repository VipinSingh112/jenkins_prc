...
import com.nbp.janaac.application.form.service.model.AccThirdPartyAppliInfoTable;
import com.nbp.janaac.application.form.service.model.impl.AccThirdPartyAppliInfoImpl;
import com.nbp.janaac.application.form.service.model.impl.AccThirdPartyAppliInfoModelImpl;
import com.nbp.janaac.application.form.service.service.persistence.AccThirdPartyAppliInfoPersistence;
import com.nbp.janaac.application.form.service.service.persistence.AccThirdPartyAppliInfoUtil;
...
/**
 * The persistence implementation for the acc third party appli info service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = AccThirdPartyAppliInfoPersistence.class)
public class AccThirdPartyAppliInfoPersistenceImpl
	extends BasePersistenceImpl<AccThirdPartyAppliInfo>
	implements AccThirdPartyAppliInfoPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>AccThirdPartyAppliInfoUtil</code> to access the acc third party appli info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		AccThirdPartyAppliInfoImpl.class.getName();
	 ...
	 */
	@Override
	public List<AccThirdPartyAppliInfo> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<AccThirdPartyAppliInfo> findByUuid(
	...
	public List<AccThirdPartyAppliInfo> findByUuid(
		...
		List<AccThirdPartyAppliInfo> list = null;

		if (useFinderCache) {
			list = (List<AccThirdPartyAppliInfo>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (AccThirdPartyAppliInfo accThirdPartyAppliInfo : list) {
					if (!uuid.equals(accThirdPartyAppliInfo.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ACCTHIRDPARTYAPPLIINFO_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(AccThirdPartyAppliInfoModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<AccThirdPartyAppliInfo>)QueryUtil.list(
	...
	public AccThirdPartyAppliInfo findByUuid_First(
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByUuid_First(
			uuid, orderByComparator);

		if (accThirdPartyAppliInfo != null) {
			return accThirdPartyAppliInfo;
		}
		...
		throw new NoSuchAccThirdPartyAppliInfoException(sb.toString());
	}
	...
	public AccThirdPartyAppliInfo fetchByUuid_First(
		...
		List<AccThirdPartyAppliInfo> list = findByUuid(
	...
	public AccThirdPartyAppliInfo findByUuid_Last(
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public AccThirdPartyAppliInfo[] findByUuid_PrevAndNext(
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = findByPrimaryKey(
		...
		try {
			...
			AccThirdPartyAppliInfo[] array = new AccThirdPartyAppliInfoImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, accThirdPartyAppliInfo, uuid, orderByComparator, true);

			array[1] = accThirdPartyAppliInfo;

			array[2] = getByUuid_PrevAndNext(
				session, accThirdPartyAppliInfo, uuid, orderByComparator,
				false);
	...
	protected AccThirdPartyAppliInfo getByUuid_PrevAndNext(
		Session session, AccThirdPartyAppliInfo accThirdPartyAppliInfo,
		String uuid,
		OrderByComparator<AccThirdPartyAppliInfo> orderByComparator,
		boolean previous) {
		...
		List<AccThirdPartyAppliInfo> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (AccThirdPartyAppliInfo accThirdPartyAppliInfo :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(accThirdPartyAppliInfo);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ACCTHIRDPARTYAPPLIINFO_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"accThirdPartyAppliInfo.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(accThirdPartyAppliInfo.uuid IS NULL OR accThirdPartyAppliInfo.uuid = '')";
	...
	public AccThirdPartyAppliInfo findByUUID_G(String uuid, long groupId)
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByUUID_G(
			uuid, groupId);
	...
	public AccThirdPartyAppliInfo fetchByUUID_G(
		...
		if (result instanceof AccThirdPartyAppliInfo) {
			AccThirdPartyAppliInfo accThirdPartyAppliInfo =
				(AccThirdPartyAppliInfo)result;

			if (!Objects.equals(uuid, accThirdPartyAppliInfo.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					AccThirdPartyAppliInfo accThirdPartyAppliInfo = list.get(0);

					result = accThirdPartyAppliInfo;

					cacheResult(accThirdPartyAppliInfo);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (AccThirdPartyAppliInfo)result;
		}
	}
	...
	public AccThirdPartyAppliInfo removeByUUID_G(String uuid, long groupId)
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = findByUUID_G(
			uuid, groupId);

		return remove(accThirdPartyAppliInfo);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"accThirdPartyAppliInfo.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(accThirdPartyAppliInfo.uuid IS NULL OR accThirdPartyAppliInfo.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"accThirdPartyAppliInfo.groupId = ?";
	 ...
	 */
	@Override
	public List<AccThirdPartyAppliInfo> findByUuid_C(
	...
	public AccThirdPartyAppliInfo findByUuid_C_First(
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByUuid_C_First(
	...
	public AccThirdPartyAppliInfo fetchByUuid_C_First(
		...
		List<AccThirdPartyAppliInfo> list = findByUuid_C(
	...
	public AccThirdPartyAppliInfo findByUuid_C_Last(
		...
		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public AccThirdPartyAppliInfo[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, accThirdPartyAppliInfo, uuid, companyId,
	...
	protected AccThirdPartyAppliInfo getByUuid_C_PrevAndNext(
		Session session, AccThirdPartyAppliInfo accThirdPartyAppliInfo,
		String uuid, long companyId,
		OrderByComparator<AccThirdPartyAppliInfo> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"accThirdPartyAppliInfo.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"AccThirdPartyAppliInfoPersistenceImpl.fetchBygetJANAAC_ByApplicationId(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETJANAAC_BYAPPLICATIONID_JANAACAPPLICATIONID_2 =
			"accThirdPartyAppliInfo.janaacApplicationId = ?";

	public AccThirdPartyAppliInfoPersistenceImpl() {
		...
		setModelClass(AccThirdPartyAppliInfo.class);

		setModelImplClass(AccThirdPartyAppliInfoImpl.class);
		setModelPKClass(long.class);

		setTable(AccThirdPartyAppliInfoTable.INSTANCE);
	}
	...
	public void cacheResult(AccThirdPartyAppliInfo accThirdPartyAppliInfo) {
		entityCache.putResult(
			AccThirdPartyAppliInfoImpl.class,
			accThirdPartyAppliInfo.getPrimaryKey(), accThirdPartyAppliInfo);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				accThirdPartyAppliInfo.getUuid(),
				accThirdPartyAppliInfo.getGroupId()
			},
			accThirdPartyAppliInfo);

		finderCache.putResult(
			_finderPathFetchBygetJANAAC_ByApplicationId,
			new Object[] {accThirdPartyAppliInfo.getJanaacApplicationId()},
			accThirdPartyAppliInfo);
	}
	...
	public void cacheResult(
		...
		for (AccThirdPartyAppliInfo accThirdPartyAppliInfo :
				accThirdPartyAppliInfos) {

			if (entityCache.getResult(
					AccThirdPartyAppliInfoImpl.class,
					accThirdPartyAppliInfo.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all acc third party appli infos.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(AccThirdPartyAppliInfoImpl.class);

		finderCache.clearCache(AccThirdPartyAppliInfoImpl.class);
	}

	/**
	 * Clears the cache for the acc third party appli info.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(AccThirdPartyAppliInfo accThirdPartyAppliInfo) {
		entityCache.removeResult(
			AccThirdPartyAppliInfoImpl.class, accThirdPartyAppliInfo);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				AccThirdPartyAppliInfoImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		AccThirdPartyAppliInfoModelImpl accThirdPartyAppliInfoModelImpl) {

		Object[] args = new Object[] {
			accThirdPartyAppliInfoModelImpl.getUuid(),
			accThirdPartyAppliInfoModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, accThirdPartyAppliInfoModelImpl);

		args = new Object[] {
			accThirdPartyAppliInfoModelImpl.getJanaacApplicationId()
		};
		...
		finderCache.putResult(
			...
			accThirdPartyAppliInfoModelImpl);
	}
	...
	public AccThirdPartyAppliInfo create(long accThirdPartyAppliInfoId) {
		...
		accThirdPartyAppliInfo.setNew(true);
		accThirdPartyAppliInfo.setPrimaryKey(accThirdPartyAppliInfoId);

		String uuid = PortalUUIDUtil.generate();

		accThirdPartyAppliInfo.setUuid(uuid);

		accThirdPartyAppliInfo.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public AccThirdPartyAppliInfo remove(long accThirdPartyAppliInfoId)
		...
		return remove((Serializable)accThirdPartyAppliInfoId);
	}

	/**
	 * Removes the acc third party appli info with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the acc third party appli info
	 * @return the acc third party appli info that was removed
	 * @throws NoSuchAccThirdPartyAppliInfoException if a acc third party appli info with the primary key could not be found
	 */
	@Override
	public AccThirdPartyAppliInfo remove(Serializable primaryKey)
		throws NoSuchAccThirdPartyAppliInfoException {
		...
		try {
			...
			AccThirdPartyAppliInfo accThirdPartyAppliInfo =
				(AccThirdPartyAppliInfo)session.get(
					AccThirdPartyAppliInfoImpl.class, primaryKey);
			...
			if (accThirdPartyAppliInfo == null) {
				...
				throw new NoSuchAccThirdPartyAppliInfoException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(accThirdPartyAppliInfo);
		}
		catch (NoSuchAccThirdPartyAppliInfoException noSuchEntityException) {
	...
	@Override
	protected AccThirdPartyAppliInfo removeImpl(
		AccThirdPartyAppliInfo accThirdPartyAppliInfo) {
		...
		try {
			...
			if (!session.contains(accThirdPartyAppliInfo)) {
				accThirdPartyAppliInfo = (AccThirdPartyAppliInfo)session.get(
					AccThirdPartyAppliInfoImpl.class,
					accThirdPartyAppliInfo.getPrimaryKeyObj());
			}

			if (accThirdPartyAppliInfo != null) {
				session.delete(accThirdPartyAppliInfo);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (accThirdPartyAppliInfo != null) {
			clearCache(accThirdPartyAppliInfo);
		}
	...
	public AccThirdPartyAppliInfo updateImpl(
		...
		boolean isNew = accThirdPartyAppliInfo.isNew();

		if (!(accThirdPartyAppliInfo instanceof
				AccThirdPartyAppliInfoModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(accThirdPartyAppliInfo.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					accThirdPartyAppliInfo);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in accThirdPartyAppliInfo proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom AccThirdPartyAppliInfo implementation " +
					accThirdPartyAppliInfo.getClass());
		}

		AccThirdPartyAppliInfoModelImpl accThirdPartyAppliInfoModelImpl =
			(AccThirdPartyAppliInfoModelImpl)accThirdPartyAppliInfo;

		if (Validator.isNull(accThirdPartyAppliInfo.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (accThirdPartyAppliInfo.getCreateDate() == null)) {
			if (serviceContext == null) {
				accThirdPartyAppliInfo.setCreateDate(date);
			}
			else {
		...
		if (!accThirdPartyAppliInfoModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				accThirdPartyAppliInfo.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(accThirdPartyAppliInfo);
			}
			else {
				accThirdPartyAppliInfo = (AccThirdPartyAppliInfo)session.merge(
					accThirdPartyAppliInfo);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			AccThirdPartyAppliInfoImpl.class, accThirdPartyAppliInfoModelImpl,
			false, true);

		cacheUniqueFindersCache(accThirdPartyAppliInfoModelImpl);

		if (isNew) {
			accThirdPartyAppliInfo.setNew(false);
		}

		accThirdPartyAppliInfo.resetOriginalValues();

		return accThirdPartyAppliInfo;
	}

	/**
	 * Returns the acc third party appli info with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the acc third party appli info
	 ...
	 */
	@Override
	public AccThirdPartyAppliInfo findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAccThirdPartyAppliInfoException {

		AccThirdPartyAppliInfo accThirdPartyAppliInfo = fetchByPrimaryKey(
			primaryKey);
	...
	public AccThirdPartyAppliInfo findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)accThirdPartyAppliInfoId);
	}
	...
	public AccThirdPartyAppliInfo fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)accThirdPartyAppliInfoId);
	}
	 ...
	 */
	@Override
	public List<AccThirdPartyAppliInfo> findAll() {
	 ...
	 */
	@Override
	public List<AccThirdPartyAppliInfo> findAll(int start, int end) {
	...
	public List<AccThirdPartyAppliInfo> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ACCTHIRDPARTYAPPLIINFO);
				...
				sql = _SQL_SELECT_ACCTHIRDPARTYAPPLIINFO;

				sql = sql.concat(AccThirdPartyAppliInfoModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (AccThirdPartyAppliInfo accThirdPartyAppliInfo : findAll()) {
			remove(accThirdPartyAppliInfo);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_ACCTHIRDPARTYAPPLIINFO);
	...
	protected String getPKDBName() {
		return "accThirdPartyAppliInfoId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_ACCTHIRDPARTYAPPLIINFO;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return AccThirdPartyAppliInfoModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the acc third party appli info persistence.
	 */
	@Activate
	public void activate() {
		...
		AccThirdPartyAppliInfoUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		AccThirdPartyAppliInfoUtil.setPersistence(null);

		entityCache.removeCache(AccThirdPartyAppliInfoImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_ACCTHIRDPARTYAPPLIINFO =
		"SELECT accThirdPartyAppliInfo FROM AccThirdPartyAppliInfo accThirdPartyAppliInfo";

	private static final String _SQL_SELECT_ACCTHIRDPARTYAPPLIINFO_WHERE =
		"SELECT accThirdPartyAppliInfo FROM AccThirdPartyAppliInfo accThirdPartyAppliInfo WHERE ";

	private static final String _SQL_COUNT_ACCTHIRDPARTYAPPLIINFO =
		"SELECT COUNT(accThirdPartyAppliInfo) FROM AccThirdPartyAppliInfo accThirdPartyAppliInfo";

	private static final String _SQL_COUNT_ACCTHIRDPARTYAPPLIINFO_WHERE =
		"SELECT COUNT(accThirdPartyAppliInfo) FROM AccThirdPartyAppliInfo accThirdPartyAppliInfo WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"accThirdPartyAppliInfo.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No AccThirdPartyAppliInfo exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No AccThirdPartyAppliInfo exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		AccThirdPartyAppliInfoPersistenceImpl.class);
