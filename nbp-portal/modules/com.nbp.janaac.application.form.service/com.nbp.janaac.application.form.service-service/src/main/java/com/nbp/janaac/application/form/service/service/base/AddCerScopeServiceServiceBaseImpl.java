...
import com.nbp.janaac.application.form.service.service.AddCerScopeServiceService;
...
/**
 * Provides the base implementation for the add cer scope service remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceServiceImpl
 * @generated
 */
public abstract class AddCerScopeServiceServiceBaseImpl
	extends BaseServiceImpl
	implements AddCerScopeServiceService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerScopeServiceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerScopeServiceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerScopeServiceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addCerScopeServiceService = (AddCerScopeServiceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerScopeServiceService.class.getName();
	}
	...
	protected AddCerScopeServiceService addCerScopeServiceService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerScopeServiceServiceBaseImpl.class);
