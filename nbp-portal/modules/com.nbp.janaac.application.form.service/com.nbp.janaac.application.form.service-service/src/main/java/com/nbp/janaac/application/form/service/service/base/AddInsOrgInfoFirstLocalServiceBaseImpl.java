...
import com.nbp.janaac.application.form.service.service.AddInsOrgInfoFirstLocalService;
...
/**
 * Provides the base implementation for the add ins org info first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoFirstLocalServiceImpl
 * @generated
 */
public abstract class AddInsOrgInfoFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddInsOrgInfoFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsOrgInfoFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsOrgInfoFirstLocalServiceUtil</code>.
	 */
	...
	public AddInsOrgInfoFirst addAddInsOrgInfoFirst(
		...
		return addInsOrgInfoFirstPersistence.update(addInsOrgInfoFirst);
	}
	...
	public AddInsOrgInfoFirst createAddInsOrgInfoFirst(
		...
		return addInsOrgInfoFirstPersistence.create(addInsOrgInfoFirstId);
	}
	...
	public AddInsOrgInfoFirst deleteAddInsOrgInfoFirst(
		...
		return addInsOrgInfoFirstPersistence.remove(addInsOrgInfoFirstId);
	}
	...
	public AddInsOrgInfoFirst deleteAddInsOrgInfoFirst(
		...
		return addInsOrgInfoFirstPersistence.remove(addInsOrgInfoFirst);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addInsOrgInfoFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddInsOrgInfoFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addInsOrgInfoFirstPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addInsOrgInfoFirstPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addInsOrgInfoFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddInsOrgInfoFirst fetchAddInsOrgInfoFirst(
		...
		return addInsOrgInfoFirstPersistence.fetchByPrimaryKey(
	...
	public AddInsOrgInfoFirst getAddInsOrgInfoFirst(long addInsOrgInfoFirstId)
		...
		return addInsOrgInfoFirstPersistence.findByPrimaryKey(
			addInsOrgInfoFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addInsOrgInfoFirstLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddInsOrgInfoFirst.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddInsOrgInfoFirst.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addInsOrgInfoFirstPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddInsOrgInfoFirstLocalServiceImpl#deleteAddInsOrgInfoFirst(AddInsOrgInfoFirst) to avoid orphaned data");
		}

		return addInsOrgInfoFirstLocalService.deleteAddInsOrgInfoFirst(
			(AddInsOrgInfoFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddInsOrgInfoFirst> getBasePersistence() {
		return addInsOrgInfoFirstPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addInsOrgInfoFirstPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddInsOrgInfoFirst> getAddInsOrgInfoFirsts(int start, int end) {
		return addInsOrgInfoFirstPersistence.findAll(start, end);
	}
	...
	public int getAddInsOrgInfoFirstsCount() {
		return addInsOrgInfoFirstPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsOrgInfoFirstLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addInsOrgInfoFirstLocalService =
			(AddInsOrgInfoFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsOrgInfoFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addInsOrgInfoFirstPersistence.getDataSource();
	...
	protected AddInsOrgInfoFirstLocalService addInsOrgInfoFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsOrgInfoFirstLocalServiceBaseImpl.class);
