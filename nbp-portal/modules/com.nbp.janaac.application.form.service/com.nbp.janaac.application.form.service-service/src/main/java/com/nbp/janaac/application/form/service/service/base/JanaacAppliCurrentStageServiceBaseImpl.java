...
import com.nbp.janaac.application.form.service.service.JanaacAppliCurrentStageService;
...
/**
 * Provides the base implementation for the janaac appli current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.JanaacAppliCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.JanaacAppliCurrentStageServiceImpl
 * @generated
 */
public abstract class JanaacAppliCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   JanaacAppliCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JanaacAppliCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.JanaacAppliCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JanaacAppliCurrentStageService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		janaacAppliCurrentStageService =
			(JanaacAppliCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JanaacAppliCurrentStageService.class.getName();
	}
	...
	protected com.nbp.janaac.application.form.service.service.
		JanaacAppliCurrentStageLocalService janaacAppliCurrentStageLocalService;

	protected JanaacAppliCurrentStageService janaacAppliCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JanaacAppliCurrentStageServiceBaseImpl.class);
