...
import com.nbp.janaac.application.form.service.service.AccCerBodyManageReqLocalService;
...
/**
 * Provides the base implementation for the acc cer body manage req local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyManageReqLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyManageReqLocalServiceImpl
 * @generated
 */
public abstract class AccCerBodyManageReqLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccCerBodyManageReqLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyManageReqLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyManageReqLocalServiceUtil</code>.
	 */
	...
	public AccCerBodyManageReq addAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.update(accCerBodyManageReq);
	}
	...
	public AccCerBodyManageReq createAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.create(accCerBodyManageReqId);
	}
	...
	public AccCerBodyManageReq deleteAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.remove(accCerBodyManageReqId);
	}
	...
	public AccCerBodyManageReq deleteAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.remove(accCerBodyManageReq);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accCerBodyManageReqPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccCerBodyManageReq.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accCerBodyManageReqPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accCerBodyManageReqPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AccCerBodyManageReq fetchAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.fetchByPrimaryKey(
	...
	public AccCerBodyManageReq fetchAccCerBodyManageReqByUuidAndGroupId(
		...
		return accCerBodyManageReqPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AccCerBodyManageReq getAccCerBodyManageReq(
		...
		return accCerBodyManageReqPersistence.findByPrimaryKey(
			accCerBodyManageReqId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			accCerBodyManageReqLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccCerBodyManageReq.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accCerBodyManageReq);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					AccCerBodyManageReq.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyManageReqPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccCerBodyManageReqLocalServiceImpl#deleteAccCerBodyManageReq(AccCerBodyManageReq) to avoid orphaned data");
		}

		return accCerBodyManageReqLocalService.deleteAccCerBodyManageReq(
			(AccCerBodyManageReq)persistedModel);
	}

	@Override
	public BasePersistence<AccCerBodyManageReq> getBasePersistence() {
		return accCerBodyManageReqPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyManageReqPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AccCerBodyManageReq> getAccCerBodyManageReqsByUuidAndCompanyId(
		...
		return accCerBodyManageReqPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccCerBodyManageReq> getAccCerBodyManageReqsByUuidAndCompanyId(
		...
		return accCerBodyManageReqPersistence.findByUuid_C(
	...
	public AccCerBodyManageReq getAccCerBodyManageReqByUuidAndGroupId(
		...
		return accCerBodyManageReqPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AccCerBodyManageReq> getAccCerBodyManageReqs(
		...
		return accCerBodyManageReqPersistence.findAll(start, end);
	}
	...
	public int getAccCerBodyManageReqsCount() {
		return accCerBodyManageReqPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		accCerBodyManageReqLocalService =
			(AccCerBodyManageReqLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyManageReqLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accCerBodyManageReqPersistence.getDataSource();
	...
	protected AccCerBodyManageReqLocalService accCerBodyManageReqLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyManageReqLocalServiceBaseImpl.class);
