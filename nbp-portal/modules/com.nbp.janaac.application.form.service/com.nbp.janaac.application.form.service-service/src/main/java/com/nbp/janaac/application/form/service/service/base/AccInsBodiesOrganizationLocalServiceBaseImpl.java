...
import com.nbp.janaac.application.form.service.service.AccInsBodiesOrganizationLocalService;
...
/**
 * Provides the base implementation for the acc ins bodies organization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOrganizationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOrganizationLocalServiceImpl
 * @generated
 */
public abstract class AccInsBodiesOrganizationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccInsBodiesOrganizationLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccInsBodiesOrganizationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccInsBodiesOrganizationLocalServiceUtil</code>.
	 */
	...
	@Override
	public AccInsBodiesOrganization addAccInsBodiesOrganization(
		AccInsBodiesOrganization accInsBodiesOrganization) {

		accInsBodiesOrganization.setNew(true);

		return accInsBodiesOrganizationPersistence.update(
	...
	public AccInsBodiesOrganization createAccInsBodiesOrganization(
		long accInsBodiesOrganizationId) {

		return accInsBodiesOrganizationPersistence.create(
	...
	@Override
	public AccInsBodiesOrganization deleteAccInsBodiesOrganization(
			long accInsBodiesOrganizationId)
		throws PortalException {

		return accInsBodiesOrganizationPersistence.remove(
			accInsBodiesOrganizationId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accInsBodiesOrganizationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccInsBodiesOrganization.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accInsBodiesOrganizationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accInsBodiesOrganizationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AccInsBodiesOrganization fetchAccInsBodiesOrganization(
		long accInsBodiesOrganizationId) {

		return accInsBodiesOrganizationPersistence.fetchByPrimaryKey(
			accInsBodiesOrganizationId);
	}
	 ...
	 */
	@Override
	public AccInsBodiesOrganization
		fetchAccInsBodiesOrganizationByUuidAndGroupId(
			String uuid, long groupId) {

		return accInsBodiesOrganizationPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public AccInsBodiesOrganization getAccInsBodiesOrganization(
			long accInsBodiesOrganizationId)
		throws PortalException {

		return accInsBodiesOrganizationPersistence.findByPrimaryKey(
			accInsBodiesOrganizationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AccInsBodiesOrganization.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AccInsBodiesOrganization.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accInsBodiesOrganization);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccInsBodiesOrganizationLocalServiceImpl#deleteAccInsBodiesOrganization(AccInsBodiesOrganization) to avoid orphaned data");
		}

		return accInsBodiesOrganizationLocalService.
			deleteAccInsBodiesOrganization(
				(AccInsBodiesOrganization)persistedModel);
	}

	@Override
	public BasePersistence<AccInsBodiesOrganization> getBasePersistence() {
		return accInsBodiesOrganizationPersistence;
	}
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization>
		getAccInsBodiesOrganizationsByUuidAndCompanyId(
			String uuid, long companyId) {

		return accInsBodiesOrganizationPersistence.findByUuid_C(
			uuid, companyId);
	}
	 ...
	 */
	@Override
	public AccInsBodiesOrganization getAccInsBodiesOrganizationByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return accInsBodiesOrganizationPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<AccInsBodiesOrganization> getAccInsBodiesOrganizations(
		int start, int end) {

		return accInsBodiesOrganizationPersistence.findAll(start, end);
	}
	...
	public int getAccInsBodiesOrganizationsCount() {
		return accInsBodiesOrganizationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccInsBodiesOrganization updateAccInsBodiesOrganization(
		AccInsBodiesOrganization accInsBodiesOrganization) {
	...
	public void setAopProxy(Object aopProxy) {
		accInsBodiesOrganizationLocalService =
			(AccInsBodiesOrganizationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccInsBodiesOrganizationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accInsBodiesOrganizationPersistence.getDataSource();
	...
	protected AccInsBodiesOrganizationLocalService
		accInsBodiesOrganizationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesOrganizationLocalServiceBaseImpl.class);
