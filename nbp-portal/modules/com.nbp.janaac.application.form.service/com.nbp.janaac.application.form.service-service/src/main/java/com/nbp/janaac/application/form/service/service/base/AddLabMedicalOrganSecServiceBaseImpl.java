...
import com.nbp.janaac.application.form.service.service.AddLabMedicalOrganSecService;
...
/**
 * Provides the base implementation for the add lab medical organ sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalOrganSecServiceImpl
 * @generated
 */
public abstract class AddLabMedicalOrganSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabMedicalOrganSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalOrganSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalOrganSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabMedicalOrganSecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabMedicalOrganSecService = (AddLabMedicalOrganSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalOrganSecService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabMedicalOrganSecPersistence.getDataSource();
	...
	protected AddLabMedicalOrganSecService addLabMedicalOrganSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalOrganSecServiceBaseImpl.class);
