...
import com.nbp.janaac.application.form.service.service.AddLabCalibraStrucReqSecService;
...
/**
 * Provides the base implementation for the add lab calibra struc req sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabCalibraStrucReqSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabCalibraStrucReqSecServiceImpl
 * @generated
 */
public abstract class AddLabCalibraStrucReqSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabCalibraStrucReqSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabCalibraStrucReqSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabCalibraStrucReqSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabCalibraStrucReqSecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabCalibraStrucReqSecService =
			(AddLabCalibraStrucReqSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabCalibraStrucReqSecService.class.getName();
	}
	...
	protected AddLabCalibraStrucReqSecService addLabCalibraStrucReqSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabCalibraStrucReqSecServiceBaseImpl.class);
