...
import com.nbp.janaac.application.form.service.service.AccCerBodyPersonnelService;
...
/**
 * Provides the base implementation for the acc cer body personnel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyPersonnelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyPersonnelServiceImpl
 * @generated
 */
public abstract class AccCerBodyPersonnelServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyPersonnelService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyPersonnelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyPersonnelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyPersonnelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyPersonnelService = (AccCerBodyPersonnelService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyPersonnelService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accCerBodyPersonnelPersistence.getDataSource();
	...
	protected AccCerBodyPersonnelService accCerBodyPersonnelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyPersonnelServiceBaseImpl.class);
