...
import com.nbp.janaac.application.form.service.service.AccMediLabOrganizationService;
...
/**
 * Provides the base implementation for the acc medi lab organization remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabOrganizationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabOrganizationServiceImpl
 * @generated
 */
public abstract class AccMediLabOrganizationServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabOrganizationService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabOrganizationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabOrganizationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabOrganizationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accMediLabOrganizationService = (AccMediLabOrganizationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabOrganizationService.class.getName();
	}
	...
	protected AccMediLabOrganizationService accMediLabOrganizationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabOrganizationServiceBaseImpl.class);
