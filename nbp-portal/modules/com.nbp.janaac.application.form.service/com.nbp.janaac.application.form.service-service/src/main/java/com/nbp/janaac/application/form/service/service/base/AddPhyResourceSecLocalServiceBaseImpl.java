...
import com.nbp.janaac.application.form.service.service.AddPhyResourceSecLocalService;
...
/**
 * Provides the base implementation for the add phy resource sec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddPhyResourceSecLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddPhyResourceSecLocalServiceImpl
 * @generated
 */
public abstract class AddPhyResourceSecLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddPhyResourceSecLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddPhyResourceSecLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddPhyResourceSecLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddPhyResourceSec addAddPhyResourceSec(
		AddPhyResourceSec addPhyResourceSec) {

		addPhyResourceSec.setNew(true);

		return addPhyResourceSecPersistence.update(addPhyResourceSec);
	}
	...
	public AddPhyResourceSec createAddPhyResourceSec(long addPhyResourceSecId) {
		return addPhyResourceSecPersistence.create(addPhyResourceSecId);
	}
	...
	@Override
	public AddPhyResourceSec deleteAddPhyResourceSec(long addPhyResourceSecId)
		throws PortalException {

		return addPhyResourceSecPersistence.remove(addPhyResourceSecId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AddPhyResourceSec deleteAddPhyResourceSec(
		AddPhyResourceSec addPhyResourceSec) {

		return addPhyResourceSecPersistence.remove(addPhyResourceSec);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addPhyResourceSecPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddPhyResourceSec.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addPhyResourceSecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addPhyResourceSecPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addPhyResourceSecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return addPhyResourceSecPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AddPhyResourceSec fetchAddPhyResourceSec(long addPhyResourceSecId) {
		return addPhyResourceSecPersistence.fetchByPrimaryKey(
			addPhyResourceSecId);
	}
	 ...
	 */
	@Override
	public AddPhyResourceSec getAddPhyResourceSec(long addPhyResourceSecId)
		throws PortalException {

		return addPhyResourceSecPersistence.findByPrimaryKey(
			addPhyResourceSecId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addPhyResourceSecLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddPhyResourceSec.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("addPhyResourceSecId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddPhyResourceSec.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addPhyResourceSecPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddPhyResourceSecLocalServiceImpl#deleteAddPhyResourceSec(AddPhyResourceSec) to avoid orphaned data");
		}

		return addPhyResourceSecLocalService.deleteAddPhyResourceSec(
			(AddPhyResourceSec)persistedModel);
	}

	@Override
	public BasePersistence<AddPhyResourceSec> getBasePersistence() {
		return addPhyResourceSecPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addPhyResourceSecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddPhyResourceSec> getAddPhyResourceSecs(int start, int end) {
		return addPhyResourceSecPersistence.findAll(start, end);
	}
	...
	public int getAddPhyResourceSecsCount() {
		return addPhyResourceSecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddPhyResourceSec updateAddPhyResourceSec(
		AddPhyResourceSec addPhyResourceSec) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddPhyResourceSecLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addPhyResourceSecLocalService = (AddPhyResourceSecLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddPhyResourceSecLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addPhyResourceSecPersistence.getDataSource();
	...
	protected AddPhyResourceSecLocalService addPhyResourceSecLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddPhyResourceSecLocalServiceBaseImpl.class);
