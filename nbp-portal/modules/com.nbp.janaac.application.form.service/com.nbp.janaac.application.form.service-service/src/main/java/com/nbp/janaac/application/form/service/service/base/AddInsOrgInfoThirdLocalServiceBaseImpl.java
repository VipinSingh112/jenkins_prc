...
import com.nbp.janaac.application.form.service.service.AddInsOrgInfoThirdLocalService;
...
/**
 * Provides the base implementation for the add ins org info third local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoThirdLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoThirdLocalServiceImpl
 * @generated
 */
public abstract class AddInsOrgInfoThirdLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddInsOrgInfoThirdLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsOrgInfoThirdLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsOrgInfoThirdLocalServiceUtil</code>.
	 */
	...
	public AddInsOrgInfoThird addAddInsOrgInfoThird(
		...
		return addInsOrgInfoThirdPersistence.update(addInsOrgInfoThird);
	}
	...
	public AddInsOrgInfoThird createAddInsOrgInfoThird(
		...
		return addInsOrgInfoThirdPersistence.create(AddInsOrgInfoThirdId);
	}
	...
	public AddInsOrgInfoThird deleteAddInsOrgInfoThird(
		...
		return addInsOrgInfoThirdPersistence.remove(AddInsOrgInfoThirdId);
	}
	...
	public AddInsOrgInfoThird deleteAddInsOrgInfoThird(
		...
		return addInsOrgInfoThirdPersistence.remove(addInsOrgInfoThird);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addInsOrgInfoThirdPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddInsOrgInfoThird.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addInsOrgInfoThirdPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addInsOrgInfoThirdPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addInsOrgInfoThirdPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddInsOrgInfoThird fetchAddInsOrgInfoThird(
		...
		return addInsOrgInfoThirdPersistence.fetchByPrimaryKey(
	...
	public AddInsOrgInfoThird getAddInsOrgInfoThird(long AddInsOrgInfoThirdId)
		...
		return addInsOrgInfoThirdPersistence.findByPrimaryKey(
			AddInsOrgInfoThirdId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addInsOrgInfoThirdLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddInsOrgInfoThird.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddInsOrgInfoThird.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addInsOrgInfoThirdPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddInsOrgInfoThirdLocalServiceImpl#deleteAddInsOrgInfoThird(AddInsOrgInfoThird) to avoid orphaned data");
		}

		return addInsOrgInfoThirdLocalService.deleteAddInsOrgInfoThird(
			(AddInsOrgInfoThird)persistedModel);
	}

	@Override
	public BasePersistence<AddInsOrgInfoThird> getBasePersistence() {
		return addInsOrgInfoThirdPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addInsOrgInfoThirdPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddInsOrgInfoThird> getAddInsOrgInfoThirds(int start, int end) {
		return addInsOrgInfoThirdPersistence.findAll(start, end);
	}
	...
	public int getAddInsOrgInfoThirdsCount() {
		return addInsOrgInfoThirdPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsOrgInfoThirdLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addInsOrgInfoThirdLocalService =
			(AddInsOrgInfoThirdLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsOrgInfoThirdLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addInsOrgInfoThirdPersistence.getDataSource();
	...
	protected AddInsOrgInfoThirdLocalService addInsOrgInfoThirdLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsOrgInfoThirdLocalServiceBaseImpl.class);
