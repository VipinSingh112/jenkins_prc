...
import com.nbp.janaac.application.form.service.service.AddCerPersonnelThirdLocalService;
...
/**
 * Provides the base implementation for the add cer personnel third local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelThirdLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerPersonnelThirdLocalServiceImpl
 * @generated
 */
public abstract class AddCerPersonnelThirdLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddCerPersonnelThirdLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerPersonnelThirdLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerPersonnelThirdLocalServiceUtil</code>.
	 */
	...
	public AddCerPersonnelThird addAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.update(addCerPersonnelThird);
	}
	...
	public AddCerPersonnelThird createAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.create(addCerPersonnelThirdId);
	}
	...
	public AddCerPersonnelThird deleteAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.remove(addCerPersonnelThirdId);
	}
	...
	public AddCerPersonnelThird deleteAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.remove(addCerPersonnelThird);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addCerPersonnelThirdPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddCerPersonnelThird.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addCerPersonnelThirdPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addCerPersonnelThirdPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AddCerPersonnelThird fetchAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.fetchByPrimaryKey(
	...
	public AddCerPersonnelThird getAddCerPersonnelThird(
		...
		return addCerPersonnelThirdPersistence.findByPrimaryKey(
			addCerPersonnelThirdId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addCerPersonnelThirdLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddCerPersonnelThird.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addCerPersonnelThirdPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddCerPersonnelThirdLocalServiceImpl#deleteAddCerPersonnelThird(AddCerPersonnelThird) to avoid orphaned data");
		}

		return addCerPersonnelThirdLocalService.deleteAddCerPersonnelThird(
			(AddCerPersonnelThird)persistedModel);
	}

	@Override
	public BasePersistence<AddCerPersonnelThird> getBasePersistence() {
		return addCerPersonnelThirdPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addCerPersonnelThirdPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AddCerPersonnelThird> getAddCerPersonnelThirds(
		...
		return addCerPersonnelThirdPersistence.findAll(start, end);
	}
	...
	public int getAddCerPersonnelThirdsCount() {
		return addCerPersonnelThirdPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		addCerPersonnelThirdLocalService =
			(AddCerPersonnelThirdLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerPersonnelThirdLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addCerPersonnelThirdPersistence.getDataSource();
	...
	protected AddCerPersonnelThirdLocalService addCerPersonnelThirdLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerPersonnelThirdLocalServiceBaseImpl.class);
