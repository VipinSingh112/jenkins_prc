...
import com.nbp.janaac.application.form.service.service.AccThirdPartyAppliInfoService;
...
/**
 * Provides the base implementation for the acc third party appli info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccThirdPartyAppliInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccThirdPartyAppliInfoServiceImpl
 * @generated
 */
public abstract class AccThirdPartyAppliInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AccThirdPartyAppliInfoService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccThirdPartyAppliInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccThirdPartyAppliInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccThirdPartyAppliInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accThirdPartyAppliInfoService = (AccThirdPartyAppliInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccThirdPartyAppliInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accThirdPartyAppliInfoPersistence.getDataSource();
	...
	protected AccThirdPartyAppliInfoService accThirdPartyAppliInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccThirdPartyAppliInfoServiceBaseImpl.class);
