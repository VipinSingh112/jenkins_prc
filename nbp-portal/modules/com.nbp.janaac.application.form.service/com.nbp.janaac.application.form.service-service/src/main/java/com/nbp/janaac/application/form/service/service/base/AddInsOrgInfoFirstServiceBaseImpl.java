...
import com.nbp.janaac.application.form.service.service.AddInsOrgInfoFirstService;
...
/**
 * Provides the base implementation for the add ins org info first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddInsOrgInfoFirstServiceImpl
 * @generated
 */
public abstract class AddInsOrgInfoFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddInsOrgInfoFirstService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddInsOrgInfoFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddInsOrgInfoFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddInsOrgInfoFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addInsOrgInfoFirstService = (AddInsOrgInfoFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddInsOrgInfoFirstService.class.getName();
	}
	...
	protected AddInsOrgInfoFirstService addInsOrgInfoFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddInsOrgInfoFirstServiceBaseImpl.class);
