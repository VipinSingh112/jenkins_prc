...
import com.nbp.janaac.application.form.service.service.AccInsBodiesOtherReqService;
...
/**
 * Provides the base implementation for the acc ins bodies other req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOtherReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccInsBodiesOtherReqServiceImpl
 * @generated
 */
public abstract class AccInsBodiesOtherReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccInsBodiesOtherReqService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccInsBodiesOtherReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccInsBodiesOtherReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccInsBodiesOtherReqService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accInsBodiesOtherReqService = (AccInsBodiesOtherReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccInsBodiesOtherReqService.class.getName();
	}
	...
	protected AccInsBodiesOtherReqService accInsBodiesOtherReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccInsBodiesOtherReqServiceBaseImpl.class);
