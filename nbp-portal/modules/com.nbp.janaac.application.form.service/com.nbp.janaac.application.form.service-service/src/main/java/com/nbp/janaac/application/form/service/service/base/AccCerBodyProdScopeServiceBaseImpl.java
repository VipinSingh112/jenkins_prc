...
import com.nbp.janaac.application.form.service.service.AccCerBodyProdScopeService;
...
/**
 * Provides the base implementation for the acc cer body prod scope remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyProdScopeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyProdScopeServiceImpl
 * @generated
 */
public abstract class AccCerBodyProdScopeServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyProdScopeService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyProdScopeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyProdScopeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyProdScopeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyProdScopeService = (AccCerBodyProdScopeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyProdScopeService.class.getName();
	}
	...
	protected AccCerBodyProdScopeService accCerBodyProdScopeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyProdScopeServiceBaseImpl.class);
