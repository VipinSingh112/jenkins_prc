...
import com.nbp.janaac.application.form.service.service.AccMediLabTestResourceReqService;
...
/**
 * Provides the base implementation for the acc medi lab test resource req remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccMediLabTestResourceReqServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccMediLabTestResourceReqServiceImpl
 * @generated
 */
public abstract class AccMediLabTestResourceReqServiceBaseImpl
	extends BaseServiceImpl
	implements AccMediLabTestResourceReqService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccMediLabTestResourceReqService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccMediLabTestResourceReqServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccMediLabTestResourceReqService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accMediLabTestResourceReqService =
			(AccMediLabTestResourceReqService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccMediLabTestResourceReqService.class.getName();
	}
	...
	protected AccMediLabTestResourceReqService accMediLabTestResourceReqService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccMediLabTestResourceReqServiceBaseImpl.class);
