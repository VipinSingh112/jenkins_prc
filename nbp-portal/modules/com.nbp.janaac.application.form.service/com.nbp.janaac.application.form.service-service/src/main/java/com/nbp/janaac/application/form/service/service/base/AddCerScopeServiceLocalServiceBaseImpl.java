...
import com.nbp.janaac.application.form.service.service.AddCerScopeServiceLocalService;
...
/**
 * Provides the base implementation for the add cer scope service local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddCerScopeServiceLocalServiceImpl
 * @generated
 */
public abstract class AddCerScopeServiceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddCerScopeServiceLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddCerScopeServiceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddCerScopeServiceLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddCerScopeService addAddCerScopeService(
		AddCerScopeService addCerScopeService) {

		addCerScopeService.setNew(true);

		return addCerScopeServicePersistence.update(addCerScopeService);
	}
	...
	public AddCerScopeService createAddCerScopeService(
		long addCerScopeServiceId) {

		return addCerScopeServicePersistence.create(addCerScopeServiceId);
	}
	...
	@Override
	public AddCerScopeService deleteAddCerScopeService(
			long addCerScopeServiceId)
		throws PortalException {

		return addCerScopeServicePersistence.remove(addCerScopeServiceId);
	}
	...
	public AddCerScopeService deleteAddCerScopeService(
		...
		return addCerScopeServicePersistence.remove(addCerScopeService);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addCerScopeServicePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddCerScopeService.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addCerScopeServicePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return addCerScopeServicePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addCerScopeServicePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddCerScopeService fetchAddCerScopeService(
		long addCerScopeServiceId) {

		return addCerScopeServicePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AddCerScopeService getAddCerScopeService(long addCerScopeServiceId)
		throws PortalException {

		return addCerScopeServicePersistence.findByPrimaryKey(
			addCerScopeServiceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			addCerScopeServiceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AddCerScopeService.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AddCerScopeService.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return addCerScopeServicePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddCerScopeServiceLocalServiceImpl#deleteAddCerScopeService(AddCerScopeService) to avoid orphaned data");
		}

		return addCerScopeServiceLocalService.deleteAddCerScopeService(
			(AddCerScopeService)persistedModel);
	}

	@Override
	public BasePersistence<AddCerScopeService> getBasePersistence() {
		return addCerScopeServicePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return addCerScopeServicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AddCerScopeService> getAddCerScopeServices(int start, int end) {
		return addCerScopeServicePersistence.findAll(start, end);
	}
	...
	public int getAddCerScopeServicesCount() {
		return addCerScopeServicePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddCerScopeService updateAddCerScopeService(
		AddCerScopeService addCerScopeService) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddCerScopeServiceLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addCerScopeServiceLocalService =
			(AddCerScopeServiceLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddCerScopeServiceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addCerScopeServicePersistence.getDataSource();
	...
	protected AddCerScopeServiceLocalService addCerScopeServiceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddCerScopeServiceLocalServiceBaseImpl.class);
