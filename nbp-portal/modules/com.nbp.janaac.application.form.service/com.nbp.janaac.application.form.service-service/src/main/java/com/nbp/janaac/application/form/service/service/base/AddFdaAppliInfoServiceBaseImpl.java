...
import com.nbp.janaac.application.form.service.service.AddFdaAppliInfoService;
...
/**
 * Provides the base implementation for the add fda appli info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddFdaAppliInfoServiceImpl
 * @generated
 */
public abstract class AddFdaAppliInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AddFdaAppliInfoService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddFdaAppliInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddFdaAppliInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddFdaAppliInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addFdaAppliInfoService = (AddFdaAppliInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddFdaAppliInfoService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.janaac.application.form.service.service.
			AddFdaAppliInfoLocalService addFdaAppliInfoLocalService;

	protected AddFdaAppliInfoService addFdaAppliInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddFdaAppliInfoServiceBaseImpl.class);
