...
import com.nbp.janaac.application.form.service.service.AddLabMedicalDescOfActiSecService;
...
/**
 * Provides the base implementation for the add lab medical desc of acti sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalDescOfActiSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalDescOfActiSecServiceImpl
 * @generated
 */
public abstract class AddLabMedicalDescOfActiSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabMedicalDescOfActiSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalDescOfActiSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalDescOfActiSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabMedicalDescOfActiSecService.class,
	...
	public void setAopProxy(Object aopProxy) {
		addLabMedicalDescOfActiSecService =
			(AddLabMedicalDescOfActiSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalDescOfActiSecService.class.getName();
	}
	...
	protected AddLabMedicalDescOfActiSecService
		addLabMedicalDescOfActiSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalDescOfActiSecServiceBaseImpl.class);
