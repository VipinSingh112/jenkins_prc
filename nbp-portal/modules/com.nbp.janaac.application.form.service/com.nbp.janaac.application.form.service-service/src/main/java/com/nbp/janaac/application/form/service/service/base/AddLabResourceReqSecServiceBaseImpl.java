...
import com.nbp.janaac.application.form.service.service.AddLabResourceReqSecService;
...
/**
 * Provides the base implementation for the add lab resource req sec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqSecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabResourceReqSecServiceImpl
 * @generated
 */
public abstract class AddLabResourceReqSecServiceBaseImpl
	extends BaseServiceImpl
	implements AddLabResourceReqSecService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabResourceReqSecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabResourceReqSecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddLabResourceReqSecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addLabResourceReqSecService = (AddLabResourceReqSecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabResourceReqSecService.class.getName();
	}
	...
	protected AddLabResourceReqSecService addLabResourceReqSecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabResourceReqSecServiceBaseImpl.class);
