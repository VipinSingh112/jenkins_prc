...
import com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalFirstLocalService;
...
/**
 * Provides the base implementation for the add lab medical physical first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddLabMedicalPhysicalFirstLocalServiceImpl
 * @generated
 */
public abstract class AddLabMedicalPhysicalFirstLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AddLabMedicalPhysicalFirstLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddLabMedicalPhysicalFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddLabMedicalPhysicalFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public AddLabMedicalPhysicalFirst addAddLabMedicalPhysicalFirst(
		AddLabMedicalPhysicalFirst addLabMedicalPhysicalFirst) {

		addLabMedicalPhysicalFirst.setNew(true);

		return addLabMedicalPhysicalFirstPersistence.update(
	...
	public AddLabMedicalPhysicalFirst createAddLabMedicalPhysicalFirst(
		long addLabMedicalPhysicalFirstId) {

		return addLabMedicalPhysicalFirstPersistence.create(
	...
	@Override
	public AddLabMedicalPhysicalFirst deleteAddLabMedicalPhysicalFirst(
			long addLabMedicalPhysicalFirstId)
		throws PortalException {

		return addLabMedicalPhysicalFirstPersistence.remove(
			addLabMedicalPhysicalFirstId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return addLabMedicalPhysicalFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AddLabMedicalPhysicalFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return addLabMedicalPhysicalFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return addLabMedicalPhysicalFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AddLabMedicalPhysicalFirst fetchAddLabMedicalPhysicalFirst(
		long addLabMedicalPhysicalFirstId) {

		return addLabMedicalPhysicalFirstPersistence.fetchByPrimaryKey(
			addLabMedicalPhysicalFirstId);
	}
	 ...
	 */
	@Override
	public AddLabMedicalPhysicalFirst getAddLabMedicalPhysicalFirst(
			long addLabMedicalPhysicalFirstId)
		throws PortalException {

		return addLabMedicalPhysicalFirstPersistence.findByPrimaryKey(
			addLabMedicalPhysicalFirstId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AddLabMedicalPhysicalFirst.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AddLabMedicalPhysicalFirst.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AddLabMedicalPhysicalFirstLocalServiceImpl#deleteAddLabMedicalPhysicalFirst(AddLabMedicalPhysicalFirst) to avoid orphaned data");
		}

		return addLabMedicalPhysicalFirstLocalService.
			deleteAddLabMedicalPhysicalFirst(
				(AddLabMedicalPhysicalFirst)persistedModel);
	}

	@Override
	public BasePersistence<AddLabMedicalPhysicalFirst> getBasePersistence() {
		return addLabMedicalPhysicalFirstPersistence;
	}
	 ...
	 */
	@Override
	public List<AddLabMedicalPhysicalFirst> getAddLabMedicalPhysicalFirsts(
		int start, int end) {

		return addLabMedicalPhysicalFirstPersistence.findAll(start, end);
	}
	...
	public int getAddLabMedicalPhysicalFirstsCount() {
		return addLabMedicalPhysicalFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AddLabMedicalPhysicalFirst updateAddLabMedicalPhysicalFirst(
		AddLabMedicalPhysicalFirst addLabMedicalPhysicalFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		addLabMedicalPhysicalFirstLocalService =
			(AddLabMedicalPhysicalFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddLabMedicalPhysicalFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				addLabMedicalPhysicalFirstPersistence.getDataSource();
	...
	protected AddLabMedicalPhysicalFirstLocalService
		addLabMedicalPhysicalFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddLabMedicalPhysicalFirstLocalServiceBaseImpl.class);
