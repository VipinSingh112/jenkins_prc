...
import com.nbp.janaac.application.form.service.service.AccCerBodyGeneralLocalService;
...
/**
 * Provides the base implementation for the acc cer body general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyGeneralLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyGeneralLocalServiceImpl
 * @generated
 */
public abstract class AccCerBodyGeneralLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccCerBodyGeneralLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyGeneralLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyGeneralLocalServiceUtil</code>.
	 */
	...
	@Override
	public AccCerBodyGeneral addAccCerBodyGeneral(
		AccCerBodyGeneral accCerBodyGeneral) {

		accCerBodyGeneral.setNew(true);

		return accCerBodyGeneralPersistence.update(accCerBodyGeneral);
	}
	...
	public AccCerBodyGeneral createAccCerBodyGeneral(long accCerBodyGeneralId) {
		return accCerBodyGeneralPersistence.create(accCerBodyGeneralId);
	}
	...
	@Override
	public AccCerBodyGeneral deleteAccCerBodyGeneral(long accCerBodyGeneralId)
		throws PortalException {

		return accCerBodyGeneralPersistence.remove(accCerBodyGeneralId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccCerBodyGeneral deleteAccCerBodyGeneral(
		AccCerBodyGeneral accCerBodyGeneral) {

		return accCerBodyGeneralPersistence.remove(accCerBodyGeneral);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return accCerBodyGeneralPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AccCerBodyGeneral.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accCerBodyGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return accCerBodyGeneralPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accCerBodyGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return accCerBodyGeneralPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AccCerBodyGeneral fetchAccCerBodyGeneral(long accCerBodyGeneralId) {
		return accCerBodyGeneralPersistence.fetchByPrimaryKey(
			accCerBodyGeneralId);
	}
	 ...
	 */
	@Override
	public AccCerBodyGeneral fetchAccCerBodyGeneralByUuidAndGroupId(
		String uuid, long groupId) {

		return accCerBodyGeneralPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public AccCerBodyGeneral getAccCerBodyGeneral(long accCerBodyGeneralId)
		throws PortalException {

		return accCerBodyGeneralPersistence.findByPrimaryKey(
			accCerBodyGeneralId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			accCerBodyGeneralLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccCerBodyGeneral.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accCerBodyGeneralId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AccCerBodyGeneral.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(AccCerBodyGeneral accCerBodyGeneral)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, accCerBodyGeneral);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyGeneralPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AccCerBodyGeneralLocalServiceImpl#deleteAccCerBodyGeneral(AccCerBodyGeneral) to avoid orphaned data");
		}

		return accCerBodyGeneralLocalService.deleteAccCerBodyGeneral(
			(AccCerBodyGeneral)persistedModel);
	}

	@Override
	public BasePersistence<AccCerBodyGeneral> getBasePersistence() {
		return accCerBodyGeneralPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return accCerBodyGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AccCerBodyGeneral> getAccCerBodyGeneralsByUuidAndCompanyId(
		String uuid, long companyId) {

		return accCerBodyGeneralPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AccCerBodyGeneral> getAccCerBodyGeneralsByUuidAndCompanyId(
		...
		return accCerBodyGeneralPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public AccCerBodyGeneral getAccCerBodyGeneralByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return accCerBodyGeneralPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<AccCerBodyGeneral> getAccCerBodyGenerals(int start, int end) {
		return accCerBodyGeneralPersistence.findAll(start, end);
	}
	...
	public int getAccCerBodyGeneralsCount() {
		return accCerBodyGeneralPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AccCerBodyGeneral updateAccCerBodyGeneral(
		AccCerBodyGeneral accCerBodyGeneral) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyGeneralLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		accCerBodyGeneralLocalService = (AccCerBodyGeneralLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyGeneralLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				accCerBodyGeneralPersistence.getDataSource();
	...
	protected AccCerBodyGeneralLocalService accCerBodyGeneralLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyGeneralLocalServiceBaseImpl.class);
