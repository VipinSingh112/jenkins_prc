...
import com.nbp.janaac.application.form.service.service.AddPhyResourceFirstService;
...
/**
 * Provides the base implementation for the add phy resource first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AddPhyResourceFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AddPhyResourceFirstServiceImpl
 * @generated
 */
public abstract class AddPhyResourceFirstServiceBaseImpl
	extends BaseServiceImpl
	implements AddPhyResourceFirstService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddPhyResourceFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AddPhyResourceFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddPhyResourceFirstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addPhyResourceFirstService = (AddPhyResourceFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddPhyResourceFirstService.class.getName();
	}
	...
	protected AddPhyResourceFirstService addPhyResourceFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddPhyResourceFirstServiceBaseImpl.class);
