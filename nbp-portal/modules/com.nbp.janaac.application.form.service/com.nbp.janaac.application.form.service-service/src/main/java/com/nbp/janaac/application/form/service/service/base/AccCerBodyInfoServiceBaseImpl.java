...
import com.nbp.janaac.application.form.service.service.AccCerBodyInfoService;
...
/**
 * Provides the base implementation for the acc cer body info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.janaac.application.form.service.service.impl.AccCerBodyInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.janaac.application.form.service.service.impl.AccCerBodyInfoServiceImpl
 * @generated
 */
public abstract class AccCerBodyInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AccCerBodyInfoService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccCerBodyInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.janaac.application.form.service.service.AccCerBodyInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccCerBodyInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accCerBodyInfoService = (AccCerBodyInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccCerBodyInfoService.class.getName();
	}
	...
	protected AccCerBodyInfoService accCerBodyInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccCerBodyInfoServiceBaseImpl.class);
