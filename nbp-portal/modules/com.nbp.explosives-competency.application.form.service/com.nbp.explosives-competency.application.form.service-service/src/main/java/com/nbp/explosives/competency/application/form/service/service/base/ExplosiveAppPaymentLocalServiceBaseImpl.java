...
import com.nbp.explosives.competency.application.form.service.service.ExplosiveAppPaymentLocalService;
...
/**
 * Provides the base implementation for the explosive app payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.explosives.competency.application.form.service.service.impl.ExplosiveAppPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.explosives.competency.application.form.service.service.impl.ExplosiveAppPaymentLocalServiceImpl
 * @generated
 */
public abstract class ExplosiveAppPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ExplosiveAppPaymentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ExplosiveAppPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.explosives.competency.application.form.service.service.ExplosiveAppPaymentLocalServiceUtil</code>.
	 */
	...
	public ExplosiveAppPayment addExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.update(explosiveAppPayment);
	}
	...
	public ExplosiveAppPayment createExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.create(explosiveAppPaymentId);
	}
	...
	public ExplosiveAppPayment deleteExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.remove(explosiveAppPaymentId);
	}
	...
	public ExplosiveAppPayment deleteExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.remove(explosiveAppPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return explosiveAppPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ExplosiveAppPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return explosiveAppPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return explosiveAppPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ExplosiveAppPayment fetchExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.fetchByPrimaryKey(
	...
	public ExplosiveAppPayment getExplosiveAppPayment(
		...
		return explosiveAppPaymentPersistence.findByPrimaryKey(
			explosiveAppPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			explosiveAppPaymentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ExplosiveAppPayment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return explosiveAppPaymentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ExplosiveAppPaymentLocalServiceImpl#deleteExplosiveAppPayment(ExplosiveAppPayment) to avoid orphaned data");
		}

		return explosiveAppPaymentLocalService.deleteExplosiveAppPayment(
			(ExplosiveAppPayment)persistedModel);
	}

	@Override
	public BasePersistence<ExplosiveAppPayment> getBasePersistence() {
		return explosiveAppPaymentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return explosiveAppPaymentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ExplosiveAppPayment> getExplosiveAppPayments(
		...
		return explosiveAppPaymentPersistence.findAll(start, end);
	}
	...
	public int getExplosiveAppPaymentsCount() {
		return explosiveAppPaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		explosiveAppPaymentLocalService =
			(ExplosiveAppPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExplosiveAppPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				explosiveAppPaymentPersistence.getDataSource();
	...
	protected ExplosiveAppPaymentLocalService explosiveAppPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ExplosiveAppPaymentLocalServiceBaseImpl.class);
