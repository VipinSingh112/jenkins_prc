...
import com.nbp.explosives.competency.application.form.service.service.ExplosivesApplicationService;
...
/**
 * Provides the base implementation for the explosives application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.explosives.competency.application.form.service.service.impl.ExplosivesApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.explosives.competency.application.form.service.service.impl.ExplosivesApplicationServiceImpl
 * @generated
 */
public abstract class ExplosivesApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ExplosivesApplicationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ExplosivesApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.explosives.competency.application.form.service.service.ExplosivesApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ExplosivesApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		explosivesApplicationService = (ExplosivesApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExplosivesApplicationService.class.getName();
	}
	...
	protected ExplosivesApplicationService explosivesApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ExplosivesApplicationServiceBaseImpl.class);
