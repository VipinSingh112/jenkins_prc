...
import com.nbp.explosives.competency.application.form.service.service.ExplosiveAppPaymentService;
...
/**
 * Provides the base implementation for the explosive app payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.explosives.competency.application.form.service.service.impl.ExplosiveAppPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.explosives.competency.application.form.service.service.impl.ExplosiveAppPaymentServiceImpl
 * @generated
 */
public abstract class ExplosiveAppPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, ExplosiveAppPaymentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ExplosiveAppPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.explosives.competency.application.form.service.service.ExplosiveAppPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ExplosiveAppPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		explosiveAppPaymentService = (ExplosiveAppPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ExplosiveAppPaymentService.class.getName();
	}
	...
	protected ExplosiveAppPaymentService explosiveAppPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ExplosiveAppPaymentServiceBaseImpl.class);
