...
/**
 * Provides the local service interface for BlasterCompetencyForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BlasterCompetencyFormLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BlasterCompetencyFormLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.explosives.competency.application.form.service.service.impl.BlasterCompetencyFormLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the blaster competency form local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BlasterCompetencyFormLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BlasterCompetencyForm getExplosiveById(long explosivesApplicationId)
