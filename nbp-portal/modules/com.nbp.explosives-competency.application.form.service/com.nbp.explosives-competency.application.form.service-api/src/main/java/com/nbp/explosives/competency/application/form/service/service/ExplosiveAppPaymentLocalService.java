...
/**
 * Provides the local service interface for ExplosiveAppPayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExplosiveAppPaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ExplosiveAppPaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.explosives.competency.application.form.service.service.impl.ExplosiveAppPaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the explosive app payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ExplosiveAppPaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ExplosiveAppPayment addExplosiveAppPayment(
	...
	public ExplosiveAppPayment createExplosiveAppPayment(
	...
	public ExplosiveAppPayment deleteExplosiveAppPayment(
		ExplosiveAppPayment explosiveAppPayment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExplosiveAppPayment fetchExplosiveAppPayment(
		long explosiveAppPaymentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExplosiveAppPayment getExplosiveAppPayment(
			long explosiveAppPaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ExplosiveAppPayment> getExplosiveAppPayments(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExplosiveAppPayment getExplosiveById(long explosivesApplicationId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ExplosiveAppPayment updateExplosiveAppPayment(
		ExplosiveAppPayment explosiveAppPayment);
