...
import com.nbp.acquire.application.form.service.service.AcquireLandPropertyDetailsService;
...
/**
 * Provides the base implementation for the acquire land property details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.application.form.service.service.impl.AcquireLandPropertyDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.application.form.service.service.impl.AcquireLandPropertyDetailsServiceImpl
 * @generated
 */
public abstract class AcquireLandPropertyDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireLandPropertyDetailsService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireLandPropertyDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.application.form.service.service.AcquireLandPropertyDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		acquireLandPropertyDetailsService =
			(AcquireLandPropertyDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireLandPropertyDetailsService.class.getName();
	}
	...
	protected AcquireLandPropertyDetailsService
		acquireLandPropertyDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireLandPropertyDetailsServiceBaseImpl.class);
