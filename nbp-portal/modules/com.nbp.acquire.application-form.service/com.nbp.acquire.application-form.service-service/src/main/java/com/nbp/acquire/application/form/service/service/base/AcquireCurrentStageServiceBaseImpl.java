...
import com.nbp.acquire.application.form.service.service.AcquireCurrentStageService;
...
/**
 * Provides the base implementation for the acquire current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.application.form.service.service.impl.AcquireCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.application.form.service.service.impl.AcquireCurrentStageServiceImpl
 * @generated
 */
public abstract class AcquireCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireCurrentStageService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.application.form.service.service.AcquireCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireCurrentStageService = (AcquireCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireCurrentStageService.class.getName();
	}
	...
	protected AcquireCurrentStageService acquireCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireCurrentStageServiceBaseImpl.class);
