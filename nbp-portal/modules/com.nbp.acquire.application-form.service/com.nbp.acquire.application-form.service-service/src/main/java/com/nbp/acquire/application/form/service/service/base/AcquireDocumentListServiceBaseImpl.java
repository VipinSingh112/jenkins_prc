...
import com.nbp.acquire.application.form.service.service.AcquireDocumentListService;
...
/**
 * Provides the base implementation for the acquire document list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.application.form.service.service.impl.AcquireDocumentListServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.application.form.service.service.impl.AcquireDocumentListServiceImpl
 * @generated
 */
public abstract class AcquireDocumentListServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireDocumentListService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireDocumentListService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.application.form.service.service.AcquireDocumentListServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireDocumentListService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireDocumentListService = (AcquireDocumentListService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireDocumentListService.class.getName();
	}
	...
	protected AcquireDocumentListService acquireDocumentListService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireDocumentListServiceBaseImpl.class);
