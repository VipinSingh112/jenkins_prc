...
import com.nbp.acquire.application.form.service.service.AcquirePropertyDetailsService;
...
/**
 * Provides the base implementation for the acquire property details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.application.form.service.service.impl.AcquirePropertyDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.application.form.service.service.impl.AcquirePropertyDetailsServiceImpl
 * @generated
 */
public abstract class AcquirePropertyDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AcquirePropertyDetailsService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquirePropertyDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.application.form.service.service.AcquirePropertyDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquirePropertyDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquirePropertyDetailsService = (AcquirePropertyDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquirePropertyDetailsService.class.getName();
	}
	...
	protected AcquirePropertyDetailsService acquirePropertyDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquirePropertyDetailsServiceBaseImpl.class);
