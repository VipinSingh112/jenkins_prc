package com.nbp.ncbj.application.form.web.constants;

public class NCBJApplicationWorkflowConstant {
	...
	public static final String RENEW_APPLICATION = "Recertification";
