<fieldset class="wizard-fieldset" id="ncbjFormPreviewFieldset" name="NCBJ FORM PREVIEW">
	<section class="form-preview">
		<div class="d-flex align-items-center justify-content-between">
			...
			<div>
				<a id="ncbjDownloadPDF" type="button" class="common-yellow-bg p-2 border-0 download-btn">Download and Print
					<span>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="tab-plus-wizard-left">
								<p class="tab-plus-wizard-left-heading f1">Application
									Details</p>
								<ul class="nav nav-tabs form-preview-nav hide iso9001CertificationForm"  role="tablist">
									<li role="presentation" class="nav-item applicant-details">
										<a href="#ncbjPreviewStep1" class="nav-link active"> 
									...
									<li role="presentation" class="nav-item applicant-details">
										<a href="#ncbjPreviewStep2" class="nav-link"> 
											<div class="w-100 text-wrap">
									...
									<li role="presentation" class="nav-item applicant-details">
										<a href="#ncbjPreviewStep3" class="nav-link"> 
											<div class="w-100 text-wrap">
									...
									<li role="presentation" class="nav-item quotation-details">
										<a href="#ncbjPreviewStep4" class="nav-link"> 
											<div class="w-100 text-wrap">
												<span class="step-type green quotation-form-tab">4</span>
								...
								<ul class="nav nav-tabs form-preview-nav hide newForm22000" role="tablist">
									<!-- <li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep5" class="nav-link active"> 
											<div class="w-100 text-wrap">
												<span class="step-type green">1</span>
									...
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep6" class="nav-link"> 
											<div class="w-100 text-wrap">
												<span class="step-type green">1</span>
												<span>Section I</span> 
											</div>
									...
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep7" class="nav-link"> 
											<div class="w-100 text-wrap">
												<span class="step-type green">2</span>
									...
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep8" class="nav-link"> 
											<div class="w-100 text-wrap">
												<span class="step-type green">3</span>
									...
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep9" class="nav-link"> 
											<div class="w-100 text-wrap">
									...
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep10" class="nav-link"> 
											<div class="w-100 text-wrap">
								...
								<ul class="nav nav-tabs form-preview-nav supporting-doc-preview" role="tablist">
									<li role="presentation" class="nav-item">
										<a href="#ncbjPreviewStep11" class="nav-link"">
											<div class="w-100 text-wrap">
						...
						<div class="col-lg-8">
							<div class="tab-content Licence_form pl-lg-4">
								<jsp:include page="/preview/ncbj-form-preview-content.jsp" />
							</div>
						</div>
					</div>
				</div>
