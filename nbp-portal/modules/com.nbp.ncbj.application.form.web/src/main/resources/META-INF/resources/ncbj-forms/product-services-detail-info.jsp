<%
String productServicesDetailVal="";
productServicesDetailVal = (String)request.getAttribute("productServicesDetailVal");
%>
<tr class="product-services-detail-row<%=productServicesDetailVal%>">
	<td class="sub_heading_content productType<%=productServicesDetailVal%>"></td>
	<td class="sub_heading_content productList<%=productServicesDetailVal%>"></td>
	<td class="sub_heading_content productLines<%=productServicesDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="productServicesDetailId<%=productServicesDetailVal%>" name="productServicesDetails<%=productServicesDetailVal%>" value="">
</tr>