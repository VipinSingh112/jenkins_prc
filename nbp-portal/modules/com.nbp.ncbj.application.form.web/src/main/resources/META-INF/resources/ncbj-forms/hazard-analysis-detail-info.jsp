<%
String hazardAnalysisDetailVal="";
hazardAnalysisDetailVal = (String)request.getAttribute("hazardAnalysisDetailVal");
%>
<tr class="hazard-analysis-detail-row<%=hazardAnalysisDetailVal%>">
	<td class="sub_heading_content hazardAnalysis<%=hazardAnalysisDetailVal%>"></td>
	<td class="sub_heading_content">
		<!-- <div id="hazardControlPoint"> -->
			<a class="file-info sub_heading_content hazardControlPoint<%=hazardAnalysisDetailVal%>" href="javascript:void(0)"></a>
		<!-- </div> -->
	</td>
	<td> 
		<span> 
     ...
     <td> 
		<span> 
			<a href="javascript:void(0)" id="hazardAnalysisDetailDeleteDataTab" onclick="hazardAnalysisDetailDeleteData('<%=hazardAnalysisDetailVal%>');"> 
     ...
     <input type="hidden" id="hazardAnalysisDetailId<%=hazardAnalysisDetailVal%>" name="hazardAnalysisDetailId<%=hazardAnalysisDetailVal%>" value="">
</tr>