...
<div class="uploaded-info generic-doc" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
	...
	<div class="right">
		<a class="uploaded-actionlink" href="<%=fileUrlInHsraApplication%>" id="doc-download-btn"> 
			<span class="mr-2">
		...
		<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=genericNcbjCounter%>')">
