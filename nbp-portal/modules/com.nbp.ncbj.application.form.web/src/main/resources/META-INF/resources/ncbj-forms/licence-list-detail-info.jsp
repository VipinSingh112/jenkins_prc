<%
String licenceListDetailVal="";
licenceListDetailVal = (String)request.getAttribute("licenceListDetailVal");
%>
<tr class="licence-list-detail-row<%=licenceListDetailVal%>">
	<td class="sub_heading_content text-nowrap consentsList<%=licenceListDetailVal%>"></td>
	<td class="sub_heading_content">
		<!-- <div id="consentsListUpload"> -->
			<a class="file-info sub_heading_content consentsListUpload<%=licenceListDetailVal%>" href="javascript:void(0)"></a>
		<!-- </div> -->
	</td>
	<td> 
		<span> 
     ...
     <td> 
		<span> 
			<a href="javascript:void(0)" id="licenceListDetailDeleteDataTab" onclick="licenceListDetailDeleteData('<%=licenceListDetailVal%>');"> 
     ...
     <input type="hidden" id="licenceListDetailId<%=licenceListDetailVal%>" name="licenceListDetailId<%=licenceListDetailVal%>" value="">
</tr>