...
/**
 * Provides the local service utility for FireBrigadePaymentConfirmation. This utility wraps
 * <code>com.nbp.fire.brigade.stage.service.service.impl.FireBrigadePaymentConfirmationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FireBrigadePaymentConfirmationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.fire.brigade.stage.service.service.impl.FireBrigadePaymentConfirmationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static FireBrigadePaymentConfirmation
		...
		return getService().addFireBrigadePaymentConfirmation(
	 ...
	 */
	public static FireBrigadePaymentConfirmation
		createFireBrigadePaymentConfirmation(long fireBrigadePaymentConfirId) {

		return getService().createFireBrigadePaymentConfirmation(
	...
	public static FireBrigadePaymentConfirmation
		...
		return getService().deleteFireBrigadePaymentConfirmation(
			fireBrigadePaymentConfirmation);
	}
	...
	public static FireBrigadePaymentConfirmation
		fetchFireBrigadePaymentConfirmation(long fireBrigadePaymentConfirId) {

		return getService().fetchFireBrigadePaymentConfirmation(
			fireBrigadePaymentConfirId);
	}
	...
	public static List<FireBrigadePaymentConfirmation> getFBA_PC_By_FBI(
		String caseId) {

		return getService().getFBA_PC_By_FBI(caseId);
	}

	public static FireBrigadePaymentConfirmation getFireBrigadePaymentByCaseId(
			String caseId)
		throws com.nbp.fire.brigade.stage.service.exception.
			NoSuchFireBrigadePaymentConfirmationException {

		return getService().getFireBrigadePaymentByCaseId(caseId);
	}
	 ...
	 */
	public static FireBrigadePaymentConfirmation
			getFireBrigadePaymentConfirmation(long fireBrigadePaymentConfirId)
		throws PortalException {

		return getService().getFireBrigadePaymentConfirmation(
			fireBrigadePaymentConfirId);
	}
	 ...
	 */
	public static List<FireBrigadePaymentConfirmation>
		getFireBrigadePaymentConfirmations(int start, int end) {

		return getService().getFireBrigadePaymentConfirmations(start, end);
	}
	 ...
	 */
	public static int getFireBrigadePaymentConfirmationsCount() {
		return getService().getFireBrigadePaymentConfirmationsCount();
	}
	...
	public static FireBrigadePaymentConfirmation
		...
		return getService().updateFireBrigadePaymentConfirmation(
			fireBrigadePaymentConfirmation);
	}
	...
	public static FireBrigadePaymentConfirmationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FireBrigadePaymentConfirmationLocalService>
		_serviceSnapshot = new Snapshot<>(
			FireBrigadePaymentConfirmationLocalServiceUtil.class,
