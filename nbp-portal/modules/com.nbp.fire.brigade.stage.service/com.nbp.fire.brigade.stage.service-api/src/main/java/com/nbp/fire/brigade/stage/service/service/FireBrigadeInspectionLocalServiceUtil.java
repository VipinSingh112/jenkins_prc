...
/**
 * Provides the local service utility for FireBrigadeInspection. This utility wraps
 * <code>com.nbp.fire.brigade.stage.service.service.impl.FireBrigadeInspectionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FireBrigadeInspectionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.fire.brigade.stage.service.service.impl.FireBrigadeInspectionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FireBrigadeInspection addFireBrigadeInspection(
		FireBrigadeInspection fireBrigadeInspection) {

		return getService().addFireBrigadeInspection(fireBrigadeInspection);
	}
	 ...
	 */
	public static FireBrigadeInspection createFireBrigadeInspection(
		long fireBrigadeInspectionId) {

		return getService().createFireBrigadeInspection(
	 ...
	 */
	public static FireBrigadeInspection deleteFireBrigadeInspection(
		FireBrigadeInspection fireBrigadeInspection) {

		return getService().deleteFireBrigadeInspection(fireBrigadeInspection);
	}
	...
	public static FireBrigadeInspection deleteFireBrigadeInspection(
		...
		return getService().deleteFireBrigadeInspection(
			fireBrigadeInspectionId);
	}
	...
	public static FireBrigadeInspection fetchFireBrigadeInspection(
		long fireBrigadeInspectionId) {

		return getService().fetchFireBrigadeInspection(fireBrigadeInspectionId);
	}
	...
	public static List<FireBrigadeInspection> getFBI_CaseId(String caseId) {
		return getService().getFBI_CaseId(caseId);
	}

	public static List<FireBrigadeInspection> getFBI_CaseIdApplicationId(
		String status, long fireBrigadeApplicationId) {

		return getService().getFBI_CaseIdApplicationId(
			status, fireBrigadeApplicationId);
	}

	public static List<FireBrigadeInspection> getFBI_CaseIdStatus(
		String caseId, String status) {

		return getService().getFBI_CaseIdStatus(caseId, status);
	}

	public static List<FireBrigadeInspection> getFBI_FBAI(
		long fireBrigadeApplicationId) {

		return getService().getFBI_FBAI(fireBrigadeApplicationId);
	}

	public static List<FireBrigadeInspection> getFBI_Status(String status) {
		return getService().getFBI_Status(status);
	}

	public static List<FireBrigadeInspection> getFBI_StatusApplicationId(
		String status, long fireBrigadeApplicationId) {

		return getService().getFBI_StatusApplicationId(
			status, fireBrigadeApplicationId);
	}
	 ...
	 * @throws PortalException if a fire brigade inspection with the primary key could not be found
	 */
	public static FireBrigadeInspection getFireBrigadeInspection(
			long fireBrigadeInspectionId)
		throws PortalException {

		return getService().getFireBrigadeInspection(fireBrigadeInspectionId);
	}

	public static FireBrigadeInspection getFireBrigadeInspectionBy_CI(
			String caseId)
		throws com.nbp.fire.brigade.stage.service.exception.
			NoSuchFireBrigadeInspectionException {

		return getService().getFireBrigadeInspectionBy_CI(caseId);
	}
	 ...
	 */
	public static List<FireBrigadeInspection> getFireBrigadeInspections(
		int start, int end) {

		return getService().getFireBrigadeInspections(start, end);
	}
	 ...
	 */
	public static int getFireBrigadeInspectionsCount() {
		return getService().getFireBrigadeInspectionsCount();
	}
	 ...
	 */
	public static FireBrigadeInspection updateFireBrigadeInspection(
		FireBrigadeInspection fireBrigadeInspection) {

		return getService().updateFireBrigadeInspection(fireBrigadeInspection);
	}

	public static FireBrigadeInspectionLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FireBrigadeInspectionLocalService>
		_serviceSnapshot = new Snapshot<>(
			FireBrigadeInspectionLocalServiceUtil.class,
