...
import com.nbp.fire.brigade.stage.service.service.FireBrigadeCertificateLocalService;
...
/**
 * Provides the base implementation for the fire brigade certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.fire.brigade.stage.service.service.impl.FireBrigadeCertificateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.fire.brigade.stage.service.service.impl.FireBrigadeCertificateLocalServiceImpl
 * @generated
 */
public abstract class FireBrigadeCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FireBrigadeCertificateLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FireBrigadeCertificateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.fire.brigade.stage.service.service.FireBrigadeCertificateLocalServiceUtil</code>.
	 */
	...
	public FireBrigadeCertificate addFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.update(fireBrigadeCertificate);
	}
	...
	public FireBrigadeCertificate createFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.create(
	...
	public FireBrigadeCertificate deleteFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.remove(
			fireBrigadeCertificateId);
	}
	...
	public FireBrigadeCertificate deleteFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.remove(fireBrigadeCertificate);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fireBrigadeCertificatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FireBrigadeCertificate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fireBrigadeCertificatePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fireBrigadeCertificatePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FireBrigadeCertificate fetchFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.fetchByPrimaryKey(
			fireBrigadeCertificateId);
	}
	...
	public FireBrigadeCertificate getFireBrigadeCertificate(
		...
		return fireBrigadeCertificatePersistence.findByPrimaryKey(
			fireBrigadeCertificateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FireBrigadeCertificate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FireBrigadeCertificateLocalServiceImpl#deleteFireBrigadeCertificate(FireBrigadeCertificate) to avoid orphaned data");
		}

		return fireBrigadeCertificateLocalService.deleteFireBrigadeCertificate(
			(FireBrigadeCertificate)persistedModel);
	}

	@Override
	public BasePersistence<FireBrigadeCertificate> getBasePersistence() {
		return fireBrigadeCertificatePersistence;
	}
	...
	public List<FireBrigadeCertificate> getFireBrigadeCertificates(
		...
		return fireBrigadeCertificatePersistence.findAll(start, end);
	}
	...
	public int getFireBrigadeCertificatesCount() {
		return fireBrigadeCertificatePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		fireBrigadeCertificateLocalService =
			(FireBrigadeCertificateLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FireBrigadeCertificateLocalService.class.getName();
	}
	...
	protected FireBrigadeCertificateLocalService
		fireBrigadeCertificateLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FireBrigadeCertificateLocalServiceBaseImpl.class);
