...
import com.nbp.tourism.application.form.services.service.TourismNewAccommodationAddressService;
...
/**
 * Provides the base implementation for the tourism new accommodation address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccommodationAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccommodationAddressServiceImpl
 * @generated
 */
public abstract class TourismNewAccommodationAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccommodationAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccommodationAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccommodationAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccommodationAddressService =
			(TourismNewAccommodationAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccommodationAddressService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAccommodationAddressPersistence.getDataSource();
	...
	protected TourismNewAccommodationAddressService
		tourismNewAccommodationAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccommodationAddressServiceBaseImpl.class);
