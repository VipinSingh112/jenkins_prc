...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionFormSecondService;
...
/**
 * Provides the base implementation for the tourism new attraction form second remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormSecondServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormSecondServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionFormSecondServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionFormSecondService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionFormSecondServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAttractionFormSecondService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionFormSecondService =
			(TourismNewAttractionFormSecondService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionFormSecondService.class.getName();
	}
	...
	protected TourismNewAttractionFormSecondService
		tourismNewAttractionFormSecondService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionFormSecondServiceBaseImpl.class);
