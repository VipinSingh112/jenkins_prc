...
import com.nbp.tourism.application.form.services.service.TourismApplicationPaymentService;
...
/**
 * Provides the base implementation for the tourism application payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismApplicationPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismApplicationPaymentServiceImpl
 * @generated
 */
public abstract class TourismApplicationPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TourismApplicationPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismApplicationPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismApplicationPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismApplicationPaymentService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismApplicationPaymentService =
			(TourismApplicationPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismApplicationPaymentService.class.getName();
	}
	...
	protected TourismApplicationPaymentService tourismApplicationPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismApplicationPaymentServiceBaseImpl.class);
