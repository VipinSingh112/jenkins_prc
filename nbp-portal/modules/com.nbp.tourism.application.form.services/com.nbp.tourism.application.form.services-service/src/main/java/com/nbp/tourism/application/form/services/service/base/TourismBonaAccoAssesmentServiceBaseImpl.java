...
import com.nbp.tourism.application.form.services.service.TourismBonaAccoAssesmentService;
...
/**
 * Provides the base implementation for the tourism bona acco assesment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoAssesmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoAssesmentServiceImpl
 * @generated
 */
public abstract class TourismBonaAccoAssesmentServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccoAssesmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccoAssesmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAccoAssesmentService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccoAssesmentService =
			(TourismBonaAccoAssesmentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccoAssesmentService.class.getName();
	}
	...
	protected TourismBonaAccoAssesmentService tourismBonaAccoAssesmentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccoAssesmentServiceBaseImpl.class);
