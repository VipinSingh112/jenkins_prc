...
import com.nbp.tourism.application.form.services.service.TourismNewAccoAssesmentLocalService;
...
/**
 * Provides the base implementation for the tourism new acco assesment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccoAssesmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccoAssesmentLocalServiceImpl
 * @generated
 */
public abstract class TourismNewAccoAssesmentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccoAssesmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccoAssesmentLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismNewAccoAssesment addTourismNewAccoAssesment(
		TourismNewAccoAssesment tourismNewAccoAssesment) {

		tourismNewAccoAssesment.setNew(true);

		return tourismNewAccoAssesmentPersistence.update(
	...
	public TourismNewAccoAssesment createTourismNewAccoAssesment(
		long TourismNewAccoAssesmentInfoId) {

		return tourismNewAccoAssesmentPersistence.create(
	...
	@Override
	public TourismNewAccoAssesment deleteTourismNewAccoAssesment(
			long TourismNewAccoAssesmentInfoId)
		throws PortalException {

		return tourismNewAccoAssesmentPersistence.remove(
			TourismNewAccoAssesmentInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewAccoAssesmentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewAccoAssesment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewAccoAssesmentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewAccoAssesmentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismNewAccoAssesment fetchTourismNewAccoAssesment(
		long TourismNewAccoAssesmentInfoId) {

		return tourismNewAccoAssesmentPersistence.fetchByPrimaryKey(
			TourismNewAccoAssesmentInfoId);
	}
	 ...
	 */
	@Override
	public TourismNewAccoAssesment getTourismNewAccoAssesment(
			long TourismNewAccoAssesmentInfoId)
		throws PortalException {

		return tourismNewAccoAssesmentPersistence.findByPrimaryKey(
			TourismNewAccoAssesmentInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismNewAccoAssesment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewAccoAssesmentLocalServiceImpl#deleteTourismNewAccoAssesment(TourismNewAccoAssesment) to avoid orphaned data");
		}

		return tourismNewAccoAssesmentLocalService.
			deleteTourismNewAccoAssesment(
				(TourismNewAccoAssesment)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewAccoAssesment> getBasePersistence() {
		return tourismNewAccoAssesmentPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismNewAccoAssesment> getTourismNewAccoAssesments(
		int start, int end) {

		return tourismNewAccoAssesmentPersistence.findAll(start, end);
	}
	...
	public int getTourismNewAccoAssesmentsCount() {
		return tourismNewAccoAssesmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewAccoAssesment updateTourismNewAccoAssesment(
		TourismNewAccoAssesment tourismNewAccoAssesment) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccoAssesmentLocalService =
			(TourismNewAccoAssesmentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccoAssesmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAccoAssesmentPersistence.getDataSource();
	...
	protected TourismNewAccoAssesmentLocalService
		tourismNewAccoAssesmentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccoAssesmentLocalServiceBaseImpl.class);
