...
import com.nbp.tourism.application.form.services.service.TourismNewGroundTransportationService;
...
/**
 * Provides the base implementation for the tourism new ground transportation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationServiceImpl
 * @generated
 */
public abstract class TourismNewGroundTransportationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewGroundTransportationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewGroundTransportationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewGroundTransportationService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewGroundTransportationService =
			(TourismNewGroundTransportationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewGroundTransportationService.class.getName();
	}
	...
	protected TourismNewGroundTransportationService
		tourismNewGroundTransportationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewGroundTransportationServiceBaseImpl.class);
