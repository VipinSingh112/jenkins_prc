...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundPaymentInfoLocalService;
...
/**
 * Provides the base implementation for the tourism bona ground payment info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundPaymentInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundPaymentInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundPaymentInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundPaymentInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundPaymentInfoLocalServiceUtil</code>.
	 */
	...
	public TourismBonaGroundPaymentInfo addTourismBonaGroundPaymentInfo(
		...
		return tourismBonaGroundPaymentInfoPersistence.update(
	...
	public TourismBonaGroundPaymentInfo createTourismBonaGroundPaymentInfo(
		...
		return tourismBonaGroundPaymentInfoPersistence.create(
	...
	public TourismBonaGroundPaymentInfo deleteTourismBonaGroundPaymentInfo(
		...
		return tourismBonaGroundPaymentInfoPersistence.remove(
			tourismBonaGroundPayId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaGroundPaymentInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaGroundPaymentInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaGroundPaymentInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaGroundPaymentInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TourismBonaGroundPaymentInfo fetchTourismBonaGroundPaymentInfo(
		...
		return tourismBonaGroundPaymentInfoPersistence.fetchByPrimaryKey(
			tourismBonaGroundPayId);
	}
	...
	public TourismBonaGroundPaymentInfo getTourismBonaGroundPaymentInfo(
		...
		return tourismBonaGroundPaymentInfoPersistence.findByPrimaryKey(
			tourismBonaGroundPayId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			TourismBonaGroundPaymentInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaGroundPaymentInfoLocalServiceImpl#deleteTourismBonaGroundPaymentInfo(TourismBonaGroundPaymentInfo) to avoid orphaned data");
		}

		return tourismBonaGroundPaymentInfoLocalService.
			deleteTourismBonaGroundPaymentInfo(
				(TourismBonaGroundPaymentInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaGroundPaymentInfo> getBasePersistence() {
		return tourismBonaGroundPaymentInfoPersistence;
	}
	...
	public List<TourismBonaGroundPaymentInfo> getTourismBonaGroundPaymentInfos(
		...
		return tourismBonaGroundPaymentInfoPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaGroundPaymentInfosCount() {
		return tourismBonaGroundPaymentInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundPaymentInfoLocalService =
			(TourismBonaGroundPaymentInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundPaymentInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaGroundPaymentInfoPersistence.getDataSource();
	...
	protected TourismBonaGroundPaymentInfoLocalService
		tourismBonaGroundPaymentInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundPaymentInfoLocalServiceBaseImpl.class);
