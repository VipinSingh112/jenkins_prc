...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionEmployeeInfoLocalService;
...
/**
 * Provides the base implementation for the tourism new attraction employee info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionEmployeeInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionEmployeeInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionEmployeeInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismNewAttractionEmployeeInfo addTourismNewAttractionEmployeeInfo(
		TourismNewAttractionEmployeeInfo tourismNewAttractionEmployeeInfo) {

		tourismNewAttractionEmployeeInfo.setNew(true);

		return tourismNewAttractionEmployeeInfoPersistence.update(
	...
	public TourismNewAttractionEmployeeInfo
		createTourismNewAttractionEmployeeInfo(
			long tourismNewAttractionEmploId) {

		return tourismNewAttractionEmployeeInfoPersistence.create(
	...
	public TourismNewAttractionEmployeeInfo
		...
		return tourismNewAttractionEmployeeInfoPersistence.remove(
			tourismNewAttractionEmploId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewAttractionEmployeeInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewAttractionEmployeeInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewAttractionEmployeeInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewAttractionEmployeeInfoPersistence.
	...
	@Override
	public TourismNewAttractionEmployeeInfo
		fetchTourismNewAttractionEmployeeInfo(
			long tourismNewAttractionEmploId) {

		return tourismNewAttractionEmployeeInfoPersistence.fetchByPrimaryKey(
			tourismNewAttractionEmploId);
	}
	 ...
	 */
	@Override
	public TourismNewAttractionEmployeeInfo getTourismNewAttractionEmployeeInfo(
			long tourismNewAttractionEmploId)
		throws PortalException {

		return tourismNewAttractionEmployeeInfoPersistence.findByPrimaryKey(
			tourismNewAttractionEmploId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewAttractionEmployeeInfoLocalServiceImpl#deleteTourismNewAttractionEmployeeInfo(TourismNewAttractionEmployeeInfo) to avoid orphaned data");
		}

		return tourismNewAttractionEmployeeInfoLocalService.
			deleteTourismNewAttractionEmployeeInfo(
				(TourismNewAttractionEmployeeInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewAttractionEmployeeInfo>
		getBasePersistence() {
	 ...
	 */
	@Override
	public List<TourismNewAttractionEmployeeInfo>
		getTourismNewAttractionEmployeeInfos(int start, int end) {

		return tourismNewAttractionEmployeeInfoPersistence.findAll(start, end);
	}
	...
	public int getTourismNewAttractionEmployeeInfosCount() {
		return tourismNewAttractionEmployeeInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAttractionEmployeeInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionEmployeeInfoLocalService =
			(TourismNewAttractionEmployeeInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionEmployeeInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAttractionEmployeeInfoPersistence.getDataSource();
	...
	protected TourismNewAttractionEmployeeInfoLocalService
		tourismNewAttractionEmployeeInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionEmployeeInfoLocalServiceBaseImpl.class);
