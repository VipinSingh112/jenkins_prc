...
import com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormLocalService;
...
/**
 * Provides the base implementation for the tourism bona accommodation form local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaAccommodationFormLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccommodationFormLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaAccommodationForm addTourismBonaAccommodationForm(
		TourismBonaAccommodationForm tourismBonaAccommodationForm) {

		tourismBonaAccommodationForm.setNew(true);

		return tourismBonaAccommodationFormPersistence.update(
	...
	public TourismBonaAccommodationForm createTourismBonaAccommodationForm(
		long tourismBonaAFId) {

		return tourismBonaAccommodationFormPersistence.create(tourismBonaAFId);
	}
	...
	@Override
	public TourismBonaAccommodationForm deleteTourismBonaAccommodationForm(
			long tourismBonaAFId)
		throws PortalException {

		return tourismBonaAccommodationFormPersistence.remove(tourismBonaAFId);
	}
	...
	public TourismBonaAccommodationForm deleteTourismBonaAccommodationForm(
		...
		return tourismBonaAccommodationFormPersistence.remove(
			tourismBonaAccommodationForm);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaAccommodationFormPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaAccommodationForm.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaAccommodationFormPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaAccommodationFormPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismBonaAccommodationForm fetchTourismBonaAccommodationForm(
		long tourismBonaAFId) {

		return tourismBonaAccommodationFormPersistence.fetchByPrimaryKey(
			tourismBonaAFId);
	}
	 ...
	 */
	@Override
	public TourismBonaAccommodationForm getTourismBonaAccommodationForm(
			long tourismBonaAFId)
		throws PortalException {

		return tourismBonaAccommodationFormPersistence.findByPrimaryKey(
			tourismBonaAFId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			TourismBonaAccommodationForm.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("tourismBonaAFId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tourismBonaAccommodationFormPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaAccommodationFormLocalServiceImpl#deleteTourismBonaAccommodationForm(TourismBonaAccommodationForm) to avoid orphaned data");
		}

		return tourismBonaAccommodationFormLocalService.
			deleteTourismBonaAccommodationForm(
				(TourismBonaAccommodationForm)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaAccommodationForm> getBasePersistence() {
		return tourismBonaAccommodationFormPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismBonaAccommodationForm> getTourismBonaAccommodationForms(
		int start, int end) {

		return tourismBonaAccommodationFormPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaAccommodationFormsCount() {
		return tourismBonaAccommodationFormPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismBonaAccommodationForm updateTourismBonaAccommodationForm(
		TourismBonaAccommodationForm tourismBonaAccommodationForm) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccommodationFormLocalService =
			(TourismBonaAccommodationFormLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccommodationFormLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaAccommodationFormPersistence.getDataSource();
	...
	protected TourismBonaAccommodationFormLocalService
		tourismBonaAccommodationFormLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccommodationFormLocalServiceBaseImpl.class);
