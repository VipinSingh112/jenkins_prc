...
import com.nbp.tourism.application.form.services.service.TourismNewAccoGeneralFormService;
...
/**
 * Provides the base implementation for the tourism new acco general form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccoGeneralFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccoGeneralFormServiceImpl
 * @generated
 */
public abstract class TourismNewAccoGeneralFormServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccoGeneralFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccoGeneralFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccoGeneralFormService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccoGeneralFormService =
			(TourismNewAccoGeneralFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccoGeneralFormService.class.getName();
	}
	...
	protected TourismNewAccoGeneralFormService tourismNewAccoGeneralFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccoGeneralFormServiceBaseImpl.class);
