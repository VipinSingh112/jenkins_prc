...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundTransBoxService;
...
/**
 * Provides the base implementation for the tourism bona ground trans box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransBoxServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundTransBoxServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundTransBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundTransBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaGroundTransBoxService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundTransBoxService =
			(TourismBonaGroundTransBoxService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundTransBoxService.class.getName();
	}
	...
	protected TourismBonaGroundTransBoxService tourismBonaGroundTransBoxService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundTransBoxServiceBaseImpl.class);
