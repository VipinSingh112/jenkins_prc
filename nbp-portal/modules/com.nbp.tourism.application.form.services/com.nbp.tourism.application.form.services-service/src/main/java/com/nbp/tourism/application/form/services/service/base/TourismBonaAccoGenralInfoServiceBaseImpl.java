...
import com.nbp.tourism.application.form.services.service.TourismBonaAccoGenralInfoService;
...
/**
 * Provides the base implementation for the tourism bona acco genral info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoGenralInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoGenralInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaAccoGenralInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccoGenralInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccoGenralInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAccoGenralInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccoGenralInfoService =
			(TourismBonaAccoGenralInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccoGenralInfoService.class.getName();
	}
	...
	protected TourismBonaAccoGenralInfoService tourismBonaAccoGenralInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccoGenralInfoServiceBaseImpl.class);
