...
import com.nbp.tourism.application.form.services.service.TourismBonaWaterSportSignInfoLocalService;
...
/**
 * Provides the base implementation for the tourism bona water sport sign info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportSignInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportSignInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaWaterSportSignInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaWaterSportSignInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaWaterSportSignInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaWaterSportSignInfo addTourismBonaWaterSportSignInfo(
		TourismBonaWaterSportSignInfo tourismBonaWaterSportSignInfo) {

		tourismBonaWaterSportSignInfo.setNew(true);

		return tourismBonaWaterSportSignInfoPersistence.update(
	...
	public TourismBonaWaterSportSignInfo createTourismBonaWaterSportSignInfo(
		long tourismBonaWSSignId) {

		return tourismBonaWaterSportSignInfoPersistence.create(
			tourismBonaWSSignId);
	}
	...
	@Override
	public TourismBonaWaterSportSignInfo deleteTourismBonaWaterSportSignInfo(
			long tourismBonaWSSignId)
		throws PortalException {

		return tourismBonaWaterSportSignInfoPersistence.remove(
			tourismBonaWSSignId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaWaterSportSignInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaWaterSportSignInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaWaterSportSignInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaWaterSportSignInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismBonaWaterSportSignInfo fetchTourismBonaWaterSportSignInfo(
		long tourismBonaWSSignId) {

		return tourismBonaWaterSportSignInfoPersistence.fetchByPrimaryKey(
			tourismBonaWSSignId);
	}
	 ...
	 */
	@Override
	public TourismBonaWaterSportSignInfo getTourismBonaWaterSportSignInfo(
			long tourismBonaWSSignId)
		throws PortalException {

		return tourismBonaWaterSportSignInfoPersistence.findByPrimaryKey(
			tourismBonaWSSignId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("tourismBonaWSSignId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaWaterSportSignInfoLocalServiceImpl#deleteTourismBonaWaterSportSignInfo(TourismBonaWaterSportSignInfo) to avoid orphaned data");
		}

		return tourismBonaWaterSportSignInfoLocalService.
			deleteTourismBonaWaterSportSignInfo(
				(TourismBonaWaterSportSignInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaWaterSportSignInfo> getBasePersistence() {
		return tourismBonaWaterSportSignInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismBonaWaterSportSignInfo>
		getTourismBonaWaterSportSignInfos(int start, int end) {

		return tourismBonaWaterSportSignInfoPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaWaterSportSignInfosCount() {
		return tourismBonaWaterSportSignInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismBonaWaterSportSignInfo updateTourismBonaWaterSportSignInfo(
		TourismBonaWaterSportSignInfo tourismBonaWaterSportSignInfo) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaWaterSportSignInfoLocalService =
			(TourismBonaWaterSportSignInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaWaterSportSignInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaWaterSportSignInfoPersistence.getDataSource();
	...
	protected TourismBonaWaterSportSignInfoLocalService
		tourismBonaWaterSportSignInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaWaterSportSignInfoLocalServiceBaseImpl.class);
