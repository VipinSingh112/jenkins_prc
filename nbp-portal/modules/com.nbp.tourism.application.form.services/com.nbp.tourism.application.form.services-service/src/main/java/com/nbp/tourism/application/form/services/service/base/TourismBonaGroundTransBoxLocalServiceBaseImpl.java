...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundTransBoxLocalService;
...
/**
 * Provides the base implementation for the tourism bona ground trans box local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransBoxLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransBoxLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundTransBoxLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundTransBoxLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundTransBoxLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaGroundTransBox addTourismBonaGroundTransBox(
		TourismBonaGroundTransBox tourismBonaGroundTransBox) {

		tourismBonaGroundTransBox.setNew(true);

		return tourismBonaGroundTransBoxPersistence.update(
	...
	public TourismBonaGroundTransBox createTourismBonaGroundTransBox(
		long tourismVehicleBoxBonaId) {

		return tourismBonaGroundTransBoxPersistence.create(
	...
	@Override
	public TourismBonaGroundTransBox deleteTourismBonaGroundTransBox(
			long tourismVehicleBoxBonaId)
		throws PortalException {

		return tourismBonaGroundTransBoxPersistence.remove(
			tourismVehicleBoxBonaId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaGroundTransBoxPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaGroundTransBox.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaGroundTransBoxPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaGroundTransBoxPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismBonaGroundTransBox fetchTourismBonaGroundTransBox(
		long tourismVehicleBoxBonaId) {

		return tourismBonaGroundTransBoxPersistence.fetchByPrimaryKey(
			tourismVehicleBoxBonaId);
	}
	 ...
	 */
	@Override
	public TourismBonaGroundTransBox getTourismBonaGroundTransBox(
			long tourismVehicleBoxBonaId)
		throws PortalException {

		return tourismBonaGroundTransBoxPersistence.findByPrimaryKey(
			tourismVehicleBoxBonaId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismBonaGroundTransBox.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TourismBonaGroundTransBox.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaGroundTransBoxLocalServiceImpl#deleteTourismBonaGroundTransBox(TourismBonaGroundTransBox) to avoid orphaned data");
		}

		return tourismBonaGroundTransBoxLocalService.
			deleteTourismBonaGroundTransBox(
				(TourismBonaGroundTransBox)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaGroundTransBox> getBasePersistence() {
		return tourismBonaGroundTransBoxPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismBonaGroundTransBox> getTourismBonaGroundTransBoxes(
		int start, int end) {

		return tourismBonaGroundTransBoxPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaGroundTransBoxesCount() {
		return tourismBonaGroundTransBoxPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismBonaGroundTransBox updateTourismBonaGroundTransBox(
		TourismBonaGroundTransBox tourismBonaGroundTransBox) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundTransBoxLocalService =
			(TourismBonaGroundTransBoxLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundTransBoxLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaGroundTransBoxPersistence.getDataSource();
	...
	protected TourismBonaGroundTransBoxLocalService
		tourismBonaGroundTransBoxLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundTransBoxLocalServiceBaseImpl.class);
