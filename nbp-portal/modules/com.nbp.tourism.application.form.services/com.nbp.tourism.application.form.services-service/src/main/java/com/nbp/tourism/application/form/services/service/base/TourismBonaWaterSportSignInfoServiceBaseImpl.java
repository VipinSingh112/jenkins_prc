...
import com.nbp.tourism.application.form.services.service.TourismBonaWaterSportSignInfoService;
...
/**
 * Provides the base implementation for the tourism bona water sport sign info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportSignInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportSignInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaWaterSportSignInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaWaterSportSignInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaWaterSportSignInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaWaterSportSignInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaWaterSportSignInfoService =
			(TourismBonaWaterSportSignInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaWaterSportSignInfoService.class.getName();
	}
	...
	protected TourismBonaWaterSportSignInfoService
		tourismBonaWaterSportSignInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaWaterSportSignInfoServiceBaseImpl.class);
