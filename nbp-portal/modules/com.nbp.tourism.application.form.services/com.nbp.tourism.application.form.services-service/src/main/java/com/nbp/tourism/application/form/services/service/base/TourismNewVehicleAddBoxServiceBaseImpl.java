...
import com.nbp.tourism.application.form.services.service.TourismNewVehicleAddBoxService;
import com.nbp.tourism.application.form.services.service.TourismNewVehicleAddBoxServiceUtil;
...
/**
 * Provides the base implementation for the tourism new vehicle add box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewVehicleAddBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewVehicleAddBoxServiceImpl
 * @generated
 */
public abstract class TourismNewVehicleAddBoxServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewVehicleAddBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TourismNewVehicleAddBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewVehicleAddBoxService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewVehicleAddBoxService =
			(TourismNewVehicleAddBoxService)aopProxy;

		_setServiceUtilService(tourismNewVehicleAddBoxService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewVehicleAddBoxService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TourismNewVehicleAddBoxServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, tourismNewVehicleAddBoxService);
		}
	...
	protected com.nbp.tourism.application.form.services.service.
		TourismNewVehicleAddBoxLocalService tourismNewVehicleAddBoxLocalService;

	protected TourismNewVehicleAddBoxService tourismNewVehicleAddBoxService;
