...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormSecondLocalService;
...
/**
 * Provides the base implementation for the tourism bona attraction form second local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormSecondLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormSecondLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionFormSecondLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionFormSecondLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormSecondLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaAttractionFormSecond addTourismBonaAttractionFormSecond(
		TourismBonaAttractionFormSecond tourismBonaAttractionFormSecond) {

		tourismBonaAttractionFormSecond.setNew(true);

		return tourismBonaAttractionFormSecondPersistence.update(
	...
	public TourismBonaAttractionFormSecond
		createTourismBonaAttractionFormSecond(
			long tourismBonaAttractFormSecId) {

		return tourismBonaAttractionFormSecondPersistence.create(
	...
	public TourismBonaAttractionFormSecond
		...
		return tourismBonaAttractionFormSecondPersistence.remove(
			tourismBonaAttractFormSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaAttractionFormSecondPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaAttractionFormSecond.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaAttractionFormSecondPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaAttractionFormSecondPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismBonaAttractionFormSecond fetchTourismBonaAttractionFormSecond(
		long tourismBonaAttractFormSecId) {

		return tourismBonaAttractionFormSecondPersistence.fetchByPrimaryKey(
			tourismBonaAttractFormSecId);
	}
	 ...
	 */
	@Override
	public TourismBonaAttractionFormSecond getTourismBonaAttractionFormSecond(
			long tourismBonaAttractFormSecId)
		throws PortalException {

		return tourismBonaAttractionFormSecondPersistence.findByPrimaryKey(
			tourismBonaAttractFormSecId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaAttractionFormSecondLocalServiceImpl#deleteTourismBonaAttractionFormSecond(TourismBonaAttractionFormSecond) to avoid orphaned data");
		}

		return tourismBonaAttractionFormSecondLocalService.
			deleteTourismBonaAttractionFormSecond(
				(TourismBonaAttractionFormSecond)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaAttractionFormSecond>
		getBasePersistence() {

		return tourismBonaAttractionFormSecondPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismBonaAttractionFormSecond>
		getTourismBonaAttractionFormSeconds(int start, int end) {

		return tourismBonaAttractionFormSecondPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaAttractionFormSecondsCount() {
		return tourismBonaAttractionFormSecondPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionFormSecondLocalService =
			(TourismBonaAttractionFormSecondLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionFormSecondLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaAttractionFormSecondPersistence.getDataSource();
	...
	protected TourismBonaAttractionFormSecondLocalService
		tourismBonaAttractionFormSecondLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionFormSecondLocalServiceBaseImpl.class);
