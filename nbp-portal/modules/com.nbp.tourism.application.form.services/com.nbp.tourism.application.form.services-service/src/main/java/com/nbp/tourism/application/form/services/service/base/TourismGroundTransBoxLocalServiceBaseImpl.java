...
import com.nbp.tourism.application.form.services.service.TourismGroundTransBoxLocalService;
...
/**
 * Provides the base implementation for the tourism ground trans box local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismGroundTransBoxLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismGroundTransBoxLocalServiceImpl
 * @generated
 */
public abstract class TourismGroundTransBoxLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismGroundTransBoxLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismGroundTransBoxLocalServiceUtil</code>.
	 */
	...
	public TourismGroundTransBox addTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.update(tourismGroundTransBox);
	}
	...
	public TourismGroundTransBox createTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.create(tourismVehicleBoxId);
	}
	...
	public TourismGroundTransBox deleteTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.remove(tourismVehicleBoxId);
	}
	...
	public TourismGroundTransBox deleteTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.remove(tourismGroundTransBox);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismGroundTransBoxPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismGroundTransBox.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismGroundTransBoxPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismGroundTransBoxPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TourismGroundTransBox fetchTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.fetchByPrimaryKey(
			tourismVehicleBoxId);
	}
	...
	public TourismGroundTransBox getTourismGroundTransBox(
		...
		return tourismGroundTransBoxPersistence.findByPrimaryKey(
			tourismVehicleBoxId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismGroundTransBox.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("tourismVehicleBoxId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tourismGroundTransBoxPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismGroundTransBoxLocalServiceImpl#deleteTourismGroundTransBox(TourismGroundTransBox) to avoid orphaned data");
		}

		return tourismGroundTransBoxLocalService.deleteTourismGroundTransBox(
			(TourismGroundTransBox)persistedModel);
	}

	@Override
	public BasePersistence<TourismGroundTransBox> getBasePersistence() {
		return tourismGroundTransBoxPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return tourismGroundTransBoxPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TourismGroundTransBox> getTourismGroundTransBoxes(
		...
		return tourismGroundTransBoxPersistence.findAll(start, end);
	}
	...
	public int getTourismGroundTransBoxesCount() {
		return tourismGroundTransBoxPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismGroundTransBoxLocalService =
			(TourismGroundTransBoxLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismGroundTransBoxLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TourismGroundTransBox.class;
	}

	protected String getModelClassName() {
		return TourismGroundTransBox.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismGroundTransBoxPersistence.getDataSource();
	...
	protected TourismGroundTransBoxLocalService
		tourismGroundTransBoxLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismGroundTransBoxLocalServiceBaseImpl.class);
