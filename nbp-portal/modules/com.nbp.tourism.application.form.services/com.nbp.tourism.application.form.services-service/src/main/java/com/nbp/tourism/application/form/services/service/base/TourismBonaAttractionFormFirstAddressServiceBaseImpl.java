...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormFirstAddressService;
...
/**
 * Provides the base implementation for the tourism bona attraction form first address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstAddressServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionFormFirstAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionFormFirstAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormFirstAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionFormFirstAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionFormFirstAddressService =
			(TourismBonaAttractionFormFirstAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionFormFirstAddressService.class.getName();
	}
	...
	protected TourismBonaAttractionFormFirstAddressService
		tourismBonaAttractionFormFirstAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionFormFirstAddressServiceBaseImpl.class);
