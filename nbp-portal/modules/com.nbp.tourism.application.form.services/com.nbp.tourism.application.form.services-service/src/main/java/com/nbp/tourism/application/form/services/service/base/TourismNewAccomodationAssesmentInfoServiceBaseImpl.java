...
import com.nbp.tourism.application.form.services.service.TourismNewAccomodationAssesmentInfoService;
import com.nbp.tourism.application.form.services.service.TourismNewAccomodationAssesmentInfoServiceUtil;
...
/**
 * Provides the base implementation for the tourism new accomodation assesment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccomodationAssesmentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccomodationAssesmentInfoServiceImpl
 * @generated
 */
public abstract class TourismNewAccomodationAssesmentInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccomodationAssesmentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TourismNewAccomodationAssesmentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccomodationAssesmentInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccomodationAssesmentInfoService =
			(TourismNewAccomodationAssesmentInfoService)aopProxy;

		_setServiceUtilService(tourismNewAccomodationAssesmentInfoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccomodationAssesmentInfoService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TourismNewAccomodationAssesmentInfoServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, tourismNewAccomodationAssesmentInfoService);
		}
	...
	protected TourismNewAccomodationAssesmentInfoService
		tourismNewAccomodationAssesmentInfoService;
