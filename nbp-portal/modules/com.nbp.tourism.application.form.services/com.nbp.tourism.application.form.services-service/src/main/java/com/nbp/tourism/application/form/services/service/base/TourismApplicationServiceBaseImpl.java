...
import com.nbp.tourism.application.form.services.service.TourismApplicationService;
...
/**
 * Provides the base implementation for the tourism application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismApplicationServiceImpl
 * @generated
 */
public abstract class TourismApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TourismApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tourismApplicationService = (TourismApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismApplicationService.class.getName();
	}
	...
	protected TourismApplicationService tourismApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismApplicationServiceBaseImpl.class);
