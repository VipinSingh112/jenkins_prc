...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstAddressService;
...
/**
 * Provides the base implementation for the tourism new attraction form first address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstAddressServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionFormFirstAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionFormFirstAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAttractionFormFirstAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionFormFirstAddressService =
			(TourismNewAttractionFormFirstAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionFormFirstAddressService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAttractionFormFirstAddressPersistence.getDataSource();
	...
	protected TourismNewAttractionFormFirstAddressService
		tourismNewAttractionFormFirstAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionFormFirstAddressServiceBaseImpl.class);
