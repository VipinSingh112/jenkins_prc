...
import com.nbp.tourism.application.form.services.service.TourismAnnualEntertainBoxService;
...
/**
 * Provides the base implementation for the tourism annual entertain box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismAnnualEntertainBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismAnnualEntertainBoxServiceImpl
 * @generated
 */
public abstract class TourismAnnualEntertainBoxServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismAnnualEntertainBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismAnnualEntertainBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismAnnualEntertainBoxService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismAnnualEntertainBoxService =
			(TourismAnnualEntertainBoxService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismAnnualEntertainBoxService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismAnnualEntertainBoxPersistence.getDataSource();
	...
	protected TourismAnnualEntertainBoxService tourismAnnualEntertainBoxService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismAnnualEntertainBoxServiceBaseImpl.class);
