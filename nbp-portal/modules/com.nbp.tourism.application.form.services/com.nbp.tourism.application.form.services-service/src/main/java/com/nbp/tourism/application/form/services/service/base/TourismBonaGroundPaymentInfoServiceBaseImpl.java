...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundPaymentInfoService;
...
/**
 * Provides the base implementation for the tourism bona ground payment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundPaymentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundPaymentInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundPaymentInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundPaymentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundPaymentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaGroundPaymentInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundPaymentInfoService =
			(TourismBonaGroundPaymentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundPaymentInfoService.class.getName();
	}
	...
	protected TourismBonaGroundPaymentInfoService
		tourismBonaGroundPaymentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundPaymentInfoServiceBaseImpl.class);
