...
import com.nbp.tourism.application.form.services.model.TourismBonaVehicleAddBoxTable;
import com.nbp.tourism.application.form.services.model.impl.TourismBonaVehicleAddBoxImpl;
import com.nbp.tourism.application.form.services.model.impl.TourismBonaVehicleAddBoxModelImpl;
import com.nbp.tourism.application.form.services.service.persistence.TourismBonaVehicleAddBoxPersistence;
import com.nbp.tourism.application.form.services.service.persistence.TourismBonaVehicleAddBoxUtil;
...
/**
 * The persistence implementation for the tourism bona vehicle add box service.
 *
 * <p>
 ...
 */
@Component(
	service = {TourismBonaVehicleAddBoxPersistence.class, BasePersistence.class}
)
public class TourismBonaVehicleAddBoxPersistenceImpl
	extends BasePersistenceImpl<TourismBonaVehicleAddBox>
	implements TourismBonaVehicleAddBoxPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>TourismBonaVehicleAddBoxUtil</code> to access the tourism bona vehicle add box persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		TourismBonaVehicleAddBoxImpl.class.getName();
	 ...
	 */
	@Override
	public List<TourismBonaVehicleAddBox> findBygetTAP_TAI(
	...
	public List<TourismBonaVehicleAddBox> findBygetTAP_TAI(
		...
		List<TourismBonaVehicleAddBox> list = null;

		if (useFinderCache) {
			list = (List<TourismBonaVehicleAddBox>)finderCache.getResult(
				finderPath, finderArgs,this);

			if ((list != null) && !list.isEmpty()) {
				for (TourismBonaVehicleAddBox tourismBonaVehicleAddBox : list) {
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_TOURISMBONAVEHICLEADDBOX_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(TourismBonaVehicleAddBoxModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<TourismBonaVehicleAddBox>)QueryUtil.list(
	...
	public TourismBonaVehicleAddBox findBygetTAP_TAI_First(
		...
		if (tourismBonaVehicleAddBox != null) {
			return tourismBonaVehicleAddBox;
		}
		...
		throw new NoSuchTourismBonaVehicleAddBoxException(sb.toString());
	}
	...
	public TourismBonaVehicleAddBox fetchBygetTAP_TAI_First(
		...
		List<TourismBonaVehicleAddBox> list = findBygetTAP_TAI(
	...
	public TourismBonaVehicleAddBox[] findBygetTAP_TAI_PrevAndNext(
		...
		TourismBonaVehicleAddBox tourismBonaVehicleAddBox = findByPrimaryKey(
			tourismBonaVehBoxId);
		...
		try {
			...
			TourismBonaVehicleAddBox[] array =
				new TourismBonaVehicleAddBoxImpl[3];

			array[0] = getBygetTAP_TAI_PrevAndNext(
				session, tourismBonaVehicleAddBox, tourismApplicationId,
				orderByComparator, true);

			array[1] = tourismBonaVehicleAddBox;
	...
	protected TourismBonaVehicleAddBox getBygetTAP_TAI_PrevAndNext(
		Session session, TourismBonaVehicleAddBox tourismBonaVehicleAddBox,
		long tourismApplicationId,
		OrderByComparator<TourismBonaVehicleAddBox> orderByComparator,
		boolean previous) {
		...
		List<TourismBonaVehicleAddBox> list = query.list();
	...
	public void removeBygetTAP_TAI(long tourismApplicationId) {
		for (TourismBonaVehicleAddBox tourismBonaVehicleAddBox :
				findBygetTAP_TAI(
					tourismApplicationId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {

			remove(tourismBonaVehicleAddBox);
		}
	}
	...
	public int countBygetTAP_TAI(long tourismApplicationId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_TOURISMBONAVEHICLEADDBOX_WHERE);
	...
	private static final String
		_FINDER_COLUMN_GETTAP_TAI_TOURISMAPPLICATIONID_2 =
			"tourismBonaVehicleAddBox.tourismApplicationId = ?";

	public TourismBonaVehicleAddBoxPersistenceImpl() {
		setModelClass(TourismBonaVehicleAddBox.class);

		setModelImplClass(TourismBonaVehicleAddBoxImpl.class);
		setModelPKClass(long.class);

		setTable(TourismBonaVehicleAddBoxTable.INSTANCE);
	}
	...
	public void cacheResult(TourismBonaVehicleAddBox tourismBonaVehicleAddBox) {
		entityCache.putResult(
			TourismBonaVehicleAddBoxImpl.class,
			tourismBonaVehicleAddBox.getPrimaryKey(), tourismBonaVehicleAddBox);
	}
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (tourismBonaVehicleAddBoxes.size() >
		...
		for (TourismBonaVehicleAddBox tourismBonaVehicleAddBox :
				tourismBonaVehicleAddBoxes) {

			if (entityCache.getResult(
					TourismBonaVehicleAddBoxImpl.class,
					tourismBonaVehicleAddBox.getPrimaryKey()) == null) {

				cacheResult(tourismBonaVehicleAddBox);
			}
		}
	}

	/**
	 * Clears the cache for all tourism bona vehicle add boxes.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(TourismBonaVehicleAddBoxImpl.class);

		finderCache.clearCache(TourismBonaVehicleAddBoxImpl.class);
	}

	/**
	 * Clears the cache for the tourism bona vehicle add box.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(TourismBonaVehicleAddBox tourismBonaVehicleAddBox) {
		entityCache.removeResult(
			TourismBonaVehicleAddBoxImpl.class, tourismBonaVehicleAddBox);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				TourismBonaVehicleAddBoxImpl.class, primaryKey);
		}
	}
	...
	public TourismBonaVehicleAddBox create(long tourismBonaVehBoxId) {
		...
		tourismBonaVehicleAddBox.setPrimaryKey(tourismBonaVehBoxId);
	...
	public TourismBonaVehicleAddBox remove(long tourismBonaVehBoxId)
		...
		return remove((Serializable)tourismBonaVehBoxId);
	}

	/**
	 * Removes the tourism bona vehicle add box with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the tourism bona vehicle add box
	 * @return the tourism bona vehicle add box that was removed
	 * @throws NoSuchTourismBonaVehicleAddBoxException if a tourism bona vehicle add box with the primary key could not be found
	 */
	@Override
	public TourismBonaVehicleAddBox remove(Serializable primaryKey)
		throws NoSuchTourismBonaVehicleAddBoxException {
		...
		try {
			...
			TourismBonaVehicleAddBox tourismBonaVehicleAddBox =
				(TourismBonaVehicleAddBox)session.get(
					TourismBonaVehicleAddBoxImpl.class, primaryKey);
			...
			if (tourismBonaVehicleAddBox == null) {
				...
				throw new NoSuchTourismBonaVehicleAddBoxException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(tourismBonaVehicleAddBox);
		}
		catch (NoSuchTourismBonaVehicleAddBoxException noSuchEntityException) {
	...
	@Override
	protected TourismBonaVehicleAddBox removeImpl(
		TourismBonaVehicleAddBox tourismBonaVehicleAddBox) {
		...
		try {
			...
			if (!session.contains(tourismBonaVehicleAddBox)) {
				tourismBonaVehicleAddBox =
					(TourismBonaVehicleAddBox)session.get(
						TourismBonaVehicleAddBoxImpl.class,
						tourismBonaVehicleAddBox.getPrimaryKeyObj());
			}

			if (tourismBonaVehicleAddBox != null) {
				session.delete(tourismBonaVehicleAddBox);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (tourismBonaVehicleAddBox != null) {
			clearCache(tourismBonaVehicleAddBox);
		}
	...
	public TourismBonaVehicleAddBox updateImpl(
		...
		boolean isNew = tourismBonaVehicleAddBox.isNew();

		if (!(tourismBonaVehicleAddBox instanceof
				TourismBonaVehicleAddBoxModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(tourismBonaVehicleAddBox.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					tourismBonaVehicleAddBox);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in tourismBonaVehicleAddBox proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom TourismBonaVehicleAddBox implementation " +
					tourismBonaVehicleAddBox.getClass());
		}

		TourismBonaVehicleAddBoxModelImpl tourismBonaVehicleAddBoxModelImpl =
			(TourismBonaVehicleAddBoxModelImpl)tourismBonaVehicleAddBox;
		...
		if (isNew && (tourismBonaVehicleAddBox.getCreateDate() == null)) {
			if (serviceContext == null) {
				tourismBonaVehicleAddBox.setCreateDate(date);
			}
			else {
		...
		if (!tourismBonaVehicleAddBoxModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				tourismBonaVehicleAddBox.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(tourismBonaVehicleAddBox);
			}
			else {
				tourismBonaVehicleAddBox =
					(TourismBonaVehicleAddBox)session.merge(
						tourismBonaVehicleAddBox);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			TourismBonaVehicleAddBoxImpl.class,
			tourismBonaVehicleAddBoxModelImpl, false, true);

		if (isNew) {
			tourismBonaVehicleAddBox.setNew(false);
		}

		tourismBonaVehicleAddBox.resetOriginalValues();

		return tourismBonaVehicleAddBox;
	}

	/**
	 * Returns the tourism bona vehicle add box with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the tourism bona vehicle add box
	 ...
	 */
	@Override
	public TourismBonaVehicleAddBox findByPrimaryKey(Serializable primaryKey)
		throws NoSuchTourismBonaVehicleAddBoxException {

		TourismBonaVehicleAddBox tourismBonaVehicleAddBox = fetchByPrimaryKey(
			primaryKey);
	...
	public TourismBonaVehicleAddBox findByPrimaryKey(long tourismBonaVehBoxId)
		...
		return findByPrimaryKey((Serializable)tourismBonaVehBoxId);
	}
	 ...
	 */
	@Override
	public TourismBonaVehicleAddBox fetchByPrimaryKey(
		long tourismBonaVehBoxId) {

		return fetchByPrimaryKey((Serializable)tourismBonaVehBoxId);
	}
	 ...
	 */
	@Override
	public List<TourismBonaVehicleAddBox> findAll() {
	 ...
	 */
	@Override
	public List<TourismBonaVehicleAddBox> findAll(int start, int end) {
	...
	public List<TourismBonaVehicleAddBox> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_TOURISMBONAVEHICLEADDBOX);
				...
				sql = _SQL_SELECT_TOURISMBONAVEHICLEADDBOX;

				sql = sql.concat(
					TourismBonaVehicleAddBoxModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (TourismBonaVehicleAddBox tourismBonaVehicleAddBox : findAll()) {
			remove(tourismBonaVehicleAddBox);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_TOURISMBONAVEHICLEADDBOX);
	...
	protected String getPKDBName() {
		return "tourismBonaVehBoxId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_TOURISMBONAVEHICLEADDBOX;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return TourismBonaVehicleAddBoxModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the tourism bona vehicle add box persistence.
	 */
	@Activate
	public void activate() {
		...
		_setTourismBonaVehicleAddBoxUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setTourismBonaVehicleAddBoxUtilPersistence(null);

		entityCache.removeCache(TourismBonaVehicleAddBoxImpl.class.getName());
	}

	private void _setTourismBonaVehicleAddBoxUtilPersistence(
		TourismBonaVehicleAddBoxPersistence
			tourismBonaVehicleAddBoxPersistence) {

		try {
			Field field = TourismBonaVehicleAddBoxUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, tourismBonaVehicleAddBoxPersistence);
		}
	...
	private static final String _SQL_SELECT_TOURISMBONAVEHICLEADDBOX =
		"SELECT tourismBonaVehicleAddBox FROM TourismBonaVehicleAddBox tourismBonaVehicleAddBox";

	private static final String _SQL_SELECT_TOURISMBONAVEHICLEADDBOX_WHERE =
		"SELECT tourismBonaVehicleAddBox FROM TourismBonaVehicleAddBox tourismBonaVehicleAddBox WHERE ";

	private static final String _SQL_COUNT_TOURISMBONAVEHICLEADDBOX =
		"SELECT COUNT(tourismBonaVehicleAddBox) FROM TourismBonaVehicleAddBox tourismBonaVehicleAddBox";

	private static final String _SQL_COUNT_TOURISMBONAVEHICLEADDBOX_WHERE =
		"SELECT COUNT(tourismBonaVehicleAddBox) FROM TourismBonaVehicleAddBox tourismBonaVehicleAddBox WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"tourismBonaVehicleAddBox.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No TourismBonaVehicleAddBox exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No TourismBonaVehicleAddBox exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaVehicleAddBoxPersistenceImpl.class);
	...
	@Reference
	private TourismBonaVehicleAddBoxModelArgumentsResolver
		_tourismBonaVehicleAddBoxModelArgumentsResolver;
