...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormFirstService;
...
/**
 * Provides the base implementation for the tourism bona attraction form first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionFormFirstServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionFormFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionFormFirstService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionFormFirstService =
			(TourismBonaAttractionFormFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionFormFirstService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaAttractionFormFirstPersistence.getDataSource();
	...
	protected TourismBonaAttractionFormFirstService
		tourismBonaAttractionFormFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionFormFirstServiceBaseImpl.class);
