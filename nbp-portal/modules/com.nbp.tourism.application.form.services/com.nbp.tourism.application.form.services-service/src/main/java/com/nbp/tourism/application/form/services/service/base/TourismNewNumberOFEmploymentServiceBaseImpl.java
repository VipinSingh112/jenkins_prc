...
import com.nbp.tourism.application.form.services.service.TourismNewNumberOFEmploymentService;
...
/**
 * Provides the base implementation for the tourism new number of employment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewNumberOFEmploymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewNumberOFEmploymentServiceImpl
 * @generated
 */
public abstract class TourismNewNumberOFEmploymentServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewNumberOFEmploymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewNumberOFEmploymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewNumberOFEmploymentService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewNumberOFEmploymentService =
			(TourismNewNumberOFEmploymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewNumberOFEmploymentService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewNumberOFEmploymentPersistence.getDataSource();
	...
	protected TourismNewNumberOFEmploymentService
		tourismNewNumberOFEmploymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewNumberOFEmploymentServiceBaseImpl.class);
