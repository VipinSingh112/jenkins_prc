...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstService;
...
/**
 * Provides the base implementation for the tourism new attraction form first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionFormFirstServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionFormFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAttractionFormFirstService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionFormFirstService =
			(TourismNewAttractionFormFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionFormFirstService.class.getName();
	}
	...
	protected TourismNewAttractionFormFirstService
		tourismNewAttractionFormFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionFormFirstServiceBaseImpl.class);
