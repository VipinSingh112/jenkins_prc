...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundTransContractSignLocalService;
...
/**
 * Provides the base implementation for the tourism bona ground trans contract sign local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransContractSignLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransContractSignLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundTransContractSignLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundTransContractSignLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundTransContractSignLocalServiceUtil</code>.
	 */
	...
	public TourismBonaGroundTransContractSign
		...
		return tourismBonaGroundTransContractSignPersistence.update(
			tourismBonaGroundTransContractSign);
	}
	...
	public TourismBonaGroundTransContractSign
		...
		return tourismBonaGroundTransContractSignPersistence.create(
	...
	public TourismBonaGroundTransContractSign
		...
		return tourismBonaGroundTransContractSignPersistence.remove(
			tourismBonaGroTraCoSignId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaGroundTransContractSignPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaGroundTransContractSign.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaGroundTransContractSignPersistence.
	...
	public TourismBonaGroundTransContractSign
		...
		return tourismBonaGroundTransContractSignPersistence.fetchByPrimaryKey(
			tourismBonaGroTraCoSignId);
	}
	...
	public TourismBonaGroundTransContractSign
		...
		return tourismBonaGroundTransContractSignPersistence.findByPrimaryKey(
			tourismBonaGroTraCoSignId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaGroundTransContractSignLocalServiceImpl#deleteTourismBonaGroundTransContractSign(TourismBonaGroundTransContractSign) to avoid orphaned data");
		}

		return tourismBonaGroundTransContractSignLocalService.
			deleteTourismBonaGroundTransContractSign(
				(TourismBonaGroundTransContractSign)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaGroundTransContractSign>
		getBasePersistence() {
	...
	public List<TourismBonaGroundTransContractSign>
		...
		return tourismBonaGroundTransContractSignPersistence.findAll(
			start, end);
	}
	...
	public int getTourismBonaGroundTransContractSignsCount() {
		return tourismBonaGroundTransContractSignPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaGroundTransContractSignLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundTransContractSignLocalService =
			(TourismBonaGroundTransContractSignLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundTransContractSignLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaGroundTransContractSignPersistence.getDataSource();
	...
	protected TourismBonaGroundTransContractSignLocalService
		tourismBonaGroundTransContractSignLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundTransContractSignLocalServiceBaseImpl.class);
