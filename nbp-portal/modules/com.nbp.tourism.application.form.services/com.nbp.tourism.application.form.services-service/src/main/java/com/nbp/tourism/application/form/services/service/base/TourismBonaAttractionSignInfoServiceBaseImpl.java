...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionSignInfoService;
...
/**
 * Provides the base implementation for the tourism bona attraction sign info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionSignInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionSignInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionSignInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionSignInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionSignInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionSignInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionSignInfoService =
			(TourismBonaAttractionSignInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionSignInfoService.class.getName();
	}
	...
	protected TourismBonaAttractionSignInfoService
		tourismBonaAttractionSignInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionSignInfoServiceBaseImpl.class);
