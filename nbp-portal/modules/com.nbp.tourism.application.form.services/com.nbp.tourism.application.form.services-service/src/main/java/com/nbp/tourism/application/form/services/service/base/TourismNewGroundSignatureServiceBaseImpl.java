...
import com.nbp.tourism.application.form.services.service.TourismNewGroundSignatureService;
...
/**
 * Provides the base implementation for the tourism new ground signature remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewGroundSignatureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewGroundSignatureServiceImpl
 * @generated
 */
public abstract class TourismNewGroundSignatureServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewGroundSignatureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewGroundSignatureServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewGroundSignatureService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewGroundSignatureService =
			(TourismNewGroundSignatureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewGroundSignatureService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewGroundSignaturePersistence.getDataSource();
	...
	protected TourismNewGroundSignatureService tourismNewGroundSignatureService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewGroundSignatureServiceBaseImpl.class);
