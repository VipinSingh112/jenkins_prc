...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionEmployeeInfoLocalService;
...
/**
 * Provides the base implementation for the tourism bona attraction employee info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionEmployeeInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionEmployeeInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionEmployeeInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaAttractionEmployeeInfo
		...
		return tourismBonaAttractionEmployeeInfoPersistence.update(
			tourismBonaAttractionEmployeeInfo);
	}
	...
	public TourismBonaAttractionEmployeeInfo
		...
		return tourismBonaAttractionEmployeeInfoPersistence.create(
	...
	@Override
	public TourismBonaAttractionEmployeeInfo
			deleteTourismBonaAttractionEmployeeInfo(long tourismBonaAttrEmpId)
		throws PortalException {

		return tourismBonaAttractionEmployeeInfoPersistence.remove(
			tourismBonaAttrEmpId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaAttractionEmployeeInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaAttractionEmployeeInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaAttractionEmployeeInfoPersistence.
	...
	public TourismBonaAttractionEmployeeInfo
		...
		return tourismBonaAttractionEmployeeInfoPersistence.fetchByPrimaryKey(
			tourismBonaAttrEmpId);
	}
	...
	@Override
	public TourismBonaAttractionEmployeeInfo
			getTourismBonaAttractionEmployeeInfo(long tourismBonaAttrEmpId)
		throws PortalException {

		return tourismBonaAttractionEmployeeInfoPersistence.findByPrimaryKey(
			tourismBonaAttrEmpId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaAttractionEmployeeInfoLocalServiceImpl#deleteTourismBonaAttractionEmployeeInfo(TourismBonaAttractionEmployeeInfo) to avoid orphaned data");
		}

		return tourismBonaAttractionEmployeeInfoLocalService.
			deleteTourismBonaAttractionEmployeeInfo(
				(TourismBonaAttractionEmployeeInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaAttractionEmployeeInfo>
		getBasePersistence() {
	 ...
	 */
	@Override
	public List<TourismBonaAttractionEmployeeInfo>
		getTourismBonaAttractionEmployeeInfos(int start, int end) {

		return tourismBonaAttractionEmployeeInfoPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaAttractionEmployeeInfosCount() {
		return tourismBonaAttractionEmployeeInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionEmployeeInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionEmployeeInfoLocalService =
			(TourismBonaAttractionEmployeeInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionEmployeeInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaAttractionEmployeeInfoPersistence.getDataSource();
	...
	protected TourismBonaAttractionEmployeeInfoLocalService
		tourismBonaAttractionEmployeeInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionEmployeeInfoLocalServiceBaseImpl.class);
