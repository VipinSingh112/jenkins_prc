...
import com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormAddressService;
...
/**
 * Provides the base implementation for the tourism bona accommodation form address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormAddressServiceImpl
 * @generated
 */
public abstract class TourismBonaAccommodationFormAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccommodationFormAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAccommodationFormAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccommodationFormAddressService =
			(TourismBonaAccommodationFormAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccommodationFormAddressService.class.getName();
	}
	...
	protected TourismBonaAccommodationFormAddressService
		tourismBonaAccommodationFormAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccommodationFormAddressServiceBaseImpl.class);
