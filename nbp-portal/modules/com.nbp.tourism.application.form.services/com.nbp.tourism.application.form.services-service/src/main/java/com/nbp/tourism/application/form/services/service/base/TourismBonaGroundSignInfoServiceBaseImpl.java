...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundSignInfoService;
...
/**
 * Provides the base implementation for the tourism bona ground sign info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundSignInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundSignInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundSignInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundSignInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundSignInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaGroundSignInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundSignInfoService =
			(TourismBonaGroundSignInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundSignInfoService.class.getName();
	}
	...
	protected TourismBonaGroundSignInfoService tourismBonaGroundSignInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundSignInfoServiceBaseImpl.class);
