...
import com.nbp.tourism.application.form.services.service.TourismNewAnnualEarningsService;
...
/**
 * Provides the base implementation for the tourism new annual earnings remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAnnualEarningsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAnnualEarningsServiceImpl
 * @generated
 */
public abstract class TourismNewAnnualEarningsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAnnualEarningsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAnnualEarningsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAnnualEarningsService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAnnualEarningsService =
			(TourismNewAnnualEarningsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAnnualEarningsService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAnnualEarningsPersistence.getDataSource();
	...
	protected TourismNewAnnualEarningsService tourismNewAnnualEarningsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAnnualEarningsServiceBaseImpl.class);
