...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundSignInfoLocalService;
...
/**
 * Provides the base implementation for the tourism bona ground sign info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundSignInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundSignInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaGroundSignInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundSignInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundSignInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaGroundSignInfo addTourismBonaGroundSignInfo(
		TourismBonaGroundSignInfo tourismBonaGroundSignInfo) {

		tourismBonaGroundSignInfo.setNew(true);

		return tourismBonaGroundSignInfoPersistence.update(
	...
	public TourismBonaGroundSignInfo createTourismBonaGroundSignInfo(
		long tourismBonaGroundSignInfoId) {

		return tourismBonaGroundSignInfoPersistence.create(
	...
	@Override
	public TourismBonaGroundSignInfo deleteTourismBonaGroundSignInfo(
			long tourismBonaGroundSignInfoId)
		throws PortalException {

		return tourismBonaGroundSignInfoPersistence.remove(
			tourismBonaGroundSignInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaGroundSignInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaGroundSignInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaGroundSignInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaGroundSignInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismBonaGroundSignInfo fetchTourismBonaGroundSignInfo(
		long tourismBonaGroundSignInfoId) {

		return tourismBonaGroundSignInfoPersistence.fetchByPrimaryKey(
			tourismBonaGroundSignInfoId);
	}
	 ...
	 */
	@Override
	public TourismBonaGroundSignInfo getTourismBonaGroundSignInfo(
			long tourismBonaGroundSignInfoId)
		throws PortalException {

		return tourismBonaGroundSignInfoPersistence.findByPrimaryKey(
			tourismBonaGroundSignInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismBonaGroundSignInfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TourismBonaGroundSignInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaGroundSignInfoLocalServiceImpl#deleteTourismBonaGroundSignInfo(TourismBonaGroundSignInfo) to avoid orphaned data");
		}

		return tourismBonaGroundSignInfoLocalService.
			deleteTourismBonaGroundSignInfo(
				(TourismBonaGroundSignInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaGroundSignInfo> getBasePersistence() {
		return tourismBonaGroundSignInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismBonaGroundSignInfo> getTourismBonaGroundSignInfos(
		int start, int end) {

		return tourismBonaGroundSignInfoPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaGroundSignInfosCount() {
		return tourismBonaGroundSignInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismBonaGroundSignInfo updateTourismBonaGroundSignInfo(
		TourismBonaGroundSignInfo tourismBonaGroundSignInfo) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundSignInfoLocalService =
			(TourismBonaGroundSignInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundSignInfoLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TourismBonaGroundSignInfo.class;
	}

	protected String getModelClassName() {
		return TourismBonaGroundSignInfo.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaGroundSignInfoPersistence.getDataSource();
	...
	protected TourismBonaGroundSignInfoLocalService
		tourismBonaGroundSignInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundSignInfoLocalServiceBaseImpl.class);
