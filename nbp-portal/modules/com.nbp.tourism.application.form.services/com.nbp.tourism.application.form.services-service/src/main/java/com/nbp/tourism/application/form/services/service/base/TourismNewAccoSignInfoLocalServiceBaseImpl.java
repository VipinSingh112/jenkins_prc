...
import com.nbp.tourism.application.form.services.service.TourismNewAccoSignInfoLocalService;
...
/**
 * Provides the base implementation for the tourism new acco sign info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccoSignInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccoSignInfoLocalServiceImpl
 * @generated
 */
public abstract class TourismNewAccoSignInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TourismNewAccoSignInfoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccoSignInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccoSignInfoLocalServiceUtil</code>.
	 */

	/**
	 * Adds the tourism new acco sign info to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TourismNewAccoSignInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param tourismNewAccoSignInfo the tourism new acco sign info
	 * @return the tourism new acco sign info that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewAccoSignInfo addTourismNewAccoSignInfo(
		TourismNewAccoSignInfo tourismNewAccoSignInfo) {

		tourismNewAccoSignInfo.setNew(true);

		return tourismNewAccoSignInfoPersistence.update(tourismNewAccoSignInfo);
	}
	...
	public TourismNewAccoSignInfo createTourismNewAccoSignInfo(
		long tourismNewAccoSignInfoId) {

		return tourismNewAccoSignInfoPersistence.create(
			tourismNewAccoSignInfoId);
	}

	/**
	 * Deletes the tourism new acco sign info with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TourismNewAccoSignInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a tourism new acco sign info with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TourismNewAccoSignInfo deleteTourismNewAccoSignInfo(
			long tourismNewAccoSignInfoId)
		throws PortalException {

		return tourismNewAccoSignInfoPersistence.remove(
			tourismNewAccoSignInfoId);
	}

	/**
	 * Deletes the tourism new acco sign info from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TourismNewAccoSignInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	public TourismNewAccoSignInfo deleteTourismNewAccoSignInfo(
		...
		return tourismNewAccoSignInfoPersistence.remove(tourismNewAccoSignInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewAccoSignInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewAccoSignInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewAccoSignInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>com.nbp.tourism.application.form.services.model.impl.TourismNewAccoSignInfoModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewAccoSignInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismNewAccoSignInfo fetchTourismNewAccoSignInfo(
		long tourismNewAccoSignInfoId) {

		return tourismNewAccoSignInfoPersistence.fetchByPrimaryKey(
			tourismNewAccoSignInfoId);
	}

	/**
	 * Returns the tourism new acco sign info with the primary key.
	 *
	 * @param tourismNewAccoSignInfoId the primary key of the tourism new acco sign info
	 ...
	 */
	@Override
	public TourismNewAccoSignInfo getTourismNewAccoSignInfo(
			long tourismNewAccoSignInfoId)
		throws PortalException {

		return tourismNewAccoSignInfoPersistence.findByPrimaryKey(
			tourismNewAccoSignInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismNewAccoSignInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewAccoSignInfoLocalServiceImpl#deleteTourismNewAccoSignInfo(TourismNewAccoSignInfo) to avoid orphaned data");
		}

		return tourismNewAccoSignInfoLocalService.deleteTourismNewAccoSignInfo(
			(TourismNewAccoSignInfo)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewAccoSignInfo> getBasePersistence() {
		return tourismNewAccoSignInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismNewAccoSignInfo> getTourismNewAccoSignInfos(
		int start, int end) {

		return tourismNewAccoSignInfoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTourismNewAccoSignInfosCount() {
		return tourismNewAccoSignInfoPersistence.countAll();
	}

	/**
	 * Updates the tourism new acco sign info in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TourismNewAccoSignInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param tourismNewAccoSignInfo the tourism new acco sign info
	 * @return the tourism new acco sign info that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewAccoSignInfo updateTourismNewAccoSignInfo(
		TourismNewAccoSignInfo tourismNewAccoSignInfo) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccoSignInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccoSignInfoLocalService =
			(TourismNewAccoSignInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccoSignInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAccoSignInfoPersistence.getDataSource();
	...
	protected TourismNewAccoSignInfoLocalService
		tourismNewAccoSignInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccoSignInfoLocalServiceBaseImpl.class);
