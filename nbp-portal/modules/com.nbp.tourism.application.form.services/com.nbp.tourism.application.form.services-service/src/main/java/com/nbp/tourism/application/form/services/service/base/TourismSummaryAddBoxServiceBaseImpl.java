...
import com.nbp.tourism.application.form.services.service.TourismSummaryAddBoxService;
...
/**
 * Provides the base implementation for the tourism summary add box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismSummaryAddBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismSummaryAddBoxServiceImpl
 * @generated
 */
public abstract class TourismSummaryAddBoxServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TourismSummaryAddBoxService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismSummaryAddBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismSummaryAddBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismSummaryAddBoxService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tourismSummaryAddBoxService = (TourismSummaryAddBoxService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismSummaryAddBoxService.class.getName();
	}
	...
	protected TourismSummaryAddBoxService tourismSummaryAddBoxService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismSummaryAddBoxServiceBaseImpl.class);
