...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormSecondService;
...
/**
 * Provides the base implementation for the tourism bona attraction form second remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormSecondServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormSecondServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionFormSecondServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionFormSecondService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionFormSecondServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionFormSecondService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionFormSecondService =
			(TourismBonaAttractionFormSecondService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionFormSecondService.class.getName();
	}
	...
	protected TourismBonaAttractionFormSecondService
		tourismBonaAttractionFormSecondService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionFormSecondServiceBaseImpl.class);
