...
import com.nbp.tourism.application.form.services.service.TourismBonaWaterSportsFormSecondLocalService;
...
/**
 * Provides the base implementation for the tourism bona water sports form second local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportsFormSecondLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportsFormSecondLocalServiceImpl
 * @generated
 */
public abstract class TourismBonaWaterSportsFormSecondLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaWaterSportsFormSecondLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaWaterSportsFormSecondLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismBonaWaterSportsFormSecond addTourismBonaWaterSportsFormSecond(
		TourismBonaWaterSportsFormSecond tourismBonaWaterSportsFormSecond) {

		tourismBonaWaterSportsFormSecond.setNew(true);

		return tourismBonaWaterSportsFormSecondPersistence.update(
	...
	public TourismBonaWaterSportsFormSecond
		createTourismBonaWaterSportsFormSecond(
			long tourismBonaWaterSportsFSecId) {

		return tourismBonaWaterSportsFormSecondPersistence.create(
	...
	public TourismBonaWaterSportsFormSecond
		...
		return tourismBonaWaterSportsFormSecondPersistence.remove(
			tourismBonaWaterSportsFSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaWaterSportsFormSecondPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismBonaWaterSportsFormSecond.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaWaterSportsFormSecondPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismBonaWaterSportsFormSecondPersistence.
	...
	public TourismBonaWaterSportsFormSecond
		...
		return tourismBonaWaterSportsFormSecondPersistence.fetchByPrimaryKey(
			tourismBonaWaterSportsFSecId);
	}
	 ...
	 */
	@Override
	public TourismBonaWaterSportsFormSecond getTourismBonaWaterSportsFormSecond(
			long tourismBonaWaterSportsFSecId)
		throws PortalException {

		return tourismBonaWaterSportsFormSecondPersistence.findByPrimaryKey(
			tourismBonaWaterSportsFSecId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaWaterSportsFormSecondLocalServiceImpl#deleteTourismBonaWaterSportsFormSecond(TourismBonaWaterSportsFormSecond) to avoid orphaned data");
		}

		return tourismBonaWaterSportsFormSecondLocalService.
			deleteTourismBonaWaterSportsFormSecond(
				(TourismBonaWaterSportsFormSecond)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaWaterSportsFormSecond>
		getBasePersistence() {
	 ...
	 */
	@Override
	public List<TourismBonaWaterSportsFormSecond>
		getTourismBonaWaterSportsFormSeconds(int start, int end) {

		return tourismBonaWaterSportsFormSecondPersistence.findAll(start, end);
	}
	...
	public int getTourismBonaWaterSportsFormSecondsCount() {
		return tourismBonaWaterSportsFormSecondPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaWaterSportsFormSecondLocalService =
			(TourismBonaWaterSportsFormSecondLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaWaterSportsFormSecondLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaWaterSportsFormSecondPersistence.getDataSource();
	...
	protected TourismBonaWaterSportsFormSecondLocalService
		tourismBonaWaterSportsFormSecondLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaWaterSportsFormSecondLocalServiceBaseImpl.class);
