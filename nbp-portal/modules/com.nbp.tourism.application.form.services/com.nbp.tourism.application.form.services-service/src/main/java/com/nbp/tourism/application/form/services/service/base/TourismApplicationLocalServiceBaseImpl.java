...
import com.nbp.tourism.application.form.services.service.TourismApplicationLocalService;
...
/**
 * Provides the base implementation for the tourism application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismApplicationLocalServiceImpl
 * @generated
 */
public abstract class TourismApplicationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismApplicationLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismApplication addTourismApplication(
		TourismApplication tourismApplication) {

		tourismApplication.setNew(true);

		return tourismApplicationPersistence.update(tourismApplication);
	}
	...
	public TourismApplication createTourismApplication(
		long tourismApplicationId) {

		return tourismApplicationPersistence.create(tourismApplicationId);
	}
	...
	@Override
	public TourismApplication deleteTourismApplication(
			long tourismApplicationId)
		throws PortalException {

		return tourismApplicationPersistence.remove(tourismApplicationId);
	}
	...
	public TourismApplication deleteTourismApplication(
		...
		return tourismApplicationPersistence.remove(tourismApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismApplicationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tourismApplicationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismApplicationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismApplication fetchTourismApplication(
		long tourismApplicationId) {

		return tourismApplicationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public TourismApplication getTourismApplication(long tourismApplicationId)
		throws PortalException {

		return tourismApplicationPersistence.findByPrimaryKey(
			tourismApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismApplication.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TourismApplication.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tourismApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismApplicationLocalServiceImpl#deleteTourismApplication(TourismApplication) to avoid orphaned data");
		}

		return tourismApplicationLocalService.deleteTourismApplication(
			(TourismApplication)persistedModel);
	}

	@Override
	public BasePersistence<TourismApplication> getBasePersistence() {
		return tourismApplicationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return tourismApplicationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TourismApplication> getTourismApplications(int start, int end) {
		return tourismApplicationPersistence.findAll(start, end);
	}
	...
	public int getTourismApplicationsCount() {
		return tourismApplicationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismApplication updateTourismApplication(
		TourismApplication tourismApplication) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismApplicationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismApplicationLocalService =
			(TourismApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismApplicationPersistence.getDataSource();
	...
	protected TourismApplicationLocalService tourismApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismApplicationLocalServiceBaseImpl.class);
