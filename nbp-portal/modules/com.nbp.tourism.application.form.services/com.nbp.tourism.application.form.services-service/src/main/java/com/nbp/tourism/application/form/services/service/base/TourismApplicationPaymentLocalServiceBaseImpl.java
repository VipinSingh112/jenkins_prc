...
import com.nbp.tourism.application.form.services.service.TourismApplicationPaymentLocalService;
...
/**
 * Provides the base implementation for the tourism application payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismApplicationPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismApplicationPaymentLocalServiceImpl
 * @generated
 */
public abstract class TourismApplicationPaymentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismApplicationPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismApplicationPaymentLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismApplicationPayment addTourismApplicationPayment(
		TourismApplicationPayment tourismApplicationPayment) {

		tourismApplicationPayment.setNew(true);

		return tourismApplicationPaymentPersistence.update(
	...
	public TourismApplicationPayment createTourismApplicationPayment(
		long TourismApplicationPaymentId) {

		return tourismApplicationPaymentPersistence.create(
	...
	@Override
	public TourismApplicationPayment deleteTourismApplicationPayment(
			long TourismApplicationPaymentId)
		throws PortalException {

		return tourismApplicationPaymentPersistence.remove(
			TourismApplicationPaymentId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismApplicationPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismApplicationPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismApplicationPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismApplicationPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismApplicationPayment fetchTourismApplicationPayment(
		long TourismApplicationPaymentId) {

		return tourismApplicationPaymentPersistence.fetchByPrimaryKey(
			TourismApplicationPaymentId);
	}
	 ...
	 */
	@Override
	public TourismApplicationPayment getTourismApplicationPayment(
			long TourismApplicationPaymentId)
		throws PortalException {

		return tourismApplicationPaymentPersistence.findByPrimaryKey(
			TourismApplicationPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TourismApplicationPayment.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TourismApplicationPayment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismApplicationPaymentLocalServiceImpl#deleteTourismApplicationPayment(TourismApplicationPayment) to avoid orphaned data");
		}

		return tourismApplicationPaymentLocalService.
			deleteTourismApplicationPayment(
				(TourismApplicationPayment)persistedModel);
	}

	@Override
	public BasePersistence<TourismApplicationPayment> getBasePersistence() {
		return tourismApplicationPaymentPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismApplicationPayment> getTourismApplicationPayments(
		int start, int end) {

		return tourismApplicationPaymentPersistence.findAll(start, end);
	}
	...
	public int getTourismApplicationPaymentsCount() {
		return tourismApplicationPaymentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismApplicationPayment updateTourismApplicationPayment(
		TourismApplicationPayment tourismApplicationPayment) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismApplicationPaymentLocalService =
			(TourismApplicationPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismApplicationPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismApplicationPaymentPersistence.getDataSource();
	...
	protected TourismApplicationPaymentLocalService
		tourismApplicationPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismApplicationPaymentLocalServiceBaseImpl.class);
