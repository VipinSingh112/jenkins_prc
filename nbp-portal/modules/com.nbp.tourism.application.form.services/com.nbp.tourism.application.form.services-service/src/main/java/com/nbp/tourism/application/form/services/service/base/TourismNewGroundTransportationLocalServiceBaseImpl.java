...
import com.nbp.tourism.application.form.services.service.TourismNewGroundTransportationLocalService;
...
/**
 * Provides the base implementation for the tourism new ground transportation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationLocalServiceImpl
 * @generated
 */
public abstract class TourismNewGroundTransportationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewGroundTransportationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewGroundTransportationLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismNewGroundTransportation addTourismNewGroundTransportation(
		TourismNewGroundTransportation tourismNewGroundTransportation) {

		tourismNewGroundTransportation.setNew(true);

		return tourismNewGroundTransportationPersistence.update(
	...
	public TourismNewGroundTransportation createTourismNewGroundTransportation(
		long TourismNewGroundTransId) {

		return tourismNewGroundTransportationPersistence.create(
	...
	@Override
	public TourismNewGroundTransportation deleteTourismNewGroundTransportation(
			long TourismNewGroundTransId)
		throws PortalException {

		return tourismNewGroundTransportationPersistence.remove(
			TourismNewGroundTransId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewGroundTransportationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewGroundTransportation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewGroundTransportationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewGroundTransportationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismNewGroundTransportation fetchTourismNewGroundTransportation(
		long TourismNewGroundTransId) {

		return tourismNewGroundTransportationPersistence.fetchByPrimaryKey(
			TourismNewGroundTransId);
	}
	 ...
	 */
	@Override
	public TourismNewGroundTransportation getTourismNewGroundTransportation(
			long TourismNewGroundTransId)
		throws PortalException {

		return tourismNewGroundTransportationPersistence.findByPrimaryKey(
			TourismNewGroundTransId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewGroundTransportationLocalServiceImpl#deleteTourismNewGroundTransportation(TourismNewGroundTransportation) to avoid orphaned data");
		}

		return tourismNewGroundTransportationLocalService.
			deleteTourismNewGroundTransportation(
				(TourismNewGroundTransportation)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewGroundTransportation>
		getBasePersistence() {

		return tourismNewGroundTransportationPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismNewGroundTransportation>
		getTourismNewGroundTransportations(int start, int end) {

		return tourismNewGroundTransportationPersistence.findAll(start, end);
	}
	...
	public int getTourismNewGroundTransportationsCount() {
		return tourismNewGroundTransportationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewGroundTransportation updateTourismNewGroundTransportation(
		TourismNewGroundTransportation tourismNewGroundTransportation) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewGroundTransportationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewGroundTransportationLocalService =
			(TourismNewGroundTransportationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewGroundTransportationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewGroundTransportationPersistence.getDataSource();
	...
	protected TourismNewGroundTransportationLocalService
		tourismNewGroundTransportationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewGroundTransportationLocalServiceBaseImpl.class);
