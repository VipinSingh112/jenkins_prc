...
import com.nbp.tourism.application.form.services.service.TourismBonaOperatorInfoService;
...
/**
 * Provides the base implementation for the tourism bona operator info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaOperatorInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaOperatorInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaOperatorInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaOperatorInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaOperatorInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaOperatorInfoService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaOperatorInfoService =
			(TourismBonaOperatorInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaOperatorInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaOperatorInfoPersistence.getDataSource();
	...
	protected com.nbp.tourism.application.form.services.service.
		TourismBonaOperatorInfoLocalService tourismBonaOperatorInfoLocalService;

	protected TourismBonaOperatorInfoService tourismBonaOperatorInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaOperatorInfoServiceBaseImpl.class);
