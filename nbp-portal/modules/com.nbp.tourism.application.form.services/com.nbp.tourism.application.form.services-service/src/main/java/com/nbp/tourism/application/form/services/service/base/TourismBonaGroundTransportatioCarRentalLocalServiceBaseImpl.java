...
import com.nbp.tourism.application.form.services.service.TourismBonaGroundTransportatioCarRentalLocalService;
...
/**
 * Provides the base implementation for the tourism bona ground transportatio car rental local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransportatioCarRentalLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransportatioCarRentalLocalServiceImpl
 * @generated
 */
public abstract class
	TourismBonaGroundTransportatioCarRentalLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaGroundTransportatioCarRentalLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaGroundTransportatioCarRentalLocalServiceUtil</code>.
	 */
	...
	public TourismBonaGroundTransportatioCarRental
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.update(
			tourismBonaGroundTransportatioCarRental);
	}
	...
	public TourismBonaGroundTransportatioCarRental
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.create(
	...
	public TourismBonaGroundTransportatioCarRental
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.remove(
			tourismBonaGroundTransportCRId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismBonaGroundTransportatioCarRentalPersistence.dslQuery(
			dslQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismBonaGroundTransportatioCarRentalPersistence.
	...
	public TourismBonaGroundTransportatioCarRental
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.
			fetchByPrimaryKey(tourismBonaGroundTransportCRId);
	}
	...
	public TourismBonaGroundTransportatioCarRental
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.
			findByPrimaryKey(tourismBonaGroundTransportCRId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismBonaGroundTransportatioCarRentalLocalServiceImpl#deleteTourismBonaGroundTransportatioCarRental(TourismBonaGroundTransportatioCarRental) to avoid orphaned data");
		}

		return tourismBonaGroundTransportatioCarRentalLocalService.
			deleteTourismBonaGroundTransportatioCarRental(
				(TourismBonaGroundTransportatioCarRental)persistedModel);
	}

	@Override
	public BasePersistence<TourismBonaGroundTransportatioCarRental>
		getBasePersistence() {
	...
	public List<TourismBonaGroundTransportatioCarRental>
		...
		return tourismBonaGroundTransportatioCarRentalPersistence.findAll(
			start, end);
	}
	...
	public int getTourismBonaGroundTransportatioCarRentalsCount() {
		return tourismBonaGroundTransportatioCarRentalPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaGroundTransportatioCarRentalLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaGroundTransportatioCarRentalLocalService =
			(TourismBonaGroundTransportatioCarRentalLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaGroundTransportatioCarRentalLocalService.class.
			getName();
	}
	...
	protected TourismBonaGroundTransportatioCarRentalLocalService
		tourismBonaGroundTransportatioCarRentalLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaGroundTransportatioCarRentalLocalServiceBaseImpl.class);
