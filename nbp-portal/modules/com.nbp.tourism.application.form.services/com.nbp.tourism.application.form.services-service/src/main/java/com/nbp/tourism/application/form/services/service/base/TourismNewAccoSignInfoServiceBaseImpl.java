...
import com.nbp.tourism.application.form.services.service.TourismNewAccoSignInfoService;
...
/**
 * Provides the base implementation for the tourism new acco sign info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccoSignInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccoSignInfoServiceImpl
 * @generated
 */
public abstract class TourismNewAccoSignInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccoSignInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccoSignInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccoSignInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tourismNewAccoSignInfoService = (TourismNewAccoSignInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccoSignInfoService.class.getName();
	}
	...
	protected TourismNewAccoSignInfoService tourismNewAccoSignInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccoSignInfoServiceBaseImpl.class);
