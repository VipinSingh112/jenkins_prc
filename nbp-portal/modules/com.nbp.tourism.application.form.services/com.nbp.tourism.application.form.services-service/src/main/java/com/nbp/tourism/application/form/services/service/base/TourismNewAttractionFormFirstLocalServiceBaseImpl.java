...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstLocalService;
...
/**
 * Provides the base implementation for the tourism new attraction form first local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstLocalServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionFormFirstLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionFormFirstLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionFormFirstLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismNewAttractionFormFirst addTourismNewAttractionFormFirst(
		TourismNewAttractionFormFirst tourismNewAttractionFormFirst) {

		tourismNewAttractionFormFirst.setNew(true);

		return tourismNewAttractionFormFirstPersistence.update(
	...
	public TourismNewAttractionFormFirst createTourismNewAttractionFormFirst(
		long tourismNewAttractFormFirstId) {

		return tourismNewAttractionFormFirstPersistence.create(
	...
	@Override
	public TourismNewAttractionFormFirst deleteTourismNewAttractionFormFirst(
			long tourismNewAttractFormFirstId)
		throws PortalException {

		return tourismNewAttractionFormFirstPersistence.remove(
			tourismNewAttractFormFirstId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewAttractionFormFirstPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewAttractionFormFirst.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewAttractionFormFirstPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewAttractionFormFirstPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismNewAttractionFormFirst fetchTourismNewAttractionFormFirst(
		long tourismNewAttractFormFirstId) {

		return tourismNewAttractionFormFirstPersistence.fetchByPrimaryKey(
			tourismNewAttractFormFirstId);
	}
	 ...
	 */
	@Override
	public TourismNewAttractionFormFirst getTourismNewAttractionFormFirst(
			long tourismNewAttractFormFirstId)
		throws PortalException {

		return tourismNewAttractionFormFirstPersistence.findByPrimaryKey(
			tourismNewAttractFormFirstId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewAttractionFormFirstLocalServiceImpl#deleteTourismNewAttractionFormFirst(TourismNewAttractionFormFirst) to avoid orphaned data");
		}

		return tourismNewAttractionFormFirstLocalService.
			deleteTourismNewAttractionFormFirst(
				(TourismNewAttractionFormFirst)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewAttractionFormFirst> getBasePersistence() {
		return tourismNewAttractionFormFirstPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismNewAttractionFormFirst>
		getTourismNewAttractionFormFirsts(int start, int end) {

		return tourismNewAttractionFormFirstPersistence.findAll(start, end);
	}
	...
	public int getTourismNewAttractionFormFirstsCount() {
		return tourismNewAttractionFormFirstPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewAttractionFormFirst updateTourismNewAttractionFormFirst(
		TourismNewAttractionFormFirst tourismNewAttractionFormFirst) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionFormFirstLocalService =
			(TourismNewAttractionFormFirstLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionFormFirstLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAttractionFormFirstPersistence.getDataSource();
	...
	protected TourismNewAttractionFormFirstLocalService
		tourismNewAttractionFormFirstLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionFormFirstLocalServiceBaseImpl.class);
