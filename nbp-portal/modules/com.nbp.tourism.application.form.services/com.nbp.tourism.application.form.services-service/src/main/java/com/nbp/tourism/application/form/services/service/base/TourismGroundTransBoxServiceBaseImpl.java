...
import com.nbp.tourism.application.form.services.service.TourismGroundTransBoxService;
...
/**
 * Provides the base implementation for the tourism ground trans box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismGroundTransBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismGroundTransBoxServiceImpl
 * @generated
 */
public abstract class TourismGroundTransBoxServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismGroundTransBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismGroundTransBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismGroundTransBoxService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		tourismGroundTransBoxService = (TourismGroundTransBoxService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismGroundTransBoxService.class.getName();
	}
	...
	protected TourismGroundTransBoxService tourismGroundTransBoxService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismGroundTransBoxServiceBaseImpl.class);
