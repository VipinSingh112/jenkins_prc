...
import com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormService;
...
/**
 * Provides the base implementation for the tourism bona accommodation form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccommodationFormServiceImpl
 * @generated
 */
public abstract class TourismBonaAccommodationFormServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccommodationFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccommodationFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAccommodationFormService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccommodationFormService =
			(TourismBonaAccommodationFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccommodationFormService.class.getName();
	}
	...
	protected TourismBonaAccommodationFormService
		tourismBonaAccommodationFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccommodationFormServiceBaseImpl.class);
