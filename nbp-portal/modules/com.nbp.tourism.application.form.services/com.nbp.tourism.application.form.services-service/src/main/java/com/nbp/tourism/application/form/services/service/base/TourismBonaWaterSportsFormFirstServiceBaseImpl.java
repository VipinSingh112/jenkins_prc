...
import com.nbp.tourism.application.form.services.service.TourismBonaWaterSportsFormFirstService;
...
/**
 * Provides the base implementation for the tourism bona water sports form first remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportsFormFirstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportsFormFirstServiceImpl
 * @generated
 */
public abstract class TourismBonaWaterSportsFormFirstServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaWaterSportsFormFirstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaWaterSportsFormFirstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaWaterSportsFormFirstService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaWaterSportsFormFirstService =
			(TourismBonaWaterSportsFormFirstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaWaterSportsFormFirstService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaWaterSportsFormFirstPersistence.getDataSource();
	...
	protected TourismBonaWaterSportsFormFirstService
		tourismBonaWaterSportsFormFirstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaWaterSportsFormFirstServiceBaseImpl.class);
