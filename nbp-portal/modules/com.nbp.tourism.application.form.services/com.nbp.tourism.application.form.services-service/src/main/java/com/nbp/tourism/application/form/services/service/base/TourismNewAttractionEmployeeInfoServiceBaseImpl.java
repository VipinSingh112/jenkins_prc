...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionEmployeeInfoService;
...
/**
 * Provides the base implementation for the tourism new attraction employee info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionEmployeeInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionEmployeeInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionEmployeeInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAttractionEmployeeInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionEmployeeInfoService =
			(TourismNewAttractionEmployeeInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionEmployeeInfoService.class.getName();
	}
	...
	protected TourismNewAttractionEmployeeInfoService
		tourismNewAttractionEmployeeInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionEmployeeInfoServiceBaseImpl.class);
