...
import com.nbp.tourism.application.form.services.service.TourismNewAccommodationFormService;
...
/**
 * Provides the base implementation for the tourism new accommodation form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAccommodationFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAccommodationFormServiceImpl
 * @generated
 */
public abstract class TourismNewAccommodationFormServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAccommodationFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAccommodationFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismNewAccommodationFormService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAccommodationFormService =
			(TourismNewAccommodationFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAccommodationFormService.class.getName();
	}
	...
	protected TourismNewAccommodationFormService
		tourismNewAccommodationFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAccommodationFormServiceBaseImpl.class);
