...
import com.nbp.tourism.application.form.services.service.TourismNewAttractionFormSecondLocalService;
...
/**
 * Provides the base implementation for the tourism new attraction form second local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormSecondLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormSecondLocalServiceImpl
 * @generated
 */
public abstract class TourismNewAttractionFormSecondLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismNewAttractionFormSecondLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismNewAttractionFormSecondLocalServiceUtil</code>.
	 */
	...
	@Override
	public TourismNewAttractionFormSecond addTourismNewAttractionFormSecond(
		TourismNewAttractionFormSecond tourismNewAttractionFormSecond) {

		tourismNewAttractionFormSecond.setNew(true);

		return tourismNewAttractionFormSecondPersistence.update(
	...
	public TourismNewAttractionFormSecond createTourismNewAttractionFormSecond(
		long tourismNewAttractionFormSecId) {

		return tourismNewAttractionFormSecondPersistence.create(
	...
	@Override
	public TourismNewAttractionFormSecond deleteTourismNewAttractionFormSecond(
			long tourismNewAttractionFormSecId)
		throws PortalException {

		return tourismNewAttractionFormSecondPersistence.remove(
			tourismNewAttractionFormSecId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tourismNewAttractionFormSecondPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TourismNewAttractionFormSecond.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tourismNewAttractionFormSecondPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tourismNewAttractionFormSecondPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TourismNewAttractionFormSecond fetchTourismNewAttractionFormSecond(
		long tourismNewAttractionFormSecId) {

		return tourismNewAttractionFormSecondPersistence.fetchByPrimaryKey(
			tourismNewAttractionFormSecId);
	}
	 ...
	 */
	@Override
	public TourismNewAttractionFormSecond getTourismNewAttractionFormSecond(
			long tourismNewAttractionFormSecId)
		throws PortalException {

		return tourismNewAttractionFormSecondPersistence.findByPrimaryKey(
			tourismNewAttractionFormSecId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TourismNewAttractionFormSecondLocalServiceImpl#deleteTourismNewAttractionFormSecond(TourismNewAttractionFormSecond) to avoid orphaned data");
		}

		return tourismNewAttractionFormSecondLocalService.
			deleteTourismNewAttractionFormSecond(
				(TourismNewAttractionFormSecond)persistedModel);
	}

	@Override
	public BasePersistence<TourismNewAttractionFormSecond>
		getBasePersistence() {

		return tourismNewAttractionFormSecondPersistence;
	}
	 ...
	 */
	@Override
	public List<TourismNewAttractionFormSecond>
		getTourismNewAttractionFormSeconds(int start, int end) {

		return tourismNewAttractionFormSecondPersistence.findAll(start, end);
	}
	...
	public int getTourismNewAttractionFormSecondsCount() {
		return tourismNewAttractionFormSecondPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TourismNewAttractionFormSecond updateTourismNewAttractionFormSecond(
		TourismNewAttractionFormSecond tourismNewAttractionFormSecond) {
	...
	public void setAopProxy(Object aopProxy) {
		tourismNewAttractionFormSecondLocalService =
			(TourismNewAttractionFormSecondLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismNewAttractionFormSecondLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismNewAttractionFormSecondPersistence.getDataSource();
	...
	protected TourismNewAttractionFormSecondLocalService
		tourismNewAttractionFormSecondLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismNewAttractionFormSecondLocalServiceBaseImpl.class);
