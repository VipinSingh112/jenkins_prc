...
import com.nbp.tourism.application.form.services.service.TourismBonaAttractionEmployeeInfoService;
...
/**
 * Provides the base implementation for the tourism bona attraction employee info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaAttractionEmployeeInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAttractionEmployeeInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAttractionEmployeeInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAttractionEmployeeInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAttractionEmployeeInfoService =
			(TourismBonaAttractionEmployeeInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAttractionEmployeeInfoService.class.getName();
	}
	...
	protected TourismBonaAttractionEmployeeInfoService
		tourismBonaAttractionEmployeeInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAttractionEmployeeInfoServiceBaseImpl.class);
