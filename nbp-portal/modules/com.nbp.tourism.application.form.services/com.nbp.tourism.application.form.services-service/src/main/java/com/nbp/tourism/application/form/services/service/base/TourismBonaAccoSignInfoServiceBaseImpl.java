...
import com.nbp.tourism.application.form.services.service.TourismBonaAccoSignInfoService;
...
/**
 * Provides the base implementation for the tourism bona acco sign info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoSignInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoSignInfoServiceImpl
 * @generated
 */
public abstract class TourismBonaAccoSignInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismBonaAccoSignInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.form.services.service.TourismBonaAccoSignInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismBonaAccoSignInfoService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismBonaAccoSignInfoService =
			(TourismBonaAccoSignInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismBonaAccoSignInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				tourismBonaAccoSignInfoPersistence.getDataSource();
	...
	protected com.nbp.tourism.application.form.services.service.
		TourismBonaAccoSignInfoLocalService tourismBonaAccoSignInfoLocalService;

	protected TourismBonaAccoSignInfoService tourismBonaAccoSignInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismBonaAccoSignInfoServiceBaseImpl.class);
