...
/**
 * Provides the local service interface for TourismAnnualEntertainBox. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismAnnualEntertainBoxLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismAnnualEntertainBoxLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismAnnualEntertainBoxLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism annual entertain box local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismAnnualEntertainBoxLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismAnnualEntertainBox addTourismAnnualEntertainBox(
	...
	public TourismAnnualEntertainBox createTourismAnnualEntertainBox(
	...
	public TourismAnnualEntertainBox deleteTourismAnnualEntertainBox(
			long tourismAnnualEntertainBoxId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismAnnualEntertainBox fetchTourismAnnualEntertainBox(
		long tourismAnnualEntertainBoxId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismAnnualEntertainBox> getTAP_TAI(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismAnnualEntertainBox getTourismAnnualEntertainBox(
			long tourismAnnualEntertainBoxId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismAnnualEntertainBox> getTourismAnnualEntertainBoxes(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismAnnualEntertainBox> getTourismEntertainmentBoxById(
		long applicationId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TourismAnnualEntertainBox updateTourismAnnualEntertainBox(
		TourismAnnualEntertainBox tourismAnnualEntertainBox);
