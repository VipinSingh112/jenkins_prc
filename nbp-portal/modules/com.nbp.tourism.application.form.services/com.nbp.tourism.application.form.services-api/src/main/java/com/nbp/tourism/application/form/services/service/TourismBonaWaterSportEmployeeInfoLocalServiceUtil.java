...
/**
 * Provides the local service utility for TourismBonaWaterSportEmployeeInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportEmployeeInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismBonaWaterSportEmployeeInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportEmployeeInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismBonaWaterSportEmployeeInfo
		addTourismBonaWaterSportEmployeeInfo(
			TourismBonaWaterSportEmployeeInfo
				tourismBonaWaterSportEmployeeInfo) {

		return getService().addTourismBonaWaterSportEmployeeInfo(
			tourismBonaWaterSportEmployeeInfo);
	}
	...
	public static TourismBonaWaterSportEmployeeInfo
		...
		return getService().createTourismBonaWaterSportEmployeeInfo(
			tourismBonaWSEmplId);
	}
	...
	public static TourismBonaWaterSportEmployeeInfo
		...
		return getService().deleteTourismBonaWaterSportEmployeeInfo(
			tourismBonaWSEmplId);
	}
	...
	public static TourismBonaWaterSportEmployeeInfo
		...
		return getService().fetchTourismBonaWaterSportEmployeeInfo(
			tourismBonaWSEmplId);
	}
	...
	public static TourismBonaWaterSportEmployeeInfo
		...
		return getService().getTourismBonaWaterSportEmployeeInfo(
			tourismBonaWSEmplId);
	}
	 ...
	 */
	public static List<TourismBonaWaterSportEmployeeInfo>
		getTourismBonaWaterSportEmployeeInfos(int start, int end) {

		return getService().getTourismBonaWaterSportEmployeeInfos(start, end);
	}
	 ...
	 */
	public static int getTourismBonaWaterSportEmployeeInfosCount() {
		return getService().getTourismBonaWaterSportEmployeeInfosCount();
	}

	public static TourismBonaWaterSportEmployeeInfo getTourismById(
	...
	public static TourismBonaWaterSportEmployeeInfo
		...
		return getService().updateTourismBonaWaterSportEmployeeInfo(
			tourismBonaWaterSportEmployeeInfo);
	}

	public static TourismBonaWaterSportEmployeeInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismBonaWaterSportEmployeeInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismBonaWaterSportEmployeeInfoLocalServiceUtil.class,
