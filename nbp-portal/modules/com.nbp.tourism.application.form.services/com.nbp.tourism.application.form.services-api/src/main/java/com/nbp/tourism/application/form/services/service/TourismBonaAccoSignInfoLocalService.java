...
/**
 * Provides the local service interface for TourismBonaAccoSignInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaAccoSignInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaAccoSignInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAccoSignInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona acco sign info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaAccoSignInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismBonaAccoSignInfo addTourismBonaAccoSignInfo(
	...
	public TourismBonaAccoSignInfo createTourismBonaAccoSignInfo(
	...
	public TourismBonaAccoSignInfo deleteTourismBonaAccoSignInfo(
			long tourismBonaAccoSignId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAccoSignInfo fetchTourismBonaAccoSignInfo(
		long tourismBonaAccoSignId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAccoSignInfo getTourismBonaAccoSignInfo(
			long tourismBonaAccoSignId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismBonaAccoSignInfo> getTourismBonaAccoSignInfos(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAccoSignInfo getTourismById(long tourismApplicationId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TourismBonaAccoSignInfo updateTourismBonaAccoSignInfo(
		TourismBonaAccoSignInfo tourismBonaAccoSignInfo);
