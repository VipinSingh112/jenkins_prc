...
/**
 * Provides the local service interface for TourismBonaOperatorInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaOperatorInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaOperatorInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaOperatorInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona operator info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaOperatorInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismBonaOperatorInfo addTourismBonaOperatorInfo(
	...
	public TourismBonaOperatorInfo createTourismBonaOperatorInfo(
	...
	public TourismBonaOperatorInfo deleteTourismBonaOperatorInfo(
			long tourismBonaOperatorInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaOperatorInfo fetchTourismBonaOperatorInfo(
		long tourismBonaOperatorInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaOperatorInfo getOperatorInfoById(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaOperatorInfo getTourismBonaOperatorInfo(
			long tourismBonaOperatorInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismBonaOperatorInfo> getTourismBonaOperatorInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TourismBonaOperatorInfo updateTourismBonaOperatorInfo(
		TourismBonaOperatorInfo tourismBonaOperatorInfo);
