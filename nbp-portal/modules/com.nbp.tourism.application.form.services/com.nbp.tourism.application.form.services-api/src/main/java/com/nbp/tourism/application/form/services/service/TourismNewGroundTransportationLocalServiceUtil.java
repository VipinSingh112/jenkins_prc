...
/**
 * Provides the local service utility for TourismNewGroundTransportation. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewGroundTransportationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewGroundTransportationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismNewGroundTransportation
		addTourismNewGroundTransportation(
			TourismNewGroundTransportation tourismNewGroundTransportation) {

		return getService().addTourismNewGroundTransportation(
	 ...
	 */
	public static TourismNewGroundTransportation
		createTourismNewGroundTransportation(long TourismNewGroundTransId) {

		return getService().createTourismNewGroundTransportation(
	 ...
	 */
	public static TourismNewGroundTransportation
			deleteTourismNewGroundTransportation(long TourismNewGroundTransId)
		throws PortalException {

		return getService().deleteTourismNewGroundTransportation(
			TourismNewGroundTransId);
	}
	...
	public static TourismNewGroundTransportation
		fetchTourismNewGroundTransportation(long TourismNewGroundTransId) {

		return getService().fetchTourismNewGroundTransportation(
			TourismNewGroundTransId);
	}
	...
	public static TourismNewGroundTransportation getTourismById(
	 ...
	 */
	public static TourismNewGroundTransportation
			getTourismNewGroundTransportation(long TourismNewGroundTransId)
		throws PortalException {

		return getService().getTourismNewGroundTransportation(
			TourismNewGroundTransId);
	}
	 ...
	 */
	public static List<TourismNewGroundTransportation>
		getTourismNewGroundTransportations(int start, int end) {

		return getService().getTourismNewGroundTransportations(start, end);
	}
	 ...
	 */
	public static int getTourismNewGroundTransportationsCount() {
		return getService().getTourismNewGroundTransportationsCount();
	}
	...
	public static TourismNewGroundTransportation
		...
		return getService().updateTourismNewGroundTransportation(
			tourismNewGroundTransportation);
	}

	public static TourismNewGroundTransportationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismNewGroundTransportationLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismNewGroundTransportationLocalServiceUtil.class,
