...
/**
 * Provides the local service utility for TourismBonaGroundTransContractSign. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransContractSignLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismBonaGroundTransContractSignLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundTransContractSignLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismBonaGroundTransContractSign
		addTourismBonaGroundTransContractSign(
			TourismBonaGroundTransContractSign
				tourismBonaGroundTransContractSign) {

		return getService().addTourismBonaGroundTransContractSign(
			tourismBonaGroundTransContractSign);
	}
	...
	public static TourismBonaGroundTransContractSign
		...
		return getService().createTourismBonaGroundTransContractSign(
	...
	public static TourismBonaGroundTransContractSign
		...
		return getService().deleteTourismBonaGroundTransContractSign(
			tourismBonaGroTraCoSignId);
	}
	...
	public static TourismBonaGroundTransContractSign
		...
		return getService().fetchTourismBonaGroundTransContractSign(
			tourismBonaGroTraCoSignId);
	}
	...
	public static TourismBonaGroundTransContractSign
		...
		return getService().getTourismBonaGroundTransContractSign(
			tourismBonaGroTraCoSignId);
	}
	 ...
	 */
	public static List<TourismBonaGroundTransContractSign>
		getTourismBonaGroundTransContractSigns(int start, int end) {

		return getService().getTourismBonaGroundTransContractSigns(start, end);
	}
	 ...
	 */
	public static int getTourismBonaGroundTransContractSignsCount() {
		return getService().getTourismBonaGroundTransContractSignsCount();
	}

	public static TourismBonaGroundTransContractSign getTourismById(
	...
	public static TourismBonaGroundTransContractSign
		...
		return getService().updateTourismBonaGroundTransContractSign(
			tourismBonaGroundTransContractSign);
	}

	public static TourismBonaGroundTransContractSignLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot
		<TourismBonaGroundTransContractSignLocalService> _serviceSnapshot =
			new Snapshot<>(
				TourismBonaGroundTransContractSignLocalServiceUtil.class,
