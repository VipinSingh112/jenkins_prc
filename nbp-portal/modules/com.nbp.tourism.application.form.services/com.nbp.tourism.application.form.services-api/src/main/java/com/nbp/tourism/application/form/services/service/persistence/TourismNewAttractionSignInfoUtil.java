...
/**
 * The persistence utility for the tourism new attraction sign info service. This utility wraps <code>com.nbp.tourism.application.form.services.service.persistence.impl.TourismNewAttractionSignInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TourismNewAttractionSignInfoPersistence
 * @generated
 */
public class TourismNewAttractionSignInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(tourismNewAttractionSignInfo);
	}
	 ...
	 */
	public static Map<Serializable, TourismNewAttractionSignInfo>
	 ...
	 */
	public static List<TourismNewAttractionSignInfo> findWithDynamicQuery(
	 ...
	 */
	public static TourismNewAttractionSignInfo update(
		TourismNewAttractionSignInfo tourismNewAttractionSignInfo) {

		return getPersistence().update(tourismNewAttractionSignInfo);
	}
	...
	public static TourismNewAttractionSignInfo update(
		...
		return getPersistence().update(
			tourismNewAttractionSignInfo, serviceContext);
	}
	 ...
	 */
	public static TourismNewAttractionSignInfo findBygetTourismById(
	 ...
	 */
	public static TourismNewAttractionSignInfo fetchBygetTourismById(
		long tourismApplicationId) {
	 ...
	 */
	public static TourismNewAttractionSignInfo removeBygetTourismById(
			long tourismApplicationId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismNewAttractionSignInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tourismNewAttractionSignInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tourismNewAttractionSignInfos);
	}
	 ...
	 */
	public static TourismNewAttractionSignInfo create(
		long tourismNewAttraSignInfoId) {

		return getPersistence().create(tourismNewAttraSignInfoId);
	}
	 ...
	 */
	public static TourismNewAttractionSignInfo remove(
			long tourismNewAttraSignInfoId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismNewAttractionSignInfoException {

		return getPersistence().remove(tourismNewAttraSignInfoId);
	}

	public static TourismNewAttractionSignInfo updateImpl(
		TourismNewAttractionSignInfo tourismNewAttractionSignInfo) {

		return getPersistence().updateImpl(tourismNewAttractionSignInfo);
	}
	 ...
	 * @throws NoSuchTourismNewAttractionSignInfoException if a tourism new attraction sign info with the primary key could not be found
	 */
	public static TourismNewAttractionSignInfo findByPrimaryKey(
			long tourismNewAttraSignInfoId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismNewAttractionSignInfoException {

		return getPersistence().findByPrimaryKey(tourismNewAttraSignInfoId);
	}
	 ...
	 */
	public static TourismNewAttractionSignInfo fetchByPrimaryKey(
		long tourismNewAttraSignInfoId) {

		return getPersistence().fetchByPrimaryKey(tourismNewAttraSignInfoId);
	}
	 ...
	 */
	public static List<TourismNewAttractionSignInfo> findAll() {
	...
	public static TourismNewAttractionSignInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		TourismNewAttractionSignInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile TourismNewAttractionSignInfoPersistence
		_persistence;
