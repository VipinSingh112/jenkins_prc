...
/**
 * Provides the local service utility for TourismNewAccoGeneralForm. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAccoGeneralFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewAccoGeneralFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAccoGeneralFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismNewAccoGeneralForm addTourismNewAccoGeneralForm(
		TourismNewAccoGeneralForm tourismNewAccoGeneralForm) {

		return getService().addTourismNewAccoGeneralForm(
	 ...
	 */
	public static TourismNewAccoGeneralForm createTourismNewAccoGeneralForm(
		long tourismNewAccoGenFormId) {

		return getService().createTourismNewAccoGeneralForm(
	 ...
	 */
	public static TourismNewAccoGeneralForm deleteTourismNewAccoGeneralForm(
			long tourismNewAccoGenFormId)
		throws PortalException {

		return getService().deleteTourismNewAccoGeneralForm(
			tourismNewAccoGenFormId);
	}
	...
	public static TourismNewAccoGeneralForm fetchTourismNewAccoGeneralForm(
		long tourismNewAccoGenFormId) {

		return getService().fetchTourismNewAccoGeneralForm(
			tourismNewAccoGenFormId);
	}
	...
	public static TourismNewAccoGeneralForm getTourismById(
	 ...
	 * @throws PortalException if a tourism new acco general form with the primary key could not be found
	 */
	public static TourismNewAccoGeneralForm getTourismNewAccoGeneralForm(
			long tourismNewAccoGenFormId)
		throws PortalException {

		return getService().getTourismNewAccoGeneralForm(
			tourismNewAccoGenFormId);
	}
	 ...
	 */
	public static List<TourismNewAccoGeneralForm> getTourismNewAccoGeneralForms(
		int start, int end) {

		return getService().getTourismNewAccoGeneralForms(start, end);
	}
	 ...
	 */
	public static int getTourismNewAccoGeneralFormsCount() {
		return getService().getTourismNewAccoGeneralFormsCount();
	}
	 ...
	 */
	public static TourismNewAccoGeneralForm updateTourismNewAccoGeneralForm(
		TourismNewAccoGeneralForm tourismNewAccoGeneralForm) {

		return getService().updateTourismNewAccoGeneralForm(
			tourismNewAccoGeneralForm);
	}

	public static TourismNewAccoGeneralFormLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismNewAccoGeneralFormLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismNewAccoGeneralFormLocalServiceUtil.class,
