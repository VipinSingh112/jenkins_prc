...
/**
 * Provides the local service interface for TourismBonaAttractionFormFirst. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaAttractionFormFirstLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaAttractionFormFirstLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona attraction form first local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaAttractionFormFirstLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismBonaAttractionFormFirst addTourismBonaAttractionFormFirst(
	...
	public TourismBonaAttractionFormFirst createTourismBonaAttractionFormFirst(
	...
	public TourismBonaAttractionFormFirst deleteTourismBonaAttractionFormFirst(
			long tourismBonaAttractFormFirstId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormFirst fetchTourismBonaAttractionFormFirst(
		long tourismBonaAttractFormFirstId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormFirst getTourismBonaAttractionFormFirst(
			long tourismBonaAttractFormFirstId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismBonaAttractionFormFirst>
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormFirst gettourismById(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TourismBonaAttractionFormFirst updateTourismBonaAttractionFormFirst(
		TourismBonaAttractionFormFirst tourismBonaAttractionFormFirst);
