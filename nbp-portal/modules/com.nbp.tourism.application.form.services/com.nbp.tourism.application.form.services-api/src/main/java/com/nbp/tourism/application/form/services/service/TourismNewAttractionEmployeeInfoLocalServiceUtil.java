...
/**
 * Provides the local service utility for TourismNewAttractionEmployeeInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewAttractionEmployeeInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionEmployeeInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static TourismNewAttractionEmployeeInfo
		...
		return getService().createTourismNewAttractionEmployeeInfo(
	...
	public static TourismNewAttractionEmployeeInfo
		...
		return getService().deleteTourismNewAttractionEmployeeInfo(
			tourismNewAttractionEmploId);
	}
	...
	public static TourismNewAttractionEmployeeInfo
		...
		return getService().fetchTourismNewAttractionEmployeeInfo(
			tourismNewAttractionEmploId);
	}
	...
	public static TourismNewAttractionEmployeeInfo getTourismById(
	 ...
	 */
	public static TourismNewAttractionEmployeeInfo
			getTourismNewAttractionEmployeeInfo(
				long tourismNewAttractionEmploId)
		throws PortalException {

		return getService().getTourismNewAttractionEmployeeInfo(
			tourismNewAttractionEmploId);
	}
	 ...
	 */
	public static List<TourismNewAttractionEmployeeInfo>
		getTourismNewAttractionEmployeeInfos(int start, int end) {

		return getService().getTourismNewAttractionEmployeeInfos(start, end);
	}
	 ...
	 */
	public static int getTourismNewAttractionEmployeeInfosCount() {
		return getService().getTourismNewAttractionEmployeeInfosCount();
	}
	...
	public static TourismNewAttractionEmployeeInfo
		...
		return getService().updateTourismNewAttractionEmployeeInfo(
			tourismNewAttractionEmployeeInfo);
	}

	public static TourismNewAttractionEmployeeInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismNewAttractionEmployeeInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismNewAttractionEmployeeInfoLocalServiceUtil.class,
