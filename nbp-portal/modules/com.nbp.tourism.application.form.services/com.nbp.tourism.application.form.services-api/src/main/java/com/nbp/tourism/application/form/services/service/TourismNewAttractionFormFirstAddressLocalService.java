...
/**
 * Provides the local service interface for TourismNewAttractionFormFirstAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismNewAttractionFormFirstAddressLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismNewAttractionFormFirstAddressLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstAddressLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism new attraction form first address local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismNewAttractionFormFirstAddressLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismNewAttractionFormFirstAddress
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismNewAttractionFormFirstAddress getTN_Attract_AT(
		String addressType, long tourismNewAttractFormFirstId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismNewAttractionFormFirstAddress getTourismById(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismNewAttractionFormFirstAddress>
