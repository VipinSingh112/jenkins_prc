...
/**
 * Provides the local service utility for TourismBonaAttractionEmployeeInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismBonaAttractionEmployeeInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionEmployeeInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismBonaAttractionEmployeeInfo
		addTourismBonaAttractionEmployeeInfo(
			TourismBonaAttractionEmployeeInfo
				tourismBonaAttractionEmployeeInfo) {

		return getService().addTourismBonaAttractionEmployeeInfo(
			tourismBonaAttractionEmployeeInfo);
	}
	...
	public static TourismBonaAttractionEmployeeInfo
		...
		return getService().createTourismBonaAttractionEmployeeInfo(
	...
	public static TourismBonaAttractionEmployeeInfo
		...
		return getService().deleteTourismBonaAttractionEmployeeInfo(
			tourismBonaAttrEmpId);
	}
	...
	public static TourismBonaAttractionEmployeeInfo
		...
		return getService().fetchTourismBonaAttractionEmployeeInfo(
			tourismBonaAttrEmpId);
	}
	...
	public static TourismBonaAttractionEmployeeInfo
		...
		return getService().getTourismBonaAttractionEmployeeInfo(
			tourismBonaAttrEmpId);
	}
	 ...
	 */
	public static List<TourismBonaAttractionEmployeeInfo>
		getTourismBonaAttractionEmployeeInfos(int start, int end) {

		return getService().getTourismBonaAttractionEmployeeInfos(start, end);
	}
	 ...
	 */
	public static int getTourismBonaAttractionEmployeeInfosCount() {
		return getService().getTourismBonaAttractionEmployeeInfosCount();
	}

	public static TourismBonaAttractionEmployeeInfo getTourismById(
	...
	public static TourismBonaAttractionEmployeeInfo
		...
		return getService().updateTourismBonaAttractionEmployeeInfo(
			tourismBonaAttractionEmployeeInfo);
	}

	public static TourismBonaAttractionEmployeeInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismBonaAttractionEmployeeInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismBonaAttractionEmployeeInfoLocalServiceUtil.class,
