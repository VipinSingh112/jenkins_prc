...
/**
 * Provides the local service utility for TourismBonaGroundContractTransPaymentInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundContractTransPaymentInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismBonaGroundContractTransPaymentInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaGroundContractTransPaymentInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().addTourismBonaGroundContractTransPaymentInfo(
			tourismBonaGroundContractTransPaymentInfo);
	}
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().createTourismBonaGroundContractTransPaymentInfo(
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().deleteTourismBonaGroundContractTransPaymentInfo(
			tourismBonaGroTransPayId);
	}
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().fetchTourismBonaGroundContractTransPaymentInfo(
			tourismBonaGroTransPayId);
	}
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().getTourismBonaGroundContractTransPaymentInfo(
			tourismBonaGroTransPayId);
	}
	...
	public static List<TourismBonaGroundContractTransPaymentInfo>
		...
		return getService().getTourismBonaGroundContractTransPaymentInfos(
			start, end);
	}
	 ...
	 */
	public static int getTourismBonaGroundContractTransPaymentInfosCount() {
		return getService().
			getTourismBonaGroundContractTransPaymentInfosCount();
	}

	public static TourismBonaGroundContractTransPaymentInfo getTourismById(
	...
	public static TourismBonaGroundContractTransPaymentInfo
		...
		return getService().updateTourismBonaGroundContractTransPaymentInfo(
			tourismBonaGroundContractTransPaymentInfo);
	}

	public static TourismBonaGroundContractTransPaymentInfoLocalService
		getService() {
	...
	private static final Snapshot
		<TourismBonaGroundContractTransPaymentInfoLocalService>
			_serviceSnapshot = new Snapshot<>(
				TourismBonaGroundContractTransPaymentInfoLocalServiceUtil.class,
				TourismBonaGroundContractTransPaymentInfoLocalService.class);
