...
/**
 * The base model interface for the TourismApplicationCurrentStage service. Represents a row in the &quot;nbp_tourism_stage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.tourism.application.form.services.model.impl.TourismApplicationCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.tourism.application.form.services.model.impl.TourismApplicationCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface TourismApplicationCurrentStageModel
	extends BaseModel<TourismApplicationCurrentStage>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a tourism application current stage model instance should use the {@link TourismApplicationCurrentStage} interface instead.
	 */
