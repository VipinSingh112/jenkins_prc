...
/**
 * Provides the local service interface for TourismBonaAttractionFormFirstAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaAttractionFormFirstAddressLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaAttractionFormFirstAddressLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstAddressLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona attraction form first address local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaAttractionFormFirstAddressLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormFirstAddress getTB_Attract_AT(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormFirstAddress getTourismById(
