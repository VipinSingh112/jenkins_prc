...
/**
 * Provides the local service utility for TourismNewAccomodationAssesmentInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAccomodationAssesmentInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewAccomodationAssesmentInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAccomodationAssesmentInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismNewAccomodationAssesmentInfo
		addTourismNewAccomodationAssesmentInfo(
			TourismNewAccomodationAssesmentInfo
				tourismNewAccomodationAssesmentInfo) {

		return getService().addTourismNewAccomodationAssesmentInfo(
			tourismNewAccomodationAssesmentInfo);
	}
	...
	public static TourismNewAccomodationAssesmentInfo
		...
		return getService().createTourismNewAccomodationAssesmentInfo(
	...
	public static TourismNewAccomodationAssesmentInfo
		...
		return getService().deleteTourismNewAccomodationAssesmentInfo(
			tourismNewAccomodationAssesId);
	}
	...
	public static TourismNewAccomodationAssesmentInfo
		...
		return getService().fetchTourismNewAccomodationAssesmentInfo(
			tourismNewAccomodationAssesId);
	}
	...
	public static TourismNewAccomodationAssesmentInfo getTourismById(
	...
	public static TourismNewAccomodationAssesmentInfo
		...
		return getService().getTourismNewAccomodationAssesmentInfo(
			tourismNewAccomodationAssesId);
	}
	...
	public static List<TourismNewAccomodationAssesmentInfo>
		...
		return getService().getTourismNewAccomodationAssesmentInfos(start, end);
	}
	 ...
	 */
	public static int getTourismNewAccomodationAssesmentInfosCount() {
		return getService().getTourismNewAccomodationAssesmentInfosCount();
	}
	...
	public static TourismNewAccomodationAssesmentInfo
		...
		return getService().updateTourismNewAccomodationAssesmentInfo(
			tourismNewAccomodationAssesmentInfo);
	}

	public static TourismNewAccomodationAssesmentInfoLocalService getService() {
		return _service;
	}

	private static volatile TourismNewAccomodationAssesmentInfoLocalService
		_service;
