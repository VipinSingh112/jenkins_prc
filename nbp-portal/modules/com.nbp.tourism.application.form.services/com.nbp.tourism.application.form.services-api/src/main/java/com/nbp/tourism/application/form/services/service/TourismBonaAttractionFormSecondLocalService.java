...
/**
 * Provides the local service interface for TourismBonaAttractionFormSecond. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaAttractionFormSecondLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaAttractionFormSecondLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormSecondLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona attraction form second local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaAttractionFormSecondLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismBonaAttractionFormSecond
		createTourismBonaAttractionFormSecond(long tourismBonaAttractFormSecId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaAttractionFormSecond getTourismById(
