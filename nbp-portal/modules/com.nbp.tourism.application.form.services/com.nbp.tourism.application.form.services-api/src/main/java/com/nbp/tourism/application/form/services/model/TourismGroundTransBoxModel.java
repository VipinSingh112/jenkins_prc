...
/**
 * The base model interface for the TourismGroundTransBox service. Represents a row in the &quot;nbp_tourism_new_ground_box&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.tourism.application.form.services.model.impl.TourismGroundTransBoxModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.tourism.application.form.services.model.impl.TourismGroundTransBoxImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface TourismGroundTransBoxModel
	extends BaseModel<TourismGroundTransBox>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a tourism ground trans box model instance should use the {@link TourismGroundTransBox} interface instead.
	 */
