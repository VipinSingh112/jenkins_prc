...
/**
 * Provides the local service utility for TourismNewAttractionSignInfo. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionSignInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewAttractionSignInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionSignInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismNewAttractionSignInfo addTourismNewAttractionSignInfo(
		TourismNewAttractionSignInfo tourismNewAttractionSignInfo) {

		return getService().addTourismNewAttractionSignInfo(
	 ...
	 */
	public static TourismNewAttractionSignInfo
		createTourismNewAttractionSignInfo(long tourismNewAttraSignInfoId) {

		return getService().createTourismNewAttractionSignInfo(
	 ...
	 */
	public static TourismNewAttractionSignInfo
			deleteTourismNewAttractionSignInfo(long tourismNewAttraSignInfoId)
		throws PortalException {

		return getService().deleteTourismNewAttractionSignInfo(
			tourismNewAttraSignInfoId);
	}
	...
	public static TourismNewAttractionSignInfo
		fetchTourismNewAttractionSignInfo(long tourismNewAttraSignInfoId) {

		return getService().fetchTourismNewAttractionSignInfo(
			tourismNewAttraSignInfoId);
	}
	...
	public static TourismNewAttractionSignInfo getTourismById(
	 ...
	 * @throws PortalException if a tourism new attraction sign info with the primary key could not be found
	 */
	public static TourismNewAttractionSignInfo getTourismNewAttractionSignInfo(
			long tourismNewAttraSignInfoId)
		throws PortalException {

		return getService().getTourismNewAttractionSignInfo(
			tourismNewAttraSignInfoId);
	}
	 ...
	 */
	public static List<TourismNewAttractionSignInfo>
		getTourismNewAttractionSignInfos(int start, int end) {

		return getService().getTourismNewAttractionSignInfos(start, end);
	}
	 ...
	 */
	public static int getTourismNewAttractionSignInfosCount() {
		return getService().getTourismNewAttractionSignInfosCount();
	}
	 ...
	 */
	public static TourismNewAttractionSignInfo
		updateTourismNewAttractionSignInfo(
			TourismNewAttractionSignInfo tourismNewAttractionSignInfo) {

		return getService().updateTourismNewAttractionSignInfo(
			tourismNewAttractionSignInfo);
	}

	public static TourismNewAttractionSignInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismNewAttractionSignInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismNewAttractionSignInfoLocalServiceUtil.class,
