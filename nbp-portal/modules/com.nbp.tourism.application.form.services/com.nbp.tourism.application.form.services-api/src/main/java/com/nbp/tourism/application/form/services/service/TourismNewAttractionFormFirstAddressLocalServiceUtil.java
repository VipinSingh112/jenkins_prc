...
/**
 * Provides the local service utility for TourismNewAttractionFormFirstAddress. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismNewAttractionFormFirstAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAttractionFormFirstAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismNewAttractionFormFirstAddress
		addTourismNewAttractionFormFirstAddress(
			TourismNewAttractionFormFirstAddress
				tourismNewAttractionFormFirstAddress) {

		return getService().addTourismNewAttractionFormFirstAddress(
			tourismNewAttractionFormFirstAddress);
	}
	...
	public static TourismNewAttractionFormFirstAddress
		...
		return getService().createTourismNewAttractionFormFirstAddress(
	...
	public static TourismNewAttractionFormFirstAddress
		...
		return getService().deleteTourismNewAttractionFormFirstAddress(
			tourismNewAttractionFormFAOOId);
	}
	...
	public static TourismNewAttractionFormFirstAddress
		...
		return getService().fetchTourismNewAttractionFormFirstAddress(
			tourismNewAttractionFormFAOOId);
	}
	...
	public static TourismNewAttractionFormFirstAddress getTN_Attract_AT(
		String addressType, long tourismNewAttractFormFirstId) {

		return getService().getTN_Attract_AT(
			addressType, tourismNewAttractFormFirstId);
	}

	public static TourismNewAttractionFormFirstAddress getTourismById(
	...
	public static TourismNewAttractionFormFirstAddress
		...
		return getService().getTourismNewAttractionFormFirstAddress(
			tourismNewAttractionFormFAOOId);
	}
	...
	public static List<TourismNewAttractionFormFirstAddress>
		...
		return getService().getTourismNewAttractionFormFirstAddresses(
			start, end);
	}
	 ...
	 */
	public static int getTourismNewAttractionFormFirstAddressesCount() {
		return getService().getTourismNewAttractionFormFirstAddressesCount();
	}
	...
	public static TourismNewAttractionFormFirstAddress
		...
		return getService().updateTourismNewAttractionFormFirstAddress(
			tourismNewAttractionFormFirstAddress);
	}

	public static TourismNewAttractionFormFirstAddressLocalService
		getService() {
	...
	private static final Snapshot
		<TourismNewAttractionFormFirstAddressLocalService> _serviceSnapshot =
			new Snapshot<>(
				TourismNewAttractionFormFirstAddressLocalServiceUtil.class,
				TourismNewAttractionFormFirstAddressLocalService.class);
