...
/**
 * Provides the local service interface for TourismNewAnnualEarnings. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismNewAnnualEarningsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismNewAnnualEarningsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismNewAnnualEarningsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism new annual earnings local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismNewAnnualEarningsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismNewAnnualEarnings addTourismNewAnnualEarnings(
	...
	public TourismNewAnnualEarnings createTourismNewAnnualEarnings(
	...
	public TourismNewAnnualEarnings deleteTourismNewAnnualEarnings(
			long tourismNewAnnualEarningsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismNewAnnualEarnings fetchTourismNewAnnualEarnings(
		long tourismNewAnnualEarningsId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismNewAnnualEarnings getTourismById(long tourismApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismNewAnnualEarnings getTourismNewAnnualEarnings(
			long tourismNewAnnualEarningsId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismNewAnnualEarnings> getTourismNewAnnualEarningses(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TourismNewAnnualEarnings updateTourismNewAnnualEarnings(
		TourismNewAnnualEarnings tourismNewAnnualEarnings);
