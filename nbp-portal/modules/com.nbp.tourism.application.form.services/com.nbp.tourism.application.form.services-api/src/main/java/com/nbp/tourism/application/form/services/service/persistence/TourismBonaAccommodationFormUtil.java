...
/**
 * The persistence utility for the tourism bona accommodation form service. This utility wraps <code>com.nbp.tourism.application.form.services.service.persistence.impl.TourismBonaAccommodationFormPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TourismBonaAccommodationFormPersistence
 * @generated
 */
public class TourismBonaAccommodationFormUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(tourismBonaAccommodationForm);
	}
	 ...
	 */
	public static Map<Serializable, TourismBonaAccommodationForm>
	 ...
	 */
	public static List<TourismBonaAccommodationForm> findWithDynamicQuery(
	 ...
	 */
	public static TourismBonaAccommodationForm update(
		TourismBonaAccommodationForm tourismBonaAccommodationForm) {

		return getPersistence().update(tourismBonaAccommodationForm);
	}
	...
	public static TourismBonaAccommodationForm update(
		...
		return getPersistence().update(
			tourismBonaAccommodationForm, serviceContext);
	}
	 ...
	 */
	public static TourismBonaAccommodationForm findBygetTourismById(
			long tourismApplicationId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismBonaAccommodationFormException {
	 ...
	 */
	public static TourismBonaAccommodationForm fetchBygetTourismById(
		long tourismApplicationId) {
	 ...
	 */
	public static TourismBonaAccommodationForm removeBygetTourismById(
			long tourismApplicationId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismBonaAccommodationFormException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tourismBonaAccommodationForm);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tourismBonaAccommodationForms);
	}
	 ...
	 */
	public static TourismBonaAccommodationForm create(long tourismBonaAFId) {
		return getPersistence().create(tourismBonaAFId);
	}
	 ...
	 */
	public static TourismBonaAccommodationForm remove(long tourismBonaAFId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismBonaAccommodationFormException {

		return getPersistence().remove(tourismBonaAFId);
	}

	public static TourismBonaAccommodationForm updateImpl(
		TourismBonaAccommodationForm tourismBonaAccommodationForm) {

		return getPersistence().updateImpl(tourismBonaAccommodationForm);
	}
	 ...
	 * @throws NoSuchTourismBonaAccommodationFormException if a tourism bona accommodation form with the primary key could not be found
	 */
	public static TourismBonaAccommodationForm findByPrimaryKey(
			long tourismBonaAFId)
		throws com.nbp.tourism.application.form.services.exception.
			NoSuchTourismBonaAccommodationFormException {

		return getPersistence().findByPrimaryKey(tourismBonaAFId);
	}
	 ...
	 */
	public static TourismBonaAccommodationForm fetchByPrimaryKey(
		long tourismBonaAFId) {

		return getPersistence().fetchByPrimaryKey(tourismBonaAFId);
	}
	 ...
	 */
	public static List<TourismBonaAccommodationForm> findAll() {
	...
	public static TourismBonaAccommodationFormPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		TourismBonaAccommodationFormPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile TourismBonaAccommodationFormPersistence
		_persistence;
