...
/**
 * Provides the local service interface for TourismBonaWaterSportsFormFirst. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TourismBonaWaterSportsFormFirstLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TourismBonaWaterSportsFormFirstLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaWaterSportsFormFirstLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tourism bona water sports form first local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TourismBonaWaterSportsFormFirstLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TourismBonaWaterSportsFormFirst addTourismBonaWaterSportsFormFirst(
	...
	public TourismBonaWaterSportsFormFirst
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaWaterSportsFormFirst fetchTourismBonaWaterSportsFormFirst(
		long tourismBonaWaterSFFirstId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaWaterSportsFormFirst getTourismBonaWaterSportsFormFirst(
			long tourismBonaWaterSFFirstId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TourismBonaWaterSportsFormFirst>
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TourismBonaWaterSportsFormFirst getTourismById(
