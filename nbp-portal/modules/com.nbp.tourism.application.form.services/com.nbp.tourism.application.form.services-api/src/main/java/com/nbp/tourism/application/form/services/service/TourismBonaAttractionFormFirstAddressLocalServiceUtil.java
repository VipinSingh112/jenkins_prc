...
/**
 * Provides the local service utility for TourismBonaAttractionFormFirstAddress. This utility wraps
 * <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismBonaAttractionFormFirstAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.form.services.service.impl.TourismBonaAttractionFormFirstAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().addTourismBonaAttractionFormFirstAddress(
			tourismBonaAttractionFormFirstAddress);
	}
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().createTourismBonaAttractionFormFirstAddress(
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().deleteTourismBonaAttractionFormFirstAddress(
			tourismBonaAttractionFFAOOId);
	}
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().fetchTourismBonaAttractionFormFirstAddress(
			tourismBonaAttractionFFAOOId);
	}
	...
	public static TourismBonaAttractionFormFirstAddress getTB_Attract_AT(
		String addressType, long tourismBonaAttractFormFirstId) {

		return getService().getTB_Attract_AT(
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().getTourismBonaAttractionFormFirstAddress(
			tourismBonaAttractionFFAOOId);
	}
	...
	public static List<TourismBonaAttractionFormFirstAddress>
		...
		return getService().getTourismBonaAttractionFormFirstAddresses(
			start, end);
	}
	 ...
	 */
	public static int getTourismBonaAttractionFormFirstAddressesCount() {
		return getService().getTourismBonaAttractionFormFirstAddressesCount();
	}

	public static TourismBonaAttractionFormFirstAddress getTourismById(
	...
	public static TourismBonaAttractionFormFirstAddress
		...
		return getService().updateTourismBonaAttractionFormFirstAddress(
			tourismBonaAttractionFormFirstAddress);
	}

	public static TourismBonaAttractionFormFirstAddressLocalService
		getService() {
	...
	private static final Snapshot
		<TourismBonaAttractionFormFirstAddressLocalService> _serviceSnapshot =
			new Snapshot<>(
				TourismBonaAttractionFormFirstAddressLocalServiceUtil.class,
