...
try{
	if(osiServiceAppPayment.getPaymentMethod().equals("Bank Draft")){
		paymentMethodBankDraft="active";
	}else if(osiServiceAppPayment.getPaymentMethod().equals("Cheque")){
		paymentMethodBankCheque="active";
	}else if(osiServiceAppPayment.getPaymentMethod().equals("Cash")){
		paymentMethodCash="active";
	}else if(osiServiceAppPayment.getPaymentMethod().equals("Direct Deposit")){
		paymentMethodDirectDeposit="active";
	}else if(osiServiceAppPayment.getPaymentMethod().equals("Other")){
...
try{
	selPaymentMethod = osiServiceAppPayment.getPaymentMethod();
}catch(Exception e){
	
}
%>
<fieldset class="wizard-fieldset" id="osiServicesfeePaymentFieldset" name="APPLICATION FEES PAYMENT">
	<section class="application-Fees">
		...
		<div class="row" id="rm-payment-method">
			<div class="col-md-12">
				<ul class="d-flex">
					<li class="arrowed" id="choose-payment-method"><span>Payment method</span></li>
			...
			<div class="col-md-7">
										...
										<a href="javascript:;" id="credit-card-method">
											<div class="wizard-card-icon">
												<svg width="45" height="29" viewBox="0 0 45 29" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M41.8318 0H2.22744C0.997285 0 0 0.997286 0 2.22744V4.76302H44.0593V2.22744C44.0593 0.997286 43.062 0 41.8318 0Z" fill="#047247"/>
													<path d="M0 26.0995C0 27.3297 0.997285 28.327 2.22744 28.327H41.8318C43.0619 28.327 44.0592 27.3297 44.0592 26.0995V11.2761H0V26.0995ZM18.9315 23.3542H16.1329C15.3334 23.3542 14.6853 22.7061 14.6853 21.9067C14.6853 21.1072 15.3334 20.4591 16.1329 20.4591H18.9315C19.731 20.4591 20.3791 21.1072 20.3791 21.9067C20.3791 22.7061 19.731 23.3542 18.9315 23.3542ZM33.6289 20.4591H38.1647C38.9641 20.4591 39.6122 21.1072 39.6122 21.9067C39.6122 22.7061 38.9641 23.3542 38.1647 23.3542H33.6289C32.8295 23.3542 32.1813 22.7061 32.1813 21.9067C32.1813 21.1072 32.8295 20.4591 33.6289 20.4591ZM29.2576 21.9067C29.2576 22.7061 28.6095 23.3542 27.81 23.3542H25.0114C24.2119 23.3542 23.5638 22.7061 23.5638 21.9067C23.5638 21.1072 24.2119 20.4591 25.0114 20.4591H27.81C28.6095 20.4591 29.2576 21.1072 29.2576 21.9067ZM5.68165 14.9583H27.2988C28.0983 14.9583 28.7464 15.6064 28.7464 16.4059C28.7464 17.2053 28.0983 17.8534 27.2988 17.8534H5.68165C4.8822 17.8534 4.23407 17.2053 4.23407 16.4059C4.23407 15.6064 4.8822 14.9583 5.68165 14.9583ZM5.68165 20.4591H10.2174C11.0168 20.4591 11.665 21.1072 11.665 21.9067C11.665 22.7061 11.0169 23.3542 10.2174 23.3542H5.68165C4.8822 23.3542 4.23407 22.7061 4.23407 21.9067C4.23407 21.1072 4.8822 20.4591 5.68165 20.4591Z" fill="#047247"/>
												</svg>
											</div>
											<div class="wizard-card-content-box">
												<p class="wizard-title f2">Credit Card</p>
												<p class="wizard-info">Pay directly through credit card. Secured by PayGate.</p>
											</div>
										</a>
									</div>
								</li>
										...
										<a href="javascript:;" id="direct-deposit-method">
											<div class="wizard-card-icon">
												<svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M27.5996 15H5.59961C4.99961 15 4.59961 14.6 4.59961 14V2C4.59961 1.4 4.99961 1 5.59961 1H27.5996C28.1996 1 28.5996 1.4 28.5996 2V14C28.5996 14.6 28.1996 15 27.5996 15ZM6.59961 13H26.5996V3H6.59961V13Z" fill="#047247"/>
													<path d="M16.5996 12C14.8996 12 13.5996 10.2 13.5996 8C13.5996 5.8 14.8996 4 16.5996 4C18.2996 4 19.5996 5.8 19.5996 8C19.5996 10.2 18.2996 12 16.5996 12Z" fill="#047247"/>
													<path d="M30.4988 16.5C30.2988 16.2 29.9988 16 29.5988 16C27.3988 16 25.2988 17 23.9988 18.8L23.0988 20C21.9988 21.3 20.2988 22 18.5988 22H15.5988C14.9988 22 14.5988 21.6 14.5988 21C14.5988 20.4 14.9988 20 15.5988 20H17.4988C19.0988 20 20.5988 18.7 20.5988 17.1V17C20.5988 16.5 20.0988 16 19.5988 16H13.4988C9.89883 16 6.99883 17.6 5.39883 20.2L2.69883 24.4C2.49883 24.7 2.49883 25.1 2.69883 25.4L5.69883 30.4C5.79883 30.6 6.09883 30.8 6.29883 30.9C6.39883 30.9 6.39883 30.9 6.49883 30.9C6.69883 30.9 6.89883 30.8 7.09883 30.7C10.8988 28.2 15.2988 26.9 19.7988 26.9C23.0988 26.9 26.0988 25.1 27.6988 22.2L30.3988 17.4C30.5988 17.2 30.5988 16.8 30.4988 16.5Z" fill="#047247"/>
													<path d="M9.59961 2H8.59961H5.59961V5V6V7C8.39961 7 10.5996 4.8 10.5996 2H9.59961Z" fill="#047247"/>
													<path d="M5.59961 10V11V14H8.59961H9.59961H10.5996C10.5996 11.2 8.39961 9 5.59961 9V10Z" fill="#047247"/>
													<path d="M23.5996 14H24.5996H27.5996V11V10V9C24.7996 9 22.5996 11.2 22.5996 14H23.5996Z" fill="#047247"/>
												<path d="M27.5996 6V5V2H24.5996H23.5996H22.5996C22.5996 4.8 24.7996 7 27.5996 7V6Z" fill="#047247"/>
												</svg>
											</div>
											<div class="wizard-card-content-box">
				...
				<div class="credit-card-detail-view-wrapper hide" id="credit-card-details">
					...
					<div class="fee-payment-wrapper mt-2">
						<div class="row">
							<div class="col-md-12">
								<div class="tab-plus-wizard">
									<div class="tab-form">
										<input type="text" class="form-control border-0 mb-3" id="fullName" aria-describedby="" placeholder="Full Name">
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="tab-plus-wizard">
									<div class="tab-form">
										<input type="text" class="form-control border-0 mb-3" id="postalCode" aria-describedby="" placeholder="Postal Code">
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="tab-plus-wizard">
									<div class="tab-form">
										<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="City">
									</div>
								</div>
							</div>
							<div class="col-md-4">
								<div class="tab-plus-wizard">
									<div class="tab-form">
										<input type="text" class="form-control border-0 mb-3" id="country" aria-describedby="" placeholder="Country">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="credit-card-detail-view-wrapper hide" id="all-other-payment-details">
					<div class="fee-payment-wrapper">
						<div class="row">
							<div class="col-md-12">
										...
										<div class="d-flex">
											<span>
												<svg width="99" height="99" viewBox="0 0 99 99" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M83.5312 46.4062H15.4688C13.6125 46.4062 12.375 45.1688 12.375 43.3125V6.1875C12.375 4.33125 13.6125 3.09375 15.4688 3.09375H83.5312C85.3875 3.09375 86.625 4.33125 86.625 6.1875V43.3125C86.625 45.1688 85.3875 46.4062 83.5312 46.4062ZM18.5625 40.2188H80.4375V9.28125H18.5625V40.2188Z" fill="#047247"/>
													<path d="M49.5 37.125C44.2406 37.125 40.2188 31.5562 40.2188 24.75C40.2188 17.9437 44.2406 12.375 49.5 12.375C54.7594 12.375 58.7812 17.9437 58.7812 24.75C58.7812 31.5562 54.7594 37.125 49.5 37.125Z" fill="#047247"/>
													<path d="M92.5035 51.0469C91.8848 50.1187 90.9566 49.5 89.7191 49.5C82.9129 49.5 76.416 52.5937 72.3941 58.1625L69.6098 61.875C66.2066 65.8969 60.9473 68.0625 55.6879 68.0625H46.4066C44.5504 68.0625 43.3129 66.825 43.3129 64.9688C43.3129 63.1125 44.5504 61.875 46.4066 61.875H52.2848C57.2348 61.875 61.8754 57.8531 61.8754 52.9031V52.5938C61.8754 51.0469 60.3285 49.5 58.7816 49.5H39.9098C28.7723 49.5 19.8004 54.45 14.8504 62.4938L6.49727 75.4875C5.87852 76.4156 5.87852 77.6531 6.49727 78.5812L15.7785 94.05C16.0879 94.6687 17.016 95.2875 17.6348 95.5969C17.9441 95.5969 17.9441 95.5969 18.2535 95.5969C18.8723 95.5969 19.491 95.2875 20.1098 94.9781C31.866 87.2438 45.4785 83.2219 59.4004 83.2219C69.6098 83.2219 78.891 77.6531 83.841 68.6813L92.1941 53.8312C92.8129 53.2125 92.8129 51.975 92.5035 51.0469Z" fill="#047247"/>
													<path d="M27.8438 6.1875H24.75H15.4688V15.4688V18.5625V21.6562C24.1312 21.6562 30.9375 14.85 30.9375 6.1875H27.8438Z" fill="#047247"/>
													<path d="M15.4688 30.9375V34.0312V43.3125H24.75H27.8438H30.9375C30.9375 34.65 24.1312 27.8438 15.4688 27.8438V30.9375Z" fill="#047247"/>
													<path d="M71.1562 43.3125H74.25H83.5312V34.0312V30.9375V27.8438C74.8688 27.8438 68.0625 34.65 68.0625 43.3125H71.1562Z" fill="#047247"/>
													<path d="M83.5312 18.5625V15.4688V6.1875H74.25H71.1562H68.0625C68.0625 14.85 74.8688 21.6562 83.5312 21.6562V18.5625Z" fill="#047247"/>
												</svg>
											</span>
											<div class="right-side ml-3">
												<p class="mb-0" id="selected-payment-method"></p>
												<p class="mb-0">Pay with a <span id="selected-payment-method-inner">direct deposit</span> and uploading a proof of payment.</p>
											</div>
										</div>
									</div>
									<div class="right">
										<input type="file" id="osi-payment-upload" onchange="attachDetailed(this.id)" name="<portlet:namespace/>osi-payment-upload" hidden/>
										<label class="btn btn-primary ml-5 transparent-btn" for="osi-payment-upload">Upload</label>
									</div>
								</div>
						     	<div class="supporting-document-card">
						     	<span id="osi-payment-file-chosen" class="attach-detailed-overview"></span>
       <%				
               if(osiServiceApplicationId>0){
                 boolean isFilePresent = false; 
                 FileEntry fileEntryForFee = null;
				if(Validator.isNotNull(feeFileEntry)){
					for (DLFileEntry uploadedFile : feeFileEntry) {
						try {
							fileEntryForFee = DLAppLocalServiceUtil.getFileEntry(uploadedFile.getFileEntryId());
							fileUrl = DLURLHelperUtil.getDownloadURL(fileEntryForFee,
									fileEntryForFee.getFileVersion(), themeDisplay, StringPool.BLANK, false, true);
							isFilePresent = true; 
							%>
						...
						<span id="osi-payment-file-chosen"></span>
					<%}
					%>		
							...
							<div class="col-md-6"> 
	                          	<div class="form-group"> 
	                          		<p class="tab-form-main-heading">Amount Paid</p> 
	                           		...
	                           		value="<%=Validator.isNotNull(osiServiceAppPayment)&&Validator.isNotNull(osiServiceAppPayment.getAmountPaid())?osiServiceAppPayment.getAmountPaid():"" %>" 
	                           		oninput="this.value = this.value.replace(/[^\d.,]+/g, '').replace(/(\..*)\./g, '$1');" placeholder=""> 
	                          	</div> 
	                         </div>
	                         <div class="col-md-6"> 
	                          	<div class="form-group">
	                          	...
	                          	<div class="select-wrapper position-relative">
                                   <select class="form-select form-control" name="currency-status"
								      id="amountCurrency">
								    		...
								    		<option <%=Validator.isNotNull(osiServiceAppPayment)&&Validator.isNotNull(osiServiceAppPayment.getAmountCurrency())&&osiServiceAppPayment.getAmountCurrency().contains("JMD")?"selected":"" %> value="JMD" >JMD</option>
											<option <%=Validator.isNotNull(osiServiceAppPayment)&&Validator.isNotNull(osiServiceAppPayment.getAmountCurrency())&&osiServiceAppPayment.getAmountCurrency().contains("USD")?"selected":"" %> value="USD"  >USD</option>
											<option <%=Validator.isNotNull(osiServiceAppPayment)&&Validator.isNotNull(osiServiceAppPayment.getAmountCurrency())&&osiServiceAppPayment.getAmountCurrency().contains("POUND")?"selected":"" %> value="POUND"  >POUND</option>
											<option <%=Validator.isNotNull(osiServiceAppPayment)&&Validator.isNotNull(osiServiceAppPayment.getAmountCurrency())&&osiServiceAppPayment.getAmountCurrency().contains("EURO")?"selected":"" %> value="EURO"   >EURO</option>
							     </select>
	                          	</div> 
	                          	</div>
	                         </div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="d-flex align-items-center justify-content-between">
								...
								<p class="mb-0">$JMD <span class="groundTransportationVehicleFee">20,000.00</span></p>
							</div>
						</div>
					</div>
					<div class="row">
			...
			<div class="fee-payment-wrapper">
				<div class="row">
					<div class="col-md-7">
						<div class="tab-plus-wizard">
							<div class="tab-form">
								<input type="text" class="form-control border-0 mb-3" id="postalCode" aria-describedby="" placeholder="Entity number">
							</div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="tab-plus-wizard">
							<div class="tab-form">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Receipt Number">
							</div>
						</div>
					</div>
					<div class="col-md-12">
						<div class="tab-plus-wizard">
							<div class="tab-form">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Receipt Number">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="License Number(Optional)">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Category/Tier/Type">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Type of Payment">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Security Bond">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Security Bond">
								<input type="text" class="form-control border-0 mb-3" id="city" aria-describedby="" placeholder="Total">
							</div>
						</div>
					</div>
				</div>
	...
	<%@include file="/osi-services-wizard-buttons.jsp" %>
</fieldset>