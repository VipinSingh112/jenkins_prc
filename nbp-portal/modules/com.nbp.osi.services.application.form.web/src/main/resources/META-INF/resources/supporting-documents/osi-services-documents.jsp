...
<fieldset class="wizard-fieldset" id="osiServicesSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<input type="hidden" id="osiDocumentuploadCounter"
		name="osiDocumentuploadCounter">
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="osiServiceGenericUpload" multiple="multiple"
				name="<portlet:namespace/>osiServiceGenericUpload"
				hidden=""> <label class="custom-upload"
				for="osiServiceGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="osiServiceFileChosen">or drag and drop from your computer</span>
		</div>
		...
		<%
			...
			if (dlFileEntriesGeneric != null) {
				try{
					int genericCounterOfDocuments=50;
				for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
					try {
						...
						fileUrl = DLURLHelperUtil.getDownloadURL(fileEntryForGeneric,
								fileEntryForGeneric.getFileVersion(), themeDisplay, StringPool.BLANK, false, true);
					} catch (Exception e) {
					}
		%>
		<div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=genericCounterOfDocuments%>">
			<div class="row">
				<div class="col-md-12"
					id="uploadedFormResult<%=genericCounterOfDocuments%>">
					<%
					...
					<div class="uploaded-info generic-doc" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
						...
						<div class="right">
							...
							<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=genericCounterOfDocuments%>')">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="osiServicesEnrollDocuments"
												name="<portlet:namespace/>osiServicesEnrollDocuments">
							...
							<input type="hidden" id="osiServicesDocumentuploadCounter"
								name="osiServicesDocumentuploadCounter">
							<div class="col-md-12">
