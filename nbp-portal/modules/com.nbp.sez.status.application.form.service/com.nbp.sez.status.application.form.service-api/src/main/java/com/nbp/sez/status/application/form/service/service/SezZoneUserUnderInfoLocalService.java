...
/**
 * Provides the local service interface for SezZoneUserUnderInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezZoneUserUnderInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezZoneUserUnderInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneUserUnderInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez zone user under info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezZoneUserUnderInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezZoneUserUnderInfo addSezZoneUserUnderInfo(
	...
	public SezZoneUserUnderInfo createSezZoneUserUnderInfo(
	...
	public SezZoneUserUnderInfo deleteSezZoneUserUnderInfo(
			long sezZoneUserUnderInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneUserUnderInfo fetchSezZoneUserUnderInfo(
		long sezZoneUserUnderInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneUserUnderInfo getSezById(long sezStatusApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneUserUnderInfo getSezZoneUserUnderInfo(
			long sezZoneUserUnderInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezZoneUserUnderInfo> getSezZoneUserUnderInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezZoneUserUnderInfo updateSezZoneUserUnderInfo(
		SezZoneUserUnderInfo sezZoneUserUnderInfo);
