...
/**
 * Provides the local service utility for SezDevEmplomentInfo. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevEmplomentInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevEmplomentInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevEmplomentInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevEmplomentInfo addSezDevEmplomentInfo(
		SezDevEmplomentInfo sezDevEmplomentInfo) {

		return getService().addSezDevEmplomentInfo(sezDevEmplomentInfo);
	}
	 ...
	 */
	public static SezDevEmplomentInfo createSezDevEmplomentInfo(
		long sezDevEmplomentInfoId) {

		return getService().createSezDevEmplomentInfo(sezDevEmplomentInfoId);
	}
	 ...
	 */
	public static SezDevEmplomentInfo deleteSezDevEmplomentInfo(
			long sezDevEmplomentInfoId)
		throws PortalException {

		return getService().deleteSezDevEmplomentInfo(sezDevEmplomentInfoId);
	}
	...
	public static SezDevEmplomentInfo deleteSezDevEmplomentInfo(
		...
		return getService().deleteSezDevEmplomentInfo(sezDevEmplomentInfo);
	}
	...
	public static SezDevEmplomentInfo fetchSezDevEmplomentInfo(
		long sezDevEmplomentInfoId) {

		return getService().fetchSezDevEmplomentInfo(sezDevEmplomentInfoId);
	}
	...
	public static SezDevEmplomentInfo getgetSezById(long sezStatusApplicationId)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevEmplomentInfoException {

		return getService().getgetSezById(sezStatusApplicationId);
	}
	 ...
	 * @throws PortalException if a sez dev emploment info with the primary key could not be found
	 */
	public static SezDevEmplomentInfo getSezDevEmplomentInfo(
			long sezDevEmplomentInfoId)
		throws PortalException {

		return getService().getSezDevEmplomentInfo(sezDevEmplomentInfoId);
	}
	 ...
	 */
	public static List<SezDevEmplomentInfo> getSezDevEmplomentInfos(
		int start, int end) {

		return getService().getSezDevEmplomentInfos(start, end);
	}
	 ...
	 */
	public static int getSezDevEmplomentInfosCount() {
		return getService().getSezDevEmplomentInfosCount();
	}
	 ...
	 */
	public static SezDevEmplomentInfo updateSezDevEmplomentInfo(
		SezDevEmplomentInfo sezDevEmplomentInfo) {

		return getService().updateSezDevEmplomentInfo(sezDevEmplomentInfo);
	}

	public static SezDevEmplomentInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevEmplomentInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevEmplomentInfoLocalServiceUtil.class,
			SezDevEmplomentInfoLocalService.class);
