...
/**
 * Provides the local service interface for SezDevInvestmentAndFinancial. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezDevInvestmentAndFinancialLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezDevInvestmentAndFinancialLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevInvestmentAndFinancialLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez dev investment and financial local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezDevInvestmentAndFinancialLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezDevInvestmentAndFinancial addSezDevInvestmentAndFinancial(
	...
	public SezDevInvestmentAndFinancial createSezDevInvestmentAndFinancial(
	...
	public SezDevInvestmentAndFinancial deleteSezDevInvestmentAndFinancial(
			long sezDevInvestmentAndFinancialId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevInvestmentAndFinancial fetchSezDevInvestmentAndFinancial(
		long sezDevInvestmentAndFinancialId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevInvestmentAndFinancial getSezById(long sezStatusApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevInvestmentAndFinancial getSezDevInvestmentAndFinancial(
			long sezDevInvestmentAndFinancialId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezDevInvestmentAndFinancial> getSezDevInvestmentAndFinancials(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezDevInvestmentAndFinancial updateSezDevInvestmentAndFinancial(
		SezDevInvestmentAndFinancial sezDevInvestmentAndFinancial);
