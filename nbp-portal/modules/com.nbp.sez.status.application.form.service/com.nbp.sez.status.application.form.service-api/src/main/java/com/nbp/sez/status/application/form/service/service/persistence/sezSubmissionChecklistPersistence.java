...
/**
 * The persistence interface for the sez submission checklist service.
 *
 * <p>
 ...
 * @see sezSubmissionChecklistUtil
 * @generated
 */
@ProviderType
public interface sezSubmissionChecklistPersistence
	extends BasePersistence<sezSubmissionChecklist> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link sezSubmissionChecklistUtil} to access the sez submission checklist persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<sezSubmissionChecklist> sezSubmissionChecklists);
	 ...
	 */
	public java.util.List<sezSubmissionChecklist> findAll();
	 ...
	 */
	public java.util.List<sezSubmissionChecklist> findAll(int start, int end);
	...
	public java.util.List<sezSubmissionChecklist> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<sezSubmissionChecklist>
			orderByComparator);
