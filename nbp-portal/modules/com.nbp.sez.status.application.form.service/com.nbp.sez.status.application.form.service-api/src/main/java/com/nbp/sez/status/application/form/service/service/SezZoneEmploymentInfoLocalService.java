...
/**
 * Provides the local service interface for SezZoneEmploymentInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezZoneEmploymentInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezZoneEmploymentInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneEmploymentInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez zone employment info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezZoneEmploymentInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezZoneEmploymentInfo addSezZoneEmploymentInfo(
	...
	public SezZoneEmploymentInfo createSezZoneEmploymentInfo(
	...
	public SezZoneEmploymentInfo deleteSezZoneEmploymentInfo(
			long sezZoneEmploymentInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneEmploymentInfo fetchSezZoneEmploymentInfo(
		long sezZoneEmploymentInfoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneEmploymentInfo getSezZoneEmploymentInfo(
			long sezZoneEmploymentInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezZoneEmploymentInfo> getSezZoneEmploymentInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezZoneEmploymentInfo updateSezZoneEmploymentInfo(
		SezZoneEmploymentInfo sezZoneEmploymentInfo);
