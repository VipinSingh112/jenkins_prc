...
/**
 * Provides the local service utility for SezZoneLocationAdd. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneLocationAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezZoneLocationAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneLocationAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezZoneLocationAdd addSezZoneLocationAdd(
		SezZoneLocationAdd sezZoneLocationAdd) {

		return getService().addSezZoneLocationAdd(sezZoneLocationAdd);
	}
	 ...
	 */
	public static SezZoneLocationAdd createSezZoneLocationAdd(
		long sezZoneLocationAddId) {

		return getService().createSezZoneLocationAdd(sezZoneLocationAddId);
	}
	...
	public static void deleteSezStatusByAppId(long sezStatusApplicationId) {
		getService().deleteSezStatusByAppId(sezStatusApplicationId);
	}
	 ...
	 */
	public static SezZoneLocationAdd deleteSezZoneLocationAdd(
			long sezZoneLocationAddId)
		throws PortalException {

		return getService().deleteSezZoneLocationAdd(sezZoneLocationAddId);
	}
	...
	public static SezZoneLocationAdd deleteSezZoneLocationAdd(
		...
		return getService().deleteSezZoneLocationAdd(sezZoneLocationAdd);
	}
	...
	public static SezZoneLocationAdd fetchSezZoneLocationAdd(
		long sezZoneLocationAddId) {

		return getService().fetchSezZoneLocationAdd(sezZoneLocationAddId);
	}
	...
	public static List<SezZoneLocationAdd> getSezById(
	 ...
	 * @throws PortalException if a sez zone location add with the primary key could not be found
	 */
	public static SezZoneLocationAdd getSezZoneLocationAdd(
			long sezZoneLocationAddId)
		throws PortalException {

		return getService().getSezZoneLocationAdd(sezZoneLocationAddId);
	}
	 ...
	 */
	public static List<SezZoneLocationAdd> getSezZoneLocationAdds(
		int start, int end) {

		return getService().getSezZoneLocationAdds(start, end);
	}
	 ...
	 */
	public static int getSezZoneLocationAddsCount() {
		return getService().getSezZoneLocationAddsCount();
	}
	 ...
	 */
	public static SezZoneLocationAdd updateSezZoneLocationAdd(
		SezZoneLocationAdd sezZoneLocationAdd) {

		return getService().updateSezZoneLocationAdd(sezZoneLocationAdd);
	}

	public static SezZoneLocationAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezZoneLocationAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezZoneLocationAddLocalServiceUtil.class,
			SezZoneLocationAddLocalService.class);
