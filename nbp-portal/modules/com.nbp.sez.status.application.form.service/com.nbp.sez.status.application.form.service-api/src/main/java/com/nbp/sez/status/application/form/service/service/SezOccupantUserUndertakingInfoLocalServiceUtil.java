...
/**
 * Provides the local service utility for SezOccupantUserUndertakingInfo. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupantUserUndertakingInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezOccupantUserUndertakingInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupantUserUndertakingInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezOccupantUserUndertakingInfo
		addSezOccupantUserUndertakingInfo(
			SezOccupantUserUndertakingInfo sezOccupantUserUndertakingInfo) {

		return getService().addSezOccupantUserUndertakingInfo(
	 ...
	 */
	public static SezOccupantUserUndertakingInfo
		createSezOccupantUserUndertakingInfo(long sezOccUserunderId) {

		return getService().createSezOccupantUserUndertakingInfo(
			sezOccUserunderId);
	}
	 ...
	 */
	public static SezOccupantUserUndertakingInfo
			deleteSezOccupantUserUndertakingInfo(long sezOccUserunderId)
		throws PortalException {

		return getService().deleteSezOccupantUserUndertakingInfo(
			sezOccUserunderId);
	}
	...
	public static SezOccupantUserUndertakingInfo
		fetchSezOccupantUserUndertakingInfo(long sezOccUserunderId) {

		return getService().fetchSezOccupantUserUndertakingInfo(
			sezOccUserunderId);
	}
	 ...
	 */
	public static SezOccupantUserUndertakingInfo
			getSezOccupantUserUndertakingInfo(long sezOccUserunderId)
		throws PortalException {

		return getService().getSezOccupantUserUndertakingInfo(
			sezOccUserunderId);
	}
	 ...
	 */
	public static List<SezOccupantUserUndertakingInfo>
		getSezOccupantUserUndertakingInfos(int start, int end) {

		return getService().getSezOccupantUserUndertakingInfos(start, end);
	}
	 ...
	 */
	public static int getSezOccupantUserUndertakingInfosCount() {
		return getService().getSezOccupantUserUndertakingInfosCount();
	}

	public static SezOccupantUserUndertakingInfo getSezStatusBy_Id(
	...
	public static SezOccupantUserUndertakingInfo
		...
		return getService().updateSezOccupantUserUndertakingInfo(
			sezOccupantUserUndertakingInfo);
	}

	public static SezOccupantUserUndertakingInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezOccupantUserUndertakingInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezOccupantUserUndertakingInfoLocalServiceUtil.class,
			SezOccupantUserUndertakingInfoLocalService.class);
