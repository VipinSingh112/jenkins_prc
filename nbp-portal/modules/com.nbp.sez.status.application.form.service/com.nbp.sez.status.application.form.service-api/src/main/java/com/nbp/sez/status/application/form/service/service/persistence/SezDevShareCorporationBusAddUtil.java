...
/**
 * The persistence utility for the sez dev share corporation bus add service. This utility wraps <code>com.nbp.sez.status.application.form.service.service.persistence.impl.SezDevShareCorporationBusAddPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SezDevShareCorporationBusAddPersistence
 * @generated
 */
public class SezDevShareCorporationBusAddUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(sezDevShareCorporationBusAdd);
	}
	 ...
	 */
	public static Map<Serializable, SezDevShareCorporationBusAdd>
	 ...
	 */
	public static List<SezDevShareCorporationBusAdd> findWithDynamicQuery(
	 ...
	 */
	public static SezDevShareCorporationBusAdd update(
		SezDevShareCorporationBusAdd sezDevShareCorporationBusAdd) {

		return getPersistence().update(sezDevShareCorporationBusAdd);
	}
	...
	public static SezDevShareCorporationBusAdd update(
		...
		return getPersistence().update(
			sezDevShareCorporationBusAdd, serviceContext);
	}
	 ...
	 */
	public static List<SezDevShareCorporationBusAdd> findBygetSezStatusByAppId(
	 ...
	 */
	public static SezDevShareCorporationBusAdd findBygetSezStatusByAppId_First(
			long sezStatusApplicationId,
			OrderByComparator<SezDevShareCorporationBusAdd> orderByComparator)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevShareCorporationBusAddException {
	 ...
	 */
	public static SezDevShareCorporationBusAdd fetchBygetSezStatusByAppId_First(
		long sezStatusApplicationId,
		OrderByComparator<SezDevShareCorporationBusAdd> orderByComparator) {
	 ...
	 * @throws NoSuchSezDevShareCorporationBusAddException if a matching sez dev share corporation bus add could not be found
	 */
	public static SezDevShareCorporationBusAdd findBygetSezStatusByAppId_Last(
			long sezStatusApplicationId,
			OrderByComparator<SezDevShareCorporationBusAdd> orderByComparator)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevShareCorporationBusAddException {
	 ...
	 */
	public static SezDevShareCorporationBusAdd fetchBygetSezStatusByAppId_Last(
		long sezStatusApplicationId,
		OrderByComparator<SezDevShareCorporationBusAdd> orderByComparator) {
	...
	public static SezDevShareCorporationBusAdd[]
			findBygetSezStatusByAppId_PrevAndNext(
				...
				long sezStatusApplicationId,
				OrderByComparator<SezDevShareCorporationBusAdd>
					orderByComparator)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevShareCorporationBusAddException {

		return getPersistence().findBygetSezStatusByAppId_PrevAndNext(
			sezDevCorporationBusinessAddId, sezStatusApplicationId,
			orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(sezDevShareCorporationBusAdd);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(sezDevShareCorporationBusAdds);
	}
	 ...
	 */
	public static SezDevShareCorporationBusAdd create(
		long sezDevCorporationBusinessAddId) {

		return getPersistence().create(sezDevCorporationBusinessAddId);
	}
	 ...
	 * @throws NoSuchSezDevShareCorporationBusAddException if a sez dev share corporation bus add with the primary key could not be found
	 */
	public static SezDevShareCorporationBusAdd remove(
			long sezDevCorporationBusinessAddId)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevShareCorporationBusAddException {

		return getPersistence().remove(sezDevCorporationBusinessAddId);
	}

	public static SezDevShareCorporationBusAdd updateImpl(
		SezDevShareCorporationBusAdd sezDevShareCorporationBusAdd) {

		return getPersistence().updateImpl(sezDevShareCorporationBusAdd);
	}
	 ...
	 * @throws NoSuchSezDevShareCorporationBusAddException if a sez dev share corporation bus add with the primary key could not be found
	 */
	public static SezDevShareCorporationBusAdd findByPrimaryKey(
			long sezDevCorporationBusinessAddId)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevShareCorporationBusAddException {
	 ...
	 */
	public static SezDevShareCorporationBusAdd fetchByPrimaryKey(
		long sezDevCorporationBusinessAddId) {
	 ...
	 */
	public static List<SezDevShareCorporationBusAdd> findAll() {
	...
	public static SezDevShareCorporationBusAddPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		SezDevShareCorporationBusAddPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile SezDevShareCorporationBusAddPersistence
		_persistence;
