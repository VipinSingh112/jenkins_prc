...
/**
 * Provides the local service interface for SezOccupantPrincipleOfficer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezOccupantPrincipleOfficerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezOccupantPrincipleOfficerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleOfficerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez occupant principle officer local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezOccupantPrincipleOfficerLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccupantPrincipleOfficer> getPrincipleOfficerById(
