...
/**
 * The base model interface for the SezZoneEmploymentInfo service. Represents a row in the &quot;nbp_sez_zone_employment_info&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.sez.status.application.form.service.model.impl.SezZoneEmploymentInfoModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.sez.status.application.form.service.model.impl.SezZoneEmploymentInfoImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface SezZoneEmploymentInfoModel
	extends BaseModel<SezZoneEmploymentInfo>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a sez zone employment info model instance should use the {@link SezZoneEmploymentInfo} interface instead.
	 */
