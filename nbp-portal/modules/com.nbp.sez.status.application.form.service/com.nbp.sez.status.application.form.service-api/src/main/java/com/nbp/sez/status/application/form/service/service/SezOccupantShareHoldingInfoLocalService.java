...
/**
 * Provides the local service interface for SezOccupantShareHoldingInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezOccupantShareHoldingInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezOccupantShareHoldingInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupantShareHoldingInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez occupant share holding info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezOccupantShareHoldingInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezOccupantShareHoldingInfo getSezStatusBy_App_Id(
			long sezApplicationId)
		throws NoSuchSezOccupantShareHoldingInfoException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccupantShareHoldingInfo> getSezStatusBy_Id(
		long sezApplicationId);
