...
/**
 * Provides the local service interface for SezZoneGeneralBusinessInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezZoneGeneralBusinessInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezZoneGeneralBusinessInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneGeneralBusinessInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez zone general business info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezZoneGeneralBusinessInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezZoneGeneralBusinessInfo addSezZoneGeneralBusinessInfo(
	...
	public SezZoneGeneralBusinessInfo createSezZoneGeneralBusinessInfo(
	...
	public SezZoneGeneralBusinessInfo deleteSezZoneGeneralBusinessInfo(
			long sezZoneGeneralBusinessInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneGeneralBusinessInfo fetchSezZoneGeneralBusinessInfo(
		long sezZoneGeneralBusinessInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneGeneralBusinessInfo getSezById(long sezStatusApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneGeneralBusinessInfo getSezZoneGeneralBusinessInfo(
			long sezZoneGeneralBusinessInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezZoneGeneralBusinessInfo> getSezZoneGeneralBusinessInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezZoneGeneralBusinessInfo updateSezZoneGeneralBusinessInfo(
		SezZoneGeneralBusinessInfo sezZoneGeneralBusinessInfo);
