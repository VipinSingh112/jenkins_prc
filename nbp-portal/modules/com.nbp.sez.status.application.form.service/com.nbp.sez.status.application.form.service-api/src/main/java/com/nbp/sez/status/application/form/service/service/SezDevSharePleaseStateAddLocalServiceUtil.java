...
/**
 * Provides the local service utility for SezDevSharePleaseStateAdd. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevSharePleaseStateAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevSharePleaseStateAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevSharePleaseStateAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevSharePleaseStateAdd addSezDevSharePleaseStateAdd(
		SezDevSharePleaseStateAdd sezDevSharePleaseStateAdd) {

		return getService().addSezDevSharePleaseStateAdd(
	 ...
	 */
	public static SezDevSharePleaseStateAdd createSezDevSharePleaseStateAdd(
		long sezDevPleaseStateAddId) {

		return getService().createSezDevSharePleaseStateAdd(
	 ...
	 */
	public static SezDevSharePleaseStateAdd deleteSezDevSharePleaseStateAdd(
			long sezDevPleaseStateAddId)
		throws PortalException {

		return getService().deleteSezDevSharePleaseStateAdd(
			sezDevPleaseStateAddId);
	}
	...
	public static SezDevSharePleaseStateAdd fetchSezDevSharePleaseStateAdd(
		long sezDevPleaseStateAddId) {

		return getService().fetchSezDevSharePleaseStateAdd(
			sezDevPleaseStateAddId);
	}
	...
	public static List<SezDevSharePleaseStateAdd> getSezById(
	 ...
	 * @throws PortalException if a sez dev share please state add with the primary key could not be found
	 */
	public static SezDevSharePleaseStateAdd getSezDevSharePleaseStateAdd(
			long sezDevPleaseStateAddId)
		throws PortalException {

		return getService().getSezDevSharePleaseStateAdd(
			sezDevPleaseStateAddId);
	}
	 ...
	 */
	public static List<SezDevSharePleaseStateAdd> getSezDevSharePleaseStateAdds(
		int start, int end) {

		return getService().getSezDevSharePleaseStateAdds(start, end);
	}
	 ...
	 */
	public static int getSezDevSharePleaseStateAddsCount() {
		return getService().getSezDevSharePleaseStateAddsCount();
	}
	 ...
	 */
	public static SezDevSharePleaseStateAdd updateSezDevSharePleaseStateAdd(
		SezDevSharePleaseStateAdd sezDevSharePleaseStateAdd) {

		return getService().updateSezDevSharePleaseStateAdd(
			sezDevSharePleaseStateAdd);
	}

	public static SezDevSharePleaseStateAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevSharePleaseStateAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevSharePleaseStateAddLocalServiceUtil.class,
