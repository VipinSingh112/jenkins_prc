...
/**
 * Provides the local service interface for SezOccLocationAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezOccLocationAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezOccLocationAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccLocationAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez occ location add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezOccLocationAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezOccLocationAdd addSezOccLocationAdd(
	...
	public SezOccLocationAdd createSezOccLocationAdd(long sezOccLocationAddId);
	...
	public SezOccLocationAdd deleteSezOccLocationAdd(long sezOccLocationAddId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SezOccLocationAdd deleteSezOccLocationAdd(
		SezOccLocationAdd sezOccLocationAdd);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezOccLocationAdd fetchSezOccLocationAdd(long sezOccLocationAddId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccLocationAdd> getSezById(long sezStatusApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezOccLocationAdd getSezOccLocationAdd(long sezOccLocationAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccLocationAdd> getSezOccLocationAdds(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezOccLocationAdd updateSezOccLocationAdd(
		SezOccLocationAdd sezOccLocationAdd);
