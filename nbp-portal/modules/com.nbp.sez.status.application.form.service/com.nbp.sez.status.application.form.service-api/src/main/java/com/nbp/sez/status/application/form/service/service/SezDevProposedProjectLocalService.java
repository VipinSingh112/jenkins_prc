...
/**
 * Provides the local service interface for SezDevProposedProject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezDevProposedProjectLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezDevProposedProjectLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez dev proposed project local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezDevProposedProjectLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezDevProposedProject addSezDevProposedProject(
	...
	public SezDevProposedProject createSezDevProposedProject(
	...
	public SezDevProposedProject deleteSezDevProposedProject(
			long sezDevProposedProjectId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevProposedProject fetchSezDevProposedProject(
		long sezDevProposedProjectId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevProposedProject getSezById(long sezStatusApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevProposedProject getSezDevProposedProject(
			long sezDevProposedProjectId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezDevProposedProject> getSezDevProposedProjects(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezDevProposedProject updateSezDevProposedProject(
		SezDevProposedProject sezDevProposedProject);
