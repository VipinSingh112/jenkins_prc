...
/**
 * Provides the local service utility for SezDevGenBusinessInfoAdd. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevGenBusinessInfoAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevGenBusinessInfoAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevGenBusinessInfoAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevGenBusinessInfoAdd addSezDevGenBusinessInfoAdd(
		SezDevGenBusinessInfoAdd sezDevGenBusinessInfoAdd) {

		return getService().addSezDevGenBusinessInfoAdd(
	 ...
	 */
	public static SezDevGenBusinessInfoAdd createSezDevGenBusinessInfoAdd(
		long sezDevGenBusinessInfoAddId) {

		return getService().createSezDevGenBusinessInfoAdd(
	 ...
	 */
	public static SezDevGenBusinessInfoAdd deleteSezDevGenBusinessInfoAdd(
			long sezDevGenBusinessInfoAddId)
		throws PortalException {

		return getService().deleteSezDevGenBusinessInfoAdd(
			sezDevGenBusinessInfoAddId);
	}
	...
	public static SezDevGenBusinessInfoAdd fetchSezDevGenBusinessInfoAdd(
		long sezDevGenBusinessInfoAddId) {

		return getService().fetchSezDevGenBusinessInfoAdd(
			sezDevGenBusinessInfoAddId);
	}
	...
	public static List<SezDevGenBusinessInfoAdd> getSezById(
	 ...
	 * @throws PortalException if a sez dev gen business info add with the primary key could not be found
	 */
	public static SezDevGenBusinessInfoAdd getSezDevGenBusinessInfoAdd(
			long sezDevGenBusinessInfoAddId)
		throws PortalException {

		return getService().getSezDevGenBusinessInfoAdd(
			sezDevGenBusinessInfoAddId);
	}
	 ...
	 */
	public static List<SezDevGenBusinessInfoAdd> getSezDevGenBusinessInfoAdds(
		int start, int end) {

		return getService().getSezDevGenBusinessInfoAdds(start, end);
	}
	 ...
	 */
	public static int getSezDevGenBusinessInfoAddsCount() {
		return getService().getSezDevGenBusinessInfoAddsCount();
	}
	 ...
	 */
	public static SezDevGenBusinessInfoAdd updateSezDevGenBusinessInfoAdd(
		SezDevGenBusinessInfoAdd sezDevGenBusinessInfoAdd) {

		return getService().updateSezDevGenBusinessInfoAdd(
			sezDevGenBusinessInfoAdd);
	}

	public static SezDevGenBusinessInfoAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevGenBusinessInfoAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevGenBusinessInfoAddLocalServiceUtil.class,
			SezDevGenBusinessInfoAddLocalService.class);
