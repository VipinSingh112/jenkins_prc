...
/**
 * Provides the local service utility for SezDevProposedProject. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevProposedProjectLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevProposedProject addSezDevProposedProject(
		SezDevProposedProject sezDevProposedProject) {

		return getService().addSezDevProposedProject(sezDevProposedProject);
	}
	 ...
	 */
	public static SezDevProposedProject createSezDevProposedProject(
		long sezDevProposedProjectId) {

		return getService().createSezDevProposedProject(
	 ...
	 */
	public static SezDevProposedProject deleteSezDevProposedProject(
			long sezDevProposedProjectId)
		throws PortalException {

		return getService().deleteSezDevProposedProject(
			sezDevProposedProjectId);
	}
	...
	public static SezDevProposedProject deleteSezDevProposedProject(
		...
		return getService().deleteSezDevProposedProject(sezDevProposedProject);
	}
	...
	public static SezDevProposedProject fetchSezDevProposedProject(
		long sezDevProposedProjectId) {

		return getService().fetchSezDevProposedProject(sezDevProposedProjectId);
	}
	...
	public static SezDevProposedProject getSezById(long sezStatusApplicationId)
	 ...
	 * @throws PortalException if a sez dev proposed project with the primary key could not be found
	 */
	public static SezDevProposedProject getSezDevProposedProject(
			long sezDevProposedProjectId)
		throws PortalException {

		return getService().getSezDevProposedProject(sezDevProposedProjectId);
	}
	 ...
	 */
	public static List<SezDevProposedProject> getSezDevProposedProjects(
		int start, int end) {

		return getService().getSezDevProposedProjects(start, end);
	}
	 ...
	 */
	public static int getSezDevProposedProjectsCount() {
		return getService().getSezDevProposedProjectsCount();
	}
	 ...
	 */
	public static SezDevProposedProject updateSezDevProposedProject(
		SezDevProposedProject sezDevProposedProject) {

		return getService().updateSezDevProposedProject(sezDevProposedProject);
	}

	public static SezDevProposedProjectLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevProposedProjectLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevProposedProjectLocalServiceUtil.class,
			SezDevProposedProjectLocalService.class);
