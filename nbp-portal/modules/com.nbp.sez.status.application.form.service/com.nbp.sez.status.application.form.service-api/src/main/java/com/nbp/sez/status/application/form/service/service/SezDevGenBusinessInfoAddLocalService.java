...
/**
 * Provides the local service interface for SezDevGenBusinessInfoAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezDevGenBusinessInfoAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezDevGenBusinessInfoAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevGenBusinessInfoAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez dev gen business info add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezDevGenBusinessInfoAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezDevGenBusinessInfoAdd addSezDevGenBusinessInfoAdd(
	...
	public SezDevGenBusinessInfoAdd createSezDevGenBusinessInfoAdd(
	...
	public SezDevGenBusinessInfoAdd deleteSezDevGenBusinessInfoAdd(
			long sezDevGenBusinessInfoAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevGenBusinessInfoAdd fetchSezDevGenBusinessInfoAdd(
		long sezDevGenBusinessInfoAddId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezDevGenBusinessInfoAdd> getSezById(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevGenBusinessInfoAdd getSezDevGenBusinessInfoAdd(
			long sezDevGenBusinessInfoAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezDevGenBusinessInfoAdd> getSezDevGenBusinessInfoAdds(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezDevGenBusinessInfoAdd updateSezDevGenBusinessInfoAdd(
		SezDevGenBusinessInfoAdd sezDevGenBusinessInfoAdd);
