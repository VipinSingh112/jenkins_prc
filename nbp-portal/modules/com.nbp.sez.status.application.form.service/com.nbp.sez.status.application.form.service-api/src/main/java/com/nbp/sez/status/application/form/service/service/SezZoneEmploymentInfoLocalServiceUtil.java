...
/**
 * Provides the local service utility for SezZoneEmploymentInfo. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneEmploymentInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezZoneEmploymentInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneEmploymentInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezZoneEmploymentInfo addSezZoneEmploymentInfo(
		SezZoneEmploymentInfo sezZoneEmploymentInfo) {

		return getService().addSezZoneEmploymentInfo(sezZoneEmploymentInfo);
	}
	 ...
	 */
	public static SezZoneEmploymentInfo createSezZoneEmploymentInfo(
		long sezZoneEmploymentInfoId) {

		return getService().createSezZoneEmploymentInfo(
	 ...
	 */
	public static SezZoneEmploymentInfo deleteSezZoneEmploymentInfo(
			long sezZoneEmploymentInfoId)
		throws PortalException {

		return getService().deleteSezZoneEmploymentInfo(
			sezZoneEmploymentInfoId);
	}
	...
	public static SezZoneEmploymentInfo deleteSezZoneEmploymentInfo(
		...
		return getService().deleteSezZoneEmploymentInfo(sezZoneEmploymentInfo);
	}
	...
	public static SezZoneEmploymentInfo fetchSezZoneEmploymentInfo(
		long sezZoneEmploymentInfoId) {

		return getService().fetchSezZoneEmploymentInfo(sezZoneEmploymentInfoId);
	}
	 ...
	 * @throws PortalException if a sez zone employment info with the primary key could not be found
	 */
	public static SezZoneEmploymentInfo getSezZoneEmploymentInfo(
			long sezZoneEmploymentInfoId)
		throws PortalException {

		return getService().getSezZoneEmploymentInfo(sezZoneEmploymentInfoId);
	}
	 ...
	 */
	public static List<SezZoneEmploymentInfo> getSezZoneEmploymentInfos(
		int start, int end) {

		return getService().getSezZoneEmploymentInfos(start, end);
	}
	 ...
	 */
	public static int getSezZoneEmploymentInfosCount() {
		return getService().getSezZoneEmploymentInfosCount();
	}
	 ...
	 */
	public static SezZoneEmploymentInfo updateSezZoneEmploymentInfo(
		SezZoneEmploymentInfo sezZoneEmploymentInfo) {

		return getService().updateSezZoneEmploymentInfo(sezZoneEmploymentInfo);
	}

	public static SezZoneEmploymentInfoLocalService getService() {
		return _service;
	}

	private static volatile SezZoneEmploymentInfoLocalService _service;
