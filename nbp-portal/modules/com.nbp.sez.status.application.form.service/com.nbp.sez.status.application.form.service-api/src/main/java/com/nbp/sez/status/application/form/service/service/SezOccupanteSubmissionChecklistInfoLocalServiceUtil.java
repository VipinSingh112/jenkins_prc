...
/**
 * Provides the local service utility for SezOccupanteSubmissionChecklistInfo. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupanteSubmissionChecklistInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezOccupanteSubmissionChecklistInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupanteSubmissionChecklistInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().addSezOccupanteSubmissionChecklistInfo(
			sezOccupanteSubmissionChecklistInfo);
	}
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().createSezOccupanteSubmissionChecklistInfo(
			sezOccCheckSubmitId);
	}
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().deleteSezOccupanteSubmissionChecklistInfo(
			sezOccCheckSubmitId);
	}
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().fetchSezOccupanteSubmissionChecklistInfo(
			sezOccCheckSubmitId);
	}
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().getSezOccupanteSubmissionChecklistInfo(
			sezOccCheckSubmitId);
	}
	...
	public static List<SezOccupanteSubmissionChecklistInfo>
		...
		return getService().getSezOccupanteSubmissionChecklistInfos(start, end);
	}
	 ...
	 */
	public static int getSezOccupanteSubmissionChecklistInfosCount() {
		return getService().getSezOccupanteSubmissionChecklistInfosCount();
	}

	public static SezOccupanteSubmissionChecklistInfo getSezStatusBy_Id(
	...
	public static SezOccupanteSubmissionChecklistInfo
		...
		return getService().updateSezOccupanteSubmissionChecklistInfo(
			sezOccupanteSubmissionChecklistInfo);
	}

	public static SezOccupanteSubmissionChecklistInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot
		<SezOccupanteSubmissionChecklistInfoLocalService> _serviceSnapshot =
			new Snapshot<>(
				SezOccupanteSubmissionChecklistInfoLocalServiceUtil.class,
				SezOccupanteSubmissionChecklistInfoLocalService.class);
