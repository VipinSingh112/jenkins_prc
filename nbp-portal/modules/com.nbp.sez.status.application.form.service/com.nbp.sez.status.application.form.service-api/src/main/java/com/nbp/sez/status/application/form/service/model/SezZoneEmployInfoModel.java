...
/**
 * The base model interface for the SezZoneEmployInfo service. Represents a row in the &quot;nbp_sez_zone_emp_info&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.sez.status.application.form.service.model.impl.SezZoneEmployInfoModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.sez.status.application.form.service.model.impl.SezZoneEmployInfoImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface SezZoneEmployInfoModel
	extends BaseModel<SezZoneEmployInfo>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a sez zone employ info model instance should use the {@link SezZoneEmployInfo} interface instead.
	 */
