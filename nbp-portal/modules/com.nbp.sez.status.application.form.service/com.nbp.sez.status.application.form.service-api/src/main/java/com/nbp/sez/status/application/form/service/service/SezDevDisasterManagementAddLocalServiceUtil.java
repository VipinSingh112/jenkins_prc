...
/**
 * Provides the local service utility for SezDevDisasterManagementAdd. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevDisasterManagementAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevDisasterManagementAdd addSezDevDisasterManagementAdd(
		SezDevDisasterManagementAdd sezDevDisasterManagementAdd) {

		return getService().addSezDevDisasterManagementAdd(
	 ...
	 */
	public static SezDevDisasterManagementAdd createSezDevDisasterManagementAdd(
		long sezDevDisasterManagementAddId) {

		return getService().createSezDevDisasterManagementAdd(
	 ...
	 */
	public static SezDevDisasterManagementAdd deleteSezDevDisasterManagementAdd(
			long sezDevDisasterManagementAddId)
		throws PortalException {

		return getService().deleteSezDevDisasterManagementAdd(
			sezDevDisasterManagementAddId);
	}
	...
	public static SezDevDisasterManagementAdd fetchSezDevDisasterManagementAdd(
		long sezDevDisasterManagementAddId) {

		return getService().fetchSezDevDisasterManagementAdd(
			sezDevDisasterManagementAddId);
	}
	...
	public static List<SezDevDisasterManagementAdd> getSezById(
	 ...
	 * @throws PortalException if a sez dev disaster management add with the primary key could not be found
	 */
	public static SezDevDisasterManagementAdd getSezDevDisasterManagementAdd(
			long sezDevDisasterManagementAddId)
		throws PortalException {

		return getService().getSezDevDisasterManagementAdd(
			sezDevDisasterManagementAddId);
	}
	 ...
	 */
	public static List<SezDevDisasterManagementAdd>
		getSezDevDisasterManagementAdds(int start, int end) {

		return getService().getSezDevDisasterManagementAdds(start, end);
	}
	 ...
	 */
	public static int getSezDevDisasterManagementAddsCount() {
		return getService().getSezDevDisasterManagementAddsCount();
	}
	 ...
	 */
	public static SezDevDisasterManagementAdd updateSezDevDisasterManagementAdd(
		SezDevDisasterManagementAdd sezDevDisasterManagementAdd) {

		return getService().updateSezDevDisasterManagementAdd(
			sezDevDisasterManagementAdd);
	}

	public static SezDevDisasterManagementAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevDisasterManagementAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevDisasterManagementAddLocalServiceUtil.class,
			SezDevDisasterManagementAddLocalService.class);
