...
/**
 * Provides the local service utility for SezDevSharePrincipalAdd. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezDevSharePrincipalAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezDevSharePrincipalAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevSharePrincipalAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezDevSharePrincipalAdd addSezDevSharePrincipalAdd(
		SezDevSharePrincipalAdd sezDevSharePrincipalAdd) {

		return getService().addSezDevSharePrincipalAdd(sezDevSharePrincipalAdd);
	}
	 ...
	 */
	public static SezDevSharePrincipalAdd createSezDevSharePrincipalAdd(
		long sezDevSharePrincipalAddId) {

		return getService().createSezDevSharePrincipalAdd(
	 ...
	 */
	public static SezDevSharePrincipalAdd deleteSezDevSharePrincipalAdd(
			long sezDevSharePrincipalAddId)
		throws PortalException {

		return getService().deleteSezDevSharePrincipalAdd(
			sezDevSharePrincipalAddId);
	}
	...
	public static SezDevSharePrincipalAdd fetchSezDevSharePrincipalAdd(
		long sezDevSharePrincipalAddId) {

		return getService().fetchSezDevSharePrincipalAdd(
			sezDevSharePrincipalAddId);
	}
	...
	public static List<SezDevSharePrincipalAdd> getSezById(
	 ...
	 * @throws PortalException if a sez dev share principal add with the primary key could not be found
	 */
	public static SezDevSharePrincipalAdd getSezDevSharePrincipalAdd(
			long sezDevSharePrincipalAddId)
		throws PortalException {

		return getService().getSezDevSharePrincipalAdd(
			sezDevSharePrincipalAddId);
	}
	 ...
	 */
	public static List<SezDevSharePrincipalAdd> getSezDevSharePrincipalAdds(
		int start, int end) {

		return getService().getSezDevSharePrincipalAdds(start, end);
	}
	 ...
	 */
	public static int getSezDevSharePrincipalAddsCount() {
		return getService().getSezDevSharePrincipalAddsCount();
	}
	 ...
	 */
	public static SezDevSharePrincipalAdd updateSezDevSharePrincipalAdd(
		SezDevSharePrincipalAdd sezDevSharePrincipalAdd) {

		return getService().updateSezDevSharePrincipalAdd(
			sezDevSharePrincipalAdd);
	}

	public static SezDevSharePrincipalAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezDevSharePrincipalAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezDevSharePrincipalAddLocalServiceUtil.class,
