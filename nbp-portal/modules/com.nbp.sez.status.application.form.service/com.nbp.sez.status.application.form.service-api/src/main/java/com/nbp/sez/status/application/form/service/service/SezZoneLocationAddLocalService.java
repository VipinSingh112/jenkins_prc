...
/**
 * Provides the local service interface for SezZoneLocationAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezZoneLocationAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezZoneLocationAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezZoneLocationAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez zone location add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezZoneLocationAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezZoneLocationAdd addSezZoneLocationAdd(
	...
	public SezZoneLocationAdd createSezZoneLocationAdd(
	...
	public SezZoneLocationAdd deleteSezZoneLocationAdd(
			long sezZoneLocationAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneLocationAdd fetchSezZoneLocationAdd(
		long sezZoneLocationAddId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezZoneLocationAdd> getSezById(long sezStatusApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezZoneLocationAdd getSezZoneLocationAdd(long sezZoneLocationAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezZoneLocationAdd> getSezZoneLocationAdds(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezZoneLocationAdd updateSezZoneLocationAdd(
		SezZoneLocationAdd sezZoneLocationAdd);
