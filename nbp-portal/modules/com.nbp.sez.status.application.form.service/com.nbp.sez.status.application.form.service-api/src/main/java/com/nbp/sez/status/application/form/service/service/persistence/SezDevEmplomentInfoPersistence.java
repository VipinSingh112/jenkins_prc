...
/**
 * The persistence interface for the sez dev emploment info service.
 *
 * <p>
 ...
 * @see SezDevEmplomentInfoUtil
 * @generated
 */
@ProviderType
public interface SezDevEmplomentInfoPersistence
	extends BasePersistence<SezDevEmplomentInfo> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SezDevEmplomentInfoUtil} to access the sez dev emploment info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<SezDevEmplomentInfo> sezDevEmplomentInfos);
	 ...
	 */
	public java.util.List<SezDevEmplomentInfo> findAll();
	 ...
	 */
	public java.util.List<SezDevEmplomentInfo> findAll(int start, int end);
	...
	public java.util.List<SezDevEmplomentInfo> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<SezDevEmplomentInfo>
			orderByComparator);
