...
/**
 * Provides the local service interface for SezDevGeneralBusinessIfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezDevGeneralBusinessIfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezDevGeneralBusinessIfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevGeneralBusinessIfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez dev general business ifo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezDevGeneralBusinessIfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevGeneralBusinessIfo getSezById(long sezStatusApplicationId)
