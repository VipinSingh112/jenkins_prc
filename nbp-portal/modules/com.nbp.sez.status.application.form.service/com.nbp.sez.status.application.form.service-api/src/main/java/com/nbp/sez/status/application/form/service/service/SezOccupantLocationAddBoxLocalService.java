...
/**
 * Provides the local service interface for SezOccupantLocationAddBox. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezOccupantLocationAddBoxLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezOccupantLocationAddBoxLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezOccupantLocationAddBoxLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez occupant location add box local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezOccupantLocationAddBoxLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezOccupantLocationAddBox addSezOccupantLocationAddBox(
	...
	public SezOccupantLocationAddBox createSezOccupantLocationAddBox(
	...
	public SezOccupantLocationAddBox deleteSezOccupantLocationAddBox(
			long sezOccLocationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezOccupantLocationAddBox fetchSezOccupantLocationAddBox(
		long sezOccLocationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccupantLocationAddBox> getSezLocationBy_Id(
		long sezStatusAppId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezOccupantLocationAddBox getSezOccupantLocationAddBox(
			long sezOccLocationId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezOccupantLocationAddBox> getSezOccupantLocationAddBoxes(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezOccupantLocationAddBox updateSezOccupantLocationAddBox(
		SezOccupantLocationAddBox sezOccupantLocationAddBox);
