...
/**
 * The persistence utility for the sez dev share principal add service. This utility wraps <code>com.nbp.sez.status.application.form.service.service.persistence.impl.SezDevSharePrincipalAddPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see SezDevSharePrincipalAddPersistence
 * @generated
 */
public class SezDevSharePrincipalAddUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(sezDevSharePrincipalAdd);
	}
	 ...
	 */
	public static Map<Serializable, SezDevSharePrincipalAdd> fetchByPrimaryKeys(
	 ...
	 */
	public static List<SezDevSharePrincipalAdd> findWithDynamicQuery(
	 ...
	 */
	public static SezDevSharePrincipalAdd update(
		SezDevSharePrincipalAdd sezDevSharePrincipalAdd) {

		return getPersistence().update(sezDevSharePrincipalAdd);
	}
	...
	public static SezDevSharePrincipalAdd update(
		...
		return getPersistence().update(sezDevSharePrincipalAdd, serviceContext);
	}
	 ...
	 */
	public static List<SezDevSharePrincipalAdd> findBygetSezStatusByAppId(
	 ...
	 */
	public static SezDevSharePrincipalAdd findBygetSezStatusByAppId_First(
			long sezStatusApplicationId,
			OrderByComparator<SezDevSharePrincipalAdd> orderByComparator)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevSharePrincipalAddException {
	 ...
	 */
	public static SezDevSharePrincipalAdd fetchBygetSezStatusByAppId_First(
		long sezStatusApplicationId,
		OrderByComparator<SezDevSharePrincipalAdd> orderByComparator) {
	 ...
	 * @throws NoSuchSezDevSharePrincipalAddException if a matching sez dev share principal add could not be found
	 */
	public static SezDevSharePrincipalAdd findBygetSezStatusByAppId_Last(
			long sezStatusApplicationId,
			OrderByComparator<SezDevSharePrincipalAdd> orderByComparator)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevSharePrincipalAddException {
	 ...
	 */
	public static SezDevSharePrincipalAdd fetchBygetSezStatusByAppId_Last(
		long sezStatusApplicationId,
		OrderByComparator<SezDevSharePrincipalAdd> orderByComparator) {
	 ...
	 */
	public static SezDevSharePrincipalAdd[]
		...
		return getPersistence().findBygetSezStatusByAppId_PrevAndNext(
			sezDevSharePrincipalAddId, sezStatusApplicationId,
			orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(sezDevSharePrincipalAdd);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(sezDevSharePrincipalAdds);
	}
	 ...
	 */
	public static SezDevSharePrincipalAdd create(
		long sezDevSharePrincipalAddId) {

		return getPersistence().create(sezDevSharePrincipalAddId);
	}
	 ...
	 * @throws NoSuchSezDevSharePrincipalAddException if a sez dev share principal add with the primary key could not be found
	 */
	public static SezDevSharePrincipalAdd remove(long sezDevSharePrincipalAddId)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevSharePrincipalAddException {

		return getPersistence().remove(sezDevSharePrincipalAddId);
	}

	public static SezDevSharePrincipalAdd updateImpl(
		SezDevSharePrincipalAdd sezDevSharePrincipalAdd) {

		return getPersistence().updateImpl(sezDevSharePrincipalAdd);
	}
	 ...
	 * @throws NoSuchSezDevSharePrincipalAddException if a sez dev share principal add with the primary key could not be found
	 */
	public static SezDevSharePrincipalAdd findByPrimaryKey(
			long sezDevSharePrincipalAddId)
		throws com.nbp.sez.status.application.form.service.exception.
			NoSuchSezDevSharePrincipalAddException {

		return getPersistence().findByPrimaryKey(sezDevSharePrincipalAddId);
	}
	 ...
	 */
	public static SezDevSharePrincipalAdd fetchByPrimaryKey(
		long sezDevSharePrincipalAddId) {

		return getPersistence().fetchByPrimaryKey(sezDevSharePrincipalAddId);
	}
	 ...
	 */
	public static List<SezDevSharePrincipalAdd> findAll() {
	 ...
	 */
	public static List<SezDevSharePrincipalAdd> findAll(int start, int end) {
	...
	public static SezDevSharePrincipalAddPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		SezDevSharePrincipalAddPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile SezDevSharePrincipalAddPersistence _persistence;
