...
/**
 * The persistence interface for the sez dev proposed project add service.
 *
 * <p>
 ...
 * @see SezDevProposedProjectAddUtil
 * @generated
 */
@ProviderType
public interface SezDevProposedProjectAddPersistence
	extends BasePersistence<SezDevProposedProjectAdd> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SezDevProposedProjectAddUtil} to access the sez dev proposed project add persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<SezDevProposedProjectAdd> findBygetSezStatusByAppId(
	...
	public java.util.List<SezDevProposedProjectAdd> findBygetSezStatusByAppId(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<SezDevProposedProjectAdd> orderByComparator);
	...
	public void cacheResult(
		java.util.List<SezDevProposedProjectAdd> sezDevProposedProjectAdds);
	 ...
	 */
	public java.util.List<SezDevProposedProjectAdd> findAll();
	 ...
	 */
	public java.util.List<SezDevProposedProjectAdd> findAll(int start, int end);
