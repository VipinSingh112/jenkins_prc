...
/**
 * Provides the local service interface for SezDevEmplomentInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezDevEmplomentInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezDevEmplomentInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezDevEmplomentInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez dev emploment info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezDevEmplomentInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezDevEmplomentInfo addSezDevEmplomentInfo(
	...
	public SezDevEmplomentInfo createSezDevEmplomentInfo(
	...
	public SezDevEmplomentInfo deleteSezDevEmplomentInfo(
			long sezDevEmplomentInfoId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevEmplomentInfo fetchSezDevEmplomentInfo(
		long sezDevEmplomentInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevEmplomentInfo getgetSezById(long sezStatusApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezDevEmplomentInfo getSezDevEmplomentInfo(
			long sezDevEmplomentInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezDevEmplomentInfo> getSezDevEmplomentInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezDevEmplomentInfo updateSezDevEmplomentInfo(
		SezDevEmplomentInfo sezDevEmplomentInfo);
