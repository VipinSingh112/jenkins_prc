...
/**
 * Provides the local service utility for SezStatusWorkFromHome. This utility wraps
 * <code>com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezStatusWorkFromHomeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezStatusWorkFromHome addSezStatusWorkFromHome(
		SezStatusWorkFromHome sezStatusWorkFromHome) {

		return getService().addSezStatusWorkFromHome(sezStatusWorkFromHome);
	}
	 ...
	 */
	public static SezStatusWorkFromHome createSezStatusWorkFromHome(
		long sezStatusWorkFromHomeId) {

		return getService().createSezStatusWorkFromHome(
	 ...
	 */
	public static SezStatusWorkFromHome deleteSezStatusWorkFromHome(
			long sezStatusWorkFromHomeId)
		throws PortalException {

		return getService().deleteSezStatusWorkFromHome(
			sezStatusWorkFromHomeId);
	}
	...
	public static SezStatusWorkFromHome deleteSezStatusWorkFromHome(
		...
		return getService().deleteSezStatusWorkFromHome(sezStatusWorkFromHome);
	}
	...
	public static SezStatusWorkFromHome fetchSezStatusWorkFromHome(
		long sezStatusWorkFromHomeId) {

		return getService().fetchSezStatusWorkFromHome(sezStatusWorkFromHomeId);
	}
	...
	public static SezStatusWorkFromHome getSezById(long sezStatusApplicationId)
	 ...
	 * @throws PortalException if a sez status work from home with the primary key could not be found
	 */
	public static SezStatusWorkFromHome getSezStatusWorkFromHome(
			long sezStatusWorkFromHomeId)
		throws PortalException {

		return getService().getSezStatusWorkFromHome(sezStatusWorkFromHomeId);
	}
	 ...
	 */
	public static List<SezStatusWorkFromHome> getSezStatusWorkFromHomes(
		int start, int end) {

		return getService().getSezStatusWorkFromHomes(start, end);
	}
	 ...
	 */
	public static int getSezStatusWorkFromHomesCount() {
		return getService().getSezStatusWorkFromHomesCount();
	}
	 ...
	 */
	public static SezStatusWorkFromHome updateSezStatusWorkFromHome(
		SezStatusWorkFromHome sezStatusWorkFromHome) {

		return getService().updateSezStatusWorkFromHome(sezStatusWorkFromHome);
	}

	public static SezStatusWorkFromHomeLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezStatusWorkFromHomeLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezStatusWorkFromHomeLocalServiceUtil.class,
