...
import com.nbp.sez.status.application.form.service.service.SezZoneDevUnderInfoService;
...
/**
 * Provides the base implementation for the sez zone dev under info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneDevUnderInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneDevUnderInfoServiceImpl
 * @generated
 */
public abstract class SezZoneDevUnderInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezZoneDevUnderInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneDevUnderInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneDevUnderInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneDevUnderInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneDevUnderInfoService = (SezZoneDevUnderInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneDevUnderInfoService.class.getName();
	}
	...
	protected SezZoneDevUnderInfoService sezZoneDevUnderInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneDevUnderInfoServiceBaseImpl.class);
