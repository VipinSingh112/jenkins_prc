...
import com.nbp.sez.status.application.form.service.service.SezStatusApplicationCurrentStageService;
...
/**
 * Provides the base implementation for the sez status application current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationCurrentStageServiceImpl
 * @generated
 */
public abstract class SezStatusApplicationCurrentStageServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusApplicationCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusApplicationCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusApplicationCurrentStageService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusApplicationCurrentStageService =
			(SezStatusApplicationCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusApplicationCurrentStageService.class.getName();
	}
	...
	protected String getModelClassName() {
		return SezStatusApplicationCurrentStage.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezStatusApplicationCurrentStagePersistence.getDataSource();
	...
	protected SezStatusApplicationCurrentStageService
		sezStatusApplicationCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusApplicationCurrentStageServiceBaseImpl.class);
