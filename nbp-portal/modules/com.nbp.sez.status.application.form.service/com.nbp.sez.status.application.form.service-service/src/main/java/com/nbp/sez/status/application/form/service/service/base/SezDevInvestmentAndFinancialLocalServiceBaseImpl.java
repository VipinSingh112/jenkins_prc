...
import com.nbp.sez.status.application.form.service.service.SezDevInvestmentAndFinancialLocalService;
...
/**
 * Provides the base implementation for the sez dev investment and financial local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevInvestmentAndFinancialLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevInvestmentAndFinancialLocalServiceImpl
 * @generated
 */
public abstract class SezDevInvestmentAndFinancialLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevInvestmentAndFinancialLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevInvestmentAndFinancialLocalServiceUtil</code>.
	 */
	...
	public SezDevInvestmentAndFinancial addSezDevInvestmentAndFinancial(
		...
		return sezDevInvestmentAndFinancialPersistence.update(
	...
	public SezDevInvestmentAndFinancial createSezDevInvestmentAndFinancial(
		...
		return sezDevInvestmentAndFinancialPersistence.create(
	...
	public SezDevInvestmentAndFinancial deleteSezDevInvestmentAndFinancial(
		...
		return sezDevInvestmentAndFinancialPersistence.remove(
			sezDevInvestmentAndFinancialId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevInvestmentAndFinancialPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevInvestmentAndFinancial.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevInvestmentAndFinancialPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevInvestmentAndFinancialPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezDevInvestmentAndFinancial fetchSezDevInvestmentAndFinancial(
		...
		return sezDevInvestmentAndFinancialPersistence.fetchByPrimaryKey(
			sezDevInvestmentAndFinancialId);
	}
	...
	public SezDevInvestmentAndFinancial getSezDevInvestmentAndFinancial(
		...
		return sezDevInvestmentAndFinancialPersistence.findByPrimaryKey(
			sezDevInvestmentAndFinancialId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			SezDevInvestmentAndFinancial.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevInvestmentAndFinancialLocalServiceImpl#deleteSezDevInvestmentAndFinancial(SezDevInvestmentAndFinancial) to avoid orphaned data");
		}

		return sezDevInvestmentAndFinancialLocalService.
			deleteSezDevInvestmentAndFinancial(
				(SezDevInvestmentAndFinancial)persistedModel);
	}

	@Override
	public BasePersistence<SezDevInvestmentAndFinancial> getBasePersistence() {
		return sezDevInvestmentAndFinancialPersistence;
	}
	...
	public List<SezDevInvestmentAndFinancial> getSezDevInvestmentAndFinancials(
		...
		return sezDevInvestmentAndFinancialPersistence.findAll(start, end);
	}
	...
	public int getSezDevInvestmentAndFinancialsCount() {
		return sezDevInvestmentAndFinancialPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevInvestmentAndFinancialLocalService =
			(SezDevInvestmentAndFinancialLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevInvestmentAndFinancialLocalService.class.getName();
	}
	...
	protected SezDevInvestmentAndFinancialLocalService
		sezDevInvestmentAndFinancialLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevInvestmentAndFinancialLocalServiceBaseImpl.class);
