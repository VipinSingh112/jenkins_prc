...
import com.nbp.sez.status.application.form.service.service.SezOccupantEmploymentInfoLocalService;
...
/**
 * Provides the base implementation for the sez occupant employment info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantEmploymentInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantEmploymentInfoLocalServiceImpl
 * @generated
 */
public abstract class SezOccupantEmploymentInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantEmploymentInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantEmploymentInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezOccupantEmploymentInfo addSezOccupantEmploymentInfo(
		SezOccupantEmploymentInfo sezOccupantEmploymentInfo) {

		sezOccupantEmploymentInfo.setNew(true);

		return sezOccupantEmploymentInfoPersistence.update(
	...
	public SezOccupantEmploymentInfo createSezOccupantEmploymentInfo(
		long sezOccEmpId) {

		return sezOccupantEmploymentInfoPersistence.create(sezOccEmpId);
	}
	...
	@Override
	public SezOccupantEmploymentInfo deleteSezOccupantEmploymentInfo(
			long sezOccEmpId)
		throws PortalException {

		return sezOccupantEmploymentInfoPersistence.remove(sezOccEmpId);
	}
	...
	public SezOccupantEmploymentInfo deleteSezOccupantEmploymentInfo(
		...
		return sezOccupantEmploymentInfoPersistence.remove(
			sezOccupantEmploymentInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezOccupantEmploymentInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezOccupantEmploymentInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezOccupantEmploymentInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezOccupantEmploymentInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezOccupantEmploymentInfo fetchSezOccupantEmploymentInfo(
		long sezOccEmpId) {

		return sezOccupantEmploymentInfoPersistence.fetchByPrimaryKey(
			sezOccEmpId);
	}
	 ...
	 */
	@Override
	public SezOccupantEmploymentInfo getSezOccupantEmploymentInfo(
			long sezOccEmpId)
		throws PortalException {

		return sezOccupantEmploymentInfoPersistence.findByPrimaryKey(
			sezOccEmpId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezOccupantEmploymentInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sezOccEmpId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			SezOccupantEmploymentInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezOccupantEmploymentInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezOccupantEmploymentInfoLocalServiceImpl#deleteSezOccupantEmploymentInfo(SezOccupantEmploymentInfo) to avoid orphaned data");
		}

		return sezOccupantEmploymentInfoLocalService.
			deleteSezOccupantEmploymentInfo(
				(SezOccupantEmploymentInfo)persistedModel);
	}

	@Override
	public BasePersistence<SezOccupantEmploymentInfo> getBasePersistence() {
		return sezOccupantEmploymentInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<SezOccupantEmploymentInfo> getSezOccupantEmploymentInfos(
		int start, int end) {

		return sezOccupantEmploymentInfoPersistence.findAll(start, end);
	}
	...
	public int getSezOccupantEmploymentInfosCount() {
		return sezOccupantEmploymentInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezOccupantEmploymentInfo updateSezOccupantEmploymentInfo(
		SezOccupantEmploymentInfo sezOccupantEmploymentInfo) {
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantEmploymentInfoLocalService =
			(SezOccupantEmploymentInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantEmploymentInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantEmploymentInfoPersistence.getDataSource();
	...
	protected SezOccupantEmploymentInfoLocalService
		sezOccupantEmploymentInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantEmploymentInfoLocalServiceBaseImpl.class);
