...
import com.nbp.sez.status.application.form.service.service.SezDevGeneralBusinessIfoLocalService;
...
/**
 * Provides the base implementation for the sez dev general business ifo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevGeneralBusinessIfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevGeneralBusinessIfoLocalServiceImpl
 * @generated
 */
public abstract class SezDevGeneralBusinessIfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SezDevGeneralBusinessIfoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevGeneralBusinessIfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevGeneralBusinessIfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezDevGeneralBusinessIfo addSezDevGeneralBusinessIfo(
		SezDevGeneralBusinessIfo sezDevGeneralBusinessIfo) {

		sezDevGeneralBusinessIfo.setNew(true);

		return sezDevGeneralBusinessIfoPersistence.update(
	...
	public SezDevGeneralBusinessIfo createSezDevGeneralBusinessIfo(
		long sezDevGeneralBusinessIfoId) {

		return sezDevGeneralBusinessIfoPersistence.create(
	...
	@Override
	public SezDevGeneralBusinessIfo deleteSezDevGeneralBusinessIfo(
			long sezDevGeneralBusinessIfoId)
		throws PortalException {

		return sezDevGeneralBusinessIfoPersistence.remove(
			sezDevGeneralBusinessIfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevGeneralBusinessIfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevGeneralBusinessIfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevGeneralBusinessIfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevGeneralBusinessIfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezDevGeneralBusinessIfo fetchSezDevGeneralBusinessIfo(
		long sezDevGeneralBusinessIfoId) {

		return sezDevGeneralBusinessIfoPersistence.fetchByPrimaryKey(
			sezDevGeneralBusinessIfoId);
	}
	 ...
	 */
	@Override
	public SezDevGeneralBusinessIfo getSezDevGeneralBusinessIfo(
			long sezDevGeneralBusinessIfoId)
		throws PortalException {

		return sezDevGeneralBusinessIfoPersistence.findByPrimaryKey(
			sezDevGeneralBusinessIfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDevGeneralBusinessIfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			SezDevGeneralBusinessIfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevGeneralBusinessIfoLocalServiceImpl#deleteSezDevGeneralBusinessIfo(SezDevGeneralBusinessIfo) to avoid orphaned data");
		}

		return sezDevGeneralBusinessIfoLocalService.
			deleteSezDevGeneralBusinessIfo(
				(SezDevGeneralBusinessIfo)persistedModel);
	}

	@Override
	public BasePersistence<SezDevGeneralBusinessIfo> getBasePersistence() {
		return sezDevGeneralBusinessIfoPersistence;
	}
	 ...
	 */
	@Override
	public List<SezDevGeneralBusinessIfo> getSezDevGeneralBusinessIfos(
		int start, int end) {

		return sezDevGeneralBusinessIfoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSezDevGeneralBusinessIfosCount() {
		return sezDevGeneralBusinessIfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezDevGeneralBusinessIfo updateSezDevGeneralBusinessIfo(
		SezDevGeneralBusinessIfo sezDevGeneralBusinessIfo) {
	...
	public void setAopProxy(Object aopProxy) {
		sezDevGeneralBusinessIfoLocalService =
			(SezDevGeneralBusinessIfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevGeneralBusinessIfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevGeneralBusinessIfoPersistence.getDataSource();
	...
	protected SezDevGeneralBusinessIfoLocalService
		sezDevGeneralBusinessIfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevGeneralBusinessIfoLocalServiceBaseImpl.class);
