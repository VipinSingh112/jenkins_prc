...
import com.nbp.sez.status.application.form.service.service.SezOccupantUserUndertakingInfoService;
...
/**
 * Provides the base implementation for the sez occupant user undertaking info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantUserUndertakingInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantUserUndertakingInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantUserUndertakingInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantUserUndertakingInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantUserUndertakingInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantUserUndertakingInfoService =
			(SezOccupantUserUndertakingInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantUserUndertakingInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantUserUndertakingInfoPersistence.getDataSource();
	...
	protected SezOccupantUserUndertakingInfoService
		sezOccupantUserUndertakingInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantUserUndertakingInfoServiceBaseImpl.class);
