...
import com.nbp.sez.status.application.form.service.service.SezDevProposedProjectService;
...
/**
 * Provides the base implementation for the sez dev proposed project remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectServiceImpl
 * @generated
 */
public abstract class SezDevProposedProjectServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevProposedProjectService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevProposedProjectServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevProposedProjectService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezDevProposedProjectService = (SezDevProposedProjectService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevProposedProjectService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevProposedProjectPersistence.getDataSource();
	...
	protected SezDevProposedProjectService sezDevProposedProjectService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevProposedProjectServiceBaseImpl.class);
