...
import com.nbp.sez.status.application.form.service.service.SezOccupantInvestAndFinanceInfoService;
...
/**
 * Provides the base implementation for the sez occupant invest and finance info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantInvestAndFinanceInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantInvestAndFinanceInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantInvestAndFinanceInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantInvestAndFinanceInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantInvestAndFinanceInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantInvestAndFinanceInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantInvestAndFinanceInfoService =
			(SezOccupantInvestAndFinanceInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantInvestAndFinanceInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantInvestAndFinanceInfoPersistence.getDataSource();
	...
	protected SezOccupantInvestAndFinanceInfoService
		sezOccupantInvestAndFinanceInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantInvestAndFinanceInfoServiceBaseImpl.class);
