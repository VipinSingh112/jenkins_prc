...
import com.nbp.sez.status.application.form.service.service.SezStatusAppPaymentService;
...
/**
 * Provides the base implementation for the sez status app payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusAppPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusAppPaymentServiceImpl
 * @generated
 */
public abstract class SezStatusAppPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezStatusAppPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusAppPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusAppPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusAppPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezStatusAppPaymentService = (SezStatusAppPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusAppPaymentService.class.getName();
	}
	...
	protected SezStatusAppPaymentService sezStatusAppPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusAppPaymentServiceBaseImpl.class);
