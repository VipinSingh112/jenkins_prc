...
import com.nbp.sez.status.application.form.service.service.SezOccupantShareHoldingInfoService;
...
/**
 * Provides the base implementation for the sez occupant share holding info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantShareHoldingInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantShareHoldingInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantShareHoldingInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantShareHoldingInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantShareHoldingInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantShareHoldingInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantShareHoldingInfoService =
			(SezOccupantShareHoldingInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantShareHoldingInfoService.class.getName();
	}
	...
	protected SezOccupantShareHoldingInfoService
		sezOccupantShareHoldingInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantShareHoldingInfoServiceBaseImpl.class);
