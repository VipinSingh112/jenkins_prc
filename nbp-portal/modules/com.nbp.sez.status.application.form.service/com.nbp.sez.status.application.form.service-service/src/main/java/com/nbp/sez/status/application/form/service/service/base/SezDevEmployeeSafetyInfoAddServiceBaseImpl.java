...
import com.nbp.sez.status.application.form.service.service.SezDevEmployeeSafetyInfoAddService;
...
/**
 * Provides the base implementation for the sez dev employee safety info add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeSafetyInfoAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeSafetyInfoAddServiceImpl
 * @generated
 */
public abstract class SezDevEmployeeSafetyInfoAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevEmployeeSafetyInfoAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevEmployeeSafetyInfoAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezDevEmployeeSafetyInfoAddService =
			(SezDevEmployeeSafetyInfoAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevEmployeeSafetyInfoAddService.class.getName();
	}
	...
	protected SezDevEmployeeSafetyInfoAddService
		sezDevEmployeeSafetyInfoAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevEmployeeSafetyInfoAddServiceBaseImpl.class);
