...
import com.nbp.sez.status.application.form.service.service.SezDevPropDevelopmentPlanLocalService;
...
/**
 * Provides the base implementation for the sez dev prop development plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevPropDevelopmentPlanLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevPropDevelopmentPlanLocalServiceImpl
 * @generated
 */
public abstract class SezDevPropDevelopmentPlanLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevPropDevelopmentPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevPropDevelopmentPlanLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezDevPropDevelopmentPlan addSezDevPropDevelopmentPlan(
		SezDevPropDevelopmentPlan sezDevPropDevelopmentPlan) {

		sezDevPropDevelopmentPlan.setNew(true);

		return sezDevPropDevelopmentPlanPersistence.update(
	...
	public SezDevPropDevelopmentPlan createSezDevPropDevelopmentPlan(
		long sezDevPropDevelopmentPlanId) {

		return sezDevPropDevelopmentPlanPersistence.create(
	...
	@Override
	public SezDevPropDevelopmentPlan deleteSezDevPropDevelopmentPlan(
			long sezDevPropDevelopmentPlanId)
		throws PortalException {

		return sezDevPropDevelopmentPlanPersistence.remove(
			sezDevPropDevelopmentPlanId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevPropDevelopmentPlanPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevPropDevelopmentPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevPropDevelopmentPlanPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevPropDevelopmentPlanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezDevPropDevelopmentPlan fetchSezDevPropDevelopmentPlan(
		long sezDevPropDevelopmentPlanId) {

		return sezDevPropDevelopmentPlanPersistence.fetchByPrimaryKey(
			sezDevPropDevelopmentPlanId);
	}
	 ...
	 */
	@Override
	public SezDevPropDevelopmentPlan getSezDevPropDevelopmentPlan(
			long sezDevPropDevelopmentPlanId)
		throws PortalException {

		return sezDevPropDevelopmentPlanPersistence.findByPrimaryKey(
			sezDevPropDevelopmentPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDevPropDevelopmentPlan.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			SezDevPropDevelopmentPlan.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevPropDevelopmentPlanLocalServiceImpl#deleteSezDevPropDevelopmentPlan(SezDevPropDevelopmentPlan) to avoid orphaned data");
		}

		return sezDevPropDevelopmentPlanLocalService.
			deleteSezDevPropDevelopmentPlan(
				(SezDevPropDevelopmentPlan)persistedModel);
	}

	@Override
	public BasePersistence<SezDevPropDevelopmentPlan> getBasePersistence() {
		return sezDevPropDevelopmentPlanPersistence;
	}
	 ...
	 */
	@Override
	public List<SezDevPropDevelopmentPlan> getSezDevPropDevelopmentPlans(
		int start, int end) {

		return sezDevPropDevelopmentPlanPersistence.findAll(start, end);
	}
	...
	public int getSezDevPropDevelopmentPlansCount() {
		return sezDevPropDevelopmentPlanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezDevPropDevelopmentPlan updateSezDevPropDevelopmentPlan(
		SezDevPropDevelopmentPlan sezDevPropDevelopmentPlan) {
	...
	public void setAopProxy(Object aopProxy) {
		sezDevPropDevelopmentPlanLocalService =
			(SezDevPropDevelopmentPlanLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevPropDevelopmentPlanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevPropDevelopmentPlanPersistence.getDataSource();
	...
	protected SezDevPropDevelopmentPlanLocalService
		sezDevPropDevelopmentPlanLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevPropDevelopmentPlanLocalServiceBaseImpl.class);
