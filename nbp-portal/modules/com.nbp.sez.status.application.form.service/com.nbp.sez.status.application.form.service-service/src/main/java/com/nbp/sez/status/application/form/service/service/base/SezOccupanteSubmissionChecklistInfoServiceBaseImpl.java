...
import com.nbp.sez.status.application.form.service.service.SezOccupanteSubmissionChecklistInfoService;
...
/**
 * Provides the base implementation for the sez occupante submission checklist info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupanteSubmissionChecklistInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupanteSubmissionChecklistInfoServiceImpl
 * @generated
 */
public abstract class SezOccupanteSubmissionChecklistInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupanteSubmissionChecklistInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupanteSubmissionChecklistInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupanteSubmissionChecklistInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupanteSubmissionChecklistInfoService =
			(SezOccupanteSubmissionChecklistInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupanteSubmissionChecklistInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupanteSubmissionChecklistInfoPersistence.getDataSource();
	...
	protected SezOccupanteSubmissionChecklistInfoService
		sezOccupanteSubmissionChecklistInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupanteSubmissionChecklistInfoServiceBaseImpl.class);
