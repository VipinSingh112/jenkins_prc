...
import com.nbp.sez.status.application.form.service.service.SezZoneFinancialInfoLocalService;
...
/**
 * Provides the base implementation for the sez zone financial info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneFinancialInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneFinancialInfoLocalServiceImpl
 * @generated
 */
public abstract class SezZoneFinancialInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneFinancialInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneFinancialInfoLocalServiceUtil</code>.
	 */
	...
	public SezZoneFinancialInfo addSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.update(sezZoneFinancialInfo);
	}
	...
	public SezZoneFinancialInfo createSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.create(sezZoneFinancialnfoId);
	}
	...
	public SezZoneFinancialInfo deleteSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.remove(sezZoneFinancialnfoId);
	}
	...
	public SezZoneFinancialInfo deleteSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.remove(sezZoneFinancialInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezZoneFinancialInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezZoneFinancialInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezZoneFinancialInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezZoneFinancialInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezZoneFinancialInfo fetchSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.fetchByPrimaryKey(
	...
	public SezZoneFinancialInfo getSezZoneFinancialInfo(
		...
		return sezZoneFinancialInfoPersistence.findByPrimaryKey(
			sezZoneFinancialnfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezZoneFinancialInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezZoneFinancialInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezZoneFinancialInfoLocalServiceImpl#deleteSezZoneFinancialInfo(SezZoneFinancialInfo) to avoid orphaned data");
		}

		return sezZoneFinancialInfoLocalService.deleteSezZoneFinancialInfo(
			(SezZoneFinancialInfo)persistedModel);
	}

	@Override
	public BasePersistence<SezZoneFinancialInfo> getBasePersistence() {
		return sezZoneFinancialInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sezZoneFinancialInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SezZoneFinancialInfo> getSezZoneFinancialInfos(
		...
		return sezZoneFinancialInfoPersistence.findAll(start, end);
	}
	...
	public int getSezZoneFinancialInfosCount() {
		return sezZoneFinancialInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezZoneFinancialInfoLocalService =
			(SezZoneFinancialInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneFinancialInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneFinancialInfoPersistence.getDataSource();
	...
	protected SezZoneFinancialInfoLocalService sezZoneFinancialInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneFinancialInfoLocalServiceBaseImpl.class);
