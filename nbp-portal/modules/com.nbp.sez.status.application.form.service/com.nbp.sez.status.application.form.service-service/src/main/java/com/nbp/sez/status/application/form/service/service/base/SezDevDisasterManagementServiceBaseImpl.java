...
import com.nbp.sez.status.application.form.service.service.SezDevDisasterManagementService;
...
/**
 * Provides the base implementation for the sez dev disaster management remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementServiceImpl
 * @generated
 */
public abstract class SezDevDisasterManagementServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevDisasterManagementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevDisasterManagementServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevDisasterManagementService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevDisasterManagementService =
			(SezDevDisasterManagementService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevDisasterManagementService.class.getName();
	}
	...
	protected SezDevDisasterManagementService sezDevDisasterManagementService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevDisasterManagementServiceBaseImpl.class);
