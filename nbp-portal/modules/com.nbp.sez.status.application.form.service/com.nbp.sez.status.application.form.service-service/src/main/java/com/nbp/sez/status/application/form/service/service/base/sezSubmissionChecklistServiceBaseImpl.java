...
import com.nbp.sez.status.application.form.service.service.sezSubmissionChecklistService;
...
/**
 * Provides the base implementation for the sez submission checklist remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.sezSubmissionChecklistServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.sezSubmissionChecklistServiceImpl
 * @generated
 */
public abstract class sezSubmissionChecklistServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>sezSubmissionChecklistService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.sezSubmissionChecklistServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			sezSubmissionChecklistService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezSubmissionChecklistService = (sezSubmissionChecklistService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return sezSubmissionChecklistService.class.getName();
	}
	...
	protected sezSubmissionChecklistService sezSubmissionChecklistService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		sezSubmissionChecklistServiceBaseImpl.class);
