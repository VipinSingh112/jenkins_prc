...
import com.nbp.sez.status.application.form.service.service.SezOccupantGeneralBussinessAddressService;
...
/**
 * Provides the base implementation for the sez occupant general bussiness address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantGeneralBussinessAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantGeneralBussinessAddressServiceImpl
 * @generated
 */
public abstract class SezOccupantGeneralBussinessAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantGeneralBussinessAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantGeneralBussinessAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantGeneralBussinessAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantGeneralBussinessAddressService =
			(SezOccupantGeneralBussinessAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantGeneralBussinessAddressService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantGeneralBussinessAddressPersistence.getDataSource();
	...
	protected SezOccupantGeneralBussinessAddressService
		sezOccupantGeneralBussinessAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantGeneralBussinessAddressServiceBaseImpl.class);
