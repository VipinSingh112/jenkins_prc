...
import com.nbp.sez.status.application.form.service.service.SezDevShareDirectorAddService;
...
/**
 * Provides the base implementation for the sez dev share director add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareDirectorAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareDirectorAddServiceImpl
 * @generated
 */
public abstract class SezDevShareDirectorAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareDirectorAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareDirectorAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevShareDirectorAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezDevShareDirectorAddService = (SezDevShareDirectorAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareDirectorAddService.class.getName();
	}
	...
	protected SezDevShareDirectorAddService sezDevShareDirectorAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareDirectorAddServiceBaseImpl.class);
