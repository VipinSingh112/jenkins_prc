...
import com.nbp.sez.status.application.form.service.service.SezOccupanteDeveloperUndertakingInfoService;
...
/**
 * Provides the base implementation for the sez occupante developer undertaking info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupanteDeveloperUndertakingInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupanteDeveloperUndertakingInfoServiceImpl
 * @generated
 */
public abstract class SezOccupanteDeveloperUndertakingInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SezOccupanteDeveloperUndertakingInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupanteDeveloperUndertakingInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupanteDeveloperUndertakingInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupanteDeveloperUndertakingInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupanteDeveloperUndertakingInfoService =
			(SezOccupanteDeveloperUndertakingInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupanteDeveloperUndertakingInfoService.class.getName();
	}
	...
	protected SezOccupanteDeveloperUndertakingInfoService
		sezOccupanteDeveloperUndertakingInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupanteDeveloperUndertakingInfoServiceBaseImpl.class);
