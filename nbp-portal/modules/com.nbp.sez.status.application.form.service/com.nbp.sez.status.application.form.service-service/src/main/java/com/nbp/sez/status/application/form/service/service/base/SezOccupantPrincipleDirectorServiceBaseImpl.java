...
import com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleDirectorService;
...
/**
 * Provides the base implementation for the sez occupant principle director remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleDirectorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleDirectorServiceImpl
 * @generated
 */
public abstract class SezOccupantPrincipleDirectorServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantPrincipleDirectorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleDirectorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantPrincipleDirectorService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantPrincipleDirectorService =
			(SezOccupantPrincipleDirectorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantPrincipleDirectorService.class.getName();
	}
	...
	protected SezOccupantPrincipleDirectorService
		sezOccupantPrincipleDirectorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantPrincipleDirectorServiceBaseImpl.class);
