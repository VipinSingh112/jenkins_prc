...
import com.nbp.sez.status.application.form.service.service.SezOccupantProposedAreaDevelopmentPlanInfoService;
...
/**
 * Provides the base implementation for the sez occupant proposed area development plan info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantProposedAreaDevelopmentPlanInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantProposedAreaDevelopmentPlanInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantProposedAreaDevelopmentPlanInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantProposedAreaDevelopmentPlanInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantProposedAreaDevelopmentPlanInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantProposedAreaDevelopmentPlanInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantProposedAreaDevelopmentPlanInfoService =
			(SezOccupantProposedAreaDevelopmentPlanInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantProposedAreaDevelopmentPlanInfoService.class.
			getName();
	}
	...
	protected SezOccupantProposedAreaDevelopmentPlanInfoService
		sezOccupantProposedAreaDevelopmentPlanInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantProposedAreaDevelopmentPlanInfoServiceBaseImpl.class);
