...
import com.nbp.sez.status.application.form.service.service.SezStatusApplicationLocalService;
...
/**
 * Provides the base implementation for the sez status application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationLocalServiceImpl
 * @generated
 */
public abstract class SezStatusApplicationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusApplicationLocalServiceUtil</code>.
	 */
	...
	public SezStatusApplication addSezStatusApplication(
		...
		return sezStatusApplicationPersistence.update(sezStatusApplication);
	}
	...
	public SezStatusApplication createSezStatusApplication(
		...
		return sezStatusApplicationPersistence.create(sezStatusApplicationId);
	}
	...
	public SezStatusApplication deleteSezStatusApplication(
		...
		return sezStatusApplicationPersistence.remove(sezStatusApplicationId);
	}
	...
	public SezStatusApplication deleteSezStatusApplication(
		...
		return sezStatusApplicationPersistence.remove(sezStatusApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezStatusApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezStatusApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezStatusApplicationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezStatusApplicationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezStatusApplication fetchSezStatusApplication(
		...
		return sezStatusApplicationPersistence.fetchByPrimaryKey(
	...
	public SezStatusApplication getSezStatusApplication(
		...
		return sezStatusApplicationPersistence.findByPrimaryKey(
			sezStatusApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezStatusApplication.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezStatusApplicationLocalServiceImpl#deleteSezStatusApplication(SezStatusApplication) to avoid orphaned data");
		}

		return sezStatusApplicationLocalService.deleteSezStatusApplication(
			(SezStatusApplication)persistedModel);
	}

	@Override
	public BasePersistence<SezStatusApplication> getBasePersistence() {
		return sezStatusApplicationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusApplicationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SezStatusApplication> getSezStatusApplications(
		...
		return sezStatusApplicationPersistence.findAll(start, end);
	}
	...
	public int getSezStatusApplicationsCount() {
		return sezStatusApplicationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusApplicationLocalService =
			(SezStatusApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezStatusApplicationPersistence.getDataSource();
	...
	protected SezStatusApplicationLocalService sezStatusApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusApplicationLocalServiceBaseImpl.class);
