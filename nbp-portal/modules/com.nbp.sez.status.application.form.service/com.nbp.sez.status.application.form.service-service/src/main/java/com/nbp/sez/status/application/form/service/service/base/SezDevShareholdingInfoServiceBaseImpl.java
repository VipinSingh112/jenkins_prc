...
import com.nbp.sez.status.application.form.service.service.SezDevShareholdingInfoService;
...
/**
 * Provides the base implementation for the sez dev shareholding info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareholdingInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareholdingInfoServiceImpl
 * @generated
 */
public abstract class SezDevShareholdingInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareholdingInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareholdingInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevShareholdingInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezDevShareholdingInfoService = (SezDevShareholdingInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareholdingInfoService.class.getName();
	}
	...
	protected SezDevShareholdingInfoService sezDevShareholdingInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareholdingInfoServiceBaseImpl.class);
