...
import com.nbp.sez.status.application.form.service.service.SezDevShareCorporationBusAddLocalService;
...
/**
 * Provides the base implementation for the sez dev share corporation bus add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareCorporationBusAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareCorporationBusAddLocalServiceImpl
 * @generated
 */
public abstract class SezDevShareCorporationBusAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareCorporationBusAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareCorporationBusAddLocalServiceUtil</code>.
	 */
	...
	public SezDevShareCorporationBusAdd addSezDevShareCorporationBusAdd(
		...
		return sezDevShareCorporationBusAddPersistence.update(
	...
	public SezDevShareCorporationBusAdd createSezDevShareCorporationBusAdd(
		...
		return sezDevShareCorporationBusAddPersistence.create(
	...
	public SezDevShareCorporationBusAdd deleteSezDevShareCorporationBusAdd(
		...
		return sezDevShareCorporationBusAddPersistence.remove(
			sezDevCorporationBusinessAddId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevShareCorporationBusAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevShareCorporationBusAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevShareCorporationBusAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevShareCorporationBusAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezDevShareCorporationBusAdd fetchSezDevShareCorporationBusAdd(
		...
		return sezDevShareCorporationBusAddPersistence.fetchByPrimaryKey(
			sezDevCorporationBusinessAddId);
	}
	...
	public SezDevShareCorporationBusAdd getSezDevShareCorporationBusAdd(
		...
		return sezDevShareCorporationBusAddPersistence.findByPrimaryKey(
			sezDevCorporationBusinessAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			SezDevShareCorporationBusAdd.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevShareCorporationBusAddLocalServiceImpl#deleteSezDevShareCorporationBusAdd(SezDevShareCorporationBusAdd) to avoid orphaned data");
		}

		return sezDevShareCorporationBusAddLocalService.
			deleteSezDevShareCorporationBusAdd(
				(SezDevShareCorporationBusAdd)persistedModel);
	}

	@Override
	public BasePersistence<SezDevShareCorporationBusAdd> getBasePersistence() {
		return sezDevShareCorporationBusAddPersistence;
	}
	...
	public List<SezDevShareCorporationBusAdd> getSezDevShareCorporationBusAdds(
		...
		return sezDevShareCorporationBusAddPersistence.findAll(start, end);
	}
	...
	public int getSezDevShareCorporationBusAddsCount() {
		return sezDevShareCorporationBusAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareCorporationBusAddLocalService =
			(SezDevShareCorporationBusAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareCorporationBusAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevShareCorporationBusAddPersistence.getDataSource();
	...
	protected SezDevShareCorporationBusAddLocalService
		sezDevShareCorporationBusAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareCorporationBusAddLocalServiceBaseImpl.class);
