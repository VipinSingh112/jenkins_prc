...
import com.nbp.sez.status.application.form.service.service.SezDevPropDevelopmentPlanService;
...
/**
 * Provides the base implementation for the sez dev prop development plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevPropDevelopmentPlanServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevPropDevelopmentPlanServiceImpl
 * @generated
 */
public abstract class SezDevPropDevelopmentPlanServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevPropDevelopmentPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevPropDevelopmentPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevPropDevelopmentPlanService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevPropDevelopmentPlanService =
			(SezDevPropDevelopmentPlanService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevPropDevelopmentPlanService.class.getName();
	}
	...
	protected SezDevPropDevelopmentPlanService sezDevPropDevelopmentPlanService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevPropDevelopmentPlanServiceBaseImpl.class);
