...
import com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleOfficerLocalService;
...
/**
 * Provides the base implementation for the sez occupant principle officer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleOfficerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleOfficerLocalServiceImpl
 * @generated
 */
public abstract class SezOccupantPrincipleOfficerLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantPrincipleOfficerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleOfficerLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezOccupantPrincipleOfficer addSezOccupantPrincipleOfficer(
		SezOccupantPrincipleOfficer sezOccupantPrincipleOfficer) {

		sezOccupantPrincipleOfficer.setNew(true);

		return sezOccupantPrincipleOfficerPersistence.update(
	...
	public SezOccupantPrincipleOfficer createSezOccupantPrincipleOfficer(
		long sezOccPrincOffId) {

		return sezOccupantPrincipleOfficerPersistence.create(sezOccPrincOffId);
	}
	...
	@Override
	public SezOccupantPrincipleOfficer deleteSezOccupantPrincipleOfficer(
			long sezOccPrincOffId)
		throws PortalException {

		return sezOccupantPrincipleOfficerPersistence.remove(sezOccPrincOffId);
	}
	...
	public SezOccupantPrincipleOfficer deleteSezOccupantPrincipleOfficer(
		...
		return sezOccupantPrincipleOfficerPersistence.remove(
			sezOccupantPrincipleOfficer);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezOccupantPrincipleOfficerPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezOccupantPrincipleOfficer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezOccupantPrincipleOfficerPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezOccupantPrincipleOfficerPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezOccupantPrincipleOfficer fetchSezOccupantPrincipleOfficer(
		long sezOccPrincOffId) {

		return sezOccupantPrincipleOfficerPersistence.fetchByPrimaryKey(
			sezOccPrincOffId);
	}
	 ...
	 */
	@Override
	public SezOccupantPrincipleOfficer getSezOccupantPrincipleOfficer(
			long sezOccPrincOffId)
		throws PortalException {

		return sezOccupantPrincipleOfficerPersistence.findByPrimaryKey(
			sezOccPrincOffId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezOccupantPrincipleOfficer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sezOccPrincOffId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			SezOccupantPrincipleOfficer.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezOccupantPrincipleOfficerPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezOccupantPrincipleOfficerLocalServiceImpl#deleteSezOccupantPrincipleOfficer(SezOccupantPrincipleOfficer) to avoid orphaned data");
		}

		return sezOccupantPrincipleOfficerLocalService.
			deleteSezOccupantPrincipleOfficer(
				(SezOccupantPrincipleOfficer)persistedModel);
	}

	@Override
	public BasePersistence<SezOccupantPrincipleOfficer> getBasePersistence() {
		return sezOccupantPrincipleOfficerPersistence;
	}
	 ...
	 */
	@Override
	public List<SezOccupantPrincipleOfficer> getSezOccupantPrincipleOfficers(
		int start, int end) {

		return sezOccupantPrincipleOfficerPersistence.findAll(start, end);
	}
	...
	public int getSezOccupantPrincipleOfficersCount() {
		return sezOccupantPrincipleOfficerPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezOccupantPrincipleOfficer updateSezOccupantPrincipleOfficer(
		SezOccupantPrincipleOfficer sezOccupantPrincipleOfficer) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantPrincipleOfficerLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantPrincipleOfficerLocalService =
			(SezOccupantPrincipleOfficerLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantPrincipleOfficerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantPrincipleOfficerPersistence.getDataSource();
	...
	protected SezOccupantPrincipleOfficerLocalService
		sezOccupantPrincipleOfficerLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantPrincipleOfficerLocalServiceBaseImpl.class);
