...
import com.nbp.sez.status.application.form.service.service.SezZoneGeneralBussinessAddressService;
...
/**
 * Provides the base implementation for the sez zone general bussiness address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneGeneralBussinessAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneGeneralBussinessAddressServiceImpl
 * @generated
 */
public abstract class SezZoneGeneralBussinessAddressServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneGeneralBussinessAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneGeneralBussinessAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneGeneralBussinessAddressService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezZoneGeneralBussinessAddressService =
			(SezZoneGeneralBussinessAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneGeneralBussinessAddressService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneGeneralBussinessAddressPersistence.getDataSource();
	...
	protected SezZoneGeneralBussinessAddressService
		sezZoneGeneralBussinessAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneGeneralBussinessAddressServiceBaseImpl.class);
