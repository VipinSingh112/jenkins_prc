...
import com.nbp.sez.status.application.form.service.service.SezDevEmployeeSafetyInfoAddLocalService;
...
/**
 * Provides the base implementation for the sez dev employee safety info add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeSafetyInfoAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeSafetyInfoAddLocalServiceImpl
 * @generated
 */
public abstract class SezDevEmployeeSafetyInfoAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevEmployeeSafetyInfoAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevEmployeeSafetyInfoAddLocalServiceUtil</code>.
	 */
	...
	public SezDevEmployeeSafetyInfoAdd addSezDevEmployeeSafetyInfoAdd(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.update(
	...
	public SezDevEmployeeSafetyInfoAdd createSezDevEmployeeSafetyInfoAdd(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.create(
	...
	public SezDevEmployeeSafetyInfoAdd deleteSezDevEmployeeSafetyInfoAdd(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.remove(
			sezDevEmployeeSafetyInfoAddId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevEmployeeSafetyInfoAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevEmployeeSafetyInfoAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevEmployeeSafetyInfoAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevEmployeeSafetyInfoAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezDevEmployeeSafetyInfoAdd fetchSezDevEmployeeSafetyInfoAdd(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.fetchByPrimaryKey(
			sezDevEmployeeSafetyInfoAddId);
	}
	...
	public SezDevEmployeeSafetyInfoAdd getSezDevEmployeeSafetyInfoAdd(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.findByPrimaryKey(
			sezDevEmployeeSafetyInfoAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDevEmployeeSafetyInfoAdd.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			SezDevEmployeeSafetyInfoAdd.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevEmployeeSafetyInfoAddLocalServiceImpl#deleteSezDevEmployeeSafetyInfoAdd(SezDevEmployeeSafetyInfoAdd) to avoid orphaned data");
		}

		return sezDevEmployeeSafetyInfoAddLocalService.
			deleteSezDevEmployeeSafetyInfoAdd(
				(SezDevEmployeeSafetyInfoAdd)persistedModel);
	}

	@Override
	public BasePersistence<SezDevEmployeeSafetyInfoAdd> getBasePersistence() {
		return sezDevEmployeeSafetyInfoAddPersistence;
	}
	...
	public List<SezDevEmployeeSafetyInfoAdd> getSezDevEmployeeSafetyInfoAdds(
		...
		return sezDevEmployeeSafetyInfoAddPersistence.findAll(start, end);
	}
	...
	public int getSezDevEmployeeSafetyInfoAddsCount() {
		return sezDevEmployeeSafetyInfoAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevEmployeeSafetyInfoAddLocalService =
			(SezDevEmployeeSafetyInfoAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevEmployeeSafetyInfoAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevEmployeeSafetyInfoAddPersistence.getDataSource();
	...
	protected SezDevEmployeeSafetyInfoAddLocalService
		sezDevEmployeeSafetyInfoAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevEmployeeSafetyInfoAddLocalServiceBaseImpl.class);
