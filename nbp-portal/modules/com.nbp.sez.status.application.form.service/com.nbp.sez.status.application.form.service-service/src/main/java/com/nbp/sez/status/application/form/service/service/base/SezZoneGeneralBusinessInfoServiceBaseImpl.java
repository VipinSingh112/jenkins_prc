...
import com.nbp.sez.status.application.form.service.service.SezZoneGeneralBusinessInfoService;
...
/**
 * Provides the base implementation for the sez zone general business info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneGeneralBusinessInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneGeneralBusinessInfoServiceImpl
 * @generated
 */
public abstract class SezZoneGeneralBusinessInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneGeneralBusinessInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneGeneralBusinessInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneGeneralBusinessInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezZoneGeneralBusinessInfoService =
			(SezZoneGeneralBusinessInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneGeneralBusinessInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneGeneralBusinessInfoPersistence.getDataSource();
	...
	protected SezZoneGeneralBusinessInfoService
		sezZoneGeneralBusinessInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneGeneralBusinessInfoServiceBaseImpl.class);
