...
import com.nbp.sez.status.application.form.service.service.SezDevShareholdingInfoLocalService;
...
/**
 * Provides the base implementation for the sez dev shareholding info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareholdingInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareholdingInfoLocalServiceImpl
 * @generated
 */
public abstract class SezDevShareholdingInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareholdingInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareholdingInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezDevShareholdingInfo addSezDevShareholdingInfo(
		SezDevShareholdingInfo sezDevShareholdingInfo) {

		sezDevShareholdingInfo.setNew(true);

		return sezDevShareholdingInfoPersistence.update(sezDevShareholdingInfo);
	}
	...
	public SezDevShareholdingInfo createSezDevShareholdingInfo(
		long sezDevShareholdingInfoId) {

		return sezDevShareholdingInfoPersistence.create(
	...
	@Override
	public SezDevShareholdingInfo deleteSezDevShareholdingInfo(
			long sezDevShareholdingInfoId)
		throws PortalException {

		return sezDevShareholdingInfoPersistence.remove(
			sezDevShareholdingInfoId);
	}
	...
	public SezDevShareholdingInfo deleteSezDevShareholdingInfo(
		...
		return sezDevShareholdingInfoPersistence.remove(sezDevShareholdingInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevShareholdingInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevShareholdingInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevShareholdingInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevShareholdingInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezDevShareholdingInfo fetchSezDevShareholdingInfo(
		long sezDevShareholdingInfoId) {

		return sezDevShareholdingInfoPersistence.fetchByPrimaryKey(
			sezDevShareholdingInfoId);
	}
	 ...
	 */
	@Override
	public SezDevShareholdingInfo getSezDevShareholdingInfo(
			long sezDevShareholdingInfoId)
		throws PortalException {

		return sezDevShareholdingInfoPersistence.findByPrimaryKey(
			sezDevShareholdingInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDevShareholdingInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevShareholdingInfoLocalServiceImpl#deleteSezDevShareholdingInfo(SezDevShareholdingInfo) to avoid orphaned data");
		}

		return sezDevShareholdingInfoLocalService.deleteSezDevShareholdingInfo(
			(SezDevShareholdingInfo)persistedModel);
	}

	@Override
	public BasePersistence<SezDevShareholdingInfo> getBasePersistence() {
		return sezDevShareholdingInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<SezDevShareholdingInfo> getSezDevShareholdingInfos(
		int start, int end) {

		return sezDevShareholdingInfoPersistence.findAll(start, end);
	}
	...
	public int getSezDevShareholdingInfosCount() {
		return sezDevShareholdingInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezDevShareholdingInfo updateSezDevShareholdingInfo(
		SezDevShareholdingInfo sezDevShareholdingInfo) {
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareholdingInfoLocalService =
			(SezDevShareholdingInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareholdingInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevShareholdingInfoPersistence.getDataSource();
	...
	protected SezDevShareholdingInfoLocalService
		sezDevShareholdingInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareholdingInfoLocalServiceBaseImpl.class);
