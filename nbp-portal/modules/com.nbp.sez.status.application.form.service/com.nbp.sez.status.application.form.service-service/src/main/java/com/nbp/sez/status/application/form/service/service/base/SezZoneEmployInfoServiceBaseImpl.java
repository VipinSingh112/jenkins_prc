...
import com.nbp.sez.status.application.form.service.service.SezZoneEmployInfoService;
...
/**
 * Provides the base implementation for the sez zone employ info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneEmployInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneEmployInfoServiceImpl
 * @generated
 */
public abstract class SezZoneEmployInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezZoneEmployInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneEmployInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneEmployInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneEmployInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneEmployInfoService = (SezZoneEmployInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneEmployInfoService.class.getName();
	}
	...
	protected SezZoneEmployInfoService sezZoneEmployInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneEmployInfoServiceBaseImpl.class);
