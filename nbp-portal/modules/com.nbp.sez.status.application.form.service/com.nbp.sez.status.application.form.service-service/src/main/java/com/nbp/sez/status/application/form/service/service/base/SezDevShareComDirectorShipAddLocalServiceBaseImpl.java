...
import com.nbp.sez.status.application.form.service.service.SezDevShareComDirectorShipAddLocalService;
...
/**
 * Provides the base implementation for the sez dev share com director ship add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareComDirectorShipAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareComDirectorShipAddLocalServiceImpl
 * @generated
 */
public abstract class SezDevShareComDirectorShipAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareComDirectorShipAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareComDirectorShipAddLocalServiceUtil</code>.
	 */
	...
	public SezDevShareComDirectorShipAdd addSezDevShareComDirectorShipAdd(
		...
		return sezDevShareComDirectorShipAddPersistence.update(
	...
	public SezDevShareComDirectorShipAdd createSezDevShareComDirectorShipAdd(
		...
		return sezDevShareComDirectorShipAddPersistence.create(
	...
	public SezDevShareComDirectorShipAdd deleteSezDevShareComDirectorShipAdd(
		...
		return sezDevShareComDirectorShipAddPersistence.remove(
			sezDevSharComDirectorShipAddId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevShareComDirectorShipAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevShareComDirectorShipAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevShareComDirectorShipAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevShareComDirectorShipAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezDevShareComDirectorShipAdd fetchSezDevShareComDirectorShipAdd(
		...
		return sezDevShareComDirectorShipAddPersistence.fetchByPrimaryKey(
			sezDevSharComDirectorShipAddId);
	}
	...
	public SezDevShareComDirectorShipAdd getSezDevShareComDirectorShipAdd(
		...
		return sezDevShareComDirectorShipAddPersistence.findByPrimaryKey(
			sezDevSharComDirectorShipAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			SezDevShareComDirectorShipAdd.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevShareComDirectorShipAddLocalServiceImpl#deleteSezDevShareComDirectorShipAdd(SezDevShareComDirectorShipAdd) to avoid orphaned data");
		}

		return sezDevShareComDirectorShipAddLocalService.
			deleteSezDevShareComDirectorShipAdd(
				(SezDevShareComDirectorShipAdd)persistedModel);
	}

	@Override
	public BasePersistence<SezDevShareComDirectorShipAdd> getBasePersistence() {
		return sezDevShareComDirectorShipAddPersistence;
	}
	...
	public List<SezDevShareComDirectorShipAdd>
		...
		return sezDevShareComDirectorShipAddPersistence.findAll(start, end);
	}
	...
	public int getSezDevShareComDirectorShipAddsCount() {
		return sezDevShareComDirectorShipAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareComDirectorShipAddLocalService =
			(SezDevShareComDirectorShipAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareComDirectorShipAddLocalService.class.getName();
	}
	...
	protected SezDevShareComDirectorShipAddLocalService
		sezDevShareComDirectorShipAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareComDirectorShipAddLocalServiceBaseImpl.class);
