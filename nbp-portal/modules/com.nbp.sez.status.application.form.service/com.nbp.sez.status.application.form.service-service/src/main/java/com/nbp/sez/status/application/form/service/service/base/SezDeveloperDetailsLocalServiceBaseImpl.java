...
import com.nbp.sez.status.application.form.service.service.SezDeveloperDetailsLocalService;
...
/**
 * Provides the base implementation for the sez developer details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDeveloperDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDeveloperDetailsLocalServiceImpl
 * @generated
 */
public abstract class SezDeveloperDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDeveloperDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDeveloperDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezDeveloperDetails addSezDeveloperDetails(
		SezDeveloperDetails sezDeveloperDetails) {

		sezDeveloperDetails.setNew(true);

		return sezDeveloperDetailsPersistence.update(sezDeveloperDetails);
	}
	...
	public SezDeveloperDetails createSezDeveloperDetails(
		long sezDeveloperDetailsId) {

		return sezDeveloperDetailsPersistence.create(sezDeveloperDetailsId);
	}
	...
	@Override
	public SezDeveloperDetails deleteSezDeveloperDetails(
			long sezDeveloperDetailsId)
		throws PortalException {

		return sezDeveloperDetailsPersistence.remove(sezDeveloperDetailsId);
	}
	...
	public SezDeveloperDetails deleteSezDeveloperDetails(
		...
		return sezDeveloperDetailsPersistence.remove(sezDeveloperDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDeveloperDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDeveloperDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDeveloperDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDeveloperDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezDeveloperDetails fetchSezDeveloperDetails(
		long sezDeveloperDetailsId) {

		return sezDeveloperDetailsPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SezDeveloperDetails getSezDeveloperDetails(
			long sezDeveloperDetailsId)
		throws PortalException {

		return sezDeveloperDetailsPersistence.findByPrimaryKey(
			sezDeveloperDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDeveloperDetails.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezDeveloperDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDeveloperDetailsLocalServiceImpl#deleteSezDeveloperDetails(SezDeveloperDetails) to avoid orphaned data");
		}

		return sezDeveloperDetailsLocalService.deleteSezDeveloperDetails(
			(SezDeveloperDetails)persistedModel);
	}

	@Override
	public BasePersistence<SezDeveloperDetails> getBasePersistence() {
		return sezDeveloperDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sezDeveloperDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SezDeveloperDetails> getSezDeveloperDetailses(
		int start, int end) {

		return sezDeveloperDetailsPersistence.findAll(start, end);
	}
	...
	public int getSezDeveloperDetailsesCount() {
		return sezDeveloperDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezDeveloperDetails updateSezDeveloperDetails(
		SezDeveloperDetails sezDeveloperDetails) {
	...
	public void setAopProxy(Object aopProxy) {
		sezDeveloperDetailsLocalService =
			(SezDeveloperDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDeveloperDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDeveloperDetailsPersistence.getDataSource();
	...
	protected SezDeveloperDetailsLocalService sezDeveloperDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDeveloperDetailsLocalServiceBaseImpl.class);
