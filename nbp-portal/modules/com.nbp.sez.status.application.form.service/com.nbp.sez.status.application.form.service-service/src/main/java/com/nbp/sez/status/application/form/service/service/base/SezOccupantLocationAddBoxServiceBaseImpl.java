...
import com.nbp.sez.status.application.form.service.service.SezOccupantLocationAddBoxService;
...
/**
 * Provides the base implementation for the sez occupant location add box remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantLocationAddBoxServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantLocationAddBoxServiceImpl
 * @generated
 */
public abstract class SezOccupantLocationAddBoxServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantLocationAddBoxService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantLocationAddBoxServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantLocationAddBoxService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantLocationAddBoxService =
			(SezOccupantLocationAddBoxService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantLocationAddBoxService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantLocationAddBoxPersistence.getDataSource();
	...
	protected SezOccupantLocationAddBoxService sezOccupantLocationAddBoxService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantLocationAddBoxServiceBaseImpl.class);
