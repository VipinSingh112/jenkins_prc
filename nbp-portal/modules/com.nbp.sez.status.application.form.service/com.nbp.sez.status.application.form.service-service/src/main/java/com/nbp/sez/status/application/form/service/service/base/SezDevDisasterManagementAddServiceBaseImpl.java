...
import com.nbp.sez.status.application.form.service.service.SezDevDisasterManagementAddService;
...
/**
 * Provides the base implementation for the sez dev disaster management add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevDisasterManagementAddServiceImpl
 * @generated
 */
public abstract class SezDevDisasterManagementAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevDisasterManagementAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevDisasterManagementAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevDisasterManagementAddService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevDisasterManagementAddService =
			(SezDevDisasterManagementAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevDisasterManagementAddService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevDisasterManagementAddPersistence.getDataSource();
	...
	protected SezDevDisasterManagementAddService
		sezDevDisasterManagementAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevDisasterManagementAddServiceBaseImpl.class);
