...
import com.nbp.sez.status.application.form.service.service.SezConsultancyInspectionService;
...
/**
 * Provides the base implementation for the sez consultancy inspection remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezConsultancyInspectionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezConsultancyInspectionServiceImpl
 * @generated
 */
public abstract class SezConsultancyInspectionServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezConsultancyInspectionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezConsultancyInspectionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezConsultancyInspectionService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezConsultancyInspectionService =
			(SezConsultancyInspectionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezConsultancyInspectionService.class.getName();
	}
	...
	protected SezConsultancyInspectionService sezConsultancyInspectionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezConsultancyInspectionServiceBaseImpl.class);
