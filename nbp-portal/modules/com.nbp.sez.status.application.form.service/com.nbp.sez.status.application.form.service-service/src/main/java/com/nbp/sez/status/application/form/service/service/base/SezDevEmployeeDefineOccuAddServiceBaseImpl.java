...
import com.nbp.sez.status.application.form.service.service.SezDevEmployeeDefineOccuAddService;
...
/**
 * Provides the base implementation for the sez dev employee define occu add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeDefineOccuAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevEmployeeDefineOccuAddServiceImpl
 * @generated
 */
public abstract class SezDevEmployeeDefineOccuAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevEmployeeDefineOccuAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevEmployeeDefineOccuAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevEmployeeDefineOccuAddService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevEmployeeDefineOccuAddService =
			(SezDevEmployeeDefineOccuAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevEmployeeDefineOccuAddService.class.getName();
	}
	...
	protected String getModelClassName() {
		return SezDevEmployeeDefineOccuAdd.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevEmployeeDefineOccuAddPersistence.getDataSource();
	...
	protected SezDevEmployeeDefineOccuAddService
		sezDevEmployeeDefineOccuAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevEmployeeDefineOccuAddServiceBaseImpl.class);
