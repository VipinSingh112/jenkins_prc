...
import com.nbp.sez.status.application.form.service.service.SezDevSharePleaseStateAddService;
...
/**
 * Provides the base implementation for the sez dev share please state add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevSharePleaseStateAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevSharePleaseStateAddServiceImpl
 * @generated
 */
public abstract class SezDevSharePleaseStateAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevSharePleaseStateAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevSharePleaseStateAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevSharePleaseStateAddService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevSharePleaseStateAddService =
			(SezDevSharePleaseStateAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevSharePleaseStateAddService.class.getName();
	}
	...
	protected SezDevSharePleaseStateAddService sezDevSharePleaseStateAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevSharePleaseStateAddServiceBaseImpl.class);
