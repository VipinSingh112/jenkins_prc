...
import com.nbp.sez.status.application.form.service.service.SezZoneSubCheckInfoService;
...
/**
 * Provides the base implementation for the sez zone sub check info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneSubCheckInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneSubCheckInfoServiceImpl
 * @generated
 */
public abstract class SezZoneSubCheckInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezZoneSubCheckInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneSubCheckInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneSubCheckInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneSubCheckInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneSubCheckInfoService = (SezZoneSubCheckInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneSubCheckInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneSubCheckInfoPersistence.getDataSource();
	...
	protected SezZoneSubCheckInfoService sezZoneSubCheckInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneSubCheckInfoServiceBaseImpl.class);
