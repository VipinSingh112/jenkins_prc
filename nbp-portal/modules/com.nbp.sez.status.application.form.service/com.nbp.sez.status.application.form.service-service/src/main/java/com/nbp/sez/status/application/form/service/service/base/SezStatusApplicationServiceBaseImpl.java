...
import com.nbp.sez.status.application.form.service.service.SezStatusApplicationService;
...
/**
 * Provides the base implementation for the sez status application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusApplicationServiceImpl
 * @generated
 */
public abstract class SezStatusApplicationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezStatusApplicationService = (SezStatusApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusApplicationService.class.getName();
	}
	...
	protected SezStatusApplicationService sezStatusApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusApplicationServiceBaseImpl.class);
