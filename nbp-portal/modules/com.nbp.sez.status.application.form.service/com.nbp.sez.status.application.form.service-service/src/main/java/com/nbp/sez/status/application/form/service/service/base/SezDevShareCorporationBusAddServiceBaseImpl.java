...
import com.nbp.sez.status.application.form.service.service.SezDevShareCorporationBusAddService;
...
/**
 * Provides the base implementation for the sez dev share corporation bus add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareCorporationBusAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareCorporationBusAddServiceImpl
 * @generated
 */
public abstract class SezDevShareCorporationBusAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareCorporationBusAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareCorporationBusAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevShareCorporationBusAddService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareCorporationBusAddService =
			(SezDevShareCorporationBusAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareCorporationBusAddService.class.getName();
	}
	...
	protected SezDevShareCorporationBusAddService
		sezDevShareCorporationBusAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareCorporationBusAddServiceBaseImpl.class);
