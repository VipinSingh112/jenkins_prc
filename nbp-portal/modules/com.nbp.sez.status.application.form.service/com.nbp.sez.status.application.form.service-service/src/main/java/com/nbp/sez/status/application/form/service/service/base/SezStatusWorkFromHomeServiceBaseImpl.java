...
import com.nbp.sez.status.application.form.service.service.SezStatusWorkFromHomeService;
...
/**
 * Provides the base implementation for the sez status work from home remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeServiceImpl
 * @generated
 */
public abstract class SezStatusWorkFromHomeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusWorkFromHomeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusWorkFromHomeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusWorkFromHomeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezStatusWorkFromHomeService = (SezStatusWorkFromHomeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusWorkFromHomeService.class.getName();
	}
	...
	protected SezStatusWorkFromHomeService sezStatusWorkFromHomeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusWorkFromHomeServiceBaseImpl.class);
