...
import com.nbp.sez.status.application.form.service.service.SezDevSharePrincipalAddService;
...
/**
 * Provides the base implementation for the sez dev share principal add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevSharePrincipalAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevSharePrincipalAddServiceImpl
 * @generated
 */
public abstract class SezDevSharePrincipalAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevSharePrincipalAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevSharePrincipalAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevSharePrincipalAddService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevSharePrincipalAddService =
			(SezDevSharePrincipalAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevSharePrincipalAddService.class.getName();
	}
	...
	protected com.nbp.sez.status.application.form.service.service.
		SezDevSharePrincipalAddLocalService sezDevSharePrincipalAddLocalService;

	protected SezDevSharePrincipalAddService sezDevSharePrincipalAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevSharePrincipalAddServiceBaseImpl.class);
