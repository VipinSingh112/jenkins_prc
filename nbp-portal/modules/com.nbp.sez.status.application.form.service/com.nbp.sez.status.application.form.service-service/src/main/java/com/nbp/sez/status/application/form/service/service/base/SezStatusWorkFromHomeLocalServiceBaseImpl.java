...
import com.nbp.sez.status.application.form.service.service.SezStatusWorkFromHomeLocalService;
...
/**
 * Provides the base implementation for the sez status work from home local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusWorkFromHomeLocalServiceImpl
 * @generated
 */
public abstract class SezStatusWorkFromHomeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusWorkFromHomeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusWorkFromHomeLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezStatusWorkFromHome addSezStatusWorkFromHome(
		SezStatusWorkFromHome sezStatusWorkFromHome) {

		sezStatusWorkFromHome.setNew(true);

		return sezStatusWorkFromHomePersistence.update(sezStatusWorkFromHome);
	}
	...
	public SezStatusWorkFromHome createSezStatusWorkFromHome(
		long sezStatusWorkFromHomeId) {

		return sezStatusWorkFromHomePersistence.create(sezStatusWorkFromHomeId);
	}
	...
	@Override
	public SezStatusWorkFromHome deleteSezStatusWorkFromHome(
			long sezStatusWorkFromHomeId)
		throws PortalException {

		return sezStatusWorkFromHomePersistence.remove(sezStatusWorkFromHomeId);
	}
	...
	public SezStatusWorkFromHome deleteSezStatusWorkFromHome(
		...
		return sezStatusWorkFromHomePersistence.remove(sezStatusWorkFromHome);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezStatusWorkFromHomePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezStatusWorkFromHome.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezStatusWorkFromHomePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezStatusWorkFromHomePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezStatusWorkFromHome fetchSezStatusWorkFromHome(
		long sezStatusWorkFromHomeId) {

		return sezStatusWorkFromHomePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SezStatusWorkFromHome getSezStatusWorkFromHome(
			long sezStatusWorkFromHomeId)
		throws PortalException {

		return sezStatusWorkFromHomePersistence.findByPrimaryKey(
			sezStatusWorkFromHomeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezStatusWorkFromHome.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusWorkFromHomePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezStatusWorkFromHomeLocalServiceImpl#deleteSezStatusWorkFromHome(SezStatusWorkFromHome) to avoid orphaned data");
		}

		return sezStatusWorkFromHomeLocalService.deleteSezStatusWorkFromHome(
			(SezStatusWorkFromHome)persistedModel);
	}

	@Override
	public BasePersistence<SezStatusWorkFromHome> getBasePersistence() {
		return sezStatusWorkFromHomePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusWorkFromHomePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SezStatusWorkFromHome> getSezStatusWorkFromHomes(
		int start, int end) {

		return sezStatusWorkFromHomePersistence.findAll(start, end);
	}
	...
	public int getSezStatusWorkFromHomesCount() {
		return sezStatusWorkFromHomePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezStatusWorkFromHome updateSezStatusWorkFromHome(
		SezStatusWorkFromHome sezStatusWorkFromHome) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusWorkFromHomeLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusWorkFromHomeLocalService =
			(SezStatusWorkFromHomeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusWorkFromHomeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezStatusWorkFromHomePersistence.getDataSource();
	...
	protected SezStatusWorkFromHomeLocalService
		sezStatusWorkFromHomeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusWorkFromHomeLocalServiceBaseImpl.class);
