...
import com.nbp.sez.status.application.form.service.service.SezStatusWFMLocationAddLocalService;
...
/**
 * Provides the base implementation for the sez status wfm location add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusWFMLocationAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusWFMLocationAddLocalServiceImpl
 * @generated
 */
public abstract class SezStatusWFMLocationAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusWFMLocationAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusWFMLocationAddLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezStatusWFMLocationAdd addSezStatusWFMLocationAdd(
		SezStatusWFMLocationAdd sezStatusWFMLocationAdd) {

		sezStatusWFMLocationAdd.setNew(true);

		return sezStatusWFMLocationAddPersistence.update(
	...
	public SezStatusWFMLocationAdd createSezStatusWFMLocationAdd(
		long sezStatusWFHLocId) {

		return sezStatusWFMLocationAddPersistence.create(sezStatusWFHLocId);
	}
	...
	@Override
	public SezStatusWFMLocationAdd deleteSezStatusWFMLocationAdd(
			long sezStatusWFHLocId)
		throws PortalException {

		return sezStatusWFMLocationAddPersistence.remove(sezStatusWFHLocId);
	}
	...
	public SezStatusWFMLocationAdd deleteSezStatusWFMLocationAdd(
		...
		return sezStatusWFMLocationAddPersistence.remove(
			sezStatusWFMLocationAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezStatusWFMLocationAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezStatusWFMLocationAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezStatusWFMLocationAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezStatusWFMLocationAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezStatusWFMLocationAdd fetchSezStatusWFMLocationAdd(
		long sezStatusWFHLocId) {

		return sezStatusWFMLocationAddPersistence.fetchByPrimaryKey(
			sezStatusWFHLocId);
	}
	 ...
	 */
	@Override
	public SezStatusWFMLocationAdd getSezStatusWFMLocationAdd(
			long sezStatusWFHLocId)
		throws PortalException {

		return sezStatusWFMLocationAddPersistence.findByPrimaryKey(
			sezStatusWFHLocId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezStatusWFMLocationAdd.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sezStatusWFHLocId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusWFMLocationAddPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezStatusWFMLocationAddLocalServiceImpl#deleteSezStatusWFMLocationAdd(SezStatusWFMLocationAdd) to avoid orphaned data");
		}

		return sezStatusWFMLocationAddLocalService.
			deleteSezStatusWFMLocationAdd(
				(SezStatusWFMLocationAdd)persistedModel);
	}

	@Override
	public BasePersistence<SezStatusWFMLocationAdd> getBasePersistence() {
		return sezStatusWFMLocationAddPersistence;
	}
	 ...
	 */
	@Override
	public List<SezStatusWFMLocationAdd> getSezStatusWFMLocationAdds(
		int start, int end) {

		return sezStatusWFMLocationAddPersistence.findAll(start, end);
	}
	...
	public int getSezStatusWFMLocationAddsCount() {
		return sezStatusWFMLocationAddPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezStatusWFMLocationAdd updateSezStatusWFMLocationAdd(
		SezStatusWFMLocationAdd sezStatusWFMLocationAdd) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusWFMLocationAddLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusWFMLocationAddLocalService =
			(SezStatusWFMLocationAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusWFMLocationAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezStatusWFMLocationAddPersistence.getDataSource();
	...
	protected SezStatusWFMLocationAddLocalService
		sezStatusWFMLocationAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusWFMLocationAddLocalServiceBaseImpl.class);
