...
import com.nbp.sez.status.application.form.service.service.SezDevShareComDirectorShipAddService;
...
/**
 * Provides the base implementation for the sez dev share com director ship add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareComDirectorShipAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareComDirectorShipAddServiceImpl
 * @generated
 */
public abstract class SezDevShareComDirectorShipAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareComDirectorShipAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareComDirectorShipAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevShareComDirectorShipAddService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareComDirectorShipAddService =
			(SezDevShareComDirectorShipAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareComDirectorShipAddService.class.getName();
	}
	...
	protected String getModelClassName() {
		return SezDevShareComDirectorShipAdd.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevShareComDirectorShipAddPersistence.getDataSource();
	...
	protected SezDevShareComDirectorShipAddService
		sezDevShareComDirectorShipAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareComDirectorShipAddServiceBaseImpl.class);
