...
import com.nbp.sez.status.application.form.service.service.SezOccupantEmploymentInfoService;
...
/**
 * Provides the base implementation for the sez occupant employment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantEmploymentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantEmploymentInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantEmploymentInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantEmploymentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantEmploymentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantEmploymentInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantEmploymentInfoService =
			(SezOccupantEmploymentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantEmploymentInfoService.class.getName();
	}
	...
	protected SezOccupantEmploymentInfoService sezOccupantEmploymentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantEmploymentInfoServiceBaseImpl.class);
