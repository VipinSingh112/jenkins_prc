...
import com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleOfficerService;
...
/**
 * Provides the base implementation for the sez occupant principle officer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleOfficerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantPrincipleOfficerServiceImpl
 * @generated
 */
public abstract class SezOccupantPrincipleOfficerServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantPrincipleOfficerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantPrincipleOfficerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantPrincipleOfficerService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantPrincipleOfficerService =
			(SezOccupantPrincipleOfficerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantPrincipleOfficerService.class.getName();
	}
	...
	protected SezOccupantPrincipleOfficerService
		sezOccupantPrincipleOfficerService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantPrincipleOfficerServiceBaseImpl.class);
