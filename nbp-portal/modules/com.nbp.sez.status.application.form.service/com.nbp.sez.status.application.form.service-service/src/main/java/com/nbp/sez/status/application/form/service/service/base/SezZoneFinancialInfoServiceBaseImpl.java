...
import com.nbp.sez.status.application.form.service.service.SezZoneFinancialInfoService;
...
/**
 * Provides the base implementation for the sez zone financial info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneFinancialInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneFinancialInfoServiceImpl
 * @generated
 */
public abstract class SezZoneFinancialInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneFinancialInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneFinancialInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneFinancialInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneFinancialInfoService = (SezZoneFinancialInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneFinancialInfoService.class.getName();
	}
	...
	protected SezZoneFinancialInfoService sezZoneFinancialInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneFinancialInfoServiceBaseImpl.class);
