...
import com.nbp.sez.status.application.form.service.service.SezOccupantGeneralBussinessInfoService;
...
/**
 * Provides the base implementation for the sez occupant general bussiness info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantGeneralBussinessInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantGeneralBussinessInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantGeneralBussinessInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantGeneralBussinessInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantGeneralBussinessInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantGeneralBussinessInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantGeneralBussinessInfoService =
			(SezOccupantGeneralBussinessInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantGeneralBussinessInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccupantGeneralBussinessInfoPersistence.getDataSource();
	...
	protected SezOccupantGeneralBussinessInfoService
		sezOccupantGeneralBussinessInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantGeneralBussinessInfoServiceBaseImpl.class);
