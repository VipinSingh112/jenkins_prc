...
import com.nbp.sez.status.application.form.service.service.SezOccupantExistingProposedProjectBriefInfoService;
...
/**
 * Provides the base implementation for the sez occupant existing proposed project brief info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantExistingProposedProjectBriefInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantExistingProposedProjectBriefInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantExistingProposedProjectBriefInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantExistingProposedProjectBriefInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantExistingProposedProjectBriefInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantExistingProposedProjectBriefInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantExistingProposedProjectBriefInfoService =
			(SezOccupantExistingProposedProjectBriefInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantExistingProposedProjectBriefInfoService.class.
			getName();
	}
	...
	protected SezOccupantExistingProposedProjectBriefInfoService
		sezOccupantExistingProposedProjectBriefInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantExistingProposedProjectBriefInfoServiceBaseImpl.class);
