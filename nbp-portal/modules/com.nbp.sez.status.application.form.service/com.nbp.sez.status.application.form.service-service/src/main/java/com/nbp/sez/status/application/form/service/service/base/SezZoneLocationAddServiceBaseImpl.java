...
import com.nbp.sez.status.application.form.service.service.SezZoneLocationAddService;
...
/**
 * Provides the base implementation for the sez zone location add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneLocationAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneLocationAddServiceImpl
 * @generated
 */
public abstract class SezZoneLocationAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezZoneLocationAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneLocationAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneLocationAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneLocationAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneLocationAddService = (SezZoneLocationAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneLocationAddService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneLocationAddPersistence.getDataSource();
	...
	protected SezZoneLocationAddService sezZoneLocationAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneLocationAddServiceBaseImpl.class);
