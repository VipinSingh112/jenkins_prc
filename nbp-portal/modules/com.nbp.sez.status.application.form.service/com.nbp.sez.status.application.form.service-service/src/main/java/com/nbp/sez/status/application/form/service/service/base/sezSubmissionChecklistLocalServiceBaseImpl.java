...
import com.nbp.sez.status.application.form.service.service.sezSubmissionChecklistLocalService;
...
/**
 * Provides the base implementation for the sez submission checklist local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.sezSubmissionChecklistLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.sezSubmissionChecklistLocalServiceImpl
 * @generated
 */
public abstract class sezSubmissionChecklistLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>sezSubmissionChecklistLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.sezSubmissionChecklistLocalServiceUtil</code>.
	 */
	...
	@Override
	public sezSubmissionChecklist addsezSubmissionChecklist(
		sezSubmissionChecklist sezSubmissionChecklist) {

		sezSubmissionChecklist.setNew(true);

		return sezSubmissionChecklistPersistence.update(sezSubmissionChecklist);
	}
	...
	public sezSubmissionChecklist createsezSubmissionChecklist(
		long sezSubmissionChecklistId) {

		return sezSubmissionChecklistPersistence.create(
	...
	@Override
	public sezSubmissionChecklist deletesezSubmissionChecklist(
			long sezSubmissionChecklistId)
		throws PortalException {

		return sezSubmissionChecklistPersistence.remove(
			sezSubmissionChecklistId);
	}
	...
	public sezSubmissionChecklist deletesezSubmissionChecklist(
		...
		return sezSubmissionChecklistPersistence.remove(sezSubmissionChecklist);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezSubmissionChecklistPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			sezSubmissionChecklist.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezSubmissionChecklistPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezSubmissionChecklistPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public sezSubmissionChecklist fetchsezSubmissionChecklist(
		long sezSubmissionChecklistId) {

		return sezSubmissionChecklistPersistence.fetchByPrimaryKey(
			sezSubmissionChecklistId);
	}
	 ...
	 */
	@Override
	public sezSubmissionChecklist getsezSubmissionChecklist(
			long sezSubmissionChecklistId)
		throws PortalException {

		return sezSubmissionChecklistPersistence.findByPrimaryKey(
			sezSubmissionChecklistId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(sezSubmissionChecklist.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement sezSubmissionChecklistLocalServiceImpl#deletesezSubmissionChecklist(sezSubmissionChecklist) to avoid orphaned data");
		}

		return sezSubmissionChecklistLocalService.deletesezSubmissionChecklist(
			(sezSubmissionChecklist)persistedModel);
	}

	@Override
	public BasePersistence<sezSubmissionChecklist> getBasePersistence() {
		return sezSubmissionChecklistPersistence;
	}
	 ...
	 */
	@Override
	public List<sezSubmissionChecklist> getsezSubmissionChecklists(
		int start, int end) {

		return sezSubmissionChecklistPersistence.findAll(start, end);
	}
	...
	public int getsezSubmissionChecklistsCount() {
		return sezSubmissionChecklistPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public sezSubmissionChecklist updatesezSubmissionChecklist(
		sezSubmissionChecklist sezSubmissionChecklist) {
	...
	public void setAopProxy(Object aopProxy) {
		sezSubmissionChecklistLocalService =
			(sezSubmissionChecklistLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return sezSubmissionChecklistLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezSubmissionChecklistPersistence.getDataSource();
	...
	protected sezSubmissionChecklistLocalService
		sezSubmissionChecklistLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		sezSubmissionChecklistLocalServiceBaseImpl.class);
