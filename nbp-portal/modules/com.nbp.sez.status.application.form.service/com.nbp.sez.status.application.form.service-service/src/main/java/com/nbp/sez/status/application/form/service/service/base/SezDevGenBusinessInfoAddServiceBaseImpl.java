...
import com.nbp.sez.status.application.form.service.service.SezDevGenBusinessInfoAddService;
...
/**
 * Provides the base implementation for the sez dev gen business info add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevGenBusinessInfoAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevGenBusinessInfoAddServiceImpl
 * @generated
 */
public abstract class SezDevGenBusinessInfoAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevGenBusinessInfoAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevGenBusinessInfoAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevGenBusinessInfoAddService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevGenBusinessInfoAddService =
			(SezDevGenBusinessInfoAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevGenBusinessInfoAddService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevGenBusinessInfoAddPersistence.getDataSource();
	...
	protected SezDevGenBusinessInfoAddService sezDevGenBusinessInfoAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevGenBusinessInfoAddServiceBaseImpl.class);
