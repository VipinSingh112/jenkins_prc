...
import com.nbp.sez.status.application.form.service.service.SezDevEmplomentInfoService;
...
/**
 * Provides the base implementation for the sez dev emploment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevEmplomentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevEmplomentInfoServiceImpl
 * @generated
 */
public abstract class SezDevEmplomentInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezDevEmplomentInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevEmplomentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevEmplomentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevEmplomentInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezDevEmplomentInfoService = (SezDevEmplomentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevEmplomentInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevEmplomentInfoPersistence.getDataSource();
	...
	protected SezDevEmplomentInfoService sezDevEmplomentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevEmplomentInfoServiceBaseImpl.class);
