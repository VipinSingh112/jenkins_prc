...
import com.nbp.sez.status.application.form.service.service.SezZoneUserUnderInfoService;
...
/**
 * Provides the base implementation for the sez zone user under info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneUserUnderInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneUserUnderInfoServiceImpl
 * @generated
 */
public abstract class SezZoneUserUnderInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneUserUnderInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneUserUnderInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezZoneUserUnderInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezZoneUserUnderInfoService = (SezZoneUserUnderInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneUserUnderInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneUserUnderInfoPersistence.getDataSource();
	...
	protected SezZoneUserUnderInfoService sezZoneUserUnderInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneUserUnderInfoServiceBaseImpl.class);
