...
import com.nbp.sez.status.application.form.service.service.SezDevProposedProjectAddService;
...
/**
 * Provides the base implementation for the sez dev proposed project add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevProposedProjectAddServiceImpl
 * @generated
 */
public abstract class SezDevProposedProjectAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevProposedProjectAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevProposedProjectAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevProposedProjectAddService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevProposedProjectAddService =
			(SezDevProposedProjectAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevProposedProjectAddService.class.getName();
	}

	protected Class<?> getModelClass() {
		return SezDevProposedProjectAdd.class;
	}

	protected String getModelClassName() {
		return SezDevProposedProjectAdd.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevProposedProjectAddPersistence.getDataSource();
	...
	protected SezDevProposedProjectAddService sezDevProposedProjectAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevProposedProjectAddServiceBaseImpl.class);
