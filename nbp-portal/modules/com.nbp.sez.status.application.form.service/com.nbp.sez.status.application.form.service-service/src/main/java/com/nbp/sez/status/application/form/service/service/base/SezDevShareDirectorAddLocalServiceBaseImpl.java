...
import com.nbp.sez.status.application.form.service.service.SezDevShareDirectorAddLocalService;
...
/**
 * Provides the base implementation for the sez dev share director add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevShareDirectorAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevShareDirectorAddLocalServiceImpl
 * @generated
 */
public abstract class SezDevShareDirectorAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevShareDirectorAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevShareDirectorAddLocalServiceUtil</code>.
	 */
	...
	@Override
	public SezDevShareDirectorAdd addSezDevShareDirectorAdd(
		SezDevShareDirectorAdd sezDevShareDirectorAdd) {

		sezDevShareDirectorAdd.setNew(true);

		return sezDevShareDirectorAddPersistence.update(sezDevShareDirectorAdd);
	}
	...
	public SezDevShareDirectorAdd createSezDevShareDirectorAdd(
		long sezDevShareDirectorAddId) {

		return sezDevShareDirectorAddPersistence.create(
	...
	@Override
	public SezDevShareDirectorAdd deleteSezDevShareDirectorAdd(
			long sezDevShareDirectorAddId)
		throws PortalException {

		return sezDevShareDirectorAddPersistence.remove(
			sezDevShareDirectorAddId);
	}
	...
	public SezDevShareDirectorAdd deleteSezDevShareDirectorAdd(
		...
		return sezDevShareDirectorAddPersistence.remove(sezDevShareDirectorAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezDevShareDirectorAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezDevShareDirectorAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezDevShareDirectorAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezDevShareDirectorAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SezDevShareDirectorAdd fetchSezDevShareDirectorAdd(
		long sezDevShareDirectorAddId) {

		return sezDevShareDirectorAddPersistence.fetchByPrimaryKey(
			sezDevShareDirectorAddId);
	}
	 ...
	 */
	@Override
	public SezDevShareDirectorAdd getSezDevShareDirectorAdd(
			long sezDevShareDirectorAddId)
		throws PortalException {

		return sezDevShareDirectorAddPersistence.findByPrimaryKey(
			sezDevShareDirectorAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezDevShareDirectorAdd.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezDevShareDirectorAddLocalServiceImpl#deleteSezDevShareDirectorAdd(SezDevShareDirectorAdd) to avoid orphaned data");
		}

		return sezDevShareDirectorAddLocalService.deleteSezDevShareDirectorAdd(
			(SezDevShareDirectorAdd)persistedModel);
	}

	@Override
	public BasePersistence<SezDevShareDirectorAdd> getBasePersistence() {
		return sezDevShareDirectorAddPersistence;
	}
	 ...
	 */
	@Override
	public List<SezDevShareDirectorAdd> getSezDevShareDirectorAdds(
		int start, int end) {

		return sezDevShareDirectorAddPersistence.findAll(start, end);
	}
	...
	public int getSezDevShareDirectorAddsCount() {
		return sezDevShareDirectorAddPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SezDevShareDirectorAdd updateSezDevShareDirectorAdd(
		SezDevShareDirectorAdd sezDevShareDirectorAdd) {
	...
	public void setAopProxy(Object aopProxy) {
		sezDevShareDirectorAddLocalService =
			(SezDevShareDirectorAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevShareDirectorAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezDevShareDirectorAddPersistence.getDataSource();
	...
	protected SezDevShareDirectorAddLocalService
		sezDevShareDirectorAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevShareDirectorAddLocalServiceBaseImpl.class);
