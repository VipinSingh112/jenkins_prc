...
import com.nbp.sez.status.application.form.service.service.SezOccupantDirectorPartnerSponsorInfoService;
...
/**
 * Provides the base implementation for the sez occupant director partner sponsor info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccupantDirectorPartnerSponsorInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccupantDirectorPartnerSponsorInfoServiceImpl
 * @generated
 */
public abstract class SezOccupantDirectorPartnerSponsorInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccupantDirectorPartnerSponsorInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccupantDirectorPartnerSponsorInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccupantDirectorPartnerSponsorInfoService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sezOccupantDirectorPartnerSponsorInfoService =
			(SezOccupantDirectorPartnerSponsorInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccupantDirectorPartnerSponsorInfoService.class.getName();
	}
	...
	protected SezOccupantDirectorPartnerSponsorInfoService
		sezOccupantDirectorPartnerSponsorInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccupantDirectorPartnerSponsorInfoServiceBaseImpl.class);
