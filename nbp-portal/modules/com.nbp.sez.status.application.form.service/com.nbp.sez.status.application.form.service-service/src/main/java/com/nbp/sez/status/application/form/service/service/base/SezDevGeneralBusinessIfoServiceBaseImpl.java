...
import com.nbp.sez.status.application.form.service.service.SezDevGeneralBusinessIfoService;
...
/**
 * Provides the base implementation for the sez dev general business ifo remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDevGeneralBusinessIfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDevGeneralBusinessIfoServiceImpl
 * @generated
 */
public abstract class SezDevGeneralBusinessIfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDevGeneralBusinessIfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDevGeneralBusinessIfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDevGeneralBusinessIfoService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDevGeneralBusinessIfoService =
			(SezDevGeneralBusinessIfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDevGeneralBusinessIfoService.class.getName();
	}
	...
	protected SezDevGeneralBusinessIfoService sezDevGeneralBusinessIfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDevGeneralBusinessIfoServiceBaseImpl.class);
