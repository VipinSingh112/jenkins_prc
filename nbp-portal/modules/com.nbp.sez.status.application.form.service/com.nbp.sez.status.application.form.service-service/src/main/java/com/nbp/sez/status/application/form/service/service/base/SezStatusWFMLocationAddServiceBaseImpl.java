...
import com.nbp.sez.status.application.form.service.service.SezStatusWFMLocationAddService;
...
/**
 * Provides the base implementation for the sez status wfm location add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezStatusWFMLocationAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezStatusWFMLocationAddServiceImpl
 * @generated
 */
public abstract class SezStatusWFMLocationAddServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusWFMLocationAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezStatusWFMLocationAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusWFMLocationAddService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusWFMLocationAddService =
			(SezStatusWFMLocationAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusWFMLocationAddService.class.getName();
	}
	...
	protected com.nbp.sez.status.application.form.service.service.
		SezStatusWFMLocationAddLocalService sezStatusWFMLocationAddLocalService;

	protected SezStatusWFMLocationAddService sezStatusWFMLocationAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusWFMLocationAddServiceBaseImpl.class);
