...
import com.nbp.sez.status.application.form.service.service.SezOccLocationAddService;
...
/**
 * Provides the base implementation for the sez occ location add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezOccLocationAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezOccLocationAddServiceImpl
 * @generated
 */
public abstract class SezOccLocationAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezOccLocationAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezOccLocationAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezOccLocationAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezOccLocationAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezOccLocationAddService = (SezOccLocationAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezOccLocationAddService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezOccLocationAddPersistence.getDataSource();
	...
	protected SezOccLocationAddService sezOccLocationAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezOccLocationAddServiceBaseImpl.class);
