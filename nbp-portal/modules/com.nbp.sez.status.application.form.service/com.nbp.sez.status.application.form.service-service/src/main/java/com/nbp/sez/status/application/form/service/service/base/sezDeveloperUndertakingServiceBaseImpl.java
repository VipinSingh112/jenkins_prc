...
import com.nbp.sez.status.application.form.service.service.sezDeveloperUndertakingService;
...
/**
 * Provides the base implementation for the sez developer undertaking remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.sezDeveloperUndertakingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.sezDeveloperUndertakingServiceImpl
 * @generated
 */
public abstract class sezDeveloperUndertakingServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>sezDeveloperUndertakingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.sezDeveloperUndertakingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			sezDeveloperUndertakingService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezDeveloperUndertakingService =
			(sezDeveloperUndertakingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return sezDeveloperUndertakingService.class.getName();
	}
	...
	protected com.nbp.sez.status.application.form.service.service.
		sezDeveloperUndertakingLocalService sezDeveloperUndertakingLocalService;

	protected sezDeveloperUndertakingService sezDeveloperUndertakingService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		sezDeveloperUndertakingServiceBaseImpl.class);
