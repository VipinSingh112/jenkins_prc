...
import com.nbp.sez.status.application.form.service.service.SezZoneProposedProjectInfoService;
...
/**
 * Provides the base implementation for the sez zone proposed project info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezZoneProposedProjectInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezZoneProposedProjectInfoServiceImpl
 * @generated
 */
public abstract class SezZoneProposedProjectInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezZoneProposedProjectInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezZoneProposedProjectInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezZoneProposedProjectInfoService =
			(SezZoneProposedProjectInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezZoneProposedProjectInfoService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezZoneProposedProjectInfoPersistence.getDataSource();
	...
	protected SezZoneProposedProjectInfoService
		sezZoneProposedProjectInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezZoneProposedProjectInfoServiceBaseImpl.class);
