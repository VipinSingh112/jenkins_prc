...
import com.nbp.sez.status.application.form.service.service.SezDeveloperDetailsService;
...
/**
 * Provides the base implementation for the sez developer details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.form.service.service.impl.SezDeveloperDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.form.service.service.impl.SezDeveloperDetailsServiceImpl
 * @generated
 */
public abstract class SezDeveloperDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SezDeveloperDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezDeveloperDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.form.service.service.SezDeveloperDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezDeveloperDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezDeveloperDetailsService = (SezDeveloperDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezDeveloperDetailsService.class.getName();
	}
	...
	protected SezDeveloperDetailsService sezDeveloperDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezDeveloperDetailsServiceBaseImpl.class);
