...
/**
 * Provides the local service interface for MiningApplicationCertificateIssuance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiningApplicationCertificateIssuanceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiningApplicationCertificateIssuanceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.mining.stage.service.service.impl.MiningApplicationCertificateIssuanceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mining application certificate issuance local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiningApplicationCertificateIssuanceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MiningApplicationCertificateIssuance updateMiningCertificateIssuance(
		String caseId, String status, Date dateCertificateIssued,
		Date dateOfExpiration, String certificateNumber);

	public MiningApplicationCertificateIssuance updateMiningCertificateIssuance(
		String caseId, String status, Date dateCertificateIssued,
		Date dateOfExpiration, String certificateNumber, long docId);
