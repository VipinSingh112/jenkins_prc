...
/**
 * Provides the local service interface for MiningApplicationDeskVeri. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiningApplicationDeskVeriLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiningApplicationDeskVeriLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.mining.stage.service.service.impl.MiningApplicationDeskVeriLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mining application desk veri local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiningApplicationDeskVeriLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MiningApplicationDeskVeri> getMiningDeskVerification(
		long applicationId);
