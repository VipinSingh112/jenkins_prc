...
import com.nbp.mining.stage.service.service.MiningApplicationStagesLocalService;
...
/**
 * Provides the base implementation for the mining application stages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.stage.service.service.impl.MiningApplicationStagesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.stage.service.service.impl.MiningApplicationStagesLocalServiceImpl
 * @generated
 */
public abstract class MiningApplicationStagesLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningApplicationStagesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.stage.service.service.MiningApplicationStagesLocalServiceUtil</code>.
	 */
	...
	public MiningApplicationStages addMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.update(
	...
	public MiningApplicationStages createMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.create(miningStagesId);
	}
	...
	public MiningApplicationStages deleteMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.remove(miningStagesId);
	}
	...
	public MiningApplicationStages deleteMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.remove(
			miningApplicationStages);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return miningApplicationStagesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MiningApplicationStages.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return miningApplicationStagesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return miningApplicationStagesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public MiningApplicationStages fetchMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.fetchByPrimaryKey(
			miningStagesId);
	}
	...
	public MiningApplicationStages fetchMiningApplicationStagesByUuidAndGroupId(
		...
		return miningApplicationStagesPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public MiningApplicationStages getMiningApplicationStages(
		...
		return miningApplicationStagesPersistence.findByPrimaryKey(
			miningStagesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MiningApplicationStages.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("miningStagesId");
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, miningApplicationStages);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					MiningApplicationStages.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return miningApplicationStagesPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MiningApplicationStagesLocalServiceImpl#deleteMiningApplicationStages(MiningApplicationStages) to avoid orphaned data");
		}

		return miningApplicationStagesLocalService.
			deleteMiningApplicationStages(
				(MiningApplicationStages)persistedModel);
	}

	@Override
	public BasePersistence<MiningApplicationStages> getBasePersistence() {
		return miningApplicationStagesPersistence;
	}
	...
	public List<MiningApplicationStages>
		...
		return miningApplicationStagesPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<MiningApplicationStages>
		...
		return miningApplicationStagesPersistence.findByUuid_C(
	...
	public MiningApplicationStages getMiningApplicationStagesByUuidAndGroupId(
		...
		return miningApplicationStagesPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<MiningApplicationStages> getMiningApplicationStageses(
		...
		return miningApplicationStagesPersistence.findAll(start, end);
	}
	...
	public int getMiningApplicationStagesesCount() {
		return miningApplicationStagesPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		miningApplicationStagesLocalService =
			(MiningApplicationStagesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningApplicationStagesLocalService.class.getName();
	}
	...
	protected MiningApplicationStagesLocalService
		miningApplicationStagesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningApplicationStagesLocalServiceBaseImpl.class);
