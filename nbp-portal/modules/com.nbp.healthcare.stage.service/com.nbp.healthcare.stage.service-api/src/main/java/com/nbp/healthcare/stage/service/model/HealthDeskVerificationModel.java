...
/**
 * The base model interface for the HealthDeskVerification service. Represents a row in the &quot;nbp_health_desk_verifica&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.healthcare.stage.service.model.impl.HealthDeskVerificationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.healthcare.stage.service.model.impl.HealthDeskVerificationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface HealthDeskVerificationModel
	extends BaseModel<HealthDeskVerification>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a health desk verification model instance should use the {@link HealthDeskVerification} interface instead.
	 */
