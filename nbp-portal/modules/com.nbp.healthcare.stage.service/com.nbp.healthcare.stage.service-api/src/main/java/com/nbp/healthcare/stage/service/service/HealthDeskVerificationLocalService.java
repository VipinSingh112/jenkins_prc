...
/**
 * Provides the local service interface for HealthDeskVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HealthDeskVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HealthDeskVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.healthcare.stage.service.service.impl.HealthDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the health desk verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HealthDeskVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<HealthDeskVerification> healthCareDeskVerification(
