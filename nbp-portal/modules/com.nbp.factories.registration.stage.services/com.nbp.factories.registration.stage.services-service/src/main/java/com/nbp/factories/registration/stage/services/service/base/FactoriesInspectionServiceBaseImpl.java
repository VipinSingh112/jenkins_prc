...
import com.nbp.factories.registration.stage.services.service.FactoriesInspectionService;
...
/**
 * Provides the base implementation for the factories inspection remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.factories.registration.stage.services.service.impl.FactoriesInspectionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.factories.registration.stage.services.service.impl.FactoriesInspectionServiceImpl
 * @generated
 */
public abstract class FactoriesInspectionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FactoriesInspectionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FactoriesInspectionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.factories.registration.stage.services.service.FactoriesInspectionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FactoriesInspectionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		factoriesInspectionService = (FactoriesInspectionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FactoriesInspectionService.class.getName();
	}
	...
	protected FactoriesInspectionService factoriesInspectionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FactoriesInspectionServiceBaseImpl.class);
