...
import com.nbp.factories.registration.stage.services.service.FactoryPaymentVerificationLocalService;
...
/**
 * Provides the base implementation for the factory payment verification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.factories.registration.stage.services.service.impl.FactoryPaymentVerificationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.factories.registration.stage.services.service.impl.FactoryPaymentVerificationLocalServiceImpl
 * @generated
 */
public abstract class FactoryPaymentVerificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FactoryPaymentVerificationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FactoryPaymentVerificationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.factories.registration.stage.services.service.FactoryPaymentVerificationLocalServiceUtil</code>.
	 */
	...
	public FactoryPaymentVerification addFactoryPaymentVerification(
		...
		return factoryPaymentVerificationPersistence.update(
	...
	public FactoryPaymentVerification createFactoryPaymentVerification(
		...
		return factoryPaymentVerificationPersistence.create(
	...
	public FactoryPaymentVerification deleteFactoryPaymentVerification(
		...
		return factoryPaymentVerificationPersistence.remove(
			factoryPaymentVerificationId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return factoryPaymentVerificationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FactoryPaymentVerification.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return factoryPaymentVerificationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return factoryPaymentVerificationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FactoryPaymentVerification fetchFactoryPaymentVerification(
		...
		return factoryPaymentVerificationPersistence.fetchByPrimaryKey(
			factoryPaymentVerificationId);
	}
	...
	public FactoryPaymentVerification getFactoryPaymentVerification(
		...
		return factoryPaymentVerificationPersistence.findByPrimaryKey(
			factoryPaymentVerificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FactoryPaymentVerification.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			FactoryPaymentVerification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FactoryPaymentVerificationLocalServiceImpl#deleteFactoryPaymentVerification(FactoryPaymentVerification) to avoid orphaned data");
		}

		return factoryPaymentVerificationLocalService.
			deleteFactoryPaymentVerification(
				(FactoryPaymentVerification)persistedModel);
	}

	@Override
	public BasePersistence<FactoryPaymentVerification> getBasePersistence() {
		return factoryPaymentVerificationPersistence;
	}
	...
	public List<FactoryPaymentVerification> getFactoryPaymentVerifications(
		...
		return factoryPaymentVerificationPersistence.findAll(start, end);
	}
	...
	public int getFactoryPaymentVerificationsCount() {
		return factoryPaymentVerificationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		factoryPaymentVerificationLocalService =
			(FactoryPaymentVerificationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FactoryPaymentVerificationLocalService.class.getName();
	}
	...
	protected FactoryPaymentVerificationLocalService
		factoryPaymentVerificationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FactoryPaymentVerificationLocalServiceBaseImpl.class);
