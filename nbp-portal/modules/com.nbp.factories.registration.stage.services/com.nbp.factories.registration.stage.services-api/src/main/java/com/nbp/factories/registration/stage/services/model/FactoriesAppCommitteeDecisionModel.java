...
/**
 * The base model interface for the FactoriesAppCommitteeDecision service. Represents a row in the &quot;nbp_factories_comm_decision&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.factories.registration.stage.services.model.impl.FactoriesAppCommitteeDecisionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.factories.registration.stage.services.model.impl.FactoriesAppCommitteeDecisionImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FactoriesAppCommitteeDecisionModel
	extends BaseModel<FactoriesAppCommitteeDecision>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a factories app committee decision model instance should use the {@link FactoriesAppCommitteeDecision} interface instead.
	 */
