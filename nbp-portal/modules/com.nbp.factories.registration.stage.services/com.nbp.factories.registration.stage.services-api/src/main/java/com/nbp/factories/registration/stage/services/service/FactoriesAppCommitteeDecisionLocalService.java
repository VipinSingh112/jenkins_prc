...
/**
 * Provides the local service interface for FactoriesAppCommitteeDecision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FactoriesAppCommitteeDecisionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FactoriesAppCommitteeDecisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.factories.registration.stage.services.service.impl.FactoriesAppCommitteeDecisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the factories app committee decision local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FactoriesAppCommitteeDecisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FactoriesAppCommitteeDecision> getFactory_By_CD(String status)
		throws NoSuchFactoriesAppCommitteeDecisionException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesAppCommitteeDecision getFactory_CD_CI(String caseId)
		throws NoSuchFactoriesAppCommitteeDecisionException;
	...
	public FactoriesAppCommitteeDecision
		updateQuarryApplicationCommitteeDecision(
			String caseId, Date dateOfCommitteeDecision,
