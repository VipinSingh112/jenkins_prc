...
/**
 * Provides the local service utility for FactoriesCerticateOfRegis. This utility wraps
 * <code>com.nbp.factories.registration.stage.services.service.impl.FactoriesCerticateOfRegisLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FactoriesCerticateOfRegisLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.factories.registration.stage.services.service.impl.FactoriesCerticateOfRegisLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FactoriesCerticateOfRegis addFactoriesCerticateOfRegis(
		FactoriesCerticateOfRegis factoriesCerticateOfRegis) {

		return getService().addFactoriesCerticateOfRegis(
	 ...
	 */
	public static FactoriesCerticateOfRegis createFactoriesCerticateOfRegis(
		long factoriesCerticateOfRegisId) {

		return getService().createFactoriesCerticateOfRegis(
	 ...
	 */
	public static FactoriesCerticateOfRegis deleteFactoriesCerticateOfRegis(
		FactoriesCerticateOfRegis factoriesCerticateOfRegis) {

		return getService().deleteFactoriesCerticateOfRegis(
			factoriesCerticateOfRegis);
	}
	...
	public static FactoriesCerticateOfRegis fetchFactoriesCerticateOfRegis(
		long factoriesCerticateOfRegisId) {

		return getService().fetchFactoriesCerticateOfRegis(
			factoriesCerticateOfRegisId);
	}
	 ...
	 * @throws PortalException if a factories certicate of regis with the primary key could not be found
	 */
	public static FactoriesCerticateOfRegis getFactoriesCerticateOfRegis(
			long factoriesCerticateOfRegisId)
		throws PortalException {

		return getService().getFactoriesCerticateOfRegis(
			factoriesCerticateOfRegisId);
	}
	...
	public static List<FactoriesCerticateOfRegis>
		getFactoriesCerticateOfRegises(int start, int end) {

		return getService().getFactoriesCerticateOfRegises(start, end);
	}
	 ...
	 */
	public static int getFactoriesCerticateOfRegisesCount() {
		return getService().getFactoriesCerticateOfRegisesCount();
	}

	public static FactoriesCerticateOfRegis getFactoryCertifiResgiBy_CI(
			String caseId)
		throws com.nbp.factories.registration.stage.services.exception.
			NoSuchFactoriesCerticateOfRegisException {

		return getService().getFactoryCertifiResgiBy_CI(caseId);
	}

	public static List<FactoriesCerticateOfRegis> getFactoryCertifiResgisBy_CI(
		String caseId) {

		return getService().getFactoryCertifiResgisBy_CI(caseId);
	}
	 ...
	 */
	public static FactoriesCerticateOfRegis updateFactoriesCerticateOfRegis(
		FactoriesCerticateOfRegis factoriesCerticateOfRegis) {

		return getService().updateFactoriesCerticateOfRegis(
			factoriesCerticateOfRegis);
	}
	...
	public static FactoriesCerticateOfRegis
		...
		return getService().updateFactoriesCertificateOfRegistration(
			caseId, nameOfEstablishment, parish, procuctCatAndName,
			certificateIssueDate, dateOfExpiration, registration, status);
	}

	public static FactoriesCerticateOfRegisLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FactoriesCerticateOfRegisLocalService>
		_serviceSnapshot = new Snapshot<>(
			FactoriesCerticateOfRegisLocalServiceUtil.class,
