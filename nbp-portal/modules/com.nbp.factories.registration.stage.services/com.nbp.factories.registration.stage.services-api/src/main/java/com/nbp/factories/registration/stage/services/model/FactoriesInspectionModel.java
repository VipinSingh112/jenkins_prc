...
/**
 * The base model interface for the FactoriesInspection service. Represents a row in the &quot;nbp_factories_inspection&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.factories.registration.stage.services.model.impl.FactoriesInspectionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.factories.registration.stage.services.model.impl.FactoriesInspectionImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FactoriesInspectionModel
	extends BaseModel<FactoriesInspection>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a factories inspection model instance should use the {@link FactoriesInspection} interface instead.
	 */
