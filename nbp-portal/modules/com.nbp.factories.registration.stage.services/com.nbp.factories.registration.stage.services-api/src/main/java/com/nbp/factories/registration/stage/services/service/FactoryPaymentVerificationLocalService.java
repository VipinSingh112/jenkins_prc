...
/**
 * Provides the local service interface for FactoryPaymentVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FactoryPaymentVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FactoryPaymentVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.factories.registration.stage.services.service.impl.FactoryPaymentVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the factory payment verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FactoryPaymentVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FactoryPaymentVerification addFactoryPaymentVerification(
	...
	public FactoryPaymentVerification createFactoryPaymentVerification(
	...
	public FactoryPaymentVerification deleteFactoryPaymentVerification(
		FactoryPaymentVerification factoryPaymentVerification);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoryPaymentVerification fetchFactoryPaymentVerification(
		long factoryPaymentVerificationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FactoryPaymentVerification> getFactoryPayConfBy_CI(
		String caseId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoryPaymentVerification getFactoryPaymentConfBy_CI(String caseId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoryPaymentVerification getFactoryPaymentVerification(
			long factoryPaymentVerificationId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FactoryPaymentVerification> getFactoryPaymentVerifications(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FactoryPaymentVerification updateFactoryPaymentVerification(
		FactoryPaymentVerification factoryPaymentVerification);
