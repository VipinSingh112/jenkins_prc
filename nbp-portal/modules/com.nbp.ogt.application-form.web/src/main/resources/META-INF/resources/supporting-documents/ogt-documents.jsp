...
<fieldset class="wizard-fieldset" id="ogtSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<p class="common-section-small-heading mb-2">Statement of account showing the particulars of the claim, such as:</p>
	<div id="documentList">
	</div>
	<input type="hidden" id="ogtDocumentuploadCounter" name="ogtDocumentuploadCounter">
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="ogtServiceGenericUpload" multiple="multiple" name="<portlet:namespace/>ogtServiceGenericUpload"
			onchange="attachDetailed(this.id)"
				hidden="">
				 <label class="custom-upload" for="ogtServiceGenericUpload"> 
				 <span class="mr-2"> 
			...
			<span id="ogtGenericServiceFileChosen"></span>
		</div>
		...
		<% 
				...
				if(ogtApplicationId>0 && dlFileEntriesGeneric!=null){
					try{
						int docOfOgtAdditionalCounter=1001;
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						...
						%>	
	 		<div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfOgtAdditionalCounter%>">
				<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfOgtAdditionalCounter%>">
						<%
						%>
						<div class="uploaded-info generic-doc" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
							...
							<div class="right">
								...
								<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=docOfOgtAdditionalCounter%>')">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="ogtServicesEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>ogtServicesEnrollDocuments">
							...
							<input type="hidden" id="ogtServicesDocumentuploadCounter" name="ogtServicesDocumentuploadCounter">
							<div class="col-md-12">
