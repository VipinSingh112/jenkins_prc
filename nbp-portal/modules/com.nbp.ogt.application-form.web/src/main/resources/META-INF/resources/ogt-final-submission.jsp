	...
	<div class="col-md-8 mx-auto">
		<div class="final-submit-container hide">
			<div class="final-submit-img">
				<img src="<%=themeDisplay.getPathThemeImages()%>/popup.png" class="img-fluid hide"
					id="application_submitted-img" />
				<img src="<%=themeDisplay.getPathThemeImages()%>/failed-popup.png"
					class="img-fluid hide" id="application_draft-img" />
			</div>
			<div class="final-submit-content commonsavepopup">
				<div class="row">
					<div class="col-md-12 hide" id="submitted-content">
						...
						<p class="modal-subtitle f2">
							Congratulations! Your Proof of Claim for <span
								class="submit_pop_category"></span> has been submitted
							successfully.
						</p>
						<p class="modal-info f2">In the next months you will need to
							collaborate with the OGT in order to move this application
							forward. You may be asked to provide additional or updated
							documentation.</p>
						<p class="modal-info f2">
							When this happens you will be able to track your application and
							collaborate with the OGT in <a href="/group/guest/dashboard">your
								Dashboard:</a>
						</p>
					</div>
					<div class="col-md-12 hide" id="draft-content">
						...
						<p class="modal-subtitle f2">
							Your Proof of Claim for <span class="submit_pop_category"></span> has
							failed to be submitted to the OGT>
						<p class="modal-info f2">
							Please submit the Application after sometime from <a
							...
							<div class="row">
								<div class="col-lg-4 d-flex align-items-center">
									<div class="licence-box mr-2 ml-2">
										...
										<div class="right pl-2">
											<p class="licence-title f2">OGT Services</p>
								...
								<div class="col-lg-4 d-flex justify-content-center">
									<div class="tier-box">
										...
										<p class="tier-box-upper f2 submit_pop_category"></p>
									</div>
								</div>
								<div class="col-lg-4 d-flex justify-content-center">
									<div class="status-box">
										<p class="tier-box-upper f2">Status</p>
										<a href="javascript:void(0);" class="draftlink f2"
											id="submit_pop_status"></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="full-width-btn-wrapper hide"
							id="continueDashboardOGTStatus">
							<a href="javascript:void(0);" class="details-btn"
								onclick="getSingleOgtApplicationDashboard();">Continue to your
								application details page <span class="ml-2"> <svg
					...
					<div class="col-md-12">
						<p class="modal-info f2">You will be notified at the following
							email address that you provided during your account registration:</p>
					</div>
...
<script>
function getSingleOgtApplicationDashboard() {
	ogtApplicationId=$("#ogtApplicationId").val();
	window.location.href = "/group/guest/ogt-dashboard?ogtApplicationId="
			+ ogtApplicationId;
}
</script>