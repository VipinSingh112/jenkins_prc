...
if(Validator.isNotNull(request.getAttribute("ogtApplicationId"))){
ogtAppId= String.valueOf(request.getAttribute("ogtApplicationId"));
}
...
<div id="requiredDoc">
	<div class="supporting-document-card mb-3">
		<div class="row">
			<div class="col-md-12">
				<div class="supporting-document-card-wrapper">
					<div class="left">
						<p class="supporting-document-card-upper-heading" id="requiredDoc<%=counterOfDocuments%>"><%=documentNames%>
						</p>
					</div>
		...
		<!-- <div class="row" id="documentChecklist">
			<div class="col-md-6">
				<div class="form-group">
					<p class="tab-form-main-heading">Reason for Non-Provision</p>
					<input type="text" class="form-control" id="nonProvisionReasonReq"
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="date" class="form-control" id="expectedDateReq"
						placeholder="" value="">
				</div>
			</div>
		</div> -->
