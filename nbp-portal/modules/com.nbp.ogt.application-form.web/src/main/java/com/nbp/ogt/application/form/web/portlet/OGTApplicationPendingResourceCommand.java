...
@Component
	...
	property = {
		...
		"mvc.command.name=/ogt/pending" }, service = MVCResourceCommand.class)

public class OGTApplicationPendingResourceCommand implements MVCResourceCommand{
	private static Log _log = LogFactoryUtil.getLog(OGTApplicationPendingResourceCommand.class.getName());
	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		JSONObject jsonFeed = JSONFactoryUtil.createJSONObject();
			...
			_log.info("OGT Pending Resource Command Start");
