...
import com.nbp.cannabis.application.form.services.service.CannabisFeeMasterService;
...
/**
 * Provides the base implementation for the cannabis fee master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.cannabis.application.form.services.service.impl.CannabisFeeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.cannabis.application.form.services.service.impl.CannabisFeeMasterServiceImpl
 * @generated
 */
public abstract class CannabisFeeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisFeeMasterService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisFeeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.cannabis.application.form.services.service.CannabisFeeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CannabisFeeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cannabisFeeMasterService = (CannabisFeeMasterService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisFeeMasterService.class.getName();
	}
	...
	protected CannabisFeeMasterService cannabisFeeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisFeeMasterServiceBaseImpl.class);
