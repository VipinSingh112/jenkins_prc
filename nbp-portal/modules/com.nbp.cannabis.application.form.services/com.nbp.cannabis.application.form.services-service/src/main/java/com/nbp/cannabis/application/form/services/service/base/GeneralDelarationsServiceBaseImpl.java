...
import com.nbp.cannabis.application.form.services.service.GeneralDelarationsService;
...
/**
 * Provides the base implementation for the general delarations remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.cannabis.application.form.services.service.impl.GeneralDelarationsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.cannabis.application.form.services.service.impl.GeneralDelarationsServiceImpl
 * @generated
 */
public abstract class GeneralDelarationsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GeneralDelarationsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GeneralDelarationsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.cannabis.application.form.services.service.GeneralDelarationsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GeneralDelarationsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		generalDelarationsService = (GeneralDelarationsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GeneralDelarationsService.class.getName();
	}
	...
	protected GeneralDelarationsService generalDelarationsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GeneralDelarationsServiceBaseImpl.class);
