...
import com.nbp.cannabis.application.form.services.service.CannabisApplicationsService;
...
/**
 * Provides the base implementation for the cannabis applications remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.cannabis.application.form.services.service.impl.CannabisApplicationsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.cannabis.application.form.services.service.impl.CannabisApplicationsServiceImpl
 * @generated
 */
public abstract class CannabisApplicationsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisApplicationsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisApplicationsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.cannabis.application.form.services.service.CannabisApplicationsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CannabisApplicationsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cannabisApplicationsService = (CannabisApplicationsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisApplicationsService.class.getName();
	}
	...
	protected CannabisApplicationsService cannabisApplicationsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisApplicationsServiceBaseImpl.class);
