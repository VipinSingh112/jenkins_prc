...
/**
 * Provides the local service utility for CannabisSupportingDocumentsMaster. This utility wraps
 * <code>com.nbp.cannabis.application.form.services.service.impl.CannabisSupportingDocumentsMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CannabisSupportingDocumentsMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.cannabis.application.form.services.service.impl.CannabisSupportingDocumentsMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().addCannabisSupportingDocumentsMaster(
			cannabisSupportingDocumentsMaster);
	}
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().createCannabisSupportingDocumentsMaster(
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().deleteCannabisSupportingDocumentsMaster(
			cannabisSupportingDocumentsMaster);
	}
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().fetchCannabisSupportingDocumentsMaster(
			cannabisSupportingDocMasterId);
	}
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().getCannabisSupportingDocumentsMaster(
			cannabisSupportingDocMasterId);
	}
	...
	public static List<CannabisSupportingDocumentsMaster>
		...
		return getService().getCannabisSupportingDocumentsMasters(start, end);
	}
	 ...
	 */
	public static int getCannabisSupportingDocumentsMastersCount() {
		return getService().getCannabisSupportingDocumentsMastersCount();
	}
	...
	public static List<CannabisSupportingDocumentsMaster>
		getSupportingDocApplicant(
			String documentTye, String userType, String applicationType) {

		return getService().getSupportingDocApplicant(
	...
	public static List<CannabisSupportingDocumentsMaster>
		...
		return getService().getSupportingDocProperty(
	...
	public static CannabisSupportingDocumentsMaster
		...
		return getService().updateCannabisSupportingDocumentsMaster(
			cannabisSupportingDocumentsMaster);
	}

	public static CannabisSupportingDocumentsMasterLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CannabisSupportingDocumentsMasterLocalService>
		_serviceSnapshot = new Snapshot<>(
			CannabisSupportingDocumentsMasterLocalServiceUtil.class,
			CannabisSupportingDocumentsMasterLocalService.class);
