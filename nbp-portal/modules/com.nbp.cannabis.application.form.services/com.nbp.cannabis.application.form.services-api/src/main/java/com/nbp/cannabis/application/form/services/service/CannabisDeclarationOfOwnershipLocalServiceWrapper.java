...
/**
 * Provides a wrapper for {@link CannabisDeclarationOfOwnershipLocalService}.
 *
 * @author Brian Wing Shun Chan
 * @see CannabisDeclarationOfOwnershipLocalService
 * @generated
 */
public class CannabisDeclarationOfOwnershipLocalServiceWrapper
	implements CannabisDeclarationOfOwnershipLocalService,
			   ServiceWrapper<CannabisDeclarationOfOwnershipLocalService> {

	public CannabisDeclarationOfOwnershipLocalServiceWrapper() {
		this(null);
	}
	...
	public CannabisDeclarationOfOwnershipLocalServiceWrapper(
		...
		_cannabisDeclarationOfOwnershipLocalService =
			cannabisDeclarationOfOwnershipLocalService;
	}
	...
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership addCannabisDeclarationOfOwnership(
			com.nbp.cannabis.application.form.services.model.
				CannabisDeclarationOfOwnership cannabisDeclarationOfOwnership) {

		return _cannabisDeclarationOfOwnershipLocalService.
			addCannabisDeclarationOfOwnership(cannabisDeclarationOfOwnership);
	}
	...
	@Override
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership createCannabisDeclarationOfOwnership(
			long cannabisDecOfOwnershipId) {

		return _cannabisDeclarationOfOwnershipLocalService.
			createCannabisDeclarationOfOwnership(cannabisDecOfOwnershipId);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _cannabisDeclarationOfOwnershipLocalService.createPersistedModel(
			primaryKeyObj);
	}

	@Override
	public void deleteCA_DO_BY_Id(long cannabisId) {
		_cannabisDeclarationOfOwnershipLocalService.deleteCA_DO_BY_Id(
			cannabisId);
	}

	@Override
	public void deleteCA_DO_CAI(long cannabisAppicationId) {
		_cannabisDeclarationOfOwnershipLocalService.deleteCA_DO_CAI(
	...
	@Override
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership deleteCannabisDeclarationOfOwnership(
			com.nbp.cannabis.application.form.services.model.
				CannabisDeclarationOfOwnership cannabisDeclarationOfOwnership) {
	...
	public com.nbp.cannabis.application.form.services.model.
		...
		return _cannabisDeclarationOfOwnershipLocalService.
			deleteCannabisDeclarationOfOwnership(cannabisDecOfOwnershipId);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _cannabisDeclarationOfOwnershipLocalService.deletePersistedModel(
			persistedModel);
	}

	@Override
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _cannabisDeclarationOfOwnershipLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _cannabisDeclarationOfOwnershipLocalService.dslQueryCount(
			dslQuery);
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _cannabisDeclarationOfOwnershipLocalService.dynamicQuery();
	}
	...
	public long dynamicQueryCount(
		...
		return _cannabisDeclarationOfOwnershipLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	@Override
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership fetchCannabisDeclarationOfOwnership(
			long cannabisDecOfOwnershipId) {

		return _cannabisDeclarationOfOwnershipLocalService.
			fetchCannabisDeclarationOfOwnership(cannabisDecOfOwnershipId);
	}
	...
	public com.nbp.cannabis.application.form.services.model.
		...
		return _cannabisDeclarationOfOwnershipLocalService.
			fetchCannabisDeclarationOfOwnershipByUuidAndGroupId(uuid, groupId);
	}
	...
	public java.util.List
		<com.nbp.cannabis.application.form.services.model.
			CannabisDeclarationOfOwnership> getCA_DO_CAI(
				long cannabisAppicationId) {

		return _cannabisDeclarationOfOwnershipLocalService.getCA_DO_CAI(
			cannabisAppicationId);
	}
	...
	@Override
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership getCannabisDeclarationOfOwnership(
				long cannabisDecOfOwnershipId)
			throws com.liferay.portal.kernel.exception.PortalException {

		return _cannabisDeclarationOfOwnershipLocalService.
			getCannabisDeclarationOfOwnership(cannabisDecOfOwnershipId);
	}
	...
	public com.nbp.cannabis.application.form.services.model.
		...
		return _cannabisDeclarationOfOwnershipLocalService.
			getCannabisDeclarationOfOwnershipByUuidAndGroupId(uuid, groupId);
	}
	...
	public java.util.List
		<com.nbp.cannabis.application.form.services.model.
			CannabisDeclarationOfOwnership> getCannabisDeclarationOfOwnerships(
				int start, int end) {

		return _cannabisDeclarationOfOwnershipLocalService.
			getCannabisDeclarationOfOwnerships(start, end);
	}
	...
	public int getCannabisDeclarationOfOwnershipsCount() {
		return _cannabisDeclarationOfOwnershipLocalService.
			getCannabisDeclarationOfOwnershipsCount();
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _cannabisDeclarationOfOwnershipLocalService.getPersistedModel(
			primaryKeyObj);
	}
	...
	@Override
	public com.nbp.cannabis.application.form.services.model.
		CannabisDeclarationOfOwnership updateCannabisDeclarationOfOwnership(
			com.nbp.cannabis.application.form.services.model.
				CannabisDeclarationOfOwnership cannabisDeclarationOfOwnership) {
	...
	public BasePersistence<?> getBasePersistence() {
		return _cannabisDeclarationOfOwnershipLocalService.getBasePersistence();
	}

	@Override
	public CannabisDeclarationOfOwnershipLocalService getWrappedService() {
		return _cannabisDeclarationOfOwnershipLocalService;
	}
	...
	private CannabisDeclarationOfOwnershipLocalService
		_cannabisDeclarationOfOwnershipLocalService;
