...
import com.nbp.osi.services.application.form.service.service.persistence.OsiServicesAssignmentDetailinfoUtil;
...
/**
 * The persistence implementation for the osi services assignment detailinfo service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = OsiServicesAssignmentDetailinfoPersistence.class)
public class OsiServicesAssignmentDetailinfoPersistenceImpl
	extends BasePersistenceImpl<OsiServicesAssignmentDetailinfo>
	implements OsiServicesAssignmentDetailinfoPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>OsiServicesAssignmentDetailinfoUtil</code> to access the osi services assignment detailinfo persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		OsiServicesAssignmentDetailinfoImpl.class.getName();
	 ...
	 */
	@Override
	public List<OsiServicesAssignmentDetailinfo> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<OsiServicesAssignmentDetailinfo> findByUuid(
	...
	public List<OsiServicesAssignmentDetailinfo> findByUuid(
		...
		List<OsiServicesAssignmentDetailinfo> list = null;

		if (useFinderCache) {
			list = (List<OsiServicesAssignmentDetailinfo>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (OsiServicesAssignmentDetailinfo
						osiServicesAssignmentDetailinfo : list) {

					if (!uuid.equals(
							osiServicesAssignmentDetailinfo.getUuid())) {
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(
					OsiServicesAssignmentDetailinfoModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<OsiServicesAssignmentDetailinfo>)QueryUtil.list(
	...
	public OsiServicesAssignmentDetailinfo findByUuid_First(
		...
		if (osiServicesAssignmentDetailinfo != null) {
			return osiServicesAssignmentDetailinfo;
		}
		...
		throw new NoSuchOsiServicesAssignmentDetailinfoException(sb.toString());
	}
	...
	public OsiServicesAssignmentDetailinfo fetchByUuid_First(
		...
		List<OsiServicesAssignmentDetailinfo> list = findByUuid(
	...
	public OsiServicesAssignmentDetailinfo[] findByUuid_PrevAndNext(
		...
		try {
			...
			OsiServicesAssignmentDetailinfo[] array =
				new OsiServicesAssignmentDetailinfoImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, osiServicesAssignmentDetailinfo, uuid,
				orderByComparator, true);

			array[1] = osiServicesAssignmentDetailinfo;
	...
	protected OsiServicesAssignmentDetailinfo getByUuid_PrevAndNext(
		Session session,
		OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo,
		String uuid,
		OrderByComparator<OsiServicesAssignmentDetailinfo> orderByComparator,
		...
		if (orderByComparator != null) {
			...
			sb.append(OsiServicesAssignmentDetailinfoModelImpl.ORDER_BY_JPQL);
		}
		...
		List<OsiServicesAssignmentDetailinfo> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(osiServicesAssignmentDetailinfo);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_OSISERVICESASSIGNMENTDETAILINFO_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"osiServicesAssignmentDetailinfo.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(osiServicesAssignmentDetailinfo.uuid IS NULL OR osiServicesAssignmentDetailinfo.uuid = '')";
	...
	public OsiServicesAssignmentDetailinfo findByUUID_G(
		...
		if (osiServicesAssignmentDetailinfo == null) {
			...
			throw new NoSuchOsiServicesAssignmentDetailinfoException(
				sb.toString());
		}
	...
	public OsiServicesAssignmentDetailinfo fetchByUUID_G(
		...
		if (result instanceof OsiServicesAssignmentDetailinfo) {
			OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo =
				(OsiServicesAssignmentDetailinfo)result;
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					OsiServicesAssignmentDetailinfo
						osiServicesAssignmentDetailinfo = list.get(0);

					result = osiServicesAssignmentDetailinfo;

					cacheResult(osiServicesAssignmentDetailinfo);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (OsiServicesAssignmentDetailinfo)result;
		}
	}
	...
	public OsiServicesAssignmentDetailinfo removeByUUID_G(
		...
		return remove(osiServicesAssignmentDetailinfo);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"osiServicesAssignmentDetailinfo.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(osiServicesAssignmentDetailinfo.uuid IS NULL OR osiServicesAssignmentDetailinfo.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"osiServicesAssignmentDetailinfo.groupId = ?";
	 ...
	 */
	@Override
	public List<OsiServicesAssignmentDetailinfo> findByUuid_C(
			...
			if ((list != null) && !list.isEmpty()) {
				for (OsiServicesAssignmentDetailinfo
					...
					if (!uuid.equals(
							osiServicesAssignmentDetailinfo.getUuid()) ||
						(companyId !=
							osiServicesAssignmentDetailinfo.getCompanyId())) {
	...
	public OsiServicesAssignmentDetailinfo fetchByUuid_C_First(
		...
		List<OsiServicesAssignmentDetailinfo> list = findByUuid_C(
	...
	public OsiServicesAssignmentDetailinfo[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, osiServicesAssignmentDetailinfo, uuid, companyId,
				orderByComparator, true);
	...
	protected OsiServicesAssignmentDetailinfo getByUuid_C_PrevAndNext(
		Session session,
		OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo,
		String uuid, long companyId,
		OrderByComparator<OsiServicesAssignmentDetailinfo> orderByComparator,
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"osiServicesAssignmentDetailinfo.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"OsiServicesAssignmentDetailinfoPersistenceImpl.fetchBygetOsiServicesById(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETOSISERVICESBYID_OSISERVICESAPPLICATIONID_2 =
			"osiServicesAssignmentDetailinfo.osiServicesApplicationId = ?";

	public OsiServicesAssignmentDetailinfoPersistenceImpl() {
		...
		setModelClass(OsiServicesAssignmentDetailinfo.class);

		setModelImplClass(OsiServicesAssignmentDetailinfoImpl.class);
		setModelPKClass(long.class);

		setTable(OsiServicesAssignmentDetailinfoTable.INSTANCE);
	}
	...
	public void cacheResult(
		...
		entityCache.putResult(
			OsiServicesAssignmentDetailinfoImpl.class,
			osiServicesAssignmentDetailinfo.getPrimaryKey(),
			osiServicesAssignmentDetailinfo);
		...
		finderCache.putResult(
			...
			new Object[] {
				osiServicesAssignmentDetailinfo.getUuid(),
				osiServicesAssignmentDetailinfo.getGroupId()
			},
			osiServicesAssignmentDetailinfo);
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (osiServicesAssignmentDetailinfos.size() >
		...
		for (OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo :
			...
			if (entityCache.getResult(
					OsiServicesAssignmentDetailinfoImpl.class,
					osiServicesAssignmentDetailinfo.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all osi services assignment detailinfos.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(OsiServicesAssignmentDetailinfoImpl.class);

		finderCache.clearCache(OsiServicesAssignmentDetailinfoImpl.class);
	}

	/**
	 * Clears the cache for the osi services assignment detailinfo.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				OsiServicesAssignmentDetailinfoImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			osiServicesAssignmentDetailinfoModelImpl.getUuid(),
			osiServicesAssignmentDetailinfoModelImpl.getGroupId()
		};
	...
	public OsiServicesAssignmentDetailinfo create(long osiADId) {
		...
		osiServicesAssignmentDetailinfo.setPrimaryKey(osiADId);

		String uuid = PortalUUIDUtil.generate();

		osiServicesAssignmentDetailinfo.setUuid(uuid);
	...
	public OsiServicesAssignmentDetailinfo remove(long osiADId)
		...
		return remove((Serializable)osiADId);
	}

	/**
	 * Removes the osi services assignment detailinfo with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the osi services assignment detailinfo
	 * @return the osi services assignment detailinfo that was removed
	 * @throws NoSuchOsiServicesAssignmentDetailinfoException if a osi services assignment detailinfo with the primary key could not be found
	 */
	@Override
	public OsiServicesAssignmentDetailinfo remove(Serializable primaryKey)
		throws NoSuchOsiServicesAssignmentDetailinfoException {
		...
		try {
			...
			OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo =
				(OsiServicesAssignmentDetailinfo)session.get(
					OsiServicesAssignmentDetailinfoImpl.class, primaryKey);
		...
		catch (NoSuchOsiServicesAssignmentDetailinfoException
	...
	@Override
	protected OsiServicesAssignmentDetailinfo removeImpl(
		OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo) {
		...
		try {
			...
			if (!session.contains(osiServicesAssignmentDetailinfo)) {
				osiServicesAssignmentDetailinfo =
					(OsiServicesAssignmentDetailinfo)session.get(
						OsiServicesAssignmentDetailinfoImpl.class,
						osiServicesAssignmentDetailinfo.getPrimaryKeyObj());
			}

			if (osiServicesAssignmentDetailinfo != null) {
				session.delete(osiServicesAssignmentDetailinfo);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (osiServicesAssignmentDetailinfo != null) {
			clearCache(osiServicesAssignmentDetailinfo);
		}
	...
	public OsiServicesAssignmentDetailinfo updateImpl(
		...
		boolean isNew = osiServicesAssignmentDetailinfo.isNew();

		if (!(osiServicesAssignmentDetailinfo instanceof
				OsiServicesAssignmentDetailinfoModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(
					osiServicesAssignmentDetailinfo.getClass())) {

				invocationHandler = ProxyUtil.getInvocationHandler(
					osiServicesAssignmentDetailinfo);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in osiServicesAssignmentDetailinfo proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom OsiServicesAssignmentDetailinfo implementation " +
					osiServicesAssignmentDetailinfo.getClass());
		}
		...
		if (Validator.isNull(osiServicesAssignmentDetailinfo.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew &&
			(osiServicesAssignmentDetailinfo.getCreateDate() == null)) {

			if (serviceContext == null) {
				osiServicesAssignmentDetailinfo.setCreateDate(date);
			}
			else {
		...
		if (!osiServicesAssignmentDetailinfoModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				osiServicesAssignmentDetailinfo.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(osiServicesAssignmentDetailinfo);
			}
			else {
				osiServicesAssignmentDetailinfo =
					(OsiServicesAssignmentDetailinfo)session.merge(
						osiServicesAssignmentDetailinfo);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			OsiServicesAssignmentDetailinfoImpl.class,
			osiServicesAssignmentDetailinfoModelImpl, false, true);

		cacheUniqueFindersCache(osiServicesAssignmentDetailinfoModelImpl);

		if (isNew) {
			osiServicesAssignmentDetailinfo.setNew(false);
		}

		osiServicesAssignmentDetailinfo.resetOriginalValues();

		return osiServicesAssignmentDetailinfo;
	}

	/**
	 * Returns the osi services assignment detailinfo with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the osi services assignment detailinfo
	 ...
	 */
	@Override
	public OsiServicesAssignmentDetailinfo findByPrimaryKey(
	...
	public OsiServicesAssignmentDetailinfo findByPrimaryKey(long osiADId)
		...
		return findByPrimaryKey((Serializable)osiADId);
	}
	...
	public OsiServicesAssignmentDetailinfo fetchByPrimaryKey(long osiADId) {
		return fetchByPrimaryKey((Serializable)osiADId);
	}
	 ...
	 */
	@Override
	public List<OsiServicesAssignmentDetailinfo> findAll() {
	 ...
	 */
	@Override
	public List<OsiServicesAssignmentDetailinfo> findAll(int start, int end) {
	...
	public List<OsiServicesAssignmentDetailinfo> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO);
				...
				sql = _SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO;
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_OSISERVICESASSIGNMENTDETAILINFO);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return OsiServicesAssignmentDetailinfoModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the osi services assignment detailinfo persistence.
	 */
	@Activate
	public void activate() {
		...
		OsiServicesAssignmentDetailinfoUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		OsiServicesAssignmentDetailinfoUtil.setPersistence(null);
	...
	private static final String _SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO =
		"SELECT osiServicesAssignmentDetailinfo FROM OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo";

	private static final String
		_SQL_SELECT_OSISERVICESASSIGNMENTDETAILINFO_WHERE =
			"SELECT osiServicesAssignmentDetailinfo FROM OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo WHERE ";

	private static final String _SQL_COUNT_OSISERVICESASSIGNMENTDETAILINFO =
		"SELECT COUNT(osiServicesAssignmentDetailinfo) FROM OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo";

	private static final String
		_SQL_COUNT_OSISERVICESASSIGNMENTDETAILINFO_WHERE =
			"SELECT COUNT(osiServicesAssignmentDetailinfo) FROM OsiServicesAssignmentDetailinfo osiServicesAssignmentDetailinfo WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"osiServicesAssignmentDetailinfo.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No OsiServicesAssignmentDetailinfo exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No OsiServicesAssignmentDetailinfo exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		OsiServicesAssignmentDetailinfoPersistenceImpl.class);
