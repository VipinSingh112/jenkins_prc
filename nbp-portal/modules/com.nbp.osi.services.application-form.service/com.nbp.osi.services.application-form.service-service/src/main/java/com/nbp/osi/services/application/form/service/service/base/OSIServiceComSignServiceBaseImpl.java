...
import com.nbp.osi.services.application.form.service.service.OSIServiceComSignService;
...
/**
 * Provides the base implementation for the osi service com sign remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.services.application.form.service.service.impl.OSIServiceComSignServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.services.application.form.service.service.impl.OSIServiceComSignServiceImpl
 * @generated
 */
public abstract class OSIServiceComSignServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OSIServiceComSignService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OSIServiceComSignService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.services.application.form.service.service.OSIServiceComSignServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OSIServiceComSignService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiServiceComSignService = (OSIServiceComSignService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OSIServiceComSignService.class.getName();
	}
	...
	protected OSIServiceComSignService osiServiceComSignService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OSIServiceComSignServiceBaseImpl.class);
