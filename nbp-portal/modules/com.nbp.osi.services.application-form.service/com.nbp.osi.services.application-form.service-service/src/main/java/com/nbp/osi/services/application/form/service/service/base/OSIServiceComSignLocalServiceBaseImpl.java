...
import com.nbp.osi.services.application.form.service.service.OSIServiceComSignLocalService;
...
/**
 * Provides the base implementation for the osi service com sign local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.services.application.form.service.service.impl.OSIServiceComSignLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.services.application.form.service.service.impl.OSIServiceComSignLocalServiceImpl
 * @generated
 */
public abstract class OSIServiceComSignLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OSIServiceComSignLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OSIServiceComSignLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.services.application.form.service.service.OSIServiceComSignLocalServiceUtil</code>.
	 */
	...
	public OSIServiceComSign addOSIServiceComSign(
		...
		return osiServiceComSignPersistence.update(osiServiceComSign);
	}
	...
	public OSIServiceComSign createOSIServiceComSign(long osiComSignId) {
		return osiServiceComSignPersistence.create(osiComSignId);
	}
	...
	public OSIServiceComSign deleteOSIServiceComSign(long osiComSignId)
		...
		return osiServiceComSignPersistence.remove(osiComSignId);
	}
	...
	public OSIServiceComSign deleteOSIServiceComSign(
		...
		return osiServiceComSignPersistence.remove(osiServiceComSign);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiServiceComSignPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OSIServiceComSign.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiServiceComSignPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return osiServiceComSignPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiServiceComSignPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return osiServiceComSignPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OSIServiceComSign fetchOSIServiceComSign(long osiComSignId) {
		return osiServiceComSignPersistence.fetchByPrimaryKey(osiComSignId);
	}
	...
	public OSIServiceComSign getOSIServiceComSign(long osiComSignId)
		...
		return osiServiceComSignPersistence.findByPrimaryKey(osiComSignId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OSIServiceComSign.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("osiComSignId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OSIServiceComSign.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return osiServiceComSignPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OSIServiceComSignLocalServiceImpl#deleteOSIServiceComSign(OSIServiceComSign) to avoid orphaned data");
		}

		return osiServiceComSignLocalService.deleteOSIServiceComSign(
			(OSIServiceComSign)persistedModel);
	}

	@Override
	public BasePersistence<OSIServiceComSign> getBasePersistence() {
		return osiServiceComSignPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return osiServiceComSignPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OSIServiceComSign> getOSIServiceComSigns(int start, int end) {
		return osiServiceComSignPersistence.findAll(start, end);
	}
	...
	public int getOSIServiceComSignsCount() {
		return osiServiceComSignPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OSIServiceComSignLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		osiServiceComSignLocalService = (OSIServiceComSignLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OSIServiceComSignLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				osiServiceComSignPersistence.getDataSource();
	...
	protected OSIServiceComSignLocalService osiServiceComSignLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OSIServiceComSignLocalServiceBaseImpl.class);
