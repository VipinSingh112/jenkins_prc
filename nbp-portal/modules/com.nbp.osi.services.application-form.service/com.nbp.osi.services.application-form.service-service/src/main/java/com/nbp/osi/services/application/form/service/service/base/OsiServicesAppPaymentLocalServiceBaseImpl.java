...
import com.nbp.osi.services.application.form.service.service.OsiServicesAppPaymentLocalService;
...
/**
 * Provides the base implementation for the osi services app payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.services.application.form.service.service.impl.OsiServicesAppPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.services.application.form.service.service.impl.OsiServicesAppPaymentLocalServiceImpl
 * @generated
 */
public abstract class OsiServicesAppPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiServicesAppPaymentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiServicesAppPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.services.application.form.service.service.OsiServicesAppPaymentLocalServiceUtil</code>.
	 */
	...
	public OsiServicesAppPayment addOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.update(osiServicesAppPayment);
	}
	...
	public OsiServicesAppPayment createOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.create(osiServicesAppPaymentId);
	}
	...
	public OsiServicesAppPayment deleteOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.remove(osiServicesAppPaymentId);
	}
	...
	public OsiServicesAppPayment deleteOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.remove(osiServicesAppPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiServicesAppPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OsiServicesAppPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiServicesAppPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiServicesAppPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public OsiServicesAppPayment fetchOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.fetchByPrimaryKey(
	...
	public OsiServicesAppPayment getOsiServicesAppPayment(
		...
		return osiServicesAppPaymentPersistence.findByPrimaryKey(
			osiServicesAppPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OsiServicesAppPayment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return osiServicesAppPaymentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OsiServicesAppPaymentLocalServiceImpl#deleteOsiServicesAppPayment(OsiServicesAppPayment) to avoid orphaned data");
		}

		return osiServicesAppPaymentLocalService.deleteOsiServicesAppPayment(
			(OsiServicesAppPayment)persistedModel);
	}

	@Override
	public BasePersistence<OsiServicesAppPayment> getBasePersistence() {
		return osiServicesAppPaymentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return osiServicesAppPaymentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OsiServicesAppPayment> getOsiServicesAppPayments(
		...
		return osiServicesAppPaymentPersistence.findAll(start, end);
	}
	...
	public int getOsiServicesAppPaymentsCount() {
		return osiServicesAppPaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		osiServicesAppPaymentLocalService =
			(OsiServicesAppPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiServicesAppPaymentLocalService.class.getName();
	}
	...
	protected OsiServicesAppPaymentLocalService
		osiServicesAppPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiServicesAppPaymentLocalServiceBaseImpl.class);
