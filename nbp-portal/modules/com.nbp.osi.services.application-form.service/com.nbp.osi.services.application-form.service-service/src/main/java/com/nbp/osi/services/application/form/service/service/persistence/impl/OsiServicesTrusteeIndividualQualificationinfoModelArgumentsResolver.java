...
/**
 * The arguments resolver class for retrieving value from OsiServicesTrusteeIndividualQualificationinfo.
 *
...
@Component(
	property = {
		"class.name=com.nbp.osi.services.application.form.service.model.impl.OsiServicesTrusteeIndividualQualificationinfoImpl",
		"table.name=nbp_osi_services_trus_in_qual"
	},
	service = ArgumentsResolver.class
)
public class OsiServicesTrusteeIndividualQualificationinfoModelArgumentsResolver
	...
	public String getClassName() {
		return OsiServicesTrusteeIndividualQualificationinfoImpl.class.
			getName();
	}

	@Override
	public String getTableName() {
		return OsiServicesTrusteeIndividualQualificationinfoTable.INSTANCE.
			getTableName();
	}
