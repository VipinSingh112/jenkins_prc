...
import com.nbp.osi.services.application.form.service.service.OsiServicesApplicationService;
...
/**
 * Provides the base implementation for the osi services application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.services.application.form.service.service.impl.OsiServicesApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.services.application.form.service.service.impl.OsiServicesApplicationServiceImpl
 * @generated
 */
public abstract class OsiServicesApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiServicesApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiServicesApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.services.application.form.service.service.OsiServicesApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiServicesApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiServicesApplicationService = (OsiServicesApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiServicesApplicationService.class.getName();
	}
	...
	protected OsiServicesApplicationService osiServicesApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiServicesApplicationServiceBaseImpl.class);
