...
import com.nbp.osi.services.application.form.service.service.OSIServiceCurrentStageService;
...
/**
 * Provides the base implementation for the osi service current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.services.application.form.service.service.impl.OSIServiceCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.services.application.form.service.service.impl.OSIServiceCurrentStageServiceImpl
 * @generated
 */
public abstract class OSIServiceCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OSIServiceCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OSIServiceCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.services.application.form.service.service.OSIServiceCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OSIServiceCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiServiceCurrentStageService = (OSIServiceCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OSIServiceCurrentStageService.class.getName();
	}
	...
	protected OSIServiceCurrentStageService osiServiceCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OSIServiceCurrentStageServiceBaseImpl.class);
