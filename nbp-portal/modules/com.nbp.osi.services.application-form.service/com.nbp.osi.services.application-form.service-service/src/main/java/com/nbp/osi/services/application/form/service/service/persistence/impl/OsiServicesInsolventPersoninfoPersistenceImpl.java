...
import com.nbp.osi.services.application.form.service.service.persistence.OsiServicesInsolventPersoninfoUtil;
...
/**
 * The persistence implementation for the osi services insolvent personinfo service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = OsiServicesInsolventPersoninfoPersistence.class)
public class OsiServicesInsolventPersoninfoPersistenceImpl
	extends BasePersistenceImpl<OsiServicesInsolventPersoninfo>
	implements OsiServicesInsolventPersoninfoPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>OsiServicesInsolventPersoninfoUtil</code> to access the osi services insolvent personinfo persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		OsiServicesInsolventPersoninfoImpl.class.getName();
	 ...
	 */
	@Override
	public List<OsiServicesInsolventPersoninfo> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<OsiServicesInsolventPersoninfo> findByUuid(
	...
	public List<OsiServicesInsolventPersoninfo> findByUuid(
		...
		List<OsiServicesInsolventPersoninfo> list = null;

		if (useFinderCache) {
			list = (List<OsiServicesInsolventPersoninfo>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (OsiServicesInsolventPersoninfo
						osiServicesInsolventPersoninfo : list) {

					if (!uuid.equals(
							osiServicesInsolventPersoninfo.getUuid())) {
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(
					OsiServicesInsolventPersoninfoModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<OsiServicesInsolventPersoninfo>)QueryUtil.list(
	...
	public OsiServicesInsolventPersoninfo findByUuid_First(
		...
		if (osiServicesInsolventPersoninfo != null) {
		...
		throw new NoSuchOsiServicesInsolventPersoninfoException(sb.toString());
	}
	...
	public OsiServicesInsolventPersoninfo fetchByUuid_First(
		...
		List<OsiServicesInsolventPersoninfo> list = findByUuid(
	...
	public OsiServicesInsolventPersoninfo[] findByUuid_PrevAndNext(
		...
		OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo =
			findByPrimaryKey(osiServicesInsoId);
		...
		try {
			...
			OsiServicesInsolventPersoninfo[] array =
				new OsiServicesInsolventPersoninfoImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, osiServicesInsolventPersoninfo, uuid,
				orderByComparator, true);

			array[1] = osiServicesInsolventPersoninfo;
	...
	protected OsiServicesInsolventPersoninfo getByUuid_PrevAndNext(
		Session session,
		OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo,
		String uuid,
		OrderByComparator<OsiServicesInsolventPersoninfo> orderByComparator,
		...
		if (orderByComparator != null) {
			...
			sb.append(OsiServicesInsolventPersoninfoModelImpl.ORDER_BY_JPQL);
		}
		...
		List<OsiServicesInsolventPersoninfo> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(osiServicesInsolventPersoninfo);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_OSISERVICESINSOLVENTPERSONINFO_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"osiServicesInsolventPersoninfo.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(osiServicesInsolventPersoninfo.uuid IS NULL OR osiServicesInsolventPersoninfo.uuid = '')";
	...
	public OsiServicesInsolventPersoninfo findByUUID_G(
		...
		if (osiServicesInsolventPersoninfo == null) {
			...
			throw new NoSuchOsiServicesInsolventPersoninfoException(
				sb.toString());
		}
	...
	public OsiServicesInsolventPersoninfo fetchByUUID_G(
		...
		if (result instanceof OsiServicesInsolventPersoninfo) {
			OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo =
				(OsiServicesInsolventPersoninfo)result;
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					OsiServicesInsolventPersoninfo
						osiServicesInsolventPersoninfo = list.get(0);

					result = osiServicesInsolventPersoninfo;

					cacheResult(osiServicesInsolventPersoninfo);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (OsiServicesInsolventPersoninfo)result;
		}
	}
	...
	public OsiServicesInsolventPersoninfo removeByUUID_G(
		...
		return remove(osiServicesInsolventPersoninfo);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"osiServicesInsolventPersoninfo.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(osiServicesInsolventPersoninfo.uuid IS NULL OR osiServicesInsolventPersoninfo.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"osiServicesInsolventPersoninfo.groupId = ?";
	 ...
	 */
	@Override
	public List<OsiServicesInsolventPersoninfo> findByUuid_C(
			...
			if ((list != null) && !list.isEmpty()) {
				for (OsiServicesInsolventPersoninfo
					...
					if (!uuid.equals(
							osiServicesInsolventPersoninfo.getUuid()) ||
						(companyId !=
							osiServicesInsolventPersoninfo.getCompanyId())) {
	...
	public OsiServicesInsolventPersoninfo fetchByUuid_C_First(
		...
		List<OsiServicesInsolventPersoninfo> list = findByUuid_C(
	...
	public OsiServicesInsolventPersoninfo[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, osiServicesInsolventPersoninfo, uuid, companyId,
				orderByComparator, true);
	...
	protected OsiServicesInsolventPersoninfo getByUuid_C_PrevAndNext(
		Session session,
		OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo,
		String uuid, long companyId,
		OrderByComparator<OsiServicesInsolventPersoninfo> orderByComparator,
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"osiServicesInsolventPersoninfo.companyId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"OsiServicesInsolventPersoninfoPersistenceImpl.fetchBygetOsiServicesById(long, boolean) with parameters (" +
	...
	private static final String
		_FINDER_COLUMN_GETOSISERVICESBYID_OSISERVICESAPPLICATIONID_2 =
			"osiServicesInsolventPersoninfo.osiServicesApplicationId = ?";

	public OsiServicesInsolventPersoninfoPersistenceImpl() {
		...
		setModelClass(OsiServicesInsolventPersoninfo.class);

		setModelImplClass(OsiServicesInsolventPersoninfoImpl.class);
		setModelPKClass(long.class);

		setTable(OsiServicesInsolventPersoninfoTable.INSTANCE);
	}
	...
	public void cacheResult(
		...
		entityCache.putResult(
			OsiServicesInsolventPersoninfoImpl.class,
			osiServicesInsolventPersoninfo.getPrimaryKey(),
			osiServicesInsolventPersoninfo);
		...
		finderCache.putResult(
			...
			new Object[] {
				osiServicesInsolventPersoninfo.getUuid(),
				osiServicesInsolventPersoninfo.getGroupId()
			},
			osiServicesInsolventPersoninfo);
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (osiServicesInsolventPersoninfos.size() >
		...
		for (OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo :
			...
			if (entityCache.getResult(
					OsiServicesInsolventPersoninfoImpl.class,
					osiServicesInsolventPersoninfo.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all osi services insolvent personinfos.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(OsiServicesInsolventPersoninfoImpl.class);

		finderCache.clearCache(OsiServicesInsolventPersoninfoImpl.class);
	}

	/**
	 * Clears the cache for the osi services insolvent personinfo.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				OsiServicesInsolventPersoninfoImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			osiServicesInsolventPersoninfoModelImpl.getUuid(),
			osiServicesInsolventPersoninfoModelImpl.getGroupId()
		};
	...
	public OsiServicesInsolventPersoninfo create(long osiServicesInsoId) {
		...
		osiServicesInsolventPersoninfo.setPrimaryKey(osiServicesInsoId);

		String uuid = PortalUUIDUtil.generate();

		osiServicesInsolventPersoninfo.setUuid(uuid);
	...
	public OsiServicesInsolventPersoninfo remove(long osiServicesInsoId)
		...
		return remove((Serializable)osiServicesInsoId);
	}

	/**
	 * Removes the osi services insolvent personinfo with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the osi services insolvent personinfo
	 * @return the osi services insolvent personinfo that was removed
	 * @throws NoSuchOsiServicesInsolventPersoninfoException if a osi services insolvent personinfo with the primary key could not be found
	 */
	@Override
	public OsiServicesInsolventPersoninfo remove(Serializable primaryKey)
		throws NoSuchOsiServicesInsolventPersoninfoException {
		...
		try {
			...
			OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo =
				(OsiServicesInsolventPersoninfo)session.get(
					OsiServicesInsolventPersoninfoImpl.class, primaryKey);
		...
		catch (NoSuchOsiServicesInsolventPersoninfoException
	...
	@Override
	protected OsiServicesInsolventPersoninfo removeImpl(
		OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo) {
		...
		try {
			...
			if (!session.contains(osiServicesInsolventPersoninfo)) {
				osiServicesInsolventPersoninfo =
					(OsiServicesInsolventPersoninfo)session.get(
						OsiServicesInsolventPersoninfoImpl.class,
						osiServicesInsolventPersoninfo.getPrimaryKeyObj());
			}

			if (osiServicesInsolventPersoninfo != null) {
				session.delete(osiServicesInsolventPersoninfo);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (osiServicesInsolventPersoninfo != null) {
			clearCache(osiServicesInsolventPersoninfo);
		}
	...
	public OsiServicesInsolventPersoninfo updateImpl(
		...
		boolean isNew = osiServicesInsolventPersoninfo.isNew();

		if (!(osiServicesInsolventPersoninfo instanceof
				OsiServicesInsolventPersoninfoModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(
					osiServicesInsolventPersoninfo.getClass())) {

				invocationHandler = ProxyUtil.getInvocationHandler(
					osiServicesInsolventPersoninfo);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in osiServicesInsolventPersoninfo proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom OsiServicesInsolventPersoninfo implementation " +
					osiServicesInsolventPersoninfo.getClass());
		}
		...
		if (Validator.isNull(osiServicesInsolventPersoninfo.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (osiServicesInsolventPersoninfo.getCreateDate() == null)) {
			if (serviceContext == null) {
				osiServicesInsolventPersoninfo.setCreateDate(date);
			}
			else {
		...
		if (!osiServicesInsolventPersoninfoModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				osiServicesInsolventPersoninfo.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(osiServicesInsolventPersoninfo);
			}
			else {
				osiServicesInsolventPersoninfo =
					(OsiServicesInsolventPersoninfo)session.merge(
						osiServicesInsolventPersoninfo);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			OsiServicesInsolventPersoninfoImpl.class,
			osiServicesInsolventPersoninfoModelImpl, false, true);

		cacheUniqueFindersCache(osiServicesInsolventPersoninfoModelImpl);

		if (isNew) {
			osiServicesInsolventPersoninfo.setNew(false);
		}

		osiServicesInsolventPersoninfo.resetOriginalValues();

		return osiServicesInsolventPersoninfo;
	}

	/**
	 * Returns the osi services insolvent personinfo with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the osi services insolvent personinfo
	...
	public OsiServicesInsolventPersoninfo findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)osiServicesInsoId);
	}
	...
	public OsiServicesInsolventPersoninfo fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)osiServicesInsoId);
	}
	 ...
	 */
	@Override
	public List<OsiServicesInsolventPersoninfo> findAll() {
	 ...
	 */
	@Override
	public List<OsiServicesInsolventPersoninfo> findAll(int start, int end) {
	...
	public List<OsiServicesInsolventPersoninfo> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO);
				...
				sql = _SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO;
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_OSISERVICESINSOLVENTPERSONINFO);
	...
	protected String getPKDBName() {
		return "osiServicesInsoId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return OsiServicesInsolventPersoninfoModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the osi services insolvent personinfo persistence.
	 */
	@Activate
	public void activate() {
		...
		OsiServicesInsolventPersoninfoUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		OsiServicesInsolventPersoninfoUtil.setPersistence(null);
	...
	private static final String _SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO =
		"SELECT osiServicesInsolventPersoninfo FROM OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo";

	private static final String
		_SQL_SELECT_OSISERVICESINSOLVENTPERSONINFO_WHERE =
			"SELECT osiServicesInsolventPersoninfo FROM OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo WHERE ";

	private static final String _SQL_COUNT_OSISERVICESINSOLVENTPERSONINFO =
		"SELECT COUNT(osiServicesInsolventPersoninfo) FROM OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo";

	private static final String
		_SQL_COUNT_OSISERVICESINSOLVENTPERSONINFO_WHERE =
			"SELECT COUNT(osiServicesInsolventPersoninfo) FROM OsiServicesInsolventPersoninfo osiServicesInsolventPersoninfo WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"osiServicesInsolventPersoninfo.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No OsiServicesInsolventPersoninfo exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No OsiServicesInsolventPersoninfo exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		OsiServicesInsolventPersoninfoPersistenceImpl.class);
