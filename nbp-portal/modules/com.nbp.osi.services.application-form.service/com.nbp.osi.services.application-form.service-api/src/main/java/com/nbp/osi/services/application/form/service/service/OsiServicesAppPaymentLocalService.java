...
/**
 * Provides the local service interface for OsiServicesAppPayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiServicesAppPaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiServicesAppPaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesAppPaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi services app payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiServicesAppPaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OsiServicesAppPayment addOsiServicesAppPayment(
	...
	public OsiServicesAppPayment createOsiServicesAppPayment(
	...
	public OsiServicesAppPayment deleteOsiServicesAppPayment(
			long osiServicesAppPaymentId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiServicesAppPayment fetchOsiServicesAppPayment(
		long osiServicesAppPaymentId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiServicesAppPayment getOsiServiceAppPaymentById(long applicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiServicesAppPayment getOsiServicesAppPayment(
			long osiServicesAppPaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiServicesAppPayment> getOsiServicesAppPayments(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OsiServicesAppPayment updateOsiServicesAppPayment(
		OsiServicesAppPayment osiServicesAppPayment);
