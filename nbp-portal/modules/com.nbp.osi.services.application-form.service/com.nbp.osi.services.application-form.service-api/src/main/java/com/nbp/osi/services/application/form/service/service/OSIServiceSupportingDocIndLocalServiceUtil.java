...
/**
 * Provides the local service utility for OSIServiceSupportingDocInd. This utility wraps
 * <code>com.nbp.osi.services.application.form.service.service.impl.OSIServiceSupportingDocIndLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OSIServiceSupportingDocIndLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.services.application.form.service.service.impl.OSIServiceSupportingDocIndLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OSIServiceSupportingDocInd addOSIServiceSupportingDocInd(
		OSIServiceSupportingDocInd osiServiceSupportingDocInd) {

		return getService().addOSIServiceSupportingDocInd(
	 ...
	 */
	public static OSIServiceSupportingDocInd createOSIServiceSupportingDocInd(
		long oSIServiceSupportingDocIndId) {

		return getService().createOSIServiceSupportingDocInd(
	 ...
	 */
	public static OSIServiceSupportingDocInd deleteOSIServiceSupportingDocInd(
			long oSIServiceSupportingDocIndId)
		throws PortalException {

		return getService().deleteOSIServiceSupportingDocInd(
			oSIServiceSupportingDocIndId);
	}
	...
	public static OSIServiceSupportingDocInd fetchOSIServiceSupportingDocInd(
		long oSIServiceSupportingDocIndId) {

		return getService().fetchOSIServiceSupportingDocInd(
			oSIServiceSupportingDocIndId);
	}
	...
	public static OSIServiceSupportingDocInd getOSIService_ById(
			long applicationId)
		throws com.nbp.osi.services.application.form.service.exception.
			NoSuchOSIServiceSupportingDocIndException {

		return getService().getOSIService_ById(applicationId);
	}
	 ...
	 * @throws PortalException if a osi service supporting doc ind with the primary key could not be found
	 */
	public static OSIServiceSupportingDocInd getOSIServiceSupportingDocInd(
			long oSIServiceSupportingDocIndId)
		throws PortalException {

		return getService().getOSIServiceSupportingDocInd(
			oSIServiceSupportingDocIndId);
	}
	 ...
	 */
	public static List<OSIServiceSupportingDocInd>
		getOSIServiceSupportingDocInds(int start, int end) {

		return getService().getOSIServiceSupportingDocInds(start, end);
	}
	 ...
	 */
	public static int getOSIServiceSupportingDocIndsCount() {
		return getService().getOSIServiceSupportingDocIndsCount();
	}
	 ...
	 */
	public static OSIServiceSupportingDocInd updateOSIServiceSupportingDocInd(
		OSIServiceSupportingDocInd osiServiceSupportingDocInd) {

		return getService().updateOSIServiceSupportingDocInd(
			osiServiceSupportingDocInd);
	}

	public static OSIServiceSupportingDocIndLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OSIServiceSupportingDocIndLocalService>
		_serviceSnapshot = new Snapshot<>(
			OSIServiceSupportingDocIndLocalServiceUtil.class,
