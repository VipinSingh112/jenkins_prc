...
/**
 * Provides the local service utility for OsiServicesAppPayment. This utility wraps
 * <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesAppPaymentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OsiServicesAppPaymentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesAppPaymentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OsiServicesAppPayment addOsiServicesAppPayment(
		OsiServicesAppPayment osiServicesAppPayment) {

		return getService().addOsiServicesAppPayment(osiServicesAppPayment);
	}
	 ...
	 */
	public static OsiServicesAppPayment createOsiServicesAppPayment(
		long osiServicesAppPaymentId) {

		return getService().createOsiServicesAppPayment(
	 ...
	 */
	public static OsiServicesAppPayment deleteOsiServicesAppPayment(
			long osiServicesAppPaymentId)
		throws PortalException {

		return getService().deleteOsiServicesAppPayment(
			osiServicesAppPaymentId);
	}
	...
	public static OsiServicesAppPayment deleteOsiServicesAppPayment(
		...
		return getService().deleteOsiServicesAppPayment(osiServicesAppPayment);
	}
	...
	public static OsiServicesAppPayment fetchOsiServicesAppPayment(
		long osiServicesAppPaymentId) {

		return getService().fetchOsiServicesAppPayment(osiServicesAppPaymentId);
	}
	...
	public static OsiServicesAppPayment getOsiServiceAppPaymentById(
			long applicationId)
		throws com.nbp.osi.services.application.form.service.exception.
			NoSuchOsiServicesAppPaymentException {

		return getService().getOsiServiceAppPaymentById(applicationId);
	}
	 ...
	 * @throws PortalException if a osi services app payment with the primary key could not be found
	 */
	public static OsiServicesAppPayment getOsiServicesAppPayment(
			long osiServicesAppPaymentId)
		throws PortalException {

		return getService().getOsiServicesAppPayment(osiServicesAppPaymentId);
	}
	 ...
	 */
	public static List<OsiServicesAppPayment> getOsiServicesAppPayments(
		int start, int end) {

		return getService().getOsiServicesAppPayments(start, end);
	}
	 ...
	 */
	public static int getOsiServicesAppPaymentsCount() {
		return getService().getOsiServicesAppPaymentsCount();
	}
	 ...
	 */
	public static OsiServicesAppPayment updateOsiServicesAppPayment(
		OsiServicesAppPayment osiServicesAppPayment) {

		return getService().updateOsiServicesAppPayment(osiServicesAppPayment);
	}

	public static OsiServicesAppPaymentLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OsiServicesAppPaymentLocalService>
		_serviceSnapshot = new Snapshot<>(
			OsiServicesAppPaymentLocalServiceUtil.class,
			OsiServicesAppPaymentLocalService.class);
