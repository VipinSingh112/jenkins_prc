...
/**
 * Provides the local service utility for OsiServicesApplicantinfo. This utility wraps
 * <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesApplicantinfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OsiServicesApplicantinfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesApplicantinfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OsiServicesApplicantinfo addOsiServicesApplicantinfo(
		OsiServicesApplicantinfo osiServicesApplicantinfo) {

		return getService().addOsiServicesApplicantinfo(
	 ...
	 */
	public static OsiServicesApplicantinfo createOsiServicesApplicantinfo(
		long osiServicesApplicanId) {

		return getService().createOsiServicesApplicantinfo(
	 ...
	 */
	public static OsiServicesApplicantinfo deleteOsiServicesApplicantinfo(
			long osiServicesApplicanId)
		throws PortalException {

		return getService().deleteOsiServicesApplicantinfo(
			osiServicesApplicanId);
	}
	...
	public static OsiServicesApplicantinfo fetchOsiServicesApplicantinfo(
		long osiServicesApplicanId) {

		return getService().fetchOsiServicesApplicantinfo(
			osiServicesApplicanId);
	}
	 ...
	 */
	public static OsiServicesApplicantinfo
		fetchOsiServicesApplicantinfoByUuidAndGroupId(
			String uuid, long groupId) {

		return getService().fetchOsiServicesApplicantinfoByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static OsiServicesApplicantinfo getOsiServiceApplicantInfoById(
		...
		return getService().getOsiServiceApplicantInfoById(
	 ...
	 * @throws PortalException if a osi services applicantinfo with the primary key could not be found
	 */
	public static OsiServicesApplicantinfo getOsiServicesApplicantinfo(
			long osiServicesApplicanId)
		throws PortalException {

		return getService().getOsiServicesApplicantinfo(osiServicesApplicanId);
	}
	...
	public static OsiServicesApplicantinfo
		...
		return getService().getOsiServicesApplicantinfoByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<OsiServicesApplicantinfo> getOsiServicesApplicantinfos(
		int start, int end) {

		return getService().getOsiServicesApplicantinfos(start, end);
	}
	 ...
	 */
	public static List<OsiServicesApplicantinfo>
		getOsiServicesApplicantinfosByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getOsiServicesApplicantinfosByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getOsiServicesApplicantinfosCount() {
		return getService().getOsiServicesApplicantinfosCount();
	}
	 ...
	 */
	public static OsiServicesApplicantinfo updateOsiServicesApplicantinfo(
		OsiServicesApplicantinfo osiServicesApplicantinfo) {

		return getService().updateOsiServicesApplicantinfo(
			osiServicesApplicantinfo);
	}

	public static OsiServicesApplicantinfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OsiServicesApplicantinfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			OsiServicesApplicantinfoLocalServiceUtil.class,
