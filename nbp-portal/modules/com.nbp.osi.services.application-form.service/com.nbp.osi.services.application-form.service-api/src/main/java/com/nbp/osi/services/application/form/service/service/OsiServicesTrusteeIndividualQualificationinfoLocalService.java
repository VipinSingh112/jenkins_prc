...
/**
 * Provides the local service interface for OsiServicesTrusteeIndividualQualificationinfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiServicesTrusteeIndividualQualificationinfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiServicesTrusteeIndividualQualificationinfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.services.application.form.service.service.impl.OsiServicesTrusteeIndividualQualificationinfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi services trustee individual qualificationinfo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiServicesTrusteeIndividualQualificationinfoLocalServiceUtil} if injection and service tracking are not available.
	 */
