...
/**
 * The persistence utility for the medical payment confirmation service. This utility wraps <code>com.nbp.medical.stages.service.service.persistence.impl.MedicalPaymentConfirmationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see MedicalPaymentConfirmationPersistence
 * @generated
 */
public class MedicalPaymentConfirmationUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(medicalPaymentConfirmation);
	}
	 ...
	 */
	public static Map<Serializable, MedicalPaymentConfirmation>
	 ...
	 */
	public static List<MedicalPaymentConfirmation> findWithDynamicQuery(
	 ...
	 */
	public static MedicalPaymentConfirmation update(
		MedicalPaymentConfirmation medicalPaymentConfirmation) {

		return getPersistence().update(medicalPaymentConfirmation);
	}
	...
	public static MedicalPaymentConfirmation update(
		...
		return getPersistence().update(
			medicalPaymentConfirmation, serviceContext);
	}
	 ...
	 */
	public static MedicalPaymentConfirmation findBygetMedicalPaymentConfBy_CI(
			String caseId)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().findBygetMedicalPaymentConfBy_CI(caseId);
	}
	 ...
	 */
	public static MedicalPaymentConfirmation fetchBygetMedicalPaymentConfBy_CI(
		String caseId) {

		return getPersistence().fetchBygetMedicalPaymentConfBy_CI(caseId);
	}
	...
	public static MedicalPaymentConfirmation fetchBygetMedicalPaymentConfBy_CI(
		...
		return getPersistence().fetchBygetMedicalPaymentConfBy_CI(
	 ...
	 */
	public static MedicalPaymentConfirmation removeBygetMedicalPaymentConfBy_CI(
			String caseId)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().removeBygetMedicalPaymentConfBy_CI(caseId);
	}
	 ...
	 */
	public static int countBygetMedicalPaymentConfBy_CI(String caseId) {
		return getPersistence().countBygetMedicalPaymentConfBy_CI(caseId);
	}
	 ...
	 */
	public static List<MedicalPaymentConfirmation> findBygetMedicalPayConfBy_CI(
		String caseId) {

		return getPersistence().findBygetMedicalPayConfBy_CI(caseId);
	}
	...
	public static List<MedicalPaymentConfirmation> findBygetMedicalPayConfBy_CI(
		...
		return getPersistence().findBygetMedicalPayConfBy_CI(
			caseId, start, end);
	}
	 ...
	 * @throws NoSuchMedicalPaymentConfirmationException if a matching medical payment confirmation could not be found
	 */
	public static MedicalPaymentConfirmation findBygetMedicalPayConfBy_CI_First(
			String caseId,
			OrderByComparator<MedicalPaymentConfirmation> orderByComparator)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().findBygetMedicalPayConfBy_CI_First(
	 ...
	 */
	public static MedicalPaymentConfirmation
		fetchBygetMedicalPayConfBy_CI_First(
			String caseId,
			OrderByComparator<MedicalPaymentConfirmation> orderByComparator) {

		return getPersistence().fetchBygetMedicalPayConfBy_CI_First(
			caseId, orderByComparator);
	}
	 ...
	 * @throws NoSuchMedicalPaymentConfirmationException if a matching medical payment confirmation could not be found
	 */
	public static MedicalPaymentConfirmation findBygetMedicalPayConfBy_CI_Last(
			String caseId,
			OrderByComparator<MedicalPaymentConfirmation> orderByComparator)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().findBygetMedicalPayConfBy_CI_Last(
			caseId, orderByComparator);
	}
	 ...
	 */
	public static MedicalPaymentConfirmation fetchBygetMedicalPayConfBy_CI_Last(
		String caseId,
		OrderByComparator<MedicalPaymentConfirmation> orderByComparator) {

		return getPersistence().fetchBygetMedicalPayConfBy_CI_Last(
			caseId, orderByComparator);
	}
	...
	public static MedicalPaymentConfirmation[]
		...
		return getPersistence().findBygetMedicalPayConfBy_CI_PrevAndNext(
			medicalPaymentConfirmationId, caseId, orderByComparator);
	}
	 ...
	 * @param caseId the case ID
	 */
	public static void removeBygetMedicalPayConfBy_CI(String caseId) {
		getPersistence().removeBygetMedicalPayConfBy_CI(caseId);
	}
	 ...
	 * @return the number of matching medical payment confirmations
	 */
	public static int countBygetMedicalPayConfBy_CI(String caseId) {
		return getPersistence().countBygetMedicalPayConfBy_CI(caseId);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(medicalPaymentConfirmation);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(medicalPaymentConfirmations);
	}
	 ...
	 */
	public static MedicalPaymentConfirmation create(
		long medicalPaymentConfirmationId) {

		return getPersistence().create(medicalPaymentConfirmationId);
	}
	 ...
	 * @throws NoSuchMedicalPaymentConfirmationException if a medical payment confirmation with the primary key could not be found
	 */
	public static MedicalPaymentConfirmation remove(
			long medicalPaymentConfirmationId)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().remove(medicalPaymentConfirmationId);
	}

	public static MedicalPaymentConfirmation updateImpl(
		MedicalPaymentConfirmation medicalPaymentConfirmation) {

		return getPersistence().updateImpl(medicalPaymentConfirmation);
	}
	 ...
	 * @throws NoSuchMedicalPaymentConfirmationException if a medical payment confirmation with the primary key could not be found
	 */
	public static MedicalPaymentConfirmation findByPrimaryKey(
			long medicalPaymentConfirmationId)
		throws com.nbp.medical.stages.service.exception.
			NoSuchMedicalPaymentConfirmationException {

		return getPersistence().findByPrimaryKey(medicalPaymentConfirmationId);
	}
	 ...
	 */
	public static MedicalPaymentConfirmation fetchByPrimaryKey(
		long medicalPaymentConfirmationId) {

		return getPersistence().fetchByPrimaryKey(medicalPaymentConfirmationId);
	}
	 ...
	 */
	public static List<MedicalPaymentConfirmation> findAll() {
	 ...
	 */
	public static List<MedicalPaymentConfirmation> findAll(int start, int end) {
	...
	public static MedicalPaymentConfirmationPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		MedicalPaymentConfirmationPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile MedicalPaymentConfirmationPersistence _persistence;
