...
/**
 * Provides the local service interface for MedicalFacilitiesInspection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MedicalFacilitiesInspectionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MedicalFacilitiesInspectionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.medical.stages.service.service.impl.MedicalFacilitiesInspectionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the medical facilities inspection local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MedicalFacilitiesInspectionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesInspection> getMed_CaseIdApplicationId(
		String status, long medicalApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesInspection> getMed_CaseIdStatus(
		String caseId, String status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesInspection> getMed_FBAI(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesInspection> getMed_StatusApplicationId(
		String status, long medicalApplicationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesInspection getMedicalFacilitiesInspectionBy_CI(
			String caseId)
		throws NoSuchMedicalFacilitiesInspectionException;
