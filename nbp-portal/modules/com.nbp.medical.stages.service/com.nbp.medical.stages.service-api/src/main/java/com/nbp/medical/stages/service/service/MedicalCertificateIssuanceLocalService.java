...
/**
 * Provides the local service interface for MedicalCertificateIssuance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MedicalCertificateIssuanceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MedicalCertificateIssuanceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.medical.stages.service.service.impl.MedicalCertificateIssuanceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the medical certificate issuance local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MedicalCertificateIssuanceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalCertificateIssuance getCertificateIssuance(String caseId)
	...
	public MedicalCertificateIssuance updateMedicalCertificateIssuance(
		...
		String medicalCategory, Date dateOfCertificateIssuance,
		Date dateOfCertificateExpiration, long licenceFileEntryId);
