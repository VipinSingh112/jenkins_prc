...
import com.nbp.ncbj.application.form.service.service.NcbjSectionOneLocalService;
...
/**
 * Provides the base implementation for the ncbj section one local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneLocalServiceImpl
 * @generated
 */
public abstract class NcbjSectionOneLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjSectionOneLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjSectionOneLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjSectionOneLocalServiceUtil</code>.
	 */
	...
	public NcbjSectionOne addNcbjSectionOne(NcbjSectionOne ncbjSectionOne) {
		...
		return ncbjSectionOnePersistence.update(ncbjSectionOne);
	}
	...
	public NcbjSectionOne createNcbjSectionOne(long ncbjSectionOneId) {
		return ncbjSectionOnePersistence.create(ncbjSectionOneId);
	}
	...
	public NcbjSectionOne deleteNcbjSectionOne(long ncbjSectionOneId)
		...
		return ncbjSectionOnePersistence.remove(ncbjSectionOneId);
	}
	...
	public NcbjSectionOne deleteNcbjSectionOne(NcbjSectionOne ncbjSectionOne) {
		return ncbjSectionOnePersistence.remove(ncbjSectionOne);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjSectionOnePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NcbjSectionOne.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjSectionOnePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ncbjSectionOnePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjSectionOnePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ncbjSectionOnePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NcbjSectionOne fetchNcbjSectionOne(long ncbjSectionOneId) {
		return ncbjSectionOnePersistence.fetchByPrimaryKey(ncbjSectionOneId);
	}
	...
	public NcbjSectionOne getNcbjSectionOne(long ncbjSectionOneId)
		...
		return ncbjSectionOnePersistence.findByPrimaryKey(ncbjSectionOneId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ncbjSectionOneLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NcbjSectionOne.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ncbjSectionOneId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ncbjSectionOneLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NcbjSectionOne.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjSectionOnePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NcbjSectionOneLocalServiceImpl#deleteNcbjSectionOne(NcbjSectionOne) to avoid orphaned data");
		}

		return ncbjSectionOneLocalService.deleteNcbjSectionOne(
			(NcbjSectionOne)persistedModel);
	}

	@Override
	public BasePersistence<NcbjSectionOne> getBasePersistence() {
		return ncbjSectionOnePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjSectionOnePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NcbjSectionOne> getNcbjSectionOnes(int start, int end) {
		return ncbjSectionOnePersistence.findAll(start, end);
	}
	...
	public int getNcbjSectionOnesCount() {
		return ncbjSectionOnePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjSectionOneLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ncbjSectionOneLocalService = (NcbjSectionOneLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjSectionOneLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ncbjSectionOnePersistence.getDataSource();
	...
	protected NcbjSectionOneLocalService ncbjSectionOneLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjSectionOneLocalServiceBaseImpl.class);
