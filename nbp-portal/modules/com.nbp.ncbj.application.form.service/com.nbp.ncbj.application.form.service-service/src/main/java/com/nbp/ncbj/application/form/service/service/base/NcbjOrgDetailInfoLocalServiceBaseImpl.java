...
import com.nbp.ncbj.application.form.service.service.NcbjOrgDetailInfoLocalService;
...
/**
 * Provides the base implementation for the ncbj org detail info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjOrgDetailInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjOrgDetailInfoLocalServiceImpl
 * @generated
 */
public abstract class NcbjOrgDetailInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjOrgDetailInfoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjOrgDetailInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjOrgDetailInfoLocalServiceUtil</code>.
	 */
	...
	public NcbjOrgDetailInfo addNcbjOrgDetailInfo(
		...
		return ncbjOrgDetailInfoPersistence.update(ncbjOrgDetailInfo);
	}
	...
	public NcbjOrgDetailInfo createNcbjOrgDetailInfo(long ncbjOrgDetailInfoId) {
		return ncbjOrgDetailInfoPersistence.create(ncbjOrgDetailInfoId);
	}
	...
	public NcbjOrgDetailInfo deleteNcbjOrgDetailInfo(long ncbjOrgDetailInfoId)
		...
		return ncbjOrgDetailInfoPersistence.remove(ncbjOrgDetailInfoId);
	}
	...
	public NcbjOrgDetailInfo deleteNcbjOrgDetailInfo(
		...
		return ncbjOrgDetailInfoPersistence.remove(ncbjOrgDetailInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjOrgDetailInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NcbjOrgDetailInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjOrgDetailInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ncbjOrgDetailInfoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjOrgDetailInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ncbjOrgDetailInfoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NcbjOrgDetailInfo fetchNcbjOrgDetailInfo(long ncbjOrgDetailInfoId) {
		return ncbjOrgDetailInfoPersistence.fetchByPrimaryKey(
			ncbjOrgDetailInfoId);
	}
	...
	public NcbjOrgDetailInfo getNcbjOrgDetailInfo(long ncbjOrgDetailInfoId)
		...
		return ncbjOrgDetailInfoPersistence.findByPrimaryKey(
			ncbjOrgDetailInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(NcbjOrgDetailInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ncbjOrgDetailInfoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(NcbjOrgDetailInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjOrgDetailInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NcbjOrgDetailInfoLocalServiceImpl#deleteNcbjOrgDetailInfo(NcbjOrgDetailInfo) to avoid orphaned data");
		}

		return ncbjOrgDetailInfoLocalService.deleteNcbjOrgDetailInfo(
			(NcbjOrgDetailInfo)persistedModel);
	}

	@Override
	public BasePersistence<NcbjOrgDetailInfo> getBasePersistence() {
		return ncbjOrgDetailInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjOrgDetailInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NcbjOrgDetailInfo> getNcbjOrgDetailInfos(int start, int end) {
		return ncbjOrgDetailInfoPersistence.findAll(start, end);
	}
	...
	public int getNcbjOrgDetailInfosCount() {
		return ncbjOrgDetailInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjOrgDetailInfoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ncbjOrgDetailInfoLocalService = (NcbjOrgDetailInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjOrgDetailInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				ncbjOrgDetailInfoPersistence.getDataSource();
	...
	protected NcbjOrgDetailInfoLocalService ncbjOrgDetailInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjOrgDetailInfoLocalServiceBaseImpl.class);
