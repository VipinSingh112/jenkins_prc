...
import com.nbp.ncbj.application.form.service.service.NcbjApplicantDetailService;
...
/**
 * Provides the base implementation for the ncbj applicant detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailServiceImpl
 * @generated
 */
public abstract class NcbjApplicantDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjApplicantDetailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjApplicantDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjApplicantDetailServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjApplicantDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjApplicantDetailService = (NcbjApplicantDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjApplicantDetailService.class.getName();
	}
	...
	protected NcbjApplicantDetailService ncbjApplicantDetailService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjApplicantDetailServiceBaseImpl.class);
