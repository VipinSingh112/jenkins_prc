...
import com.nbp.ncbj.application.form.service.service.NcbjCurrentStageService;
...
/**
 * Provides the base implementation for the ncbj current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjCurrentStageServiceImpl
 * @generated
 */
public abstract class NcbjCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjCurrentStageService = (NcbjCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjCurrentStageService.class.getName();
	}
	...
	protected NcbjCurrentStageService ncbjCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjCurrentStageServiceBaseImpl.class);
