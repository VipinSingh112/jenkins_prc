...
import com.nbp.ncbj.application.form.service.service.NCBJCompanyNewService;
...
/**
 * Provides the base implementation for the ncbj company new remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NCBJCompanyNewServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NCBJCompanyNewServiceImpl
 * @generated
 */
public abstract class NCBJCompanyNewServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NCBJCompanyNewService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NCBJCompanyNewService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NCBJCompanyNewServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NCBJCompanyNewService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjCompanyNewService = (NCBJCompanyNewService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NCBJCompanyNewService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ncbj.application.form.service.service.NCBJCompanyNewLocalService
			ncbjCompanyNewLocalService;

	protected NCBJCompanyNewService ncbjCompanyNewService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NCBJCompanyNewServiceBaseImpl.class);
