...
import com.nbp.ncbj.application.form.service.service.NCBJCompanyNewLocalService;
...
/**
 * Provides the base implementation for the ncbj company new local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NCBJCompanyNewLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NCBJCompanyNewLocalServiceImpl
 * @generated
 */
public abstract class NCBJCompanyNewLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, NCBJCompanyNewLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NCBJCompanyNewLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NCBJCompanyNewLocalServiceUtil</code>.
	 */
	...
	public NCBJCompanyNew addNCBJCompanyNew(NCBJCompanyNew ncbjCompanyNew) {
		...
		return ncbjCompanyNewPersistence.update(ncbjCompanyNew);
	}
	...
	public NCBJCompanyNew createNCBJCompanyNew(long nCBJCompanyNewId) {
		return ncbjCompanyNewPersistence.create(nCBJCompanyNewId);
	}
	...
	public NCBJCompanyNew deleteNCBJCompanyNew(long nCBJCompanyNewId)
		...
		return ncbjCompanyNewPersistence.remove(nCBJCompanyNewId);
	}
	...
	public NCBJCompanyNew deleteNCBJCompanyNew(NCBJCompanyNew ncbjCompanyNew) {
		return ncbjCompanyNewPersistence.remove(ncbjCompanyNew);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjCompanyNewPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NCBJCompanyNew.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjCompanyNewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ncbjCompanyNewPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjCompanyNewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ncbjCompanyNewPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NCBJCompanyNew fetchNCBJCompanyNew(long nCBJCompanyNewId) {
		return ncbjCompanyNewPersistence.fetchByPrimaryKey(nCBJCompanyNewId);
	}
	...
	public NCBJCompanyNew getNCBJCompanyNew(long nCBJCompanyNewId)
		...
		return ncbjCompanyNewPersistence.findByPrimaryKey(nCBJCompanyNewId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ncbjCompanyNewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NCBJCompanyNew.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("nCBJCompanyNewId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ncbjCompanyNewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NCBJCompanyNew.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjCompanyNewPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NCBJCompanyNewLocalServiceImpl#deleteNCBJCompanyNew(NCBJCompanyNew) to avoid orphaned data");
		}

		return ncbjCompanyNewLocalService.deleteNCBJCompanyNew(
			(NCBJCompanyNew)persistedModel);
	}

	@Override
	public BasePersistence<NCBJCompanyNew> getBasePersistence() {
		return ncbjCompanyNewPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjCompanyNewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NCBJCompanyNew> getNCBJCompanyNews(int start, int end) {
		return ncbjCompanyNewPersistence.findAll(start, end);
	}
	...
	public int getNCBJCompanyNewsCount() {
		return ncbjCompanyNewPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NCBJCompanyNewLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ncbjCompanyNewLocalService = (NCBJCompanyNewLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NCBJCompanyNewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ncbjCompanyNewPersistence.getDataSource();
	...
	protected NCBJCompanyNewLocalService ncbjCompanyNewLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NCBJCompanyNewLocalServiceBaseImpl.class);
