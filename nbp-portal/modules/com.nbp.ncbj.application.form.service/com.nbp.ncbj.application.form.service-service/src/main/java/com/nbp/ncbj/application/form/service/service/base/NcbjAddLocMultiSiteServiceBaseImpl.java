...
import com.nbp.ncbj.application.form.service.service.NcbjAddLocMultiSiteService;
...
/**
 * Provides the base implementation for the ncbj add loc multi site remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjAddLocMultiSiteServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjAddLocMultiSiteServiceImpl
 * @generated
 */
public abstract class NcbjAddLocMultiSiteServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjAddLocMultiSiteService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjAddLocMultiSiteService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjAddLocMultiSiteServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjAddLocMultiSiteService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjAddLocMultiSiteService = (NcbjAddLocMultiSiteService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjAddLocMultiSiteService.class.getName();
	}
	...
	protected NcbjAddLocMultiSiteService ncbjAddLocMultiSiteService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjAddLocMultiSiteServiceBaseImpl.class);
