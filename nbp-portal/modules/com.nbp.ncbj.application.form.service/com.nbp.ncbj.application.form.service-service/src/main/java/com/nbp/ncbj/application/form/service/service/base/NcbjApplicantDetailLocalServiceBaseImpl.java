...
import com.nbp.ncbj.application.form.service.service.NcbjApplicantDetailLocalService;
...
/**
 * Provides the base implementation for the ncbj applicant detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailLocalServiceImpl
 * @generated
 */
public abstract class NcbjApplicantDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjApplicantDetailLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjApplicantDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjApplicantDetailLocalServiceUtil</code>.
	 */
	...
	public NcbjApplicantDetail addNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.update(ncbjApplicantDetail);
	}
	...
	public NcbjApplicantDetail createNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.create(ncbjApplicantDetailId);
	}
	...
	public NcbjApplicantDetail deleteNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.remove(ncbjApplicantDetailId);
	}
	...
	public NcbjApplicantDetail deleteNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.remove(ncbjApplicantDetail);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjApplicantDetailPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NcbjApplicantDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjApplicantDetailPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjApplicantDetailPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public NcbjApplicantDetail fetchNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.fetchByPrimaryKey(
	...
	public NcbjApplicantDetail getNcbjApplicantDetail(
		...
		return ncbjApplicantDetailPersistence.findByPrimaryKey(
			ncbjApplicantDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(NcbjApplicantDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjApplicantDetailPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NcbjApplicantDetailLocalServiceImpl#deleteNcbjApplicantDetail(NcbjApplicantDetail) to avoid orphaned data");
		}

		return ncbjApplicantDetailLocalService.deleteNcbjApplicantDetail(
			(NcbjApplicantDetail)persistedModel);
	}

	@Override
	public BasePersistence<NcbjApplicantDetail> getBasePersistence() {
		return ncbjApplicantDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjApplicantDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NcbjApplicantDetail> getNcbjApplicantDetails(
		...
		return ncbjApplicantDetailPersistence.findAll(start, end);
	}
	...
	public int getNcbjApplicantDetailsCount() {
		return ncbjApplicantDetailPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		ncbjApplicantDetailLocalService =
			(NcbjApplicantDetailLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjApplicantDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				ncbjApplicantDetailPersistence.getDataSource();
	...
	protected NcbjApplicantDetailLocalService ncbjApplicantDetailLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjApplicantDetailLocalServiceBaseImpl.class);
