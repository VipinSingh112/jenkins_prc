...
import com.nbp.ncbj.application.form.service.service.NcbjSectionOneService;
...
/**
 * Provides the base implementation for the ncbj section one remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneServiceImpl
 * @generated
 */
public abstract class NcbjSectionOneServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjSectionOneService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjSectionOneService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjSectionOneServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjSectionOneService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjSectionOneService = (NcbjSectionOneService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjSectionOneService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ncbj.application.form.service.service.NcbjSectionOneLocalService
			ncbjSectionOneLocalService;

	protected NcbjSectionOneService ncbjSectionOneService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjSectionOneServiceBaseImpl.class);
