...
import com.nbp.ncbj.application.form.service.service.NcbjAppPaymentLocalService;
...
/**
 * Provides the base implementation for the ncbj app payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjAppPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjAppPaymentLocalServiceImpl
 * @generated
 */
public abstract class NcbjAppPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjAppPaymentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjAppPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjAppPaymentLocalServiceUtil</code>.
	 */
	...
	public NcbjAppPayment addNcbjAppPayment(NcbjAppPayment ncbjAppPayment) {
		...
		return ncbjAppPaymentPersistence.update(ncbjAppPayment);
	}
	...
	public NcbjAppPayment createNcbjAppPayment(long ncbjAppPaymentId) {
		return ncbjAppPaymentPersistence.create(ncbjAppPaymentId);
	}
	...
	public NcbjAppPayment deleteNcbjAppPayment(long ncbjAppPaymentId)
		...
		return ncbjAppPaymentPersistence.remove(ncbjAppPaymentId);
	}
	...
	public NcbjAppPayment deleteNcbjAppPayment(NcbjAppPayment ncbjAppPayment) {
		return ncbjAppPaymentPersistence.remove(ncbjAppPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjAppPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NcbjAppPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjAppPaymentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ncbjAppPaymentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjAppPaymentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ncbjAppPaymentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NcbjAppPayment fetchNcbjAppPayment(long ncbjAppPaymentId) {
		return ncbjAppPaymentPersistence.fetchByPrimaryKey(ncbjAppPaymentId);
	}
	...
	public NcbjAppPayment getNcbjAppPayment(long ncbjAppPaymentId)
		...
		return ncbjAppPaymentPersistence.findByPrimaryKey(ncbjAppPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ncbjAppPaymentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NcbjAppPayment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ncbjAppPaymentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ncbjAppPaymentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(NcbjAppPayment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjAppPaymentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NcbjAppPaymentLocalServiceImpl#deleteNcbjAppPayment(NcbjAppPayment) to avoid orphaned data");
		}

		return ncbjAppPaymentLocalService.deleteNcbjAppPayment(
			(NcbjAppPayment)persistedModel);
	}

	@Override
	public BasePersistence<NcbjAppPayment> getBasePersistence() {
		return ncbjAppPaymentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjAppPaymentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NcbjAppPayment> getNcbjAppPayments(int start, int end) {
		return ncbjAppPaymentPersistence.findAll(start, end);
	}
	...
	public int getNcbjAppPaymentsCount() {
		return ncbjAppPaymentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjAppPaymentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ncbjAppPaymentLocalService = (NcbjAppPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjAppPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ncbjAppPaymentPersistence.getDataSource();
	...
	protected NcbjAppPaymentLocalService ncbjAppPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjAppPaymentLocalServiceBaseImpl.class);
