...
import com.nbp.ncbj.application.form.service.service.NcbjApplicationService;
...
/**
 * Provides the base implementation for the ncbj application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjApplicationServiceImpl
 * @generated
 */
public abstract class NcbjApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcbjApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjApplicationService = (NcbjApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjApplicationService.class.getName();
	}
	...
	protected NcbjApplicationService ncbjApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjApplicationServiceBaseImpl.class);
