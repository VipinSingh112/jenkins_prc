...
import com.nbp.ncbj.application.form.service.service.NcbjCompanyDetailAddLocalService;
...
/**
 * Provides the base implementation for the ncbj company detail add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjCompanyDetailAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjCompanyDetailAddLocalServiceImpl
 * @generated
 */
public abstract class NcbjCompanyDetailAddLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjCompanyDetailAddLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjCompanyDetailAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjCompanyDetailAddLocalServiceUtil</code>.
	 */
	...
	public NcbjCompanyDetailAdd addNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.update(ncbjCompanyDetailAdd);
	}
	...
	public NcbjCompanyDetailAdd createNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.create(ncbjCompanyDetailAddId);
	}
	...
	public NcbjCompanyDetailAdd deleteNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.remove(ncbjCompanyDetailAddId);
	}
	...
	public NcbjCompanyDetailAdd deleteNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.remove(ncbjCompanyDetailAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ncbjCompanyDetailAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NcbjCompanyDetailAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ncbjCompanyDetailAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ncbjCompanyDetailAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public NcbjCompanyDetailAdd fetchNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.fetchByPrimaryKey(
	...
	public NcbjCompanyDetailAdd getNcbjCompanyDetailAdd(
		...
		return ncbjCompanyDetailAddPersistence.findByPrimaryKey(
			ncbjCompanyDetailAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(NcbjCompanyDetailAdd.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjCompanyDetailAddPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NcbjCompanyDetailAddLocalServiceImpl#deleteNcbjCompanyDetailAdd(NcbjCompanyDetailAdd) to avoid orphaned data");
		}

		return ncbjCompanyDetailAddLocalService.deleteNcbjCompanyDetailAdd(
			(NcbjCompanyDetailAdd)persistedModel);
	}

	@Override
	public BasePersistence<NcbjCompanyDetailAdd> getBasePersistence() {
		return ncbjCompanyDetailAddPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ncbjCompanyDetailAddPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NcbjCompanyDetailAdd> getNcbjCompanyDetailAdds(
		...
		return ncbjCompanyDetailAddPersistence.findAll(start, end);
	}
	...
	public int getNcbjCompanyDetailAddsCount() {
		return ncbjCompanyDetailAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		ncbjCompanyDetailAddLocalService =
			(NcbjCompanyDetailAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjCompanyDetailAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				ncbjCompanyDetailAddPersistence.getDataSource();
	...
	protected NcbjCompanyDetailAddLocalService ncbjCompanyDetailAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjCompanyDetailAddLocalServiceBaseImpl.class);
