...
import com.nbp.ncbj.application.form.service.service.NcbjSpecificActivitiesService;
...
/**
 * Provides the base implementation for the ncbj specific activities remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.application.form.service.service.impl.NcbjSpecificActivitiesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.application.form.service.service.impl.NcbjSpecificActivitiesServiceImpl
 * @generated
 */
public abstract class NcbjSpecificActivitiesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjSpecificActivitiesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjSpecificActivitiesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.application.form.service.service.NcbjSpecificActivitiesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjSpecificActivitiesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjSpecificActivitiesService = (NcbjSpecificActivitiesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjSpecificActivitiesService.class.getName();
	}
	...
	@Reference
	protected com.nbp.ncbj.application.form.service.service.
		NcbjSpecificActivitiesLocalService ncbjSpecificActivitiesLocalService;

	protected NcbjSpecificActivitiesService ncbjSpecificActivitiesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjSpecificActivitiesServiceBaseImpl.class);
