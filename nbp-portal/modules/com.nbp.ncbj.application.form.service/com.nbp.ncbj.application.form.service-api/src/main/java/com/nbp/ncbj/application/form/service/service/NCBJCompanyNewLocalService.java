...
/**
 * Provides the local service interface for NCBJCompanyNew. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NCBJCompanyNewLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NCBJCompanyNewLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NCBJCompanyNewLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj company new local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NCBJCompanyNewLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NCBJCompanyNew addNCBJCompanyNew(NCBJCompanyNew ncbjCompanyNew);
	...
	public NCBJCompanyNew createNCBJCompanyNew(long nCBJCompanyNewId);
	...
	public NCBJCompanyNew deleteNCBJCompanyNew(long nCBJCompanyNewId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NCBJCompanyNew deleteNCBJCompanyNew(NCBJCompanyNew ncbjCompanyNew);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NCBJCompanyNew fetchNCBJCompanyNew(long nCBJCompanyNewId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NCBJCompanyNew getNCBJById(long ncbjApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NCBJCompanyNew getNCBJCompanyNew(long nCBJCompanyNewId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NCBJCompanyNew> getNCBJCompanyNews(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NCBJCompanyNew updateNCBJCompanyNew(NCBJCompanyNew ncbjCompanyNew);
