...
/**
 * Provides the local service interface for NcbjSectionOne. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjSectionOneLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjSectionOneLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj section one local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjSectionOneLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjSectionOne addNcbjSectionOne(NcbjSectionOne ncbjSectionOne);
	...
	public NcbjSectionOne createNcbjSectionOne(long ncbjSectionOneId);
	...
	public NcbjSectionOne deleteNcbjSectionOne(long ncbjSectionOneId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NcbjSectionOne deleteNcbjSectionOne(NcbjSectionOne ncbjSectionOne);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjSectionOne fetchNcbjSectionOne(long ncbjSectionOneId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjSectionOne getNCBJById(long ncbjApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjSectionOne getNcbjSectionOne(long ncbjSectionOneId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjSectionOne> getNcbjSectionOnes(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NcbjSectionOne updateNcbjSectionOne(NcbjSectionOne ncbjSectionOne);
