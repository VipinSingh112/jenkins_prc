...
/**
 * Provides the local service interface for NcbjBusinessDetailAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjBusinessDetailAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjBusinessDetailAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjBusinessDetailAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj business detail add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjBusinessDetailAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjBusinessDetailAdd> getNCBJById(long ncbjApplicationId);
