...
/**
 * Provides the local service utility for NcbjPremisesLocation. This utility wraps
 * <code>com.nbp.ncbj.application.form.service.service.impl.NcbjPremisesLocationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcbjPremisesLocationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjPremisesLocationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcbjPremisesLocation addNcbjPremisesLocation(
		NcbjPremisesLocation ncbjPremisesLocation) {

		return getService().addNcbjPremisesLocation(ncbjPremisesLocation);
	}
	 ...
	 */
	public static NcbjPremisesLocation createNcbjPremisesLocation(
		long ncbjPremisesLocationId) {

		return getService().createNcbjPremisesLocation(ncbjPremisesLocationId);
	}
	 ...
	 */
	public static NcbjPremisesLocation deleteNcbjPremisesLocation(
			long ncbjPremisesLocationId)
		throws PortalException {

		return getService().deleteNcbjPremisesLocation(ncbjPremisesLocationId);
	}
	...
	public static NcbjPremisesLocation deleteNcbjPremisesLocation(
		...
		return getService().deleteNcbjPremisesLocation(ncbjPremisesLocation);
	}
	...
	public static NcbjPremisesLocation fetchNcbjPremisesLocation(
		long ncbjPremisesLocationId) {

		return getService().fetchNcbjPremisesLocation(ncbjPremisesLocationId);
	}
	...
	public static NcbjPremisesLocation getNCBJByAppId(long ncbjApplicationId)
	 ...
	 * @throws PortalException if a ncbj premises location with the primary key could not be found
	 */
	public static NcbjPremisesLocation getNcbjPremisesLocation(
			long ncbjPremisesLocationId)
		throws PortalException {

		return getService().getNcbjPremisesLocation(ncbjPremisesLocationId);
	}
	 ...
	 */
	public static List<NcbjPremisesLocation> getNcbjPremisesLocations(
		int start, int end) {

		return getService().getNcbjPremisesLocations(start, end);
	}
	 ...
	 */
	public static int getNcbjPremisesLocationsCount() {
		return getService().getNcbjPremisesLocationsCount();
	}
	 ...
	 */
	public static NcbjPremisesLocation updateNcbjPremisesLocation(
		NcbjPremisesLocation ncbjPremisesLocation) {

		return getService().updateNcbjPremisesLocation(ncbjPremisesLocation);
	}

	public static NcbjPremisesLocationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcbjPremisesLocationLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcbjPremisesLocationLocalServiceUtil.class,
