...
/**
 * Provides the local service utility for NcbjBusinessDetailAdd. This utility wraps
 * <code>com.nbp.ncbj.application.form.service.service.impl.NcbjBusinessDetailAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcbjBusinessDetailAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjBusinessDetailAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcbjBusinessDetailAdd addNcbjBusinessDetailAdd(
		NcbjBusinessDetailAdd ncbjBusinessDetailAdd) {

		return getService().addNcbjBusinessDetailAdd(ncbjBusinessDetailAdd);
	}
	 ...
	 */
	public static NcbjBusinessDetailAdd createNcbjBusinessDetailAdd(
		long ncbjBusinessDetailAddId) {

		return getService().createNcbjBusinessDetailAdd(
	 ...
	 */
	public static NcbjBusinessDetailAdd deleteNcbjBusinessDetailAdd(
			long ncbjBusinessDetailAddId)
		throws PortalException {

		return getService().deleteNcbjBusinessDetailAdd(
			ncbjBusinessDetailAddId);
	}
	...
	public static NcbjBusinessDetailAdd deleteNcbjBusinessDetailAdd(
		...
		return getService().deleteNcbjBusinessDetailAdd(ncbjBusinessDetailAdd);
	}
	...
	public static NcbjBusinessDetailAdd fetchNcbjBusinessDetailAdd(
		long ncbjBusinessDetailAddId) {

		return getService().fetchNcbjBusinessDetailAdd(ncbjBusinessDetailAddId);
	}
	 ...
	 * @throws PortalException if a ncbj business detail add with the primary key could not be found
	 */
	public static NcbjBusinessDetailAdd getNcbjBusinessDetailAdd(
			long ncbjBusinessDetailAddId)
		throws PortalException {

		return getService().getNcbjBusinessDetailAdd(ncbjBusinessDetailAddId);
	}
	 ...
	 */
	public static List<NcbjBusinessDetailAdd> getNcbjBusinessDetailAdds(
		int start, int end) {

		return getService().getNcbjBusinessDetailAdds(start, end);
	}
	 ...
	 */
	public static int getNcbjBusinessDetailAddsCount() {
		return getService().getNcbjBusinessDetailAddsCount();
	}

	public static List<NcbjBusinessDetailAdd> getNCBJById(
	 ...
	 */
	public static NcbjBusinessDetailAdd updateNcbjBusinessDetailAdd(
		NcbjBusinessDetailAdd ncbjBusinessDetailAdd) {

		return getService().updateNcbjBusinessDetailAdd(ncbjBusinessDetailAdd);
	}

	public static NcbjBusinessDetailAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcbjBusinessDetailAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcbjBusinessDetailAddLocalServiceUtil.class,
