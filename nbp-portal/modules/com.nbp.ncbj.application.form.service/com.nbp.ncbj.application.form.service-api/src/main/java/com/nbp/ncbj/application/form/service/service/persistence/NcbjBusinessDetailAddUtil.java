...
/**
 * The persistence utility for the ncbj business detail add service. This utility wraps <code>com.nbp.ncbj.application.form.service.service.persistence.impl.NcbjBusinessDetailAddPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see NcbjBusinessDetailAddPersistence
 * @generated
 */
public class NcbjBusinessDetailAddUtil {
	 ...
	 */
	public static void clearCache(NcbjBusinessDetailAdd ncbjBusinessDetailAdd) {
		getPersistence().clearCache(ncbjBusinessDetailAdd);
	}
	 ...
	 */
	public static Map<Serializable, NcbjBusinessDetailAdd> fetchByPrimaryKeys(
	 ...
	 */
	public static List<NcbjBusinessDetailAdd> findWithDynamicQuery(
	 ...
	 */
	public static NcbjBusinessDetailAdd update(
		NcbjBusinessDetailAdd ncbjBusinessDetailAdd) {

		return getPersistence().update(ncbjBusinessDetailAdd);
	}
	...
	public static NcbjBusinessDetailAdd update(
		...
		return getPersistence().update(ncbjBusinessDetailAdd, serviceContext);
	}
	 ...
	 */
	public static List<NcbjBusinessDetailAdd> findBygetNCBJById(
	 ...
	 */
	public static NcbjBusinessDetailAdd findBygetNCBJById_First(
			long ncbjApplicationId,
			OrderByComparator<NcbjBusinessDetailAdd> orderByComparator)
		throws com.nbp.ncbj.application.form.service.exception.
			NoSuchNcbjBusinessDetailAddException {
	 ...
	 */
	public static NcbjBusinessDetailAdd fetchBygetNCBJById_First(
		long ncbjApplicationId,
		OrderByComparator<NcbjBusinessDetailAdd> orderByComparator) {
	 ...
	 * @throws NoSuchNcbjBusinessDetailAddException if a matching ncbj business detail add could not be found
	 */
	public static NcbjBusinessDetailAdd findBygetNCBJById_Last(
			long ncbjApplicationId,
			OrderByComparator<NcbjBusinessDetailAdd> orderByComparator)
		throws com.nbp.ncbj.application.form.service.exception.
			NoSuchNcbjBusinessDetailAddException {
	 ...
	 */
	public static NcbjBusinessDetailAdd fetchBygetNCBJById_Last(
		long ncbjApplicationId,
		OrderByComparator<NcbjBusinessDetailAdd> orderByComparator) {
	 ...
	 */
	public static NcbjBusinessDetailAdd[] findBygetNCBJById_PrevAndNext(
		...
		return getPersistence().findBygetNCBJById_PrevAndNext(
			ncbjBusinessDetailAddId, ncbjApplicationId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(ncbjBusinessDetailAdd);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(ncbjBusinessDetailAdds);
	}
	 ...
	 */
	public static NcbjBusinessDetailAdd create(long ncbjBusinessDetailAddId) {
		return getPersistence().create(ncbjBusinessDetailAddId);
	}
	 ...
	 * @throws NoSuchNcbjBusinessDetailAddException if a ncbj business detail add with the primary key could not be found
	 */
	public static NcbjBusinessDetailAdd remove(long ncbjBusinessDetailAddId)
		throws com.nbp.ncbj.application.form.service.exception.
			NoSuchNcbjBusinessDetailAddException {

		return getPersistence().remove(ncbjBusinessDetailAddId);
	}

	public static NcbjBusinessDetailAdd updateImpl(
		NcbjBusinessDetailAdd ncbjBusinessDetailAdd) {

		return getPersistence().updateImpl(ncbjBusinessDetailAdd);
	}
	 ...
	 * @throws NoSuchNcbjBusinessDetailAddException if a ncbj business detail add with the primary key could not be found
	 */
	public static NcbjBusinessDetailAdd findByPrimaryKey(
			long ncbjBusinessDetailAddId)
		throws com.nbp.ncbj.application.form.service.exception.
			NoSuchNcbjBusinessDetailAddException {

		return getPersistence().findByPrimaryKey(ncbjBusinessDetailAddId);
	}
	 ...
	 */
	public static NcbjBusinessDetailAdd fetchByPrimaryKey(
		long ncbjBusinessDetailAddId) {

		return getPersistence().fetchByPrimaryKey(ncbjBusinessDetailAddId);
	}
	 ...
	 */
	public static List<NcbjBusinessDetailAdd> findAll() {
	 ...
	 */
	public static List<NcbjBusinessDetailAdd> findAll(int start, int end) {
	...
	public static NcbjBusinessDetailAddPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		NcbjBusinessDetailAddPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile NcbjBusinessDetailAddPersistence _persistence;
