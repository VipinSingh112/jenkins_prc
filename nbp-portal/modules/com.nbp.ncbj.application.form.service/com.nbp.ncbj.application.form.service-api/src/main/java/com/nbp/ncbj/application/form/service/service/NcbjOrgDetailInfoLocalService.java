...
/**
 * Provides the local service interface for NcbjOrgDetailInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjOrgDetailInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjOrgDetailInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjOrgDetailInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj org detail info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjOrgDetailInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjOrgDetailInfo addNcbjOrgDetailInfo(
	...
	public NcbjOrgDetailInfo createNcbjOrgDetailInfo(long ncbjOrgDetailInfoId);
	...
	public NcbjOrgDetailInfo deleteNcbjOrgDetailInfo(long ncbjOrgDetailInfoId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NcbjOrgDetailInfo deleteNcbjOrgDetailInfo(
		NcbjOrgDetailInfo ncbjOrgDetailInfo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjOrgDetailInfo fetchNcbjOrgDetailInfo(long ncbjOrgDetailInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjOrgDetailInfo getNCBJByAppId(long ncbjApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjOrgDetailInfo getNcbjOrgDetailInfo(long ncbjOrgDetailInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjOrgDetailInfo> getNcbjOrgDetailInfos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NcbjOrgDetailInfo updateNcbjOrgDetailInfo(
		NcbjOrgDetailInfo ncbjOrgDetailInfo);
