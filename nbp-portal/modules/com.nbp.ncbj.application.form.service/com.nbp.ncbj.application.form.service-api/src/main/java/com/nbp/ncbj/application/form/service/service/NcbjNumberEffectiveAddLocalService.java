...
/**
 * Provides the local service interface for NcbjNumberEffectiveAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjNumberEffectiveAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjNumberEffectiveAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjNumberEffectiveAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj number effective add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjNumberEffectiveAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjNumberEffectiveAdd addNcbjNumberEffectiveAdd(
	...
	public NcbjNumberEffectiveAdd createNcbjNumberEffectiveAdd(
	...
	public NcbjNumberEffectiveAdd deleteNcbjNumberEffectiveAdd(
			long ncbjNumberEffectiveAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjNumberEffectiveAdd fetchNcbjNumberEffectiveAdd(
		long ncbjNumberEffectiveAddId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjNumberEffectiveAdd> getNCBJById(long ncbjApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjNumberEffectiveAdd getNcbjNumberEffectiveAdd(
			long ncbjNumberEffectiveAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjNumberEffectiveAdd> getNcbjNumberEffectiveAdds(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NcbjNumberEffectiveAdd updateNcbjNumberEffectiveAdd(
		NcbjNumberEffectiveAdd ncbjNumberEffectiveAdd);
