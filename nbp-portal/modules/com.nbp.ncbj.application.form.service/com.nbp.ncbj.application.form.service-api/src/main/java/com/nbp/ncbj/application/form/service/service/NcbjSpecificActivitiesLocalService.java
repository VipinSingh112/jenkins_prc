...
/**
 * Provides the local service interface for NcbjSpecificActivities. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjSpecificActivitiesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjSpecificActivitiesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjSpecificActivitiesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj specific activities local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjSpecificActivitiesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjSpecificActivities getApp_byNcbjID(long ncbjApplicationId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjSpecificActivities> getNcbjById(long ncbjApplicationId);
