...
/**
 * The persistence interface for the ncbj number effective add service.
 *
 * <p>
 ...
 * @see NcbjNumberEffectiveAddUtil
 * @generated
 */
@ProviderType
public interface NcbjNumberEffectiveAddPersistence
	extends BasePersistence<NcbjNumberEffectiveAdd> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NcbjNumberEffectiveAddUtil} to access the ncbj number effective add persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<NcbjNumberEffectiveAdd> findBygetNCBJById(
	...
	public java.util.List<NcbjNumberEffectiveAdd> findBygetNCBJById(
		long ncbjApplicationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<NcbjNumberEffectiveAdd>
			orderByComparator);
	...
	public NcbjNumberEffectiveAdd findBygetNCBJById_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<NcbjNumberEffectiveAdd> orderByComparator)
	...
	public void cacheResult(
		java.util.List<NcbjNumberEffectiveAdd> ncbjNumberEffectiveAdds);
	 ...
	 */
	public java.util.List<NcbjNumberEffectiveAdd> findAll();
	 ...
	 */
	public java.util.List<NcbjNumberEffectiveAdd> findAll(int start, int end);
