...
/**
 * Provides the local service utility for NcbjNumberEffectiveAdd. This utility wraps
 * <code>com.nbp.ncbj.application.form.service.service.impl.NcbjNumberEffectiveAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcbjNumberEffectiveAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjNumberEffectiveAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcbjNumberEffectiveAdd addNcbjNumberEffectiveAdd(
		NcbjNumberEffectiveAdd ncbjNumberEffectiveAdd) {

		return getService().addNcbjNumberEffectiveAdd(ncbjNumberEffectiveAdd);
	}
	 ...
	 */
	public static NcbjNumberEffectiveAdd createNcbjNumberEffectiveAdd(
		long ncbjNumberEffectiveAddId) {

		return getService().createNcbjNumberEffectiveAdd(
	 ...
	 */
	public static NcbjNumberEffectiveAdd deleteNcbjNumberEffectiveAdd(
			long ncbjNumberEffectiveAddId)
		throws PortalException {

		return getService().deleteNcbjNumberEffectiveAdd(
			ncbjNumberEffectiveAddId);
	}
	...
	public static NcbjNumberEffectiveAdd fetchNcbjNumberEffectiveAdd(
		long ncbjNumberEffectiveAddId) {

		return getService().fetchNcbjNumberEffectiveAdd(
			ncbjNumberEffectiveAddId);
	}
	...
	public static List<NcbjNumberEffectiveAdd> getNCBJById(
	 ...
	 * @throws PortalException if a ncbj number effective add with the primary key could not be found
	 */
	public static NcbjNumberEffectiveAdd getNcbjNumberEffectiveAdd(
			long ncbjNumberEffectiveAddId)
		throws PortalException {

		return getService().getNcbjNumberEffectiveAdd(ncbjNumberEffectiveAddId);
	}
	 ...
	 */
	public static List<NcbjNumberEffectiveAdd> getNcbjNumberEffectiveAdds(
		int start, int end) {

		return getService().getNcbjNumberEffectiveAdds(start, end);
	}
	 ...
	 */
	public static int getNcbjNumberEffectiveAddsCount() {
		return getService().getNcbjNumberEffectiveAddsCount();
	}
	 ...
	 */
	public static NcbjNumberEffectiveAdd updateNcbjNumberEffectiveAdd(
		NcbjNumberEffectiveAdd ncbjNumberEffectiveAdd) {

		return getService().updateNcbjNumberEffectiveAdd(
			ncbjNumberEffectiveAdd);
	}

	public static NcbjNumberEffectiveAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcbjNumberEffectiveAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcbjNumberEffectiveAddLocalServiceUtil.class,
			NcbjNumberEffectiveAddLocalService.class);
