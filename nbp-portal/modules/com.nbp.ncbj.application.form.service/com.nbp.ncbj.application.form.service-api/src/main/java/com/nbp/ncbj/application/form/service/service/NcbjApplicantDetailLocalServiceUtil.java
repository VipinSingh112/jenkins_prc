...
/**
 * Provides the local service utility for NcbjApplicantDetail. This utility wraps
 * <code>com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcbjApplicantDetailLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjApplicantDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcbjApplicantDetail addNcbjApplicantDetail(
		NcbjApplicantDetail ncbjApplicantDetail) {

		return getService().addNcbjApplicantDetail(ncbjApplicantDetail);
	}
	 ...
	 */
	public static NcbjApplicantDetail createNcbjApplicantDetail(
		long ncbjApplicantDetailId) {

		return getService().createNcbjApplicantDetail(ncbjApplicantDetailId);
	}
	 ...
	 */
	public static NcbjApplicantDetail deleteNcbjApplicantDetail(
			long ncbjApplicantDetailId)
		throws PortalException {

		return getService().deleteNcbjApplicantDetail(ncbjApplicantDetailId);
	}
	...
	public static NcbjApplicantDetail deleteNcbjApplicantDetail(
		...
		return getService().deleteNcbjApplicantDetail(ncbjApplicantDetail);
	}
	...
	public static NcbjApplicantDetail fetchNcbjApplicantDetail(
		long ncbjApplicantDetailId) {

		return getService().fetchNcbjApplicantDetail(ncbjApplicantDetailId);
	}
	 ...
	 * @throws PortalException if a ncbj applicant detail with the primary key could not be found
	 */
	public static NcbjApplicantDetail getNcbjApplicantDetail(
			long ncbjApplicantDetailId)
		throws PortalException {

		return getService().getNcbjApplicantDetail(ncbjApplicantDetailId);
	}
	 ...
	 */
	public static List<NcbjApplicantDetail> getNcbjApplicantDetails(
		int start, int end) {

		return getService().getNcbjApplicantDetails(start, end);
	}
	 ...
	 */
	public static int getNcbjApplicantDetailsCount() {
		return getService().getNcbjApplicantDetailsCount();
	}

	public static NcbjApplicantDetail getNCBJById(long ncbjApplicationId)
	 ...
	 */
	public static NcbjApplicantDetail updateNcbjApplicantDetail(
		NcbjApplicantDetail ncbjApplicantDetail) {

		return getService().updateNcbjApplicantDetail(ncbjApplicantDetail);
	}

	public static NcbjApplicantDetailLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcbjApplicantDetailLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcbjApplicantDetailLocalServiceUtil.class,
			NcbjApplicantDetailLocalService.class);
