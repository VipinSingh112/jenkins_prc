...
/**
 * Provides the local service utility for NcbjSectionOneAdd. This utility wraps
 * <code>com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcbjSectionOneAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjSectionOneAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcbjSectionOneAdd addNcbjSectionOneAdd(
		NcbjSectionOneAdd ncbjSectionOneAdd) {

		return getService().addNcbjSectionOneAdd(ncbjSectionOneAdd);
	}
	 ...
	 */
	public static NcbjSectionOneAdd createNcbjSectionOneAdd(
		long ncbjSectionOneAddId) {

		return getService().createNcbjSectionOneAdd(ncbjSectionOneAddId);
	}
	 ...
	 */
	public static NcbjSectionOneAdd deleteNcbjSectionOneAdd(
			long ncbjSectionOneAddId)
		throws PortalException {

		return getService().deleteNcbjSectionOneAdd(ncbjSectionOneAddId);
	}
	...
	public static NcbjSectionOneAdd deleteNcbjSectionOneAdd(
		...
		return getService().deleteNcbjSectionOneAdd(ncbjSectionOneAdd);
	}
	...
	public static NcbjSectionOneAdd fetchNcbjSectionOneAdd(
		long ncbjSectionOneAddId) {

		return getService().fetchNcbjSectionOneAdd(ncbjSectionOneAddId);
	}
	...
	public static List<NcbjSectionOneAdd> getNCBJById(long ncbjApplicationId) {
	 ...
	 * @throws PortalException if a ncbj section one add with the primary key could not be found
	 */
	public static NcbjSectionOneAdd getNcbjSectionOneAdd(
			long ncbjSectionOneAddId)
		throws PortalException {

		return getService().getNcbjSectionOneAdd(ncbjSectionOneAddId);
	}
	 ...
	 */
	public static List<NcbjSectionOneAdd> getNcbjSectionOneAdds(
		int start, int end) {

		return getService().getNcbjSectionOneAdds(start, end);
	}
	 ...
	 */
	public static int getNcbjSectionOneAddsCount() {
		return getService().getNcbjSectionOneAddsCount();
	}
	 ...
	 */
	public static NcbjSectionOneAdd updateNcbjSectionOneAdd(
		NcbjSectionOneAdd ncbjSectionOneAdd) {

		return getService().updateNcbjSectionOneAdd(ncbjSectionOneAdd);
	}

	public static NcbjSectionOneAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcbjSectionOneAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcbjSectionOneAddLocalServiceUtil.class,
			NcbjSectionOneAddLocalService.class);
