...
/**
 * Provides the local service interface for NcbjCompanyDetailAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjCompanyDetailAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjCompanyDetailAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjCompanyDetailAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj company detail add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjCompanyDetailAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjCompanyDetailAdd addNcbjCompanyDetailAdd(
	...
	public NcbjCompanyDetailAdd createNcbjCompanyDetailAdd(
	...
	public NcbjCompanyDetailAdd deleteNcbjCompanyDetailAdd(
			long ncbjCompanyDetailAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjCompanyDetailAdd fetchNcbjCompanyDetailAdd(
		long ncbjCompanyDetailAddId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjCompanyDetailAdd> getNCBJById(long ncbjApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjCompanyDetailAdd getNcbjCompanyDetailAdd(
			long ncbjCompanyDetailAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjCompanyDetailAdd> getNcbjCompanyDetailAdds(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NcbjCompanyDetailAdd updateNcbjCompanyDetailAdd(
		NcbjCompanyDetailAdd ncbjCompanyDetailAdd);
