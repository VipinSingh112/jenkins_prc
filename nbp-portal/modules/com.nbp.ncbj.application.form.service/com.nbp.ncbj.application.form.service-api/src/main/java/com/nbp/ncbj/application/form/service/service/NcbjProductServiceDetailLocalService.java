...
/**
 * Provides the local service interface for NcbjProductServiceDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjProductServiceDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjProductServiceDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.application.form.service.service.impl.NcbjProductServiceDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj product service detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjProductServiceDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjProductServiceDetail addNcbjProductServiceDetail(
	...
	public NcbjProductServiceDetail createNcbjProductServiceDetail(
	...
	public NcbjProductServiceDetail deleteNcbjProductServiceDetail(
			long ncbjProductServiceDetailId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjProductServiceDetail fetchNcbjProductServiceDetail(
		long ncbjProductServiceDetailId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjProductServiceDetail> getNCBJ_ByAppId(
		long ncbjApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjProductServiceDetail getNCBJByAppId(long ncbjApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcbjProductServiceDetail getNcbjProductServiceDetail(
			long ncbjProductServiceDetailId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcbjProductServiceDetail> getNcbjProductServiceDetails(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NcbjProductServiceDetail updateNcbjProductServiceDetail(
		NcbjProductServiceDetail ncbjProductServiceDetail);
