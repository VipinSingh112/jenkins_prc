...
/**
 * The persistence interface for the ncbj company detail add service.
 *
 * <p>
 ...
 * @see NcbjCompanyDetailAddUtil
 * @generated
 */
@ProviderType
public interface NcbjCompanyDetailAddPersistence
	extends BasePersistence<NcbjCompanyDetailAdd> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NcbjCompanyDetailAddUtil} to access the ncbj company detail add persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<NcbjCompanyDetailAdd> findBygetNCBJById(
	...
	public java.util.List<NcbjCompanyDetailAdd> findBygetNCBJById(
		long ncbjApplicationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<NcbjCompanyDetailAdd>
			orderByComparator);
	...
	public NcbjCompanyDetailAdd findBygetNCBJById_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<NcbjCompanyDetailAdd> orderByComparator)
	...
	public void cacheResult(
		java.util.List<NcbjCompanyDetailAdd> ncbjCompanyDetailAdds);
	 ...
	 */
	public java.util.List<NcbjCompanyDetailAdd> findAll();
	 ...
	 */
	public java.util.List<NcbjCompanyDetailAdd> findAll(int start, int end);
