...
import com.nbp.acquire.stages.service.service.AcquireDueDiligenceLocalService;
...
/**
 * Provides the base implementation for the acquire due diligence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireDueDiligenceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireDueDiligenceLocalServiceImpl
 * @generated
 */
public abstract class AcquireDueDiligenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AcquireDueDiligenceLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireDueDiligenceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireDueDiligenceLocalServiceUtil</code>.
	 */
	...
	public AcquireDueDiligence addAcquireDueDiligence(
		...
		return acquireDueDiligencePersistence.update(acquireDueDiligence);
	}
	...
	public AcquireDueDiligence createAcquireDueDiligence(long sampleId) {
		return acquireDueDiligencePersistence.create(sampleId);
	}
	...
	public AcquireDueDiligence deleteAcquireDueDiligence(long sampleId)
		...
		return acquireDueDiligencePersistence.remove(sampleId);
	}
	...
	public AcquireDueDiligence deleteAcquireDueDiligence(
		...
		return acquireDueDiligencePersistence.remove(acquireDueDiligence);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return acquireDueDiligencePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AcquireDueDiligence.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acquireDueDiligencePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acquireDueDiligencePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AcquireDueDiligence fetchAcquireDueDiligence(long sampleId) {
		return acquireDueDiligencePersistence.fetchByPrimaryKey(sampleId);
	}
	...
	public AcquireDueDiligence getAcquireDueDiligence(long sampleId)
		...
		return acquireDueDiligencePersistence.findByPrimaryKey(sampleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AcquireDueDiligence.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return acquireDueDiligencePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AcquireDueDiligenceLocalServiceImpl#deleteAcquireDueDiligence(AcquireDueDiligence) to avoid orphaned data");
		}

		return acquireDueDiligenceLocalService.deleteAcquireDueDiligence(
			(AcquireDueDiligence)persistedModel);
	}

	@Override
	public BasePersistence<AcquireDueDiligence> getBasePersistence() {
		return acquireDueDiligencePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return acquireDueDiligencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AcquireDueDiligence> getAcquireDueDiligences(
		...
		return acquireDueDiligencePersistence.findAll(start, end);
	}
	...
	public int getAcquireDueDiligencesCount() {
		return acquireDueDiligencePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		acquireDueDiligenceLocalService =
			(AcquireDueDiligenceLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireDueDiligenceLocalService.class.getName();
	}
	...
	protected AcquireDueDiligenceLocalService acquireDueDiligenceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireDueDiligenceLocalServiceBaseImpl.class);
