...
import com.nbp.acquire.stages.service.service.AcquireFinalExecutedAgreementService;
...
/**
 * Provides the base implementation for the acquire final executed agreement remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireFinalExecutedAgreementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireFinalExecutedAgreementServiceImpl
 * @generated
 */
public abstract class AcquireFinalExecutedAgreementServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireFinalExecutedAgreementService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireFinalExecutedAgreementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireFinalExecutedAgreementServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		acquireFinalExecutedAgreementService =
			(AcquireFinalExecutedAgreementService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireFinalExecutedAgreementService.class.getName();
	}
	...
	@Reference
	protected com.nbp.acquire.stages.service.service.
		AcquireFinalExecutedAgreementLocalService
			acquireFinalExecutedAgreementLocalService;

	protected AcquireFinalExecutedAgreementService
		acquireFinalExecutedAgreementService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireFinalExecutedAgreementServiceBaseImpl.class);
