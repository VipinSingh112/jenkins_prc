...
import com.nbp.acquire.stages.service.service.AcquireEvaluationService;
...
/**
 * Provides the base implementation for the acquire evaluation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireEvaluationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireEvaluationServiceImpl
 * @generated
 */
public abstract class AcquireEvaluationServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireEvaluationService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireEvaluationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireEvaluationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireEvaluationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireEvaluationService = (AcquireEvaluationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireEvaluationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.acquire.stages.service.service.AcquireEvaluationLocalService
			acquireEvaluationLocalService;

	protected AcquireEvaluationService acquireEvaluationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireEvaluationServiceBaseImpl.class);
