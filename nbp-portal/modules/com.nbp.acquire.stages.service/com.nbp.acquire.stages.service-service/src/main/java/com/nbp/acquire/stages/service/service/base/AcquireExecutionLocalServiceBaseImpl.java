...
import com.nbp.acquire.stages.service.service.AcquireExecutionLocalService;
...
/**
 * Provides the base implementation for the acquire execution local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireExecutionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireExecutionLocalServiceImpl
 * @generated
 */
public abstract class AcquireExecutionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AcquireExecutionLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireExecutionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireExecutionLocalServiceUtil</code>.
	 */
	...
	public AcquireExecution addAcquireExecution(
		...
		return acquireExecutionPersistence.update(acquireExecution);
	}
	...
	public AcquireExecution createAcquireExecution(long acquireExecutionId) {
		return acquireExecutionPersistence.create(acquireExecutionId);
	}
	...
	public AcquireExecution deleteAcquireExecution(long acquireExecutionId)
		...
		return acquireExecutionPersistence.remove(acquireExecutionId);
	}
	...
	public AcquireExecution deleteAcquireExecution(
		...
		return acquireExecutionPersistence.remove(acquireExecution);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return acquireExecutionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AcquireExecution.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acquireExecutionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return acquireExecutionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acquireExecutionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return acquireExecutionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AcquireExecution fetchAcquireExecution(long acquireExecutionId) {
		return acquireExecutionPersistence.fetchByPrimaryKey(
			acquireExecutionId);
	}
	...
	public AcquireExecution getAcquireExecution(long acquireExecutionId)
		...
		return acquireExecutionPersistence.findByPrimaryKey(acquireExecutionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AcquireExecution.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("acquireExecutionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AcquireExecution.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return acquireExecutionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AcquireExecutionLocalServiceImpl#deleteAcquireExecution(AcquireExecution) to avoid orphaned data");
		}

		return acquireExecutionLocalService.deleteAcquireExecution(
			(AcquireExecution)persistedModel);
	}

	@Override
	public BasePersistence<AcquireExecution> getBasePersistence() {
		return acquireExecutionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return acquireExecutionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AcquireExecution> getAcquireExecutions(int start, int end) {
		return acquireExecutionPersistence.findAll(start, end);
	}
	...
	public int getAcquireExecutionsCount() {
		return acquireExecutionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireExecutionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		acquireExecutionLocalService = (AcquireExecutionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireExecutionLocalService.class.getName();
	}
	...
	protected AcquireExecutionLocalService acquireExecutionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireExecutionLocalServiceBaseImpl.class);
