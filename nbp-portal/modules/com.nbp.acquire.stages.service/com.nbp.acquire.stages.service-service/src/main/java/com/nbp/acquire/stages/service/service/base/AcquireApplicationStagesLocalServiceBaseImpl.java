...
import com.nbp.acquire.stages.service.service.AcquireApplicationStagesLocalService;
...
/**
 * Provides the base implementation for the acquire application stages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireApplicationStagesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireApplicationStagesLocalServiceImpl
 * @generated
 */
public abstract class AcquireApplicationStagesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AcquireApplicationStagesLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireApplicationStagesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireApplicationStagesLocalServiceUtil</code>.
	 */
	...
	public AcquireApplicationStages addAcquireApplicationStages(
		...
		return acquireApplicationStagesPersistence.update(
	...
	public AcquireApplicationStages createAcquireApplicationStages(
		...
		return acquireApplicationStagesPersistence.create(
	...
	public AcquireApplicationStages deleteAcquireApplicationStages(
		...
		return acquireApplicationStagesPersistence.remove(
			acquireApplicationStagesId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return acquireApplicationStagesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AcquireApplicationStages.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acquireApplicationStagesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acquireApplicationStagesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AcquireApplicationStages fetchAcquireApplicationStages(
		...
		return acquireApplicationStagesPersistence.fetchByPrimaryKey(
			acquireApplicationStagesId);
	}
	...
	public AcquireApplicationStages getAcquireApplicationStages(
		...
		return acquireApplicationStagesPersistence.findByPrimaryKey(
			acquireApplicationStagesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AcquireApplicationStages.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AcquireApplicationStages.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AcquireApplicationStagesLocalServiceImpl#deleteAcquireApplicationStages(AcquireApplicationStages) to avoid orphaned data");
		}

		return acquireApplicationStagesLocalService.
			deleteAcquireApplicationStages(
				(AcquireApplicationStages)persistedModel);
	}

	@Override
	public BasePersistence<AcquireApplicationStages> getBasePersistence() {
		return acquireApplicationStagesPersistence;
	}
	...
	public List<AcquireApplicationStages> getAcquireApplicationStageses(
		...
		return acquireApplicationStagesPersistence.findAll(start, end);
	}
	...
	public int getAcquireApplicationStagesesCount() {
		return acquireApplicationStagesPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		acquireApplicationStagesLocalService =
			(AcquireApplicationStagesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireApplicationStagesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				acquireApplicationStagesPersistence.getDataSource();
	...
	protected AcquireApplicationStagesLocalService
		acquireApplicationStagesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireApplicationStagesLocalServiceBaseImpl.class);
