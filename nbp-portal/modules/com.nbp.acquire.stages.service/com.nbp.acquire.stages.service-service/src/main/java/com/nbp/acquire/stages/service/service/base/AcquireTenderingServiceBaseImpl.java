...
import com.nbp.acquire.stages.service.service.AcquireTenderingService;
...
/**
 * Provides the base implementation for the acquire tendering remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireTenderingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireTenderingServiceImpl
 * @generated
 */
public abstract class AcquireTenderingServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireTenderingService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireTenderingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireTenderingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireTenderingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireTenderingService = (AcquireTenderingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireTenderingService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.acquire.stages.service.service.AcquireTenderingLocalService
			acquireTenderingLocalService;

	protected AcquireTenderingService acquireTenderingService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireTenderingServiceBaseImpl.class);
