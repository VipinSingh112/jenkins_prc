...
import com.nbp.acquire.stages.service.service.AcquirePaymentConfirmationService;
...
/**
 * Provides the base implementation for the acquire payment confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquirePaymentConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquirePaymentConfirmationServiceImpl
 * @generated
 */
public abstract class AcquirePaymentConfirmationServiceBaseImpl
	extends BaseServiceImpl
	implements AcquirePaymentConfirmationService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquirePaymentConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquirePaymentConfirmationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		acquirePaymentConfirmationService =
			(AcquirePaymentConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquirePaymentConfirmationService.class.getName();
	}
	...
	protected AcquirePaymentConfirmationService
		acquirePaymentConfirmationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquirePaymentConfirmationServiceBaseImpl.class);
