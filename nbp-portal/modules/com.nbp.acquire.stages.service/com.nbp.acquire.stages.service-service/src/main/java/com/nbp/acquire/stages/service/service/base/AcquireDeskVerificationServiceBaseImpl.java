...
import com.nbp.acquire.stages.service.service.AcquireDeskVerificationService;
...
/**
 * Provides the base implementation for the acquire desk verification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireDeskVerificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireDeskVerificationServiceImpl
 * @generated
 */
public abstract class AcquireDeskVerificationServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireDeskVerificationService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireDeskVerificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireDeskVerificationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireDeskVerificationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireDeskVerificationService =
			(AcquireDeskVerificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireDeskVerificationService.class.getName();
	}
	...
	protected AcquireDeskVerificationService acquireDeskVerificationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireDeskVerificationServiceBaseImpl.class);
