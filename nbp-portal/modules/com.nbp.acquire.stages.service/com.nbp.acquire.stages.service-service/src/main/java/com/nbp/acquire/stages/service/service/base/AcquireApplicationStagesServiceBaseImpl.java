...
import com.nbp.acquire.stages.service.service.AcquireApplicationStagesService;
...
/**
 * Provides the base implementation for the acquire application stages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireApplicationStagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireApplicationStagesServiceImpl
 * @generated
 */
public abstract class AcquireApplicationStagesServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireApplicationStagesService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireApplicationStagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireApplicationStagesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireApplicationStagesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireApplicationStagesService =
			(AcquireApplicationStagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireApplicationStagesService.class.getName();
	}
	...
	protected AcquireApplicationStagesService acquireApplicationStagesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireApplicationStagesServiceBaseImpl.class);
