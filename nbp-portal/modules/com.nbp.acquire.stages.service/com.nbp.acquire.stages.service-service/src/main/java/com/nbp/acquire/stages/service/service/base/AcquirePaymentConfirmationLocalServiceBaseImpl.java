...
import com.nbp.acquire.stages.service.service.AcquirePaymentConfirmationLocalService;
...
/**
 * Provides the base implementation for the acquire payment confirmation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquirePaymentConfirmationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquirePaymentConfirmationLocalServiceImpl
 * @generated
 */
public abstract class AcquirePaymentConfirmationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AcquirePaymentConfirmationLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquirePaymentConfirmationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquirePaymentConfirmationLocalServiceUtil</code>.
	 */
	...
	public AcquirePaymentConfirmation addAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.update(
	...
	public AcquirePaymentConfirmation createAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.create(acquirePaymentId);
	}
	...
	public AcquirePaymentConfirmation deleteAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.remove(acquirePaymentId);
	}
	...
	public AcquirePaymentConfirmation deleteAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.remove(
			acquirePaymentConfirmation);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return acquirePaymentConfirmationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AcquirePaymentConfirmation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return acquirePaymentConfirmationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return acquirePaymentConfirmationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AcquirePaymentConfirmation fetchAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.fetchByPrimaryKey(
			acquirePaymentId);
	}
	...
	public AcquirePaymentConfirmation getAcquirePaymentConfirmation(
		...
		return acquirePaymentConfirmationPersistence.findByPrimaryKey(
			acquirePaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AcquirePaymentConfirmation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("acquirePaymentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AcquirePaymentConfirmation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return acquirePaymentConfirmationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AcquirePaymentConfirmationLocalServiceImpl#deleteAcquirePaymentConfirmation(AcquirePaymentConfirmation) to avoid orphaned data");
		}

		return acquirePaymentConfirmationLocalService.
			deleteAcquirePaymentConfirmation(
				(AcquirePaymentConfirmation)persistedModel);
	}

	@Override
	public BasePersistence<AcquirePaymentConfirmation> getBasePersistence() {
		return acquirePaymentConfirmationPersistence;
	}
	...
	public List<AcquirePaymentConfirmation> getAcquirePaymentConfirmations(
		...
		return acquirePaymentConfirmationPersistence.findAll(start, end);
	}
	...
	public int getAcquirePaymentConfirmationsCount() {
		return acquirePaymentConfirmationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		acquirePaymentConfirmationLocalService =
			(AcquirePaymentConfirmationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquirePaymentConfirmationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				acquirePaymentConfirmationPersistence.getDataSource();
	...
	protected AcquirePaymentConfirmationLocalService
		acquirePaymentConfirmationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquirePaymentConfirmationLocalServiceBaseImpl.class);
