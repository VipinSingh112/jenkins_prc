...
import com.nbp.acquire.stages.service.service.AcquireDraftAgreementService;
...
/**
 * Provides the base implementation for the acquire draft agreement remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.acquire.stages.service.service.impl.AcquireDraftAgreementServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.acquire.stages.service.service.impl.AcquireDraftAgreementServiceImpl
 * @generated
 */
public abstract class AcquireDraftAgreementServiceBaseImpl
	extends BaseServiceImpl
	implements AcquireDraftAgreementService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AcquireDraftAgreementService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.acquire.stages.service.service.AcquireDraftAgreementServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AcquireDraftAgreementService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		acquireDraftAgreementService = (AcquireDraftAgreementService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AcquireDraftAgreementService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.acquire.stages.service.service.AcquireDraftAgreementLocalService
			acquireDraftAgreementLocalService;

	protected AcquireDraftAgreementService acquireDraftAgreementService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AcquireDraftAgreementServiceBaseImpl.class);
