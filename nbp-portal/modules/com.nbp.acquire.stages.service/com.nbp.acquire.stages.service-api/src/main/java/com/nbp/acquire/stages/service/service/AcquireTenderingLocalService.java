...
/**
 * Provides the local service interface for AcquireTendering. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AcquireTenderingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AcquireTenderingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquireTenderingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the acquire tendering local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AcquireTenderingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquireTendering getAcquireTenderingBy_CI(String caseId)
		throws NoSuchAcquireTenderingException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AcquireTendering> getAcquireTenderingListByCI(String caseId)
		throws NoSuchAcquireTenderingException;
	...
	public AcquireTendering updateAcquireApplicationTendering(
	...
	public AcquireTendering updateApplicationTenderingBiddingStage(
