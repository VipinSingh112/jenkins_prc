...
/**
 * Provides the local service utility for AcquireFinalExecutedAgreement. This utility wraps
 * <code>com.nbp.acquire.stages.service.service.impl.AcquireFinalExecutedAgreementLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AcquireFinalExecutedAgreementLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquireFinalExecutedAgreementLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AcquireFinalExecutedAgreement
		addAcquireFinalExecutedAgreement(
			AcquireFinalExecutedAgreement acquireFinalExecutedAgreement) {

		return getService().addAcquireFinalExecutedAgreement(
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().createAcquireFinalExecutedAgreement(acquirefinalId);
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().deleteAcquireFinalExecutedAgreement(
			acquireFinalExecutedAgreement);
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().deleteAcquireFinalExecutedAgreement(acquirefinalId);
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().fetchAcquireFinalExecutedAgreement(acquirefinalId);
	}

	public static AcquireFinalExecutedAgreement getAcquireFinalAgreementBy_CI(
			String caseId)
		throws com.nbp.acquire.stages.service.exception.
			NoSuchAcquireFinalExecutedAgreementException {

		return getService().getAcquireFinalAgreementBy_CI(caseId);
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().getAcquireFinalExecutedAgreement(acquirefinalId);
	}
	 ...
	 */
	public static List<AcquireFinalExecutedAgreement>
		getAcquireFinalExecutedAgreements(int start, int end) {

		return getService().getAcquireFinalExecutedAgreements(start, end);
	}
	 ...
	 */
	public static int getAcquireFinalExecutedAgreementsCount() {
		return getService().getAcquireFinalExecutedAgreementsCount();
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().updateAcquireFinalExecutedAgreement(
			acquireFinalExecutedAgreement);
	}
	...
	public static AcquireFinalExecutedAgreement
		...
		return getService().updateAcquireFinalExecutedAgreement(
			caseId, dateContractExecuted);
	}

	public static AcquireFinalExecutedAgreementLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AcquireFinalExecutedAgreementLocalService>
		_serviceSnapshot = new Snapshot<>(
			AcquireFinalExecutedAgreementLocalServiceUtil.class,
