...
/**
 * Provides the local service utility for AcquireDraftAgreement. This utility wraps
 * <code>com.nbp.acquire.stages.service.service.impl.AcquireDraftAgreementLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AcquireDraftAgreementLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquireDraftAgreementLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AcquireDraftAgreement addAcquireDraftAgreement(
		AcquireDraftAgreement acquireDraftAgreement) {

		return getService().addAcquireDraftAgreement(acquireDraftAgreement);
	}
	 ...
	 */
	public static AcquireDraftAgreement createAcquireDraftAgreement(
		long acquireDraftId) {

		return getService().createAcquireDraftAgreement(acquireDraftId);
	}
	 ...
	 */
	public static AcquireDraftAgreement deleteAcquireDraftAgreement(
		AcquireDraftAgreement acquireDraftAgreement) {

		return getService().deleteAcquireDraftAgreement(acquireDraftAgreement);
	}
	...
	public static AcquireDraftAgreement deleteAcquireDraftAgreement(
		...
		return getService().deleteAcquireDraftAgreement(acquireDraftId);
	}
	...
	public static AcquireDraftAgreement fetchAcquireDraftAgreement(
		long acquireDraftId) {

		return getService().fetchAcquireDraftAgreement(acquireDraftId);
	}

	public static AcquireDraftAgreement getAcquireDrafAgreementBy_CI(
			String caseId)
		throws com.nbp.acquire.stages.service.exception.
			NoSuchAcquireDraftAgreementException {

		return getService().getAcquireDrafAgreementBy_CI(caseId);
	}
	 ...
	 * @throws PortalException if a acquire draft agreement with the primary key could not be found
	 */
	public static AcquireDraftAgreement getAcquireDraftAgreement(
			long acquireDraftId)
		throws PortalException {

		return getService().getAcquireDraftAgreement(acquireDraftId);
	}
	 ...
	 */
	public static List<AcquireDraftAgreement> getAcquireDraftAgreements(
		int start, int end) {

		return getService().getAcquireDraftAgreements(start, end);
	}
	 ...
	 */
	public static int getAcquireDraftAgreementsCount() {
		return getService().getAcquireDraftAgreementsCount();
	}
	 ...
	 */
	public static AcquireDraftAgreement updateAcquireDraftAgreement(
		AcquireDraftAgreement acquireDraftAgreement) {

		return getService().updateAcquireDraftAgreement(acquireDraftAgreement);
	}

	public static AcquireDraftAgreement updateAcquireDraftAgreement(
		String caseId, String paymentAmountDue) {

		return getService().updateAcquireDraftAgreement(
			caseId, paymentAmountDue);
	}

	public static AcquireDraftAgreementLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AcquireDraftAgreementLocalService>
		_serviceSnapshot = new Snapshot<>(
			AcquireDraftAgreementLocalServiceUtil.class,
