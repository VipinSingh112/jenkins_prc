...
/**
 * Provides the local service interface for AcquireEvaluation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AcquireEvaluationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AcquireEvaluationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquireEvaluationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the acquire evaluation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AcquireEvaluationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquireEvaluation getAcquireEvaluationBy_CI(String caseId)
	...
	public AcquireEvaluation updateAcquireApplicationEvaluation(
		String caseId, String typeOfCommittee, Date dateOfCommitteeDecision,
