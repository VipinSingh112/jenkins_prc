...
/**
 * Provides the local service interface for AcquirePaymentConfirmation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AcquirePaymentConfirmationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AcquirePaymentConfirmationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquirePaymentConfirmationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the acquire payment confirmation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AcquirePaymentConfirmationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AcquirePaymentConfirmation addAcquirePaymentConfirmation(
	...
	public AcquirePaymentConfirmation createAcquirePaymentConfirmation(
	...
	public AcquirePaymentConfirmation deleteAcquirePaymentConfirmation(
		AcquirePaymentConfirmation acquirePaymentConfirmation);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquirePaymentConfirmation fetchAcquirePaymentConfirmation(
		long acquirePaymentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquirePaymentConfirmation getAcquirePaymentConfirmation(
			long acquirePaymentId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquirePaymentConfirmation getAcquirePaymentConfirmationById(
		String caseId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AcquirePaymentConfirmation> getAcquirePaymentConfirmations(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AcquirePaymentConfirmation updateAcquirePaymentConfirmation(
		AcquirePaymentConfirmation acquirePaymentConfirmation);
