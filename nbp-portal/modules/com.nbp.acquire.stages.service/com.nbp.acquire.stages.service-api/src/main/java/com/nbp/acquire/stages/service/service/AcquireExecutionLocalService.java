...
/**
 * Provides the local service interface for AcquireExecution. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AcquireExecutionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AcquireExecutionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.acquire.stages.service.service.impl.AcquireExecutionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the acquire execution local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AcquireExecutionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AcquireExecution addAcquireExecution(
	...
	public AcquireExecution createAcquireExecution(long acquireExecutionId);
	...
	public AcquireExecution deleteAcquireExecution(
		AcquireExecution acquireExecution);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AcquireExecution deleteAcquireExecution(long acquireExecutionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquireExecution fetchAcquireExecution(long acquireExecutionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquireExecution getAcquireExecution(long acquireExecutionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AcquireExecution getAcquireExecutionBy_CI(String caseId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AcquireExecution> getAcquireExecutions(int start, int end);
	...
	public AcquireExecution updateAcquireApplicationExecutiion(
		String caseId, String paymentSection, String paymentDue);

	public AcquireExecution updateAcquireApplicationExecutiion(
		String caseId, String paymentSection, String paymentDue,
		String contractSEction, Date dateContractExecuted);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AcquireExecution updateAcquireExecution(
		AcquireExecution acquireExecution);
