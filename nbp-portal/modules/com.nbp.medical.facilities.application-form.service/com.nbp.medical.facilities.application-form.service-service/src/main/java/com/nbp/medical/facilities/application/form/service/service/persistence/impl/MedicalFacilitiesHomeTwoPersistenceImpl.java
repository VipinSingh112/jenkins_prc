...
import com.nbp.medical.facilities.application.form.service.service.persistence.MedicalFacilitiesHomeTwoUtil;
...
/**
 * The persistence implementation for the medical facilities home two service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = MedicalFacilitiesHomeTwoPersistence.class)
public class MedicalFacilitiesHomeTwoPersistenceImpl
	extends BasePersistenceImpl<MedicalFacilitiesHomeTwo>
	implements MedicalFacilitiesHomeTwoPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>MedicalFacilitiesHomeTwoUtil</code> to access the medical facilities home two persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		MedicalFacilitiesHomeTwoImpl.class.getName();
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findByUuid(
	...
	public List<MedicalFacilitiesHomeTwo> findByUuid(
		...
		List<MedicalFacilitiesHomeTwo> list = null;

		if (useFinderCache) {
			list = (List<MedicalFacilitiesHomeTwo>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo : list) {
					if (!uuid.equals(medicalFacilitiesHomeTwo.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_MEDICALFACILITIESHOMETWO_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(MedicalFacilitiesHomeTwoModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<MedicalFacilitiesHomeTwo>)QueryUtil.list(
	...
	public MedicalFacilitiesHomeTwo findByUuid_First(
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByUuid_First(
			uuid, orderByComparator);

		if (medicalFacilitiesHomeTwo != null) {
		...
		throw new NoSuchMedicalFacilitiesHomeTwoException(sb.toString());
	}
	...
	public MedicalFacilitiesHomeTwo fetchByUuid_First(
		...
		List<MedicalFacilitiesHomeTwo> list = findByUuid(
	...
	public MedicalFacilitiesHomeTwo findByUuid_Last(
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public MedicalFacilitiesHomeTwo[] findByUuid_PrevAndNext(
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = findByPrimaryKey(
		...
		try {
			...
			MedicalFacilitiesHomeTwo[] array =
				new MedicalFacilitiesHomeTwoImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, medicalFacilitiesHomeTwo, uuid, orderByComparator,
				true);

			array[1] = medicalFacilitiesHomeTwo;
	...
	protected MedicalFacilitiesHomeTwo getByUuid_PrevAndNext(
		Session session, MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo,
		String uuid,
		OrderByComparator<MedicalFacilitiesHomeTwo> orderByComparator,
		boolean previous) {
		...
		List<MedicalFacilitiesHomeTwo> list = query.list();
	...
	public void removeByUuid(String uuid) {
		for (MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo :
				findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {

			remove(medicalFacilitiesHomeTwo);
		}
	}
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_MEDICALFACILITIESHOMETWO_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"medicalFacilitiesHomeTwo.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(medicalFacilitiesHomeTwo.uuid IS NULL OR medicalFacilitiesHomeTwo.uuid = '')";
	...
	public MedicalFacilitiesHomeTwo findByUUID_G(String uuid, long groupId)
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByUUID_G(
			uuid, groupId);
	...
	public MedicalFacilitiesHomeTwo fetchByUUID_G(
		...
		if (result instanceof MedicalFacilitiesHomeTwo) {
			MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo =
				(MedicalFacilitiesHomeTwo)result;

			if (!Objects.equals(uuid, medicalFacilitiesHomeTwo.getUuid()) ||
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					result = medicalFacilitiesHomeTwo;

					cacheResult(medicalFacilitiesHomeTwo);
				}
			}
			catch (Exception exception) {
				throw processException(exception);
		...
		if (result instanceof List<?>) {
			...
			return (MedicalFacilitiesHomeTwo)result;
		}
	}
	...
	public MedicalFacilitiesHomeTwo removeByUUID_G(String uuid, long groupId)
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = findByUUID_G(
			uuid, groupId);

		return remove(medicalFacilitiesHomeTwo);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"medicalFacilitiesHomeTwo.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(medicalFacilitiesHomeTwo.uuid IS NULL OR medicalFacilitiesHomeTwo.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"medicalFacilitiesHomeTwo.groupId = ?";
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo : list) {
					if (!uuid.equals(medicalFacilitiesHomeTwo.getUuid()) ||
						(companyId !=
							medicalFacilitiesHomeTwo.getCompanyId())) {
	...
	public MedicalFacilitiesHomeTwo findByUuid_C_First(
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByUuid_C_First(
	...
	public MedicalFacilitiesHomeTwo fetchByUuid_C_First(
		...
		List<MedicalFacilitiesHomeTwo> list = findByUuid_C(
	...
	public MedicalFacilitiesHomeTwo findByUuid_C_Last(
		...
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public MedicalFacilitiesHomeTwo[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, medicalFacilitiesHomeTwo, uuid, companyId,
	...
	protected MedicalFacilitiesHomeTwo getByUuid_C_PrevAndNext(
		Session session, MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo,
		String uuid, long companyId,
		OrderByComparator<MedicalFacilitiesHomeTwo> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 =
		"medicalFacilitiesHomeTwo.companyId = ?";
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findBygetMedicalFacilitiesById(
	...
	public MedicalFacilitiesHomeTwo fetchBygetMedicalFacilitiesById_First(
		...
		List<MedicalFacilitiesHomeTwo> list = findBygetMedicalFacilitiesById(
	...
	public MedicalFacilitiesHomeTwo[]
		...
		try {
			...
			array[0] = getBygetMedicalFacilitiesById_PrevAndNext(
				session, medicalFacilitiesHomeTwo, medicalFacilitiesAppId,
				orderByComparator, true);
	...
	protected MedicalFacilitiesHomeTwo
	...
	private static final String
		_FINDER_COLUMN_GETMEDICALFACILITIESBYID_MEDICALFACILITIESAPPID_2 =
			"medicalFacilitiesHomeTwo.medicalFacilitiesAppId = ?";
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"MedicalFacilitiesHomeTwoPersistenceImpl.fetchBygetMedicalFacilities_ByAppId(long, boolean) with parameters (" +
	...
	public MedicalFacilitiesHomeTwoPersistenceImpl() {
		...
		setModelClass(MedicalFacilitiesHomeTwo.class);

		setModelImplClass(MedicalFacilitiesHomeTwoImpl.class);
		setModelPKClass(long.class);

		setTable(MedicalFacilitiesHomeTwoTable.INSTANCE);
	}
	...
	public void cacheResult(MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo) {
		entityCache.putResult(
			MedicalFacilitiesHomeTwoImpl.class,
			medicalFacilitiesHomeTwo.getPrimaryKey(), medicalFacilitiesHomeTwo);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {
				medicalFacilitiesHomeTwo.getUuid(),
				medicalFacilitiesHomeTwo.getGroupId()
			},
			medicalFacilitiesHomeTwo);

		finderCache.putResult(
			_finderPathFetchBygetMedicalFacilities_ByAppId,
			new Object[] {medicalFacilitiesHomeTwo.getMedicalFacilitiesAppId()},
			medicalFacilitiesHomeTwo);
	}
	...
	public void cacheResult(
		...
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (medicalFacilitiesHomeTwos.size() >
		...
		for (MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo :
				medicalFacilitiesHomeTwos) {

			if (entityCache.getResult(
					MedicalFacilitiesHomeTwoImpl.class,
					medicalFacilitiesHomeTwo.getPrimaryKey()) == null) {
	...
	/**
	 * Clears the cache for all medical facilities home twos.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(MedicalFacilitiesHomeTwoImpl.class);

		finderCache.clearCache(MedicalFacilitiesHomeTwoImpl.class);
	}

	/**
	 * Clears the cache for the medical facilities home two.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo) {
		entityCache.removeResult(
			MedicalFacilitiesHomeTwoImpl.class, medicalFacilitiesHomeTwo);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				MedicalFacilitiesHomeTwoImpl.class, primaryKey);
		}
	}
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			medicalFacilitiesHomeTwoModelImpl.getUuid(),
			medicalFacilitiesHomeTwoModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, medicalFacilitiesHomeTwoModelImpl);

		args = new Object[] {
			medicalFacilitiesHomeTwoModelImpl.getMedicalFacilitiesAppId()
		};
		...
		finderCache.putResult(
			...
			medicalFacilitiesHomeTwoModelImpl);
	}
	...
	public MedicalFacilitiesHomeTwo create(long medicalFacilitiesHomeTwoId) {
		...
		medicalFacilitiesHomeTwo.setPrimaryKey(medicalFacilitiesHomeTwoId);

		String uuid = PortalUUIDUtil.generate();

		medicalFacilitiesHomeTwo.setUuid(uuid);
	...
	public MedicalFacilitiesHomeTwo remove(long medicalFacilitiesHomeTwoId)
		...
		return remove((Serializable)medicalFacilitiesHomeTwoId);
	}

	/**
	 * Removes the medical facilities home two with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the medical facilities home two
	 * @return the medical facilities home two that was removed
	 * @throws NoSuchMedicalFacilitiesHomeTwoException if a medical facilities home two with the primary key could not be found
	 */
	@Override
	public MedicalFacilitiesHomeTwo remove(Serializable primaryKey)
		throws NoSuchMedicalFacilitiesHomeTwoException {
		...
		try {
			...
			MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo =
				(MedicalFacilitiesHomeTwo)session.get(
					MedicalFacilitiesHomeTwoImpl.class, primaryKey);
			...
			if (medicalFacilitiesHomeTwo == null) {
				...
				throw new NoSuchMedicalFacilitiesHomeTwoException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(medicalFacilitiesHomeTwo);
		}
		catch (NoSuchMedicalFacilitiesHomeTwoException noSuchEntityException) {
	...
	@Override
	protected MedicalFacilitiesHomeTwo removeImpl(
		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo) {
		...
		try {
			...
			if (!session.contains(medicalFacilitiesHomeTwo)) {
				medicalFacilitiesHomeTwo =
					(MedicalFacilitiesHomeTwo)session.get(
						MedicalFacilitiesHomeTwoImpl.class,
						medicalFacilitiesHomeTwo.getPrimaryKeyObj());
			}

			if (medicalFacilitiesHomeTwo != null) {
				session.delete(medicalFacilitiesHomeTwo);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		if (medicalFacilitiesHomeTwo != null) {
			clearCache(medicalFacilitiesHomeTwo);
		}
	...
	public MedicalFacilitiesHomeTwo updateImpl(
		...
		boolean isNew = medicalFacilitiesHomeTwo.isNew();

		if (!(medicalFacilitiesHomeTwo instanceof
				MedicalFacilitiesHomeTwoModelImpl)) {

			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(medicalFacilitiesHomeTwo.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					medicalFacilitiesHomeTwo);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in medicalFacilitiesHomeTwo proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom MedicalFacilitiesHomeTwo implementation " +
					medicalFacilitiesHomeTwo.getClass());
		}

		MedicalFacilitiesHomeTwoModelImpl medicalFacilitiesHomeTwoModelImpl =
			(MedicalFacilitiesHomeTwoModelImpl)medicalFacilitiesHomeTwo;

		if (Validator.isNull(medicalFacilitiesHomeTwo.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (medicalFacilitiesHomeTwo.getCreateDate() == null)) {
			if (serviceContext == null) {
				medicalFacilitiesHomeTwo.setCreateDate(date);
			}
			else {
		...
		if (!medicalFacilitiesHomeTwoModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				medicalFacilitiesHomeTwo.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				session.save(medicalFacilitiesHomeTwo);
			}
			else {
				medicalFacilitiesHomeTwo =
					(MedicalFacilitiesHomeTwo)session.merge(
						medicalFacilitiesHomeTwo);
			}
		}
		catch (Exception exception) {
		...
		entityCache.putResult(
			MedicalFacilitiesHomeTwoImpl.class,
			medicalFacilitiesHomeTwoModelImpl, false, true);

		cacheUniqueFindersCache(medicalFacilitiesHomeTwoModelImpl);

		if (isNew) {
			medicalFacilitiesHomeTwo.setNew(false);
		}

		medicalFacilitiesHomeTwo.resetOriginalValues();

		return medicalFacilitiesHomeTwo;
	}

	/**
	 * Returns the medical facilities home two with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the medical facilities home two
	 ...
	 */
	@Override
	public MedicalFacilitiesHomeTwo findByPrimaryKey(Serializable primaryKey)
		throws NoSuchMedicalFacilitiesHomeTwoException {

		MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo = fetchByPrimaryKey(
			primaryKey);
	...
	public MedicalFacilitiesHomeTwo findByPrimaryKey(
		...
		return findByPrimaryKey((Serializable)medicalFacilitiesHomeTwoId);
	}
	...
	public MedicalFacilitiesHomeTwo fetchByPrimaryKey(
		...
		return fetchByPrimaryKey((Serializable)medicalFacilitiesHomeTwoId);
	}
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findAll() {
	 ...
	 */
	@Override
	public List<MedicalFacilitiesHomeTwo> findAll(int start, int end) {
	...
	public List<MedicalFacilitiesHomeTwo> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_MEDICALFACILITIESHOMETWO);
				...
				sql = _SQL_SELECT_MEDICALFACILITIESHOMETWO;

				sql = sql.concat(
					MedicalFacilitiesHomeTwoModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeAll() {
		for (MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo : findAll()) {
			remove(medicalFacilitiesHomeTwo);
		}
	}
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(
					_SQL_COUNT_MEDICALFACILITIESHOMETWO);
	...
	protected String getPKDBName() {
		return "medicalFacilitiesHomeTwoId";
	}

	@Override
	protected String getSelectSQL() {
		return _SQL_SELECT_MEDICALFACILITIESHOMETWO;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return MedicalFacilitiesHomeTwoModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the medical facilities home two persistence.
	 */
	@Activate
	public void activate() {
		...
		MedicalFacilitiesHomeTwoUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		MedicalFacilitiesHomeTwoUtil.setPersistence(null);

		entityCache.removeCache(MedicalFacilitiesHomeTwoImpl.class.getName());
	}
	...
	private static final String _SQL_SELECT_MEDICALFACILITIESHOMETWO =
		"SELECT medicalFacilitiesHomeTwo FROM MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo";

	private static final String _SQL_SELECT_MEDICALFACILITIESHOMETWO_WHERE =
		"SELECT medicalFacilitiesHomeTwo FROM MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo WHERE ";

	private static final String _SQL_COUNT_MEDICALFACILITIESHOMETWO =
		"SELECT COUNT(medicalFacilitiesHomeTwo) FROM MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo";

	private static final String _SQL_COUNT_MEDICALFACILITIESHOMETWO_WHERE =
		"SELECT COUNT(medicalFacilitiesHomeTwo) FROM MedicalFacilitiesHomeTwo medicalFacilitiesHomeTwo WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS =
		"medicalFacilitiesHomeTwo.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No MedicalFacilitiesHomeTwo exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No MedicalFacilitiesHomeTwo exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		MedicalFacilitiesHomeTwoPersistenceImpl.class);
