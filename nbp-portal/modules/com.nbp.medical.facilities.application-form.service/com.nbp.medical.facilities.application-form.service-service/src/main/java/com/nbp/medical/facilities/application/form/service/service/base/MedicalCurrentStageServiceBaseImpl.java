...
import com.nbp.medical.facilities.application.form.service.service.MedicalCurrentStageService;
...
/**
 * Provides the base implementation for the medical current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.medical.facilities.application.form.service.service.impl.MedicalCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.medical.facilities.application.form.service.service.impl.MedicalCurrentStageServiceImpl
 * @generated
 */
public abstract class MedicalCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MedicalCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MedicalCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.medical.facilities.application.form.service.service.MedicalCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MedicalCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		medicalCurrentStageService = (MedicalCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MedicalCurrentStageService.class.getName();
	}
	...
	protected MedicalCurrentStageService medicalCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MedicalCurrentStageServiceBaseImpl.class);
