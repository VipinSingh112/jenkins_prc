...
/**
 * Provides the local service utility for MedicalFacilitiesMaterHome. This utility wraps
 * <code>com.nbp.medical.facilities.application.form.service.service.impl.MedicalFacilitiesMaterHomeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MedicalFacilitiesMaterHomeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.medical.facilities.application.form.service.service.impl.MedicalFacilitiesMaterHomeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MedicalFacilitiesMaterHome addMedicalFacilitiesMaterHome(
		MedicalFacilitiesMaterHome medicalFacilitiesMaterHome) {

		return getService().addMedicalFacilitiesMaterHome(
	 ...
	 */
	public static MedicalFacilitiesMaterHome createMedicalFacilitiesMaterHome(
		long medicalFacilitiesMaterHomeId) {

		return getService().createMedicalFacilitiesMaterHome(
	 ...
	 */
	public static MedicalFacilitiesMaterHome deleteMedicalFacilitiesMaterHome(
			long medicalFacilitiesMaterHomeId)
		throws PortalException {

		return getService().deleteMedicalFacilitiesMaterHome(
			medicalFacilitiesMaterHomeId);
	}
	...
	public static MedicalFacilitiesMaterHome fetchMedicalFacilitiesMaterHome(
		long medicalFacilitiesMaterHomeId) {

		return getService().fetchMedicalFacilitiesMaterHome(
			medicalFacilitiesMaterHomeId);
	}
	...
	public static MedicalFacilitiesMaterHome
		...
		return getService().fetchMedicalFacilitiesMaterHomeByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a medical facilities mater home with the primary key could not be found
	 */
	public static MedicalFacilitiesMaterHome getMedicalFacilitiesMaterHome(
			long medicalFacilitiesMaterHomeId)
		throws PortalException {

		return getService().getMedicalFacilitiesMaterHome(
			medicalFacilitiesMaterHomeId);
	}
	...
	public static MedicalFacilitiesMaterHome
		...
		return getService().getMedicalFacilitiesMaterHomeByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<MedicalFacilitiesMaterHome>
		getMedicalFacilitiesMaterHomes(int start, int end) {

		return getService().getMedicalFacilitiesMaterHomes(start, end);
	}
	...
	public static List<MedicalFacilitiesMaterHome>
		...
		return getService().getMedicalFacilitiesMaterHomesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getMedicalFacilitiesMaterHomesCount() {
		return getService().getMedicalFacilitiesMaterHomesCount();
	}
	 ...
	 */
	public static MedicalFacilitiesMaterHome updateMedicalFacilitiesMaterHome(
		MedicalFacilitiesMaterHome medicalFacilitiesMaterHome) {

		return getService().updateMedicalFacilitiesMaterHome(
			medicalFacilitiesMaterHome);
	}

	public static MedicalFacilitiesMaterHomeLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MedicalFacilitiesMaterHomeLocalService>
		_serviceSnapshot = new Snapshot<>(
			MedicalFacilitiesMaterHomeLocalServiceUtil.class,
