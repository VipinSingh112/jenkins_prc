...
/**
 * Provides the local service interface for MedicalFacilitiesQNurse. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MedicalFacilitiesQNurseLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MedicalFacilitiesQNurseLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.medical.facilities.application.form.service.service.impl.MedicalFacilitiesQNurseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the medical facilities q nurse local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MedicalFacilitiesQNurseLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MedicalFacilitiesQNurse addMedicalFacilitiesQNurse(
	...
	public MedicalFacilitiesQNurse createMedicalFacilitiesQNurse(
	...
	public MedicalFacilitiesQNurse deleteMedicalFacilitiesQNurse(
			long medicalFacilitiesQNurseId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesQNurse fetchMedicalFacilitiesQNurse(
		long medicalFacilitiesQNurseId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesQNurse fetchMedicalFacilitiesQNurseByUuidAndGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesQNurse getMedicalFacilitiesById(long applicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesQNurse getMedicalFacilitiesQNurse(
			long medicalFacilitiesQNurseId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MedicalFacilitiesQNurse getMedicalFacilitiesQNurseByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesQNurse> getMedicalFacilitiesQNurses(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MedicalFacilitiesQNurse>
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MedicalFacilitiesQNurse updateMedicalFacilitiesQNurse(
		MedicalFacilitiesQNurse medicalFacilitiesQNurse);
