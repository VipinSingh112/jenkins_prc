...
/**
 * Provides the local service utility for MedicalFacilitiesQNurse. This utility wraps
 * <code>com.nbp.medical.facilities.application.form.service.service.impl.MedicalFacilitiesQNurseLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MedicalFacilitiesQNurseLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.medical.facilities.application.form.service.service.impl.MedicalFacilitiesQNurseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MedicalFacilitiesQNurse addMedicalFacilitiesQNurse(
		MedicalFacilitiesQNurse medicalFacilitiesQNurse) {

		return getService().addMedicalFacilitiesQNurse(medicalFacilitiesQNurse);
	}
	 ...
	 */
	public static MedicalFacilitiesQNurse createMedicalFacilitiesQNurse(
		long medicalFacilitiesQNurseId) {

		return getService().createMedicalFacilitiesQNurse(
	 ...
	 */
	public static MedicalFacilitiesQNurse deleteMedicalFacilitiesQNurse(
			long medicalFacilitiesQNurseId)
		throws PortalException {

		return getService().deleteMedicalFacilitiesQNurse(
			medicalFacilitiesQNurseId);
	}
	...
	public static MedicalFacilitiesQNurse fetchMedicalFacilitiesQNurse(
		long medicalFacilitiesQNurseId) {

		return getService().fetchMedicalFacilitiesQNurse(
			medicalFacilitiesQNurseId);
	}
	 ...
	 */
	public static MedicalFacilitiesQNurse
		fetchMedicalFacilitiesQNurseByUuidAndGroupId(
			String uuid, long groupId) {

		return getService().fetchMedicalFacilitiesQNurseByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static MedicalFacilitiesQNurse getMedicalFacilitiesById(
			long applicationId)
	 ...
	 * @throws PortalException if a medical facilities q nurse with the primary key could not be found
	 */
	public static MedicalFacilitiesQNurse getMedicalFacilitiesQNurse(
			long medicalFacilitiesQNurseId)
		throws PortalException {

		return getService().getMedicalFacilitiesQNurse(
			medicalFacilitiesQNurseId);
	}
	 ...
	 */
	public static MedicalFacilitiesQNurse
			getMedicalFacilitiesQNurseByUuidAndGroupId(
				String uuid, long groupId)
		throws PortalException {

		return getService().getMedicalFacilitiesQNurseByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<MedicalFacilitiesQNurse> getMedicalFacilitiesQNurses(
		int start, int end) {

		return getService().getMedicalFacilitiesQNurses(start, end);
	}
	 ...
	 */
	public static List<MedicalFacilitiesQNurse>
		getMedicalFacilitiesQNursesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getMedicalFacilitiesQNursesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getMedicalFacilitiesQNursesCount() {
		return getService().getMedicalFacilitiesQNursesCount();
	}
	 ...
	 */
	public static MedicalFacilitiesQNurse updateMedicalFacilitiesQNurse(
		MedicalFacilitiesQNurse medicalFacilitiesQNurse) {

		return getService().updateMedicalFacilitiesQNurse(
			medicalFacilitiesQNurse);
	}

	public static MedicalFacilitiesQNurseLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MedicalFacilitiesQNurseLocalService>
		_serviceSnapshot = new Snapshot<>(
			MedicalFacilitiesQNurseLocalServiceUtil.class,
			MedicalFacilitiesQNurseLocalService.class);
