<div class="uploaded-info" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
	<div class="left">
		...
		<p class="uploaded-info-size" id="document-size"><%-- <%=uploadedFile.getFileSize() %> --%></p>
	</div>
	<div class="right">
		...
		<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=docOfWraAdditionalCounter%>')">
...
<div class="modal fade commonsavepopup" id="deletepopup<%=uploadedFile.getFileEntryId()%>" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="deleteUploadedDocument('<%=uploadedFile.getFileEntryId()%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
