...
if(Validator.isNotNull(request.getAttribute("wraApplicationId"))){
	wraAppId= String.valueOf(request.getAttribute("wraApplicationId"));
}
			...
			<div class="col-md-12">
				<div class="supporting-document-card-wrapper">
					...
					<div class="right text-nowrap pl-3">
						<a id="documentUpload<%=counterOfDocuments%>" class="custom-upload <%=isDocumentUploaded%>" href="javascript:;" onchange="attachDetailed(this.id)" onclick="openDocumentUploadPopup('<%=counterOfDocuments%>','<%=documentNames%>')"> 
							<span class="mr-2">
    ...
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="deleteUploadedDocument('<%=fileEntryId%>','<%=title%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="supporting-document-card-wrapper">
					...
					<div class="right text-nowrap pl-3">
						<a id="documentUpload<%=counterOfDocuments%>" class="custom-upload <%=isDocumentUploadedNR%>" href="javascript:;" onchange="attachDetailed(this.id)" onclick="openDocumentUploadPopup('<%=counterOfDocuments%>','<%=documentNamesNR%>')"> 
							<span class="mr-2">
								<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
		                       		<path d="M5 13H9C9.55 13 10 12.55 10 12V6.99997H11.59C12.48 6.99997 12.93 5.91997 12.3 5.28997L7.71 0.699971C7.32 0.309971 6.69 0.309971 6.3 0.699971L1.71 5.28997C1.08 5.91997 1.52 6.99997 2.41 6.99997H4V12C4 12.55 4.45 13 5 13ZM1 15H13C13.55 15 14 15.45 14 16C14 16.55 13.55 17 13 17H1C0.45 17 0 16.55 0 16C0 15.45 0.45 15 1 15Z" fill="#047247" />
		                       </svg> 
