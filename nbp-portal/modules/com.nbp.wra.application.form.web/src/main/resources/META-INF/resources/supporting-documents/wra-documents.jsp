...
<fieldset class="wizard-fieldset" id="wraSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="wraGenericUpload" multiple="multiple"
				name="<portlet:namespace/>wraGenericUpload" onchange="attachDetailed(this.id)"
				hidden=""> <label class="custom-upload" 
				for="wraGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="wraGenericFileChosen"></span>
		</div>
		...
		<% 
				...
				if(wraApplicationId>0 && dlFileEntriesGeneric!=null){
					try{
						int docOfWraAdditionalCounter=1001;
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						...
						%>	
	 <div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfWraAdditionalCounter%>">
				<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfWraAdditionalCounter%>">
						<%
						%>
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="wraEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>wraEnrollDocuments">
