...
/**
 * Provides the local service utility for AttractionConCarriageInfo. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.AttractionConCarriageInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AttractionConCarriageInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionConCarriageInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AttractionConCarriageInfo addAttractionConCarriageInfo(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		return getService().addAttractionConCarriageInfo(
	 ...
	 */
	public static AttractionConCarriageInfo createAttractionConCarriageInfo(
		long attractionConCarriageInfoId) {

		return getService().createAttractionConCarriageInfo(
	 ...
	 */
	public static AttractionConCarriageInfo deleteAttractionConCarriageInfo(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		return getService().deleteAttractionConCarriageInfo(
			attractionConCarriageInfo);
	}
	...
	public static AttractionConCarriageInfo fetchAttractionConCarriageInfo(
		long attractionConCarriageInfoId) {

		return getService().fetchAttractionConCarriageInfo(
			attractionConCarriageInfoId);
	}
	 ...
	 * @throws PortalException if a attraction con carriage info with the primary key could not be found
	 */
	public static AttractionConCarriageInfo getAttractionConCarriageInfo(
			long attractionConCarriageInfoId)
		throws PortalException {

		return getService().getAttractionConCarriageInfo(
			attractionConCarriageInfoId);
	}
	 ...
	 */
	public static List<AttractionConCarriageInfo> getAttractionConCarriageInfos(
		int start, int end) {

		return getService().getAttractionConCarriageInfos(start, end);
	}
	 ...
	 */
	public static int getAttractionConCarriageInfosCount() {
		return getService().getAttractionConCarriageInfosCount();
	}
	...
	public static AttractionConCarriageInfo getJTB_ByApplicationId(
	 ...
	 */
	public static AttractionConCarriageInfo updateAttractionConCarriageInfo(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		return getService().updateAttractionConCarriageInfo(
			attractionConCarriageInfo);
	}

	public static AttractionConCarriageInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AttractionConCarriageInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			AttractionConCarriageInfoLocalServiceUtil.class,
