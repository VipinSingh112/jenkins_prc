...
/**
 * Provides the local service interface for AttractionWaterRequired. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AttractionWaterRequiredLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AttractionWaterRequiredLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterRequiredLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the attraction water required local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AttractionWaterRequiredLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AttractionWaterRequired addAttractionWaterRequired(
	...
	public AttractionWaterRequired createAttractionWaterRequired(
	...
	public AttractionWaterRequired deleteAttractionWaterRequired(
		AttractionWaterRequired attractionWaterRequired);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterRequired fetchAttractionWaterRequired(
		long attractionWaterRequiredId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterRequired getAttractionWaterRequired(
			long attractionWaterRequiredId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttractionWaterRequired> getAttractionWaterRequireds(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterRequired getJTB_ByApplicationId(long jtbApplicationId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AttractionWaterRequired updateAttractionWaterRequired(
		AttractionWaterRequired attractionWaterRequired);
