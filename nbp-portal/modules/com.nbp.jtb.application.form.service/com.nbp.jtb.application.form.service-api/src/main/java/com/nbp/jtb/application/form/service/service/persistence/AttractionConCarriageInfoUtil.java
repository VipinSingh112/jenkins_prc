...
/**
 * The persistence utility for the attraction con carriage info service. This utility wraps <code>com.nbp.jtb.application.form.service.service.persistence.impl.AttractionConCarriageInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AttractionConCarriageInfoPersistence
 * @generated
 */
public class AttractionConCarriageInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(attractionConCarriageInfo);
	}
	 ...
	 */
	public static Map<Serializable, AttractionConCarriageInfo>
	 ...
	 */
	public static List<AttractionConCarriageInfo> findWithDynamicQuery(
	 ...
	 */
	public static AttractionConCarriageInfo update(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		return getPersistence().update(attractionConCarriageInfo);
	}
	...
	public static AttractionConCarriageInfo update(
		...
		return getPersistence().update(
			attractionConCarriageInfo, serviceContext);
	}
	 ...
	 */
	public static AttractionConCarriageInfo findBygetJTB_ByApplicationId(
	 ...
	 */
	public static AttractionConCarriageInfo fetchBygetJTB_ByApplicationId(
		long jtbApplicationId) {
	 ...
	 */
	public static AttractionConCarriageInfo removeBygetJTB_ByApplicationId(
			long jtbApplicationId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionConCarriageInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(attractionConCarriageInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(attractionConCarriageInfos);
	}
	 ...
	 */
	public static AttractionConCarriageInfo create(
		long attractionConCarriageInfoId) {

		return getPersistence().create(attractionConCarriageInfoId);
	}
	 ...
	 */
	public static AttractionConCarriageInfo remove(
			long attractionConCarriageInfoId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionConCarriageInfoException {

		return getPersistence().remove(attractionConCarriageInfoId);
	}

	public static AttractionConCarriageInfo updateImpl(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		return getPersistence().updateImpl(attractionConCarriageInfo);
	}
	 ...
	 * @throws NoSuchAttractionConCarriageInfoException if a attraction con carriage info with the primary key could not be found
	 */
	public static AttractionConCarriageInfo findByPrimaryKey(
			long attractionConCarriageInfoId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionConCarriageInfoException {

		return getPersistence().findByPrimaryKey(attractionConCarriageInfoId);
	}
	 ...
	 */
	public static AttractionConCarriageInfo fetchByPrimaryKey(
		long attractionConCarriageInfoId) {

		return getPersistence().fetchByPrimaryKey(attractionConCarriageInfoId);
	}
	 ...
	 */
	public static List<AttractionConCarriageInfo> findAll() {
	 ...
	 */
	public static List<AttractionConCarriageInfo> findAll(int start, int end) {
	...
	public static AttractionConCarriageInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AttractionConCarriageInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AttractionConCarriageInfoPersistence _persistence;
