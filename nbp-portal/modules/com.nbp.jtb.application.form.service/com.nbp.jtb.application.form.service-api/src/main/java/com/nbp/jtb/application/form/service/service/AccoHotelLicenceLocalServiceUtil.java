...
/**
 * Provides the local service utility for AccoHotelLicence. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.AccoHotelLicenceLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AccoHotelLicenceLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AccoHotelLicenceLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AccoHotelLicence addAccoHotelLicence(
		AccoHotelLicence accoHotelLicence) {

		return getService().addAccoHotelLicence(accoHotelLicence);
	}
	 ...
	 */
	public static AccoHotelLicence createAccoHotelLicence(
		long accoHotelLicenceId) {

		return getService().createAccoHotelLicence(accoHotelLicenceId);
	}
	 ...
	 */
	public static AccoHotelLicence deleteAccoHotelLicence(
		AccoHotelLicence accoHotelLicence) {

		return getService().deleteAccoHotelLicence(accoHotelLicence);
	}
	...
	public static AccoHotelLicence deleteAccoHotelLicence(
		...
		return getService().deleteAccoHotelLicence(accoHotelLicenceId);
	}
	...
	public static AccoHotelLicence fetchAccoHotelLicence(
		long accoHotelLicenceId) {

		return getService().fetchAccoHotelLicence(accoHotelLicenceId);
	}
	 ...
	 */
	public static AccoHotelLicence fetchAccoHotelLicenceByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchAccoHotelLicenceByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a acco hotel licence with the primary key could not be found
	 */
	public static AccoHotelLicence getAccoHotelLicence(long accoHotelLicenceId)
		throws PortalException {

		return getService().getAccoHotelLicence(accoHotelLicenceId);
	}
	 ...
	 */
	public static AccoHotelLicence getAccoHotelLicenceByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getAccoHotelLicenceByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<AccoHotelLicence> getAccoHotelLicences(
		int start, int end) {

		return getService().getAccoHotelLicences(start, end);
	}
	 ...
	 */
	public static List<AccoHotelLicence> getAccoHotelLicencesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getAccoHotelLicencesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getAccoHotelLicencesCount() {
		return getService().getAccoHotelLicencesCount();
	}
	...
	public static AccoHotelLicence getJTB_ByApplicationId(long jtbApplicationId)
	 ...
	 */
	public static AccoHotelLicence updateAccoHotelLicence(
		AccoHotelLicence accoHotelLicence) {

		return getService().updateAccoHotelLicence(accoHotelLicence);
	}

	public static AccoHotelLicenceLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AccoHotelLicenceLocalService>
		_serviceSnapshot = new Snapshot<>(
			AccoHotelLicenceLocalServiceUtil.class,
			AccoHotelLicenceLocalService.class);
