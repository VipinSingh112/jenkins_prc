...
/**
 * The persistence utility for the attraction car rent condition service. This utility wraps <code>com.nbp.jtb.application.form.service.service.persistence.impl.AttractionCarRentConditionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AttractionCarRentConditionPersistence
 * @generated
 */
public class AttractionCarRentConditionUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(attractionCarRentCondition);
	}
	 ...
	 */
	public static Map<Serializable, AttractionCarRentCondition>
	 ...
	 */
	public static List<AttractionCarRentCondition> findWithDynamicQuery(
	 ...
	 */
	public static AttractionCarRentCondition update(
		AttractionCarRentCondition attractionCarRentCondition) {

		return getPersistence().update(attractionCarRentCondition);
	}
	...
	public static AttractionCarRentCondition update(
		...
		return getPersistence().update(
			attractionCarRentCondition, serviceContext);
	}
	 ...
	 */
	public static AttractionCarRentCondition findBygetJTB_ByApplicationId(
	 ...
	 */
	public static AttractionCarRentCondition fetchBygetJTB_ByApplicationId(
		long jtbApplicationId) {
	 ...
	 */
	public static AttractionCarRentCondition removeBygetJTB_ByApplicationId(
			long jtbApplicationId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionCarRentConditionException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(attractionCarRentCondition);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(attractionCarRentConditions);
	}
	 ...
	 */
	public static AttractionCarRentCondition create(
		long attractionCarRenConditId) {

		return getPersistence().create(attractionCarRenConditId);
	}
	 ...
	 */
	public static AttractionCarRentCondition remove(
			long attractionCarRenConditId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionCarRentConditionException {

		return getPersistence().remove(attractionCarRenConditId);
	}

	public static AttractionCarRentCondition updateImpl(
		AttractionCarRentCondition attractionCarRentCondition) {

		return getPersistence().updateImpl(attractionCarRentCondition);
	}
	 ...
	 * @throws NoSuchAttractionCarRentConditionException if a attraction car rent condition with the primary key could not be found
	 */
	public static AttractionCarRentCondition findByPrimaryKey(
			long attractionCarRenConditId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAttractionCarRentConditionException {

		return getPersistence().findByPrimaryKey(attractionCarRenConditId);
	}
	 ...
	 */
	public static AttractionCarRentCondition fetchByPrimaryKey(
		long attractionCarRenConditId) {

		return getPersistence().fetchByPrimaryKey(attractionCarRenConditId);
	}
	 ...
	 */
	public static List<AttractionCarRentCondition> findAll() {
	 ...
	 */
	public static List<AttractionCarRentCondition> findAll(int start, int end) {
	...
	public static AttractionCarRentConditionPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AttractionCarRentConditionPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AttractionCarRentConditionPersistence _persistence;
