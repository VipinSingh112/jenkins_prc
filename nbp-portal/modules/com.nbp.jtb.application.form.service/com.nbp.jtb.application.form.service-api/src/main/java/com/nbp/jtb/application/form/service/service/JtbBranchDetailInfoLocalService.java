...
/**
 * Provides the local service interface for JtbBranchDetailInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JtbBranchDetailInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JtbBranchDetailInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.JtbBranchDetailInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the jtb branch detail info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JtbBranchDetailInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
