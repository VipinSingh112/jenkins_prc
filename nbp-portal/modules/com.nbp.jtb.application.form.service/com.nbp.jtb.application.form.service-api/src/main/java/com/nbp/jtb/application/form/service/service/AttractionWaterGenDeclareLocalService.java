...
/**
 * Provides the local service interface for AttractionWaterGenDeclare. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AttractionWaterGenDeclareLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AttractionWaterGenDeclareLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterGenDeclareLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the attraction water gen declare local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AttractionWaterGenDeclareLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AttractionWaterGenDeclare addAttractionWaterGenDeclare(
	...
	public AttractionWaterGenDeclare createAttractionWaterGenDeclare(
	...
	public AttractionWaterGenDeclare deleteAttractionWaterGenDeclare(
		AttractionWaterGenDeclare attractionWaterGenDeclare);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterGenDeclare fetchAttractionWaterGenDeclare(
		long attractionWaterGenDeclareId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterGenDeclare getAttractionWaterGenDeclare(
			long attractionWaterGenDeclareId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttractionWaterGenDeclare> getAttractionWaterGenDeclares(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionWaterGenDeclare getJTB_ByApplicationId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AttractionWaterGenDeclare updateAttractionWaterGenDeclare(
		AttractionWaterGenDeclare attractionWaterGenDeclare);
