...
/**
 * Provides the local service utility for AccoNonHotelRequiredLic. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.AccoNonHotelRequiredLicLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AccoNonHotelRequiredLicLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AccoNonHotelRequiredLicLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AccoNonHotelRequiredLic addAccoNonHotelRequiredLic(
		AccoNonHotelRequiredLic accoNonHotelRequiredLic) {

		return getService().addAccoNonHotelRequiredLic(accoNonHotelRequiredLic);
	}
	 ...
	 */
	public static AccoNonHotelRequiredLic createAccoNonHotelRequiredLic(
		long accoNonHotelRequiredLicId) {

		return getService().createAccoNonHotelRequiredLic(
	 ...
	 */
	public static AccoNonHotelRequiredLic deleteAccoNonHotelRequiredLic(
		AccoNonHotelRequiredLic accoNonHotelRequiredLic) {

		return getService().deleteAccoNonHotelRequiredLic(
	...
	public static AccoNonHotelRequiredLic fetchAccoNonHotelRequiredLic(
		long accoNonHotelRequiredLicId) {

		return getService().fetchAccoNonHotelRequiredLic(
			accoNonHotelRequiredLicId);
	}
	 ...
	 * @throws PortalException if a acco non hotel required lic with the primary key could not be found
	 */
	public static AccoNonHotelRequiredLic getAccoNonHotelRequiredLic(
			long accoNonHotelRequiredLicId)
		throws PortalException {

		return getService().getAccoNonHotelRequiredLic(
			accoNonHotelRequiredLicId);
	}
	 ...
	 */
	public static List<AccoNonHotelRequiredLic> getAccoNonHotelRequiredLics(
		int start, int end) {

		return getService().getAccoNonHotelRequiredLics(start, end);
	}
	 ...
	 */
	public static int getAccoNonHotelRequiredLicsCount() {
		return getService().getAccoNonHotelRequiredLicsCount();
	}
	...
	public static AccoNonHotelRequiredLic getJTB_ByApplicationId(
	 ...
	 */
	public static AccoNonHotelRequiredLic updateAccoNonHotelRequiredLic(
		AccoNonHotelRequiredLic accoNonHotelRequiredLic) {

		return getService().updateAccoNonHotelRequiredLic(
			accoNonHotelRequiredLic);
	}

	public static AccoNonHotelRequiredLicLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AccoNonHotelRequiredLicLocalService>
		_serviceSnapshot = new Snapshot<>(
			AccoNonHotelRequiredLicLocalServiceUtil.class,
