...
/**
 * The persistence utility for the acco gen declaration service. This utility wraps <code>com.nbp.jtb.application.form.service.service.persistence.impl.AccoGenDeclarationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AccoGenDeclarationPersistence
 * @generated
 */
public class AccoGenDeclarationUtil {
	 ...
	 */
	public static void clearCache(AccoGenDeclaration accoGenDeclaration) {
		getPersistence().clearCache(accoGenDeclaration);
	}
	 ...
	 */
	public static Map<Serializable, AccoGenDeclaration> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AccoGenDeclaration> findWithDynamicQuery(
	 ...
	 */
	public static AccoGenDeclaration update(
		AccoGenDeclaration accoGenDeclaration) {

		return getPersistence().update(accoGenDeclaration);
	}
	 ...
	 */
	public static AccoGenDeclaration update(
		AccoGenDeclaration accoGenDeclaration, ServiceContext serviceContext) {

		return getPersistence().update(accoGenDeclaration, serviceContext);
	}
	 ...
	 */
	public static List<AccoGenDeclaration> findByUuid(String uuid) {
	 ...
	 */
	public static List<AccoGenDeclaration> findByUuid(
	 ...
	 */
	public static AccoGenDeclaration findByUuid_First(
			String uuid,
			OrderByComparator<AccoGenDeclaration> orderByComparator)
	 ...
	 */
	public static AccoGenDeclaration fetchByUuid_First(
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration findByUuid_Last(
			String uuid,
			OrderByComparator<AccoGenDeclaration> orderByComparator)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 */
	public static AccoGenDeclaration fetchByUuid_Last(
		String uuid, OrderByComparator<AccoGenDeclaration> orderByComparator) {
	 ...
	 */
	public static AccoGenDeclaration[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			accoGenDeclarationId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration findByUUID_G(String uuid, long groupId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 */
	public static AccoGenDeclaration fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching acco gen declaration, or <code>null</code> if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration fetchByUUID_G(
	 ...
	 */
	public static AccoGenDeclaration removeByUUID_G(String uuid, long groupId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 * @return the matching acco gen declarations
	 */
	public static List<AccoGenDeclaration> findByUuid_C(
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<AccoGenDeclaration> orderByComparator)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 * @return the first matching acco gen declaration, or <code>null</code> if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<AccoGenDeclaration> orderByComparator) {
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<AccoGenDeclaration> orderByComparator)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 * @return the last matching acco gen declaration, or <code>null</code> if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<AccoGenDeclaration> orderByComparator) {
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a acco gen declaration with the primary key could not be found
	 */
	public static AccoGenDeclaration[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			accoGenDeclarationId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration findBygetJTB_ByApplicationId(
	 ...
	 * @return the matching acco gen declaration, or <code>null</code> if a matching acco gen declaration could not be found
	 */
	public static AccoGenDeclaration fetchBygetJTB_ByApplicationId(
		long jtbApplicationId) {
	 ...
	 * @return the acco gen declaration that was removed
	 */
	public static AccoGenDeclaration removeBygetJTB_ByApplicationId(
			long jtbApplicationId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {
	 ...
	 */
	public static void cacheResult(AccoGenDeclaration accoGenDeclaration) {
		getPersistence().cacheResult(accoGenDeclaration);
	}
	...
	public static void cacheResult(
		List<AccoGenDeclaration> accoGenDeclarations) {

		getPersistence().cacheResult(accoGenDeclarations);
	}
	 ...
	 */
	public static AccoGenDeclaration create(long accoGenDeclarationId) {
		return getPersistence().create(accoGenDeclarationId);
	}
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a acco gen declaration with the primary key could not be found
	 */
	public static AccoGenDeclaration remove(long accoGenDeclarationId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {

		return getPersistence().remove(accoGenDeclarationId);
	}

	public static AccoGenDeclaration updateImpl(
		AccoGenDeclaration accoGenDeclaration) {

		return getPersistence().updateImpl(accoGenDeclaration);
	}
	 ...
	 * @throws NoSuchAccoGenDeclarationException if a acco gen declaration with the primary key could not be found
	 */
	public static AccoGenDeclaration findByPrimaryKey(long accoGenDeclarationId)
		throws com.nbp.jtb.application.form.service.exception.
			NoSuchAccoGenDeclarationException {

		return getPersistence().findByPrimaryKey(accoGenDeclarationId);
	}
	 ...
	 */
	public static AccoGenDeclaration fetchByPrimaryKey(
		long accoGenDeclarationId) {

		return getPersistence().fetchByPrimaryKey(accoGenDeclarationId);
	}
	 ...
	 */
	public static List<AccoGenDeclaration> findAll() {
	 ...
	 */
	public static List<AccoGenDeclaration> findAll(int start, int end) {
	...
	public static AccoGenDeclarationPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AccoGenDeclarationPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AccoGenDeclarationPersistence _persistence;
