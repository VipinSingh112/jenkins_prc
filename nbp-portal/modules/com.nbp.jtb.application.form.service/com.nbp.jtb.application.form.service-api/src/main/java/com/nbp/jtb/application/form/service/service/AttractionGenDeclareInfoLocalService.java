...
/**
 * Provides the local service interface for AttractionGenDeclareInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AttractionGenDeclareInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AttractionGenDeclareInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionGenDeclareInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the attraction gen declare info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AttractionGenDeclareInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AttractionGenDeclareInfo addAttractionGenDeclareInfo(
	...
	public AttractionGenDeclareInfo createAttractionGenDeclareInfo(
	...
	public AttractionGenDeclareInfo deleteAttractionGenDeclareInfo(
		AttractionGenDeclareInfo attractionGenDeclareInfo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionGenDeclareInfo fetchAttractionGenDeclareInfo(
		long attractionGenDeclareInfoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionGenDeclareInfo getAttractionGenDeclareInfo(
			long attractionGenDeclareInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AttractionGenDeclareInfo> getAttractionGenDeclareInfos(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AttractionGenDeclareInfo getJTB_ByApplicationId(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AttractionGenDeclareInfo updateAttractionGenDeclareInfo(
		AttractionGenDeclareInfo attractionGenDeclareInfo);
