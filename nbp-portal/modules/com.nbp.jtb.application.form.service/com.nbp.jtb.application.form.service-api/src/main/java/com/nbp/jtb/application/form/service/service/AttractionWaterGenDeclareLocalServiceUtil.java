...
/**
 * Provides the local service utility for AttractionWaterGenDeclare. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterGenDeclareLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AttractionWaterGenDeclareLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterGenDeclareLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AttractionWaterGenDeclare addAttractionWaterGenDeclare(
		AttractionWaterGenDeclare attractionWaterGenDeclare) {

		return getService().addAttractionWaterGenDeclare(
	 ...
	 */
	public static AttractionWaterGenDeclare createAttractionWaterGenDeclare(
		long attractionWaterGenDeclareId) {

		return getService().createAttractionWaterGenDeclare(
	 ...
	 */
	public static AttractionWaterGenDeclare deleteAttractionWaterGenDeclare(
		AttractionWaterGenDeclare attractionWaterGenDeclare) {

		return getService().deleteAttractionWaterGenDeclare(
			attractionWaterGenDeclare);
	}
	...
	public static AttractionWaterGenDeclare fetchAttractionWaterGenDeclare(
		long attractionWaterGenDeclareId) {

		return getService().fetchAttractionWaterGenDeclare(
			attractionWaterGenDeclareId);
	}
	 ...
	 * @throws PortalException if a attraction water gen declare with the primary key could not be found
	 */
	public static AttractionWaterGenDeclare getAttractionWaterGenDeclare(
			long attractionWaterGenDeclareId)
		throws PortalException {

		return getService().getAttractionWaterGenDeclare(
			attractionWaterGenDeclareId);
	}
	 ...
	 */
	public static List<AttractionWaterGenDeclare> getAttractionWaterGenDeclares(
		int start, int end) {

		return getService().getAttractionWaterGenDeclares(start, end);
	}
	 ...
	 */
	public static int getAttractionWaterGenDeclaresCount() {
		return getService().getAttractionWaterGenDeclaresCount();
	}
	...
	public static AttractionWaterGenDeclare getJTB_ByApplicationId(
	 ...
	 */
	public static AttractionWaterGenDeclare updateAttractionWaterGenDeclare(
		AttractionWaterGenDeclare attractionWaterGenDeclare) {

		return getService().updateAttractionWaterGenDeclare(
			attractionWaterGenDeclare);
	}

	public static AttractionWaterGenDeclareLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AttractionWaterGenDeclareLocalService>
		_serviceSnapshot = new Snapshot<>(
			AttractionWaterGenDeclareLocalServiceUtil.class,
			AttractionWaterGenDeclareLocalService.class);
