...
/**
 * Provides the local service utility for JtbAddCraftApplicantInfo. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.JtbAddCraftApplicantInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class JtbAddCraftApplicantInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.JtbAddCraftApplicantInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static JtbAddCraftApplicantInfo addJtbAddCraftApplicantInfo(
		JtbAddCraftApplicantInfo jtbAddCraftApplicantInfo) {

		return getService().addJtbAddCraftApplicantInfo(
	 ...
	 */
	public static JtbAddCraftApplicantInfo createJtbAddCraftApplicantInfo(
		long jtbAddCraftApplicantInfoId) {

		return getService().createJtbAddCraftApplicantInfo(
	 ...
	 */
	public static JtbAddCraftApplicantInfo deleteJtbAddCraftApplicantInfo(
		JtbAddCraftApplicantInfo jtbAddCraftApplicantInfo) {

		return getService().deleteJtbAddCraftApplicantInfo(
			jtbAddCraftApplicantInfo);
	}
	...
	public static JtbAddCraftApplicantInfo fetchJtbAddCraftApplicantInfo(
		long jtbAddCraftApplicantInfoId) {

		return getService().fetchJtbAddCraftApplicantInfo(
			jtbAddCraftApplicantInfoId);
	}
	...
	public static List<JtbAddCraftApplicantInfo> getByJtbAppId(
	 ...
	 * @throws PortalException if a jtb add craft applicant info with the primary key could not be found
	 */
	public static JtbAddCraftApplicantInfo getJtbAddCraftApplicantInfo(
			long jtbAddCraftApplicantInfoId)
		throws PortalException {

		return getService().getJtbAddCraftApplicantInfo(
			jtbAddCraftApplicantInfoId);
	}
	 ...
	 */
	public static List<JtbAddCraftApplicantInfo> getJtbAddCraftApplicantInfos(
		int start, int end) {

		return getService().getJtbAddCraftApplicantInfos(start, end);
	}
	 ...
	 */
	public static int getJtbAddCraftApplicantInfosCount() {
		return getService().getJtbAddCraftApplicantInfosCount();
	}
	 ...
	 */
	public static JtbAddCraftApplicantInfo updateJtbAddCraftApplicantInfo(
		JtbAddCraftApplicantInfo jtbAddCraftApplicantInfo) {

		return getService().updateJtbAddCraftApplicantInfo(
			jtbAddCraftApplicantInfo);
	}

	public static JtbAddCraftApplicantInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<JtbAddCraftApplicantInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			JtbAddCraftApplicantInfoLocalServiceUtil.class,
