...
/**
 * Provides the local service utility for AttractionWaterSport. This utility wraps
 * <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterSportLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AttractionWaterSportLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.form.service.service.impl.AttractionWaterSportLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AttractionWaterSport addAttractionWaterSport(
		AttractionWaterSport attractionWaterSport) {

		return getService().addAttractionWaterSport(attractionWaterSport);
	}
	 ...
	 */
	public static AttractionWaterSport createAttractionWaterSport(
		long attractionWaterSportId) {

		return getService().createAttractionWaterSport(attractionWaterSportId);
	}
	 ...
	 */
	public static AttractionWaterSport deleteAttractionWaterSport(
		AttractionWaterSport attractionWaterSport) {

		return getService().deleteAttractionWaterSport(attractionWaterSport);
	}
	...
	public static AttractionWaterSport deleteAttractionWaterSport(
		...
		return getService().deleteAttractionWaterSport(attractionWaterSportId);
	}
	...
	public static AttractionWaterSport fetchAttractionWaterSport(
		long attractionWaterSportId) {

		return getService().fetchAttractionWaterSport(attractionWaterSportId);
	}
	 ...
	 * @throws PortalException if a attraction water sport with the primary key could not be found
	 */
	public static AttractionWaterSport getAttractionWaterSport(
			long attractionWaterSportId)
		throws PortalException {

		return getService().getAttractionWaterSport(attractionWaterSportId);
	}
	 ...
	 */
	public static List<AttractionWaterSport> getAttractionWaterSports(
		int start, int end) {

		return getService().getAttractionWaterSports(start, end);
	}
	 ...
	 */
	public static int getAttractionWaterSportsCount() {
		return getService().getAttractionWaterSportsCount();
	}
	...
	public static AttractionWaterSport getJTB_ByApplicationId(
	 ...
	 */
	public static AttractionWaterSport updateAttractionWaterSport(
		AttractionWaterSport attractionWaterSport) {

		return getService().updateAttractionWaterSport(attractionWaterSport);
	}

	public static AttractionWaterSportLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AttractionWaterSportLocalService>
		_serviceSnapshot = new Snapshot<>(
			AttractionWaterSportLocalServiceUtil.class,
			AttractionWaterSportLocalService.class);
