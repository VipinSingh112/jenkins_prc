...
import com.nbp.jtb.application.form.service.service.AttractionCarRentalLicenceLocalService;
...
/**
 * Provides the base implementation for the attraction car rental licence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionCarRentalLicenceLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionCarRentalLicenceLocalServiceImpl
 * @generated
 */
public abstract class AttractionCarRentalLicenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionCarRentalLicenceLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionCarRentalLicenceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionCarRentalLicenceLocalServiceUtil</code>.
	 */
	...
	public AttractionCarRentalLicence addAttractionCarRentalLicence(
		...
		return attractionCarRentalLicencePersistence.update(
	...
	public AttractionCarRentalLicence createAttractionCarRentalLicence(
		...
		return attractionCarRentalLicencePersistence.create(
	...
	public AttractionCarRentalLicence deleteAttractionCarRentalLicence(
		...
		return attractionCarRentalLicencePersistence.remove(
			attractionCarRentalLicId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionCarRentalLicencePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionCarRentalLicence.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionCarRentalLicencePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionCarRentalLicencePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AttractionCarRentalLicence fetchAttractionCarRentalLicence(
		...
		return attractionCarRentalLicencePersistence.fetchByPrimaryKey(
			attractionCarRentalLicId);
	}
	...
	public AttractionCarRentalLicence getAttractionCarRentalLicence(
		...
		return attractionCarRentalLicencePersistence.findByPrimaryKey(
			attractionCarRentalLicId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AttractionCarRentalLicence.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AttractionCarRentalLicence.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionCarRentalLicenceLocalServiceImpl#deleteAttractionCarRentalLicence(AttractionCarRentalLicence) to avoid orphaned data");
		}

		return attractionCarRentalLicenceLocalService.
			deleteAttractionCarRentalLicence(
				(AttractionCarRentalLicence)persistedModel);
	}

	@Override
	public BasePersistence<AttractionCarRentalLicence> getBasePersistence() {
		return attractionCarRentalLicencePersistence;
	}
	...
	public List<AttractionCarRentalLicence> getAttractionCarRentalLicences(
		...
		return attractionCarRentalLicencePersistence.findAll(start, end);
	}
	...
	public int getAttractionCarRentalLicencesCount() {
		return attractionCarRentalLicencePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		attractionCarRentalLicenceLocalService =
			(AttractionCarRentalLicenceLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionCarRentalLicenceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionCarRentalLicencePersistence.getDataSource();
	...
	protected AttractionCarRentalLicenceLocalService
		attractionCarRentalLicenceLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionCarRentalLicenceLocalServiceBaseImpl.class);
