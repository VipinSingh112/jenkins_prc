...
import com.nbp.jtb.application.form.service.service.JtbAddListVehicleRegstService;
...
/**
 * Provides the base implementation for the jtb add list vehicle regst remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.JtbAddListVehicleRegstServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.JtbAddListVehicleRegstServiceImpl
 * @generated
 */
public abstract class JtbAddListVehicleRegstServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   JtbAddListVehicleRegstService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JtbAddListVehicleRegstService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.JtbAddListVehicleRegstServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JtbAddListVehicleRegstService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jtbAddListVehicleRegstService = (JtbAddListVehicleRegstService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JtbAddListVehicleRegstService.class.getName();
	}
	...
	protected JtbAddListVehicleRegstService jtbAddListVehicleRegstService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JtbAddListVehicleRegstServiceBaseImpl.class);
