...
import com.nbp.jtb.application.form.service.service.AttractionConCarriageInfoLocalService;
...
/**
 * Provides the base implementation for the attraction con carriage info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionConCarriageInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionConCarriageInfoLocalServiceImpl
 * @generated
 */
public abstract class AttractionConCarriageInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionConCarriageInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionConCarriageInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionConCarriageInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public AttractionConCarriageInfo addAttractionConCarriageInfo(
		AttractionConCarriageInfo attractionConCarriageInfo) {

		attractionConCarriageInfo.setNew(true);

		return attractionConCarriageInfoPersistence.update(
	...
	public AttractionConCarriageInfo createAttractionConCarriageInfo(
		long attractionConCarriageInfoId) {

		return attractionConCarriageInfoPersistence.create(
	...
	@Override
	public AttractionConCarriageInfo deleteAttractionConCarriageInfo(
			long attractionConCarriageInfoId)
		throws PortalException {

		return attractionConCarriageInfoPersistence.remove(
			attractionConCarriageInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionConCarriageInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionConCarriageInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionConCarriageInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionConCarriageInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AttractionConCarriageInfo fetchAttractionConCarriageInfo(
		long attractionConCarriageInfoId) {

		return attractionConCarriageInfoPersistence.fetchByPrimaryKey(
			attractionConCarriageInfoId);
	}
	 ...
	 */
	@Override
	public AttractionConCarriageInfo getAttractionConCarriageInfo(
			long attractionConCarriageInfoId)
		throws PortalException {

		return attractionConCarriageInfoPersistence.findByPrimaryKey(
			attractionConCarriageInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AttractionConCarriageInfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AttractionConCarriageInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionConCarriageInfoLocalServiceImpl#deleteAttractionConCarriageInfo(AttractionConCarriageInfo) to avoid orphaned data");
		}

		return attractionConCarriageInfoLocalService.
			deleteAttractionConCarriageInfo(
				(AttractionConCarriageInfo)persistedModel);
	}

	@Override
	public BasePersistence<AttractionConCarriageInfo> getBasePersistence() {
		return attractionConCarriageInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<AttractionConCarriageInfo> getAttractionConCarriageInfos(
		int start, int end) {

		return attractionConCarriageInfoPersistence.findAll(start, end);
	}
	...
	public int getAttractionConCarriageInfosCount() {
		return attractionConCarriageInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttractionConCarriageInfo updateAttractionConCarriageInfo(
		AttractionConCarriageInfo attractionConCarriageInfo) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionConCarriageInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		attractionConCarriageInfoLocalService =
			(AttractionConCarriageInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionConCarriageInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionConCarriageInfoPersistence.getDataSource();
	...
	protected AttractionConCarriageInfoLocalService
		attractionConCarriageInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionConCarriageInfoLocalServiceBaseImpl.class);
