...
import com.nbp.jtb.application.form.service.service.JTBApplicationService;
...
/**
 * Provides the base implementation for the jtb application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.JTBApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.JTBApplicationServiceImpl
 * @generated
 */
public abstract class JTBApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JTBApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JTBApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.JTBApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JTBApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jtbApplicationService = (JTBApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JTBApplicationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.jtb.application.form.service.service.JTBApplicationLocalService
			jtbApplicationLocalService;

	protected JTBApplicationService jtbApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JTBApplicationServiceBaseImpl.class);
