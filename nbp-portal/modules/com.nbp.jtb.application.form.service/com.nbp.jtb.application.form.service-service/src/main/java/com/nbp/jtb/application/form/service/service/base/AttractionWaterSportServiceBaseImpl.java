...
import com.nbp.jtb.application.form.service.service.AttractionWaterSportService;
...
/**
 * Provides the base implementation for the attraction water sport remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionWaterSportServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionWaterSportServiceImpl
 * @generated
 */
public abstract class AttractionWaterSportServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionWaterSportService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionWaterSportService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionWaterSportServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionWaterSportService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionWaterSportService = (AttractionWaterSportService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionWaterSportService.class.getName();
	}
	...
	protected AttractionWaterSportService attractionWaterSportService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionWaterSportServiceBaseImpl.class);
