...
import com.nbp.jtb.application.form.service.service.AttractionWaterRequiredLocalService;
...
/**
 * Provides the base implementation for the attraction water required local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionWaterRequiredLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionWaterRequiredLocalServiceImpl
 * @generated
 */
public abstract class AttractionWaterRequiredLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionWaterRequiredLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionWaterRequiredLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionWaterRequiredLocalServiceUtil</code>.
	 */
	...
	public AttractionWaterRequired addAttractionWaterRequired(
		...
		return attractionWaterRequiredPersistence.update(
	...
	public AttractionWaterRequired createAttractionWaterRequired(
		...
		return attractionWaterRequiredPersistence.create(
	...
	public AttractionWaterRequired deleteAttractionWaterRequired(
		...
		return attractionWaterRequiredPersistence.remove(
			attractionWaterRequiredId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionWaterRequiredPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionWaterRequired.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionWaterRequiredPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionWaterRequiredPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AttractionWaterRequired fetchAttractionWaterRequired(
		...
		return attractionWaterRequiredPersistence.fetchByPrimaryKey(
			attractionWaterRequiredId);
	}
	...
	public AttractionWaterRequired getAttractionWaterRequired(
		...
		return attractionWaterRequiredPersistence.findByPrimaryKey(
			attractionWaterRequiredId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AttractionWaterRequired.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionWaterRequiredLocalServiceImpl#deleteAttractionWaterRequired(AttractionWaterRequired) to avoid orphaned data");
		}

		return attractionWaterRequiredLocalService.
			deleteAttractionWaterRequired(
				(AttractionWaterRequired)persistedModel);
	}

	@Override
	public BasePersistence<AttractionWaterRequired> getBasePersistence() {
		return attractionWaterRequiredPersistence;
	}
	...
	public List<AttractionWaterRequired> getAttractionWaterRequireds(
		...
		return attractionWaterRequiredPersistence.findAll(start, end);
	}
	...
	public int getAttractionWaterRequiredsCount() {
		return attractionWaterRequiredPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		attractionWaterRequiredLocalService =
			(AttractionWaterRequiredLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionWaterRequiredLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionWaterRequiredPersistence.getDataSource();
	...
	protected AttractionWaterRequiredLocalService
		attractionWaterRequiredLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionWaterRequiredLocalServiceBaseImpl.class);
