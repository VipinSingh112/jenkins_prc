...
import com.nbp.jtb.application.form.service.service.AttractionBikeRentalInfoLocalService;
...
/**
 * Provides the base implementation for the attraction bike rental info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionBikeRentalInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionBikeRentalInfoLocalServiceImpl
 * @generated
 */
public abstract class AttractionBikeRentalInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionBikeRentalInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionBikeRentalInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionBikeRentalInfoLocalServiceUtil</code>.
	 */

	/**
	 * Adds the attraction bike rental info to the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect AttractionBikeRentalInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param attractionBikeRentalInfo the attraction bike rental info
	 * @return the attraction bike rental info that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttractionBikeRentalInfo addAttractionBikeRentalInfo(
		AttractionBikeRentalInfo attractionBikeRentalInfo) {

		attractionBikeRentalInfo.setNew(true);

		return attractionBikeRentalInfoPersistence.update(
	...
	public AttractionBikeRentalInfo createAttractionBikeRentalInfo(
		long attractionBikeRentalInfoId) {

		return attractionBikeRentalInfoPersistence.create(
			attractionBikeRentalInfoId);
	}

	/**
	 * Deletes the attraction bike rental info with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect AttractionBikeRentalInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 ...
	 * @throws PortalException if a attraction bike rental info with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AttractionBikeRentalInfo deleteAttractionBikeRentalInfo(
			long attractionBikeRentalInfoId)
		throws PortalException {

		return attractionBikeRentalInfoPersistence.remove(
			attractionBikeRentalInfoId);
	}

	/**
	 * Deletes the attraction bike rental info from the database. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect AttractionBikeRentalInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionBikeRentalInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionBikeRentalInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionBikeRentalInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	 ...
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>com.nbp.jtb.application.form.service.model.impl.AttractionBikeRentalInfoModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionBikeRentalInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AttractionBikeRentalInfo fetchAttractionBikeRentalInfo(
		long attractionBikeRentalInfoId) {

		return attractionBikeRentalInfoPersistence.fetchByPrimaryKey(
			attractionBikeRentalInfoId);
	}

	/**
	 * Returns the attraction bike rental info with the primary key.
	 *
	 * @param attractionBikeRentalInfoId the primary key of the attraction bike rental info
	 ...
	 */
	@Override
	public AttractionBikeRentalInfo getAttractionBikeRentalInfo(
			long attractionBikeRentalInfoId)
		throws PortalException {

		return attractionBikeRentalInfoPersistence.findByPrimaryKey(
			attractionBikeRentalInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			attractionBikeRentalInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AttractionBikeRentalInfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AttractionBikeRentalInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionBikeRentalInfoLocalServiceImpl#deleteAttractionBikeRentalInfo(AttractionBikeRentalInfo) to avoid orphaned data");
		}

		return attractionBikeRentalInfoLocalService.
			deleteAttractionBikeRentalInfo(
				(AttractionBikeRentalInfo)persistedModel);
	}

	@Override
	public BasePersistence<AttractionBikeRentalInfo> getBasePersistence() {
		return attractionBikeRentalInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<AttractionBikeRentalInfo> getAttractionBikeRentalInfos(
		int start, int end) {

		return attractionBikeRentalInfoPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAttractionBikeRentalInfosCount() {
		return attractionBikeRentalInfoPersistence.countAll();
	}

	/**
	 * Updates the attraction bike rental info in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect AttractionBikeRentalInfoLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	 * @param attractionBikeRentalInfo the attraction bike rental info
	 * @return the attraction bike rental info that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttractionBikeRentalInfo updateAttractionBikeRentalInfo(
		AttractionBikeRentalInfo attractionBikeRentalInfo) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionBikeRentalInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		attractionBikeRentalInfoLocalService =
			(AttractionBikeRentalInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionBikeRentalInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionBikeRentalInfoPersistence.getDataSource();
	...
	protected AttractionBikeRentalInfoLocalService
		attractionBikeRentalInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionBikeRentalInfoLocalServiceBaseImpl.class);
