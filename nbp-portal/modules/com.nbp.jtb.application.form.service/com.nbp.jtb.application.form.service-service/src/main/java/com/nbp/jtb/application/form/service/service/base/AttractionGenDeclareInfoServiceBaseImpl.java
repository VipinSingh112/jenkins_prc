...
import com.nbp.jtb.application.form.service.service.AttractionGenDeclareInfoService;
...
/**
 * Provides the base implementation for the attraction gen declare info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionGenDeclareInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionGenDeclareInfoServiceImpl
 * @generated
 */
public abstract class AttractionGenDeclareInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionGenDeclareInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionGenDeclareInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionGenDeclareInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionGenDeclareInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionGenDeclareInfoService =
			(AttractionGenDeclareInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionGenDeclareInfoService.class.getName();
	}
	...
	protected AttractionGenDeclareInfoService attractionGenDeclareInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionGenDeclareInfoServiceBaseImpl.class);
