...
import com.nbp.jtb.application.form.service.service.AccoHomeStayService;
...
/**
 * Provides the base implementation for the acco home stay remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AccoHomeStayServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AccoHomeStayServiceImpl
 * @generated
 */
public abstract class AccoHomeStayServiceBaseImpl
	extends BaseServiceImpl
	implements AccoHomeStayService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccoHomeStayService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AccoHomeStayServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccoHomeStayService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accoHomeStayService = (AccoHomeStayService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccoHomeStayService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.jtb.application.form.service.service.AccoHomeStayLocalService
			accoHomeStayLocalService;

	protected AccoHomeStayService accoHomeStayService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccoHomeStayServiceBaseImpl.class);
