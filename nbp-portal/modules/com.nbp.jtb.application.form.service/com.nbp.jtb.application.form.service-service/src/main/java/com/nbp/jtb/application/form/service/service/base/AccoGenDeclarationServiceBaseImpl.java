...
import com.nbp.jtb.application.form.service.service.AccoGenDeclarationService;
...
/**
 * Provides the base implementation for the acco gen declaration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AccoGenDeclarationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AccoGenDeclarationServiceImpl
 * @generated
 */
public abstract class AccoGenDeclarationServiceBaseImpl
	extends BaseServiceImpl
	implements AccoGenDeclarationService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccoGenDeclarationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AccoGenDeclarationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccoGenDeclarationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accoGenDeclarationService = (AccoGenDeclarationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccoGenDeclarationService.class.getName();
	}
	...
	protected AccoGenDeclarationService accoGenDeclarationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccoGenDeclarationServiceBaseImpl.class);
