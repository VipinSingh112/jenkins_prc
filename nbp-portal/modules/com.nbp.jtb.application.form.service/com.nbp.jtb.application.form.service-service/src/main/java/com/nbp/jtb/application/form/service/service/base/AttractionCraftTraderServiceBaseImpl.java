...
import com.nbp.jtb.application.form.service.service.AttractionCraftTraderService;
...
/**
 * Provides the base implementation for the attraction craft trader remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionCraftTraderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionCraftTraderServiceImpl
 * @generated
 */
public abstract class AttractionCraftTraderServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionCraftTraderService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionCraftTraderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionCraftTraderServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionCraftTraderService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionCraftTraderService = (AttractionCraftTraderService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionCraftTraderService.class.getName();
	}
	...
	protected AttractionCraftTraderService attractionCraftTraderService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionCraftTraderServiceBaseImpl.class);
