...
import com.nbp.jtb.application.form.service.service.AttractionDomesticTourService;
...
/**
 * Provides the base implementation for the attraction domestic tour remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionDomesticTourServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionDomesticTourServiceImpl
 * @generated
 */
public abstract class AttractionDomesticTourServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionDomesticTourService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionDomesticTourService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionDomesticTourServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionDomesticTourService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionDomesticTourService = (AttractionDomesticTourService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionDomesticTourService.class.getName();
	}
	...
	protected AttractionDomesticTourService attractionDomesticTourService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionDomesticTourServiceBaseImpl.class);
