...
import com.nbp.jtb.application.form.service.service.JtbAddListDriverInfoLocalService;
...
/**
 * Provides the base implementation for the jtb add list driver info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.JtbAddListDriverInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.JtbAddListDriverInfoLocalServiceImpl
 * @generated
 */
public abstract class JtbAddListDriverInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   JtbAddListDriverInfoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JtbAddListDriverInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.JtbAddListDriverInfoLocalServiceUtil</code>.
	 */
	...
	public JtbAddListDriverInfo addJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.update(jtbAddListDriverInfo);
	}
	...
	public JtbAddListDriverInfo createJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.create(jtbAddListDriverInfoId);
	}
	...
	public JtbAddListDriverInfo deleteJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.remove(jtbAddListDriverInfoId);
	}
	...
	public JtbAddListDriverInfo deleteJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.remove(jtbAddListDriverInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return jtbAddListDriverInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JtbAddListDriverInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jtbAddListDriverInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jtbAddListDriverInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public JtbAddListDriverInfo fetchJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.fetchByPrimaryKey(
	...
	public JtbAddListDriverInfo getJtbAddListDriverInfo(
		...
		return jtbAddListDriverInfoPersistence.findByPrimaryKey(
			jtbAddListDriverInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(JtbAddListDriverInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return jtbAddListDriverInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement JtbAddListDriverInfoLocalServiceImpl#deleteJtbAddListDriverInfo(JtbAddListDriverInfo) to avoid orphaned data");
		}

		return jtbAddListDriverInfoLocalService.deleteJtbAddListDriverInfo(
			(JtbAddListDriverInfo)persistedModel);
	}

	@Override
	public BasePersistence<JtbAddListDriverInfo> getBasePersistence() {
		return jtbAddListDriverInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return jtbAddListDriverInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<JtbAddListDriverInfo> getJtbAddListDriverInfos(
		...
		return jtbAddListDriverInfoPersistence.findAll(start, end);
	}
	...
	public int getJtbAddListDriverInfosCount() {
		return jtbAddListDriverInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		jtbAddListDriverInfoLocalService =
			(JtbAddListDriverInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JtbAddListDriverInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				jtbAddListDriverInfoPersistence.getDataSource();
	...
	protected JtbAddListDriverInfoLocalService jtbAddListDriverInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JtbAddListDriverInfoLocalServiceBaseImpl.class);
