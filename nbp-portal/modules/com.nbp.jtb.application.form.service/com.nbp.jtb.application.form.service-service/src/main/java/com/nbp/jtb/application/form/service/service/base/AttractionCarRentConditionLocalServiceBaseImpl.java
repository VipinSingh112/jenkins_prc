...
import com.nbp.jtb.application.form.service.service.AttractionCarRentConditionLocalService;
...
/**
 * Provides the base implementation for the attraction car rent condition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionCarRentConditionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionCarRentConditionLocalServiceImpl
 * @generated
 */
public abstract class AttractionCarRentConditionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionCarRentConditionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionCarRentConditionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionCarRentConditionLocalServiceUtil</code>.
	 */
	...
	@Override
	public AttractionCarRentCondition addAttractionCarRentCondition(
		AttractionCarRentCondition attractionCarRentCondition) {

		attractionCarRentCondition.setNew(true);

		return attractionCarRentConditionPersistence.update(
	...
	public AttractionCarRentCondition createAttractionCarRentCondition(
		long attractionCarRenConditId) {

		return attractionCarRentConditionPersistence.create(
	...
	@Override
	public AttractionCarRentCondition deleteAttractionCarRentCondition(
			long attractionCarRenConditId)
		throws PortalException {

		return attractionCarRentConditionPersistence.remove(
			attractionCarRenConditId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionCarRentConditionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionCarRentCondition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionCarRentConditionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionCarRentConditionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AttractionCarRentCondition fetchAttractionCarRentCondition(
		long attractionCarRenConditId) {

		return attractionCarRentConditionPersistence.fetchByPrimaryKey(
			attractionCarRenConditId);
	}
	 ...
	 */
	@Override
	public AttractionCarRentCondition getAttractionCarRentCondition(
			long attractionCarRenConditId)
		throws PortalException {

		return attractionCarRentConditionPersistence.findByPrimaryKey(
			attractionCarRenConditId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AttractionCarRentCondition.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			AttractionCarRentCondition.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionCarRentConditionLocalServiceImpl#deleteAttractionCarRentCondition(AttractionCarRentCondition) to avoid orphaned data");
		}

		return attractionCarRentConditionLocalService.
			deleteAttractionCarRentCondition(
				(AttractionCarRentCondition)persistedModel);
	}

	@Override
	public BasePersistence<AttractionCarRentCondition> getBasePersistence() {
		return attractionCarRentConditionPersistence;
	}
	 ...
	 */
	@Override
	public List<AttractionCarRentCondition> getAttractionCarRentConditions(
		int start, int end) {

		return attractionCarRentConditionPersistence.findAll(start, end);
	}
	...
	public int getAttractionCarRentConditionsCount() {
		return attractionCarRentConditionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttractionCarRentCondition updateAttractionCarRentCondition(
		AttractionCarRentCondition attractionCarRentCondition) {
	...
	public void setAopProxy(Object aopProxy) {
		attractionCarRentConditionLocalService =
			(AttractionCarRentConditionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionCarRentConditionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionCarRentConditionPersistence.getDataSource();
	...
	protected AttractionCarRentConditionLocalService
		attractionCarRentConditionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionCarRentConditionLocalServiceBaseImpl.class);
