...
import com.nbp.jtb.application.form.service.service.AccoNonHotelGenDecService;
...
/**
 * Provides the base implementation for the acco non hotel gen dec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AccoNonHotelGenDecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AccoNonHotelGenDecServiceImpl
 * @generated
 */
public abstract class AccoNonHotelGenDecServiceBaseImpl
	extends BaseServiceImpl
	implements AccoNonHotelGenDecService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AccoNonHotelGenDecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AccoNonHotelGenDecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AccoNonHotelGenDecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		accoNonHotelGenDecService = (AccoNonHotelGenDecService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccoNonHotelGenDecService.class.getName();
	}
	...
	protected AccoNonHotelGenDecService accoNonHotelGenDecService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AccoNonHotelGenDecServiceBaseImpl.class);
