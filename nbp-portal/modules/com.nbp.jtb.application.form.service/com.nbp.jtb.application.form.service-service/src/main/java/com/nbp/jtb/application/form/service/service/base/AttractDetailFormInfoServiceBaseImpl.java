...
import com.nbp.jtb.application.form.service.service.AttractDetailFormInfoService;
...
/**
 * Provides the base implementation for the attract detail form info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractDetailFormInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractDetailFormInfoServiceImpl
 * @generated
 */
public abstract class AttractDetailFormInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractDetailFormInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractDetailFormInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractDetailFormInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractDetailFormInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractDetailFormInfoService = (AttractDetailFormInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractDetailFormInfoService.class.getName();
	}
	...
	protected AttractDetailFormInfoService attractDetailFormInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractDetailFormInfoServiceBaseImpl.class);
