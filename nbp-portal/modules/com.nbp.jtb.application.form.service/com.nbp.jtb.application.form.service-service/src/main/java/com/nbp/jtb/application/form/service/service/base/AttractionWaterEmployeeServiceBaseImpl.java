...
import com.nbp.jtb.application.form.service.service.AttractionWaterEmployeeService;
...
/**
 * Provides the base implementation for the attraction water employee remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionWaterEmployeeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionWaterEmployeeServiceImpl
 * @generated
 */
public abstract class AttractionWaterEmployeeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionWaterEmployeeService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionWaterEmployeeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionWaterEmployeeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionWaterEmployeeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionWaterEmployeeService =
			(AttractionWaterEmployeeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionWaterEmployeeService.class.getName();
	}
	...
	protected com.nbp.jtb.application.form.service.service.
		AttractionWaterEmployeeLocalService attractionWaterEmployeeLocalService;

	protected AttractionWaterEmployeeService attractionWaterEmployeeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionWaterEmployeeServiceBaseImpl.class);
