...
import com.nbp.jtb.application.form.service.service.JTBPaymentMethodService;
...
/**
 * Provides the base implementation for the jtb payment method remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.JTBPaymentMethodServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.JTBPaymentMethodServiceImpl
 * @generated
 */
public abstract class JTBPaymentMethodServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JTBPaymentMethodService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JTBPaymentMethodService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.JTBPaymentMethodServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JTBPaymentMethodService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jtbPaymentMethodService = (JTBPaymentMethodService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JTBPaymentMethodService.class.getName();
	}
	...
	protected JTBPaymentMethodService jtbPaymentMethodService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JTBPaymentMethodServiceBaseImpl.class);
