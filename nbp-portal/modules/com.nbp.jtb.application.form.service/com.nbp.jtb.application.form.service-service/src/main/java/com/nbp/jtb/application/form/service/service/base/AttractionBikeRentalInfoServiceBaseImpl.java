...
import com.nbp.jtb.application.form.service.service.AttractionBikeRentalInfoService;
...
/**
 * Provides the base implementation for the attraction bike rental info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionBikeRentalInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionBikeRentalInfoServiceImpl
 * @generated
 */
public abstract class AttractionBikeRentalInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionBikeRentalInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionBikeRentalInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionBikeRentalInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionBikeRentalInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionBikeRentalInfoService =
			(AttractionBikeRentalInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionBikeRentalInfoService.class.getName();
	}
	...
	protected AttractionBikeRentalInfoService attractionBikeRentalInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionBikeRentalInfoServiceBaseImpl.class);
