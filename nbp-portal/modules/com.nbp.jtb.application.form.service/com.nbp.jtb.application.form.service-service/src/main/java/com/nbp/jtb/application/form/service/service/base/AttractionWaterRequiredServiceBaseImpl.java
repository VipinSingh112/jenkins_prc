...
import com.nbp.jtb.application.form.service.service.AttractionWaterRequiredService;
...
/**
 * Provides the base implementation for the attraction water required remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionWaterRequiredServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionWaterRequiredServiceImpl
 * @generated
 */
public abstract class AttractionWaterRequiredServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AttractionWaterRequiredService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionWaterRequiredService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionWaterRequiredServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AttractionWaterRequiredService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		attractionWaterRequiredService =
			(AttractionWaterRequiredService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionWaterRequiredService.class.getName();
	}
	...
	protected com.nbp.jtb.application.form.service.service.
		AttractionWaterRequiredLocalService attractionWaterRequiredLocalService;

	protected AttractionWaterRequiredService attractionWaterRequiredService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionWaterRequiredServiceBaseImpl.class);
