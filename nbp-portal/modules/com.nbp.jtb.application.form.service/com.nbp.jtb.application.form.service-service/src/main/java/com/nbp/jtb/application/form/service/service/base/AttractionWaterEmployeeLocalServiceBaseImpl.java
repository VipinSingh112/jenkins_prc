...
import com.nbp.jtb.application.form.service.service.AttractionWaterEmployeeLocalService;
...
/**
 * Provides the base implementation for the attraction water employee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.form.service.service.impl.AttractionWaterEmployeeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.form.service.service.impl.AttractionWaterEmployeeLocalServiceImpl
 * @generated
 */
public abstract class AttractionWaterEmployeeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AttractionWaterEmployeeLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AttractionWaterEmployeeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.form.service.service.AttractionWaterEmployeeLocalServiceUtil</code>.
	 */
	...
	@Override
	public AttractionWaterEmployee addAttractionWaterEmployee(
		AttractionWaterEmployee attractionWaterEmployee) {

		attractionWaterEmployee.setNew(true);

		return attractionWaterEmployeePersistence.update(
	...
	public AttractionWaterEmployee createAttractionWaterEmployee(
		long attractionWaterEmpLicId) {

		return attractionWaterEmployeePersistence.create(
	...
	@Override
	public AttractionWaterEmployee deleteAttractionWaterEmployee(
			long attractionWaterEmpLicId)
		throws PortalException {

		return attractionWaterEmployeePersistence.remove(
			attractionWaterEmpLicId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return attractionWaterEmployeePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AttractionWaterEmployee.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return attractionWaterEmployeePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return attractionWaterEmployeePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AttractionWaterEmployee fetchAttractionWaterEmployee(
		long attractionWaterEmpLicId) {

		return attractionWaterEmployeePersistence.fetchByPrimaryKey(
			attractionWaterEmpLicId);
	}
	 ...
	 */
	@Override
	public AttractionWaterEmployee getAttractionWaterEmployee(
			long attractionWaterEmpLicId)
		throws PortalException {

		return attractionWaterEmployeePersistence.findByPrimaryKey(
			attractionWaterEmpLicId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AttractionWaterEmployee.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AttractionWaterEmployeeLocalServiceImpl#deleteAttractionWaterEmployee(AttractionWaterEmployee) to avoid orphaned data");
		}

		return attractionWaterEmployeeLocalService.
			deleteAttractionWaterEmployee(
				(AttractionWaterEmployee)persistedModel);
	}

	@Override
	public BasePersistence<AttractionWaterEmployee> getBasePersistence() {
		return attractionWaterEmployeePersistence;
	}
	 ...
	 */
	@Override
	public List<AttractionWaterEmployee> getAttractionWaterEmployees(
		int start, int end) {

		return attractionWaterEmployeePersistence.findAll(start, end);
	}
	...
	public int getAttractionWaterEmployeesCount() {
		return attractionWaterEmployeePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AttractionWaterEmployee updateAttractionWaterEmployee(
		AttractionWaterEmployee attractionWaterEmployee) {
	...
	public void setAopProxy(Object aopProxy) {
		attractionWaterEmployeeLocalService =
			(AttractionWaterEmployeeLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AttractionWaterEmployeeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				attractionWaterEmployeePersistence.getDataSource();
	...
	protected AttractionWaterEmployeeLocalService
		attractionWaterEmployeeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AttractionWaterEmployeeLocalServiceBaseImpl.class);
