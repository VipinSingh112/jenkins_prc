...
import com.nbp.miic.application.form.services.service.MiicApplicantDetailsService;
...
/**
 * Provides the base implementation for the miic applicant details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicApplicantDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicApplicantDetailsServiceImpl
 * @generated
 */
public abstract class MiicApplicantDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiicApplicantDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicApplicantDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicApplicantDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicApplicantDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miicApplicantDetailsService = (MiicApplicantDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicApplicantDetailsService.class.getName();
	}
	...
	protected MiicApplicantDetailsService miicApplicantDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicApplicantDetailsServiceBaseImpl.class);
