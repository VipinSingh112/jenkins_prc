...
import com.nbp.miic.application.form.services.service.MiicSuspensionOfCetService;
...
/**
 * Provides the base implementation for the miic suspension of cet remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetServiceImpl
 * @generated
 */
public abstract class MiicSuspensionOfCetServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MiicSuspensionOfCetService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicSuspensionOfCetService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicSuspensionOfCetServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicSuspensionOfCetService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miicSuspensionOfCetService = (MiicSuspensionOfCetService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicSuspensionOfCetService.class.getName();
	}
	...
	protected MiicSuspensionOfCetService miicSuspensionOfCetService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicSuspensionOfCetServiceBaseImpl.class);
