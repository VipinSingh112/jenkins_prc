...
import com.nbp.miic.application.form.services.service.MiicSafeguardGoodAddService;
...
/**
 * Provides the base implementation for the miic safeguard good add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicSafeguardGoodAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicSafeguardGoodAddServiceImpl
 * @generated
 */
public abstract class MiicSafeguardGoodAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiicSafeguardGoodAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicSafeguardGoodAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicSafeguardGoodAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicSafeguardGoodAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miicSafeguardGoodAddService = (MiicSafeguardGoodAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicSafeguardGoodAddService.class.getName();
	}
	...
	protected MiicSafeguardGoodAddService miicSafeguardGoodAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicSafeguardGoodAddServiceBaseImpl.class);
