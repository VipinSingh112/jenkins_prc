...
import com.nbp.miic.application.form.services.service.MiicSuspensionOfCetAddLocalService;
...
/**
 * Provides the base implementation for the miic suspension of cet add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetAddLocalServiceImpl
 * @generated
 */
public abstract class MiicSuspensionOfCetAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicSuspensionOfCetAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicSuspensionOfCetAddLocalServiceUtil</code>.
	 */
	...
	public MiicSuspensionOfCetAdd addMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.update(miicSuspensionOfCetAdd);
	}
	...
	public MiicSuspensionOfCetAdd createMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.create(
	...
	public MiicSuspensionOfCetAdd deleteMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.remove(
			miicSuspensionOfCetAddId);
	}
	...
	public MiicSuspensionOfCetAdd deleteMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.remove(miicSuspensionOfCetAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return miicSuspensionOfCetAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MiicSuspensionOfCetAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return miicSuspensionOfCetAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return miicSuspensionOfCetAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public MiicSuspensionOfCetAdd fetchMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.fetchByPrimaryKey(
			miicSuspensionOfCetAddId);
	}
	...
	public MiicSuspensionOfCetAdd getMiicSuspensionOfCetAdd(
		...
		return miicSuspensionOfCetAddPersistence.findByPrimaryKey(
			miicSuspensionOfCetAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MiicSuspensionOfCetAdd.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MiicSuspensionOfCetAddLocalServiceImpl#deleteMiicSuspensionOfCetAdd(MiicSuspensionOfCetAdd) to avoid orphaned data");
		}

		return miicSuspensionOfCetAddLocalService.deleteMiicSuspensionOfCetAdd(
			(MiicSuspensionOfCetAdd)persistedModel);
	}

	@Override
	public BasePersistence<MiicSuspensionOfCetAdd> getBasePersistence() {
		return miicSuspensionOfCetAddPersistence;
	}
	...
	public List<MiicSuspensionOfCetAdd> getMiicSuspensionOfCetAdds(
		...
		return miicSuspensionOfCetAddPersistence.findAll(start, end);
	}
	...
	public int getMiicSuspensionOfCetAddsCount() {
		return miicSuspensionOfCetAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		miicSuspensionOfCetAddLocalService =
			(MiicSuspensionOfCetAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicSuspensionOfCetAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				miicSuspensionOfCetAddPersistence.getDataSource();
	...
	protected MiicSuspensionOfCetAddLocalService
		miicSuspensionOfCetAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicSuspensionOfCetAddLocalServiceBaseImpl.class);
