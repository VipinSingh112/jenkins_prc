...
import com.nbp.miic.application.form.services.service.MiicApplicationCurrentStageLocalService;
...
/**
 * Provides the base implementation for the miic application current stage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicApplicationCurrentStageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicApplicationCurrentStageLocalServiceImpl
 * @generated
 */
public abstract class MiicApplicationCurrentStageLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicApplicationCurrentStageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicApplicationCurrentStageLocalServiceUtil</code>.
	 */
	...
	public MiicApplicationCurrentStage addMiicApplicationCurrentStage(
		...
		return miicApplicationCurrentStagePersistence.update(
	...
	public MiicApplicationCurrentStage createMiicApplicationCurrentStage(
		...
		return miicApplicationCurrentStagePersistence.create(
	...
	public MiicApplicationCurrentStage deleteMiicApplicationCurrentStage(
		...
		return miicApplicationCurrentStagePersistence.remove(
			miicApplicationCurrentStageId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return miicApplicationCurrentStagePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MiicApplicationCurrentStage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return miicApplicationCurrentStagePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return miicApplicationCurrentStagePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public MiicApplicationCurrentStage fetchMiicApplicationCurrentStage(
		...
		return miicApplicationCurrentStagePersistence.fetchByPrimaryKey(
			miicApplicationCurrentStageId);
	}
	...
	public MiicApplicationCurrentStage getMiicApplicationCurrentStage(
		...
		return miicApplicationCurrentStagePersistence.findByPrimaryKey(
			miicApplicationCurrentStageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MiicApplicationCurrentStage.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			MiicApplicationCurrentStage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MiicApplicationCurrentStageLocalServiceImpl#deleteMiicApplicationCurrentStage(MiicApplicationCurrentStage) to avoid orphaned data");
		}

		return miicApplicationCurrentStageLocalService.
			deleteMiicApplicationCurrentStage(
				(MiicApplicationCurrentStage)persistedModel);
	}

	@Override
	public BasePersistence<MiicApplicationCurrentStage> getBasePersistence() {
		return miicApplicationCurrentStagePersistence;
	}
	...
	public List<MiicApplicationCurrentStage> getMiicApplicationCurrentStages(
		...
		return miicApplicationCurrentStagePersistence.findAll(start, end);
	}
	...
	public int getMiicApplicationCurrentStagesCount() {
		return miicApplicationCurrentStagePersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		miicApplicationCurrentStageLocalService =
			(MiicApplicationCurrentStageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicApplicationCurrentStageLocalService.class.getName();
	}
	...
	protected MiicApplicationCurrentStageLocalService
		miicApplicationCurrentStageLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicApplicationCurrentStageLocalServiceBaseImpl.class);
