...
import com.nbp.miic.application.form.services.service.MiicSuspensionOfCetAddService;
...
/**
 * Provides the base implementation for the miic suspension of cet add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetAddServiceImpl
 * @generated
 */
public abstract class MiicSuspensionOfCetAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiicSuspensionOfCetAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicSuspensionOfCetAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicSuspensionOfCetAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicSuspensionOfCetAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miicSuspensionOfCetAddService = (MiicSuspensionOfCetAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicSuspensionOfCetAddService.class.getName();
	}
	...
	protected MiicSuspensionOfCetAddService miicSuspensionOfCetAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicSuspensionOfCetAddServiceBaseImpl.class);
