...
import com.nbp.miic.application.form.services.service.MiicPaymentLocalService;
...
/**
 * Provides the base implementation for the miic payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicPaymentLocalServiceImpl
 * @generated
 */
public abstract class MiicPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MiicPaymentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicPaymentLocalServiceUtil</code>.
	 */
	...
	public MiicPayment addMiicPayment(MiicPayment miicPayment) {
		...
		return miicPaymentPersistence.update(miicPayment);
	}
	...
	public MiicPayment createMiicPayment(long miicPaymentId) {
		return miicPaymentPersistence.create(miicPaymentId);
	}
	...
	public MiicPayment deleteMiicPayment(long miicPaymentId)
		...
		return miicPaymentPersistence.remove(miicPaymentId);
	}
	...
	public MiicPayment deleteMiicPayment(MiicPayment miicPayment) {
		return miicPaymentPersistence.remove(miicPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return miicPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MiicPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return miicPaymentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return miicPaymentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return miicPaymentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return miicPaymentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MiicPayment fetchMiicPayment(long miicPaymentId) {
		return miicPaymentPersistence.fetchByPrimaryKey(miicPaymentId);
	}
	...
	public MiicPayment getMiicPayment(long miicPaymentId)
		...
		return miicPaymentPersistence.findByPrimaryKey(miicPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(miicPaymentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MiicPayment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("miicPaymentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MiicPayment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return miicPaymentPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MiicPaymentLocalServiceImpl#deleteMiicPayment(MiicPayment) to avoid orphaned data");
		}

		return miicPaymentLocalService.deleteMiicPayment(
			(MiicPayment)persistedModel);
	}

	@Override
	public BasePersistence<MiicPayment> getBasePersistence() {
		return miicPaymentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return miicPaymentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MiicPayment> getMiicPayments(int start, int end) {
		return miicPaymentPersistence.findAll(start, end);
	}
	...
	public int getMiicPaymentsCount() {
		return miicPaymentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicPaymentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		miicPaymentLocalService = (MiicPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicPaymentLocalService.class.getName();
	}
	...
	protected MiicPaymentLocalService miicPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicPaymentLocalServiceBaseImpl.class);
