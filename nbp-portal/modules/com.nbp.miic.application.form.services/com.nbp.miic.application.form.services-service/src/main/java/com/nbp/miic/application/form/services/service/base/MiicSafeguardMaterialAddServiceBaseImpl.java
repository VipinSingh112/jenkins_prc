...
import com.nbp.miic.application.form.services.service.MiicSafeguardMaterialAddService;
...
/**
 * Provides the base implementation for the miic safeguard material add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicSafeguardMaterialAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicSafeguardMaterialAddServiceImpl
 * @generated
 */
public abstract class MiicSafeguardMaterialAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiicSafeguardMaterialAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicSafeguardMaterialAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicSafeguardMaterialAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicSafeguardMaterialAddService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		miicSafeguardMaterialAddService =
			(MiicSafeguardMaterialAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicSafeguardMaterialAddService.class.getName();
	}
	...
	protected MiicSafeguardMaterialAddService miicSafeguardMaterialAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicSafeguardMaterialAddServiceBaseImpl.class);
