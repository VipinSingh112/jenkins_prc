...
import com.nbp.miic.application.form.services.service.MiicApplicationService;
...
/**
 * Provides the base implementation for the miic application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.application.form.services.service.impl.MiicApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.application.form.services.service.impl.MiicApplicationServiceImpl
 * @generated
 */
public abstract class MiicApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MiicApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.application.form.services.service.MiicApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiicApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miicApplicationService = (MiicApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicApplicationService.class.getName();
	}
	...
	protected MiicApplicationService miicApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicApplicationServiceBaseImpl.class);
