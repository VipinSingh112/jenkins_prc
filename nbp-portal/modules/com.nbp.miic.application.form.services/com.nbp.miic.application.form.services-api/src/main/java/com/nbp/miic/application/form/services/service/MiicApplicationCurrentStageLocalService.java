...
/**
 * Provides the local service interface for MiicApplicationCurrentStage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiicApplicationCurrentStageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiicApplicationCurrentStageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicApplicationCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the miic application current stage local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiicApplicationCurrentStageLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MiicApplicationCurrentStage addMiicApplicationCurrentStage(
	...
	public MiicApplicationCurrentStage createMiicApplicationCurrentStage(
	...
	public MiicApplicationCurrentStage deleteMiicApplicationCurrentStage(
			long miicApplicationCurrentStageId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicApplicationCurrentStage fetchMiicApplicationCurrentStage(
		long miicApplicationCurrentStageId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicApplicationCurrentStage getMIIC_Stage_MIIC_AI(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicApplicationCurrentStage getMiicApplicationCurrentStage(
			long miicApplicationCurrentStageId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MiicApplicationCurrentStage> getMiicApplicationCurrentStages(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MiicApplicationCurrentStage updateMiicApplicationCurrentStage(
		MiicApplicationCurrentStage miicApplicationCurrentStage);
