...
/**
 * Provides the local service interface for MiicPayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiicPaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiicPaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicPaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the miic payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiicPaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MiicPayment addMiicPayment(MiicPayment miicPayment);
	...
	public MiicPayment createMiicPayment(long miicPaymentId);
	...
	public MiicPayment deleteMiicPayment(long miicPaymentId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MiicPayment deleteMiicPayment(MiicPayment miicPayment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicPayment fetchMiicPayment(long miicPaymentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicPayment getMiicPayment(long miicPaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MiicPayment> getMiicPayments(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MiicPayment updateMiicPayment(MiicPayment miicPayment);
