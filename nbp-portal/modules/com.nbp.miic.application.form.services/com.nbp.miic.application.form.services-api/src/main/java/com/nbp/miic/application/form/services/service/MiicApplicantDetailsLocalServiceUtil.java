...
/**
 * Provides the local service utility for MiicApplicantDetails. This utility wraps
 * <code>com.nbp.miic.application.form.services.service.impl.MiicApplicantDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MiicApplicantDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicApplicantDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MiicApplicantDetails addMiicApplicantDetails(
		MiicApplicantDetails miicApplicantDetails) {

		return getService().addMiicApplicantDetails(miicApplicantDetails);
	}
	 ...
	 */
	public static MiicApplicantDetails createMiicApplicantDetails(
		long miicApplicantDetailsId) {

		return getService().createMiicApplicantDetails(miicApplicantDetailsId);
	}
	 ...
	 */
	public static MiicApplicantDetails deleteMiicApplicantDetails(
			long miicApplicantDetailsId)
		throws PortalException {

		return getService().deleteMiicApplicantDetails(miicApplicantDetailsId);
	}
	...
	public static MiicApplicantDetails deleteMiicApplicantDetails(
		...
		return getService().deleteMiicApplicantDetails(miicApplicantDetails);
	}
	...
	public static MiicApplicantDetails fetchMiicApplicantDetails(
		long miicApplicantDetailsId) {

		return getService().fetchMiicApplicantDetails(miicApplicantDetailsId);
	}
	 ...
	 * @throws PortalException if a miic applicant details with the primary key could not be found
	 */
	public static MiicApplicantDetails getMiicApplicantDetails(
			long miicApplicantDetailsId)
		throws PortalException {

		return getService().getMiicApplicantDetails(miicApplicantDetailsId);
	}
	 ...
	 */
	public static List<MiicApplicantDetails> getMiicApplicantDetailses(
		int start, int end) {

		return getService().getMiicApplicantDetailses(start, end);
	}
	 ...
	 */
	public static int getMiicApplicantDetailsesCount() {
		return getService().getMiicApplicantDetailsesCount();
	}

	public static MiicApplicantDetails getMiicById(long applicationId)
	 ...
	 */
	public static MiicApplicantDetails updateMiicApplicantDetails(
		MiicApplicantDetails miicApplicantDetails) {

		return getService().updateMiicApplicantDetails(miicApplicantDetails);
	}

	public static MiicApplicantDetailsLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MiicApplicantDetailsLocalService>
		_serviceSnapshot = new Snapshot<>(
			MiicApplicantDetailsLocalServiceUtil.class,
