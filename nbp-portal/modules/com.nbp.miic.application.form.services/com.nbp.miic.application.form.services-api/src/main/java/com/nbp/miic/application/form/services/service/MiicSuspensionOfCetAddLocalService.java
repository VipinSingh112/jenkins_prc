...
/**
 * Provides the local service interface for MiicSuspensionOfCetAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MiicSuspensionOfCetAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MiicSuspensionOfCetAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicSuspensionOfCetAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the miic suspension of cet add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MiicSuspensionOfCetAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MiicSuspensionOfCetAdd addMiicSuspensionOfCetAdd(
	...
	public MiicSuspensionOfCetAdd createMiicSuspensionOfCetAdd(
	...
	public MiicSuspensionOfCetAdd deleteMiicSuspensionOfCetAdd(
			long miicSuspensionOfCetAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicSuspensionOfCetAdd fetchMiicSuspensionOfCetAdd(
		long miicSuspensionOfCetAddId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MiicSuspensionOfCetAdd getMiicSuspensionOfCetAdd(
			long miicSuspensionOfCetAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MiicSuspensionOfCetAdd> getMiicSuspensionOfCetAdds(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MiicSuspensionOfCetAdd updateMiicSuspensionOfCetAdd(
		MiicSuspensionOfCetAdd miicSuspensionOfCetAdd);
