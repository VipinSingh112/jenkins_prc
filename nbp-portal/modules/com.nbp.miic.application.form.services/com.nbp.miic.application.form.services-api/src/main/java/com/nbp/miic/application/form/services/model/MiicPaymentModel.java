...
/**
 * The base model interface for the MiicPayment service. Represents a row in the &quot;nbp_miic_payment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.miic.application.form.services.model.impl.MiicPaymentModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.miic.application.form.services.model.impl.MiicPaymentImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface MiicPaymentModel
	extends BaseModel<MiicPayment>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a miic payment model instance should use the {@link MiicPayment} interface instead.
	 */
