...
/**
 * Provides the local service utility for MiicApplicationCurrentStage. This utility wraps
 * <code>com.nbp.miic.application.form.services.service.impl.MiicApplicationCurrentStageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MiicApplicationCurrentStageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicApplicationCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MiicApplicationCurrentStage addMiicApplicationCurrentStage(
		MiicApplicationCurrentStage miicApplicationCurrentStage) {

		return getService().addMiicApplicationCurrentStage(
	 ...
	 */
	public static MiicApplicationCurrentStage createMiicApplicationCurrentStage(
		long miicApplicationCurrentStageId) {

		return getService().createMiicApplicationCurrentStage(
	 ...
	 */
	public static MiicApplicationCurrentStage deleteMiicApplicationCurrentStage(
			long miicApplicationCurrentStageId)
		throws PortalException {

		return getService().deleteMiicApplicationCurrentStage(
			miicApplicationCurrentStageId);
	}
	...
	public static MiicApplicationCurrentStage fetchMiicApplicationCurrentStage(
		long miicApplicationCurrentStageId) {

		return getService().fetchMiicApplicationCurrentStage(
			miicApplicationCurrentStageId);
	}
	...
	public static MiicApplicationCurrentStage getMIIC_Stage_MIIC_AI(
			long miicApplicationId)
		throws com.nbp.miic.application.form.services.exception.
			NoSuchMiicApplicationCurrentStageException {

		return getService().getMIIC_Stage_MIIC_AI(miicApplicationId);
	}
	 ...
	 * @throws PortalException if a miic application current stage with the primary key could not be found
	 */
	public static MiicApplicationCurrentStage getMiicApplicationCurrentStage(
			long miicApplicationCurrentStageId)
		throws PortalException {

		return getService().getMiicApplicationCurrentStage(
			miicApplicationCurrentStageId);
	}
	 ...
	 */
	public static List<MiicApplicationCurrentStage>
		getMiicApplicationCurrentStages(int start, int end) {

		return getService().getMiicApplicationCurrentStages(start, end);
	}
	 ...
	 */
	public static int getMiicApplicationCurrentStagesCount() {
		return getService().getMiicApplicationCurrentStagesCount();
	}
	 ...
	 */
	public static MiicApplicationCurrentStage updateMiicApplicationCurrentStage(
		MiicApplicationCurrentStage miicApplicationCurrentStage) {

		return getService().updateMiicApplicationCurrentStage(
			miicApplicationCurrentStage);
	}

	public static MiicApplicationCurrentStageLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MiicApplicationCurrentStageLocalService>
		_serviceSnapshot = new Snapshot<>(
			MiicApplicationCurrentStageLocalServiceUtil.class,
			MiicApplicationCurrentStageLocalService.class);
