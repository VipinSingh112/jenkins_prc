...
/**
 * Provides the local service utility for MiicSafeguardGoodAdd. This utility wraps
 * <code>com.nbp.miic.application.form.services.service.impl.MiicSafeguardGoodAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MiicSafeguardGoodAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.miic.application.form.services.service.impl.MiicSafeguardGoodAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MiicSafeguardGoodAdd addMiicSafeguardGoodAdd(
		MiicSafeguardGoodAdd miicSafeguardGoodAdd) {

		return getService().addMiicSafeguardGoodAdd(miicSafeguardGoodAdd);
	}
	 ...
	 */
	public static MiicSafeguardGoodAdd createMiicSafeguardGoodAdd(
		long miicSafeguardGoodAddId) {

		return getService().createMiicSafeguardGoodAdd(miicSafeguardGoodAddId);
	}
	 ...
	 */
	public static MiicSafeguardGoodAdd deleteMiicSafeguardGoodAdd(
			long miicSafeguardGoodAddId)
		throws PortalException {

		return getService().deleteMiicSafeguardGoodAdd(miicSafeguardGoodAddId);
	}
	...
	public static MiicSafeguardGoodAdd deleteMiicSafeguardGoodAdd(
		...
		return getService().deleteMiicSafeguardGoodAdd(miicSafeguardGoodAdd);
	}
	...
	public static MiicSafeguardGoodAdd fetchMiicSafeguardGoodAdd(
		long miicSafeguardGoodAddId) {

		return getService().fetchMiicSafeguardGoodAdd(miicSafeguardGoodAddId);
	}
	...
	public static List<MiicSafeguardGoodAdd> getMiicById(long applicationId) {
	 ...
	 * @throws PortalException if a miic safeguard good add with the primary key could not be found
	 */
	public static MiicSafeguardGoodAdd getMiicSafeguardGoodAdd(
			long miicSafeguardGoodAddId)
		throws PortalException {

		return getService().getMiicSafeguardGoodAdd(miicSafeguardGoodAddId);
	}
	 ...
	 */
	public static List<MiicSafeguardGoodAdd> getMiicSafeguardGoodAdds(
		int start, int end) {

		return getService().getMiicSafeguardGoodAdds(start, end);
	}
	 ...
	 */
	public static int getMiicSafeguardGoodAddsCount() {
		return getService().getMiicSafeguardGoodAddsCount();
	}
	 ...
	 */
	public static MiicSafeguardGoodAdd updateMiicSafeguardGoodAdd(
		MiicSafeguardGoodAdd miicSafeguardGoodAdd) {

		return getService().updateMiicSafeguardGoodAdd(miicSafeguardGoodAdd);
	}

	public static MiicSafeguardGoodAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MiicSafeguardGoodAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			MiicSafeguardGoodAddLocalServiceUtil.class,
