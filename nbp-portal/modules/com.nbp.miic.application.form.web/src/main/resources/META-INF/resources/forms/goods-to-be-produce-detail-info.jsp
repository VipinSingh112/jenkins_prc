<%
String goodsProducedDetailVal="";
goodsProducedDetailVal = (String)request.getAttribute("goodsProducedDetailVal");
System.out.println("Inside render jsp");
%>

<tr class="goodsProduced-row<%=goodsProducedDetailVal%>">
	<td class="sub_heading_content goodsTariff<%=goodsProducedDetailVal%>"></td>
	<td class="sub_heading_content goodsDescription<%=goodsProducedDetailVal%>"></td>
	<td class="sub_heading_content goodsQuantity<%=goodsProducedDetailVal%>"></td>
	<td class="sub_heading_content goodsEstimate<%=goodsProducedDetailVal%>"></td>
	<td class="sub_heading_content goodsMechanism<%=goodsProducedDetailVal%>"></td>
	<td> 
		<span> 
