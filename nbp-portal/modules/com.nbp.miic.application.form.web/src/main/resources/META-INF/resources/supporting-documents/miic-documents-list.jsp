...
if(Validator.isNotNull(request.getAttribute("miicApplicationId"))){
	miicAppliId= String.valueOf(request.getAttribute("miicApplicationId"));
}
...
//Optional
System.out.println("document name array--"+documentNameArray);
...
<p class="supporting-document-subtitle">Mandatory Documents (that may attract an expiry date)</p>
<%}%>
<%
