...
<fieldset class="wizard-fieldset" id="miicSupportingDocumentFieldset" name="Supporting Documents">
	...
	<input type="hidden" id="miicDocumentuploadCounter"
		name="miicDocumentuploadCounter">
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="miicGenericUpload" multiple="multiple"
				name="<portlet:namespace/>miicGenericUpload" onchange="attachDetailed(this.id)"
				hidden=""> <label class="custom-upload"
				for="miicGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="miicGenericFileChosen">or drag and drop from your computer</span>
		</div>
		   ...
		   <!-- <a class="uploaded-delete mr-2" href="#" style="display: none;">
		        <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
		            <path d="M1 18H13V4H1V18ZM3.46 8.88L4.87 7.47L7 9.59L9.12 7.47L10.53 8.88L8.41 11L10.53 13.12L9.12 14.53L7 12.41L4.88 14.53L3.47 13.12L5.59 11L3.46 8.88ZM10.5 1L9.5 0H4.5L3.5 1H0V3H14V1H10.5Z" fill="#184C48"></path>
							...
							<%int miicCounter =counterOfDocuments+ 1;
				...
				if(miicApplicationId>0 && dlFileEntriesGeneric!=null){
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						try{
							...
							fileUrlInMiic = DLURLHelperUtil.getDownloadURL(fileEntryForGeneric, fileEntryForGeneric.getFileVersion(), themeDisplay,
									StringPool.BLANK, false, true);
						}catch(Exception e ){
						}
						%>	
						<div class="supporting-document-card mb-2" id="genericSupportingDocuments<%=miicCounter%>">
				<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=miicCounter%>">
						<%
						%>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<input type="date" class="form-control"
											...
											placeholder="#2345" max="<%=MIICApplicationUtil.getValidationIssueDate()%>">
									</div>
									<div class="col-md-6 mb-3">
										<p class="tab-form-main-heading">Expiry Date</p>
										<input type="date" class="form-control"
											id="<portlet:namespace/>expiryDate"
											placeholder="#2345"min="<%= MIICApplicationUtil.getValidationExpiryDate()%>">
									</div>
									<div class="col-md-6 mb-3">
										<p class="tab-form-main-heading">Choose File</p>
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="ncraEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>ncraEnrollDocuments">
							...
							<input type="hidden" id="ncraDocumentuploadCounter"
								name="ncraDocumentuploadCounter">
							<div class="col-md-12">
								<div class="footer-above-b;
								order"></div>
							</div>
						</div>
					</div>
