<div class="uploaded-info" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
	...
	<div class="right">
		<a class="uploaded-actionlink" href="<%=fileUrlInMiic%>" id="doc-download-btn" target="_blank"> 
			<span class="mr-2">
		...
		<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=miicCounter%>')">
    ...
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="miicDeleteDocumentForGeneric('<%=uploadedFile.getFileEntryId()%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
