...
public abstract class BaseAgricultureApplicationStagesResourceImpl
	implements AgricultureApplicationStagesResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-agriculture-app/v1.0/updateAgricultureApplicationStage' -d $'{"caseId": ___, "duration": ___, "stageEndDate": ___, "stageName": ___, "stageStartDate": ___, "status": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "AgricultureApplicationStages"
			)
		}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/updateAgricultureApplicationStage")
	@javax.ws.rs.POST
...
//	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseAgricultureApplicationStagesResourceImpl.class);
