...
public abstract class BaseAgricultureApplicationPermitResourceImpl
	implements AgricultureApplicationPermitResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-agriculture-app/v1.0/updateAgricultureApplicationPermit/{caseId}'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "AgricultureApplicationPermit"
			)
		}
	)
	@javax.ws.rs.Consumes("multipart/form-data")
	@javax.ws.rs.Path("/updateAgricultureApplicationPermit/{caseId}")
	@javax.ws.rs.POST
	...
	public AgricultureApplicationPermit updateAgricultureApplicationPermit(
			...
			String caseId,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("pirPermtNumber")
			String pirPermtNumber,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("dateofIssue")
			Date dateofIssue,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("dateOfExpiration")
			Date dateOfExpiration,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("durationOfPermit")
	...
	protected <T, R> List<R> transform(
		Collection<T> collection, UnsafeFunction<T, R, Exception> unsafeFunction) {
...
//	}
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(
			BaseAgricultureApplicationPermitResourceImpl.class);
