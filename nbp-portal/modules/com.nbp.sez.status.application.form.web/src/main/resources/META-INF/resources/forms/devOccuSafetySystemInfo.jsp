<%
String devOccuSafetySystemVal="";
devOccuSafetySystemVal = (String)request.getAttribute("devOccuSafetySystemVal");
%>
<tr class="dev-occ-safety-system-row<%=devOccuSafetySystemVal%>">
	<td class="sub_heading_content occuSafetySystem<%=devOccuSafetySystemVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devOccuSafetySystemId<%=devOccuSafetySystemVal%>"  name="devOccuSafetySystemId<%=devOccuSafetySystemVal%>" value="">