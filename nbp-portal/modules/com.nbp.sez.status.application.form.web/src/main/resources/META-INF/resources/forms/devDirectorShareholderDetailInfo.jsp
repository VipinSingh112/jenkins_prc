<%
String devDirectorShareholderVal="";
devDirectorShareholderVal = (String)request.getAttribute("devDirectorShareholderVal");
%>
<tr class="dev-director-shareholder-row<%=devDirectorShareholderVal%>">
	<td class="sub_heading_content principalShareholderName<%=devDirectorShareholderVal%>"></td>
	<td class="sub_heading_content principalShareholderShares<%=devDirectorShareholderVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devDirectorShareholderId<%=devDirectorShareholderVal%>"  name="devDirectorShareholderId<%=devDirectorShareholderVal%>" value="">