<%
String devOperatingZoneLocationVal="";
devOperatingZoneLocationVal = (String)request.getAttribute("devOperatingZoneLocationVal");
%>
<tr class="dev-operating-zone-location-row<%=devOperatingZoneLocationVal%>">
	<td class="sub_heading_content sezFreeCurrentZoneName<%=devOperatingZoneLocationVal%>"></td>
	<td class="sub_heading_content sezFreeCurrentZoneParish<%=devOperatingZoneLocationVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devOperatingZoneLocationId<%=devOperatingZoneLocationVal%>"  name="devOperatingZoneLocationId<%=devOperatingZoneLocationVal%>" value="">