<%
String devDirectorBankruptInvolveVal="";
devDirectorBankruptInvolveVal = (String)request.getAttribute("devDirectorBankruptInvolveVal");
%>
<tr class="dev-director-bankrupt-row<%=devDirectorBankruptInvolveVal%>">
	<td class="sub_heading_content comDirectorBankruptName<%=devDirectorBankruptInvolveVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devDirectorBankruptInvolveId<%=devDirectorBankruptInvolveVal%>"  name="devDirectorBankruptInvolveId<%=devDirectorBankruptInvolveVal%>" value="">