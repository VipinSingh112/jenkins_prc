...
<fieldset class="wizard-fieldset" id="SezStatusSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	<p class="supporting-document-title common-heading f1 mb-2">Supporting Documents</p>
	<p class="supporting-document-subtitle mandatory-doc-heading hide">Mandatory Documents (that may attract an expiry date)</p>
	<div id="documentList">
	</div>
	<div id="list-required-and non-required-documents"></div>
	<div class="generic-document">
		<p class="generic-heading">Additional Supporting Documents</p>
		<p>Upload additional supporting documents that you think would help in processing this application</p>
		<div class="right text-nowrap">
			<input type="file" id="sez-application-generic-upload" multiple=""
				name="<portlet:namespace/>sez-application-generic-upload"
				hidden="">
			<label class="custom-upload" for="sez-application-generic-upload"> <span class="mr-2">
					<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							d="M5 13H9C9.55 13 10 12.55 10 12V6.99997H11.59C12.48 6.99997 12.93 5.91997 12.3 5.28997L7.71 0.699971C7.32 0.309971 6.69 0.309971 6.3 0.699971L1.71 5.28997C1.08 5.91997 1.52 6.99997 2.41 6.99997H4V12C4 12.55 4.45 13 5 13ZM1 15H13C13.55 15 14 15.45 14 16C14 16.55 13.55 17 13 17H1C0.45 17 0 16.55 0 16C0 15.45 0.45 15 1 15Z"
							fill="#047247"></path>
					</svg> </span>Upload </label>
			<span id="sez-status-generic-file-chosen">or drag and drop from your computer</span>
		</div>
		<div id="uploaded-documents-container">
		 	...
		 	<% 
				...
				if(sezStatusApplicationId>0 && dlFileEntriesGeneric!=null){
					try{
						int docOfSezAdditionalCounter=1001;
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						...
						%>	
			<div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfSezAdditionalCounter%>">
				<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfSezAdditionalCounter%>">
						<%
						%>
						<div class="uploaded-info generic-doc" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
							<div class="left">
								<p class="uploaded-info-title" id="document-name<%=docOfSezAdditionalCounter%>"><%=uploadedFile.getFileName() %></p>
								<p class="uploaded-info-size" id="document-size"><%=uploadedFile.getSize() %></p>
							</div>
							<div class="right">
								<a class="uploaded-actionlink" href="<%=Validator.isNotNull(fileUrl)? fileUrl:""%>" id="doc-download-btn" target="_blank"> 
									<span class="mr-2">
										<svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=docOfSezAdditionalCounter%>')">
			...
			<input type="text" hidden id="fileUrl<%=docOfSezAdditionalCounter %>" value="<%=fileUrl %>"/>
							<%	
			docOfSezAdditionalCounter++;}
				}catch(Exception e){}}
			%> 
	</div>
	<div class="modal fade commonsavepopup" id="commonuploadpopup" data-keyboard="false" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
			<div class="modal-content">
				...
				<div class="modal-pic">
					<img src="http://localhost:8080/o/nbp-theme/images/popup.png" class="img-fluid">
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
								...
								<div class="col-md-6 mb-3">
									...
									<input type="date" class="form-control"
										...
										placeholder="#2345" max="2023-11-07">
								</div>
								<div class="col-md-6 mb-3">
									<p class="tab-form-main-heading">Expiry Date</p>
									<input type="date" class="form-control"
										id="<portlet:namespace/>expiryDate"
										placeholder="#2345" min="2023-11-09">
								</div>
								<div class="col-md-6 mb-3">
									<p class="tab-form-main-heading">Choose File</p>
									<div class="custom-file">
										<input type="file" class="custom-file-input" id="sezStatusEnrollDocuments"
											name="<portlet:namespace/>sezStatusEnrollDocuments">
						...
						<input type="hidden" id="sezStatusDocumentuploadCounter"
							name="sezStatusDocumentuploadCounter">
						<div class="col-md-12">
				...
				<div class="modal-footer border-0 d-flex justify-content-end">
					<div>
						<a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard"
							onclick="supportingDocumentUpload();">Submit<span class="ml-2"> </span> </a>
					</div>
				</div>
			</div>
		</div>
