<%
String devComDirectorVal="";
devComDirectorVal = (String)request.getAttribute("devComDirectorVal");
%>
<tr class="dev-com-director-row<%=devComDirectorVal%>">
	<td class="sub_heading_content comDirectorName<%=devComDirectorVal%>"></td>
	<td class="sub_heading_content comDirectorCompanyName<%=devComDirectorVal%>"></td>
	<td class="sub_heading_content comDirectorRelationship<%=devComDirectorVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devComDirectorId<%=devComDirectorVal%>"  name="devComDirectorId<%=devComDirectorVal%>" value="">