<%
String disasterMitigationPlanVal="";
disasterMitigationPlanVal = (String)request.getAttribute("disasterMitigationPlanVal");
%>
<tr class="dev-disaster-mitigation-plan-row<%=disasterMitigationPlanVal%>">
	<td class="sub_heading_content disasterMitigationPlan<%=disasterMitigationPlanVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="disasterMitigationPlanId<%=disasterMitigationPlanVal%>"  name="disasterMitigationPlanId<%=disasterMitigationPlanVal%>" value="">