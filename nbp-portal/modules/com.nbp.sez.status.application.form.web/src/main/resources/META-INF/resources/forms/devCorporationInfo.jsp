<%
String devCorporationVal="";
devCorporationVal = (String)request.getAttribute("devCorporationVal");
%>
<tr class="dev-corporation-row<%=devCorporationVal%>">
	<td class="sub_heading_content comCorporationPersonName<%=devCorporationVal%>"></td>
	<td class="sub_heading_content comCorporationName<%=devCorporationVal%>"></td>
	<td class="sub_heading_content comCorporationRelationship<%=devCorporationVal%>"></td>
	<td> 
		<span> 
...
<input type="hidden" id="devCorporationBusinessId<%=devCorporationVal%>"  name="devCorporationBusinessId<%=devCorporationVal%>" value="">