...
/**
 * Provides the local service interface for NcraInspection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcraInspectionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcraInspectionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncra.stages.services.service.impl.NcraInspectionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncra inspection local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcraInspectionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraInspection getInspectionByStatus_SlotBoooked_ApplicationId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcraInspection> getNcra_CaseIdApplicationId(
		String status, long ncraApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcraInspection> getNcra_CaseIdStatus(
		String caseId, String status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcraInspection> getNcra_StatusApplicationId(
		String status, long ncraApplicationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraInspection getNcraInspectionBy_CI(String caseId)
		throws NoSuchNcraInspectionException;
