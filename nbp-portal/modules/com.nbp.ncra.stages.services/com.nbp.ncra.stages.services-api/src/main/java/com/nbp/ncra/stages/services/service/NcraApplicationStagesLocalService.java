...
/**
 * Provides the local service interface for NcraApplicationStages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcraApplicationStagesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcraApplicationStagesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncra.stages.services.service.impl.NcraApplicationStagesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncra application stages local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcraApplicationStagesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplicationStages getNCRA_ByCI_SN(
			String caseId, String stageName)
		throws NoSuchNcraApplicationStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplicationStages getNCRA_ByCI_SN_SS(
			String caseId, String stageName, String stageStatus)
		throws NoSuchNcraApplicationStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplicationStages getNCRA_ByCI_SS(
	...
	public NcraApplicationStages updateNCRAAppStage(
		String caseId, String stageName, String stageStatus,
