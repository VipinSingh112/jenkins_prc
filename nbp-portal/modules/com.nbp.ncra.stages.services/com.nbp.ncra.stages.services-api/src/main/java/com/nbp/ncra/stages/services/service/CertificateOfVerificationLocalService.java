...
/**
 * Provides the local service interface for CertificateOfVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CertificateOfVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CertificateOfVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncra.stages.services.service.impl.CertificateOfVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the certificate of verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CertificateOfVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CertificateOfVerification getNcra_By_CaseId(String caseId)
	...
	public CertificateOfVerification updateNcraCertificateOfVerification(
