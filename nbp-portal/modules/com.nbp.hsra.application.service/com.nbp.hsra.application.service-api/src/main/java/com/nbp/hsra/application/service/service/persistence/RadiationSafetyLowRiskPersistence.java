...
/**
 * The persistence interface for the radiation safety low risk service.
 *
 * <p>
 ...
 * @see RadiationSafetyLowRiskUtil
 * @generated
 */
@ProviderType
public interface RadiationSafetyLowRiskPersistence
	extends BasePersistence<RadiationSafetyLowRisk> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RadiationSafetyLowRiskUtil} to access the radiation safety low risk persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<RadiationSafetyLowRisk> radiationSafetyLowRisks);
	 ...
	 */
	public java.util.List<RadiationSafetyLowRisk> findAll();
	 ...
	 */
	public java.util.List<RadiationSafetyLowRisk> findAll(int start, int end);
	...
	public java.util.List<RadiationSafetyLowRisk> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<RadiationSafetyLowRisk>
			orderByComparator);
