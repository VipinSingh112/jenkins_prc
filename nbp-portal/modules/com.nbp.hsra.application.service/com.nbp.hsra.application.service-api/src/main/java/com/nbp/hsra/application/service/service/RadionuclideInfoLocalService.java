...
/**
 * Provides the local service interface for RadionuclideInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RadionuclideInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RadionuclideInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadionuclideInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the radionuclide info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RadionuclideInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RadionuclideInfo addRadionuclideInfo(
	...
	public RadionuclideInfo createRadionuclideInfo(long radionuclideInfoId);
	...
	public RadionuclideInfo deleteRadionuclideInfo(long radionuclideInfoId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RadionuclideInfo deleteRadionuclideInfo(
		RadionuclideInfo radionuclideInfo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RadionuclideInfo fetchRadionuclideInfo(long radionuclideInfoId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RadionuclideInfo getHsraById(long hsraApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RadionuclideInfo getRadionuclideInfo(long radionuclideInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RadionuclideInfo> getRadionuclideInfos(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RadionuclideInfo updateRadionuclideInfo(
		RadionuclideInfo radionuclideInfo);
