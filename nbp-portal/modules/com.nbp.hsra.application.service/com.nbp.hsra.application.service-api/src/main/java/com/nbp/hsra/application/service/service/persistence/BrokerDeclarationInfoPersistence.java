...
/**
 * The persistence interface for the broker declaration info service.
 *
 * <p>
 ...
 * @see BrokerDeclarationInfoUtil
 * @generated
 */
@ProviderType
public interface BrokerDeclarationInfoPersistence
	extends BasePersistence<BrokerDeclarationInfo> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BrokerDeclarationInfoUtil} to access the broker declaration info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<BrokerDeclarationInfo> brokerDeclarationInfos);
	 ...
	 */
	public java.util.List<BrokerDeclarationInfo> findAll();
	 ...
	 */
	public java.util.List<BrokerDeclarationInfo> findAll(int start, int end);
	...
	public java.util.List<BrokerDeclarationInfo> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<BrokerDeclarationInfo>
			orderByComparator);
