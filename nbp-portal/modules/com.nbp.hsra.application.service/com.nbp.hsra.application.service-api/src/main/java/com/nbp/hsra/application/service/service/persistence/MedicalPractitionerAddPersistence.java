...
/**
 * The persistence interface for the medical practitioner add service.
 *
 * <p>
 ...
 * @see MedicalPractitionerAddUtil
 * @generated
 */
@ProviderType
public interface MedicalPractitionerAddPersistence
	extends BasePersistence<MedicalPractitionerAdd> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MedicalPractitionerAddUtil} to access the medical practitioner add persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<MedicalPractitionerAdd> findBygetHsraById(
	...
	public java.util.List<MedicalPractitionerAdd> findBygetHsraById(
		long hsraApplicationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MedicalPractitionerAdd>
			orderByComparator);
	...
	public MedicalPractitionerAdd findBygetHsraById_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<MedicalPractitionerAdd> orderByComparator)
	...
	public void cacheResult(
		java.util.List<MedicalPractitionerAdd> medicalPractitionerAdds);
	 ...
	 */
	public java.util.List<MedicalPractitionerAdd> findAll();
	 ...
	 */
	public java.util.List<MedicalPractitionerAdd> findAll(int start, int end);
