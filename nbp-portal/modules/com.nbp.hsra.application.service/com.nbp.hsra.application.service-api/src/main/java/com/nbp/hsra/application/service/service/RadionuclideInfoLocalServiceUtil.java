...
/**
 * Provides the local service utility for RadionuclideInfo. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.RadionuclideInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RadionuclideInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadionuclideInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RadionuclideInfo addRadionuclideInfo(
		RadionuclideInfo radionuclideInfo) {

		return getService().addRadionuclideInfo(radionuclideInfo);
	}
	 ...
	 */
	public static RadionuclideInfo createRadionuclideInfo(
		long radionuclideInfoId) {

		return getService().createRadionuclideInfo(radionuclideInfoId);
	}
	 ...
	 */
	public static RadionuclideInfo deleteRadionuclideInfo(
			long radionuclideInfoId)
		throws PortalException {

		return getService().deleteRadionuclideInfo(radionuclideInfoId);
	}
	...
	public static RadionuclideInfo deleteRadionuclideInfo(
		...
		return getService().deleteRadionuclideInfo(radionuclideInfo);
	}
	...
	public static RadionuclideInfo fetchRadionuclideInfo(
		long radionuclideInfoId) {

		return getService().fetchRadionuclideInfo(radionuclideInfoId);
	}
	...
	public static RadionuclideInfo getHsraById(long hsraApplicationId)
	 ...
	 * @throws PortalException if a radionuclide info with the primary key could not be found
	 */
	public static RadionuclideInfo getRadionuclideInfo(long radionuclideInfoId)
		throws PortalException {

		return getService().getRadionuclideInfo(radionuclideInfoId);
	}
	 ...
	 */
	public static List<RadionuclideInfo> getRadionuclideInfos(
		int start, int end) {

		return getService().getRadionuclideInfos(start, end);
	}
	 ...
	 */
	public static int getRadionuclideInfosCount() {
		return getService().getRadionuclideInfosCount();
	}
	 ...
	 */
	public static RadionuclideInfo updateRadionuclideInfo(
		RadionuclideInfo radionuclideInfo) {

		return getService().updateRadionuclideInfo(radionuclideInfo);
	}

	public static RadionuclideInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RadionuclideInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			RadionuclideInfoLocalServiceUtil.class,
			RadionuclideInfoLocalService.class);
