...
/**
 * Provides the local service interface for SourcesDetailAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SourcesDetailAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SourcesDetailAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.SourcesDetailAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sources detail add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SourcesDetailAddLocalServiceUtil} if injection and service tracking are not available.
	 */
