...
/**
 * Provides the local service utility for QualityDeclarationInfo. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.QualityDeclarationInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class QualityDeclarationInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.QualityDeclarationInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static QualityDeclarationInfo addQualityDeclarationInfo(
		QualityDeclarationInfo qualityDeclarationInfo) {

		return getService().addQualityDeclarationInfo(qualityDeclarationInfo);
	}
	 ...
	 */
	public static QualityDeclarationInfo createQualityDeclarationInfo(
		long qualityDeclarationInfoId) {

		return getService().createQualityDeclarationInfo(
	 ...
	 */
	public static QualityDeclarationInfo deleteQualityDeclarationInfo(
			long qualityDeclarationInfoId)
		throws PortalException {

		return getService().deleteQualityDeclarationInfo(
			qualityDeclarationInfoId);
	}
	...
	public static QualityDeclarationInfo fetchQualityDeclarationInfo(
		long qualityDeclarationInfoId) {

		return getService().fetchQualityDeclarationInfo(
			qualityDeclarationInfoId);
	}
	...
	public static QualityDeclarationInfo getHsraById(long hsraApplicationId)
	 ...
	 * @throws PortalException if a quality declaration info with the primary key could not be found
	 */
	public static QualityDeclarationInfo getQualityDeclarationInfo(
			long qualityDeclarationInfoId)
		throws PortalException {

		return getService().getQualityDeclarationInfo(qualityDeclarationInfoId);
	}
	 ...
	 */
	public static List<QualityDeclarationInfo> getQualityDeclarationInfos(
		int start, int end) {

		return getService().getQualityDeclarationInfos(start, end);
	}
	 ...
	 */
	public static int getQualityDeclarationInfosCount() {
		return getService().getQualityDeclarationInfosCount();
	}
	 ...
	 */
	public static QualityDeclarationInfo updateQualityDeclarationInfo(
		QualityDeclarationInfo qualityDeclarationInfo) {

		return getService().updateQualityDeclarationInfo(
			qualityDeclarationInfo);
	}

	public static QualityDeclarationInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<QualityDeclarationInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			QualityDeclarationInfoLocalServiceUtil.class,
