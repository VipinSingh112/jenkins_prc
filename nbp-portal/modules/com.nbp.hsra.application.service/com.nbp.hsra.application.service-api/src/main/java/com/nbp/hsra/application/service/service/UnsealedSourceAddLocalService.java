...
/**
 * Provides the local service interface for UnsealedSourceAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UnsealedSourceAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UnsealedSourceAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.UnsealedSourceAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the unsealed source add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UnsealedSourceAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UnsealedSourceAdd addUnsealedSourceAdd(
	...
	public UnsealedSourceAdd createUnsealedSourceAdd(long unsealedSourceAddId);
	...
	public UnsealedSourceAdd deleteUnsealedSourceAdd(long unsealedSourceAddId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UnsealedSourceAdd deleteUnsealedSourceAdd(
		UnsealedSourceAdd unsealedSourceAdd);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UnsealedSourceAdd fetchUnsealedSourceAdd(long unsealedSourceAddId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UnsealedSourceAdd> getHsraById(long hsraApplicationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UnsealedSourceAdd getUnsealedSourceAdd(long unsealedSourceAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UnsealedSourceAdd> getUnsealedSourceAdds(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UnsealedSourceAdd updateUnsealedSourceAdd(
		UnsealedSourceAdd unsealedSourceAdd);
