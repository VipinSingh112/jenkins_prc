...
/**
 * Provides the local service utility for MedicalPractitionerAdd. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.MedicalPractitionerAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MedicalPractitionerAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.MedicalPractitionerAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MedicalPractitionerAdd addMedicalPractitionerAdd(
		MedicalPractitionerAdd medicalPractitionerAdd) {

		return getService().addMedicalPractitionerAdd(medicalPractitionerAdd);
	}
	 ...
	 */
	public static MedicalPractitionerAdd createMedicalPractitionerAdd(
		long medicalPractitionerAddId) {

		return getService().createMedicalPractitionerAdd(
	 ...
	 */
	public static MedicalPractitionerAdd deleteMedicalPractitionerAdd(
			long medicalPractitionerAddId)
		throws PortalException {

		return getService().deleteMedicalPractitionerAdd(
			medicalPractitionerAddId);
	}
	...
	public static MedicalPractitionerAdd fetchMedicalPractitionerAdd(
		long medicalPractitionerAddId) {

		return getService().fetchMedicalPractitionerAdd(
			medicalPractitionerAddId);
	}
	...
	public static List<MedicalPractitionerAdd> getHsraById(
	 ...
	 * @throws PortalException if a medical practitioner add with the primary key could not be found
	 */
	public static MedicalPractitionerAdd getMedicalPractitionerAdd(
			long medicalPractitionerAddId)
		throws PortalException {

		return getService().getMedicalPractitionerAdd(medicalPractitionerAddId);
	}
	 ...
	 */
	public static List<MedicalPractitionerAdd> getMedicalPractitionerAdds(
		int start, int end) {

		return getService().getMedicalPractitionerAdds(start, end);
	}
	 ...
	 */
	public static int getMedicalPractitionerAddsCount() {
		return getService().getMedicalPractitionerAddsCount();
	}
	 ...
	 */
	public static MedicalPractitionerAdd updateMedicalPractitionerAdd(
		MedicalPractitionerAdd medicalPractitionerAdd) {

		return getService().updateMedicalPractitionerAdd(
			medicalPractitionerAdd);
	}

	public static MedicalPractitionerAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MedicalPractitionerAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			MedicalPractitionerAddLocalServiceUtil.class,
			MedicalPractitionerAddLocalService.class);
