...
/**
 * Provides the local service utility for DetailOfSources. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.DetailOfSourcesLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DetailOfSourcesLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.DetailOfSourcesLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DetailOfSources addDetailOfSources(
		DetailOfSources detailOfSources) {

		return getService().addDetailOfSources(detailOfSources);
	}
	 ...
	 */
	public static DetailOfSources createDetailOfSources(
		long detailOfSourcesId) {

		return getService().createDetailOfSources(detailOfSourcesId);
	}
	 ...
	 */
	public static DetailOfSources deleteDetailOfSources(
		DetailOfSources detailOfSources) {

		return getService().deleteDetailOfSources(detailOfSources);
	}
	 ...
	 */
	public static DetailOfSources deleteDetailOfSources(long detailOfSourcesId)
		throws PortalException {

		return getService().deleteDetailOfSources(detailOfSourcesId);
	}
	...
	public static DetailOfSources fetchDetailOfSources(long detailOfSourcesId) {
		return getService().fetchDetailOfSources(detailOfSourcesId);
	}
	 ...
	 * @throws PortalException if a detail of sources with the primary key could not be found
	 */
	public static DetailOfSources getDetailOfSources(long detailOfSourcesId)
		throws PortalException {

		return getService().getDetailOfSources(detailOfSourcesId);
	}
	 ...
	 */
	public static List<DetailOfSources> getDetailOfSourceses(
		int start, int end) {

		return getService().getDetailOfSourceses(start, end);
	}
	 ...
	 */
	public static int getDetailOfSourcesesCount() {
		return getService().getDetailOfSourcesesCount();
	}

	public static DetailOfSources getHsraById(long hsraApplicationId)
	 ...
	 */
	public static DetailOfSources updateDetailOfSources(
		DetailOfSources detailOfSources) {

		return getService().updateDetailOfSources(detailOfSources);
	}

	public static DetailOfSourcesLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<DetailOfSourcesLocalService>
		_serviceSnapshot = new Snapshot<>(
			DetailOfSourcesLocalServiceUtil.class,
			DetailOfSourcesLocalService.class);
