...
/**
 * Provides the local service utility for QualityApplicantDetail. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.QualityApplicantDetailLocalServiceImpl</code> and
 ...
 * @generated
 */
public class QualityApplicantDetailLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.QualityApplicantDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static QualityApplicantDetail addQualityApplicantDetail(
		QualityApplicantDetail qualityApplicantDetail) {

		return getService().addQualityApplicantDetail(qualityApplicantDetail);
	}
	 ...
	 */
	public static QualityApplicantDetail createQualityApplicantDetail(
		long qualityApplicantDetailId) {

		return getService().createQualityApplicantDetail(
	 ...
	 */
	public static QualityApplicantDetail deleteQualityApplicantDetail(
			long qualityApplicantDetailId)
		throws PortalException {

		return getService().deleteQualityApplicantDetail(
			qualityApplicantDetailId);
	}
	...
	public static QualityApplicantDetail fetchQualityApplicantDetail(
		long qualityApplicantDetailId) {

		return getService().fetchQualityApplicantDetail(
			qualityApplicantDetailId);
	}
	...
	public static QualityApplicantDetail getHsraById(long hsraApplicationId)
	 ...
	 * @throws PortalException if a quality applicant detail with the primary key could not be found
	 */
	public static QualityApplicantDetail getQualityApplicantDetail(
			long qualityApplicantDetailId)
		throws PortalException {

		return getService().getQualityApplicantDetail(qualityApplicantDetailId);
	}
	 ...
	 */
	public static List<QualityApplicantDetail> getQualityApplicantDetails(
		int start, int end) {

		return getService().getQualityApplicantDetails(start, end);
	}
	 ...
	 */
	public static int getQualityApplicantDetailsCount() {
		return getService().getQualityApplicantDetailsCount();
	}
	 ...
	 */
	public static QualityApplicantDetail updateQualityApplicantDetail(
		QualityApplicantDetail qualityApplicantDetail) {

		return getService().updateQualityApplicantDetail(
			qualityApplicantDetail);
	}

	public static QualityApplicantDetailLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<QualityApplicantDetailLocalService>
		_serviceSnapshot = new Snapshot<>(
			QualityApplicantDetailLocalServiceUtil.class,
			QualityApplicantDetailLocalService.class);
