...
/**
 * Provides the local service utility for HsraApplicationCurrentStage. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HsraApplicationCurrentStageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HsraApplicationCurrentStage addHsraApplicationCurrentStage(
		HsraApplicationCurrentStage hsraApplicationCurrentStage) {

		return getService().addHsraApplicationCurrentStage(
	 ...
	 */
	public static HsraApplicationCurrentStage createHsraApplicationCurrentStage(
		long hsraApplicationCurrentStageId) {

		return getService().createHsraApplicationCurrentStage(
	 ...
	 */
	public static HsraApplicationCurrentStage deleteHsraApplicationCurrentStage(
		HsraApplicationCurrentStage hsraApplicationCurrentStage) {

		return getService().deleteHsraApplicationCurrentStage(
			hsraApplicationCurrentStage);
	}
	...
	public static HsraApplicationCurrentStage fetchHsraApplicationCurrentStage(
		long hsraApplicationCurrentStageId) {

		return getService().fetchHsraApplicationCurrentStage(
			hsraApplicationCurrentStageId);
	}
	...
	public static HsraApplicationCurrentStage getHsra_Stage_HAI(
			long hsraApplicationId)
		throws com.nbp.hsra.application.service.exception.
			NoSuchHsraApplicationCurrentStageException {

		return getService().getHsra_Stage_HAI(hsraApplicationId);
	}
	 ...
	 * @throws PortalException if a hsra application current stage with the primary key could not be found
	 */
	public static HsraApplicationCurrentStage getHsraApplicationCurrentStage(
			long hsraApplicationCurrentStageId)
		throws PortalException {

		return getService().getHsraApplicationCurrentStage(
			hsraApplicationCurrentStageId);
	}
	 ...
	 */
	public static List<HsraApplicationCurrentStage>
		getHsraApplicationCurrentStages(int start, int end) {

		return getService().getHsraApplicationCurrentStages(start, end);
	}
	 ...
	 */
	public static int getHsraApplicationCurrentStagesCount() {
		return getService().getHsraApplicationCurrentStagesCount();
	}
	 ...
	 */
	public static HsraApplicationCurrentStage updateHsraApplicationCurrentStage(
		HsraApplicationCurrentStage hsraApplicationCurrentStage) {

		return getService().updateHsraApplicationCurrentStage(
			hsraApplicationCurrentStage);
	}

	public static HsraApplicationCurrentStageLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<HsraApplicationCurrentStageLocalService>
		_serviceSnapshot = new Snapshot<>(
			HsraApplicationCurrentStageLocalServiceUtil.class,
