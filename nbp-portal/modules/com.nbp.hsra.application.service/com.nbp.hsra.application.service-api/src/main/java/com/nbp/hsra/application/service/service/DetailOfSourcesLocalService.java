...
/**
 * Provides the local service interface for DetailOfSources. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DetailOfSourcesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DetailOfSourcesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.DetailOfSourcesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the detail of sources local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DetailOfSourcesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DetailOfSources addDetailOfSources(DetailOfSources detailOfSources);
	...
	public DetailOfSources createDetailOfSources(long detailOfSourcesId);
	...
	public DetailOfSources deleteDetailOfSources(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DetailOfSources deleteDetailOfSources(long detailOfSourcesId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DetailOfSources fetchDetailOfSources(long detailOfSourcesId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DetailOfSources getDetailOfSources(long detailOfSourcesId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DetailOfSources> getDetailOfSourceses(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DetailOfSources getHsraById(long hsraApplicationId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DetailOfSources updateDetailOfSources(
		DetailOfSources detailOfSources);
