...
/**
 * Provides the local service interface for RadiationDevicesDetailAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RadiationDevicesDetailAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RadiationDevicesDetailAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadiationDevicesDetailAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the radiation devices detail add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RadiationDevicesDetailAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RadiationDevicesDetailAdd addRadiationDevicesDetailAdd(
	...
	public RadiationDevicesDetailAdd createRadiationDevicesDetailAdd(
	...
	public RadiationDevicesDetailAdd deleteRadiationDevicesDetailAdd(
			long radiationDevicesDetailAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RadiationDevicesDetailAdd fetchRadiationDevicesDetailAdd(
		long radiationDevicesDetailAddId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RadiationDevicesDetailAdd getRadiationDevicesDetailAdd(
			long radiationDevicesDetailAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RadiationDevicesDetailAdd> getRadiationDevicesDetailAdds(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RadiationDevicesDetailAdd updateRadiationDevicesDetailAdd(
		RadiationDevicesDetailAdd radiationDevicesDetailAdd);
