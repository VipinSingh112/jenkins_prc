...
/**
 * The persistence interface for the qualifed expert one add service.
 *
 * <p>
 ...
 * @see QualifedExpertOneAddUtil
 * @generated
 */
@ProviderType
public interface QualifedExpertOneAddPersistence
	extends BasePersistence<QualifedExpertOneAdd> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QualifedExpertOneAddUtil} to access the qualifed expert one add persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<QualifedExpertOneAdd> findBygetHsraById(
	...
	public java.util.List<QualifedExpertOneAdd> findBygetHsraById(
		long hsraApplicationId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<QualifedExpertOneAdd>
			orderByComparator);
	...
	public QualifedExpertOneAdd findBygetHsraById_First(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<QualifedExpertOneAdd> orderByComparator)
	...
	public void cacheResult(
		java.util.List<QualifedExpertOneAdd> qualifedExpertOneAdds);
	 ...
	 */
	public java.util.List<QualifedExpertOneAdd> findAll();
	 ...
	 */
	public java.util.List<QualifedExpertOneAdd> findAll(int start, int end);
