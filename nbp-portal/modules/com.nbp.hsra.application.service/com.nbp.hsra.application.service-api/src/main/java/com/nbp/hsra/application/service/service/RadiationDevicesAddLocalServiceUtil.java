...
/**
 * Provides the local service utility for RadiationDevicesAdd. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.RadiationDevicesAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RadiationDevicesAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadiationDevicesAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RadiationDevicesAdd addRadiationDevicesAdd(
		RadiationDevicesAdd radiationDevicesAdd) {

		return getService().addRadiationDevicesAdd(radiationDevicesAdd);
	}
	 ...
	 */
	public static RadiationDevicesAdd createRadiationDevicesAdd(
		long radiationDevicesAddId) {

		return getService().createRadiationDevicesAdd(radiationDevicesAddId);
	}
	 ...
	 */
	public static RadiationDevicesAdd deleteRadiationDevicesAdd(
			long radiationDevicesAddId)
		throws PortalException {

		return getService().deleteRadiationDevicesAdd(radiationDevicesAddId);
	}
	...
	public static RadiationDevicesAdd deleteRadiationDevicesAdd(
		...
		return getService().deleteRadiationDevicesAdd(radiationDevicesAdd);
	}
	...
	public static RadiationDevicesAdd fetchRadiationDevicesAdd(
		long radiationDevicesAddId) {

		return getService().fetchRadiationDevicesAdd(radiationDevicesAddId);
	}
	...
	public static List<RadiationDevicesAdd> getHsraById(
	 ...
	 * @throws PortalException if a radiation devices add with the primary key could not be found
	 */
	public static RadiationDevicesAdd getRadiationDevicesAdd(
			long radiationDevicesAddId)
		throws PortalException {

		return getService().getRadiationDevicesAdd(radiationDevicesAddId);
	}
	 ...
	 */
	public static List<RadiationDevicesAdd> getRadiationDevicesAdds(
		int start, int end) {

		return getService().getRadiationDevicesAdds(start, end);
	}
	 ...
	 */
	public static int getRadiationDevicesAddsCount() {
		return getService().getRadiationDevicesAddsCount();
	}
	 ...
	 */
	public static RadiationDevicesAdd updateRadiationDevicesAdd(
		RadiationDevicesAdd radiationDevicesAdd) {

		return getService().updateRadiationDevicesAdd(radiationDevicesAdd);
	}

	public static RadiationDevicesAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RadiationDevicesAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			RadiationDevicesAddLocalServiceUtil.class,
