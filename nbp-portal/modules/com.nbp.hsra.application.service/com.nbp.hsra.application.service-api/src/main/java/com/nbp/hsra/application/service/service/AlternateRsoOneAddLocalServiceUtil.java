...
/**
 * Provides the local service utility for AlternateRsoOneAdd. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.AlternateRsoOneAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AlternateRsoOneAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.AlternateRsoOneAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AlternateRsoOneAdd addAlternateRsoOneAdd(
		AlternateRsoOneAdd alternateRsoOneAdd) {

		return getService().addAlternateRsoOneAdd(alternateRsoOneAdd);
	}
	 ...
	 */
	public static AlternateRsoOneAdd createAlternateRsoOneAdd(
		long alternateRsoOneAddId) {

		return getService().createAlternateRsoOneAdd(alternateRsoOneAddId);
	}
	 ...
	 */
	public static AlternateRsoOneAdd deleteAlternateRsoOneAdd(
		AlternateRsoOneAdd alternateRsoOneAdd) {

		return getService().deleteAlternateRsoOneAdd(alternateRsoOneAdd);
	}
	...
	public static AlternateRsoOneAdd deleteAlternateRsoOneAdd(
		...
		return getService().deleteAlternateRsoOneAdd(alternateRsoOneAddId);
	}
	...
	public static AlternateRsoOneAdd fetchAlternateRsoOneAdd(
		long alternateRsoOneAddId) {

		return getService().fetchAlternateRsoOneAdd(alternateRsoOneAddId);
	}
	 ...
	 * @throws PortalException if a alternate rso one add with the primary key could not be found
	 */
	public static AlternateRsoOneAdd getAlternateRsoOneAdd(
			long alternateRsoOneAddId)
		throws PortalException {

		return getService().getAlternateRsoOneAdd(alternateRsoOneAddId);
	}
	 ...
	 */
	public static List<AlternateRsoOneAdd> getAlternateRsoOneAdds(
		int start, int end) {

		return getService().getAlternateRsoOneAdds(start, end);
	}
	 ...
	 */
	public static int getAlternateRsoOneAddsCount() {
		return getService().getAlternateRsoOneAddsCount();
	}

	public static List<AlternateRsoOneAdd> getHsraById(long hsraApplicationId) {
	 ...
	 */
	public static AlternateRsoOneAdd updateAlternateRsoOneAdd(
		AlternateRsoOneAdd alternateRsoOneAdd) {

		return getService().updateAlternateRsoOneAdd(alternateRsoOneAdd);
	}

	public static AlternateRsoOneAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AlternateRsoOneAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			AlternateRsoOneAddLocalServiceUtil.class,
			AlternateRsoOneAddLocalService.class);
