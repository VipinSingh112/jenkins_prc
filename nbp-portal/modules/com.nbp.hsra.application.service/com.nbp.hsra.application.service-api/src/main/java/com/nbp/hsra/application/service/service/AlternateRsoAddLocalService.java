...
/**
 * Provides the local service interface for AlternateRsoAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AlternateRsoAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AlternateRsoAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.AlternateRsoAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the alternate rso add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AlternateRsoAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AlternateRsoAdd addAlternateRsoAdd(AlternateRsoAdd alternateRsoAdd);
	...
	public AlternateRsoAdd createAlternateRsoAdd(long alternateRsoAddId);
	...
	public AlternateRsoAdd deleteAlternateRsoAdd(
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AlternateRsoAdd deleteAlternateRsoAdd(long alternateRsoAddId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AlternateRsoAdd fetchAlternateRsoAdd(long alternateRsoAddId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AlternateRsoAdd getAlternateRsoAdd(long alternateRsoAddId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AlternateRsoAdd> getAlternateRsoAdds(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AlternateRsoAdd> getHsraById(long hsraApplicationId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AlternateRsoAdd updateAlternateRsoAdd(
		AlternateRsoAdd alternateRsoAdd);
