...
/**
 * Provides the local service interface for RadiationDevicesAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RadiationDevicesAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RadiationDevicesAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadiationDevicesAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the radiation devices add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RadiationDevicesAddLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RadiationDevicesAdd> getHsraById(long hsraApplicationId);
