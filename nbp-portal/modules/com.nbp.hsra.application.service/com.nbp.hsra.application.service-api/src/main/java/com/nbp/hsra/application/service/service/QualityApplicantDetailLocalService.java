...
/**
 * Provides the local service interface for QualityApplicantDetail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see QualityApplicantDetailLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface QualityApplicantDetailLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.QualityApplicantDetailLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the quality applicant detail local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link QualityApplicantDetailLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public QualityApplicantDetail addQualityApplicantDetail(
	...
	public QualityApplicantDetail createQualityApplicantDetail(
	...
	public QualityApplicantDetail deleteQualityApplicantDetail(
			long qualityApplicantDetailId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QualityApplicantDetail fetchQualityApplicantDetail(
		long qualityApplicantDetailId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QualityApplicantDetail getHsraById(long hsraApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public QualityApplicantDetail getQualityApplicantDetail(
			long qualityApplicantDetailId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<QualityApplicantDetail> getQualityApplicantDetails(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public QualityApplicantDetail updateQualityApplicantDetail(
		QualityApplicantDetail qualityApplicantDetail);
