...
/**
 * Provides the local service utility for RadiationDeclaration. This utility wraps
 * <code>com.nbp.hsra.application.service.service.impl.RadiationDeclarationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RadiationDeclarationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.hsra.application.service.service.impl.RadiationDeclarationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RadiationDeclaration addRadiationDeclaration(
		RadiationDeclaration radiationDeclaration) {

		return getService().addRadiationDeclaration(radiationDeclaration);
	}
	 ...
	 */
	public static RadiationDeclaration createRadiationDeclaration(
		long radiationDeclarationId) {

		return getService().createRadiationDeclaration(radiationDeclarationId);
	}
	 ...
	 */
	public static RadiationDeclaration deleteRadiationDeclaration(
			long radiationDeclarationId)
		throws PortalException {

		return getService().deleteRadiationDeclaration(radiationDeclarationId);
	}
	...
	public static RadiationDeclaration deleteRadiationDeclaration(
		...
		return getService().deleteRadiationDeclaration(radiationDeclaration);
	}
	...
	public static RadiationDeclaration fetchRadiationDeclaration(
		long radiationDeclarationId) {

		return getService().fetchRadiationDeclaration(radiationDeclarationId);
	}
	...
	public static RadiationDeclaration getHsraById(long hsraApplicationId)
	 ...
	 * @throws PortalException if a radiation declaration with the primary key could not be found
	 */
	public static RadiationDeclaration getRadiationDeclaration(
			long radiationDeclarationId)
		throws PortalException {

		return getService().getRadiationDeclaration(radiationDeclarationId);
	}
	 ...
	 */
	public static List<RadiationDeclaration> getRadiationDeclarations(
		int start, int end) {

		return getService().getRadiationDeclarations(start, end);
	}
	 ...
	 */
	public static int getRadiationDeclarationsCount() {
		return getService().getRadiationDeclarationsCount();
	}
	 ...
	 */
	public static RadiationDeclaration updateRadiationDeclaration(
		RadiationDeclaration radiationDeclaration) {

		return getService().updateRadiationDeclaration(radiationDeclaration);
	}

	public static RadiationDeclarationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<RadiationDeclarationLocalService>
		_serviceSnapshot = new Snapshot<>(
			RadiationDeclarationLocalServiceUtil.class,
