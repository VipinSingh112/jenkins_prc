...
/**
 * The persistence utility for the fit prop financial profile service. This utility wraps <code>com.nbp.hsra.application.service.service.persistence.impl.FitPropFinancialProfilePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FitPropFinancialProfilePersistence
 * @generated
 */
public class FitPropFinancialProfileUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(fitPropFinancialProfile);
	}
	 ...
	 */
	public static Map<Serializable, FitPropFinancialProfile> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FitPropFinancialProfile> findWithDynamicQuery(
	 ...
	 */
	public static FitPropFinancialProfile update(
		FitPropFinancialProfile fitPropFinancialProfile) {

		return getPersistence().update(fitPropFinancialProfile);
	}
	...
	public static FitPropFinancialProfile update(
		...
		return getPersistence().update(fitPropFinancialProfile, serviceContext);
	}
	 ...
	 */
	public static FitPropFinancialProfile findBygetHsraById(
	 ...
	 */
	public static FitPropFinancialProfile fetchBygetHsraById(
		long hsraApplicationId) {
	 ...
	 */
	public static FitPropFinancialProfile removeBygetHsraById(
			long hsraApplicationId)
		throws com.nbp.hsra.application.service.exception.
			NoSuchFitPropFinancialProfileException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fitPropFinancialProfile);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(fitPropFinancialProfiles);
	}
	 ...
	 */
	public static FitPropFinancialProfile create(
		long fitPropFinancialProfileId) {

		return getPersistence().create(fitPropFinancialProfileId);
	}
	 ...
	 */
	public static FitPropFinancialProfile remove(long fitPropFinancialProfileId)
		throws com.nbp.hsra.application.service.exception.
			NoSuchFitPropFinancialProfileException {

		return getPersistence().remove(fitPropFinancialProfileId);
	}

	public static FitPropFinancialProfile updateImpl(
		FitPropFinancialProfile fitPropFinancialProfile) {

		return getPersistence().updateImpl(fitPropFinancialProfile);
	}
	 ...
	 * @throws NoSuchFitPropFinancialProfileException if a fit prop financial profile with the primary key could not be found
	 */
	public static FitPropFinancialProfile findByPrimaryKey(
			long fitPropFinancialProfileId)
		throws com.nbp.hsra.application.service.exception.
			NoSuchFitPropFinancialProfileException {

		return getPersistence().findByPrimaryKey(fitPropFinancialProfileId);
	}
	 ...
	 */
	public static FitPropFinancialProfile fetchByPrimaryKey(
		long fitPropFinancialProfileId) {

		return getPersistence().fetchByPrimaryKey(fitPropFinancialProfileId);
	}
	 ...
	 */
	public static List<FitPropFinancialProfile> findAll() {
	 ...
	 */
	public static List<FitPropFinancialProfile> findAll(int start, int end) {
	...
	public static FitPropFinancialProfilePersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FitPropFinancialProfilePersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FitPropFinancialProfilePersistence _persistence;
