...
import com.nbp.hsra.application.service.service.DetailOfApplicantSecTwoService;
...
/**
 * Provides the base implementation for the detail of applicant sec two remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.DetailOfApplicantSecTwoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.DetailOfApplicantSecTwoServiceImpl
 * @generated
 */
public abstract class DetailOfApplicantSecTwoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DetailOfApplicantSecTwoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DetailOfApplicantSecTwoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.DetailOfApplicantSecTwoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DetailOfApplicantSecTwoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		detailOfApplicantSecTwoService =
			(DetailOfApplicantSecTwoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DetailOfApplicantSecTwoService.class.getName();
	}
	...
	protected DetailOfApplicantSecTwoService detailOfApplicantSecTwoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DetailOfApplicantSecTwoServiceBaseImpl.class);
