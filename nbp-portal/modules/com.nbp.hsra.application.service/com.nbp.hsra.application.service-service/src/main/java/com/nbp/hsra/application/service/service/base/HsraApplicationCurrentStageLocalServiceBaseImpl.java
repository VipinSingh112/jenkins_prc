...
import com.nbp.hsra.application.service.service.HsraApplicationCurrentStageLocalService;
...
/**
 * Provides the base implementation for the hsra application current stage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageLocalServiceImpl
 * @generated
 */
public abstract class HsraApplicationCurrentStageLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HsraApplicationCurrentStageLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationCurrentStageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationCurrentStageLocalServiceUtil</code>.
	 */
	...
	@Override
	public HsraApplicationCurrentStage addHsraApplicationCurrentStage(
		HsraApplicationCurrentStage hsraApplicationCurrentStage) {

		hsraApplicationCurrentStage.setNew(true);

		return hsraApplicationCurrentStagePersistence.update(
	...
	public HsraApplicationCurrentStage createHsraApplicationCurrentStage(
		long hsraApplicationCurrentStageId) {

		return hsraApplicationCurrentStagePersistence.create(
	...
	@Override
	public HsraApplicationCurrentStage deleteHsraApplicationCurrentStage(
			long hsraApplicationCurrentStageId)
		throws PortalException {

		return hsraApplicationCurrentStagePersistence.remove(
			hsraApplicationCurrentStageId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return hsraApplicationCurrentStagePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HsraApplicationCurrentStage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hsraApplicationCurrentStagePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hsraApplicationCurrentStagePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public HsraApplicationCurrentStage fetchHsraApplicationCurrentStage(
		long hsraApplicationCurrentStageId) {

		return hsraApplicationCurrentStagePersistence.fetchByPrimaryKey(
			hsraApplicationCurrentStageId);
	}
	 ...
	 */
	@Override
	public HsraApplicationCurrentStage getHsraApplicationCurrentStage(
			long hsraApplicationCurrentStageId)
		throws PortalException {

		return hsraApplicationCurrentStagePersistence.findByPrimaryKey(
			hsraApplicationCurrentStageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(HsraApplicationCurrentStage.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			HsraApplicationCurrentStage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement HsraApplicationCurrentStageLocalServiceImpl#deleteHsraApplicationCurrentStage(HsraApplicationCurrentStage) to avoid orphaned data");
		}

		return hsraApplicationCurrentStageLocalService.
			deleteHsraApplicationCurrentStage(
				(HsraApplicationCurrentStage)persistedModel);
	}

	@Override
	public BasePersistence<HsraApplicationCurrentStage> getBasePersistence() {
		return hsraApplicationCurrentStagePersistence;
	}
	 ...
	 */
	@Override
	public List<HsraApplicationCurrentStage> getHsraApplicationCurrentStages(
		int start, int end) {

		return hsraApplicationCurrentStagePersistence.findAll(start, end);
	}
	...
	public int getHsraApplicationCurrentStagesCount() {
		return hsraApplicationCurrentStagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HsraApplicationCurrentStage updateHsraApplicationCurrentStage(
		HsraApplicationCurrentStage hsraApplicationCurrentStage) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HsraApplicationCurrentStageLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		hsraApplicationCurrentStageLocalService =
			(HsraApplicationCurrentStageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationCurrentStageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				hsraApplicationCurrentStagePersistence.getDataSource();
	...
	protected HsraApplicationCurrentStageLocalService
		hsraApplicationCurrentStageLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationCurrentStageLocalServiceBaseImpl.class);
