...
import com.nbp.hsra.application.service.service.RadiationDevicesAddService;
...
/**
 * Provides the base implementation for the radiation devices add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationDevicesAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationDevicesAddServiceImpl
 * @generated
 */
public abstract class RadiationDevicesAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RadiationDevicesAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationDevicesAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationDevicesAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadiationDevicesAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radiationDevicesAddService = (RadiationDevicesAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationDevicesAddService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.RadiationDevicesAddLocalService
			radiationDevicesAddLocalService;

	protected RadiationDevicesAddService radiationDevicesAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationDevicesAddServiceBaseImpl.class);
