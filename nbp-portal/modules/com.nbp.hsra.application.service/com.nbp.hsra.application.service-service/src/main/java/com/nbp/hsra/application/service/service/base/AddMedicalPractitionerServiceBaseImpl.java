...
import com.nbp.hsra.application.service.service.AddMedicalPractitionerService;
...
/**
 * Provides the base implementation for the add medical practitioner remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.AddMedicalPractitionerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.AddMedicalPractitionerServiceImpl
 * @generated
 */
public abstract class AddMedicalPractitionerServiceBaseImpl
	extends BaseServiceImpl
	implements AddMedicalPractitionerService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddMedicalPractitionerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.AddMedicalPractitionerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddMedicalPractitionerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addMedicalPractitionerService = (AddMedicalPractitionerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddMedicalPractitionerService.class.getName();
	}
	...
	protected AddMedicalPractitionerService addMedicalPractitionerService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddMedicalPractitionerServiceBaseImpl.class);
