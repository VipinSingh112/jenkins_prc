...
import com.nbp.hsra.application.service.service.RadionuclideInfoService;
...
/**
 * Provides the base implementation for the radionuclide info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadionuclideInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadionuclideInfoServiceImpl
 * @generated
 */
public abstract class RadionuclideInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RadionuclideInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadionuclideInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadionuclideInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadionuclideInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radionuclideInfoService = (RadionuclideInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadionuclideInfoService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.RadionuclideInfoLocalService
			radionuclideInfoLocalService;

	protected RadionuclideInfoService radionuclideInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadionuclideInfoServiceBaseImpl.class);
