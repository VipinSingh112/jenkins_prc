...
import com.nbp.hsra.application.service.service.RadiationSafetyProgramService;
...
/**
 * Provides the base implementation for the radiation safety program remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationSafetyProgramServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationSafetyProgramServiceImpl
 * @generated
 */
public abstract class RadiationSafetyProgramServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RadiationSafetyProgramService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationSafetyProgramService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationSafetyProgramServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadiationSafetyProgramService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radiationSafetyProgramService = (RadiationSafetyProgramService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationSafetyProgramService.class.getName();
	}
	...
	protected RadiationSafetyProgramService radiationSafetyProgramService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationSafetyProgramServiceBaseImpl.class);
