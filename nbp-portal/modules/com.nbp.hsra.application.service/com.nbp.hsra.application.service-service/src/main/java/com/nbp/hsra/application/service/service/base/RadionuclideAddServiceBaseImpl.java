...
import com.nbp.hsra.application.service.service.RadionuclideAddService;
...
/**
 * Provides the base implementation for the radionuclide add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadionuclideAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadionuclideAddServiceImpl
 * @generated
 */
public abstract class RadionuclideAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RadionuclideAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadionuclideAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadionuclideAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadionuclideAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radionuclideAddService = (RadionuclideAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadionuclideAddService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.RadionuclideAddLocalService
			radionuclideAddLocalService;

	protected RadionuclideAddService radionuclideAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadionuclideAddServiceBaseImpl.class);
