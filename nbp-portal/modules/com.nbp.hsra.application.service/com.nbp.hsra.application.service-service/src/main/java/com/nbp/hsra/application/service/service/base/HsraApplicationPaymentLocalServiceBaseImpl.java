...
import com.nbp.hsra.application.service.service.HsraApplicationPaymentLocalService;
...
/**
 * Provides the base implementation for the hsra application payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationPaymentLocalServiceImpl
 * @generated
 */
public abstract class HsraApplicationPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HsraApplicationPaymentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationPaymentLocalServiceUtil</code>.
	 */
	...
	public HsraApplicationPayment addHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.update(hsraApplicationPayment);
	}
	...
	public HsraApplicationPayment createHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.create(
	...
	public HsraApplicationPayment deleteHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.remove(
			hsraApplicationPaymentId);
	}
	...
	public HsraApplicationPayment deleteHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.remove(hsraApplicationPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return hsraApplicationPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HsraApplicationPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hsraApplicationPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hsraApplicationPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public HsraApplicationPayment fetchHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.fetchByPrimaryKey(
			hsraApplicationPaymentId);
	}
	...
	public HsraApplicationPayment getHsraApplicationPayment(
		...
		return hsraApplicationPaymentPersistence.findByPrimaryKey(
			hsraApplicationPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(HsraApplicationPayment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement HsraApplicationPaymentLocalServiceImpl#deleteHsraApplicationPayment(HsraApplicationPayment) to avoid orphaned data");
		}

		return hsraApplicationPaymentLocalService.deleteHsraApplicationPayment(
			(HsraApplicationPayment)persistedModel);
	}

	@Override
	public BasePersistence<HsraApplicationPayment> getBasePersistence() {
		return hsraApplicationPaymentPersistence;
	}
	...
	public List<HsraApplicationPayment> getHsraApplicationPayments(
		...
		return hsraApplicationPaymentPersistence.findAll(start, end);
	}
	...
	public int getHsraApplicationPaymentsCount() {
		return hsraApplicationPaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		hsraApplicationPaymentLocalService =
			(HsraApplicationPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				hsraApplicationPaymentPersistence.getDataSource();
	...
	protected HsraApplicationPaymentLocalService
		hsraApplicationPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationPaymentLocalServiceBaseImpl.class);
