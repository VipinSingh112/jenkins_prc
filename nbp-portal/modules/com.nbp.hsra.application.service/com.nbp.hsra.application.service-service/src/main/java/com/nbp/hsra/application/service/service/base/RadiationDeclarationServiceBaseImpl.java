...
import com.nbp.hsra.application.service.service.RadiationDeclarationService;
...
/**
 * Provides the base implementation for the radiation declaration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationDeclarationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationDeclarationServiceImpl
 * @generated
 */
public abstract class RadiationDeclarationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RadiationDeclarationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationDeclarationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationDeclarationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadiationDeclarationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radiationDeclarationService = (RadiationDeclarationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationDeclarationService.class.getName();
	}
	...
	protected RadiationDeclarationService radiationDeclarationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationDeclarationServiceBaseImpl.class);
