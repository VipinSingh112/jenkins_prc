...
import com.nbp.hsra.application.service.service.BrokerRegistrationInfoLocalService;
...
/**
 * Provides the base implementation for the broker registration info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.BrokerRegistrationInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.BrokerRegistrationInfoLocalServiceImpl
 * @generated
 */
public abstract class BrokerRegistrationInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BrokerRegistrationInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BrokerRegistrationInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.BrokerRegistrationInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public BrokerRegistrationInfo addBrokerRegistrationInfo(
		BrokerRegistrationInfo brokerRegistrationInfo) {

		brokerRegistrationInfo.setNew(true);

		return brokerRegistrationInfoPersistence.update(brokerRegistrationInfo);
	}
	...
	public BrokerRegistrationInfo createBrokerRegistrationInfo(
		long brokerRegstInfoId) {

		return brokerRegistrationInfoPersistence.create(brokerRegstInfoId);
	}
	...
	@Override
	public BrokerRegistrationInfo deleteBrokerRegistrationInfo(
			long brokerRegstInfoId)
		throws PortalException {

		return brokerRegistrationInfoPersistence.remove(brokerRegstInfoId);
	}
	...
	public BrokerRegistrationInfo deleteBrokerRegistrationInfo(
		...
		return brokerRegistrationInfoPersistence.remove(brokerRegistrationInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return brokerRegistrationInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BrokerRegistrationInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return brokerRegistrationInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return brokerRegistrationInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public BrokerRegistrationInfo fetchBrokerRegistrationInfo(
		long brokerRegstInfoId) {

		return brokerRegistrationInfoPersistence.fetchByPrimaryKey(
			brokerRegstInfoId);
	}
	 ...
	 */
	@Override
	public BrokerRegistrationInfo getBrokerRegistrationInfo(
			long brokerRegstInfoId)
		throws PortalException {

		return brokerRegistrationInfoPersistence.findByPrimaryKey(
			brokerRegstInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(BrokerRegistrationInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("brokerRegstInfoId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return brokerRegistrationInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BrokerRegistrationInfoLocalServiceImpl#deleteBrokerRegistrationInfo(BrokerRegistrationInfo) to avoid orphaned data");
		}

		return brokerRegistrationInfoLocalService.deleteBrokerRegistrationInfo(
			(BrokerRegistrationInfo)persistedModel);
	}

	@Override
	public BasePersistence<BrokerRegistrationInfo> getBasePersistence() {
		return brokerRegistrationInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<BrokerRegistrationInfo> getBrokerRegistrationInfos(
		int start, int end) {

		return brokerRegistrationInfoPersistence.findAll(start, end);
	}
	...
	public int getBrokerRegistrationInfosCount() {
		return brokerRegistrationInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BrokerRegistrationInfo updateBrokerRegistrationInfo(
		BrokerRegistrationInfo brokerRegistrationInfo) {
	...
	public void setAopProxy(Object aopProxy) {
		brokerRegistrationInfoLocalService =
			(BrokerRegistrationInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BrokerRegistrationInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				brokerRegistrationInfoPersistence.getDataSource();
	...
	protected BrokerRegistrationInfoLocalService
		brokerRegistrationInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BrokerRegistrationInfoLocalServiceBaseImpl.class);
