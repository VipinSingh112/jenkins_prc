...
import com.nbp.hsra.application.service.service.DetailOfSourcesService;
...
/**
 * Provides the base implementation for the detail of sources remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.DetailOfSourcesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.DetailOfSourcesServiceImpl
 * @generated
 */
public abstract class DetailOfSourcesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DetailOfSourcesService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DetailOfSourcesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.DetailOfSourcesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DetailOfSourcesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		detailOfSourcesService = (DetailOfSourcesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DetailOfSourcesService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.DetailOfSourcesLocalService
			detailOfSourcesLocalService;

	protected DetailOfSourcesService detailOfSourcesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DetailOfSourcesServiceBaseImpl.class);
