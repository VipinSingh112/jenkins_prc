...
import com.nbp.hsra.application.service.service.RadiationDevicesAddLocalService;
...
/**
 * Provides the base implementation for the radiation devices add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationDevicesAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationDevicesAddLocalServiceImpl
 * @generated
 */
public abstract class RadiationDevicesAddLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RadiationDevicesAddLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationDevicesAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationDevicesAddLocalServiceUtil</code>.
	 */
	...
	@Override
	public RadiationDevicesAdd addRadiationDevicesAdd(
		RadiationDevicesAdd radiationDevicesAdd) {

		radiationDevicesAdd.setNew(true);

		return radiationDevicesAddPersistence.update(radiationDevicesAdd);
	}
	...
	public RadiationDevicesAdd createRadiationDevicesAdd(
		long radiationDevicesAddId) {

		return radiationDevicesAddPersistence.create(radiationDevicesAddId);
	}
	...
	@Override
	public RadiationDevicesAdd deleteRadiationDevicesAdd(
			long radiationDevicesAddId)
		throws PortalException {

		return radiationDevicesAddPersistence.remove(radiationDevicesAddId);
	}
	...
	public RadiationDevicesAdd deleteRadiationDevicesAdd(
		...
		return radiationDevicesAddPersistence.remove(radiationDevicesAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return radiationDevicesAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RadiationDevicesAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return radiationDevicesAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return radiationDevicesAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public RadiationDevicesAdd fetchRadiationDevicesAdd(
		long radiationDevicesAddId) {

		return radiationDevicesAddPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public RadiationDevicesAdd getRadiationDevicesAdd(
			long radiationDevicesAddId)
		throws PortalException {

		return radiationDevicesAddPersistence.findByPrimaryKey(
			radiationDevicesAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(RadiationDevicesAdd.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return radiationDevicesAddPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RadiationDevicesAddLocalServiceImpl#deleteRadiationDevicesAdd(RadiationDevicesAdd) to avoid orphaned data");
		}

		return radiationDevicesAddLocalService.deleteRadiationDevicesAdd(
			(RadiationDevicesAdd)persistedModel);
	}

	@Override
	public BasePersistence<RadiationDevicesAdd> getBasePersistence() {
		return radiationDevicesAddPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return radiationDevicesAddPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<RadiationDevicesAdd> getRadiationDevicesAdds(
		int start, int end) {

		return radiationDevicesAddPersistence.findAll(start, end);
	}
	...
	public int getRadiationDevicesAddsCount() {
		return radiationDevicesAddPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RadiationDevicesAdd updateRadiationDevicesAdd(
		RadiationDevicesAdd radiationDevicesAdd) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadiationDevicesAddLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		radiationDevicesAddLocalService =
			(RadiationDevicesAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationDevicesAddLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return RadiationDevicesAdd.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				radiationDevicesAddPersistence.getDataSource();
	...
	protected RadiationDevicesAddLocalService radiationDevicesAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationDevicesAddLocalServiceBaseImpl.class);
