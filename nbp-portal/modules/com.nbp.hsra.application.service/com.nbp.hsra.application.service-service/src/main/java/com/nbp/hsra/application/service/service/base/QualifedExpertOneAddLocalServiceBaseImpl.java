...
import com.nbp.hsra.application.service.service.QualifedExpertOneAddLocalService;
...
/**
 * Provides the base implementation for the qualifed expert one add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.QualifedExpertOneAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.QualifedExpertOneAddLocalServiceImpl
 * @generated
 */
public abstract class QualifedExpertOneAddLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualifedExpertOneAddLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualifedExpertOneAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.QualifedExpertOneAddLocalServiceUtil</code>.
	 */
	...
	public QualifedExpertOneAdd addQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.update(qualifedExpertOneAdd);
	}
	...
	public QualifedExpertOneAdd createQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.create(qualifedExpertOneAddId);
	}
	...
	public QualifedExpertOneAdd deleteQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.remove(qualifedExpertOneAddId);
	}
	...
	public QualifedExpertOneAdd deleteQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.remove(qualifedExpertOneAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return qualifedExpertOneAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QualifedExpertOneAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return qualifedExpertOneAddPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return qualifedExpertOneAddPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public QualifedExpertOneAdd fetchQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.fetchByPrimaryKey(
	...
	public QualifedExpertOneAdd getQualifedExpertOneAdd(
		...
		return qualifedExpertOneAddPersistence.findByPrimaryKey(
			qualifedExpertOneAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(QualifedExpertOneAdd.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return qualifedExpertOneAddPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement QualifedExpertOneAddLocalServiceImpl#deleteQualifedExpertOneAdd(QualifedExpertOneAdd) to avoid orphaned data");
		}

		return qualifedExpertOneAddLocalService.deleteQualifedExpertOneAdd(
			(QualifedExpertOneAdd)persistedModel);
	}

	@Override
	public BasePersistence<QualifedExpertOneAdd> getBasePersistence() {
		return qualifedExpertOneAddPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return qualifedExpertOneAddPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<QualifedExpertOneAdd> getQualifedExpertOneAdds(
		...
		return qualifedExpertOneAddPersistence.findAll(start, end);
	}
	...
	public int getQualifedExpertOneAddsCount() {
		return qualifedExpertOneAddPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		qualifedExpertOneAddLocalService =
			(QualifedExpertOneAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualifedExpertOneAddLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				qualifedExpertOneAddPersistence.getDataSource();
	...
	protected QualifedExpertOneAddLocalService qualifedExpertOneAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QualifedExpertOneAddLocalServiceBaseImpl.class);
