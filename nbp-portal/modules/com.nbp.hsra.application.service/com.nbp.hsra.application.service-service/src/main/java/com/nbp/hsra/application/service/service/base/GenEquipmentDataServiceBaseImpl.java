...
import com.nbp.hsra.application.service.service.GenEquipmentDataService;
...
/**
 * Provides the base implementation for the gen equipment data remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.GenEquipmentDataServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.GenEquipmentDataServiceImpl
 * @generated
 */
public abstract class GenEquipmentDataServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GenEquipmentDataService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GenEquipmentDataService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.GenEquipmentDataServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GenEquipmentDataService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		genEquipmentDataService = (GenEquipmentDataService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GenEquipmentDataService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.GenEquipmentDataLocalService
			genEquipmentDataLocalService;

	protected GenEquipmentDataService genEquipmentDataService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GenEquipmentDataServiceBaseImpl.class);
