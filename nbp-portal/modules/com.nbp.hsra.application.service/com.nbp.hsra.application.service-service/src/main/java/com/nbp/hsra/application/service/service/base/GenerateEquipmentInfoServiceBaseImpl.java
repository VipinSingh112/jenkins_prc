...
import com.nbp.hsra.application.service.service.GenerateEquipmentInfoService;
...
/**
 * Provides the base implementation for the generate equipment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.GenerateEquipmentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.GenerateEquipmentInfoServiceImpl
 * @generated
 */
public abstract class GenerateEquipmentInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GenerateEquipmentInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GenerateEquipmentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.GenerateEquipmentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GenerateEquipmentInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		generateEquipmentInfoService = (GenerateEquipmentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GenerateEquipmentInfoService.class.getName();
	}
	...
	protected GenerateEquipmentInfoService generateEquipmentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GenerateEquipmentInfoServiceBaseImpl.class);
