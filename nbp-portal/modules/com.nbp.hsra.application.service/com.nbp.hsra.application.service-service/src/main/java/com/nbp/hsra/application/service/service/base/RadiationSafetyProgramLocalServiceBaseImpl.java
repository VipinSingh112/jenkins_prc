...
import com.nbp.hsra.application.service.service.RadiationSafetyProgramLocalService;
...
/**
 * Provides the base implementation for the radiation safety program local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationSafetyProgramLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationSafetyProgramLocalServiceImpl
 * @generated
 */
public abstract class RadiationSafetyProgramLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationSafetyProgramLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationSafetyProgramLocalServiceUtil</code>.
	 */
	...
	@Override
	public RadiationSafetyProgram addRadiationSafetyProgram(
		RadiationSafetyProgram radiationSafetyProgram) {

		radiationSafetyProgram.setNew(true);

		return radiationSafetyProgramPersistence.update(radiationSafetyProgram);
	}
	...
	public RadiationSafetyProgram createRadiationSafetyProgram(
		long radiationSafetyProgramId) {

		return radiationSafetyProgramPersistence.create(
	...
	@Override
	public RadiationSafetyProgram deleteRadiationSafetyProgram(
			long radiationSafetyProgramId)
		throws PortalException {

		return radiationSafetyProgramPersistence.remove(
			radiationSafetyProgramId);
	}
	...
	public RadiationSafetyProgram deleteRadiationSafetyProgram(
		...
		return radiationSafetyProgramPersistence.remove(radiationSafetyProgram);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return radiationSafetyProgramPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RadiationSafetyProgram.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return radiationSafetyProgramPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return radiationSafetyProgramPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public RadiationSafetyProgram fetchRadiationSafetyProgram(
		long radiationSafetyProgramId) {

		return radiationSafetyProgramPersistence.fetchByPrimaryKey(
			radiationSafetyProgramId);
	}
	 ...
	 */
	@Override
	public RadiationSafetyProgram getRadiationSafetyProgram(
			long radiationSafetyProgramId)
		throws PortalException {

		return radiationSafetyProgramPersistence.findByPrimaryKey(
			radiationSafetyProgramId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(RadiationSafetyProgram.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RadiationSafetyProgramLocalServiceImpl#deleteRadiationSafetyProgram(RadiationSafetyProgram) to avoid orphaned data");
		}

		return radiationSafetyProgramLocalService.deleteRadiationSafetyProgram(
			(RadiationSafetyProgram)persistedModel);
	}

	@Override
	public BasePersistence<RadiationSafetyProgram> getBasePersistence() {
		return radiationSafetyProgramPersistence;
	}
	 ...
	 */
	@Override
	public List<RadiationSafetyProgram> getRadiationSafetyPrograms(
		int start, int end) {

		return radiationSafetyProgramPersistence.findAll(start, end);
	}
	...
	public int getRadiationSafetyProgramsCount() {
		return radiationSafetyProgramPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public RadiationSafetyProgram updateRadiationSafetyProgram(
		RadiationSafetyProgram radiationSafetyProgram) {
	...
	public void setAopProxy(Object aopProxy) {
		radiationSafetyProgramLocalService =
			(RadiationSafetyProgramLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationSafetyProgramLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				radiationSafetyProgramPersistence.getDataSource();
	...
	protected RadiationSafetyProgramLocalService
		radiationSafetyProgramLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationSafetyProgramLocalServiceBaseImpl.class);
