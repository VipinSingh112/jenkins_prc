...
import com.nbp.hsra.application.service.service.DetailOfSourcesLocalService;
...
/**
 * Provides the base implementation for the detail of sources local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.DetailOfSourcesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.DetailOfSourcesLocalServiceImpl
 * @generated
 */
public abstract class DetailOfSourcesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DetailOfSourcesLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DetailOfSourcesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.DetailOfSourcesLocalServiceUtil</code>.
	 */
	...
	public DetailOfSources addDetailOfSources(DetailOfSources detailOfSources) {
		...
		return detailOfSourcesPersistence.update(detailOfSources);
	}
	...
	public DetailOfSources createDetailOfSources(long detailOfSourcesId) {
		return detailOfSourcesPersistence.create(detailOfSourcesId);
	}
	...
	public DetailOfSources deleteDetailOfSources(long detailOfSourcesId)
		...
		return detailOfSourcesPersistence.remove(detailOfSourcesId);
	}
	...
	public DetailOfSources deleteDetailOfSources(
		...
		return detailOfSourcesPersistence.remove(detailOfSources);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return detailOfSourcesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DetailOfSources.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return detailOfSourcesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return detailOfSourcesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return detailOfSourcesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return detailOfSourcesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DetailOfSources fetchDetailOfSources(long detailOfSourcesId) {
		return detailOfSourcesPersistence.fetchByPrimaryKey(detailOfSourcesId);
	}
	...
	public DetailOfSources getDetailOfSources(long detailOfSourcesId)
		...
		return detailOfSourcesPersistence.findByPrimaryKey(detailOfSourcesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(detailOfSourcesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DetailOfSources.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("detailOfSourcesId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			detailOfSourcesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DetailOfSources.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return detailOfSourcesPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DetailOfSourcesLocalServiceImpl#deleteDetailOfSources(DetailOfSources) to avoid orphaned data");
		}

		return detailOfSourcesLocalService.deleteDetailOfSources(
			(DetailOfSources)persistedModel);
	}

	@Override
	public BasePersistence<DetailOfSources> getBasePersistence() {
		return detailOfSourcesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return detailOfSourcesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DetailOfSources> getDetailOfSourceses(int start, int end) {
		return detailOfSourcesPersistence.findAll(start, end);
	}
	...
	public int getDetailOfSourcesesCount() {
		return detailOfSourcesPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DetailOfSourcesLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		detailOfSourcesLocalService = (DetailOfSourcesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DetailOfSourcesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = detailOfSourcesPersistence.getDataSource();
	...
	protected DetailOfSourcesLocalService detailOfSourcesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DetailOfSourcesLocalServiceBaseImpl.class);
