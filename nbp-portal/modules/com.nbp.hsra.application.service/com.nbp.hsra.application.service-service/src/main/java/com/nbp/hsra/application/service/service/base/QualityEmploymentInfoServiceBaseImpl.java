...
import com.nbp.hsra.application.service.service.QualityEmploymentInfoService;
...
/**
 * Provides the base implementation for the quality employment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.QualityEmploymentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.QualityEmploymentInfoServiceImpl
 * @generated
 */
public abstract class QualityEmploymentInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualityEmploymentInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualityEmploymentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.QualityEmploymentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualityEmploymentInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualityEmploymentInfoService = (QualityEmploymentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualityEmploymentInfoService.class.getName();
	}
	...
	protected QualityEmploymentInfoService qualityEmploymentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QualityEmploymentInfoServiceBaseImpl.class);
