...
import com.nbp.hsra.application.service.service.RadiationSafetyLowRiskService;
...
/**
 * Provides the base implementation for the radiation safety low risk remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.RadiationSafetyLowRiskServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.RadiationSafetyLowRiskServiceImpl
 * @generated
 */
public abstract class RadiationSafetyLowRiskServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RadiationSafetyLowRiskService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RadiationSafetyLowRiskService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.RadiationSafetyLowRiskServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RadiationSafetyLowRiskService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		radiationSafetyLowRiskService = (RadiationSafetyLowRiskService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return RadiationSafetyLowRiskService.class.getName();
	}
	...
	protected RadiationSafetyLowRiskService radiationSafetyLowRiskService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RadiationSafetyLowRiskServiceBaseImpl.class);
