...
import com.nbp.hsra.application.service.service.HsraApplicationCurrentStageService;
...
/**
 * Provides the base implementation for the hsra application current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationCurrentStageServiceImpl
 * @generated
 */
public abstract class HsraApplicationCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HsraApplicationCurrentStageService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		hsraApplicationCurrentStageService =
			(HsraApplicationCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationCurrentStageService.class.getName();
	}
	...
	protected HsraApplicationCurrentStageService
		hsraApplicationCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationCurrentStageServiceBaseImpl.class);
