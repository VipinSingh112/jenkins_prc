...
import com.nbp.hsra.application.service.service.HsraApplicationService;
...
/**
 * Provides the base implementation for the hsra application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationServiceImpl
 * @generated
 */
public abstract class HsraApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HsraApplicationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HsraApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		hsraApplicationService = (HsraApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.HsraApplicationLocalService
			hsraApplicationLocalService;

	protected HsraApplicationService hsraApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationServiceBaseImpl.class);
