...
import com.nbp.hsra.application.service.service.FitPropBusinessInfoService;
...
/**
 * Provides the base implementation for the fit prop business info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.FitPropBusinessInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.FitPropBusinessInfoServiceImpl
 * @generated
 */
public abstract class FitPropBusinessInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FitPropBusinessInfoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FitPropBusinessInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.FitPropBusinessInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FitPropBusinessInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		fitPropBusinessInfoService = (FitPropBusinessInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FitPropBusinessInfoService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.FitPropBusinessInfoLocalService
			fitPropBusinessInfoLocalService;

	protected FitPropBusinessInfoService fitPropBusinessInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FitPropBusinessInfoServiceBaseImpl.class);
