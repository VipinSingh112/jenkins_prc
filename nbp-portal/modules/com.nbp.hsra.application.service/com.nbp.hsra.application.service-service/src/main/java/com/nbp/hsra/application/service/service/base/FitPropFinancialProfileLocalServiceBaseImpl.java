...
import com.nbp.hsra.application.service.service.FitPropFinancialProfileLocalService;
...
/**
 * Provides the base implementation for the fit prop financial profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.FitPropFinancialProfileLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.FitPropFinancialProfileLocalServiceImpl
 * @generated
 */
public abstract class FitPropFinancialProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FitPropFinancialProfileLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FitPropFinancialProfileLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.FitPropFinancialProfileLocalServiceUtil</code>.
	 */
	...
	@Override
	public FitPropFinancialProfile addFitPropFinancialProfile(
		FitPropFinancialProfile fitPropFinancialProfile) {

		fitPropFinancialProfile.setNew(true);

		return fitPropFinancialProfilePersistence.update(
	...
	public FitPropFinancialProfile createFitPropFinancialProfile(
		long fitPropFinancialProfileId) {

		return fitPropFinancialProfilePersistence.create(
	...
	@Override
	public FitPropFinancialProfile deleteFitPropFinancialProfile(
			long fitPropFinancialProfileId)
		throws PortalException {

		return fitPropFinancialProfilePersistence.remove(
			fitPropFinancialProfileId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fitPropFinancialProfilePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FitPropFinancialProfile.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fitPropFinancialProfilePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fitPropFinancialProfilePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FitPropFinancialProfile fetchFitPropFinancialProfile(
		long fitPropFinancialProfileId) {

		return fitPropFinancialProfilePersistence.fetchByPrimaryKey(
			fitPropFinancialProfileId);
	}
	 ...
	 */
	@Override
	public FitPropFinancialProfile getFitPropFinancialProfile(
			long fitPropFinancialProfileId)
		throws PortalException {

		return fitPropFinancialProfilePersistence.findByPrimaryKey(
			fitPropFinancialProfileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FitPropFinancialProfile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FitPropFinancialProfileLocalServiceImpl#deleteFitPropFinancialProfile(FitPropFinancialProfile) to avoid orphaned data");
		}

		return fitPropFinancialProfileLocalService.
			deleteFitPropFinancialProfile(
				(FitPropFinancialProfile)persistedModel);
	}

	@Override
	public BasePersistence<FitPropFinancialProfile> getBasePersistence() {
		return fitPropFinancialProfilePersistence;
	}
	 ...
	 */
	@Override
	public List<FitPropFinancialProfile> getFitPropFinancialProfiles(
		int start, int end) {

		return fitPropFinancialProfilePersistence.findAll(start, end);
	}
	...
	public int getFitPropFinancialProfilesCount() {
		return fitPropFinancialProfilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FitPropFinancialProfile updateFitPropFinancialProfile(
		FitPropFinancialProfile fitPropFinancialProfile) {
	...
	public void setAopProxy(Object aopProxy) {
		fitPropFinancialProfileLocalService =
			(FitPropFinancialProfileLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FitPropFinancialProfileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				fitPropFinancialProfilePersistence.getDataSource();
	...
	protected FitPropFinancialProfileLocalService
		fitPropFinancialProfileLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FitPropFinancialProfileLocalServiceBaseImpl.class);
