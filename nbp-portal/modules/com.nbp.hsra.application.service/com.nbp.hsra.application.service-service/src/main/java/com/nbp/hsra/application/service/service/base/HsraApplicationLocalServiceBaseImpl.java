...
import com.nbp.hsra.application.service.service.HsraApplicationLocalService;
...
/**
 * Provides the base implementation for the hsra application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationLocalServiceImpl
 * @generated
 */
public abstract class HsraApplicationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HsraApplicationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationLocalServiceUtil</code>.
	 */
	...
	public HsraApplication addHsraApplication(HsraApplication hsraApplication) {
		...
		return hsraApplicationPersistence.update(hsraApplication);
	}
	...
	public HsraApplication createHsraApplication(long hsraApplicationId) {
		return hsraApplicationPersistence.create(hsraApplicationId);
	}
	...
	public HsraApplication deleteHsraApplication(long hsraApplicationId)
		...
		return hsraApplicationPersistence.remove(hsraApplicationId);
	}
	...
	public HsraApplication deleteHsraApplication(
		...
		return hsraApplicationPersistence.remove(hsraApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return hsraApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HsraApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return hsraApplicationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return hsraApplicationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return hsraApplicationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return hsraApplicationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HsraApplication fetchHsraApplication(long hsraApplicationId) {
		return hsraApplicationPersistence.fetchByPrimaryKey(hsraApplicationId);
	}
	...
	public HsraApplication fetchHsraApplicationByUuidAndGroupId(
		...
		return hsraApplicationPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public HsraApplication getHsraApplication(long hsraApplicationId)
		...
		return hsraApplicationPersistence.findByPrimaryKey(hsraApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(hsraApplicationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HsraApplication.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("hsraApplicationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			hsraApplicationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HsraApplication.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<HsraApplication>() {

				@Override
				public void performAction(HsraApplication hsraApplication)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, hsraApplication);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return hsraApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement HsraApplicationLocalServiceImpl#deleteHsraApplication(HsraApplication) to avoid orphaned data");
		}

		return hsraApplicationLocalService.deleteHsraApplication(
			(HsraApplication)persistedModel);
	}

	@Override
	public BasePersistence<HsraApplication> getBasePersistence() {
		return hsraApplicationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return hsraApplicationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HsraApplication> getHsraApplicationsByUuidAndCompanyId(
		...
		return hsraApplicationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<HsraApplication> getHsraApplicationsByUuidAndCompanyId(
		...
		return hsraApplicationPersistence.findByUuid_C(
	...
	public HsraApplication getHsraApplicationByUuidAndGroupId(
		...
		return hsraApplicationPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<HsraApplication> getHsraApplications(int start, int end) {
		return hsraApplicationPersistence.findAll(start, end);
	}
	...
	public int getHsraApplicationsCount() {
		return hsraApplicationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HsraApplicationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		hsraApplicationLocalService = (HsraApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = hsraApplicationPersistence.getDataSource();
	...
	protected HsraApplicationLocalService hsraApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationLocalServiceBaseImpl.class);
