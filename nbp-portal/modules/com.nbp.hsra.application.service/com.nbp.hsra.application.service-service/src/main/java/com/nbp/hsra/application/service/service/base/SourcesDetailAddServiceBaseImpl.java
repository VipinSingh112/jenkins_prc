...
import com.nbp.hsra.application.service.service.SourcesDetailAddService;
...
/**
 * Provides the base implementation for the sources detail add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.SourcesDetailAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.SourcesDetailAddServiceImpl
 * @generated
 */
public abstract class SourcesDetailAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SourcesDetailAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SourcesDetailAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.SourcesDetailAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SourcesDetailAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sourcesDetailAddService = (SourcesDetailAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SourcesDetailAddService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.SourcesDetailAddLocalService
			sourcesDetailAddLocalService;

	protected SourcesDetailAddService sourcesDetailAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SourcesDetailAddServiceBaseImpl.class);
