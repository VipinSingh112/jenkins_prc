...
import com.nbp.hsra.application.service.service.base.SourcesDetailAddServiceBaseImpl;
...
@Component(
	property = {
		...
		"json.web.service.context.path=SourcesDetailAdd"
	},
	service = AopService.class
)
public class SourcesDetailAddServiceImpl
	extends SourcesDetailAddServiceBaseImpl {
