...
import com.nbp.hsra.application.service.service.HsraApplicationPaymentService;
...
/**
 * Provides the base implementation for the hsra application payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.HsraApplicationPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.HsraApplicationPaymentServiceImpl
 * @generated
 */
public abstract class HsraApplicationPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HsraApplicationPaymentService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HsraApplicationPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.HsraApplicationPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HsraApplicationPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		hsraApplicationPaymentService = (HsraApplicationPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HsraApplicationPaymentService.class.getName();
	}
	...
	protected HsraApplicationPaymentService hsraApplicationPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HsraApplicationPaymentServiceBaseImpl.class);
