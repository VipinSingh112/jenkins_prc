...
import com.nbp.hsra.application.service.service.QualityDeclarationInfoService;
...
/**
 * Provides the base implementation for the quality declaration info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.QualityDeclarationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.QualityDeclarationInfoServiceImpl
 * @generated
 */
public abstract class QualityDeclarationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QualityDeclarationInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QualityDeclarationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.QualityDeclarationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QualityDeclarationInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qualityDeclarationInfoService = (QualityDeclarationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QualityDeclarationInfoService.class.getName();
	}
	...
	protected QualityDeclarationInfoService qualityDeclarationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QualityDeclarationInfoServiceBaseImpl.class);
