...
import com.nbp.hsra.application.service.service.UnsealedSourceAddService;
...
/**
 * Provides the base implementation for the unsealed source add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.UnsealedSourceAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.UnsealedSourceAddServiceImpl
 * @generated
 */
public abstract class UnsealedSourceAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UnsealedSourceAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UnsealedSourceAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.UnsealedSourceAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UnsealedSourceAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		unsealedSourceAddService = (UnsealedSourceAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UnsealedSourceAddService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.UnsealedSourceAddLocalService
			unsealedSourceAddLocalService;

	protected UnsealedSourceAddService unsealedSourceAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UnsealedSourceAddServiceBaseImpl.class);
