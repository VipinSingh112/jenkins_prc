...
import com.nbp.hsra.application.service.service.MedicalPractitionerAddService;
...
/**
 * Provides the base implementation for the medical practitioner add remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.MedicalPractitionerAddServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.MedicalPractitionerAddServiceImpl
 * @generated
 */
public abstract class MedicalPractitionerAddServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MedicalPractitionerAddService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MedicalPractitionerAddService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.MedicalPractitionerAddServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MedicalPractitionerAddService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		medicalPractitionerAddService = (MedicalPractitionerAddService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MedicalPractitionerAddService.class.getName();
	}
	...
	protected MedicalPractitionerAddService medicalPractitionerAddService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MedicalPractitionerAddServiceBaseImpl.class);
