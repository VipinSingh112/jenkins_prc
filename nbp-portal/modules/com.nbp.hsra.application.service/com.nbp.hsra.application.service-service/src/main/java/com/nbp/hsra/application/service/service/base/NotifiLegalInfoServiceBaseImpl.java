...
import com.nbp.hsra.application.service.service.NotifiLegalInfoService;
...
/**
 * Provides the base implementation for the notifi legal info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.NotifiLegalInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.NotifiLegalInfoServiceImpl
 * @generated
 */
public abstract class NotifiLegalInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NotifiLegalInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NotifiLegalInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.NotifiLegalInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NotifiLegalInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		notifiLegalInfoService = (NotifiLegalInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotifiLegalInfoService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.hsra.application.service.service.NotifiLegalInfoLocalService
			notifiLegalInfoLocalService;

	protected NotifiLegalInfoService notifiLegalInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NotifiLegalInfoServiceBaseImpl.class);
