...
import com.nbp.hsra.application.service.service.FitPropPersonalDetailInfoLocalService;
...
/**
 * Provides the base implementation for the fit prop personal detail info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.FitPropPersonalDetailInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.FitPropPersonalDetailInfoLocalServiceImpl
 * @generated
 */
public abstract class FitPropPersonalDetailInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FitPropPersonalDetailInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FitPropPersonalDetailInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.FitPropPersonalDetailInfoLocalServiceUtil</code>.
	 */
	...
	public FitPropPersonalDetailInfo addFitPropPersonalDetailInfo(
		...
		return fitPropPersonalDetailInfoPersistence.update(
	...
	public FitPropPersonalDetailInfo createFitPropPersonalDetailInfo(
		...
		return fitPropPersonalDetailInfoPersistence.create(
	...
	public FitPropPersonalDetailInfo deleteFitPropPersonalDetailInfo(
		...
		return fitPropPersonalDetailInfoPersistence.remove(
			fitPropPersonalDetailInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fitPropPersonalDetailInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FitPropPersonalDetailInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fitPropPersonalDetailInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fitPropPersonalDetailInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FitPropPersonalDetailInfo fetchFitPropPersonalDetailInfo(
		...
		return fitPropPersonalDetailInfoPersistence.fetchByPrimaryKey(
			fitPropPersonalDetailInfoId);
	}
	...
	public FitPropPersonalDetailInfo getFitPropPersonalDetailInfo(
		...
		return fitPropPersonalDetailInfoPersistence.findByPrimaryKey(
			fitPropPersonalDetailInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FitPropPersonalDetailInfo.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			FitPropPersonalDetailInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FitPropPersonalDetailInfoLocalServiceImpl#deleteFitPropPersonalDetailInfo(FitPropPersonalDetailInfo) to avoid orphaned data");
		}

		return fitPropPersonalDetailInfoLocalService.
			deleteFitPropPersonalDetailInfo(
				(FitPropPersonalDetailInfo)persistedModel);
	}

	@Override
	public BasePersistence<FitPropPersonalDetailInfo> getBasePersistence() {
		return fitPropPersonalDetailInfoPersistence;
	}
	...
	public List<FitPropPersonalDetailInfo> getFitPropPersonalDetailInfos(
		...
		return fitPropPersonalDetailInfoPersistence.findAll(start, end);
	}
	...
	public int getFitPropPersonalDetailInfosCount() {
		return fitPropPersonalDetailInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		fitPropPersonalDetailInfoLocalService =
			(FitPropPersonalDetailInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FitPropPersonalDetailInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				fitPropPersonalDetailInfoPersistence.getDataSource();
	...
	protected FitPropPersonalDetailInfoLocalService
		fitPropPersonalDetailInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FitPropPersonalDetailInfoLocalServiceBaseImpl.class);
