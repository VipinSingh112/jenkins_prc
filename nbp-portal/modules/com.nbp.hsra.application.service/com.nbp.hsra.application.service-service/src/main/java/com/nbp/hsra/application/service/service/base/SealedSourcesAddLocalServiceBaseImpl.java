...
import com.nbp.hsra.application.service.service.SealedSourcesAddLocalService;
...
/**
 * Provides the base implementation for the sealed sources add local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.SealedSourcesAddLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.SealedSourcesAddLocalServiceImpl
 * @generated
 */
public abstract class SealedSourcesAddLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SealedSourcesAddLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.SealedSourcesAddLocalServiceUtil</code>.
	 */
	...
	@Override
	public SealedSourcesAdd addSealedSourcesAdd(
		SealedSourcesAdd sealedSourcesAdd) {

		sealedSourcesAdd.setNew(true);

		return sealedSourcesAddPersistence.update(sealedSourcesAdd);
	}
	...
	public SealedSourcesAdd createSealedSourcesAdd(long sealedSourcesAddId) {
		return sealedSourcesAddPersistence.create(sealedSourcesAddId);
	}
	...
	@Override
	public SealedSourcesAdd deleteSealedSourcesAdd(long sealedSourcesAddId)
		throws PortalException {

		return sealedSourcesAddPersistence.remove(sealedSourcesAddId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SealedSourcesAdd deleteSealedSourcesAdd(
		SealedSourcesAdd sealedSourcesAdd) {

		return sealedSourcesAddPersistence.remove(sealedSourcesAdd);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sealedSourcesAddPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SealedSourcesAdd.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sealedSourcesAddPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return sealedSourcesAddPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sealedSourcesAddPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return sealedSourcesAddPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SealedSourcesAdd fetchSealedSourcesAdd(long sealedSourcesAddId) {
		return sealedSourcesAddPersistence.fetchByPrimaryKey(
			sealedSourcesAddId);
	}
	 ...
	 */
	@Override
	public SealedSourcesAdd getSealedSourcesAdd(long sealedSourcesAddId)
		throws PortalException {

		return sealedSourcesAddPersistence.findByPrimaryKey(sealedSourcesAddId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SealedSourcesAdd.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sealedSourcesAddId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SealedSourcesAdd.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sealedSourcesAddPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SealedSourcesAddLocalServiceImpl#deleteSealedSourcesAdd(SealedSourcesAdd) to avoid orphaned data");
		}

		return sealedSourcesAddLocalService.deleteSealedSourcesAdd(
			(SealedSourcesAdd)persistedModel);
	}

	@Override
	public BasePersistence<SealedSourcesAdd> getBasePersistence() {
		return sealedSourcesAddPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return sealedSourcesAddPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SealedSourcesAdd> getSealedSourcesAdds(int start, int end) {
		return sealedSourcesAddPersistence.findAll(start, end);
	}
	...
	public int getSealedSourcesAddsCount() {
		return sealedSourcesAddPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SealedSourcesAdd updateSealedSourcesAdd(
		SealedSourcesAdd sealedSourcesAdd) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SealedSourcesAddLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sealedSourcesAddLocalService = (SealedSourcesAddLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SealedSourcesAddLocalService.class.getName();
	}
	...
	protected SealedSourcesAddLocalService sealedSourcesAddLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SealedSourcesAddLocalServiceBaseImpl.class);
