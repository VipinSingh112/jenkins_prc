...
import com.nbp.hsra.application.service.service.BrokerDeclarationInfoService;
...
/**
 * Provides the base implementation for the broker declaration info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.BrokerDeclarationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.BrokerDeclarationInfoServiceImpl
 * @generated
 */
public abstract class BrokerDeclarationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BrokerDeclarationInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BrokerDeclarationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.BrokerDeclarationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BrokerDeclarationInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		brokerDeclarationInfoService = (BrokerDeclarationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BrokerDeclarationInfoService.class.getName();
	}
	...
	protected BrokerDeclarationInfoService brokerDeclarationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BrokerDeclarationInfoServiceBaseImpl.class);
