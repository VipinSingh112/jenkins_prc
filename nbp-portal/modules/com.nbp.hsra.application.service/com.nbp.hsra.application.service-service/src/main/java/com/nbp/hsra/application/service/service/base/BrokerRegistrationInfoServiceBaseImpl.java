...
import com.nbp.hsra.application.service.service.BrokerRegistrationInfoService;
...
/**
 * Provides the base implementation for the broker registration info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.BrokerRegistrationInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.BrokerRegistrationInfoServiceImpl
 * @generated
 */
public abstract class BrokerRegistrationInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BrokerRegistrationInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BrokerRegistrationInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.BrokerRegistrationInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BrokerRegistrationInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		brokerRegistrationInfoService = (BrokerRegistrationInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return BrokerRegistrationInfoService.class.getName();
	}
	...
	protected BrokerRegistrationInfoService brokerRegistrationInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BrokerRegistrationInfoServiceBaseImpl.class);
