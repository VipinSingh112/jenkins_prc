...
import com.nbp.hsra.application.service.service.AddApplicantPractitionerService;
...
/**
 * Provides the base implementation for the add applicant practitioner remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.AddApplicantPractitionerServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.AddApplicantPractitionerServiceImpl
 * @generated
 */
public abstract class AddApplicantPractitionerServiceBaseImpl
	extends BaseServiceImpl
	implements AddApplicantPractitionerService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AddApplicantPractitionerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.AddApplicantPractitionerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AddApplicantPractitionerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		addApplicantPractitionerService =
			(AddApplicantPractitionerService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AddApplicantPractitionerService.class.getName();
	}
	...
	protected AddApplicantPractitionerService addApplicantPractitionerService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AddApplicantPractitionerServiceBaseImpl.class);
