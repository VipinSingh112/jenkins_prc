...
import com.nbp.hsra.application.service.service.FitPropDeclareApplicantLocalService;
...
/**
 * Provides the base implementation for the fit prop declare applicant local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.hsra.application.service.service.impl.FitPropDeclareApplicantLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.hsra.application.service.service.impl.FitPropDeclareApplicantLocalServiceImpl
 * @generated
 */
public abstract class FitPropDeclareApplicantLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FitPropDeclareApplicantLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FitPropDeclareApplicantLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.hsra.application.service.service.FitPropDeclareApplicantLocalServiceUtil</code>.
	 */
	...
	public FitPropDeclareApplicant addFitPropDeclareApplicant(
		...
		return fitPropDeclareApplicantPersistence.update(
	...
	public FitPropDeclareApplicant createFitPropDeclareApplicant(
		...
		return fitPropDeclareApplicantPersistence.create(
	...
	public FitPropDeclareApplicant deleteFitPropDeclareApplicant(
		...
		return fitPropDeclareApplicantPersistence.remove(
			fitPropDeclareApplicantId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return fitPropDeclareApplicantPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FitPropDeclareApplicant.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return fitPropDeclareApplicantPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fitPropDeclareApplicantPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FitPropDeclareApplicant fetchFitPropDeclareApplicant(
		...
		return fitPropDeclareApplicantPersistence.fetchByPrimaryKey(
			fitPropDeclareApplicantId);
	}
	...
	public FitPropDeclareApplicant getFitPropDeclareApplicant(
		...
		return fitPropDeclareApplicantPersistence.findByPrimaryKey(
			fitPropDeclareApplicantId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FitPropDeclareApplicant.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FitPropDeclareApplicantLocalServiceImpl#deleteFitPropDeclareApplicant(FitPropDeclareApplicant) to avoid orphaned data");
		}

		return fitPropDeclareApplicantLocalService.
			deleteFitPropDeclareApplicant(
				(FitPropDeclareApplicant)persistedModel);
	}

	@Override
	public BasePersistence<FitPropDeclareApplicant> getBasePersistence() {
		return fitPropDeclareApplicantPersistence;
	}
	...
	public List<FitPropDeclareApplicant> getFitPropDeclareApplicants(
		...
		return fitPropDeclareApplicantPersistence.findAll(start, end);
	}
	...
	public int getFitPropDeclareApplicantsCount() {
		return fitPropDeclareApplicantPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		fitPropDeclareApplicantLocalService =
			(FitPropDeclareApplicantLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FitPropDeclareApplicantLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				fitPropDeclareApplicantPersistence.getDataSource();
	...
	protected FitPropDeclareApplicantLocalService
		fitPropDeclareApplicantLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FitPropDeclareApplicantLocalServiceBaseImpl.class);
