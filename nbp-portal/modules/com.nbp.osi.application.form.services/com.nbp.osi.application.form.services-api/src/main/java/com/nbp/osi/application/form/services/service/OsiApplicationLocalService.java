...
/**
 * Provides the local service interface for OsiApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.application.form.services.service.impl.OsiApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiApplication> getOsiApplicationByS_UId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiApplication> getOsiApplicationByStatus_UserId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiApplication getOsiByAppNum(String applicationNumber)
		throws NoSuchOsiApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiApplication getOsiByAT_AppNo(
			String applicationType, String appNumber)
		throws NoSuchOsiApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiApplication getOsiByCaseId(String caseId)
		throws NoSuchOsiApplicationException;
