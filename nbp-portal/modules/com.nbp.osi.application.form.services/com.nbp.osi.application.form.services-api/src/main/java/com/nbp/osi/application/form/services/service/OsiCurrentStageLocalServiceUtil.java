...
/**
 * Provides the local service utility for OsiCurrentStage. This utility wraps
 * <code>com.nbp.osi.application.form.services.service.impl.OsiCurrentStageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OsiCurrentStageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.application.form.services.service.impl.OsiCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OsiCurrentStage addOsiCurrentStage(
		OsiCurrentStage osiCurrentStage) {

		return getService().addOsiCurrentStage(osiCurrentStage);
	}
	 ...
	 */
	public static OsiCurrentStage createOsiCurrentStage(
		long osiCurrentStageId) {

		return getService().createOsiCurrentStage(osiCurrentStageId);
	}
	 ...
	 */
	public static OsiCurrentStage deleteOsiCurrentStage(long osiCurrentStageId)
		throws PortalException {

		return getService().deleteOsiCurrentStage(osiCurrentStageId);
	}
	 ...
	 * @return the osi current stage that was removed
	 */
	public static OsiCurrentStage deleteOsiCurrentStage(
		OsiCurrentStage osiCurrentStage) {

		return getService().deleteOsiCurrentStage(osiCurrentStage);
	}
	...
	public static OsiCurrentStage fetchOsiCurrentStage(long osiCurrentStageId) {
		return getService().fetchOsiCurrentStage(osiCurrentStageId);
	}
	 ...
	 * @throws PortalException if a osi current stage with the primary key could not be found
	 */
	public static OsiCurrentStage getOsiCurrentStage(long osiCurrentStageId)
		throws PortalException {

		return getService().getOsiCurrentStage(osiCurrentStageId);
	}

	public static OsiCurrentStage getOsiCurrentStageById(long osiApplicationId)
		throws com.nbp.osi.application.form.services.exception.
			NoSuchOsiCurrentStageException {

		return getService().getOsiCurrentStageById(osiApplicationId);
	}
	 ...
	 */
	public static List<OsiCurrentStage> getOsiCurrentStages(
		int start, int end) {

		return getService().getOsiCurrentStages(start, end);
	}
	 ...
	 */
	public static int getOsiCurrentStagesCount() {
		return getService().getOsiCurrentStagesCount();
	}
	 ...
	 */
	public static OsiCurrentStage updateOsiCurrentStage(
		OsiCurrentStage osiCurrentStage) {

		return getService().updateOsiCurrentStage(osiCurrentStage);
	}

	public static OsiCurrentStageLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OsiCurrentStageLocalService>
		_serviceSnapshot = new Snapshot<>(
			OsiCurrentStageLocalServiceUtil.class,
			OsiCurrentStageLocalService.class);
