...
/**
 * <p>
 * This class is a wrapper for {@link TourismApplicationStages}.
 * </p>
 *
 ...
 * @generated
 */
public class TourismApplicationStagesWrapper
	extends BaseModelWrapper<TourismApplicationStages>
	implements ModelWrapper<TourismApplicationStages>,
			   TourismApplicationStages {

	public TourismApplicationStagesWrapper(
		TourismApplicationStages tourismApplicationStages) {

		super(tourismApplicationStages);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put(
			"tourismApplicationStagesId", getTourismApplicationStagesId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long tourismApplicationStagesId = (Long)attributes.get(
			"tourismApplicationStagesId");

		if (tourismApplicationStagesId != null) {
			setTourismApplicationStagesId(tourismApplicationStagesId);
		}
	...
	public long getTourismApplicationStagesId() {
		return model.getTourismApplicationStagesId();
	}
	...
	public void setTourismApplicationStagesId(long tourismApplicationStagesId) {
		model.setTourismApplicationStagesId(tourismApplicationStagesId);
	}
	...
	@Override
	protected TourismApplicationStagesWrapper wrap(
		TourismApplicationStages tourismApplicationStages) {

		return new TourismApplicationStagesWrapper(tourismApplicationStages);
	}
