...
/**
 * Provides the local service utility for TourismDeskVerification. This utility wraps
 * <code>com.nbp.tourism.application.stages.services.service.impl.TourismDeskVerificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TourismDeskVerificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.tourism.application.stages.services.service.impl.TourismDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TourismDeskVerification addTourismDeskVerification(
		TourismDeskVerification tourismDeskVerification) {

		return getService().addTourismDeskVerification(tourismDeskVerification);
	}
	 ...
	 */
	public static TourismDeskVerification createTourismDeskVerification(
		long tourismDeskVeriId) {

		return getService().createTourismDeskVerification(tourismDeskVeriId);
	}
	 ...
	 */
	public static TourismDeskVerification deleteTourismDeskVerification(
			long tourismDeskVeriId)
		throws PortalException {

		return getService().deleteTourismDeskVerification(tourismDeskVeriId);
	}
	...
	public static TourismDeskVerification deleteTourismDeskVerification(
		...
		return getService().deleteTourismDeskVerification(
			tourismDeskVerification);
	}

	public static void deleteTourismDV_ById(long tourismApplicationId) {
		getService().deleteTourismDV_ById(tourismApplicationId);
	}
	...
	public static TourismDeskVerification fetchTourismDeskVerification(
		long tourismDeskVeriId) {

		return getService().fetchTourismDeskVerification(tourismDeskVeriId);
	}
	 ...
	 * @throws PortalException if a tourism desk verification with the primary key could not be found
	 */
	public static TourismDeskVerification getTourismDeskVerification(
			long tourismDeskVeriId)
		throws PortalException {

		return getService().getTourismDeskVerification(tourismDeskVeriId);
	}
	 ...
	 */
	public static List<TourismDeskVerification> getTourismDeskVerifications(
		int start, int end) {

		return getService().getTourismDeskVerifications(start, end);
	}

	public static List<TourismDeskVerification> getTourismDeskVerifications(
		long tourismApplicationId) {

		return getService().getTourismDeskVerifications(tourismApplicationId);
	}
	 ...
	 */
	public static int getTourismDeskVerificationsCount() {
		return getService().getTourismDeskVerificationsCount();
	}
	 ...
	 */
	public static TourismDeskVerification updateTourismDeskVerification(
		TourismDeskVerification tourismDeskVerification) {

		return getService().updateTourismDeskVerification(
			tourismDeskVerification);
	}

	public static TourismDeskVerificationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<TourismDeskVerificationLocalService>
		_serviceSnapshot = new Snapshot<>(
			TourismDeskVerificationLocalServiceUtil.class,
