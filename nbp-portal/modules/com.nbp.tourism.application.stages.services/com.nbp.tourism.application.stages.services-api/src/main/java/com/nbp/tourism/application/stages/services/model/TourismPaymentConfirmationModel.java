...
/**
 * The base model interface for the TourismPaymentConfirmation service. Represents a row in the &quot;nbp_tourism_payment_con&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.tourism.application.stages.services.model.impl.TourismPaymentConfirmationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.tourism.application.stages.services.model.impl.TourismPaymentConfirmationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface TourismPaymentConfirmationModel
	extends BaseModel<TourismPaymentConfirmation>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a tourism payment confirmation model instance should use the {@link TourismPaymentConfirmation} interface instead.
	 */
