...
import com.nbp.tourism.application.stages.services.service.TourismApplicationStagesService;
...
/**
 * Provides the base implementation for the tourism application stages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.tourism.application.stages.services.service.impl.TourismApplicationStagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.tourism.application.stages.services.service.impl.TourismApplicationStagesServiceImpl
 * @generated
 */
public abstract class TourismApplicationStagesServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TourismApplicationStagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.tourism.application.stages.services.service.TourismApplicationStagesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TourismApplicationStagesService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		tourismApplicationStagesService =
			(TourismApplicationStagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return TourismApplicationStagesService.class.getName();
	}
	...
	protected TourismApplicationStagesService tourismApplicationStagesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TourismApplicationStagesServiceBaseImpl.class);
