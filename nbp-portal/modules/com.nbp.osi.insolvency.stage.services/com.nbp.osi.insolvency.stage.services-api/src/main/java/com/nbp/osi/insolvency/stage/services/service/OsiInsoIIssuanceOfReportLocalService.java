...
/**
 * Provides the local service interface for OsiInsoIIssuanceOfReport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiInsoIIssuanceOfReportLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiInsoIIssuanceOfReportLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.stage.services.service.impl.OsiInsoIIssuanceOfReportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi inso i issuance of report local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiInsoIIssuanceOfReportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OsiInsoIIssuanceOfReport
