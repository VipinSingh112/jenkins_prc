...
/**
 * <p>
 * This class is a wrapper for {@link OsiInsolvencyPaymentConfirmation}.
 * </p>
 *
 ...
 * @generated
 */
public class OsiInsolvencyPaymentConfirmationWrapper
	extends BaseModelWrapper<OsiInsolvencyPaymentConfirmation>
	implements ModelWrapper<OsiInsolvencyPaymentConfirmation>,
			   OsiInsolvencyPaymentConfirmation {

	public OsiInsolvencyPaymentConfirmationWrapper(
		OsiInsolvencyPaymentConfirmation osiInsolvencyPaymentConfirmation) {

		super(osiInsolvencyPaymentConfirmation);
	}
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("osiIRPaymentId", getOsiIRPaymentId());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		Long osiIRPaymentId = (Long)attributes.get("osiIRPaymentId");

		if (osiIRPaymentId != null) {
			setOsiIRPaymentId(osiIRPaymentId);
		}
	...
	public long getOsiIRPaymentId() {
		return model.getOsiIRPaymentId();
	}
	...
	public void setOsiIRPaymentId(long osiIRPaymentId) {
		model.setOsiIRPaymentId(osiIRPaymentId);
	}
	...
	@Override
	protected OsiInsolvencyPaymentConfirmationWrapper wrap(
		OsiInsolvencyPaymentConfirmation osiInsolvencyPaymentConfirmation) {

		return new OsiInsolvencyPaymentConfirmationWrapper(
			osiInsolvencyPaymentConfirmation);
	}
