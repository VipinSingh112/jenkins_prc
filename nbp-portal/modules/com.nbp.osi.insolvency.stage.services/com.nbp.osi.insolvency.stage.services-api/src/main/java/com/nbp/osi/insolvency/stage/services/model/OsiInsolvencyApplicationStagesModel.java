...
/**
 * The base model interface for the OsiInsolvencyApplicationStages service. Represents a row in the &quot;nbp_osi_insolvency_app_stages&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.insolvency.stage.services.model.impl.OsiInsolvencyApplicationStagesModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.insolvency.stage.services.model.impl.OsiInsolvencyApplicationStagesImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface OsiInsolvencyApplicationStagesModel
	extends BaseModel<OsiInsolvencyApplicationStages>, GroupedModel,
			ShardedModel, StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a osi insolvency application stages model instance should use the {@link OsiInsolvencyApplicationStages} interface instead.
	 */
