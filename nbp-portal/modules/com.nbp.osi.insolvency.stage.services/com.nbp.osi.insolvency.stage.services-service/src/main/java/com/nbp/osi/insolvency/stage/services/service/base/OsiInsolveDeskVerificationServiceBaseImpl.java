...
import com.nbp.osi.insolvency.stage.services.service.OsiInsolveDeskVerificationService;
...
/**
 * Provides the base implementation for the osi insolve desk verification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.stage.services.service.impl.OsiInsolveDeskVerificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.stage.services.service.impl.OsiInsolveDeskVerificationServiceImpl
 * @generated
 */
public abstract class OsiInsolveDeskVerificationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiInsolveDeskVerificationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolveDeskVerificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.stage.services.service.OsiInsolveDeskVerificationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolveDeskVerificationService =
			(OsiInsolveDeskVerificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolveDeskVerificationService.class.getName();
	}
	...
	protected OsiInsolveDeskVerificationService
		osiInsolveDeskVerificationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolveDeskVerificationServiceBaseImpl.class);
