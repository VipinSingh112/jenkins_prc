...
import com.nbp.farm.application.stages.service.service.FarmApplicationStagesLocalService;
...
/**
 * Provides the base implementation for the farm application stages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.stages.service.service.impl.FarmApplicationStagesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.stages.service.service.impl.FarmApplicationStagesLocalServiceImpl
 * @generated
 */
public abstract class FarmApplicationStagesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FarmApplicationStagesLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmApplicationStagesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmApplicationStagesLocalServiceUtil</code>.
	 */
	...
	public FarmApplicationStages addFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.update(farmApplicationStages);
	}
	...
	public FarmApplicationStages createFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.create(farmApplicationStagesId);
	}
	...
	public FarmApplicationStages deleteFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.remove(farmApplicationStagesId);
	}
	...
	public FarmApplicationStages deleteFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.remove(farmApplicationStages);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return farmApplicationStagesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FarmApplicationStages.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return farmApplicationStagesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return farmApplicationStagesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FarmApplicationStages fetchFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.fetchByPrimaryKey(
	...
	public FarmApplicationStages fetchFarmApplicationStagesByUuidAndGroupId(
		...
		return farmApplicationStagesPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public FarmApplicationStages getFarmApplicationStages(
		...
		return farmApplicationStagesPersistence.findByPrimaryKey(
			farmApplicationStagesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			farmApplicationStagesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FarmApplicationStages.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, farmApplicationStages);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					FarmApplicationStages.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return farmApplicationStagesPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return farmApplicationStagesLocalService.deleteFarmApplicationStages(
			(FarmApplicationStages)persistedModel);
	}

	@Override
	public BasePersistence<FarmApplicationStages> getBasePersistence() {
		return farmApplicationStagesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return farmApplicationStagesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FarmApplicationStages>
		...
		return farmApplicationStagesPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<FarmApplicationStages>
		...
		return farmApplicationStagesPersistence.findByUuid_C(
	...
	public FarmApplicationStages getFarmApplicationStagesByUuidAndGroupId(
		...
		return farmApplicationStagesPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<FarmApplicationStages> getFarmApplicationStageses(
		...
		return farmApplicationStagesPersistence.findAll(start, end);
	}
	...
	public int getFarmApplicationStagesesCount() {
		return farmApplicationStagesPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmApplicationStagesLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		farmApplicationStagesLocalService =
			(FarmApplicationStagesLocalService)aopProxy;

		_setLocalServiceUtilService(farmApplicationStagesLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmApplicationStagesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				farmApplicationStagesPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FarmApplicationStagesLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, farmApplicationStagesLocalService);
		}
	...
	protected FarmApplicationStagesLocalService
		farmApplicationStagesLocalService;
