...
/**
 * Provides the local service interface for FarmPermit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmPermitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmPermitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.farm.application.stages.service.service.impl.FarmPermitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farm permit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmPermitLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FarmPermit addFarmPermit(FarmPermit farmPermit);
	...
	public FarmPermit createFarmPermit(long farmPermitId);
	...
	public FarmPermit deleteFarmPermit(FarmPermit farmPermit);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FarmPermit deleteFarmPermit(long farmPermitId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmPermit fetchFarmPermit(long farmPermitId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmPermit getFarmBY_CI(String caseId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmPermit getFarmPermit(long farmPermitId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FarmPermit> getFarmPermits(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FarmPermit updateFarmPermit(FarmPermit farmPermit);

	public FarmPermit updateFarmPermit(
		String caseId, String PIRPermtNumber, Date dateofIssue,
		Date dateofExpiration, long docFileEntryId);

	public FarmPermit updateFarmPermit(
		String caseId, String PIRPermtNumber, Date dateofIssue,
		Date dateofExpiration, long docFileEntryId, String durationOfPermit);
