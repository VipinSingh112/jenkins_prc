...
/**
 * The persistence utility for the ogt claimant detail service. This utility wraps <code>com.nbp.ogt.application.form.services.service.persistence.impl.OgtClaimantDetailPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see OgtClaimantDetailPersistence
 * @generated
 */
public class OgtClaimantDetailUtil {
	 ...
	 */
	public static void clearCache(OgtClaimantDetail ogtClaimantDetail) {
		getPersistence().clearCache(ogtClaimantDetail);
	}
	 ...
	 */
	public static Map<Serializable, OgtClaimantDetail> fetchByPrimaryKeys(
	 ...
	 */
	public static List<OgtClaimantDetail> findWithDynamicQuery(
	 ...
	 */
	public static OgtClaimantDetail update(
		OgtClaimantDetail ogtClaimantDetail) {

		return getPersistence().update(ogtClaimantDetail);
	}
	 ...
	 */
	public static OgtClaimantDetail update(
		OgtClaimantDetail ogtClaimantDetail, ServiceContext serviceContext) {

		return getPersistence().update(ogtClaimantDetail, serviceContext);
	}
	 ...
	 */
	public static OgtClaimantDetail findBygetOgtById(long ogtApplicationId)
	 ...
	 */
	public static OgtClaimantDetail fetchBygetOgtById(long ogtApplicationId) {
	 ...
	 * @return the matching ogt claimant detail, or <code>null</code> if a matching ogt claimant detail could not be found
	 */
	public static OgtClaimantDetail fetchBygetOgtById(
	 ...
	 */
	public static OgtClaimantDetail removeBygetOgtById(long ogtApplicationId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtClaimantDetailException {
	 ...
	 */
	public static void cacheResult(OgtClaimantDetail ogtClaimantDetail) {
		getPersistence().cacheResult(ogtClaimantDetail);
	}
	 ...
	 */
	public static void cacheResult(List<OgtClaimantDetail> ogtClaimantDetails) {
		getPersistence().cacheResult(ogtClaimantDetails);
	}
	 ...
	 */
	public static OgtClaimantDetail create(long ogtClaimantDetailId) {
		return getPersistence().create(ogtClaimantDetailId);
	}
	 ...
	 */
	public static OgtClaimantDetail remove(long ogtClaimantDetailId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtClaimantDetailException {

		return getPersistence().remove(ogtClaimantDetailId);
	}

	public static OgtClaimantDetail updateImpl(
		OgtClaimantDetail ogtClaimantDetail) {

		return getPersistence().updateImpl(ogtClaimantDetail);
	}
	 ...
	 * @throws NoSuchOgtClaimantDetailException if a ogt claimant detail with the primary key could not be found
	 */
	public static OgtClaimantDetail findByPrimaryKey(long ogtClaimantDetailId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtClaimantDetailException {

		return getPersistence().findByPrimaryKey(ogtClaimantDetailId);
	}
	 ...
	 */
	public static OgtClaimantDetail fetchByPrimaryKey(
		long ogtClaimantDetailId) {

		return getPersistence().fetchByPrimaryKey(ogtClaimantDetailId);
	}
	 ...
	 */
	public static List<OgtClaimantDetail> findAll() {
	 ...
	 */
	public static List<OgtClaimantDetail> findAll(int start, int end) {
	...
	public static OgtClaimantDetailPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		OgtClaimantDetailPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile OgtClaimantDetailPersistence _persistence;
