...
/**
 * The persistence interface for the ogt claim to property service.
 *
 * <p>
 ...
 * @see OgtClaimToPropertyUtil
 * @generated
 */
@ProviderType
public interface OgtClaimToPropertyPersistence
	extends BasePersistence<OgtClaimToProperty> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OgtClaimToPropertyUtil} to access the ogt claim to property persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<OgtClaimToProperty> ogtClaimToProperties);
	...
	public OgtClaimToProperty updateImpl(OgtClaimToProperty ogtClaimToProperty);
	 ...
	 */
	public java.util.List<OgtClaimToProperty> findAll();
	 ...
	 */
	public java.util.List<OgtClaimToProperty> findAll(int start, int end);
	...
	public java.util.List<OgtClaimToProperty> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OgtClaimToProperty>
			orderByComparator);
