...
/**
 * Provides the local service interface for OgtClaimToProperty. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OgtClaimToPropertyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OgtClaimToPropertyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ogt.application.form.services.service.impl.OgtClaimToPropertyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ogt claim to property local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OgtClaimToPropertyLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OgtClaimToProperty getOgtById(long ogtApplicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OgtClaimToProperty> getOgtClaimToProperties(int start, int end);
