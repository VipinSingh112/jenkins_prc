...
/**
 * Provides the local service utility for OgtClaimToProperty. This utility wraps
 * <code>com.nbp.ogt.application.form.services.service.impl.OgtClaimToPropertyLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OgtClaimToPropertyLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ogt.application.form.services.service.impl.OgtClaimToPropertyLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OgtClaimToProperty addOgtClaimToProperty(
		OgtClaimToProperty ogtClaimToProperty) {

		return getService().addOgtClaimToProperty(ogtClaimToProperty);
	}
	 ...
	 */
	public static OgtClaimToProperty createOgtClaimToProperty(
		long ogtClaimToPropertyId) {

		return getService().createOgtClaimToProperty(ogtClaimToPropertyId);
	}
	 ...
	 */
	public static OgtClaimToProperty deleteOgtClaimToProperty(
			long ogtClaimToPropertyId)
		throws PortalException {

		return getService().deleteOgtClaimToProperty(ogtClaimToPropertyId);
	}
	...
	public static OgtClaimToProperty deleteOgtClaimToProperty(
		...
		return getService().deleteOgtClaimToProperty(ogtClaimToProperty);
	}
	...
	public static OgtClaimToProperty fetchOgtClaimToProperty(
		long ogtClaimToPropertyId) {

		return getService().fetchOgtClaimToProperty(ogtClaimToPropertyId);
	}
	...
	public static OgtClaimToProperty getOgtById(long ogtApplicationId)
	 ...
	 */
	public static List<OgtClaimToProperty> getOgtClaimToProperties(
		int start, int end) {

		return getService().getOgtClaimToProperties(start, end);
	}
	 ...
	 */
	public static int getOgtClaimToPropertiesCount() {
		return getService().getOgtClaimToPropertiesCount();
	}
	 ...
	 * @throws PortalException if a ogt claim to property with the primary key could not be found
	 */
	public static OgtClaimToProperty getOgtClaimToProperty(
			long ogtClaimToPropertyId)
		throws PortalException {

		return getService().getOgtClaimToProperty(ogtClaimToPropertyId);
	}
	 ...
	 */
	public static OgtClaimToProperty updateOgtClaimToProperty(
		OgtClaimToProperty ogtClaimToProperty) {

		return getService().updateOgtClaimToProperty(ogtClaimToProperty);
	}

	public static OgtClaimToPropertyLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OgtClaimToPropertyLocalService>
		_serviceSnapshot = new Snapshot<>(
			OgtClaimToPropertyLocalServiceUtil.class,
			OgtClaimToPropertyLocalService.class);
