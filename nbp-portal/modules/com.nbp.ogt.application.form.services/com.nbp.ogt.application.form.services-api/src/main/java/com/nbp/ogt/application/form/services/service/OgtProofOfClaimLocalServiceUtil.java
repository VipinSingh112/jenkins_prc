...
/**
 * Provides the local service utility for OgtProofOfClaim. This utility wraps
 * <code>com.nbp.ogt.application.form.services.service.impl.OgtProofOfClaimLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OgtProofOfClaimLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ogt.application.form.services.service.impl.OgtProofOfClaimLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OgtProofOfClaim addOgtProofOfClaim(
		OgtProofOfClaim ogtProofOfClaim) {

		return getService().addOgtProofOfClaim(ogtProofOfClaim);
	}
	 ...
	 */
	public static OgtProofOfClaim createOgtProofOfClaim(
		long ogtProofOfClaimId) {

		return getService().createOgtProofOfClaim(ogtProofOfClaimId);
	}
	 ...
	 */
	public static OgtProofOfClaim deleteOgtProofOfClaim(long ogtProofOfClaimId)
		throws PortalException {

		return getService().deleteOgtProofOfClaim(ogtProofOfClaimId);
	}
	 ...
	 * @return the ogt proof of claim that was removed
	 */
	public static OgtProofOfClaim deleteOgtProofOfClaim(
		OgtProofOfClaim ogtProofOfClaim) {

		return getService().deleteOgtProofOfClaim(ogtProofOfClaim);
	}
	...
	public static OgtProofOfClaim fetchOgtProofOfClaim(long ogtProofOfClaimId) {
		return getService().fetchOgtProofOfClaim(ogtProofOfClaimId);
	}
	...
	public static OgtProofOfClaim getOgtById(long ogtApplicationId)
	 ...
	 * @throws PortalException if a ogt proof of claim with the primary key could not be found
	 */
	public static OgtProofOfClaim getOgtProofOfClaim(long ogtProofOfClaimId)
		throws PortalException {

		return getService().getOgtProofOfClaim(ogtProofOfClaimId);
	}
	 ...
	 */
	public static List<OgtProofOfClaim> getOgtProofOfClaims(
		int start, int end) {

		return getService().getOgtProofOfClaims(start, end);
	}
	 ...
	 */
	public static int getOgtProofOfClaimsCount() {
		return getService().getOgtProofOfClaimsCount();
	}
	 ...
	 */
	public static OgtProofOfClaim updateOgtProofOfClaim(
		OgtProofOfClaim ogtProofOfClaim) {

		return getService().updateOgtProofOfClaim(ogtProofOfClaim);
	}

	public static OgtProofOfClaimLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OgtProofOfClaimLocalService>
		_serviceSnapshot = new Snapshot<>(
			OgtProofOfClaimLocalServiceUtil.class,
			OgtProofOfClaimLocalService.class);
