...
/**
 * The persistence utility for the ogt proof of claim service. This utility wraps <code>com.nbp.ogt.application.form.services.service.persistence.impl.OgtProofOfClaimPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see OgtProofOfClaimPersistence
 * @generated
 */
public class OgtProofOfClaimUtil {
	 ...
	 */
	public static void clearCache(OgtProofOfClaim ogtProofOfClaim) {
		getPersistence().clearCache(ogtProofOfClaim);
	}
	 ...
	 */
	public static Map<Serializable, OgtProofOfClaim> fetchByPrimaryKeys(
	 ...
	 */
	public static List<OgtProofOfClaim> findWithDynamicQuery(
	 ...
	 */
	public static OgtProofOfClaim update(OgtProofOfClaim ogtProofOfClaim) {
		return getPersistence().update(ogtProofOfClaim);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static OgtProofOfClaim update(
		OgtProofOfClaim ogtProofOfClaim, ServiceContext serviceContext) {

		return getPersistence().update(ogtProofOfClaim, serviceContext);
	}
	 ...
	 */
	public static OgtProofOfClaim findBygetOgtById(long ogtApplicationId)
	 ...
	 */
	public static OgtProofOfClaim fetchBygetOgtById(long ogtApplicationId) {
	 ...
	 * @return the matching ogt proof of claim, or <code>null</code> if a matching ogt proof of claim could not be found
	 */
	public static OgtProofOfClaim fetchBygetOgtById(
	 ...
	 */
	public static OgtProofOfClaim removeBygetOgtById(long ogtApplicationId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtProofOfClaimException {
	 ...
	 */
	public static void cacheResult(OgtProofOfClaim ogtProofOfClaim) {
		getPersistence().cacheResult(ogtProofOfClaim);
	}
	 ...
	 */
	public static void cacheResult(List<OgtProofOfClaim> ogtProofOfClaims) {
		getPersistence().cacheResult(ogtProofOfClaims);
	}
	 ...
	 */
	public static OgtProofOfClaim create(long ogtProofOfClaimId) {
		return getPersistence().create(ogtProofOfClaimId);
	}
	 ...
	 */
	public static OgtProofOfClaim remove(long ogtProofOfClaimId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtProofOfClaimException {

		return getPersistence().remove(ogtProofOfClaimId);
	}

	public static OgtProofOfClaim updateImpl(OgtProofOfClaim ogtProofOfClaim) {
		return getPersistence().updateImpl(ogtProofOfClaim);
	}
	 ...
	 * @throws NoSuchOgtProofOfClaimException if a ogt proof of claim with the primary key could not be found
	 */
	public static OgtProofOfClaim findByPrimaryKey(long ogtProofOfClaimId)
		throws com.nbp.ogt.application.form.services.exception.
			NoSuchOgtProofOfClaimException {

		return getPersistence().findByPrimaryKey(ogtProofOfClaimId);
	}
	 ...
	 */
	public static OgtProofOfClaim fetchByPrimaryKey(long ogtProofOfClaimId) {
		return getPersistence().fetchByPrimaryKey(ogtProofOfClaimId);
	}
	 ...
	 */
	public static List<OgtProofOfClaim> findAll() {
	 ...
	 */
	public static List<OgtProofOfClaim> findAll(int start, int end) {
	...
	public static OgtProofOfClaimPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(OgtProofOfClaimPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile OgtProofOfClaimPersistence _persistence;
