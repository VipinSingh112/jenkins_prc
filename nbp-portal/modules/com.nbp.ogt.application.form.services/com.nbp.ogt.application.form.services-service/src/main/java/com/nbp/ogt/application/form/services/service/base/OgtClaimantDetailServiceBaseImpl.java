...
import com.nbp.ogt.application.form.services.service.OgtClaimantDetailService;
...
/**
 * Provides the base implementation for the ogt claimant detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtClaimantDetailServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtClaimantDetailServiceImpl
 * @generated
 */
public abstract class OgtClaimantDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OgtClaimantDetailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtClaimantDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtClaimantDetailServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtClaimantDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ogtClaimantDetailService = (OgtClaimantDetailService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtClaimantDetailService.class.getName();
	}
	...
	protected OgtClaimantDetailService ogtClaimantDetailService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtClaimantDetailServiceBaseImpl.class);
