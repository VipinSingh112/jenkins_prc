...
import com.nbp.ogt.application.form.services.service.OgtApplicationService;
...
/**
 * Provides the base implementation for the ogt application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtApplicationServiceImpl
 * @generated
 */
public abstract class OgtApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OgtApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ogtApplicationService = (OgtApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtApplicationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ogt.application.form.services.service.OgtApplicationLocalService
			ogtApplicationLocalService;

	protected OgtApplicationService ogtApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtApplicationServiceBaseImpl.class);
