...
import com.nbp.ogt.application.form.services.service.OgtApplicationLocalService;
...
/**
 * Provides the base implementation for the ogt application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtApplicationLocalServiceImpl
 * @generated
 */
public abstract class OgtApplicationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, OgtApplicationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtApplicationLocalServiceUtil</code>.
	 */
	...
	public OgtApplication addOgtApplication(OgtApplication ogtApplication) {
		...
		return ogtApplicationPersistence.update(ogtApplication);
	}
	...
	public OgtApplication createOgtApplication(long ogtApplicationId) {
		return ogtApplicationPersistence.create(ogtApplicationId);
	}
	...
	public OgtApplication deleteOgtApplication(long ogtApplicationId)
		...
		return ogtApplicationPersistence.remove(ogtApplicationId);
	}
	...
	public OgtApplication deleteOgtApplication(OgtApplication ogtApplication) {
		return ogtApplicationPersistence.remove(ogtApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ogtApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OgtApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ogtApplicationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ogtApplicationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ogtApplicationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ogtApplicationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OgtApplication fetchOgtApplication(long ogtApplicationId) {
		return ogtApplicationPersistence.fetchByPrimaryKey(ogtApplicationId);
	}
	...
	public OgtApplication getOgtApplication(long ogtApplicationId)
		...
		return ogtApplicationPersistence.findByPrimaryKey(ogtApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ogtApplicationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OgtApplication.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ogtApplicationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ogtApplicationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OgtApplication.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ogtApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OgtApplicationLocalServiceImpl#deleteOgtApplication(OgtApplication) to avoid orphaned data");
		}

		return ogtApplicationLocalService.deleteOgtApplication(
			(OgtApplication)persistedModel);
	}

	@Override
	public BasePersistence<OgtApplication> getBasePersistence() {
		return ogtApplicationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ogtApplicationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OgtApplication> getOgtApplications(int start, int end) {
		return ogtApplicationPersistence.findAll(start, end);
	}
	...
	public int getOgtApplicationsCount() {
		return ogtApplicationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtApplicationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ogtApplicationLocalService = (OgtApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ogtApplicationPersistence.getDataSource();
	...
	protected OgtApplicationLocalService ogtApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtApplicationLocalServiceBaseImpl.class);
