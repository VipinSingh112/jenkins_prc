...
import com.nbp.ogt.application.form.services.service.OgtProofOfClaimService;
...
/**
 * Provides the base implementation for the ogt proof of claim remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtProofOfClaimServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtProofOfClaimServiceImpl
 * @generated
 */
public abstract class OgtProofOfClaimServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OgtProofOfClaimService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtProofOfClaimService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtProofOfClaimServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtProofOfClaimService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ogtProofOfClaimService = (OgtProofOfClaimService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtProofOfClaimService.class.getName();
	}
	...
	protected OgtProofOfClaimService ogtProofOfClaimService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtProofOfClaimServiceBaseImpl.class);
