...
import com.nbp.ogt.application.form.services.service.OgtClaimToSpouseLocalService;
...
/**
 * Provides the base implementation for the ogt claim to spouse local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtClaimToSpouseLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtClaimToSpouseLocalServiceImpl
 * @generated
 */
public abstract class OgtClaimToSpouseLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OgtClaimToSpouseLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtClaimToSpouseLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtClaimToSpouseLocalServiceUtil</code>.
	 */
	...
	public OgtClaimToSpouse addOgtClaimToSpouse(
		...
		return ogtClaimToSpousePersistence.update(ogtClaimToSpouse);
	}
	...
	public OgtClaimToSpouse createOgtClaimToSpouse(long ogtClaimToSpouseId) {
		return ogtClaimToSpousePersistence.create(ogtClaimToSpouseId);
	}
	...
	public OgtClaimToSpouse deleteOgtClaimToSpouse(long ogtClaimToSpouseId)
		...
		return ogtClaimToSpousePersistence.remove(ogtClaimToSpouseId);
	}
	...
	public OgtClaimToSpouse deleteOgtClaimToSpouse(
		...
		return ogtClaimToSpousePersistence.remove(ogtClaimToSpouse);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ogtClaimToSpousePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OgtClaimToSpouse.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ogtClaimToSpousePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ogtClaimToSpousePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ogtClaimToSpousePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ogtClaimToSpousePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OgtClaimToSpouse fetchOgtClaimToSpouse(long ogtClaimToSpouseId) {
		return ogtClaimToSpousePersistence.fetchByPrimaryKey(
			ogtClaimToSpouseId);
	}
	...
	public OgtClaimToSpouse getOgtClaimToSpouse(long ogtClaimToSpouseId)
		...
		return ogtClaimToSpousePersistence.findByPrimaryKey(ogtClaimToSpouseId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OgtClaimToSpouse.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ogtClaimToSpouseId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(OgtClaimToSpouse.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ogtClaimToSpousePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OgtClaimToSpouseLocalServiceImpl#deleteOgtClaimToSpouse(OgtClaimToSpouse) to avoid orphaned data");
		}

		return ogtClaimToSpouseLocalService.deleteOgtClaimToSpouse(
			(OgtClaimToSpouse)persistedModel);
	}

	@Override
	public BasePersistence<OgtClaimToSpouse> getBasePersistence() {
		return ogtClaimToSpousePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ogtClaimToSpousePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<OgtClaimToSpouse> getOgtClaimToSpouses(int start, int end) {
		return ogtClaimToSpousePersistence.findAll(start, end);
	}
	...
	public int getOgtClaimToSpousesCount() {
		return ogtClaimToSpousePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtClaimToSpouseLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ogtClaimToSpouseLocalService = (OgtClaimToSpouseLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtClaimToSpouseLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ogtClaimToSpousePersistence.getDataSource();
	...
	protected OgtClaimToSpouseLocalService ogtClaimToSpouseLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtClaimToSpouseLocalServiceBaseImpl.class);
