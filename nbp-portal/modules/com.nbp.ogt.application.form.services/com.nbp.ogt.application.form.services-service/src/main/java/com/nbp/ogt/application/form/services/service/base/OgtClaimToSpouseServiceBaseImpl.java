...
import com.nbp.ogt.application.form.services.service.OgtClaimToSpouseService;
...
/**
 * Provides the base implementation for the ogt claim to spouse remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtClaimToSpouseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtClaimToSpouseServiceImpl
 * @generated
 */
public abstract class OgtClaimToSpouseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OgtClaimToSpouseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtClaimToSpouseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtClaimToSpouseServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtClaimToSpouseService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ogtClaimToSpouseService = (OgtClaimToSpouseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtClaimToSpouseService.class.getName();
	}
	...
	protected OgtClaimToSpouseService ogtClaimToSpouseService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtClaimToSpouseServiceBaseImpl.class);
