...
import com.nbp.ogt.application.form.services.service.OgtSectionBService;
...
/**
 * Provides the base implementation for the ogt section b remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ogt.application.form.services.service.impl.OgtSectionBServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ogt.application.form.services.service.impl.OgtSectionBServiceImpl
 * @generated
 */
public abstract class OgtSectionBServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OgtSectionBService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OgtSectionBService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ogt.application.form.services.service.OgtSectionBServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OgtSectionBService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ogtSectionBService = (OgtSectionBService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OgtSectionBService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ogt.application.form.services.service.OgtSectionBLocalService
			ogtSectionBLocalService;

	protected OgtSectionBService ogtSectionBService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OgtSectionBServiceBaseImpl.class);
