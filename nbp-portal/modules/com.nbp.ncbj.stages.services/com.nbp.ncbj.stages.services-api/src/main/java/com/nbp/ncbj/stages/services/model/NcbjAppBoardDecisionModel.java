...
/**
 * The base model interface for the NcbjAppBoardDecision service. Represents a row in the &quot;nbp_ncbj_board_decision&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.ncbj.stages.services.model.impl.NcbjAppBoardDecisionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.ncbj.stages.services.model.impl.NcbjAppBoardDecisionImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface NcbjAppBoardDecisionModel
	extends BaseModel<NcbjAppBoardDecision>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ncbj app board decision model instance should use the {@link NcbjAppBoardDecision} interface instead.
	 */
