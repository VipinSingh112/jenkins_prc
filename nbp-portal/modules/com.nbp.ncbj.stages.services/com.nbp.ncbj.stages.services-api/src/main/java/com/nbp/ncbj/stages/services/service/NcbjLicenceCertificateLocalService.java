...
/**
 * Provides the local service interface for NcbjLicenceCertificate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcbjLicenceCertificateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcbjLicenceCertificateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncbj.stages.services.service.impl.NcbjLicenceCertificateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncbj licence certificate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcbjLicenceCertificateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NcbjLicenceCertificate updateNcbjLicenceCertificate(
		...
		String nameOfCerti, String scopeOfCerti, Date issueDate,
