...
/**
 * The base model interface for the NcbjInspection service. Represents a row in the &quot;nbp_ncbj_inspection&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.ncbj.stages.services.model.impl.NcbjInspectionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.ncbj.stages.services.model.impl.NcbjInspectionImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface NcbjInspectionModel
	extends BaseModel<NcbjInspection>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ncbj inspection model instance should use the {@link NcbjInspection} interface instead.
	 */
