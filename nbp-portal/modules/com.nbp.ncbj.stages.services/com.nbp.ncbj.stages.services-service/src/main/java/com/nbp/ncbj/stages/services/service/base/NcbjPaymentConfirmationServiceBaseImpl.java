...
import com.nbp.ncbj.stages.services.service.NcbjPaymentConfirmationService;
...
/**
 * Provides the base implementation for the ncbj payment confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.stages.services.service.impl.NcbjPaymentConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.stages.services.service.impl.NcbjPaymentConfirmationServiceImpl
 * @generated
 */
public abstract class NcbjPaymentConfirmationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjPaymentConfirmationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjPaymentConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.stages.services.service.NcbjPaymentConfirmationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjPaymentConfirmationService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		ncbjPaymentConfirmationService =
			(NcbjPaymentConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjPaymentConfirmationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ncbj.stages.services.service.NcbjPaymentConfirmationLocalService
			ncbjPaymentConfirmationLocalService;

	protected NcbjPaymentConfirmationService ncbjPaymentConfirmationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjPaymentConfirmationServiceBaseImpl.class);
