...
import com.nbp.ncbj.stages.services.service.NcbjApplicationStagesService;
...
/**
 * Provides the base implementation for the ncbj application stages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.stages.services.service.impl.NcbjApplicationStagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.stages.services.service.impl.NcbjApplicationStagesServiceImpl
 * @generated
 */
public abstract class NcbjApplicationStagesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjApplicationStagesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjApplicationStagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.stages.services.service.NcbjApplicationStagesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjApplicationStagesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjApplicationStagesService = (NcbjApplicationStagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjApplicationStagesService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ncbj.stages.services.service.NcbjApplicationStagesLocalService
			ncbjApplicationStagesLocalService;

	protected NcbjApplicationStagesService ncbjApplicationStagesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjApplicationStagesServiceBaseImpl.class);
