...
import com.nbp.ncbj.stages.services.service.NcbjLicenceCertificateService;
...
/**
 * Provides the base implementation for the ncbj licence certificate remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncbj.stages.services.service.impl.NcbjLicenceCertificateServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncbj.stages.services.service.impl.NcbjLicenceCertificateServiceImpl
 * @generated
 */
public abstract class NcbjLicenceCertificateServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NcbjLicenceCertificateService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcbjLicenceCertificateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncbj.stages.services.service.NcbjLicenceCertificateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcbjLicenceCertificateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncbjLicenceCertificateService = (NcbjLicenceCertificateService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcbjLicenceCertificateService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.ncbj.stages.services.service.NcbjLicenceCertificateLocalService
			ncbjLicenceCertificateLocalService;

	protected NcbjLicenceCertificateService ncbjLicenceCertificateService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcbjLicenceCertificateServiceBaseImpl.class);
