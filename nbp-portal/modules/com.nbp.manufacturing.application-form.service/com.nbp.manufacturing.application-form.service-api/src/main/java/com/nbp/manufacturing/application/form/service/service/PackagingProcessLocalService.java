...
/**
 * Provides the local service interface for PackagingProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PackagingProcessLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PackagingProcessLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.form.service.service.impl.PackagingProcessLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the packaging process local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PackagingProcessLocalServiceUtil} if injection and service tracking are not available.
	 */
