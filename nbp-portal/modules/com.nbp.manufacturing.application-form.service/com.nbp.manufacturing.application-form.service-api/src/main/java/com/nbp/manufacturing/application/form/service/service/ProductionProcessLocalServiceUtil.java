...
/**
 * Provides the local service utility for ProductionProcess. This utility wraps
 * <code>com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProductionProcessLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProductionProcess addProductionProcess(
		ProductionProcess productionProcess) {

		return getService().addProductionProcess(productionProcess);
	}
	 ...
	 */
	public static ProductionProcess createProductionProcess(
		long productionProcessId) {

		return getService().createProductionProcess(productionProcessId);
	}
	 ...
	 */
	public static ProductionProcess deleteProductionProcess(
			long productionProcessId)
		throws PortalException {

		return getService().deleteProductionProcess(productionProcessId);
	}
	...
	public static ProductionProcess deleteProductionProcess(
		...
		return getService().deleteProductionProcess(productionProcess);
	}
	...
	public static ProductionProcess fetchProductionProcess(
		long productionProcessId) {

		return getService().fetchProductionProcess(productionProcessId);
	}
	...
	public static List<ProductionProcess> getMA_PDP_MAI(long applicationId) {
		return getService().getMA_PDP_MAI(applicationId);
	}

	public static ProductionProcess getManuByAppId(long applicationId)
	 ...
	 * @throws PortalException if a production process with the primary key could not be found
	 */
	public static ProductionProcess getProductionProcess(
			long productionProcessId)
		throws PortalException {

		return getService().getProductionProcess(productionProcessId);
	}
	 ...
	 */
	public static List<ProductionProcess> getProductionProcesses(
		int start, int end) {

		return getService().getProductionProcesses(start, end);
	}
	 ...
	 */
	public static int getProductionProcessesCount() {
		return getService().getProductionProcessesCount();
	}
	 ...
	 */
	public static ProductionProcess updateProductionProcess(
		ProductionProcess productionProcess) {

		return getService().updateProductionProcess(productionProcess);
	}

	public static ProductionProcessLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<ProductionProcessLocalService>
		_serviceSnapshot = new Snapshot<>(
			ProductionProcessLocalServiceUtil.class,
			ProductionProcessLocalService.class);
