...
/**
 * Provides the local service interface for ProductionProcess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProductionProcessLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProductionProcessLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the production process local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProductionProcessLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProductionProcess addProductionProcess(
	...
	public ProductionProcess createProductionProcess(long productionProcessId);
	...
	public ProductionProcess deleteProductionProcess(long productionProcessId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ProductionProcess deleteProductionProcess(
		ProductionProcess productionProcess);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProductionProcess fetchProductionProcess(long productionProcessId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProductionProcess getManuByAppId(long applicationId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProductionProcess getProductionProcess(long productionProcessId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProductionProcess> getProductionProcesses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProductionProcess updateProductionProcess(
		ProductionProcess productionProcess);
