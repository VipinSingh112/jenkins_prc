...
/**
 * Provides the local service utility for ManuExportData. This utility wraps
 * <code>com.nbp.manufacturing.application.form.service.service.impl.ManuExportDataLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ManuExportDataLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.manufacturing.application.form.service.service.impl.ManuExportDataLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ManuExportData addManuExportData(
		ManuExportData manuExportData) {

		return getService().addManuExportData(manuExportData);
	}
	 ...
	 */
	public static ManuExportData createManuExportData(long manuExportDataId) {
		return getService().createManuExportData(manuExportDataId);
	}
	 ...
	 */
	public static ManuExportData deleteManuExportData(long manuExportDataId)
		throws PortalException {

		return getService().deleteManuExportData(manuExportDataId);
	}
	 ...
	 * @return the manu export data that was removed
	 */
	public static ManuExportData deleteManuExportData(
		ManuExportData manuExportData) {

		return getService().deleteManuExportData(manuExportData);
	}
	...
	public static ManuExportData fetchManuExportData(long manuExportDataId) {
		return getService().fetchManuExportData(manuExportDataId);
	}
	...
	public static List<ManuExportData> getMA_ED_MAI(long applicationId) {
		return getService().getMA_ED_MAI(applicationId);
	}

	public static ManuExportData getManuByAppId(long applicationId) {
	 ...
	 * @throws PortalException if a manu export data with the primary key could not be found
	 */
	public static ManuExportData getManuExportData(long manuExportDataId)
		throws PortalException {

		return getService().getManuExportData(manuExportDataId);
	}
	 ...
	 */
	public static List<ManuExportData> getManuExportDatas(int start, int end) {
		return getService().getManuExportDatas(start, end);
	}
	 ...
	 */
	public static int getManuExportDatasCount() {
		return getService().getManuExportDatasCount();
	}
	 ...
	 */
	public static ManuExportData updateManuExportData(
		ManuExportData manuExportData) {

		return getService().updateManuExportData(manuExportData);
	}

	public static ManuExportDataLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<ManuExportDataLocalService> _serviceSnapshot =
		new Snapshot<>(
			ManuExportDataLocalServiceUtil.class,
			ManuExportDataLocalService.class);
