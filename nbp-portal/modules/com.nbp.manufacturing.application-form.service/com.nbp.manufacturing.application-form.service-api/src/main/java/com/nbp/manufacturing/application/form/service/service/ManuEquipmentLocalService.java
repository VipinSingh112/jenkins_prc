...
/**
 * Provides the local service interface for ManuEquipment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManuEquipmentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ManuEquipmentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.form.service.service.impl.ManuEquipmentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the manu equipment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ManuEquipmentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ManuEquipment addManuEquipment(ManuEquipment manuEquipment);
	...
	public ManuEquipment createManuEquipment(long manuEquipmentId);
	...
	public ManuEquipment deleteManuEquipment(long manuEquipmentId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ManuEquipment deleteManuEquipment(ManuEquipment manuEquipment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManuEquipment fetchManuEquipment(long manuEquipmentId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManuEquipment getManuEquipment(long manuEquipmentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManuEquipment> getManuEquipments(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ManuEquipment updateManuEquipment(ManuEquipment manuEquipment);
