...
import com.nbp.manufacturing.application.form.service.service.ProductionProcessService;
...
/**
 * Provides the base implementation for the production process remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessServiceImpl
 * @generated
 */
public abstract class ProductionProcessServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProductionProcessService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductionProcessService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ProductionProcessServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductionProcessService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		productionProcessService = (ProductionProcessService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductionProcessService.class.getName();
	}
	...
	protected ProductionProcessService productionProcessService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductionProcessServiceBaseImpl.class);
