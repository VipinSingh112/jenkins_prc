...
import com.nbp.manufacturing.application.form.service.service.PackagingProcessService;
...
/**
 * Provides the base implementation for the packaging process remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.PackagingProcessServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.PackagingProcessServiceImpl
 * @generated
 */
public abstract class PackagingProcessServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PackagingProcessService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PackagingProcessService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.PackagingProcessServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PackagingProcessService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		packagingProcessService = (PackagingProcessService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PackagingProcessService.class.getName();
	}
	...
	protected PackagingProcessService packagingProcessService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PackagingProcessServiceBaseImpl.class);
