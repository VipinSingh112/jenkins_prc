...
import com.nbp.manufacturing.application.form.service.service.ManuCompanyInfoAddressService;
...
/**
 * Provides the base implementation for the manu company info address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManuCompanyInfoAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManuCompanyInfoAddressServiceImpl
 * @generated
 */
public abstract class ManuCompanyInfoAddressServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ManuCompanyInfoAddressService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManuCompanyInfoAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManuCompanyInfoAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ManuCompanyInfoAddressService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		manuCompanyInfoAddressService = (ManuCompanyInfoAddressService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManuCompanyInfoAddressService.class.getName();
	}
	...
	protected ManuCompanyInfoAddressService manuCompanyInfoAddressService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManuCompanyInfoAddressServiceBaseImpl.class);
