...
import com.nbp.manufacturing.application.form.service.service.ManuEquipmentLocalService;
...
/**
 * Provides the base implementation for the manu equipment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManuEquipmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManuEquipmentLocalServiceImpl
 * @generated
 */
public abstract class ManuEquipmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ManuEquipmentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManuEquipmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManuEquipmentLocalServiceUtil</code>.
	 */
	...
	public ManuEquipment addManuEquipment(ManuEquipment manuEquipment) {
		...
		return manuEquipmentPersistence.update(manuEquipment);
	}
	...
	public ManuEquipment createManuEquipment(long manuEquipmentId) {
		return manuEquipmentPersistence.create(manuEquipmentId);
	}
	...
	public ManuEquipment deleteManuEquipment(long manuEquipmentId)
		...
		return manuEquipmentPersistence.remove(manuEquipmentId);
	}
	...
	public ManuEquipment deleteManuEquipment(ManuEquipment manuEquipment) {
		return manuEquipmentPersistence.remove(manuEquipment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return manuEquipmentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ManuEquipment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return manuEquipmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return manuEquipmentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return manuEquipmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return manuEquipmentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ManuEquipment fetchManuEquipment(long manuEquipmentId) {
		return manuEquipmentPersistence.fetchByPrimaryKey(manuEquipmentId);
	}
	...
	public ManuEquipment getManuEquipment(long manuEquipmentId)
		...
		return manuEquipmentPersistence.findByPrimaryKey(manuEquipmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(manuEquipmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ManuEquipment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("manuEquipmentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			manuEquipmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ManuEquipment.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return manuEquipmentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ManuEquipmentLocalServiceImpl#deleteManuEquipment(ManuEquipment) to avoid orphaned data");
		}

		return manuEquipmentLocalService.deleteManuEquipment(
			(ManuEquipment)persistedModel);
	}

	@Override
	public BasePersistence<ManuEquipment> getBasePersistence() {
		return manuEquipmentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return manuEquipmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ManuEquipment> getManuEquipments(int start, int end) {
		return manuEquipmentPersistence.findAll(start, end);
	}
	...
	public int getManuEquipmentsCount() {
		return manuEquipmentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ManuEquipmentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		manuEquipmentLocalService = (ManuEquipmentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManuEquipmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = manuEquipmentPersistence.getDataSource();
	...
	protected ManuEquipmentLocalService manuEquipmentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManuEquipmentLocalServiceBaseImpl.class);
