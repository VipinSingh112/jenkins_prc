...
import com.nbp.manufacturing.application.form.service.service.ManuExportDataService;
...
/**
 * Provides the base implementation for the manu export data remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManuExportDataServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManuExportDataServiceImpl
 * @generated
 */
public abstract class ManuExportDataServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ManuExportDataService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManuExportDataService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManuExportDataServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ManuExportDataService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		manuExportDataService = (ManuExportDataService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManuExportDataService.class.getName();
	}
	...
	protected ManuExportDataService manuExportDataService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManuExportDataServiceBaseImpl.class);
