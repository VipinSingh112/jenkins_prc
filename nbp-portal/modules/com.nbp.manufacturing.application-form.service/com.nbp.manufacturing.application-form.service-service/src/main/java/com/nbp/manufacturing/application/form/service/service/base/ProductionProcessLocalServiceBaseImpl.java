...
import com.nbp.manufacturing.application.form.service.service.ProductionProcessLocalService;
...
/**
 * Provides the base implementation for the production process local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ProductionProcessLocalServiceImpl
 * @generated
 */
public abstract class ProductionProcessLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProductionProcessLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductionProcessLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ProductionProcessLocalServiceUtil</code>.
	 */
	...
	public ProductionProcess addProductionProcess(
		...
		return productionProcessPersistence.update(productionProcess);
	}
	...
	public ProductionProcess createProductionProcess(long productionProcessId) {
		return productionProcessPersistence.create(productionProcessId);
	}
	...
	public ProductionProcess deleteProductionProcess(long productionProcessId)
		...
		return productionProcessPersistence.remove(productionProcessId);
	}
	...
	public ProductionProcess deleteProductionProcess(
		...
		return productionProcessPersistence.remove(productionProcess);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return productionProcessPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductionProcess.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return productionProcessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return productionProcessPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return productionProcessPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return productionProcessPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProductionProcess fetchProductionProcess(long productionProcessId) {
		return productionProcessPersistence.fetchByPrimaryKey(
			productionProcessId);
	}
	...
	public ProductionProcess getProductionProcess(long productionProcessId)
		...
		return productionProcessPersistence.findByPrimaryKey(
			productionProcessId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProductionProcess.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("productionProcessId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ProductionProcess.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return productionProcessPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProductionProcessLocalServiceImpl#deleteProductionProcess(ProductionProcess) to avoid orphaned data");
		}

		return productionProcessLocalService.deleteProductionProcess(
			(ProductionProcess)persistedModel);
	}

	@Override
	public BasePersistence<ProductionProcess> getBasePersistence() {
		return productionProcessPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return productionProcessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProductionProcess> getProductionProcesses(int start, int end) {
		return productionProcessPersistence.findAll(start, end);
	}
	...
	public int getProductionProcessesCount() {
		return productionProcessPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductionProcessLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		productionProcessLocalService = (ProductionProcessLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductionProcessLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				productionProcessPersistence.getDataSource();
	...
	protected ProductionProcessLocalService productionProcessLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductionProcessLocalServiceBaseImpl.class);
