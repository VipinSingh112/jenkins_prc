...
import com.nbp.manufacturing.application.form.service.service.ManuEquipmentService;
...
/**
 * Provides the base implementation for the manu equipment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManuEquipmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManuEquipmentServiceImpl
 * @generated
 */
public abstract class ManuEquipmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ManuEquipmentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManuEquipmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManuEquipmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ManuEquipmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		manuEquipmentService = (ManuEquipmentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManuEquipmentService.class.getName();
	}
	...
	protected ManuEquipmentService manuEquipmentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManuEquipmentServiceBaseImpl.class);
