...
import com.nbp.manufacturing.application.form.service.service.ManufacturingApplicationLocalService;
...
/**
 * Provides the base implementation for the manufacturing application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManufacturingApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManufacturingApplicationLocalServiceImpl
 * @generated
 */
public abstract class ManufacturingApplicationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManufacturingApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManufacturingApplicationLocalServiceUtil</code>.
	 */
	...
	public ManufacturingApplication addManufacturingApplication(
		...
		return manufacturingApplicationPersistence.update(
	...
	public ManufacturingApplication createManufacturingApplication(
		...
		return manufacturingApplicationPersistence.create(
	...
	public ManufacturingApplication deleteManufacturingApplication(
		...
		return manufacturingApplicationPersistence.remove(
			manufacturingApplicationId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return manufacturingApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ManufacturingApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return manufacturingApplicationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return manufacturingApplicationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ManufacturingApplication fetchManufacturingApplication(
		...
		return manufacturingApplicationPersistence.fetchByPrimaryKey(
			manufacturingApplicationId);
	}
	...
	public ManufacturingApplication getManufacturingApplication(
		...
		return manufacturingApplicationPersistence.findByPrimaryKey(
			manufacturingApplicationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ManufacturingApplication.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ManufacturingApplication.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ManufacturingApplicationLocalServiceImpl#deleteManufacturingApplication(ManufacturingApplication) to avoid orphaned data");
		}

		return manufacturingApplicationLocalService.
			deleteManufacturingApplication(
				(ManufacturingApplication)persistedModel);
	}

	@Override
	public BasePersistence<ManufacturingApplication> getBasePersistence() {
		return manufacturingApplicationPersistence;
	}
	...
	public List<ManufacturingApplication> getManufacturingApplications(
		...
		return manufacturingApplicationPersistence.findAll(start, end);
	}
	...
	public int getManufacturingApplicationsCount() {
		return manufacturingApplicationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		manufacturingApplicationLocalService =
			(ManufacturingApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManufacturingApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				manufacturingApplicationPersistence.getDataSource();
	...
	protected ManufacturingApplicationLocalService
		manufacturingApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManufacturingApplicationLocalServiceBaseImpl.class);
