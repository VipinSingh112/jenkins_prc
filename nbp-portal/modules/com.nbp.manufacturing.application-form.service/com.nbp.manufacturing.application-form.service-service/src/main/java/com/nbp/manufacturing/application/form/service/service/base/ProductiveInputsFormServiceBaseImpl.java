...
import com.nbp.manufacturing.application.form.service.service.ProductiveInputsFormService;
...
/**
 * Provides the base implementation for the productive inputs form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ProductiveInputsFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ProductiveInputsFormServiceImpl
 * @generated
 */
public abstract class ProductiveInputsFormServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProductiveInputsFormService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductiveInputsFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ProductiveInputsFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductiveInputsFormService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		productiveInputsFormService = (ProductiveInputsFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductiveInputsFormService.class.getName();
	}
	...
	protected ProductiveInputsFormService productiveInputsFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProductiveInputsFormServiceBaseImpl.class);
