...
import com.nbp.manufacturing.application.form.service.service.ManufacturingApplicationService;
...
/**
 * Provides the base implementation for the manufacturing application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.manufacturing.application.form.service.service.impl.ManufacturingApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.manufacturing.application.form.service.service.impl.ManufacturingApplicationServiceImpl
 * @generated
 */
public abstract class ManufacturingApplicationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ManufacturingApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.manufacturing.application.form.service.service.ManufacturingApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ManufacturingApplicationService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		manufacturingApplicationService =
			(ManufacturingApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ManufacturingApplicationService.class.getName();
	}
	...
	protected ManufacturingApplicationService manufacturingApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ManufacturingApplicationServiceBaseImpl.class);
