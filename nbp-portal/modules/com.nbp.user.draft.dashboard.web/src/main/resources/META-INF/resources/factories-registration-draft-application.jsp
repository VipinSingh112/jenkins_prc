...
<%
		for (FactoriesApplicationRegistration applications : factoriesDraftApplicationsList) {
			  factoriesApplicationRenderUrl.setParameter("factoriesApplicationId",String.valueOf(applications.getFactoriesApplicationId())); 
	%>
				...
				<div class="col-md-12">
					<div class="progress-plus-wizard-card">
						<div class="d-flex ">
							<div class="icon">
								<span class="mr-2">
									<svg width="33" height="40" viewBox="0 0 205 220" fill="none" xmlns="http://www.w3.org/2000/svg"> 
						...
						<div class="right-part d-flex  justify-content-end">
							...
							<div class="dash-action-box d-flex">
								<div class="dash-action-box d-flex">
									...
									<a href="/group/guest/factories-registration-application-form?factoriesApplicationId=<%=String.valueOf(applications.getFactoriesApplicationId())%>" class="dash-action-btns common-yellow-bg"  data-toggle="tooltip" title="Continue your Application"> 
			...
			<div class="row pt-0 px-3 pb-3">
				<div class="col-md-12">
					<div class="lower  dash-lower-multiple-links-box d-flex justify-content-end">
						<a class="dash-yellow-repeated-link light-grey dashboard-progress-repeated-grey-btn with-greeb-bg" data-senna-off="true" href="/group/guest/factories-registration-application-form?factoriesApplicationId=<%=String.valueOf(applications.getFactoriesApplicationId())%>"> 
