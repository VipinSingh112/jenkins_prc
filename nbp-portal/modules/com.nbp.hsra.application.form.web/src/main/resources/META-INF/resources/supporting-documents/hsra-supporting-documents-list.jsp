...
<%@page import="com.nbp.hsra.upload.document.commands.GettingDocumentData"%>
...
if(Validator.isNotNull(request.getAttribute("hsraApplicationId"))){
	hsraAppId= String.valueOf(request.getAttribute("hsraApplicationId"));
}
