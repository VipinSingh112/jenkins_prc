package com.nbp.hsra.application.form.web.constants;

/**
 * @author hp
 */
public class HSRAApplicationFormPortletKeys {

	public static final String HSRAAPPLICATIONFORM =
		"com_nbp_hsra_application_form_web_HSRAApplicationFormPortlet";
