...
@Component(
		...
		"mvc.command.name=/add/Hsra/Upload/Document/Url" }, 
	...
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try {
			...
			if (Validator.isNotNull(inputStream)) {
				...
				DLFolder dlFolder = createFolder(themeDisplay.getUserId(), hsraApplicationId,
						themeDisplay.getScopeGroupId());
				/* commonsUtil.updateFolderPermission(dlFolder); */
				commonsUtil.updateFolderPermissionGuest(dlFolder);
				FileEntry fileEntry = _dlAppLocalService.addFileEntry(String.valueOf(CounterLocalServiceUtil.increment(DLFileEntry.class.getName())) + hsraApplicationId,
				...
				resourceRequest.getPortletContext().getRequestDispatcher("/supporting-documents/hsra-supporting-document-info.jsp")
