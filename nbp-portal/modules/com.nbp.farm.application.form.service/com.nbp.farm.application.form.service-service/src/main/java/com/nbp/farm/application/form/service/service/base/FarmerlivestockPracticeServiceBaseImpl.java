...
import com.nbp.farm.application.form.service.service.FarmerlivestockPracticeService;
import com.nbp.farm.application.form.service.service.FarmerlivestockPracticeServiceUtil;
...
/**
 * Provides the base implementation for the farmerlivestock practice remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerlivestockPracticeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerlivestockPracticeServiceImpl
 * @generated
 */
public abstract class FarmerlivestockPracticeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FarmerlivestockPracticeService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerlivestockPracticeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerlivestockPracticeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerlivestockPracticeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		farmerlivestockPracticeService =
			(FarmerlivestockPracticeService)aopProxy;

		_setServiceUtilService(farmerlivestockPracticeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerlivestockPracticeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				FarmerlivestockPracticeServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, farmerlivestockPracticeService);
		}
	...
	protected com.nbp.farm.application.form.service.service.
		FarmerlivestockPracticeLocalService farmerlivestockPracticeLocalService;

	protected FarmerlivestockPracticeService farmerlivestockPracticeService;
