...
import com.nbp.farm.application.form.service.service.FarmerPropertyLocalService;
...
/**
 * Provides the base implementation for the farmer property local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerPropertyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerPropertyLocalServiceImpl
 * @generated
 */
public abstract class FarmerPropertyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FarmerPropertyLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerPropertyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerPropertyLocalServiceUtil</code>.
	 */
	...
	public FarmerProperty addFarmerProperty(FarmerProperty farmerProperty) {
		...
		return farmerPropertyPersistence.update(farmerProperty);
	}
	...
	public FarmerProperty createFarmerProperty(long farmerPropertyId) {
		return farmerPropertyPersistence.create(farmerPropertyId);
	}
	...
	public FarmerProperty deleteFarmerProperty(long farmerPropertyId)
		...
		return farmerPropertyPersistence.remove(farmerPropertyId);
	}
	...
	public FarmerProperty deleteFarmerProperty(FarmerProperty farmerProperty) {
		return farmerPropertyPersistence.remove(farmerProperty);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return farmerPropertyPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FarmerProperty.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return farmerPropertyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return farmerPropertyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return farmerPropertyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return farmerPropertyPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FarmerProperty fetchFarmerProperty(long farmerPropertyId) {
		return farmerPropertyPersistence.fetchByPrimaryKey(farmerPropertyId);
	}
	...
	public FarmerProperty getFarmerProperty(long farmerPropertyId)
		...
		return farmerPropertyPersistence.findByPrimaryKey(farmerPropertyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(farmerPropertyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FarmerProperty.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("farmerPropertyId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			farmerPropertyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FarmerProperty.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return farmerPropertyPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return farmerPropertyLocalService.deleteFarmerProperty(
			(FarmerProperty)persistedModel);
	}

	@Override
	public BasePersistence<FarmerProperty> getBasePersistence() {
		return farmerPropertyPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return farmerPropertyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FarmerProperty> getFarmerProperties(int start, int end) {
		return farmerPropertyPersistence.findAll(start, end);
	}
	...
	public int getFarmerPropertiesCount() {
		return farmerPropertyPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerPropertyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		farmerPropertyLocalService = (FarmerPropertyLocalService)aopProxy;

		_setLocalServiceUtilService(farmerPropertyLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerPropertyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = farmerPropertyPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FarmerPropertyLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, farmerPropertyLocalService);
		}
	...
	protected FarmerPropertyLocalService farmerPropertyLocalService;
