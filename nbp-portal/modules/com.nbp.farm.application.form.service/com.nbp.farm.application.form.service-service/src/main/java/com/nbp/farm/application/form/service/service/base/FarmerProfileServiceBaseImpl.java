...
import com.nbp.farm.application.form.service.service.FarmerProfileService;
import com.nbp.farm.application.form.service.service.FarmerProfileServiceUtil;
...
/**
 * Provides the base implementation for the farmer profile remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerProfileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerProfileServiceImpl
 * @generated
 */
public abstract class FarmerProfileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FarmerProfileService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerProfileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerProfileServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerProfileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		farmerProfileService = (FarmerProfileService)aopProxy;

		_setServiceUtilService(farmerProfileService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerProfileService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FarmerProfileServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, farmerProfileService);
		}
	...
	@Reference
	protected
		com.nbp.farm.application.form.service.service.FarmerProfileLocalService
			farmerProfileLocalService;

	protected FarmerProfileService farmerProfileService;
