...
import com.nbp.farm.application.form.service.service.FarmerStakeholderAddressService;
import com.nbp.farm.application.form.service.service.FarmerStakeholderAddressServiceUtil;
...
/**
 * Provides the base implementation for the farmer stakeholder address remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerStakeholderAddressServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerStakeholderAddressServiceImpl
 * @generated
 */
public abstract class FarmerStakeholderAddressServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FarmerStakeholderAddressService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerStakeholderAddressService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerStakeholderAddressServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerStakeholderAddressService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		farmerStakeholderAddressService =
			(FarmerStakeholderAddressService)aopProxy;

		_setServiceUtilService(farmerStakeholderAddressService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerStakeholderAddressService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				FarmerStakeholderAddressServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, farmerStakeholderAddressService);
		}
	...
	protected FarmerStakeholderAddressService farmerStakeholderAddressService;
