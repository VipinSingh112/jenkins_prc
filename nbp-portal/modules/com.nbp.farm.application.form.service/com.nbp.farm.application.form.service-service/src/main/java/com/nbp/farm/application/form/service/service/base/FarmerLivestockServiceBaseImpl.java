...
import com.nbp.farm.application.form.service.service.FarmerLivestockService;
import com.nbp.farm.application.form.service.service.FarmerLivestockServiceUtil;
...
/**
 * Provides the base implementation for the farmer livestock remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerLivestockServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerLivestockServiceImpl
 * @generated
 */
public abstract class FarmerLivestockServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FarmerLivestockService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerLivestockService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerLivestockServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerLivestockService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		farmerLivestockService = (FarmerLivestockService)aopProxy;

		_setServiceUtilService(farmerLivestockService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerLivestockService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FarmerLivestockServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, farmerLivestockService);
		}
	...
	protected FarmerLivestockService farmerLivestockService;
