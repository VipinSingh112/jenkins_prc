...
import com.nbp.farm.application.form.service.service.FarmerStakeholderInfoLocalService;
...
/**
 * Provides the base implementation for the farmer stakeholder info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerStakeholderInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerStakeholderInfoLocalServiceImpl
 * @generated
 */
public abstract class FarmerStakeholderInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FarmerStakeholderInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerStakeholderInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerStakeholderInfoLocalServiceUtil</code>.
	 */
	...
	public FarmerStakeholderInfo addFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.update(farmerStakeholderInfo);
	}
	...
	public FarmerStakeholderInfo createFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.create(farmerStakeholderInfoId);
	}
	...
	public FarmerStakeholderInfo deleteFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.remove(farmerStakeholderInfoId);
	}
	...
	public FarmerStakeholderInfo deleteFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.remove(farmerStakeholderInfo);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return farmerStakeholderInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FarmerStakeholderInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return farmerStakeholderInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return farmerStakeholderInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FarmerStakeholderInfo fetchFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.fetchByPrimaryKey(
	...
	public FarmerStakeholderInfo getFarmerStakeholderInfo(
		...
		return farmerStakeholderInfoPersistence.findByPrimaryKey(
			farmerStakeholderInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			farmerStakeholderInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FarmerStakeholderInfo.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return farmerStakeholderInfoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return farmerStakeholderInfoLocalService.deleteFarmerStakeholderInfo(
			(FarmerStakeholderInfo)persistedModel);
	}

	@Override
	public BasePersistence<FarmerStakeholderInfo> getBasePersistence() {
		return farmerStakeholderInfoPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return farmerStakeholderInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FarmerStakeholderInfo> getFarmerStakeholderInfos(
		...
		return farmerStakeholderInfoPersistence.findAll(start, end);
	}
	...
	public int getFarmerStakeholderInfosCount() {
		return farmerStakeholderInfoPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerStakeholderInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		farmerStakeholderInfoLocalService =
			(FarmerStakeholderInfoLocalService)aopProxy;

		_setLocalServiceUtilService(farmerStakeholderInfoLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerStakeholderInfoLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FarmerStakeholderInfoLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, farmerStakeholderInfoLocalService);
		}
	...
	protected FarmerStakeholderInfoLocalService
		farmerStakeholderInfoLocalService;
