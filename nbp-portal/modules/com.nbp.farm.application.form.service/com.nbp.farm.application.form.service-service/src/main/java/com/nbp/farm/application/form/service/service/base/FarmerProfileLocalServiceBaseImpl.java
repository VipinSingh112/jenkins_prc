...
import com.nbp.farm.application.form.service.service.FarmerProfileLocalService;
...
/**
 * Provides the base implementation for the farmer profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerProfileLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerProfileLocalServiceImpl
 * @generated
 */
public abstract class FarmerProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FarmerProfileLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerProfileLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerProfileLocalServiceUtil</code>.
	 */
	...
	public FarmerProfile addFarmerProfile(FarmerProfile farmerProfile) {
		...
		return farmerProfilePersistence.update(farmerProfile);
	}
	...
	public FarmerProfile createFarmerProfile(long farmerProfileId) {
		return farmerProfilePersistence.create(farmerProfileId);
	}
	...
	public FarmerProfile deleteFarmerProfile(long farmerProfileId)
		...
		return farmerProfilePersistence.remove(farmerProfileId);
	}
	...
	public FarmerProfile deleteFarmerProfile(FarmerProfile farmerProfile) {
		return farmerProfilePersistence.remove(farmerProfile);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return farmerProfilePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FarmerProfile.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return farmerProfilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return farmerProfilePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return farmerProfilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return farmerProfilePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FarmerProfile fetchFarmerProfile(long farmerProfileId) {
		return farmerProfilePersistence.fetchByPrimaryKey(farmerProfileId);
	}
	...
	public FarmerProfile getFarmerProfile(long farmerProfileId)
		...
		return farmerProfilePersistence.findByPrimaryKey(farmerProfileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(farmerProfileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FarmerProfile.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("farmerProfileId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			farmerProfileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FarmerProfile.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return farmerProfilePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return farmerProfileLocalService.deleteFarmerProfile(
			(FarmerProfile)persistedModel);
	}

	@Override
	public BasePersistence<FarmerProfile> getBasePersistence() {
		return farmerProfilePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return farmerProfilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FarmerProfile> getFarmerProfiles(int start, int end) {
		return farmerProfilePersistence.findAll(start, end);
	}
	...
	public int getFarmerProfilesCount() {
		return farmerProfilePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerProfileLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		farmerProfileLocalService = (FarmerProfileLocalService)aopProxy;

		_setLocalServiceUtilService(farmerProfileLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerProfileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = farmerProfilePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FarmerProfileLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, farmerProfileLocalService);
		}
	...
	protected FarmerProfileLocalService farmerProfileLocalService;
