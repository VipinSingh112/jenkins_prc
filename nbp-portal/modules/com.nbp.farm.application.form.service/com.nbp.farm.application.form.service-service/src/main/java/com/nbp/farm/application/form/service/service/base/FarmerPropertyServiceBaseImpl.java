...
import com.nbp.farm.application.form.service.service.FarmerPropertyService;
import com.nbp.farm.application.form.service.service.FarmerPropertyServiceUtil;
...
/**
 * Provides the base implementation for the farmer property remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.farm.application.form.service.service.impl.FarmerPropertyServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.farm.application.form.service.service.impl.FarmerPropertyServiceImpl
 * @generated
 */
public abstract class FarmerPropertyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FarmerPropertyService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FarmerPropertyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FarmerPropertyServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FarmerPropertyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		farmerPropertyService = (FarmerPropertyService)aopProxy;

		_setServiceUtilService(farmerPropertyService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FarmerPropertyService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FarmerPropertyServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, farmerPropertyService);
		}
	...
	@Reference
	protected
		com.nbp.farm.application.form.service.service.FarmerPropertyLocalService
			farmerPropertyLocalService;

	protected FarmerPropertyService farmerPropertyService;
