...
/**
 * Provides the local service interface for FarmerProfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerProfileLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmerProfileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerProfileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farmer profile local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmerProfileLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FarmerProfile addFarmerProfile(FarmerProfile farmerProfile);
	...
	public FarmerProfile createFarmerProfile(long farmerProfileId);
	...
	public FarmerProfile deleteFarmerProfile(FarmerProfile farmerProfile);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FarmerProfile deleteFarmerProfile(long farmerProfileId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerProfile fetchFarmerProfile(long farmerProfileId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerProfile getFarmerProfile(long farmerProfileId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FarmerProfile> getFarmerProfiles(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FarmerProfile updateFarmerProfile(FarmerProfile farmerProfile);
