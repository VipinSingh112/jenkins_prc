...
/**
 * Provides the local service interface for FarmerStakeholderInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerStakeholderInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmerStakeholderInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerStakeholderInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farmer stakeholder info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmerStakeholderInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FarmerStakeholderInfo addFarmerStakeholderInfo(
	...
	public FarmerStakeholderInfo createFarmerStakeholderInfo(
	...
	public FarmerStakeholderInfo deleteFarmerStakeholderInfo(
		FarmerStakeholderInfo farmerStakeholderInfo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerStakeholderInfo fetchFarmerStakeholderInfo(
		long farmerStakeholderInfoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerStakeholderInfo getFarmerStakeholderInfo(
			long farmerStakeholderInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FarmerStakeholderInfo> getFarmerStakeholderInfos(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FarmerStakeholderInfo updateFarmerStakeholderInfo(
		FarmerStakeholderInfo farmerStakeholderInfo);
