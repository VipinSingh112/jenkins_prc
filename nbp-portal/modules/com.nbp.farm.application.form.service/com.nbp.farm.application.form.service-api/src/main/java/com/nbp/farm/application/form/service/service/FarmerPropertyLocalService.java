...
/**
 * Provides the local service interface for FarmerProperty. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerPropertyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmerPropertyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerPropertyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farmer property local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmerPropertyLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FarmerProperty addFarmerProperty(FarmerProperty farmerProperty);
	...
	public FarmerProperty createFarmerProperty(long farmerPropertyId);
	...
	public FarmerProperty deleteFarmerProperty(FarmerProperty farmerProperty);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FarmerProperty deleteFarmerProperty(long farmerPropertyId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerProperty fetchFarmerProperty(long farmerPropertyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FarmerProperty> getFarmerProperties(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerProperty getFarmerProperty(long farmerPropertyId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FarmerProperty updateFarmerProperty(FarmerProperty farmerProperty);
