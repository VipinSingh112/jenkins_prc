...
/**
 * Provides the local service utility for FarmerlivestockPractice. This utility wraps
 * <code>com.nbp.farm.application.form.service.service.impl.FarmerlivestockPracticeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FarmerlivestockPracticeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerlivestockPracticeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FarmerlivestockPractice addFarmerlivestockPractice(
		FarmerlivestockPractice farmerlivestockPractice) {

		return getService().addFarmerlivestockPractice(farmerlivestockPractice);
	}
	 ...
	 */
	public static FarmerlivestockPractice createFarmerlivestockPractice(
		long farmerLivestockPracticeId) {

		return getService().createFarmerlivestockPractice(
	 ...
	 */
	public static FarmerlivestockPractice deleteFarmerlivestockPractice(
		FarmerlivestockPractice farmerlivestockPractice) {

		return getService().deleteFarmerlivestockPractice(
	...
	public static FarmerlivestockPractice fetchFarmerlivestockPractice(
		long farmerLivestockPracticeId) {

		return getService().fetchFarmerlivestockPractice(
			farmerLivestockPracticeId);
	}
	...
	public static List<FarmerlivestockPractice> getFA_FLSP_FAI(
		long ApplicationId) {

		return getService().getFA_FLSP_FAI(ApplicationId);
	}

	public static FarmerlivestockPractice getFarmerById(long ApplicationId) {
	 ...
	 * @throws PortalException if a farmerlivestock practice with the primary key could not be found
	 */
	public static FarmerlivestockPractice getFarmerlivestockPractice(
			long farmerLivestockPracticeId)
		throws PortalException {

		return getService().getFarmerlivestockPractice(
			farmerLivestockPracticeId);
	}
	 ...
	 */
	public static List<FarmerlivestockPractice> getFarmerlivestockPractices(
		int start, int end) {

		return getService().getFarmerlivestockPractices(start, end);
	}
	 ...
	 */
	public static int getFarmerlivestockPracticesCount() {
		return getService().getFarmerlivestockPracticesCount();
	}
	 ...
	 */
	public static FarmerlivestockPractice updateFarmerlivestockPractice(
		FarmerlivestockPractice farmerlivestockPractice) {

		return getService().updateFarmerlivestockPractice(
			farmerlivestockPractice);
	}

	public static FarmerlivestockPracticeLocalService getService() {
		return _service;
	}

	private static volatile FarmerlivestockPracticeLocalService _service;
