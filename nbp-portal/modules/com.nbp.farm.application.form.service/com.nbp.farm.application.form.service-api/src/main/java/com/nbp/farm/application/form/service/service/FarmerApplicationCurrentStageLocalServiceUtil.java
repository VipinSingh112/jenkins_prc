...
/**
 * Provides the local service utility for FarmerApplicationCurrentStage. This utility wraps
 * <code>com.nbp.farm.application.form.service.service.impl.FarmerApplicationCurrentStageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FarmerApplicationCurrentStageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerApplicationCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FarmerApplicationCurrentStage
		addFarmerApplicationCurrentStage(
			FarmerApplicationCurrentStage farmerApplicationCurrentStage) {

		return getService().addFarmerApplicationCurrentStage(
	 ...
	 */
	public static FarmerApplicationCurrentStage
		createFarmerApplicationCurrentStage(long farmerCurrentStageId) {

		return getService().createFarmerApplicationCurrentStage(
	...
	public static FarmerApplicationCurrentStage
		...
		return getService().deleteFarmerApplicationCurrentStage(
			farmerApplicationCurrentStage);
	}
	 ...
	 */
	public static FarmerApplicationCurrentStage
			deleteFarmerApplicationCurrentStage(long farmerCurrentStageId)
		throws PortalException {
	...
	public static FarmerApplicationCurrentStage
		fetchFarmerApplicationCurrentStage(long farmerCurrentStageId) {

		return getService().fetchFarmerApplicationCurrentStage(
			farmerCurrentStageId);
	}
	...
	public static FarmerApplicationCurrentStage
		...
		return getService().fetchFarmerApplicationCurrentStageByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static FarmerApplicationCurrentStage
			getFarmerApplicationCurrentStage(long farmerCurrentStageId)
		throws PortalException {

		return getService().getFarmerApplicationCurrentStage(
			farmerCurrentStageId);
	}
	...
	public static FarmerApplicationCurrentStage
		...
		return getService().getFarmerApplicationCurrentStageByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<FarmerApplicationCurrentStage>
		getFarmerApplicationCurrentStages(int start, int end) {

		return getService().getFarmerApplicationCurrentStages(start, end);
	}
	...
	public static List<FarmerApplicationCurrentStage>
		...
		return getService().getFarmerApplicationCurrentStagesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getFarmerApplicationCurrentStagesCount() {
		return getService().getFarmerApplicationCurrentStagesCount();
	}

	public static FarmerApplicationCurrentStage getfarmerById(
		long farmerApplicationId) {

		return getService().getfarmerById(farmerApplicationId);
	}
	 ...
	 */
	public static FarmerApplicationCurrentStage
		updateFarmerApplicationCurrentStage(
			FarmerApplicationCurrentStage farmerApplicationCurrentStage) {

		return getService().updateFarmerApplicationCurrentStage(
			farmerApplicationCurrentStage);
	}

	public static FarmerApplicationCurrentStageLocalService getService() {
		return _service;
	}

	private static volatile FarmerApplicationCurrentStageLocalService _service;
