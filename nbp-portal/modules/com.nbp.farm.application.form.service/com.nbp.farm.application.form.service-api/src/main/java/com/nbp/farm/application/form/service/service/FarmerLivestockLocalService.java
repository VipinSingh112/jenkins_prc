...
/**
 * Provides the local service interface for FarmerLivestock. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerLivestockLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FarmerLivestockLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.farm.application.form.service.service.impl.FarmerLivestockLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the farmer livestock local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FarmerLivestockLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FarmerLivestock> getFA_FLS_FAI(long ApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FarmerLivestock getFarmerById(long ApplicationId);
