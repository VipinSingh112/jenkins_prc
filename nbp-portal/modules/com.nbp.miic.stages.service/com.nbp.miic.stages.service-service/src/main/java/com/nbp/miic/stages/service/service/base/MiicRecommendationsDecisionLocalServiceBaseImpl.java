...
import com.nbp.miic.stages.service.service.MiicRecommendationsDecisionLocalService;
...
/**
 * Provides the base implementation for the miic recommendations decision local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.miic.stages.service.service.impl.MiicRecommendationsDecisionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.miic.stages.service.service.impl.MiicRecommendationsDecisionLocalServiceImpl
 * @generated
 */
public abstract class MiicRecommendationsDecisionLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiicRecommendationsDecisionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.miic.stages.service.service.MiicRecommendationsDecisionLocalServiceUtil</code>.
	 */
	...
	public MiicRecommendationsDecision addMiicRecommendationsDecision(
		...
		return miicRecommendationsDecisionPersistence.update(
	...
	public MiicRecommendationsDecision createMiicRecommendationsDecision(
		...
		return miicRecommendationsDecisionPersistence.create(
	...
	public MiicRecommendationsDecision deleteMiicRecommendationsDecision(
		...
		return miicRecommendationsDecisionPersistence.remove(
			miicRecommendationsDecisionId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return miicRecommendationsDecisionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MiicRecommendationsDecision.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return miicRecommendationsDecisionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return miicRecommendationsDecisionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public MiicRecommendationsDecision fetchMiicRecommendationsDecision(
		...
		return miicRecommendationsDecisionPersistence.fetchByPrimaryKey(
			miicRecommendationsDecisionId);
	}
	...
	public MiicRecommendationsDecision getMiicRecommendationsDecision(
		...
		return miicRecommendationsDecisionPersistence.findByPrimaryKey(
			miicRecommendationsDecisionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MiicRecommendationsDecision.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			MiicRecommendationsDecision.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement MiicRecommendationsDecisionLocalServiceImpl#deleteMiicRecommendationsDecision(MiicRecommendationsDecision) to avoid orphaned data");
		}

		return miicRecommendationsDecisionLocalService.
			deleteMiicRecommendationsDecision(
				(MiicRecommendationsDecision)persistedModel);
	}

	@Override
	public BasePersistence<MiicRecommendationsDecision> getBasePersistence() {
		return miicRecommendationsDecisionPersistence;
	}
	...
	public List<MiicRecommendationsDecision> getMiicRecommendationsDecisions(
		...
		return miicRecommendationsDecisionPersistence.findAll(start, end);
	}
	...
	public int getMiicRecommendationsDecisionsCount() {
		return miicRecommendationsDecisionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		miicRecommendationsDecisionLocalService =
			(MiicRecommendationsDecisionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiicRecommendationsDecisionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				miicRecommendationsDecisionPersistence.getDataSource();
	...
	protected MiicRecommendationsDecisionLocalService
		miicRecommendationsDecisionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiicRecommendationsDecisionLocalServiceBaseImpl.class);
