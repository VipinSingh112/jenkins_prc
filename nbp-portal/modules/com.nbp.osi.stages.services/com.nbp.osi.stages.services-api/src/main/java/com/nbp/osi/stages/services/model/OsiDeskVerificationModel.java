...
/**
 * The base model interface for the OsiDeskVerification service. Represents a row in the &quot;nbp_osi_desk_verification&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.stages.services.model.impl.OsiDeskVerificationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.stages.services.model.impl.OsiDeskVerificationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface OsiDeskVerificationModel
	extends BaseModel<OsiDeskVerification>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a osi desk verification model instance should use the {@link OsiDeskVerification} interface instead.
	 */
