...
/**
 * The base model interface for the FilmApplicationPayment service. Represents a row in the &quot;nbp_film_application_payment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.film.application.form.service.model.impl.FilmApplicationPaymentModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.film.application.form.service.model.impl.FilmApplicationPaymentImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface FilmApplicationPaymentModel
	extends BaseModel<FilmApplicationPayment>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a film application payment model instance should use the {@link FilmApplicationPayment} interface instead.
	 */
