...
/**
 * The persistence utility for the film production details service. This utility wraps <code>com.nbp.film.application.form.service.service.persistence.impl.FilmProductionDetailsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see FilmProductionDetailsPersistence
 * @generated
 */
public class FilmProductionDetailsUtil {
	 ...
	 */
	public static void clearCache(FilmProductionDetails filmProductionDetails) {
		getPersistence().clearCache(filmProductionDetails);
	}
	 ...
	 */
	public static Map<Serializable, FilmProductionDetails> fetchByPrimaryKeys(
	 ...
	 */
	public static List<FilmProductionDetails> findWithDynamicQuery(
	 ...
	 */
	public static FilmProductionDetails update(
		FilmProductionDetails filmProductionDetails) {

		return getPersistence().update(filmProductionDetails);
	}
	...
	public static FilmProductionDetails update(
		...
		return getPersistence().update(filmProductionDetails, serviceContext);
	}
	 ...
	 */
	public static FilmProductionDetails findBygetFilmById(
			long filmApplicationId)
		throws com.nbp.film.application.form.service.exception.
			NoSuchFilmProductionDetailsException {
	 ...
	 */
	public static FilmProductionDetails fetchBygetFilmById(
		long filmApplicationId) {
	 ...
	 */
	public static FilmProductionDetails removeBygetFilmById(
			long filmApplicationId)
		throws com.nbp.film.application.form.service.exception.
			NoSuchFilmProductionDetailsException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(filmProductionDetails);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(filmProductionDetailses);
	}
	 ...
	 */
	public static FilmProductionDetails create(long filmProductionDetailsId) {
		return getPersistence().create(filmProductionDetailsId);
	}
	 ...
	 */
	public static FilmProductionDetails remove(long filmProductionDetailsId)
		throws com.nbp.film.application.form.service.exception.
			NoSuchFilmProductionDetailsException {

		return getPersistence().remove(filmProductionDetailsId);
	}

	public static FilmProductionDetails updateImpl(
		FilmProductionDetails filmProductionDetails) {

		return getPersistence().updateImpl(filmProductionDetails);
	}
	 ...
	 * @throws NoSuchFilmProductionDetailsException if a film production details with the primary key could not be found
	 */
	public static FilmProductionDetails findByPrimaryKey(
			long filmProductionDetailsId)
		throws com.nbp.film.application.form.service.exception.
			NoSuchFilmProductionDetailsException {

		return getPersistence().findByPrimaryKey(filmProductionDetailsId);
	}
	 ...
	 */
	public static FilmProductionDetails fetchByPrimaryKey(
		long filmProductionDetailsId) {

		return getPersistence().fetchByPrimaryKey(filmProductionDetailsId);
	}
	 ...
	 */
	public static List<FilmProductionDetails> findAll() {
	 ...
	 */
	public static List<FilmProductionDetails> findAll(int start, int end) {
	...
	public static FilmProductionDetailsPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		FilmProductionDetailsPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile FilmProductionDetailsPersistence _persistence;
