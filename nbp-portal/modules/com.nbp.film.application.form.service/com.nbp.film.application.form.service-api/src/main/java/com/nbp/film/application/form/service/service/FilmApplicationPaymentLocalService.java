...
/**
 * Provides the local service interface for FilmApplicationPayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FilmApplicationPaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FilmApplicationPaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.film.application.form.service.service.impl.FilmApplicationPaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the film application payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FilmApplicationPaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FilmApplicationPayment addFilmApplicationPayment(
	...
	public FilmApplicationPayment createFilmApplicationPayment(
	...
	public FilmApplicationPayment deleteFilmApplicationPayment(
		FilmApplicationPayment filmApplicationPayment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FilmApplicationPayment fetchFilmApplicationPayment(
		long filmApplicationPaymentId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FilmApplicationPayment getFilm_Pay_FAI(long filmApplicaitonId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FilmApplicationPayment getFilmApplicationPayment(
			long filmApplicationPaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FilmApplicationPayment> getFilmApplicationPayments(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FilmApplicationPayment updateFilmApplicationPayment(
		FilmApplicationPayment filmApplicationPayment);
