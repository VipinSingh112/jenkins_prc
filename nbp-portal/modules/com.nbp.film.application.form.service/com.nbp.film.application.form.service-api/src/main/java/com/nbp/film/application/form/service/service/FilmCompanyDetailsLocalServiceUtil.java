...
/**
 * Provides the local service utility for FilmCompanyDetails. This utility wraps
 * <code>com.nbp.film.application.form.service.service.impl.FilmCompanyDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FilmCompanyDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.film.application.form.service.service.impl.FilmCompanyDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FilmCompanyDetails addFilmCompanyDetails(
		FilmCompanyDetails filmCompanyDetails) {

		return getService().addFilmCompanyDetails(filmCompanyDetails);
	}
	 ...
	 */
	public static FilmCompanyDetails createFilmCompanyDetails(
		long filmCompanyDetailsId) {

		return getService().createFilmCompanyDetails(filmCompanyDetailsId);
	}
	 ...
	 */
	public static FilmCompanyDetails deleteFilmCompanyDetails(
		FilmCompanyDetails filmCompanyDetails) {

		return getService().deleteFilmCompanyDetails(filmCompanyDetails);
	}
	...
	public static FilmCompanyDetails deleteFilmCompanyDetails(
		...
		return getService().deleteFilmCompanyDetails(filmCompanyDetailsId);
	}
	...
	public static FilmCompanyDetails fetchFilmCompanyDetails(
		long filmCompanyDetailsId) {

		return getService().fetchFilmCompanyDetails(filmCompanyDetailsId);
	}
	...
	public static FilmCompanyDetails getFilmById(long filmById) {
	 ...
	 * @throws PortalException if a film company details with the primary key could not be found
	 */
	public static FilmCompanyDetails getFilmCompanyDetails(
			long filmCompanyDetailsId)
		throws PortalException {

		return getService().getFilmCompanyDetails(filmCompanyDetailsId);
	}
	 ...
	 */
	public static List<FilmCompanyDetails> getFilmCompanyDetailses(
		int start, int end) {

		return getService().getFilmCompanyDetailses(start, end);
	}
	 ...
	 */
	public static int getFilmCompanyDetailsesCount() {
		return getService().getFilmCompanyDetailsesCount();
	}
	 ...
	 */
	public static FilmCompanyDetails updateFilmCompanyDetails(
		FilmCompanyDetails filmCompanyDetails) {

		return getService().updateFilmCompanyDetails(filmCompanyDetails);
	}

	public static FilmCompanyDetailsLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FilmCompanyDetailsLocalService>
		_serviceSnapshot = new Snapshot<>(
			FilmCompanyDetailsLocalServiceUtil.class,
			FilmCompanyDetailsLocalService.class);
