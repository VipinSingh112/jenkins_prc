...
/**
 * Provides the local service utility for FilmApplicationPayment. This utility wraps
 * <code>com.nbp.film.application.form.service.service.impl.FilmApplicationPaymentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FilmApplicationPaymentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.film.application.form.service.service.impl.FilmApplicationPaymentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FilmApplicationPayment addFilmApplicationPayment(
		FilmApplicationPayment filmApplicationPayment) {

		return getService().addFilmApplicationPayment(filmApplicationPayment);
	}
	 ...
	 */
	public static FilmApplicationPayment createFilmApplicationPayment(
		long filmApplicationPaymentId) {

		return getService().createFilmApplicationPayment(
	 ...
	 */
	public static FilmApplicationPayment deleteFilmApplicationPayment(
		FilmApplicationPayment filmApplicationPayment) {

		return getService().deleteFilmApplicationPayment(
	...
	public static FilmApplicationPayment fetchFilmApplicationPayment(
		long filmApplicationPaymentId) {

		return getService().fetchFilmApplicationPayment(
			filmApplicationPaymentId);
	}
	...
	public static FilmApplicationPayment getFilm_Pay_FAI(long filmApplicaitonId)
		throws com.nbp.film.application.form.service.exception.
			NoSuchFilmApplicationPaymentException {

		return getService().getFilm_Pay_FAI(filmApplicaitonId);
	}
	 ...
	 * @throws PortalException if a film application payment with the primary key could not be found
	 */
	public static FilmApplicationPayment getFilmApplicationPayment(
			long filmApplicationPaymentId)
		throws PortalException {

		return getService().getFilmApplicationPayment(filmApplicationPaymentId);
	}
	 ...
	 */
	public static List<FilmApplicationPayment> getFilmApplicationPayments(
		int start, int end) {

		return getService().getFilmApplicationPayments(start, end);
	}
	 ...
	 */
	public static int getFilmApplicationPaymentsCount() {
		return getService().getFilmApplicationPaymentsCount();
	}
	 ...
	 */
	public static FilmApplicationPayment updateFilmApplicationPayment(
		FilmApplicationPayment filmApplicationPayment) {

		return getService().updateFilmApplicationPayment(
			filmApplicationPayment);
	}

	public static FilmApplicationPaymentLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<FilmApplicationPaymentLocalService>
		_serviceSnapshot = new Snapshot<>(
			FilmApplicationPaymentLocalServiceUtil.class,
			FilmApplicationPaymentLocalService.class);
