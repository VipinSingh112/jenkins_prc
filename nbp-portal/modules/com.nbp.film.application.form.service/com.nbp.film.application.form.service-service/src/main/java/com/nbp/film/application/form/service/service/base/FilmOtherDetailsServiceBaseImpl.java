...
import com.nbp.film.application.form.service.service.FilmOtherDetailsService;
...
/**
 * Provides the base implementation for the film other details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.film.application.form.service.service.impl.FilmOtherDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.film.application.form.service.service.impl.FilmOtherDetailsServiceImpl
 * @generated
 */
public abstract class FilmOtherDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FilmOtherDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FilmOtherDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.film.application.form.service.service.FilmOtherDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FilmOtherDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		filmOtherDetailsService = (FilmOtherDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FilmOtherDetailsService.class.getName();
	}
	...
	protected FilmOtherDetailsService filmOtherDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FilmOtherDetailsServiceBaseImpl.class);
