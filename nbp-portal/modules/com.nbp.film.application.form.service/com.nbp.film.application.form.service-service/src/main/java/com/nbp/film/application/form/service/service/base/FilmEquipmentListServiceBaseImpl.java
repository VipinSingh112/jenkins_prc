...
import com.nbp.film.application.form.service.service.FilmEquipmentListService;
...
/**
 * Provides the base implementation for the film equipment list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.film.application.form.service.service.impl.FilmEquipmentListServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.film.application.form.service.service.impl.FilmEquipmentListServiceImpl
 * @generated
 */
public abstract class FilmEquipmentListServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FilmEquipmentListService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FilmEquipmentListService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.film.application.form.service.service.FilmEquipmentListServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FilmEquipmentListService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		filmEquipmentListService = (FilmEquipmentListService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FilmEquipmentListService.class.getName();
	}
	...
	protected FilmEquipmentListService filmEquipmentListService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FilmEquipmentListServiceBaseImpl.class);
