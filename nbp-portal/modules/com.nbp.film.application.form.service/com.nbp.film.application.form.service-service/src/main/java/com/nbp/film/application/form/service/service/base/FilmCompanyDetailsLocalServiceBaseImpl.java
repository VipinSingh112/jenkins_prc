...
import com.nbp.film.application.form.service.service.FilmCompanyDetailsLocalService;
...
/**
 * Provides the base implementation for the film company details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.film.application.form.service.service.impl.FilmCompanyDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.film.application.form.service.service.impl.FilmCompanyDetailsLocalServiceImpl
 * @generated
 */
public abstract class FilmCompanyDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FilmCompanyDetailsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FilmCompanyDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.film.application.form.service.service.FilmCompanyDetailsLocalServiceUtil</code>.
	 */
	...
	public FilmCompanyDetails addFilmCompanyDetails(
		...
		return filmCompanyDetailsPersistence.update(filmCompanyDetails);
	}
	...
	public FilmCompanyDetails createFilmCompanyDetails(
		...
		return filmCompanyDetailsPersistence.create(filmCompanyDetailsId);
	}
	...
	public FilmCompanyDetails deleteFilmCompanyDetails(
		...
		return filmCompanyDetailsPersistence.remove(filmCompanyDetailsId);
	}
	...
	public FilmCompanyDetails deleteFilmCompanyDetails(
		...
		return filmCompanyDetailsPersistence.remove(filmCompanyDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return filmCompanyDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FilmCompanyDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return filmCompanyDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return filmCompanyDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return filmCompanyDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FilmCompanyDetails fetchFilmCompanyDetails(
		...
		return filmCompanyDetailsPersistence.fetchByPrimaryKey(
	...
	public FilmCompanyDetails getFilmCompanyDetails(long filmCompanyDetailsId)
		...
		return filmCompanyDetailsPersistence.findByPrimaryKey(
			filmCompanyDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			filmCompanyDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FilmCompanyDetails.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FilmCompanyDetails.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return filmCompanyDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FilmCompanyDetailsLocalServiceImpl#deleteFilmCompanyDetails(FilmCompanyDetails) to avoid orphaned data");
		}

		return filmCompanyDetailsLocalService.deleteFilmCompanyDetails(
			(FilmCompanyDetails)persistedModel);
	}

	@Override
	public BasePersistence<FilmCompanyDetails> getBasePersistence() {
		return filmCompanyDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return filmCompanyDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FilmCompanyDetails> getFilmCompanyDetailses(
		int start, int end) {

		return filmCompanyDetailsPersistence.findAll(start, end);
	}
	...
	public int getFilmCompanyDetailsesCount() {
		return filmCompanyDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FilmCompanyDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		filmCompanyDetailsLocalService =
			(FilmCompanyDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FilmCompanyDetailsLocalService.class.getName();
	}
	...
	protected FilmCompanyDetailsLocalService filmCompanyDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FilmCompanyDetailsLocalServiceBaseImpl.class);
