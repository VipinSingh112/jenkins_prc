...
import com.nbp.film.application.form.service.service.FilmApplicationPaymentLocalService;
...
/**
 * Provides the base implementation for the film application payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.film.application.form.service.service.impl.FilmApplicationPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.film.application.form.service.service.impl.FilmApplicationPaymentLocalServiceImpl
 * @generated
 */
public abstract class FilmApplicationPaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FilmApplicationPaymentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FilmApplicationPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.film.application.form.service.service.FilmApplicationPaymentLocalServiceUtil</code>.
	 */
	...
	public FilmApplicationPayment addFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.update(filmApplicationPayment);
	}
	...
	public FilmApplicationPayment createFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.create(
	...
	public FilmApplicationPayment deleteFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.remove(
			filmApplicationPaymentId);
	}
	...
	public FilmApplicationPayment deleteFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.remove(filmApplicationPayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return filmApplicationPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FilmApplicationPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return filmApplicationPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return filmApplicationPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FilmApplicationPayment fetchFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.fetchByPrimaryKey(
			filmApplicationPaymentId);
	}
	...
	public FilmApplicationPayment getFilmApplicationPayment(
		...
		return filmApplicationPaymentPersistence.findByPrimaryKey(
			filmApplicationPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FilmApplicationPayment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FilmApplicationPaymentLocalServiceImpl#deleteFilmApplicationPayment(FilmApplicationPayment) to avoid orphaned data");
		}

		return filmApplicationPaymentLocalService.deleteFilmApplicationPayment(
			(FilmApplicationPayment)persistedModel);
	}

	@Override
	public BasePersistence<FilmApplicationPayment> getBasePersistence() {
		return filmApplicationPaymentPersistence;
	}
	...
	public List<FilmApplicationPayment> getFilmApplicationPayments(
		...
		return filmApplicationPaymentPersistence.findAll(start, end);
	}
	...
	public int getFilmApplicationPaymentsCount() {
		return filmApplicationPaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		filmApplicationPaymentLocalService =
			(FilmApplicationPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FilmApplicationPaymentLocalService.class.getName();
	}
	...
	protected FilmApplicationPaymentLocalService
		filmApplicationPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FilmApplicationPaymentLocalServiceBaseImpl.class);
