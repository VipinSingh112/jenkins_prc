...
import com.nbp.quarry.stage.service.service.QuarryPaymentConfirmationService;
...
/**
 * Provides the base implementation for the quarry payment confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.quarry.stage.service.service.impl.QuarryPaymentConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.quarry.stage.service.service.impl.QuarryPaymentConfirmationServiceImpl
 * @generated
 */
public abstract class QuarryPaymentConfirmationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuarryPaymentConfirmationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuarryPaymentConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.quarry.stage.service.service.QuarryPaymentConfirmationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		quarryPaymentConfirmationService =
			(QuarryPaymentConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuarryPaymentConfirmationService.class.getName();
	}
	...
	protected QuarryPaymentConfirmationService quarryPaymentConfirmationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuarryPaymentConfirmationServiceBaseImpl.class);
