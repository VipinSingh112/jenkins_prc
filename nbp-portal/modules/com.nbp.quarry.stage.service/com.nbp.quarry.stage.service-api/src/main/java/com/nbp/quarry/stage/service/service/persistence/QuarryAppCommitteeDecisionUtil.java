...
/**
 * The persistence utility for the quarry app committee decision service. This utility wraps <code>com.nbp.quarry.stage.service.service.persistence.impl.QuarryAppCommitteeDecisionPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see QuarryAppCommitteeDecisionPersistence
 * @generated
 */
public class QuarryAppCommitteeDecisionUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(quarryAppCommitteeDecision);
	}
	 ...
	 */
	public static Map<Serializable, QuarryAppCommitteeDecision>
	 ...
	 */
	public static List<QuarryAppCommitteeDecision> findWithDynamicQuery(
	 ...
	 */
	public static QuarryAppCommitteeDecision update(
		QuarryAppCommitteeDecision quarryAppCommitteeDecision) {

		return getPersistence().update(quarryAppCommitteeDecision);
	}
	...
	public static QuarryAppCommitteeDecision update(
		...
		return getPersistence().update(
			quarryAppCommitteeDecision, serviceContext);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision findBygetQuarry_CD_CI(
			String caseId)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().findBygetQuarry_CD_CI(caseId);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision fetchBygetQuarry_CD_CI(
		String caseId) {

		return getPersistence().fetchBygetQuarry_CD_CI(caseId);
	}
	...
	public static QuarryAppCommitteeDecision fetchBygetQuarry_CD_CI(
		...
		return getPersistence().fetchBygetQuarry_CD_CI(caseId, useFinderCache);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision removeBygetQuarry_CD_CI(
			String caseId)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().removeBygetQuarry_CD_CI(caseId);
	}
	 ...
	 */
	public static int countBygetQuarry_CD_CI(String caseId) {
		return getPersistence().countBygetQuarry_CD_CI(caseId);
	}
	 ...
	 */
	public static List<QuarryAppCommitteeDecision> findBygetQuarry_By_CD(
		String committeeDecision) {

		return getPersistence().findBygetQuarry_By_CD(committeeDecision);
	}
	...
	public static List<QuarryAppCommitteeDecision> findBygetQuarry_By_CD(
		...
		return getPersistence().findBygetQuarry_By_CD(
	 ...
	 * @throws NoSuchQuarryAppCommitteeDecisionException if a matching quarry app committee decision could not be found
	 */
	public static QuarryAppCommitteeDecision findBygetQuarry_By_CD_First(
			String committeeDecision,
			OrderByComparator<QuarryAppCommitteeDecision> orderByComparator)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().findBygetQuarry_By_CD_First(
	 ...
	 */
	public static QuarryAppCommitteeDecision fetchBygetQuarry_By_CD_First(
		String committeeDecision,
		OrderByComparator<QuarryAppCommitteeDecision> orderByComparator) {

		return getPersistence().fetchBygetQuarry_By_CD_First(
			committeeDecision, orderByComparator);
	}
	 ...
	 * @throws NoSuchQuarryAppCommitteeDecisionException if a matching quarry app committee decision could not be found
	 */
	public static QuarryAppCommitteeDecision findBygetQuarry_By_CD_Last(
			String committeeDecision,
			OrderByComparator<QuarryAppCommitteeDecision> orderByComparator)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().findBygetQuarry_By_CD_Last(
			committeeDecision, orderByComparator);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision fetchBygetQuarry_By_CD_Last(
		String committeeDecision,
		OrderByComparator<QuarryAppCommitteeDecision> orderByComparator) {

		return getPersistence().fetchBygetQuarry_By_CD_Last(
			committeeDecision, orderByComparator);
	}
	...
	public static QuarryAppCommitteeDecision[]
			findBygetQuarry_By_CD_PrevAndNext(
				long quarryAppCommitteeDecisionId, String committeeDecision,
				OrderByComparator<QuarryAppCommitteeDecision> orderByComparator)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().findBygetQuarry_By_CD_PrevAndNext(
			quarryAppCommitteeDecisionId, committeeDecision, orderByComparator);
	}
	 ...
	 * @param committeeDecision the committee decision
	 */
	public static void removeBygetQuarry_By_CD(String committeeDecision) {
		getPersistence().removeBygetQuarry_By_CD(committeeDecision);
	}
	 ...
	 * @return the number of matching quarry app committee decisions
	 */
	public static int countBygetQuarry_By_CD(String committeeDecision) {
		return getPersistence().countBygetQuarry_By_CD(committeeDecision);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(quarryAppCommitteeDecision);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(quarryAppCommitteeDecisions);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision create(
		long quarryAppCommitteeDecisionId) {

		return getPersistence().create(quarryAppCommitteeDecisionId);
	}
	 ...
	 * @throws NoSuchQuarryAppCommitteeDecisionException if a quarry app committee decision with the primary key could not be found
	 */
	public static QuarryAppCommitteeDecision remove(
			long quarryAppCommitteeDecisionId)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().remove(quarryAppCommitteeDecisionId);
	}

	public static QuarryAppCommitteeDecision updateImpl(
		QuarryAppCommitteeDecision quarryAppCommitteeDecision) {

		return getPersistence().updateImpl(quarryAppCommitteeDecision);
	}
	 ...
	 * @throws NoSuchQuarryAppCommitteeDecisionException if a quarry app committee decision with the primary key could not be found
	 */
	public static QuarryAppCommitteeDecision findByPrimaryKey(
			long quarryAppCommitteeDecisionId)
		throws com.nbp.quarry.stage.service.exception.
			NoSuchQuarryAppCommitteeDecisionException {

		return getPersistence().findByPrimaryKey(quarryAppCommitteeDecisionId);
	}
	 ...
	 */
	public static QuarryAppCommitteeDecision fetchByPrimaryKey(
		long quarryAppCommitteeDecisionId) {

		return getPersistence().fetchByPrimaryKey(quarryAppCommitteeDecisionId);
	}
	 ...
	 */
	public static List<QuarryAppCommitteeDecision> findAll() {
	 ...
	 */
	public static List<QuarryAppCommitteeDecision> findAll(int start, int end) {
	...
	public static QuarryAppCommitteeDecisionPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		QuarryAppCommitteeDecisionPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile QuarryAppCommitteeDecisionPersistence _persistence;
