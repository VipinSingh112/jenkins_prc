...
import com.nbp.ncra.application.form.service.service.NcraApplicationService;
...
/**
 * Provides the base implementation for the ncra application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.ncra.application.form.service.service.impl.NcraApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.ncra.application.form.service.service.impl.NcraApplicationServiceImpl
 * @generated
 */
public abstract class NcraApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NcraApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NcraApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.ncra.application.form.service.service.NcraApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NcraApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ncraApplicationService = (NcraApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NcraApplicationService.class.getName();
	}
	...
	protected NcraApplicationService ncraApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NcraApplicationServiceBaseImpl.class);
