...
/**
 * Provides the local service utility for NcraVerifyWeighingDeviceInfo. This utility wraps
 * <code>com.nbp.ncra.application.form.service.service.impl.NcraVerifyWeighingDeviceInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcraVerifyWeighingDeviceInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncra.application.form.service.service.impl.NcraVerifyWeighingDeviceInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcraVerifyWeighingDeviceInfo addNcraVerifyWeighingDeviceInfo(
		NcraVerifyWeighingDeviceInfo ncraVerifyWeighingDeviceInfo) {

		return getService().addNcraVerifyWeighingDeviceInfo(
	...
	public static NcraVerifyWeighingDeviceInfo
		...
		return getService().createNcraVerifyWeighingDeviceInfo(
	...
	public static NcraVerifyWeighingDeviceInfo
		...
		return getService().deleteNcraVerifyWeighingDeviceInfo(
			ncraVerifyWeighingDeviceInfoId);
	}
	...
	public static NcraVerifyWeighingDeviceInfo
		fetchNcraVerifyWeighingDeviceInfo(long ncraVerifyWeighingDeviceInfoId) {

		return getService().fetchNcraVerifyWeighingDeviceInfo(
			ncraVerifyWeighingDeviceInfoId);
	}
	...
	public static List<NcraVerifyWeighingDeviceInfo> getNcraVerify_By_DataList(
		long ncraApplicationId) {

		return getService().getNcraVerify_By_DataList(ncraApplicationId);
	}

	public static NcraVerifyWeighingDeviceInfo getNcraVerify_By_NCRA_Id(
			long ncraApplicationId)
		throws com.nbp.ncra.application.form.service.exception.
			NoSuchNcraVerifyWeighingDeviceInfoException {

		return getService().getNcraVerify_By_NCRA_Id(ncraApplicationId);
	}
	 ...
	 * @throws PortalException if a ncra verify weighing device info with the primary key could not be found
	 */
	public static NcraVerifyWeighingDeviceInfo getNcraVerifyWeighingDeviceInfo(
			long ncraVerifyWeighingDeviceInfoId)
		throws PortalException {

		return getService().getNcraVerifyWeighingDeviceInfo(
			ncraVerifyWeighingDeviceInfoId);
	}
	...
	public static List<NcraVerifyWeighingDeviceInfo>
		getNcraVerifyWeighingDeviceInfos(int start, int end) {

		return getService().getNcraVerifyWeighingDeviceInfos(start, end);
	}
	 ...
	 */
	public static int getNcraVerifyWeighingDeviceInfosCount() {
		return getService().getNcraVerifyWeighingDeviceInfosCount();
	}
	...
	public static NcraVerifyWeighingDeviceInfo
		...
		return getService().updateNcraVerifyWeighingDeviceInfo(
			ncraVerifyWeighingDeviceInfo);
	}

	public static NcraVerifyWeighingDeviceInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcraVerifyWeighingDeviceInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcraVerifyWeighingDeviceInfoLocalServiceUtil.class,
