...
/**
 * Provides the local service interface for NcraApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcraApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcraApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncra.application.form.service.service.impl.NcraApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncra application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcraApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplication getNcraByAppNum(String applicationNumber)
		throws NoSuchNcraApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplication getNcraByCaseId(String caseId)
		throws NoSuchNcraApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplication getNcraByEI_CI(String entityId, String caseId)
		throws NoSuchNcraApplicationException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcraApplication> getNcraByEntityId_Status(
		String entityId, int status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraApplication getNcraByRT_AppNo(
