...
/**
 * The base model interface for the NcraCurrentStage service. Represents a row in the &quot;nbp_ncra_current_stages&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.ncra.application.form.service.model.impl.NcraCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.ncra.application.form.service.model.impl.NcraCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface NcraCurrentStageModel
	extends BaseModel<NcraCurrentStage>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a ncra current stage model instance should use the {@link NcraCurrentStage} interface instead.
	 */
