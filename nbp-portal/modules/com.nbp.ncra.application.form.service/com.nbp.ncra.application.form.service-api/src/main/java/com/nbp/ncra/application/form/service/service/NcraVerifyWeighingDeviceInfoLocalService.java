...
/**
 * Provides the local service interface for NcraVerifyWeighingDeviceInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NcraVerifyWeighingDeviceInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NcraVerifyWeighingDeviceInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.ncra.application.form.service.service.impl.NcraVerifyWeighingDeviceInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ncra verify weighing device info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NcraVerifyWeighingDeviceInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NcraVerifyWeighingDeviceInfo> getNcraVerify_By_DataList(
		long ncraApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NcraVerifyWeighingDeviceInfo getNcraVerify_By_NCRA_Id(
			long ncraApplicationId)
