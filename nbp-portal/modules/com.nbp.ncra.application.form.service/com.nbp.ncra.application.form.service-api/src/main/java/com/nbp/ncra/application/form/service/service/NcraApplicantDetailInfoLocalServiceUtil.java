...
/**
 * Provides the local service utility for NcraApplicantDetailInfo. This utility wraps
 * <code>com.nbp.ncra.application.form.service.service.impl.NcraApplicantDetailInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NcraApplicantDetailInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.ncra.application.form.service.service.impl.NcraApplicantDetailInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static NcraApplicantDetailInfo addNcraApplicantDetailInfo(
		NcraApplicantDetailInfo ncraApplicantDetailInfo) {

		return getService().addNcraApplicantDetailInfo(ncraApplicantDetailInfo);
	}
	 ...
	 */
	public static NcraApplicantDetailInfo createNcraApplicantDetailInfo(
		long ncraApplicantDetailInfoId) {

		return getService().createNcraApplicantDetailInfo(
	 ...
	 */
	public static NcraApplicantDetailInfo deleteNcraApplicantDetailInfo(
			long ncraApplicantDetailInfoId)
		throws PortalException {

		return getService().deleteNcraApplicantDetailInfo(
			ncraApplicantDetailInfoId);
	}
	...
	public static NcraApplicantDetailInfo fetchNcraApplicantDetailInfo(
		long ncraApplicantDetailInfoId) {

		return getService().fetchNcraApplicantDetailInfo(
			ncraApplicantDetailInfoId);
	}
	 ...
	 * @throws PortalException if a ncra applicant detail info with the primary key could not be found
	 */
	public static NcraApplicantDetailInfo getNcraApplicantDetailInfo(
			long ncraApplicantDetailInfoId)
		throws PortalException {

		return getService().getNcraApplicantDetailInfo(
			ncraApplicantDetailInfoId);
	}
	 ...
	 */
	public static List<NcraApplicantDetailInfo> getNcraApplicantDetailInfos(
		int start, int end) {

		return getService().getNcraApplicantDetailInfos(start, end);
	}
	 ...
	 */
	public static int getNcraApplicantDetailInfosCount() {
		return getService().getNcraApplicantDetailInfosCount();
	}

	public static NcraApplicantDetailInfo getNcraDetail_By_App_Id(
			long ncraApplicationId)
		throws com.nbp.ncra.application.form.service.exception.
			NoSuchNcraApplicantDetailInfoException {

		return getService().getNcraDetail_By_App_Id(ncraApplicationId);
	}
	 ...
	 */
	public static NcraApplicantDetailInfo updateNcraApplicantDetailInfo(
		NcraApplicantDetailInfo ncraApplicantDetailInfo) {

		return getService().updateNcraApplicantDetailInfo(
			ncraApplicantDetailInfo);
	}

	public static NcraApplicantDetailInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<NcraApplicantDetailInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			NcraApplicantDetailInfoLocalServiceUtil.class,
