...
/**
 * Provides the local service utility for WRAReqIrrigation. This utility wraps
 * <code>com.nbp.wra.application.form.service.service.impl.WRAReqIrrigationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class WRAReqIrrigationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.wra.application.form.service.service.impl.WRAReqIrrigationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static WRAReqIrrigation addWRAReqIrrigation(
		WRAReqIrrigation wraReqIrrigation) {

		return getService().addWRAReqIrrigation(wraReqIrrigation);
	}
	 ...
	 */
	public static WRAReqIrrigation createWRAReqIrrigation(
		long wraReqIrrigationId) {

		return getService().createWRAReqIrrigation(wraReqIrrigationId);
	}
	 ...
	 */
	public static WRAReqIrrigation deleteWRAReqIrrigation(
			long wraReqIrrigationId)
		throws PortalException {

		return getService().deleteWRAReqIrrigation(wraReqIrrigationId);
	}
	...
	public static WRAReqIrrigation deleteWRAReqIrrigation(
		...
		return getService().deleteWRAReqIrrigation(wraReqIrrigation);
	}
	...
	public static WRAReqIrrigation fetchWRAReqIrrigation(
		long wraReqIrrigationId) {

		return getService().fetchWRAReqIrrigation(wraReqIrrigationId);
	}
	...
	public static List<WRAReqIrrigation> getWaterRequired_BY_AppId(
		long wraApplicationId) {

		return getService().getWaterRequired_BY_AppId(wraApplicationId);
	}

	public static List<WRAReqIrrigation> getWRA_By_CtrAppId(
		long wraApplicationId,
		OrderByComparator<WRAReqIrrigation> orderByComparator) {

		return getService().getWRA_By_CtrAppId(
			wraApplicationId, orderByComparator);
	}

	public static List<WRAReqIrrigation> getWRA_By_Id(long wraApplicationId) {
	 ...
	 * @throws PortalException if a wra req irrigation with the primary key could not be found
	 */
	public static WRAReqIrrigation getWRAReqIrrigation(long wraReqIrrigationId)
		throws PortalException {

		return getService().getWRAReqIrrigation(wraReqIrrigationId);
	}
	 ...
	 */
	public static List<WRAReqIrrigation> getWRAReqIrrigations(
		int start, int end) {

		return getService().getWRAReqIrrigations(start, end);
	}
	 ...
	 */
	public static int getWRAReqIrrigationsCount() {
		return getService().getWRAReqIrrigationsCount();
	}
	 ...
	 */
	public static WRAReqIrrigation updateWRAReqIrrigation(
		WRAReqIrrigation wraReqIrrigation) {

		return getService().updateWRAReqIrrigation(wraReqIrrigation);
	}

	public static WRAReqIrrigationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<WRAReqIrrigationLocalService>
		_serviceSnapshot = new Snapshot<>(
			WRAReqIrrigationLocalServiceUtil.class,
			WRAReqIrrigationLocalService.class);
