...
import com.nbp.wra.application.form.service.service.LicenceToAbstractInfoService;
...
/**
 * Provides the base implementation for the licence to abstract info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.wra.application.form.service.service.impl.LicenceToAbstractInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.wra.application.form.service.service.impl.LicenceToAbstractInfoServiceImpl
 * @generated
 */
public abstract class LicenceToAbstractInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LicenceToAbstractInfoService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LicenceToAbstractInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.wra.application.form.service.service.LicenceToAbstractInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LicenceToAbstractInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		licenceToAbstractInfoService = (LicenceToAbstractInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return LicenceToAbstractInfoService.class.getName();
	}
	...
	protected LicenceToAbstractInfoService licenceToAbstractInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LicenceToAbstractInfoServiceBaseImpl.class);
