...
import com.nbp.wra.application.form.service.service.WRAReqIrrigationService;
...
/**
 * Provides the base implementation for the wra req irrigation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.wra.application.form.service.service.impl.WRAReqIrrigationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.wra.application.form.service.service.impl.WRAReqIrrigationServiceImpl
 * @generated
 */
public abstract class WRAReqIrrigationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WRAReqIrrigationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WRAReqIrrigationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.wra.application.form.service.service.WRAReqIrrigationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WRAReqIrrigationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		wraReqIrrigationService = (WRAReqIrrigationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WRAReqIrrigationService.class.getName();
	}
	...
	protected WRAReqIrrigationService wraReqIrrigationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WRAReqIrrigationServiceBaseImpl.class);
