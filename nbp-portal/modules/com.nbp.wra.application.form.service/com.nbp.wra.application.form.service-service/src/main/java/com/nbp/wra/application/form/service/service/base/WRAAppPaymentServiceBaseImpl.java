...
import com.nbp.wra.application.form.service.service.WRAAppPaymentService;
...
/**
 * Provides the base implementation for the wra app payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.wra.application.form.service.service.impl.WRAAppPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.wra.application.form.service.service.impl.WRAAppPaymentServiceImpl
 * @generated
 */
public abstract class WRAAppPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WRAAppPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WRAAppPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.wra.application.form.service.service.WRAAppPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WRAAppPaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		wraAppPaymentService = (WRAAppPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WRAAppPaymentService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.wra.application.form.service.service.WRAAppPaymentLocalService
			wraAppPaymentLocalService;

	protected WRAAppPaymentService wraAppPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WRAAppPaymentServiceBaseImpl.class);
