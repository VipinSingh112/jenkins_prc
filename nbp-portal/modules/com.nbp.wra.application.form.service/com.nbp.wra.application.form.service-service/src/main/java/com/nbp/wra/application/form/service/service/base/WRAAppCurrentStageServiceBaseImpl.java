...
import com.nbp.wra.application.form.service.service.WRAAppCurrentStageService;
...
/**
 * Provides the base implementation for the wra app current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.wra.application.form.service.service.impl.WRAAppCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.wra.application.form.service.service.impl.WRAAppCurrentStageServiceImpl
 * @generated
 */
public abstract class WRAAppCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WRAAppCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WRAAppCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.wra.application.form.service.service.WRAAppCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WRAAppCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		wraAppCurrentStageService = (WRAAppCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WRAAppCurrentStageService.class.getName();
	}
	...
	protected WRAAppCurrentStageService wraAppCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WRAAppCurrentStageServiceBaseImpl.class);
