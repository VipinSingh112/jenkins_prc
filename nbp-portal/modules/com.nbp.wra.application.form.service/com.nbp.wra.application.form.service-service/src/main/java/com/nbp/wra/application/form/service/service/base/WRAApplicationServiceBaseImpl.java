...
import com.nbp.wra.application.form.service.service.WRAApplicationService;
...
/**
 * Provides the base implementation for the wra application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.wra.application.form.service.service.impl.WRAApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.wra.application.form.service.service.impl.WRAApplicationServiceImpl
 * @generated
 */
public abstract class WRAApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, WRAApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>WRAApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.wra.application.form.service.service.WRAApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			WRAApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		wraApplicationService = (WRAApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return WRAApplicationService.class.getName();
	}
	...
	@Reference
	protected
		com.nbp.wra.application.form.service.service.WRAApplicationLocalService
			wraApplicationLocalService;

	protected WRAApplicationService wraApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		WRAApplicationServiceBaseImpl.class);
