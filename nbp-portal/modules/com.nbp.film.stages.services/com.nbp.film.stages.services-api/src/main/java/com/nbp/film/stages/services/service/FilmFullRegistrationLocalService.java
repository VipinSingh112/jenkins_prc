...
/**
 * Provides the local service interface for FilmFullRegistration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FilmFullRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FilmFullRegistrationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.film.stages.services.service.impl.FilmFullRegistrationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the film full registration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FilmFullRegistrationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FilmFullRegistration getPharmaFullLIcense(String caseId)
		throws NoSuchFilmFullRegistrationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FilmFullRegistration getPharmaFullLIcense_By_RN(
	...
	public FilmFullRegistration updateFilmFullRegistration(
		...
		String registrationNumber, Date dateofRegistrationPermit,
		String productionTitle, Date productionDateFrom, Date productionDateTo,
		String termsAndConditions);

	public FilmFullRegistration updateFilmFullRegistration(
		String caseId, String duration, String nameofapplicant,
		String productionType, String registrationNumber,
		Date dateofRegistrationPermit, String productionTitle,
		Date productionDateFrom, Date productionDateTo,
		String termsAndConditions);
