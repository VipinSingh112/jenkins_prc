...
/**
 * Provides the local service interface for FilmApplicationRegister. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FilmApplicationRegisterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FilmApplicationRegisterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.film.stages.services.service.impl.FilmApplicationRegisterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the film application register local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FilmApplicationRegisterLocalServiceUtil} if injection and service tracking are not available.
	 */
