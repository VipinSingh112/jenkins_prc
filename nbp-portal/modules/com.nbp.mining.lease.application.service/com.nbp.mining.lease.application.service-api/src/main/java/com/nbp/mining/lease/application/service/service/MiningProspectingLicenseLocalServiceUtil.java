...
/**
 * Provides the local service utility for MiningProspectingLicense. This utility wraps
 * <code>com.nbp.mining.lease.application.service.service.impl.MiningProspectingLicenseLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MiningProspectingLicenseLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.mining.lease.application.service.service.impl.MiningProspectingLicenseLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MiningProspectingLicense addMiningProspectingLicense(
		MiningProspectingLicense miningProspectingLicense) {

		return getService().addMiningProspectingLicense(
	 ...
	 */
	public static MiningProspectingLicense createMiningProspectingLicense(
		long miningProspectingLicenseId) {

		return getService().createMiningProspectingLicense(
	 ...
	 */
	public static MiningProspectingLicense deleteMiningProspectingLicense(
			long miningProspectingLicenseId)
		throws PortalException {

		return getService().deleteMiningProspectingLicense(
			miningProspectingLicenseId);
	}
	...
	public static MiningProspectingLicense fetchMiningProspectingLicense(
		long miningProspectingLicenseId) {

		return getService().fetchMiningProspectingLicense(
			miningProspectingLicenseId);
	}
	 ...
	 * @throws PortalException if a mining prospecting license with the primary key could not be found
	 */
	public static MiningProspectingLicense getMiningProspectingLicense(
			long miningProspectingLicenseId)
		throws PortalException {

		return getService().getMiningProspectingLicense(
			miningProspectingLicenseId);
	}
	 ...
	 */
	public static List<MiningProspectingLicense> getMiningProspectingLicenses(
		int start, int end) {

		return getService().getMiningProspectingLicenses(start, end);
	}
	 ...
	 */
	public static int getMiningProspectingLicensesCount() {
		return getService().getMiningProspectingLicensesCount();
	}

	public static MiningProspectingLicense getMinningById(
	 ...
	 */
	public static MiningProspectingLicense updateMiningProspectingLicense(
		MiningProspectingLicense miningProspectingLicense) {

		return getService().updateMiningProspectingLicense(
			miningProspectingLicense);
	}

	public static MiningProspectingLicenseLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<MiningProspectingLicenseLocalService>
		_serviceSnapshot = new Snapshot<>(
			MiningProspectingLicenseLocalServiceUtil.class,
