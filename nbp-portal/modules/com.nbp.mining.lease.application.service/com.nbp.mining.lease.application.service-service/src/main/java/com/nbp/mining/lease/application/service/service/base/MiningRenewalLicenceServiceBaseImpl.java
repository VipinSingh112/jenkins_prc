...
import com.nbp.mining.lease.application.service.service.MiningRenewalLicenceService;
...
/**
 * Provides the base implementation for the mining renewal licence remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.lease.application.service.service.impl.MiningRenewalLicenceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.lease.application.service.service.impl.MiningRenewalLicenceServiceImpl
 * @generated
 */
public abstract class MiningRenewalLicenceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiningRenewalLicenceService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningRenewalLicenceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.lease.application.service.service.MiningRenewalLicenceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiningRenewalLicenceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miningRenewalLicenceService = (MiningRenewalLicenceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningRenewalLicenceService.class.getName();
	}
	...
	protected MiningRenewalLicenceService miningRenewalLicenceService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningRenewalLicenceServiceBaseImpl.class);
