...
import com.nbp.mining.lease.application.service.service.MiningFormFiveDelineationService;
...
/**
 * Provides the base implementation for the mining form five delineation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.lease.application.service.service.impl.MiningFormFiveDelineationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.lease.application.service.service.impl.MiningFormFiveDelineationServiceImpl
 * @generated
 */
public abstract class MiningFormFiveDelineationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiningFormFiveDelineationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningFormFiveDelineationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.lease.application.service.service.MiningFormFiveDelineationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		miningFormFiveDelineationService =
			(MiningFormFiveDelineationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningFormFiveDelineationService.class.getName();
	}
	...
	protected MiningFormFiveDelineationService miningFormFiveDelineationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningFormFiveDelineationServiceBaseImpl.class);
