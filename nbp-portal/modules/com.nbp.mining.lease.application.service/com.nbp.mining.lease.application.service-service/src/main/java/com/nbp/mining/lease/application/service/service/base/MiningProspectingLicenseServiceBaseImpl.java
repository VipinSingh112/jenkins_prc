...
import com.nbp.mining.lease.application.service.service.MiningProspectingLicenseService;
...
/**
 * Provides the base implementation for the mining prospecting license remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.lease.application.service.service.impl.MiningProspectingLicenseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.lease.application.service.service.impl.MiningProspectingLicenseServiceImpl
 * @generated
 */
public abstract class MiningProspectingLicenseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiningProspectingLicenseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningProspectingLicenseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.lease.application.service.service.MiningProspectingLicenseServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiningProspectingLicenseService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		miningProspectingLicenseService =
			(MiningProspectingLicenseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningProspectingLicenseService.class.getName();
	}
	...
	protected MiningProspectingLicenseService miningProspectingLicenseService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningProspectingLicenseServiceBaseImpl.class);
