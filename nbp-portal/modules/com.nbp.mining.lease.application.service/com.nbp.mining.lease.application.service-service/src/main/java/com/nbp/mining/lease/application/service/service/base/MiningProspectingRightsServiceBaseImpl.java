...
import com.nbp.mining.lease.application.service.service.MiningProspectingRightsService;
...
/**
 * Provides the base implementation for the mining prospecting rights remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.lease.application.service.service.impl.MiningProspectingRightsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.lease.application.service.service.impl.MiningProspectingRightsServiceImpl
 * @generated
 */
public abstract class MiningProspectingRightsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiningProspectingRightsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningProspectingRightsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.lease.application.service.service.MiningProspectingRightsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiningProspectingRightsService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		miningProspectingRightsService =
			(MiningProspectingRightsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningProspectingRightsService.class.getName();
	}
	...
	protected com.nbp.mining.lease.application.service.service.
		MiningProspectingRightsLocalService miningProspectingRightsLocalService;

	protected MiningProspectingRightsService miningProspectingRightsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningProspectingRightsServiceBaseImpl.class);
