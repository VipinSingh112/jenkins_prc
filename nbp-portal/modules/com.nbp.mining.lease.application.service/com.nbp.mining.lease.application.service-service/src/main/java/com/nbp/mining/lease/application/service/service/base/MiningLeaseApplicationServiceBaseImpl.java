...
import com.nbp.mining.lease.application.service.service.MiningLeaseApplicationService;
...
/**
 * Provides the base implementation for the mining lease application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.mining.lease.application.service.service.impl.MiningLeaseApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.mining.lease.application.service.service.impl.MiningLeaseApplicationServiceImpl
 * @generated
 */
public abstract class MiningLeaseApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MiningLeaseApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MiningLeaseApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.mining.lease.application.service.service.MiningLeaseApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MiningLeaseApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		miningLeaseApplicationService = (MiningLeaseApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MiningLeaseApplicationService.class.getName();
	}
	...
	protected MiningLeaseApplicationService miningLeaseApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MiningLeaseApplicationServiceBaseImpl.class);
