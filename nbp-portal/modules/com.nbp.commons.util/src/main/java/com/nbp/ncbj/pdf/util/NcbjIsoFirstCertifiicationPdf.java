...
public class NcbjIsoFirstCertifiicationPdf {
	public static String replaceSignatureForFrom(long ncbjApplicationId, String folderName, long groupId,
		...
		for (DLFileEntry dlFileEntry : supportinfDocFileEntries) {
			...
			System.out.println("----------------------------------previewUrl-----Signature of Applicant of first new client form iso 9001-------------------"+previewUrl);
		}
		return previewUrl;
	}
	
	public static String getIsoFirstFormSingleSitePdf(long ncbjApplicationId, ThemeDisplay themeDisplay,
