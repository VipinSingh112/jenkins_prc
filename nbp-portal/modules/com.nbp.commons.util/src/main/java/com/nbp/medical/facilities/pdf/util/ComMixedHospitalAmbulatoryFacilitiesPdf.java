...
public class ComMixedHospitalAmbulatoryFacilitiesPdf {
	...
	public static String getComMixedHospitalAmbulatoryFacilitiesPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		//pdf go in launch case
				if (checkPdfDownloadWithoutDocument.equals("false")) {
					pdfTemplate = getTemplateFromJournalArticlePDF(themeDisplay.getScopeGroupId(),
							"company-mixed-med-facilties-1");
				} else {
					try {
					pdfTemplate = getTemplateFromJournalArticlePDF
							(themeDisplay.getScopeGroupId(),
							"company-mixed-med-facilties");
					}catch (Exception e) {
