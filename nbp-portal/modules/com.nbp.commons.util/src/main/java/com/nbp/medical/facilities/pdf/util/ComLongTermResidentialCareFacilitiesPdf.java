...
public class ComLongTermResidentialCareFacilitiesPdf {
 ...
 return previewUrl;
	...
	public static String getComLongTermResidentialCareFacilitiesPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		//pdf go in launch case
				if (checkPdfDownloadWithoutDocument.equals("false")) {
					...
					pdfTemplate = getTemplateFromJournalArticlePDF
							...
							"residential-care-facilities-company");
					}catch (Exception e) {
