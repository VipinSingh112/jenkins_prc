...
public class IndiHospitalAmbulatoryFacilitiesPdf {
 ...
 return previewUrl;
	...
	public static String getHospitalAmbulatoryFacilitiesPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		try {
			...
			System.out.println("Medical Payment---"+medicalPayment.getPaymentMethod());
			paymentMethodPdf=medicalPayment!=null&&medicalPayment.getPaymentMethod()!=null?medicalPayment.getPaymentMethod():"";
		}catch (Exception e) {
		}
