...
public class LongTermsIndiNonMaternityHomePdf {
 ...
 return previewUrl;
	...
	public static String getIndiLongTermNonMaternityHomesPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		//pdf go in launch case
				if (checkPdfDownloadWithoutDocument.equals("false")) {
					pdfTemplate = getTemplateFromJournalArticlePDF(themeDisplay.getScopeGroupId(),
							"medical-facilities-non-maternity");
				} else {
					try {
					pdfTemplate = getTemplateFromJournalArticlePDF
							(themeDisplay.getScopeGroupId(),
							"medical-indi-non-maternity-category");
					}catch (Exception e) {
