...
public class LongTermsIndiMixedCategoryPdf {
	public static String replaceSignatureForComMaternity(long medicalApplicationId, String folderName, long groupId,
 ...
 return previewUrl;
	...
	public static String getIndiLongTermMixedCategoryPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		//signatures
		  ...
		  try { 
			  signatureForComMedical =replaceSignatureForComMaternity(signatureInfoCom.getMedicalFacilitiesAppId(), "Signature of Applicant Employee", themeDisplay.getScopeGroupId(), 
		...
		//pdf go in launch case
				if(checkPdfDownloadWithoutDocument.equals("false")){
					pdfTemplate = getTemplateFromJournalArticlePDF(themeDisplay.getScopeGroupId(),
							"medical-facilities-mixed");
				} else {
					try {
					pdfTemplate = getTemplateFromJournalArticlePDF
							(themeDisplay.getScopeGroupId(),
							"medical-indi-mixed-category");
					}catch (Exception e) {
		...
		try {
			...
			//Applicant details
					...
					"[$MedicalDuly$]","[$HomeNameNon$]","[$QualificationsNon$]",
					"[$QualifiedRatioNon$]","[$NurseNon$]","[$NonNameCare$]",
					"[$QualificationsNonCare$]",
					
					"[$MaternityNameHo1$]","[$QualificationsMe1$]","[$MidwifeNurse1$]",
					"[$MaternityNameHo2$]","[$QualificationsMe2$]","[$MidwifeNurse2$]",
					"[$MaternityNameHo3$]","[$QualificationsMe3$]","[$MidwifeNurse3$]",
					"[$MaternityNameHo4$]","[$QualificationsMe4$]","[$MidwifeNurse4$]",
					"[$MaternityNameHo5$]","[$QualificationsMe5$]","[$MidwifeNurse5$]",
			...
			//Applicant details
				...
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>0)?maternityHomeInfo.get(0).getNurseName():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>0)?maternityHomeInfo.get(0).getNurseQualification():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>0)?maternityHomeInfo.get(0).getOtherPerson():"",
				
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>1)?maternityHomeInfo.get(1).getNurseName():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>1)?maternityHomeInfo.get(1).getNurseQualification():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>1)?maternityHomeInfo.get(1).getOtherPerson():"",
						
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>2)?maternityHomeInfo.get(2).getNurseName():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>2)?maternityHomeInfo.get(2).getNurseQualification():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>2)?maternityHomeInfo.get(2).getOtherPerson():"",
				
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>3)?maternityHomeInfo.get(3).getNurseName():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>3)?maternityHomeInfo.get(3).getNurseQualification():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>3)?maternityHomeInfo.get(3).getOtherPerson():"",
				
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>4)?maternityHomeInfo.get(4).getNurseName():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>4)?maternityHomeInfo.get(4).getNurseQualification():"",
				(maternityHomeInfo!=null)&&(maternityHomeInfo.size()>4)?maternityHomeInfo.get(4).getOtherPerson():"",		
