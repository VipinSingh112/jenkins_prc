...
public class ComMaternityHospitalAmbulatoryFacilitiesPdf {
 ...
 return previewUrl;
	...
	public static String getComHospitalAmbulatoryFacilitiesPdf(long medicalApplicationId, ThemeDisplay themeDisplay,
		...
		//pdf go in launch case
				if (checkPdfDownloadWithoutDocument.equals("false")) {
					pdfTemplate = getTemplateFromJournalArticlePDF(themeDisplay.getScopeGroupId(),
							"medical-facilities-maternity-company-1");
				} else {
					try {
					pdfTemplate = getTemplateFromJournalArticlePDF
							(themeDisplay.getScopeGroupId(),
							"medical-facilities-maternity-company");
					}catch (Exception e) {
		...
		try {
			...
			//Applicant details
					...
					"[$MaternityNameCompanyHo1$]","[$QualificationsCompanyHo1$]","[$MidwifeNurseCompanyHo1$]",
					"[$MaternityNameCompanyHo2$]","[$QualificationsCompanyHo2$]","[$MidwifeNurseCompanyHo2$]",
					"[$MaternityNameCompanyHo3$]","[$QualificationsCompanyHo3$]","[$MidwifeNurseCompanyHo3$]",
					"[$MaternityNameCompanyHo4$]","[$QualificationsCompanyHo4$]","[$MidwifeNurseCompanyHo4$]",
					"[$MaternityNameCompanyHo5$]","[$QualificationsCompanyHo5$]","[$MidwifeNurseCompanyHo5$]",
					
					"[$NumberCompanySign$]","[$ParticulaCompanySign$]","[$FeesChargedCompanySign$]","[$ApplicantAddressCompanySign$]",
					"[$MedicalDateCompanySign$]"/* "[$SignatureMed$]", */
