...
public class ExplosivePyrotechnicApplicationPdf {
...
public static String getPyrotechnicPdf(long explosivesApplicationId, ThemeDisplay themeDisplay, String checkPdfDownloadWithoutDocument) {
...
//pdf go in launch case
		if (checkPdfDownloadWithoutDocument.equals("false")) {
			pdfTemplate = getTemplateFromJournalArticlePDF(themeDisplay.getScopeGroupId(),
					"pyrotechnic-competency-certificate-1");
		} else {
			try {
			pdfTemplate = getTemplateFromJournalArticlePDF
					(themeDisplay.getScopeGroupId(),
					"pyrotechnic-competency-certificate");
			}catch (Exception e) {
...
try {
	...
	//Personal Information         4
		"[$SurNamePyrotech$]", "[$firstNamePyrotech$]", "[$middleInitialPyrotech$]", "[$sexPyrotech$]", 
		
		
	  //Contact Information 9
		
		"[$OfficePhonePyrotech$]", "[$CellPhonePyrotech$]", "[$ApplicantTrnPyrotech$]", "[$ApplicantBirthPyrotech$]", "[$ADDressPyrotech$]","[$EducationBackGroundPyrotech$]",
		"[$BlastingCoursePyrotech$]", "[$CourceNamePyrotech$]","[$CourseOrganizerPyrotech$]",
		
		//sign
		
		"[$SubmitterPyrotech$]", "[$imagePyrotech$]", 
		
		//date        1
		"[$SubmitterDatePyrotech$]",
