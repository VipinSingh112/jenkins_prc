...
/**
 * The base model interface for the AgricultureApplicationStages service. Represents a row in the &quot;nbp_agriculture_app_stages&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.agriculture.stages.services.model.impl.AgricultureApplicationStagesModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.agriculture.stages.services.model.impl.AgricultureApplicationStagesImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface AgricultureApplicationStagesModel
	extends BaseModel<AgricultureApplicationStages>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a agriculture application stages model instance should use the {@link AgricultureApplicationStages} interface instead.
	 */
