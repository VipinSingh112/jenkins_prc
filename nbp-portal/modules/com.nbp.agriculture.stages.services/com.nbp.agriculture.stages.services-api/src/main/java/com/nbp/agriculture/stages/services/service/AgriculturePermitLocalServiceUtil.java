...
/**
 * Provides the local service utility for AgriculturePermit. This utility wraps
 * <code>com.nbp.agriculture.stages.services.service.impl.AgriculturePermitLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AgriculturePermitLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.agriculture.stages.services.service.impl.AgriculturePermitLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AgriculturePermit addAgriculturePermit(
		AgriculturePermit agriculturePermit) {

		return getService().addAgriculturePermit(agriculturePermit);
	}
	 ...
	 */
	public static AgriculturePermit createAgriculturePermit(
		long agriculturePermitId) {

		return getService().createAgriculturePermit(agriculturePermitId);
	}
	 ...
	 */
	public static AgriculturePermit deleteAgriculturePermit(
		AgriculturePermit agriculturePermit) {

		return getService().deleteAgriculturePermit(agriculturePermit);
	}
	...
	public static AgriculturePermit deleteAgriculturePermit(
		...
		return getService().deleteAgriculturePermit(agriculturePermitId);
	}
	...
	public static AgriculturePermit fetchAgriculturePermit(
		long agriculturePermitId) {

		return getService().fetchAgriculturePermit(agriculturePermitId);
	}
	...
	public static AgriculturePermit getAgricultureBy_CI(String caseId)
	...
	public static AgriculturePermit getAgricultureBy_PN(String PermitNumber)
		throws com.nbp.agriculture.stages.services.exception.
			NoSuchAgriculturePermitException {

		return getService().getAgricultureBy_PN(PermitNumber);
	}
	 ...
	 * @throws PortalException if a agriculture permit with the primary key could not be found
	 */
	public static AgriculturePermit getAgriculturePermit(
			long agriculturePermitId)
		throws PortalException {

		return getService().getAgriculturePermit(agriculturePermitId);
	}
	 ...
	 */
	public static List<AgriculturePermit> getAgriculturePermits(
		int start, int end) {

		return getService().getAgriculturePermits(start, end);
	}
	 ...
	 */
	public static int getAgriculturePermitsCount() {
		return getService().getAgriculturePermitsCount();
	}
	 ...
	 */
	public static AgriculturePermit updateAgriculturePermit(
		AgriculturePermit agriculturePermit) {

		return getService().updateAgriculturePermit(agriculturePermit);
	}
	...
	public static AgriculturePermitLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AgriculturePermitLocalService>
		_serviceSnapshot = new Snapshot<>(
			AgriculturePermitLocalServiceUtil.class,
			AgriculturePermitLocalService.class);
