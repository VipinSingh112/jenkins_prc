...
/**
 * Provides the local service interface for AgricultureInspection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AgricultureInspectionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgricultureInspectionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.agriculture.stages.services.service.impl.AgricultureInspectionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agriculture inspection local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgricultureInspectionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureInspection getAgricultureBy_CI(String caseId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureInspection> getAgriInspections(
		long agriApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureInspection> getAgriInspectionsByCaseId(
		String caseId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureInspection> getAgriInspectionsByStatusApplicationId(
		long agriApplicationId, String status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureInspection getAgriInspectionsByStatusApplicationId(
			String status, long slotBookedByUser, long agriApplicationId)
		throws NoSuchAgricultureInspectionException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureInspection> getAgriInspectionsByStatusCaseId(
