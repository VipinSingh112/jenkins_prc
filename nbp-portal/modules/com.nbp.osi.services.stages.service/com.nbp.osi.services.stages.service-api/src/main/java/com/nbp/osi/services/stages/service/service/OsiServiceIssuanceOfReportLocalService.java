...
/**
 * Provides the local service interface for OsiServiceIssuanceOfReport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiServiceIssuanceOfReportLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiServiceIssuanceOfReportLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.services.stages.service.service.impl.OsiServiceIssuanceOfReportLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi service issuance of report local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiServiceIssuanceOfReportLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OsiServiceIssuanceOfReport updateInsoIIssuanceOfReport(
		String caseId, Date dateOfReport, String nameOfApplicant,
