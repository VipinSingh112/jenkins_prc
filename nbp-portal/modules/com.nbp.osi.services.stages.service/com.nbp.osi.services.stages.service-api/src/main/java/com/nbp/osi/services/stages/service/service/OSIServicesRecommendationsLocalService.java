...
/**
 * Provides the local service interface for OSIServicesRecommendations. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OSIServicesRecommendationsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OSIServicesRecommendationsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.services.stages.service.service.impl.OSIServicesRecommendationsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi services recommendations local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OSIServicesRecommendationsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OSIServicesRecommendations addOSIServicesRecommendations(
	...
	public OSIServicesRecommendations createOSIServicesRecommendations(
	...
	public OSIServicesRecommendations deleteOSIServicesRecommendations(
			long oSIServicesRecommendationsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesRecommendations fetchOSIServicesRecommendations(
		long oSIServicesRecommendationsId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesRecommendations getOsiServicesRecommendationByCaseId(
			String caseId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesRecommendations getOSIServicesRecommendations(
			long oSIServicesRecommendationsId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OSIServicesRecommendations> getOSIServicesRecommendationses(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OSIServicesRecommendations updateOSIServicesRecommendations(
		OSIServicesRecommendations osiServicesRecommendations);
