...
/**
 * Provides the local service interface for OSIServicesStages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OSIServicesStagesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OSIServicesStagesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.services.stages.service.service.impl.OSIServicesStagesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi services stages local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OSIServicesStagesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesStages getOSIService_By_CaseId(String caseId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesStages getOSIServiceStagesBy_SI_SN(
			String caseId, String stageName)
		throws NoSuchOSIServicesStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OSIServicesStages getOSIServiceStagesBy_SI_ST_SN(
