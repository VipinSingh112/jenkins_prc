...
import com.nbp.jadsc.application.form.service.service.JADSCChecklistService;
...
/**
 * Provides the base implementation for the jadsc checklist remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jadsc.application.form.service.service.impl.JADSCChecklistServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jadsc.application.form.service.service.impl.JADSCChecklistServiceImpl
 * @generated
 */
public abstract class JADSCChecklistServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JADSCChecklistService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JADSCChecklistService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jadsc.application.form.service.service.JADSCChecklistServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JADSCChecklistService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jadscChecklistService = (JADSCChecklistService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JADSCChecklistService.class.getName();
	}
	...
	protected JADSCChecklistService jadscChecklistService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JADSCChecklistServiceBaseImpl.class);
