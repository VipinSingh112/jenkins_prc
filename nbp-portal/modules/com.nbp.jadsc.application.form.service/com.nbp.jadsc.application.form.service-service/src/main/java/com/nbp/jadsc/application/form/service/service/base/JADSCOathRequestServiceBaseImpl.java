...
import com.nbp.jadsc.application.form.service.service.JADSCOathRequestService;
...
/**
 * Provides the base implementation for the jadsc oath request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jadsc.application.form.service.service.impl.JADSCOathRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jadsc.application.form.service.service.impl.JADSCOathRequestServiceImpl
 * @generated
 */
public abstract class JADSCOathRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JADSCOathRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JADSCOathRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jadsc.application.form.service.service.JADSCOathRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JADSCOathRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jadscOathRequestService = (JADSCOathRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JADSCOathRequestService.class.getName();
	}
	...
	protected JADSCOathRequestService jadscOathRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JADSCOathRequestServiceBaseImpl.class);
