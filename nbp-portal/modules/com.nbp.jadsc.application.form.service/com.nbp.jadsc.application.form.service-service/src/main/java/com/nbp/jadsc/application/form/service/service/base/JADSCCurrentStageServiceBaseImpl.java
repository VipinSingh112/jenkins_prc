...
import com.nbp.jadsc.application.form.service.service.JADSCCurrentStageService;
...
/**
 * Provides the base implementation for the jadsc current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jadsc.application.form.service.service.impl.JADSCCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jadsc.application.form.service.service.impl.JADSCCurrentStageServiceImpl
 * @generated
 */
public abstract class JADSCCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JADSCCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JADSCCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jadsc.application.form.service.service.JADSCCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JADSCCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jadscCurrentStageService = (JADSCCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JADSCCurrentStageService.class.getName();
	}
	...
	protected JADSCCurrentStageService jadscCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JADSCCurrentStageServiceBaseImpl.class);
