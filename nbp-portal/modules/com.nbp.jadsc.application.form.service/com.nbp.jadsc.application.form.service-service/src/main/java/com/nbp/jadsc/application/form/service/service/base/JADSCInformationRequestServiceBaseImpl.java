...
import com.nbp.jadsc.application.form.service.service.JADSCInformationRequestService;
...
/**
 * Provides the base implementation for the jadsc information request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jadsc.application.form.service.service.impl.JADSCInformationRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jadsc.application.form.service.service.impl.JADSCInformationRequestServiceImpl
 * @generated
 */
public abstract class JADSCInformationRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   JADSCInformationRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JADSCInformationRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jadsc.application.form.service.service.JADSCInformationRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JADSCInformationRequestService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		jadscInformationRequestService =
			(JADSCInformationRequestService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JADSCInformationRequestService.class.getName();
	}
	...
	protected com.nbp.jadsc.application.form.service.service.
		JADSCInformationRequestLocalService jadscInformationRequestLocalService;

	protected JADSCInformationRequestService jadscInformationRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JADSCInformationRequestServiceBaseImpl.class);
