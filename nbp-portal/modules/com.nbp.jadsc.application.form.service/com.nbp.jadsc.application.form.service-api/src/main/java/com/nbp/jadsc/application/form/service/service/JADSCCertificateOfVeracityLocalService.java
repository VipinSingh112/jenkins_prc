...
/**
 * Provides the local service interface for JADSCCertificateOfVeracity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JADSCCertificateOfVeracityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JADSCCertificateOfVeracityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jadsc.application.form.service.service.impl.JADSCCertificateOfVeracityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the jadsc certificate of veracity local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JADSCCertificateOfVeracityLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JADSCCertificateOfVeracity getJADSCBy_Id(long jadscApplicationId)
