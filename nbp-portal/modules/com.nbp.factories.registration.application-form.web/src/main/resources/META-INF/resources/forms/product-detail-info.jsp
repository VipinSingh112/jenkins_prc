<%
String productDetailVal = "";
productDetailVal = (String)request.getAttribute("productDetailVal");
%>
<tr class="product-details-row<%=productDetailVal%>">
	<td class="sub_heading_content brand<%=productDetailVal%>"></td>
	<td class="sub_heading_content product<%=productDetailVal%>"></td>
	<td class="sub_heading_content productSize<%=productDetailVal%>"></td>
	<td class="sub_heading_content measurementValue<%=productDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="productDetail<%=productDetailVal%>" name="productDetail<%=productDetailVal%>" value="">
</tr>
