...
<fieldset class="wizard-fieldset" id="factoriesSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	<p class="supporting-document-title common-heading f1 mb-2">Recommended Supporting Documents</p>
	...
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="factoriesGenericUpload" multiple="multiple"
				name="<portlet:namespace/>factoriesGenericUpload" onchange="attachDetailed(this.id)"
				hidden=""> <label class="custom-upload"
				for="factoriesGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="factoriesGenericFileChosen"></span>
		</div>
		...
		try{
		supportingDocumentsParentFolderGeneric=GettingDocumentData.getDocumentLibraryParentAndSubFolder(themeDisplay.getScopeGroupId(), factoriesApplicationId);
		...
		if(factoriesApplicationId>0 && dlFileEntriesGeneric!=null){
			try{
				int docOfFactoriesAdditionalCounter=1001;
		...
		%><div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfFactoriesAdditionalCounter%>">
			<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfFactoriesAdditionalCounter%>">
						<%
						%>
			...
			<%	
			docOfFactoriesAdditionalCounter++;
			}}catch(Exception e ){
			}
				}
			%> 
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="factoriesEnrollDocuments"
												name="<portlet:namespace/>factoriesEnrollDocuments" onchange="attachDetailed(this.id)"/>
