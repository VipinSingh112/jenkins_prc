...
@Component(immediate = true, property = {
		...
		"mvc.command.name=factories/Registration/Doucuments/Upload" }, service = MVCResourceCommand.class)
public class FactoriesRegistrationDocumentUploadResourceCommand implements MVCResourceCommand {
	...
	private static Log _log = LogFactoryUtil.getLog(FactoriesRegistrationDocumentUploadResourceCommand.class.getName());
	...
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try {
			...
			if (Validator.isNotNull(inputStream)) {
				...
				DLFolder dlFolder = createFolder(themeDisplay.getUserId(), factoriesApplicationId,
				...
				ExpandoColumn docNoExpandoColumn = ExpandoColumnLocalServiceUtil.getColumn(expandoTable.getTableId(),
						FactoriesRegistrationApplicationWorkFlowConstants.DOC_NO);
