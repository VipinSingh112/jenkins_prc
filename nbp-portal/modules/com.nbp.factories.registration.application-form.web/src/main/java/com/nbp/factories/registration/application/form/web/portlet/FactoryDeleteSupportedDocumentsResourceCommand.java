...
@Component(immediate = true, property = {
		...
		"mvc.command.name=/factory/Delete/Document/Url" }, service = MVCResourceCommand.class)

public class FactoryDeleteSupportedDocumentsResourceCommand implements MVCResourceCommand {
