...
@Component(
		...
		property = {
				...
				"mvc.command.name=/factories/Pending/App" }, service = MVCResourceCommand.class)

public class FactoriesRegistrationApplicationPendingResourceCommand implements MVCResourceCommand {

	private static Log _log = LogFactoryUtil.getLog(FactoriesRegistrationApplicationPendingResourceCommand.class.getName());

	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws PortletException {
			_log.info("[PENDING APPLICATION STARTED]");
