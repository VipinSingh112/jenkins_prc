...
/**
 * Provides the local service interface for ExplosiveCommisionDecision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExplosiveCommisionDecisionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ExplosiveCommisionDecisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.explosives.competency.stages.service.service.impl.ExplosiveCommisionDecisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the explosive commision decision local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ExplosiveCommisionDecisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ExplosiveCommisionDecision getExplosiveCommisionDecisionBy_CI(
			String caseId)
	...
	public ExplosiveCommisionDecision updateExplosiveCommisionDecision(
			String caseId, Date dateOfDecision, String commisionDecision)
		throws NoSuchExplosiveCommisionDecisionException;
