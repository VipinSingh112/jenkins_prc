...
/**
 * Provides the local service utility for PharmaDeskVerification. This utility wraps
 * <code>com.nbp.pharmaceutical.stages.services.service.impl.PharmaDeskVerificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PharmaDeskVerificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.pharmaceutical.stages.services.service.impl.PharmaDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PharmaDeskVerification addPharmaDeskVerification(
		PharmaDeskVerification pharmaDeskVerification) {

		return getService().addPharmaDeskVerification(pharmaDeskVerification);
	}
	 ...
	 */
	public static PharmaDeskVerification createPharmaDeskVerification(
		long pharmaDeskVerificationId) {

		return getService().createPharmaDeskVerification(
	 ...
	 */
	public static PharmaDeskVerification deletePharmaDeskVerification(
			long pharmaDeskVerificationId)
		throws PortalException {

		return getService().deletePharmaDeskVerification(
			pharmaDeskVerificationId);
	}
	...
	public static void deletePharmaDeskVerificationId(
		long pharmaApplicationId) {

		getService().deletePharmaDeskVerificationId(pharmaApplicationId);
	}
	...
	public static PharmaDeskVerification fetchPharmaDeskVerification(
		long pharmaDeskVerificationId) {

		return getService().fetchPharmaDeskVerification(
			pharmaDeskVerificationId);
	}
	...
	public static List<PharmaDeskVerification> getDeskVerificationPharmaById(
		long pharmaApplicationId) {

		return getService().getDeskVerificationPharmaById(pharmaApplicationId);
	}
	 ...
	 * @throws PortalException if a pharma desk verification with the primary key could not be found
	 */
	public static PharmaDeskVerification getPharmaDeskVerification(
			long pharmaDeskVerificationId)
		throws PortalException {

		return getService().getPharmaDeskVerification(pharmaDeskVerificationId);
	}
	 ...
	 */
	public static List<PharmaDeskVerification> getPharmaDeskVerifications(
		int start, int end) {

		return getService().getPharmaDeskVerifications(start, end);
	}
	 ...
	 */
	public static int getPharmaDeskVerificationsCount() {
		return getService().getPharmaDeskVerificationsCount();
	}
	 ...
	 */
	public static PharmaDeskVerification updatePharmaDeskVerification(
		PharmaDeskVerification pharmaDeskVerification) {

		return getService().updatePharmaDeskVerification(
			pharmaDeskVerification);
	}

	public static PharmaDeskVerificationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<PharmaDeskVerificationLocalService>
		_serviceSnapshot = new Snapshot<>(
			PharmaDeskVerificationLocalServiceUtil.class,
