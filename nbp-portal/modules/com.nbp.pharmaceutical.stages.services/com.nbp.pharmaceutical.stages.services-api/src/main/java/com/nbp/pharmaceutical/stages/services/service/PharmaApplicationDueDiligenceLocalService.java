...
/**
 * Provides the local service interface for PharmaApplicationDueDiligence. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaApplicationDueDiligenceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaApplicationDueDiligenceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationDueDiligenceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma application due diligence local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaApplicationDueDiligenceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplicationDueDiligence getPharmaApplicationDueDiligenceStage(
	...
	public PharmaApplicationDueDiligence updatePharmaApplicationDueDiligence(
		String caseId, String agencyName, Date dateSubmittedToAgency,
		Date dateFeedbackReceived, String status,
		String durationOfTimeSpentAtAgency, String agencyDecision);

	public PharmaApplicationDueDiligence updatePharmaApplicationDueDiligence(
		String caseId, String agencyName, String agencyContactName,
		String agencyEmailAddress, Date dateFeedbackReceived,
		Date dateOfApplication, Date dateSubmittedToAgency,
		Date datefoDeadlineByAgency, String entityName, String status,
