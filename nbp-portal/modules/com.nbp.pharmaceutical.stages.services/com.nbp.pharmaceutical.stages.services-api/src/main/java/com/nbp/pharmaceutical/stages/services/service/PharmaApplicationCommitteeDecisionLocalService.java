...
/**
 * Provides the local service interface for PharmaApplicationCommitteeDecision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaApplicationCommitteeDecisionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaApplicationCommitteeDecisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationCommitteeDecisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma application committee decision local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaApplicationCommitteeDecisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplicationCommitteeDecision
		fetchPharmaApplicationCommitteeDecision(long pharmaCommitteeDecisionId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplicationCommitteeDecision getPharmaCommitteDecisionByCI(
			String caseId)
