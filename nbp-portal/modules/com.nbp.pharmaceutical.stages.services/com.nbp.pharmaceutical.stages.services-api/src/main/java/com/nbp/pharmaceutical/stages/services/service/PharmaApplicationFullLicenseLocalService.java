...
/**
 * Provides the local service interface for PharmaApplicationFullLicense. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PharmaApplicationFullLicenseLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PharmaApplicationFullLicenseLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationFullLicenseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pharma application full license local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PharmaApplicationFullLicenseLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplicationFullLicense getPharmaFullLIcense(String caseId)
		throws NoSuchPharmaApplicationFullLicenseException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PharmaApplicationFullLicense getPharmaFullLIcenseBY_LN(
			String licenseNumber)
		throws NoSuchPharmaApplicationFullLicenseException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PharmaApplicationFullLicense> getPharmaFullLIcenseByCI(
			String caseId)
		throws NoSuchPharmaApplicationFullLicenseException;
