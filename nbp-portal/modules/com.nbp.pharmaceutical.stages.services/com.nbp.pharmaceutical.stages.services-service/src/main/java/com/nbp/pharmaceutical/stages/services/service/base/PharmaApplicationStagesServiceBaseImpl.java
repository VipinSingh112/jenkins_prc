...
import com.nbp.pharmaceutical.stages.services.service.PharmaApplicationStagesService;
...
/**
 * Provides the base implementation for the pharma application stages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationStagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationStagesServiceImpl
 * @generated
 */
public abstract class PharmaApplicationStagesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PharmaApplicationStagesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaApplicationStagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.stages.services.service.PharmaApplicationStagesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaApplicationStagesService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		pharmaApplicationStagesService =
			(PharmaApplicationStagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaApplicationStagesService.class.getName();
	}
	...
	protected com.nbp.pharmaceutical.stages.services.service.
		PharmaApplicationStagesLocalService pharmaApplicationStagesLocalService;

	protected PharmaApplicationStagesService pharmaApplicationStagesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaApplicationStagesServiceBaseImpl.class);
