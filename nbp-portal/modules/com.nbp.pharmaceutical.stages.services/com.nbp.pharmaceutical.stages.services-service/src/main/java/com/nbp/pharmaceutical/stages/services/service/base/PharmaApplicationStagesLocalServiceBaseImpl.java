...
import com.nbp.pharmaceutical.stages.services.service.PharmaApplicationStagesLocalService;
...
/**
 * Provides the base implementation for the pharma application stages local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationStagesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationStagesLocalServiceImpl
 * @generated
 */
public abstract class PharmaApplicationStagesLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaApplicationStagesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.stages.services.service.PharmaApplicationStagesLocalServiceUtil</code>.
	 */
	...
	public PharmaApplicationStages addPharmaApplicationStages(
		...
		return pharmaApplicationStagesPersistence.update(
	...
	public PharmaApplicationStages createPharmaApplicationStages(
		...
		return pharmaApplicationStagesPersistence.create(
	...
	public PharmaApplicationStages deletePharmaApplicationStages(
		...
		return pharmaApplicationStagesPersistence.remove(
			pharmaApplicationstageId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pharmaApplicationStagesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PharmaApplicationStages.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pharmaApplicationStagesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pharmaApplicationStagesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PharmaApplicationStages fetchPharmaApplicationStages(
		...
		return pharmaApplicationStagesPersistence.fetchByPrimaryKey(
			pharmaApplicationstageId);
	}
	...
	public PharmaApplicationStages getPharmaApplicationStages(
		...
		return pharmaApplicationStagesPersistence.findByPrimaryKey(
			pharmaApplicationstageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PharmaApplicationStages.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PharmaApplicationStagesLocalServiceImpl#deletePharmaApplicationStages(PharmaApplicationStages) to avoid orphaned data");
		}

		return pharmaApplicationStagesLocalService.
			deletePharmaApplicationStages(
				(PharmaApplicationStages)persistedModel);
	}

	@Override
	public BasePersistence<PharmaApplicationStages> getBasePersistence() {
		return pharmaApplicationStagesPersistence;
	}
	...
	public List<PharmaApplicationStages> getPharmaApplicationStageses(
		...
		return pharmaApplicationStagesPersistence.findAll(start, end);
	}
	...
	public int getPharmaApplicationStagesesCount() {
		return pharmaApplicationStagesPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		pharmaApplicationStagesLocalService =
			(PharmaApplicationStagesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaApplicationStagesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				pharmaApplicationStagesPersistence.getDataSource();
	...
	protected PharmaApplicationStagesLocalService
		pharmaApplicationStagesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaApplicationStagesLocalServiceBaseImpl.class);
