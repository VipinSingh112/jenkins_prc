...
import com.nbp.pharmaceutical.stages.services.service.PharmaApplicationDueDiligenceService;
...
/**
 * Provides the base implementation for the pharma application due diligence remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationDueDiligenceServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.stages.services.service.impl.PharmaApplicationDueDiligenceServiceImpl
 * @generated
 */
public abstract class PharmaApplicationDueDiligenceServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaApplicationDueDiligenceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.stages.services.service.PharmaApplicationDueDiligenceServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		pharmaApplicationDueDiligenceService =
			(PharmaApplicationDueDiligenceService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaApplicationDueDiligenceService.class.getName();
	}
	...
	protected PharmaApplicationDueDiligenceService
		pharmaApplicationDueDiligenceService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaApplicationDueDiligenceServiceBaseImpl.class);
