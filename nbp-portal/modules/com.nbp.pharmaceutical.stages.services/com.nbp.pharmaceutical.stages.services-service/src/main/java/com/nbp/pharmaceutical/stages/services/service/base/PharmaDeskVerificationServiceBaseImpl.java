...
import com.nbp.pharmaceutical.stages.services.service.PharmaDeskVerificationService;
...
/**
 * Provides the base implementation for the pharma desk verification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.stages.services.service.impl.PharmaDeskVerificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.stages.services.service.impl.PharmaDeskVerificationServiceImpl
 * @generated
 */
public abstract class PharmaDeskVerificationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PharmaDeskVerificationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaDeskVerificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.stages.services.service.PharmaDeskVerificationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PharmaDeskVerificationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		pharmaDeskVerificationService = (PharmaDeskVerificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaDeskVerificationService.class.getName();
	}
	...
	protected PharmaDeskVerificationService pharmaDeskVerificationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaDeskVerificationServiceBaseImpl.class);
