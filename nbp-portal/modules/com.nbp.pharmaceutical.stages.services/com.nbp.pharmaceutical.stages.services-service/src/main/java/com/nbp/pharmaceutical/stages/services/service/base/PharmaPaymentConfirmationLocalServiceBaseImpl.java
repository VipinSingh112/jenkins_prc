...
import com.nbp.pharmaceutical.stages.services.service.PharmaPaymentConfirmationLocalService;
...
/**
 * Provides the base implementation for the pharma payment confirmation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.pharmaceutical.stages.services.service.impl.PharmaPaymentConfirmationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.pharmaceutical.stages.services.service.impl.PharmaPaymentConfirmationLocalServiceImpl
 * @generated
 */
public abstract class PharmaPaymentConfirmationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PharmaPaymentConfirmationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.pharmaceutical.stages.services.service.PharmaPaymentConfirmationLocalServiceUtil</code>.
	 */
	...
	public PharmaPaymentConfirmation addPharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.update(
	...
	public PharmaPaymentConfirmation createPharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.create(pharmaPaymentId);
	}
	...
	public PharmaPaymentConfirmation deletePharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.remove(pharmaPaymentId);
	}
	...
	public PharmaPaymentConfirmation deletePharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.remove(
			pharmaPaymentConfirmation);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return pharmaPaymentConfirmationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PharmaPaymentConfirmation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return pharmaPaymentConfirmationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return pharmaPaymentConfirmationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PharmaPaymentConfirmation fetchPharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.fetchByPrimaryKey(
			pharmaPaymentId);
	}
	...
	public PharmaPaymentConfirmation getPharmaPaymentConfirmation(
		...
		return pharmaPaymentConfirmationPersistence.findByPrimaryKey(
			pharmaPaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PharmaPaymentConfirmation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("pharmaPaymentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			PharmaPaymentConfirmation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return pharmaPaymentConfirmationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PharmaPaymentConfirmationLocalServiceImpl#deletePharmaPaymentConfirmation(PharmaPaymentConfirmation) to avoid orphaned data");
		}

		return pharmaPaymentConfirmationLocalService.
			deletePharmaPaymentConfirmation(
				(PharmaPaymentConfirmation)persistedModel);
	}

	@Override
	public BasePersistence<PharmaPaymentConfirmation> getBasePersistence() {
		return pharmaPaymentConfirmationPersistence;
	}
	...
	public List<PharmaPaymentConfirmation> getPharmaPaymentConfirmations(
		...
		return pharmaPaymentConfirmationPersistence.findAll(start, end);
	}
	...
	public int getPharmaPaymentConfirmationsCount() {
		return pharmaPaymentConfirmationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		pharmaPaymentConfirmationLocalService =
			(PharmaPaymentConfirmationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PharmaPaymentConfirmationLocalService.class.getName();
	}
	...
	protected PharmaPaymentConfirmationLocalService
		pharmaPaymentConfirmationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PharmaPaymentConfirmationLocalServiceBaseImpl.class);
