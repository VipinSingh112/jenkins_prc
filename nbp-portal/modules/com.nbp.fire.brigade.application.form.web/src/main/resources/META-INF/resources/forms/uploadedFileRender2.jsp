...
<div class="uploaded-info">
	...
	<div class="right">
		<a class="uploaded-actionlink" href="<%=Validator.isNotNull(fileUrlInFireBrigade)? fileUrlInFireBrigade:""%>"id="doc-download-btn" target="_blank"> 
			<span class="mr-2">
    ...
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="firedeleteFee('<%=uploadedFile.getFileEntryId()%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
