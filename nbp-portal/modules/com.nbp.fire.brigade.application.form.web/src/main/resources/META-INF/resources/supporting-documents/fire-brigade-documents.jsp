...
<fieldset class="wizard-fieldset" id="fireBrigadeSupportingDocumentFieldset" name="Supporting Documents">
	...
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="fireBrigadeGenericUpload" multiple="multiple"
			onchange="attachDetailed(this.id)"
				name="<portlet:namespace/>fireBrigadeGenericUpload"
				hidden=""> <label class="custom-upload"
				for="fireBrigadeGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="fireBrigadeGenericFileChosen">or drag and drop from your computer</span>
		</div>
		<div id="uploaded-documents-container">
		  ...
		  <!-- <a class="uploaded-delete mr-2" href="#" style="display: none;">
				...
				if(fireBrigadeApplicationId>0 && dlFileEntriesGeneric!=null){
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						try{
							...
							fileUrlInFireBrigade = DLURLHelperUtil.getDownloadURL(fileEntryForGeneric, fileEntryForGeneric.getFileVersion(), themeDisplay,
									StringPool.BLANK, false, true);
						}catch(Exception e ){
						}
						%>	
						<div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=counterOfDocuments%>">
				<div class="row">
			...
			counterOfDocuments=counterOfDocuments+1;}
				}
			%>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="fireBrigadeEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>fireBrigadeEnrollDocuments">
							...
							<input type="hidden" id="fireBrigadeDocumentuploadCounter"
