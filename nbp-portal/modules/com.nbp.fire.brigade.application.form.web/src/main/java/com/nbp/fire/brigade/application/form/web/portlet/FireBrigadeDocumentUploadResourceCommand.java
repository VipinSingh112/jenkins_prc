...
@Component(
		...
		property = {
			...
			"mvc.command.name=/fire/brigade/upload/document"
		},
		service = MVCResourceCommand.class
	)
public class FireBrigadeDocumentUploadResourceCommand implements MVCResourceCommand {
	...
	private static Log _log = LogFactoryUtil.getLog(FireBrigadeDocumentUploadResourceCommand.class.getName());
	...
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try {
			...
			if (Validator.isNotNull(inputStream)) {
				...
				DLFolder dlFolder = createFolder(themeDisplay.getUserId(), fireBrigadeApplicationId,
				...
				ExpandoColumn docNoExpandoColumn = ExpandoColumnLocalServiceUtil.getColumn(expandoTable.getTableId(),
						FireBrigadeApplicationFormPortletKeys.DOC_NO);
				if (docNoExpandoColumn == null) {
					docNoExpandoColumn = ExpandoColumnLocalServiceUtil.getColumn(themeDisplay.getCompanyId(),
							classNameId, expandoTable.getName(), FireBrigadeApplicationFormPortletKeys.DOC_NO);
				}
