...
import com.nbp.creative.application.form.service.service.CreativeApplicationService;
...
/**
 * Provides the base implementation for the creative application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.creative.application.form.service.service.impl.CreativeApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.creative.application.form.service.service.impl.CreativeApplicationServiceImpl
 * @generated
 */
public abstract class CreativeApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CreativeApplicationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CreativeApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.creative.application.form.service.service.CreativeApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CreativeApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		creativeApplicationService = (CreativeApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CreativeApplicationService.class.getName();
	}
	...
	protected CreativeApplicationService creativeApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CreativeApplicationServiceBaseImpl.class);
