...
import com.nbp.creative.application.form.service.service.CreativeCompanyDetailsService;
...
/**
 * Provides the base implementation for the creative company details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.creative.application.form.service.service.impl.CreativeCompanyDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.creative.application.form.service.service.impl.CreativeCompanyDetailsServiceImpl
 * @generated
 */
public abstract class CreativeCompanyDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CreativeCompanyDetailsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CreativeCompanyDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.creative.application.form.service.service.CreativeCompanyDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CreativeCompanyDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		creativeCompanyDetailsService = (CreativeCompanyDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CreativeCompanyDetailsService.class.getName();
	}
	...
	protected CreativeCompanyDetailsService creativeCompanyDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CreativeCompanyDetailsServiceBaseImpl.class);
