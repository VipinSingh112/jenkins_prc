...
/**
 * Provides the local service utility for CreativeIndividualDetails. This utility wraps
 * <code>com.nbp.creative.application.form.service.service.impl.CreativeIndividualDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CreativeIndividualDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeIndividualDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CreativeIndividualDetails addCreativeIndividualDetails(
		CreativeIndividualDetails creativeIndividualDetails) {

		return getService().addCreativeIndividualDetails(
	 ...
	 */
	public static CreativeIndividualDetails createCreativeIndividualDetails(
		long creativeIndividualDetailsId) {

		return getService().createCreativeIndividualDetails(
	 ...
	 */
	public static CreativeIndividualDetails deleteCreativeIndividualDetails(
		CreativeIndividualDetails creativeIndividualDetails) {

		return getService().deleteCreativeIndividualDetails(
			creativeIndividualDetails);
	}
	...
	public static CreativeIndividualDetails fetchCreativeIndividualDetails(
		long creativeIndividualDetailsId) {

		return getService().fetchCreativeIndividualDetails(
			creativeIndividualDetailsId);
	}
	...
	public static CreativeIndividualDetails getCreativeById(
	 ...
	 * @throws PortalException if a creative individual details with the primary key could not be found
	 */
	public static CreativeIndividualDetails getCreativeIndividualDetails(
			long creativeIndividualDetailsId)
		throws PortalException {

		return getService().getCreativeIndividualDetails(
			creativeIndividualDetailsId);
	}
	 ...
	 */
	public static List<CreativeIndividualDetails>
		getCreativeIndividualDetailses(int start, int end) {

		return getService().getCreativeIndividualDetailses(start, end);
	}
	 ...
	 */
	public static int getCreativeIndividualDetailsesCount() {
		return getService().getCreativeIndividualDetailsesCount();
	}
	 ...
	 */
	public static CreativeIndividualDetails updateCreativeIndividualDetails(
		CreativeIndividualDetails creativeIndividualDetails) {

		return getService().updateCreativeIndividualDetails(
			creativeIndividualDetails);
	}

	public static CreativeIndividualDetailsLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CreativeIndividualDetailsLocalService>
		_serviceSnapshot = new Snapshot<>(
			CreativeIndividualDetailsLocalServiceUtil.class,
