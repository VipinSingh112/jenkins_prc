...
/**
 * Provides the local service utility for CreativeCompanyDetailsAddress. This utility wraps
 * <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDetailsAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CreativeCompanyDetailsAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDetailsAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static CreativeCompanyDetailsAddress
		addCreativeCompanyDetailsAddress(
			CreativeCompanyDetailsAddress creativeCompanyDetailsAddress) {

		return getService().addCreativeCompanyDetailsAddress(
	 ...
	 */
	public static CreativeCompanyDetailsAddress
		createCreativeCompanyDetailsAddress(long creativeComDetailsAddressId) {

		return getService().createCreativeCompanyDetailsAddress(
	...
	public static CreativeCompanyDetailsAddress
		...
		return getService().deleteCreativeCompanyDetailsAddress(
			creativeCompanyDetailsAddress);
	}
	...
	public static CreativeCompanyDetailsAddress
		fetchCreativeCompanyDetailsAddress(long creativeComDetailsAddressId) {

		return getService().fetchCreativeCompanyDetailsAddress(
			creativeComDetailsAddressId);
	}
	...
	public static CreativeCompanyDetailsAddress getCreative_Com_Detail_AT(
		...
		return getService().getCreative_Com_Detail_AT(
	 ...
	 */
	public static CreativeCompanyDetailsAddress
			getCreativeCompanyDetailsAddress(long creativeComDetailsAddressId)
		throws PortalException {

		return getService().getCreativeCompanyDetailsAddress(
			creativeComDetailsAddressId);
	}
	 ...
	 */
	public static List<CreativeCompanyDetailsAddress>
		getCreativeCompanyDetailsAddresses(int start, int end) {

		return getService().getCreativeCompanyDetailsAddresses(start, end);
	}
	 ...
	 */
	public static int getCreativeCompanyDetailsAddressesCount() {
		return getService().getCreativeCompanyDetailsAddressesCount();
	}
	 ...
	 */
	public static CreativeCompanyDetailsAddress
		updateCreativeCompanyDetailsAddress(
			CreativeCompanyDetailsAddress creativeCompanyDetailsAddress) {

		return getService().updateCreativeCompanyDetailsAddress(
			creativeCompanyDetailsAddress);
	}

	public static CreativeCompanyDetailsAddressLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CreativeCompanyDetailsAddressLocalService>
		_serviceSnapshot = new Snapshot<>(
			CreativeCompanyDetailsAddressLocalServiceUtil.class,
