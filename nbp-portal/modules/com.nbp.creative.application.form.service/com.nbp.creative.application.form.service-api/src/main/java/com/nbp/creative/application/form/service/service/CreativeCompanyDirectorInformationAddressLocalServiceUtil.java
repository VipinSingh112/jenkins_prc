...
/**
 * Provides the local service utility for CreativeCompanyDirectorInformationAddress. This utility wraps
 * <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDirectorInformationAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CreativeCompanyDirectorInformationAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDirectorInformationAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().addCreativeCompanyDirectorInformationAddress(
			creativeCompanyDirectorInformationAddress);
	}
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().createCreativeCompanyDirectorInformationAddress(
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().deleteCreativeCompanyDirectorInformationAddress(
			creativeCompanyDirectorInformationAddress);
	}
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().fetchCreativeCompanyDirectorInformationAddress(
			creativeComDirectorAddressId);
	}
	...
	public static CreativeCompanyDirectorInformationAddress getCreativeBYId(
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().getCreativeCompanyDirectorInformationAddress(
			creativeComDirectorAddressId);
	}
	...
	public static List<CreativeCompanyDirectorInformationAddress>
		...
		return getService().getCreativeCompanyDirectorInformationAddresses(
			start, end);
	}
	 ...
	 */
	public static int getCreativeCompanyDirectorInformationAddressesCount() {
		return getService().
	...
	public static CreativeCompanyDirectorInformationAddress
		...
		return getService().updateCreativeCompanyDirectorInformationAddress(
			creativeCompanyDirectorInformationAddress);
	}

	public static CreativeCompanyDirectorInformationAddressLocalService
		getService() {
	...
	private static final Snapshot
		<CreativeCompanyDirectorInformationAddressLocalService>
			_serviceSnapshot = new Snapshot<>(
				CreativeCompanyDirectorInformationAddressLocalServiceUtil.class,
