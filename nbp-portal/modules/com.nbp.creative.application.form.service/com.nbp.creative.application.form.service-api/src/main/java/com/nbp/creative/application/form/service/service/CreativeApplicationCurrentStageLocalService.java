...
/**
 * Provides the local service interface for CreativeApplicationCurrentStage. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeApplicationCurrentStageLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeApplicationCurrentStageLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeApplicationCurrentStageLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative application current stage local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeApplicationCurrentStageLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CreativeApplicationCurrentStage
		createCreativeApplicationCurrentStage(long creativeAppliCurrentStageId);
