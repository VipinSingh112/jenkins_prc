...
/**
 * The base model interface for the CreativeApplicationCurrentStage service. Represents a row in the &quot;nbp_creative_current_stage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.creative.application.form.service.model.impl.CreativeApplicationCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.creative.application.form.service.model.impl.CreativeApplicationCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CreativeApplicationCurrentStageModel
	extends BaseModel<CreativeApplicationCurrentStage>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a creative application current stage model instance should use the {@link CreativeApplicationCurrentStage} interface instead.
	 */
