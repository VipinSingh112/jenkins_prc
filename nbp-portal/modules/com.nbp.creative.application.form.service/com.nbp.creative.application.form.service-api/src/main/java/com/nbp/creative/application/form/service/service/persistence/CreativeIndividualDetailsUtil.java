...
/**
 * The persistence utility for the creative individual details service. This utility wraps <code>com.nbp.creative.application.form.service.service.persistence.impl.CreativeIndividualDetailsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see CreativeIndividualDetailsPersistence
 * @generated
 */
public class CreativeIndividualDetailsUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(creativeIndividualDetails);
	}
	 ...
	 */
	public static Map<Serializable, CreativeIndividualDetails>
	 ...
	 */
	public static List<CreativeIndividualDetails> findWithDynamicQuery(
	 ...
	 */
	public static CreativeIndividualDetails update(
		CreativeIndividualDetails creativeIndividualDetails) {

		return getPersistence().update(creativeIndividualDetails);
	}
	...
	public static CreativeIndividualDetails update(
		...
		return getPersistence().update(
			creativeIndividualDetails, serviceContext);
	}
	 ...
	 */
	public static CreativeIndividualDetails findBygetCreativeById(
			long CreativeApplicationId)
		throws com.nbp.creative.application.form.service.exception.
			NoSuchCreativeIndividualDetailsException {
	 ...
	 */
	public static CreativeIndividualDetails fetchBygetCreativeById(
		long CreativeApplicationId) {
	 ...
	 */
	public static CreativeIndividualDetails removeBygetCreativeById(
			long CreativeApplicationId)
		throws com.nbp.creative.application.form.service.exception.
			NoSuchCreativeIndividualDetailsException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(creativeIndividualDetails);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(creativeIndividualDetailses);
	}
	 ...
	 */
	public static CreativeIndividualDetails create(
		long creativeIndividualDetailsId) {

		return getPersistence().create(creativeIndividualDetailsId);
	}
	 ...
	 */
	public static CreativeIndividualDetails remove(
			long creativeIndividualDetailsId)
		throws com.nbp.creative.application.form.service.exception.
			NoSuchCreativeIndividualDetailsException {

		return getPersistence().remove(creativeIndividualDetailsId);
	}

	public static CreativeIndividualDetails updateImpl(
		CreativeIndividualDetails creativeIndividualDetails) {

		return getPersistence().updateImpl(creativeIndividualDetails);
	}
	 ...
	 * @throws NoSuchCreativeIndividualDetailsException if a creative individual details with the primary key could not be found
	 */
	public static CreativeIndividualDetails findByPrimaryKey(
			long creativeIndividualDetailsId)
		throws com.nbp.creative.application.form.service.exception.
			NoSuchCreativeIndividualDetailsException {

		return getPersistence().findByPrimaryKey(creativeIndividualDetailsId);
	}
	 ...
	 */
	public static CreativeIndividualDetails fetchByPrimaryKey(
		long creativeIndividualDetailsId) {

		return getPersistence().fetchByPrimaryKey(creativeIndividualDetailsId);
	}
	 ...
	 */
	public static List<CreativeIndividualDetails> findAll() {
	 ...
	 */
	public static List<CreativeIndividualDetails> findAll(int start, int end) {
	...
	public static CreativeIndividualDetailsPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		CreativeIndividualDetailsPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile CreativeIndividualDetailsPersistence _persistence;
