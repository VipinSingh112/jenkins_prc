...
/**
 * Provides the local service interface for CreativeApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CreativeApplication findBygetCreativeByCaseId(String caseId)
		throws NoSuchCreativeApplicationException;

	public CreativeApplication findBygetCreativeById(
		long creativeApplicationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeApplication getCreativeByAppNo(String applicationNumber)
		throws NoSuchCreativeApplicationException;
