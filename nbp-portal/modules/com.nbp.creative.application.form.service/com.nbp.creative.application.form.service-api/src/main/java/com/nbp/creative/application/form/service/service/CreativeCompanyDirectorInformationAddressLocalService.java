...
/**
 * Provides the local service interface for CreativeCompanyDirectorInformationAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeCompanyDirectorInformationAddressLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeCompanyDirectorInformationAddressLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDirectorInformationAddressLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative company director information address local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeCompanyDirectorInformationAddressLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeCompanyDirectorInformationAddress getCreativeBYId(
