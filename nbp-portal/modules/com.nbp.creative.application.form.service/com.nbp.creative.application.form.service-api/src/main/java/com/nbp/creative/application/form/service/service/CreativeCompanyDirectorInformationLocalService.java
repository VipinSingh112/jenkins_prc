...
/**
 * Provides the local service interface for CreativeCompanyDirectorInformation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeCompanyDirectorInformationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeCompanyDirectorInformationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeCompanyDirectorInformationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative company director information local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeCompanyDirectorInformationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeCompanyDirectorInformation
		fetchCreativeCompanyDirectorInformation(long creativeComDirectorInfoId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeCompanyDirectorInformation getCreativeById(
		long creativeApplicationId);
