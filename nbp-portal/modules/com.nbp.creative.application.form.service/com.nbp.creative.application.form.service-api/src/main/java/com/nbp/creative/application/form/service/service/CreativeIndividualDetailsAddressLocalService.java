...
/**
 * Provides the local service interface for CreativeIndividualDetailsAddress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeIndividualDetailsAddressLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeIndividualDetailsAddressLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.application.form.service.service.impl.CreativeIndividualDetailsAddressLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative individual details address local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeIndividualDetailsAddressLocalServiceUtil} if injection and service tracking are not available.
	 */
