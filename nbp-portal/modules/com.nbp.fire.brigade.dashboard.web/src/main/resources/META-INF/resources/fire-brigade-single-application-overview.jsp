...
<section class="wizard-section dashboard-progress">
			...
			<div class="col-md-12">
				<div class="progress-plus-wizard-card row cursor-pointer">
					<div class="d-flex col-lg-3">
						...
						<input type="hidden" id="fireBrigadeApplicationId" value="<%=fireBrigadeApp.getFireBrigadeApplicationId()%>">
						<div class="left-part">
 ...
 <div class="container">
	<div class="row">
		<div class="col-md-12">
			<liferay-portlet:runtime portletName="com_nbp_collaboration_web_CollaborationPortlet"></liferay-portlet:runtime>
		</div>
	</div>
</div> 
</section>