...
/**
 * Provides a wrapper for {@link FactoriesStandardActInfoLocalService}.
 *
 * @author Brian Wing Shun Chan
 * @see FactoriesStandardActInfoLocalService
 * @generated
 */
public class FactoriesStandardActInfoLocalServiceWrapper
	implements FactoriesStandardActInfoLocalService,
			   ServiceWrapper<FactoriesStandardActInfoLocalService> {

	public FactoriesStandardActInfoLocalServiceWrapper() {
		this(null);
	}
	...
	public FactoriesStandardActInfoLocalServiceWrapper(
		...
		_factoriesStandardActInfoLocalService =
			factoriesStandardActInfoLocalService;
	}
	...
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo addFactoriesStandardActInfo(
			com.nbp.factories.registration.application.form.services.model.
				FactoriesStandardActInfo factoriesStandardActInfo) {

		return _factoriesStandardActInfoLocalService.
			addFactoriesStandardActInfo(factoriesStandardActInfo);
	}
	...
	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo createFactoriesStandardActInfo(
			long factoriesStandardActId) {

		return _factoriesStandardActInfoLocalService.
			createFactoriesStandardActInfo(factoriesStandardActId);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _factoriesStandardActInfoLocalService.createPersistedModel(
			primaryKeyObj);
	}
	...
	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo deleteFactoriesStandardActInfo(
			com.nbp.factories.registration.application.form.services.model.
				FactoriesStandardActInfo factoriesStandardActInfo) {

		return _factoriesStandardActInfoLocalService.
			deleteFactoriesStandardActInfo(factoriesStandardActInfo);
	}
	...
	public com.nbp.factories.registration.application.form.services.model.
		...
		return _factoriesStandardActInfoLocalService.
			deleteFactoriesStandardActInfo(factoriesStandardActId);
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel deletePersistedModel(
		...
		return _factoriesStandardActInfoLocalService.deletePersistedModel(
			persistedModel);
	}

	@Override
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _factoriesStandardActInfoLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _factoriesStandardActInfoLocalService.dslQueryCount(dslQuery);
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _factoriesStandardActInfoLocalService.dynamicQuery();
	}
	...
	public <T> java.util.List<T> dynamicQuery(
		...
		return _factoriesStandardActInfoLocalService.dynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return _factoriesStandardActInfoLocalService.dynamicQueryCount(
			dynamicQuery);
	}
	...
	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo fetchFactoriesStandardActInfo(
			long factoriesStandardActId) {

		return _factoriesStandardActInfoLocalService.
			fetchFactoriesStandardActInfo(factoriesStandardActId);
	}
	...
	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo getFactoriesStandardActInfo(
				long factoriesStandardActId)
			throws com.liferay.portal.kernel.exception.PortalException {

		return _factoriesStandardActInfoLocalService.
			getFactoriesStandardActInfo(factoriesStandardActId);
	}
	...
	public java.util.List
		<com.nbp.factories.registration.application.form.services.model.
			FactoriesStandardActInfo> getFactoriesStandardActInfos(
				int start, int end) {

		return _factoriesStandardActInfoLocalService.
			getFactoriesStandardActInfos(start, end);
	}
	...
	public int getFactoriesStandardActInfosCount() {
		return _factoriesStandardActInfoLocalService.
			getFactoriesStandardActInfosCount();
	}

	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo getFactoryStandardActBy_Id(
		...
		return _factoriesStandardActInfoLocalService.getFactoryStandardActBy_Id(
	...
	public String getOSGiServiceIdentifier() {
		return _factoriesStandardActInfoLocalService.getOSGiServiceIdentifier();
	}
	...
	public com.liferay.portal.kernel.model.PersistedModel getPersistedModel(
		...
		return _factoriesStandardActInfoLocalService.getPersistedModel(
			primaryKeyObj);
	}
	...
	@Override
	public com.nbp.factories.registration.application.form.services.model.
		FactoriesStandardActInfo updateFactoriesStandardActInfo(
			com.nbp.factories.registration.application.form.services.model.
				FactoriesStandardActInfo factoriesStandardActInfo) {

		return _factoriesStandardActInfoLocalService.
			updateFactoriesStandardActInfo(factoriesStandardActInfo);
	}

	@Override
	public BasePersistence<?> getBasePersistence() {
		return _factoriesStandardActInfoLocalService.getBasePersistence();
	}

	@Override
	public FactoriesStandardActInfoLocalService getWrappedService() {
		return _factoriesStandardActInfoLocalService;
	}
	...
	private FactoriesStandardActInfoLocalService
		_factoriesStandardActInfoLocalService;
