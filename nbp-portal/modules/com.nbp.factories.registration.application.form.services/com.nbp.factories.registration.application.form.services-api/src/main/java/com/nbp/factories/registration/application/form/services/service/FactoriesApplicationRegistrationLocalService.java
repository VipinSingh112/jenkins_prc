...
/**
 * Provides the local service interface for FactoriesApplicationRegistration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FactoriesApplicationRegistrationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FactoriesApplicationRegistrationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.factories.registration.application.form.services.service.impl.FactoriesApplicationRegistrationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the factories application registration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FactoriesApplicationRegistrationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FactoriesApplicationRegistration addFactoriesApplicationRegistration(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesApplicationRegistration getFactoriesApplicationRegistration(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesApplicationRegistration getFactoriesRegistrationById(
			long factoriesApplicationId)
		throws NoSuchFactoriesApplicationRegistrationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesApplicationRegistration getFactoriesRegstBy_AppNo(
			String applicationNumber)
		throws NoSuchFactoriesApplicationRegistrationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesApplicationRegistration getFactoriesRegstBy_CaseId(
			String caseId)
		throws NoSuchFactoriesApplicationRegistrationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FactoriesApplicationRegistration getFactoriesRegstByAT_AppNo(
			String typeOfTransaction, String expiredLicenseAppNumber)
		throws NoSuchFactoriesApplicationRegistrationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FactoriesApplicationRegistration> getFactoriesRegstByS_U(
		long userId, int status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FactoriesApplicationRegistration> getFactoriesRegstByStatus(
		int status);
