...
import com.nbp.factories.registration.application.form.services.service.FactoriesApplicationRegistrationService;
...
/**
 * Provides the base implementation for the factories application registration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.factories.registration.application.form.services.service.impl.FactoriesApplicationRegistrationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.factories.registration.application.form.services.service.impl.FactoriesApplicationRegistrationServiceImpl
 * @generated
 */
public abstract class FactoriesApplicationRegistrationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FactoriesApplicationRegistrationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FactoriesApplicationRegistrationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.factories.registration.application.form.services.service.FactoriesApplicationRegistrationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		factoriesApplicationRegistrationService =
			(FactoriesApplicationRegistrationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FactoriesApplicationRegistrationService.class.getName();
	}
	...
	protected FactoriesApplicationRegistrationService
		factoriesApplicationRegistrationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FactoriesApplicationRegistrationServiceBaseImpl.class);
