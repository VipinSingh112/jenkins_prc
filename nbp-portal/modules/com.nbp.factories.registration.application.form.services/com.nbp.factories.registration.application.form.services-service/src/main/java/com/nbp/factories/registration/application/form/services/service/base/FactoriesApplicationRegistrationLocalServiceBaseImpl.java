...
import com.nbp.factories.registration.application.form.services.service.FactoriesApplicationRegistrationLocalService;
...
/**
 * Provides the base implementation for the factories application registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.factories.registration.application.form.services.service.impl.FactoriesApplicationRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.factories.registration.application.form.services.service.impl.FactoriesApplicationRegistrationLocalServiceImpl
 * @generated
 */
public abstract class FactoriesApplicationRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FactoriesApplicationRegistrationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FactoriesApplicationRegistrationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.factories.registration.application.form.services.service.FactoriesApplicationRegistrationLocalServiceUtil</code>.
	 */
	...
	public FactoriesApplicationRegistration addFactoriesApplicationRegistration(
		...
		return factoriesApplicationRegistrationPersistence.update(
	...
	public FactoriesApplicationRegistration
		...
		return factoriesApplicationRegistrationPersistence.create(
	...
	public FactoriesApplicationRegistration
		...
		return factoriesApplicationRegistrationPersistence.remove(
			factoriesApplicationId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return factoriesApplicationRegistrationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FactoriesApplicationRegistration.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return factoriesApplicationRegistrationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return factoriesApplicationRegistrationPersistence.
	...
	public FactoriesApplicationRegistration
		...
		return factoriesApplicationRegistrationPersistence.fetchByPrimaryKey(
			factoriesApplicationId);
	}
	...
	public FactoriesApplicationRegistration getFactoriesApplicationRegistration(
		...
		return factoriesApplicationRegistrationPersistence.findByPrimaryKey(
			factoriesApplicationId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FactoriesApplicationRegistrationLocalServiceImpl#deleteFactoriesApplicationRegistration(FactoriesApplicationRegistration) to avoid orphaned data");
		}

		return factoriesApplicationRegistrationLocalService.
			deleteFactoriesApplicationRegistration(
				(FactoriesApplicationRegistration)persistedModel);
	}

	@Override
	public BasePersistence<FactoriesApplicationRegistration>
		getBasePersistence() {
	...
	public List<FactoriesApplicationRegistration>
		...
		return factoriesApplicationRegistrationPersistence.findAll(start, end);
	}
	...
	public int getFactoriesApplicationRegistrationsCount() {
		return factoriesApplicationRegistrationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		factoriesApplicationRegistrationLocalService =
			(FactoriesApplicationRegistrationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FactoriesApplicationRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				factoriesApplicationRegistrationPersistence.getDataSource();
	...
	protected FactoriesApplicationRegistrationLocalService
		factoriesApplicationRegistrationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FactoriesApplicationRegistrationLocalServiceBaseImpl.class);
