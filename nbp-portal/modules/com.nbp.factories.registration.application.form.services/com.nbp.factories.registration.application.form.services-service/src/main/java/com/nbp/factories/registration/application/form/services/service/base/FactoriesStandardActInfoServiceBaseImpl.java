...
import com.nbp.factories.registration.application.form.services.service.FactoriesStandardActInfoService;
...
/**
 * Provides the base implementation for the factories standard act info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.factories.registration.application.form.services.service.impl.FactoriesStandardActInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.factories.registration.application.form.services.service.impl.FactoriesStandardActInfoServiceImpl
 * @generated
 */
public abstract class FactoriesStandardActInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FactoriesStandardActInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FactoriesStandardActInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.factories.registration.application.form.services.service.FactoriesStandardActInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FactoriesStandardActInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		factoriesStandardActInfoService =
			(FactoriesStandardActInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FactoriesStandardActInfoService.class.getName();
	}
	...
	protected FactoriesStandardActInfoService factoriesStandardActInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FactoriesStandardActInfoServiceBaseImpl.class);
