...
import com.nbp.sez.status.application.stage.services.service.SezStatusPreApprovalConditionsService;
...
/**
 * Provides the base implementation for the sez status pre approval conditions remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusPreApprovalConditionsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusPreApprovalConditionsServiceImpl
 * @generated
 */
public abstract class SezStatusPreApprovalConditionsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusPreApprovalConditionsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusPreApprovalConditionsServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusPreApprovalConditionsService =
			(SezStatusPreApprovalConditionsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusPreApprovalConditionsService.class.getName();
	}
	...
	protected SezStatusPreApprovalConditionsService
		sezStatusPreApprovalConditionsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusPreApprovalConditionsServiceBaseImpl.class);
