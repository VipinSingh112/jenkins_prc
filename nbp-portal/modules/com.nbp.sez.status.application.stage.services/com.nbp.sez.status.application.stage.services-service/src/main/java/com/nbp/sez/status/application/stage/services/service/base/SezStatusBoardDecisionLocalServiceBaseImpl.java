...
import com.nbp.sez.status.application.stage.services.service.SezStatusBoardDecisionLocalService;
...
/**
 * Provides the base implementation for the sez status board decision local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusBoardDecisionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusBoardDecisionLocalServiceImpl
 * @generated
 */
public abstract class SezStatusBoardDecisionLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusBoardDecisionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusBoardDecisionLocalServiceUtil</code>.
	 */
	...
	public SezStatusBoardDecision addSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.update(sezStatusBoardDecision);
	}
	...
	public SezStatusBoardDecision createSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.create(sezStatusBoardId);
	}
	...
	public SezStatusBoardDecision deleteSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.remove(sezStatusBoardId);
	}
	...
	public SezStatusBoardDecision deleteSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.remove(sezStatusBoardDecision);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sezStatusBoardDecisionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SezStatusBoardDecision.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sezStatusBoardDecisionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sezStatusBoardDecisionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SezStatusBoardDecision fetchSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.fetchByPrimaryKey(
			sezStatusBoardId);
	}
	...
	public SezStatusBoardDecision fetchSezStatusBoardDecisionByUuidAndGroupId(
		...
		return sezStatusBoardDecisionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public SezStatusBoardDecision getSezStatusBoardDecision(
		...
		return sezStatusBoardDecisionPersistence.findByPrimaryKey(
			sezStatusBoardId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SezStatusBoardDecision.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("sezStatusBoardId");
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, sezStatusBoardDecision);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					SezStatusBoardDecision.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return sezStatusBoardDecisionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SezStatusBoardDecisionLocalServiceImpl#deleteSezStatusBoardDecision(SezStatusBoardDecision) to avoid orphaned data");
		}

		return sezStatusBoardDecisionLocalService.deleteSezStatusBoardDecision(
			(SezStatusBoardDecision)persistedModel);
	}

	@Override
	public BasePersistence<SezStatusBoardDecision> getBasePersistence() {
		return sezStatusBoardDecisionPersistence;
	}
	...
	public List<SezStatusBoardDecision>
		...
		return sezStatusBoardDecisionPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<SezStatusBoardDecision>
		...
		return sezStatusBoardDecisionPersistence.findByUuid_C(
	...
	public SezStatusBoardDecision getSezStatusBoardDecisionByUuidAndGroupId(
		...
		return sezStatusBoardDecisionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<SezStatusBoardDecision> getSezStatusBoardDecisions(
		...
		return sezStatusBoardDecisionPersistence.findAll(start, end);
	}
	...
	public int getSezStatusBoardDecisionsCount() {
		return sezStatusBoardDecisionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusBoardDecisionLocalService =
			(SezStatusBoardDecisionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusBoardDecisionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sezStatusBoardDecisionPersistence.getDataSource();
	...
	protected SezStatusBoardDecisionLocalService
		sezStatusBoardDecisionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusBoardDecisionLocalServiceBaseImpl.class);
