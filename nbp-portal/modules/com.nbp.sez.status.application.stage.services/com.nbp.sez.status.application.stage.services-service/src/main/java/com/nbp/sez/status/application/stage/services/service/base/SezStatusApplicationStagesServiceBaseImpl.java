...
import com.nbp.sez.status.application.stage.services.service.SezStatusApplicationStagesService;
...
/**
 * Provides the base implementation for the sez status application stages remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusApplicationStagesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusApplicationStagesServiceImpl
 * @generated
 */
public abstract class SezStatusApplicationStagesServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusApplicationStagesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusApplicationStagesServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusApplicationStagesService =
			(SezStatusApplicationStagesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusApplicationStagesService.class.getName();
	}
	...
	protected SezStatusApplicationStagesService
		sezStatusApplicationStagesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusApplicationStagesServiceBaseImpl.class);
