...
import com.nbp.sez.status.application.stage.services.service.SezStatusARCDecisionService;
...
/**
 * Provides the base implementation for the sez status arc decision remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusARCDecisionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusARCDecisionServiceImpl
 * @generated
 */
public abstract class SezStatusARCDecisionServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusARCDecisionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusARCDecisionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusARCDecisionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezStatusARCDecisionService = (SezStatusARCDecisionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusARCDecisionService.class.getName();
	}
	...
	protected SezStatusARCDecisionService sezStatusARCDecisionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusARCDecisionServiceBaseImpl.class);
