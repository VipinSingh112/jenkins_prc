...
import com.nbp.sez.status.application.stage.services.service.SezStatusDeskVerificationService;
...
/**
 * Provides the base implementation for the sez status desk verification remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusDeskVerificationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusDeskVerificationServiceImpl
 * @generated
 */
public abstract class SezStatusDeskVerificationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusDeskVerificationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusDeskVerificationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusDeskVerificationService =
			(SezStatusDeskVerificationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusDeskVerificationService.class.getName();
	}
	...
	protected SezStatusDeskVerificationService sezStatusDeskVerificationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusDeskVerificationServiceBaseImpl.class);
