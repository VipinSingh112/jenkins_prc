...
import com.nbp.sez.status.application.stage.services.service.SezStatusBoardDecisionService;
...
/**
 * Provides the base implementation for the sez status board decision remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusBoardDecisionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusBoardDecisionServiceImpl
 * @generated
 */
public abstract class SezStatusBoardDecisionServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusBoardDecisionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusBoardDecisionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SezStatusBoardDecisionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		sezStatusBoardDecisionService = (SezStatusBoardDecisionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusBoardDecisionService.class.getName();
	}
	...
	protected SezStatusBoardDecisionService sezStatusBoardDecisionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusBoardDecisionServiceBaseImpl.class);
