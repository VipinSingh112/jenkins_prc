...
import com.nbp.sez.status.application.stage.services.service.SezStatusPaymentConfirmationService;
...
/**
 * Provides the base implementation for the sez status payment confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.sez.status.application.stage.services.service.impl.SezStatusPaymentConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.sez.status.application.stage.services.service.impl.SezStatusPaymentConfirmationServiceImpl
 * @generated
 */
public abstract class SezStatusPaymentConfirmationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SezStatusPaymentConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.sez.status.application.stage.services.service.SezStatusPaymentConfirmationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		sezStatusPaymentConfirmationService =
			(SezStatusPaymentConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SezStatusPaymentConfirmationService.class.getName();
	}
	...
	protected SezStatusPaymentConfirmationService
		sezStatusPaymentConfirmationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SezStatusPaymentConfirmationServiceBaseImpl.class);
