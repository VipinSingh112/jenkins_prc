...
/**
 * Provides the local service interface for SezStatusDeskVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezStatusDeskVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezStatusDeskVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.stage.services.service.impl.SezStatusDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez status desk verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezStatusDeskVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public void deleteSezStatusDeskVerificationById(long sezStatusApplicatioId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezStatusDeskVerification> getDeskVerificationById(
		long applicationId);
