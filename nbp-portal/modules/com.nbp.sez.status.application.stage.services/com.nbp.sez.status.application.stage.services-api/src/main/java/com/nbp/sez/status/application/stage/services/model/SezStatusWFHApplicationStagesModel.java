...
/**
 * The base model interface for the SezStatusWFHApplicationStages service. Represents a row in the &quot;nbp_sez_status_wfh_app_stages&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.sez.status.application.stage.services.model.impl.SezStatusWFHApplicationStagesModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.sez.status.application.stage.services.model.impl.SezStatusWFHApplicationStagesImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface SezStatusWFHApplicationStagesModel
	extends BaseModel<SezStatusWFHApplicationStages>, GroupedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a sez status wfh application stages model instance should use the {@link SezStatusWFHApplicationStages} interface instead.
	 */
