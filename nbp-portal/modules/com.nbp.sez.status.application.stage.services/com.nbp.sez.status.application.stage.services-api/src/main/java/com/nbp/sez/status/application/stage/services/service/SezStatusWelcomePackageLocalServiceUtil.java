...
/**
 * Provides the local service utility for SezStatusWelcomePackage. This utility wraps
 * <code>com.nbp.sez.status.application.stage.services.service.impl.SezStatusWelcomePackageLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SezStatusWelcomePackageLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.sez.status.application.stage.services.service.impl.SezStatusWelcomePackageLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SezStatusWelcomePackage addSezStatusWelcomePackage(
		SezStatusWelcomePackage sezStatusWelcomePackage) {

		return getService().addSezStatusWelcomePackage(sezStatusWelcomePackage);
	}
	 ...
	 */
	public static SezStatusWelcomePackage createSezStatusWelcomePackage(
		long sezStatusWelcomeId) {

		return getService().createSezStatusWelcomePackage(sezStatusWelcomeId);
	}
	 ...
	 */
	public static SezStatusWelcomePackage deleteSezStatusWelcomePackage(
			long sezStatusWelcomeId)
		throws PortalException {

		return getService().deleteSezStatusWelcomePackage(sezStatusWelcomeId);
	}
	...
	public static SezStatusWelcomePackage deleteSezStatusWelcomePackage(
		...
		return getService().deleteSezStatusWelcomePackage(
	...
	public static SezStatusWelcomePackage fetchSezStatusWelcomePackage(
		long sezStatusWelcomeId) {

		return getService().fetchSezStatusWelcomePackage(sezStatusWelcomeId);
	}
	...
	public static SezStatusWelcomePackage
		...
		return getService().fetchSezStatusWelcomePackageByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static SezStatusWelcomePackage getSezStatus_Welcome_Package_By_CI(
			String caseId)
		throws com.nbp.sez.status.application.stage.services.exception.
			NoSuchSezStatusWelcomePackageException {

		return getService().getSezStatus_Welcome_Package_By_CI(caseId);
	}
	 ...
	 * @throws PortalException if a sez status welcome package with the primary key could not be found
	 */
	public static SezStatusWelcomePackage getSezStatusWelcomePackage(
			long sezStatusWelcomeId)
		throws PortalException {

		return getService().getSezStatusWelcomePackage(sezStatusWelcomeId);
	}
	 ...
	 */
	public static SezStatusWelcomePackage
			getSezStatusWelcomePackageByUuidAndGroupId(
				String uuid, long groupId)
		throws PortalException {

		return getService().getSezStatusWelcomePackageByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<SezStatusWelcomePackage> getSezStatusWelcomePackages(
		int start, int end) {

		return getService().getSezStatusWelcomePackages(start, end);
	}
	 ...
	 */
	public static List<SezStatusWelcomePackage>
		getSezStatusWelcomePackagesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getSezStatusWelcomePackagesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getSezStatusWelcomePackagesCount() {
		return getService().getSezStatusWelcomePackagesCount();
	}
	 ...
	 */
	public static SezStatusWelcomePackage updateSezStatusWelcomePackage(
		SezStatusWelcomePackage sezStatusWelcomePackage) {

		return getService().updateSezStatusWelcomePackage(
			sezStatusWelcomePackage);
	}

	public static SezStatusWelcomePackage updateSezStatusWelcomePackage(
		String caseId, java.util.Date dateOfWelcomePackageSigned,
		java.util.Date dateOfApplicantSigned, long welcomePackageFileEntry) {
	...
	public static SezStatusWelcomePackageLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SezStatusWelcomePackageLocalService>
		_serviceSnapshot = new Snapshot<>(
			SezStatusWelcomePackageLocalServiceUtil.class,
			SezStatusWelcomePackageLocalService.class);
