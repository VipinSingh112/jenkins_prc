...
/**
 * Provides the local service interface for SezStatusPreApprovalConditions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezStatusPreApprovalConditionsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezStatusPreApprovalConditionsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.stage.services.service.impl.SezStatusPreApprovalConditionsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez status pre approval conditions local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezStatusPreApprovalConditionsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusPreApprovalConditions getPreApprovalCondition_By_CI(
			String caseId)
	...
	public SezStatusPreApprovalConditions updatePreApprovalConditions(
