...
/**
 * The base model interface for the SezStatusApplicationStages service. Represents a row in the &quot;nbp_sez_status_app_stages&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.sez.status.application.stage.services.model.impl.SezStatusApplicationStagesModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.sez.status.application.stage.services.model.impl.SezStatusApplicationStagesImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface SezStatusApplicationStagesModel
	extends BaseModel<SezStatusApplicationStages>, GroupedModel, ShardedModel,
			StagedAuditedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a sez status application stages model instance should use the {@link SezStatusApplicationStages} interface instead.
	 */
