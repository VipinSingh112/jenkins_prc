...
/**
 * Provides the local service interface for SezStatusBoardDecision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SezStatusBoardDecisionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SezStatusBoardDecisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.sez.status.application.stage.services.service.impl.SezStatusBoardDecisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sez status board decision local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SezStatusBoardDecisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SezStatusBoardDecision addSezStatusBoardDecision(
	...
	public SezStatusBoardDecision createSezStatusBoardDecision(
	...
	public SezStatusBoardDecision deleteSezStatusBoardDecision(
			long sezStatusBoardId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusBoardDecision fetchSezStatusBoardDecision(
		long sezStatusBoardId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusBoardDecision fetchSezStatusBoardDecisionByUuidAndGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusBoardDecision getSezStatus_Board_Decision_By_Id(
		String caseId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusBoardDecision getSezStatusBoardDecision(
			long sezStatusBoardId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SezStatusBoardDecision getSezStatusBoardDecisionByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezStatusBoardDecision> getSezStatusBoardDecisions(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SezStatusBoardDecision>
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SezStatusBoardDecision updateSezStatusBoardDecision(
		SezStatusBoardDecision sezStatusBoardDecision);

	public SezStatusBoardDecision updateSezStatusDecision(
		String caseId, Date dateOfBoardDecision, String boardDecisio);
