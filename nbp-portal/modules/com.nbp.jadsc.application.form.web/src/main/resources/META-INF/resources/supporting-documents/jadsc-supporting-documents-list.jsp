<%@page import="com.nbp.jadsc.application.documents.util.GettingDocumentData"%>
...
if(Validator.isNotNull(request.getAttribute("jadscApplicationId"))){
	jadscAppId= String.valueOf(request.getAttribute("jadscApplicationId"));
}
	...
	<div class="supporting-document-card mb-3">
		...
		<div class="row">
			...
			<%if(fileEntryNR!=null && fileEntryIdNR!=0){ %>
				...
				<div class="left">
					<p class="uploaded-info-title" id="document-name"><%=fileNameNR %></p>
