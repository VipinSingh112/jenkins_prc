...
<fieldset class="wizard-fieldset" id="jadscSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	<p class="supporting-document-title common-heading f1 mb-2">Supporting Documents</p>
	<p class="supporting-document-subtitle mandatory-doc-heading">Mandatory
	...
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="jadscGenericUpload" onchange="attachDetailed(this.id)" multiple="multiple"
				name="<portlet:namespace/>jadscGenericUpload"
				hidden=""> <label class="custom-upload"
				for="jadscGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="jadscGenericFileChosen"></span>
		</div>
		...
		<% 
				...
				if(jadscApplicationId>0 && dlFileEntriesGeneric!=null){
					try{
						int docOfJadscAdditionalCounter=1001;
					for (DLFileEntry uploadedFile : dlFileEntriesGeneric) {
						...
						%>	
	 <div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfJadscAdditionalCounter%>">
				<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfJadscAdditionalCounter%>">
						<%
						%>
	...
	<div class="right">
		...
		<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=docOfJadscAdditionalCounter%>')">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" onchange="attachDetailed(this.id)" id="jadscEnrollDocuments"
												name="<portlet:namespace/>jadscEnrollDocuments">
					...
					<div class="modal-footer border-0 d-flex justify-content-end">
						<div>
							<a href="javascript:;"
								...
								onclick="uploadDocumentInjadsc();"> Submit<span class="ml-2">
							</span>
							</a>
						</div>
					</div>
