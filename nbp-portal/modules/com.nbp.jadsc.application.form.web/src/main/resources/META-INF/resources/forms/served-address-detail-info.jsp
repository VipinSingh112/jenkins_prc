<%
String docServedAddressVal = "";
docServedAddressVal = (String)request.getAttribute("docServedAddressVal");
%>
<tr class="doc-served-address-row<%=docServedAddressVal%>">
	<td class="sub_heading_content docServeName<%=docServedAddressVal%>"></td>
	<td class="sub_heading_content docServeCom<%=docServedAddressVal%>"></td>
	<td class="sub_heading_content docServeAddress<%=docServedAddressVal%>"></td>
	<td> 
		<span> 
     ...
     <td> 
		<span> 
			<a href="javascript:void(0)" id="docServedAddressDeleteDataTab" onclick="docServedAddressDeleteData('<%=docServedAddressVal%>');"> 
     ...
     <input type="hidden" id="docServedAddress<%=docServedAddressVal%>" name="docServedAddress<%=docServedAddressVal%>" value="">
</tr>
