...
import com.nbp.healthcare.application.form.service.service.HealthCareCurrentStageService;
...
/**
 * Provides the base implementation for the health care current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.healthcare.application.form.service.service.impl.HealthCareCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.healthcare.application.form.service.service.impl.HealthCareCurrentStageServiceImpl
 * @generated
 */
public abstract class HealthCareCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthCareCurrentStageService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthCareCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.healthcare.application.form.service.service.HealthCareCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthCareCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthCareCurrentStageService = (HealthCareCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthCareCurrentStageService.class.getName();
	}
	...
	protected HealthCareCurrentStageService healthCareCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HealthCareCurrentStageServiceBaseImpl.class);
