...
import com.nbp.healthcare.application.form.service.service.HealthCareEquipmentInfoService;
...
/**
 * Provides the base implementation for the health care equipment info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.healthcare.application.form.service.service.impl.HealthCareEquipmentInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.healthcare.application.form.service.service.impl.HealthCareEquipmentInfoServiceImpl
 * @generated
 */
public abstract class HealthCareEquipmentInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthCareEquipmentInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthCareEquipmentInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.healthcare.application.form.service.service.HealthCareEquipmentInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthCareEquipmentInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthCareEquipmentInfoService =
			(HealthCareEquipmentInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthCareEquipmentInfoService.class.getName();
	}
	...
	protected com.nbp.healthcare.application.form.service.service.
		HealthCareEquipmentInfoLocalService healthCareEquipmentInfoLocalService;

	protected HealthCareEquipmentInfoService healthCareEquipmentInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HealthCareEquipmentInfoServiceBaseImpl.class);
