...
import com.nbp.healthcare.application.form.service.service.HealthCareEquipmentInfoLocalService;
...
/**
 * Provides the base implementation for the health care equipment info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.healthcare.application.form.service.service.impl.HealthCareEquipmentInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.healthcare.application.form.service.service.impl.HealthCareEquipmentInfoLocalServiceImpl
 * @generated
 */
public abstract class HealthCareEquipmentInfoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthCareEquipmentInfoLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthCareEquipmentInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.healthcare.application.form.service.service.HealthCareEquipmentInfoLocalServiceUtil</code>.
	 */
	...
	public HealthCareEquipmentInfo addHealthCareEquipmentInfo(
		...
		return healthCareEquipmentInfoPersistence.update(
	...
	public HealthCareEquipmentInfo createHealthCareEquipmentInfo(
		...
		return healthCareEquipmentInfoPersistence.create(
	...
	public HealthCareEquipmentInfo deleteHealthCareEquipmentInfo(
		...
		return healthCareEquipmentInfoPersistence.remove(
			healthCareEquipmentInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return healthCareEquipmentInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthCareEquipmentInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthCareEquipmentInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthCareEquipmentInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public HealthCareEquipmentInfo fetchHealthCareEquipmentInfo(
		...
		return healthCareEquipmentInfoPersistence.fetchByPrimaryKey(
			healthCareEquipmentInfoId);
	}
	...
	public HealthCareEquipmentInfo getHealthCareEquipmentInfo(
		...
		return healthCareEquipmentInfoPersistence.findByPrimaryKey(
			healthCareEquipmentInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(HealthCareEquipmentInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement HealthCareEquipmentInfoLocalServiceImpl#deleteHealthCareEquipmentInfo(HealthCareEquipmentInfo) to avoid orphaned data");
		}

		return healthCareEquipmentInfoLocalService.
			deleteHealthCareEquipmentInfo(
				(HealthCareEquipmentInfo)persistedModel);
	}

	@Override
	public BasePersistence<HealthCareEquipmentInfo> getBasePersistence() {
		return healthCareEquipmentInfoPersistence;
	}
	...
	public List<HealthCareEquipmentInfo> getHealthCareEquipmentInfos(
		...
		return healthCareEquipmentInfoPersistence.findAll(start, end);
	}
	...
	public int getHealthCareEquipmentInfosCount() {
		return healthCareEquipmentInfoPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		healthCareEquipmentInfoLocalService =
			(HealthCareEquipmentInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthCareEquipmentInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				healthCareEquipmentInfoPersistence.getDataSource();
	...
	protected HealthCareEquipmentInfoLocalService
		healthCareEquipmentInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HealthCareEquipmentInfoLocalServiceBaseImpl.class);
