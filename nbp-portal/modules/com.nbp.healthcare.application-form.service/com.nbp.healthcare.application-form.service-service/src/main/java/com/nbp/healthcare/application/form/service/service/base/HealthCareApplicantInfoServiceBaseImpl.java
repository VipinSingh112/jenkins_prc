...
import com.nbp.healthcare.application.form.service.service.HealthCareApplicantInfoService;
...
/**
 * Provides the base implementation for the health care applicant info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantInfoServiceImpl
 * @generated
 */
public abstract class HealthCareApplicantInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthCareApplicantInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthCareApplicantInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.healthcare.application.form.service.service.HealthCareApplicantInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthCareApplicantInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthCareApplicantInfoService =
			(HealthCareApplicantInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthCareApplicantInfoService.class.getName();
	}
	...
	protected com.nbp.healthcare.application.form.service.service.
		HealthCareApplicantInfoLocalService healthCareApplicantInfoLocalService;

	protected HealthCareApplicantInfoService healthCareApplicantInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		HealthCareApplicantInfoServiceBaseImpl.class);
