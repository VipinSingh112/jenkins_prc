...
/**
 * The base model interface for the HealthCareBusinessAddress service. Represents a row in the &quot;nbp_healthcare_bussiness_add&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.healthcare.application.form.service.model.impl.HealthCareBusinessAddressModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.healthcare.application.form.service.model.impl.HealthCareBusinessAddressImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface HealthCareBusinessAddressModel
	extends BaseModel<HealthCareBusinessAddress>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a health care business address model instance should use the {@link HealthCareBusinessAddress} interface instead.
	 */
