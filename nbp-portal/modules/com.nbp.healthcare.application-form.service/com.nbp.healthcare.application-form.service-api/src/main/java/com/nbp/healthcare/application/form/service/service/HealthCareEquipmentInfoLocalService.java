...
/**
 * Provides the local service interface for HealthCareEquipmentInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HealthCareEquipmentInfoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HealthCareEquipmentInfoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareEquipmentInfoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the health care equipment info local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HealthCareEquipmentInfoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public HealthCareEquipmentInfo addHealthCareEquipmentInfo(
	...
	public HealthCareEquipmentInfo createHealthCareEquipmentInfo(
	...
	public HealthCareEquipmentInfo deleteHealthCareEquipmentInfo(
		HealthCareEquipmentInfo healthCareEquipmentInfo);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HealthCareEquipmentInfo fetchHealthCareEquipmentInfo(
		long healthCareEquipmentInfoId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HealthCareEquipmentInfo> getHC_EB_HAI(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HealthCareEquipmentInfo getHealthCareEquipmentInfo(
			long healthCareEquipmentInfoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HealthCareEquipmentInfo> getHealthCareEquipmentInfos(
		int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HealthCareEquipmentInfo getHelathCareById(
		long healthCareApplicationId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public HealthCareEquipmentInfo updateHealthCareEquipmentInfo(
		HealthCareEquipmentInfo healthCareEquipmentInfo);
