...
/**
 * The base model interface for the HealthCareApplication service. Represents a row in the &quot;nbp_healthcare_application&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.healthcare.application.form.service.model.impl.HealthCareApplicationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.healthcare.application.form.service.model.impl.HealthCareApplicationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface HealthCareApplicationModel
	extends BaseModel<HealthCareApplication>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a health care application model instance should use the {@link HealthCareApplication} interface instead.
	 */
