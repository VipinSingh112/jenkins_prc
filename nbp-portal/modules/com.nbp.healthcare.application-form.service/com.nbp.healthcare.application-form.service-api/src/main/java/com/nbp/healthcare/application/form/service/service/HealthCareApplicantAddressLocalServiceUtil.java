...
/**
 * Provides the local service utility for HealthCareApplicantAddress. This utility wraps
 * <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthCareApplicantAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthCareApplicantAddress addHealthCareApplicantAddress(
		HealthCareApplicantAddress healthCareApplicantAddress) {

		return getService().addHealthCareApplicantAddress(
	 ...
	 */
	public static HealthCareApplicantAddress createHealthCareApplicantAddress(
		long healthCareApplicantAddressId) {

		return getService().createHealthCareApplicantAddress(
	 ...
	 */
	public static HealthCareApplicantAddress deleteHealthCareApplicantAddress(
		HealthCareApplicantAddress healthCareApplicantAddress) {

		return getService().deleteHealthCareApplicantAddress(
			healthCareApplicantAddress);
	}
	...
	public static HealthCareApplicantAddress fetchHealthCareApplicantAddress(
		long healthCareApplicantAddressId) {

		return getService().fetchHealthCareApplicantAddress(
			healthCareApplicantAddressId);
	}
	 ...
	 * @throws PortalException if a health care applicant address with the primary key could not be found
	 */
	public static HealthCareApplicantAddress getHealthCareApplicantAddress(
			long healthCareApplicantAddressId)
		throws PortalException {

		return getService().getHealthCareApplicantAddress(
			healthCareApplicantAddressId);
	}
	 ...
	 */
	public static List<HealthCareApplicantAddress>
		getHealthCareApplicantAddresses(int start, int end) {

		return getService().getHealthCareApplicantAddresses(start, end);
	}
	 ...
	 */
	public static int getHealthCareApplicantAddressesCount() {
		return getService().getHealthCareApplicantAddressesCount();
	}

	public static HealthCareApplicantAddress getHealthCareById(
	 ...
	 */
	public static HealthCareApplicantAddress updateHealthCareApplicantAddress(
		HealthCareApplicantAddress healthCareApplicantAddress) {

		return getService().updateHealthCareApplicantAddress(
			healthCareApplicantAddress);
	}

	public static HealthCareApplicantAddressLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<HealthCareApplicantAddressLocalService>
		_serviceSnapshot = new Snapshot<>(
			HealthCareApplicantAddressLocalServiceUtil.class,
