...
/**
 * Provides the local service utility for HealthCareBusinessAddress. This utility wraps
 * <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareBusinessAddressLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthCareBusinessAddressLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareBusinessAddressLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthCareBusinessAddress addHealthCareBusinessAddress(
		HealthCareBusinessAddress healthCareBusinessAddress) {

		return getService().addHealthCareBusinessAddress(
	 ...
	 */
	public static HealthCareBusinessAddress createHealthCareBusinessAddress(
		long healthCareBusinessAddressId) {

		return getService().createHealthCareBusinessAddress(
	 ...
	 */
	public static HealthCareBusinessAddress deleteHealthCareBusinessAddress(
		HealthCareBusinessAddress healthCareBusinessAddress) {

		return getService().deleteHealthCareBusinessAddress(
			healthCareBusinessAddress);
	}
	...
	public static HealthCareBusinessAddress fetchHealthCareBusinessAddress(
		long healthCareBusinessAddressId) {

		return getService().fetchHealthCareBusinessAddress(
			healthCareBusinessAddressId);
	}
	 ...
	 * @throws PortalException if a health care business address with the primary key could not be found
	 */
	public static HealthCareBusinessAddress getHealthCareBusinessAddress(
			long healthCareBusinessAddressId)
		throws PortalException {

		return getService().getHealthCareBusinessAddress(
			healthCareBusinessAddressId);
	}
	 ...
	 */
	public static List<HealthCareBusinessAddress>
		getHealthCareBusinessAddresses(int start, int end) {

		return getService().getHealthCareBusinessAddresses(start, end);
	}
	 ...
	 */
	public static int getHealthCareBusinessAddressesCount() {
		return getService().getHealthCareBusinessAddressesCount();
	}

	public static HealthCareBusinessAddress getHealthCareById(
		long healthCareById) {
	 ...
	 */
	public static HealthCareBusinessAddress updateHealthCareBusinessAddress(
		HealthCareBusinessAddress healthCareBusinessAddress) {

		return getService().updateHealthCareBusinessAddress(
			healthCareBusinessAddress);
	}

	public static HealthCareBusinessAddressLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<HealthCareBusinessAddressLocalService>
		_serviceSnapshot = new Snapshot<>(
			HealthCareBusinessAddressLocalServiceUtil.class,
