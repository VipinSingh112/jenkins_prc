...
/**
 * Provides the local service utility for HealthCareApplicantInfo. This utility wraps
 * <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthCareApplicantInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.healthcare.application.form.service.service.impl.HealthCareApplicantInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthCareApplicantInfo addHealthCareApplicantInfo(
		HealthCareApplicantInfo healthCareApplicantInfo) {

		return getService().addHealthCareApplicantInfo(healthCareApplicantInfo);
	}
	 ...
	 */
	public static HealthCareApplicantInfo createHealthCareApplicantInfo(
		long healthCareApplicantInfoId) {

		return getService().createHealthCareApplicantInfo(
	 ...
	 */
	public static HealthCareApplicantInfo deleteHealthCareApplicantInfo(
		HealthCareApplicantInfo healthCareApplicantInfo) {

		return getService().deleteHealthCareApplicantInfo(
	...
	public static HealthCareApplicantInfo fetchHealthCareApplicantInfo(
		long healthCareApplicantInfoId) {

		return getService().fetchHealthCareApplicantInfo(
			healthCareApplicantInfoId);
	}
	 ...
	 * @throws PortalException if a health care applicant info with the primary key could not be found
	 */
	public static HealthCareApplicantInfo getHealthCareApplicantInfo(
			long healthCareApplicantInfoId)
		throws PortalException {

		return getService().getHealthCareApplicantInfo(
			healthCareApplicantInfoId);
	}
	 ...
	 */
	public static List<HealthCareApplicantInfo> getHealthCareApplicantInfos(
		int start, int end) {

		return getService().getHealthCareApplicantInfos(start, end);
	}
	 ...
	 */
	public static int getHealthCareApplicantInfosCount() {
		return getService().getHealthCareApplicantInfosCount();
	}

	public static HealthCareApplicantInfo getHealthCareById(
	 ...
	 */
	public static HealthCareApplicantInfo updateHealthCareApplicantInfo(
		HealthCareApplicantInfo healthCareApplicantInfo) {

		return getService().updateHealthCareApplicantInfo(
			healthCareApplicantInfo);
	}

	public static HealthCareApplicantInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<HealthCareApplicantInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			HealthCareApplicantInfoLocalServiceUtil.class,
