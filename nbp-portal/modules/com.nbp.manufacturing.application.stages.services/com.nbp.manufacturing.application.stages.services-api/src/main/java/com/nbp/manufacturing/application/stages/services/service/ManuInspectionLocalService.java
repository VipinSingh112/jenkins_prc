...
/**
 * Provides the local service interface for ManuInspection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManuInspectionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ManuInspectionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.stages.services.service.impl.ManuInspectionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the manu inspection local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ManuInspectionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManuInspection getInspectionByStatus_SlotBoooked(
			String status, long slotBookedByUser,
			long manufacturingApplicationId)
		throws NoSuchManuInspectionException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManuInspection getManufacturingInspectionBY_CI(String caseId)
		throws NoSuchManuInspectionException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManuInspection> getManuInspections(
		long manufacturingApplicationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManuInspection> getManuInspectionsByStatusApplicationId(
		long manufacturingApplicationId, String status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManuInspection> getManuInspectionsByStatusCaseId(
	...
	public ManuInspection updateManuInspection(
