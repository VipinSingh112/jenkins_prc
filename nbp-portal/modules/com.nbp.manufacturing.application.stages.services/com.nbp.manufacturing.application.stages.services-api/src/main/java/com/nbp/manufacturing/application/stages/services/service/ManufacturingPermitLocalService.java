...
/**
 * Provides the local service interface for ManufacturingPermit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManufacturingPermitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ManufacturingPermitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.stages.services.service.impl.ManufacturingPermitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the manufacturing permit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ManufacturingPermitLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManufacturingPermit getManufacturingPermitBY_CI(String caseId)
		throws NoSuchManufacturingPermitException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManufacturingPermit getManufacturingPermitBY_Permit(
			String pirPermitNumber)
		throws NoSuchManufacturingPermitException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManufacturingPermit getManufacturingPermitBY_PermitNumber(
			String pirPermitNumber)
		throws NoSuchManufacturingPermitException;
	...
	public ManufacturingPermit updateManufacturingPermit(
		String caseId, String pirPermitNumber, Date dateOfIssue,
		Date dateOfExpirartion, String durationOfPermit, String typeOfPermit,
