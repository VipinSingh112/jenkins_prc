...
/**
 * Provides the local service interface for ManufacturingRecommendationToJCA. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManufacturingRecommendationToJCALocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ManufacturingRecommendationToJCALocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.stages.services.service.impl.ManufacturingRecommendationToJCALocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the manufacturing recommendation to jca local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ManufacturingRecommendationToJCALocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ManufacturingRecommendationToJCA addManufacturingRecommendationToJCA(
	...
	public ManufacturingRecommendationToJCA
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManufacturingRecommendationToJCA getManufacturingRecommendationToJCA(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManufacturingRecommendationToJCA>
	...
	public ManufacturingRecommendationToJCA
		updateManufacturingRecommendationToJCA(
			String caseId, Date date, String recommendationToJCA,
