...
/**
 * Provides the local service interface for ManuDeskVerification. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ManuDeskVerificationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ManuDeskVerificationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.manufacturing.application.stages.services.service.impl.ManuDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the manu desk verification local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ManuDeskVerificationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ManuDeskVerification> getDeskVerificationManufactuirngById(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ManuDeskVerification getManufactuirngById(
			long manufacturingApplicationId)
