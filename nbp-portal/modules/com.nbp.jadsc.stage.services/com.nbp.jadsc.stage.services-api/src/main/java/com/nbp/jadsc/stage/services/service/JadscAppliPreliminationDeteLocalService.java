...
/**
 * Provides the local service interface for JadscAppliPreliminationDete. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JadscAppliPreliminationDeteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JadscAppliPreliminationDeteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jadsc.stage.services.service.impl.JadscAppliPreliminationDeteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the jadsc appli prelimination dete local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JadscAppliPreliminationDeteLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JadscAppliPreliminationDete getJadscAppliPreliminationDeteByCI(
			String caseId)
		throws NoSuchJadscAppliPreliminationDeteException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JadscAppliPreliminationDete>
	...
	public JadscAppliPreliminationDete updateJadscAppliPreliminationDete(
		String caseId, Date dateOfPreDete, String outcome);
