...
/**
 * Provides the local service interface for JadscAppliPreInitiation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JadscAppliPreInitiationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JadscAppliPreInitiationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.jadsc.stage.services.service.impl.JadscAppliPreInitiationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the jadsc appli pre initiation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JadscAppliPreInitiationLocalServiceUtil} if injection and service tracking are not available.
	 */
