...
import com.nbp.jadsc.stage.services.service.JadscApplicationPreInitiationLocalService;
...
/**
 * Provides the base implementation for the jadsc application pre initiation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jadsc.stage.services.service.impl.JadscApplicationPreInitiationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jadsc.stage.services.service.impl.JadscApplicationPreInitiationLocalServiceImpl
 * @generated
 */
public abstract class JadscApplicationPreInitiationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JadscApplicationPreInitiationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jadsc.stage.services.service.JadscApplicationPreInitiationLocalServiceUtil</code>.
	 */
	...
	public JadscApplicationPreInitiation addJadscApplicationPreInitiation(
		...
		return jadscApplicationPreInitiationPersistence.update(
	...
	public JadscApplicationPreInitiation createJadscApplicationPreInitiation(
		...
		return jadscApplicationPreInitiationPersistence.create(
	...
	public JadscApplicationPreInitiation deleteJadscApplicationPreInitiation(
		...
		return jadscApplicationPreInitiationPersistence.remove(
			jadscAppliPreInitiationId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return jadscApplicationPreInitiationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JadscApplicationPreInitiation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jadscApplicationPreInitiationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jadscApplicationPreInitiationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public JadscApplicationPreInitiation fetchJadscApplicationPreInitiation(
		...
		return jadscApplicationPreInitiationPersistence.fetchByPrimaryKey(
			jadscAppliPreInitiationId);
	}
	...
	public JadscApplicationPreInitiation getJadscApplicationPreInitiation(
		...
		return jadscApplicationPreInitiationPersistence.findByPrimaryKey(
			jadscAppliPreInitiationId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement JadscApplicationPreInitiationLocalServiceImpl#deleteJadscApplicationPreInitiation(JadscApplicationPreInitiation) to avoid orphaned data");
		}

		return jadscApplicationPreInitiationLocalService.
			deleteJadscApplicationPreInitiation(
				(JadscApplicationPreInitiation)persistedModel);
	}

	@Override
	public BasePersistence<JadscApplicationPreInitiation> getBasePersistence() {
		return jadscApplicationPreInitiationPersistence;
	}
	...
	public List<JadscApplicationPreInitiation>
		...
		return jadscApplicationPreInitiationPersistence.findAll(start, end);
	}
	...
	public int getJadscApplicationPreInitiationsCount() {
		return jadscApplicationPreInitiationPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		jadscApplicationPreInitiationLocalService =
			(JadscApplicationPreInitiationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JadscApplicationPreInitiationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				jadscApplicationPreInitiationPersistence.getDataSource();
	...
	protected JadscApplicationPreInitiationLocalService
		jadscApplicationPreInitiationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JadscApplicationPreInitiationLocalServiceBaseImpl.class);
