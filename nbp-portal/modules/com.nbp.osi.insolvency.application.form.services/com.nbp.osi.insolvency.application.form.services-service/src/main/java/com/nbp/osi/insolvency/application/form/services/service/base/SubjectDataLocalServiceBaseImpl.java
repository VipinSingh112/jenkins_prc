...
import com.nbp.osi.insolvency.application.form.services.service.SubjectDataLocalService;
...
/**
 * Provides the base implementation for the subject data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.SubjectDataLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.SubjectDataLocalServiceImpl
 * @generated
 */
public abstract class SubjectDataLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SubjectDataLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SubjectDataLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.SubjectDataLocalServiceUtil</code>.
	 */
	...
	@Override
	public SubjectData addSubjectData(SubjectData subjectData) {
		subjectData.setNew(true);

		return subjectDataPersistence.update(subjectData);
	}
	...
	public SubjectData createSubjectData(long subjectDataId) {
		return subjectDataPersistence.create(subjectDataId);
	}
	...
	@Override
	public SubjectData deleteSubjectData(long subjectDataId)
		throws PortalException {

		return subjectDataPersistence.remove(subjectDataId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SubjectData deleteSubjectData(SubjectData subjectData) {
		return subjectDataPersistence.remove(subjectData);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return subjectDataPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SubjectData.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return subjectDataPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return subjectDataPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return subjectDataPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return subjectDataPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SubjectData fetchSubjectData(long subjectDataId) {
		return subjectDataPersistence.fetchByPrimaryKey(subjectDataId);
	}
	 ...
	 */
	@Override
	public SubjectData getSubjectData(long subjectDataId)
		throws PortalException {

		return subjectDataPersistence.findByPrimaryKey(subjectDataId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(subjectDataLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SubjectData.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("subjectDataId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SubjectData.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return subjectDataPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SubjectDataLocalServiceImpl#deleteSubjectData(SubjectData) to avoid orphaned data");
		}

		return subjectDataLocalService.deleteSubjectData(
			(SubjectData)persistedModel);
	}

	@Override
	public BasePersistence<SubjectData> getBasePersistence() {
		return subjectDataPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return subjectDataPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SubjectData> getSubjectDatas(int start, int end) {
		return subjectDataPersistence.findAll(start, end);
	}
	...
	public int getSubjectDatasCount() {
		return subjectDataPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SubjectData updateSubjectData(SubjectData subjectData) {
		return subjectDataPersistence.update(subjectData);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SubjectDataLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		subjectDataLocalService = (SubjectDataLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SubjectDataLocalService.class.getName();
	}
	...
	protected SubjectDataLocalService subjectDataLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SubjectDataLocalServiceBaseImpl.class);
