...
import com.nbp.osi.insolvency.application.form.services.service.GrandTotalService;
...
/**
 * Provides the base implementation for the grand total remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.GrandTotalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.GrandTotalServiceImpl
 * @generated
 */
public abstract class GrandTotalServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GrandTotalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GrandTotalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.GrandTotalServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GrandTotalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		grandTotalService = (GrandTotalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return GrandTotalService.class.getName();
	}
	...
	protected GrandTotalService grandTotalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GrandTotalServiceBaseImpl.class);
