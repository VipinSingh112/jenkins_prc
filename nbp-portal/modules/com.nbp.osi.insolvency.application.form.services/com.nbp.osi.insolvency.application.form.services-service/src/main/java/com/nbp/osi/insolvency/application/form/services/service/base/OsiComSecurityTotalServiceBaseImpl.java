...
import com.nbp.osi.insolvency.application.form.services.service.OsiComSecurityTotalService;
...
/**
 * Provides the base implementation for the osi com security total remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiComSecurityTotalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiComSecurityTotalServiceImpl
 * @generated
 */
public abstract class OsiComSecurityTotalServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OsiComSecurityTotalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiComSecurityTotalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiComSecurityTotalServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiComSecurityTotalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiComSecurityTotalService = (OsiComSecurityTotalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiComSecurityTotalService.class.getName();
	}
	...
	protected OsiComSecurityTotalService osiComSecurityTotalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiComSecurityTotalServiceBaseImpl.class);
