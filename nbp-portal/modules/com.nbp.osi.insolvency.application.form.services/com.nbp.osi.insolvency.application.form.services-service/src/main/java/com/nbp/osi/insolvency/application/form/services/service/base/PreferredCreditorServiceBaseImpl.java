...
import com.nbp.osi.insolvency.application.form.services.service.PreferredCreditorService;
...
/**
 * Provides the base implementation for the preferred creditor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.PreferredCreditorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.PreferredCreditorServiceImpl
 * @generated
 */
public abstract class PreferredCreditorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PreferredCreditorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PreferredCreditorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.PreferredCreditorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PreferredCreditorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		preferredCreditorService = (PreferredCreditorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return PreferredCreditorService.class.getName();
	}
	...
	protected PreferredCreditorService preferredCreditorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PreferredCreditorServiceBaseImpl.class);
