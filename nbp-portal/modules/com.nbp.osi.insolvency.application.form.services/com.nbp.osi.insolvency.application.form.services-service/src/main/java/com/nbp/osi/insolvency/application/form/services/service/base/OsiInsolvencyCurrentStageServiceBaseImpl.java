...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyCurrentStageService;
...
/**
 * Provides the base implementation for the osi insolvency current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyCurrentStageServiceImpl
 * @generated
 */
public abstract class OsiInsolvencyCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiInsolvencyCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvencyCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolvencyCurrentStageService =
			(OsiInsolvencyCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvencyCurrentStageService.class.getName();
	}
	...
	protected OsiInsolvencyCurrentStageService osiInsolvencyCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvencyCurrentStageServiceBaseImpl.class);
