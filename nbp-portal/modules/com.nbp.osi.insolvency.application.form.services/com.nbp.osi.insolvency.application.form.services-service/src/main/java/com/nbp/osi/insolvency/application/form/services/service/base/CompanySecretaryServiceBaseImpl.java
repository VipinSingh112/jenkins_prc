...
import com.nbp.osi.insolvency.application.form.services.service.CompanySecretaryService;
...
/**
 * Provides the base implementation for the company secretary remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecretaryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecretaryServiceImpl
 * @generated
 */
public abstract class CompanySecretaryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanySecretaryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanySecretaryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanySecretaryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanySecretaryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companySecretaryService = (CompanySecretaryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanySecretaryService.class.getName();
	}
	...
	protected CompanySecretaryService companySecretaryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanySecretaryServiceBaseImpl.class);
