...
import com.nbp.osi.insolvency.application.form.services.service.OsiAssessmentSignatureService;
...
/**
 * Provides the base implementation for the osi assessment signature remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiAssessmentSignatureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiAssessmentSignatureServiceImpl
 * @generated
 */
public abstract class OsiAssessmentSignatureServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiAssessmentSignatureService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiAssessmentSignatureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiAssessmentSignatureServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiAssessmentSignatureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiAssessmentSignatureService = (OsiAssessmentSignatureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiAssessmentSignatureService.class.getName();
	}
	...
	protected OsiAssessmentSignatureService osiAssessmentSignatureService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiAssessmentSignatureServiceBaseImpl.class);
