...
import com.nbp.osi.insolvency.application.form.services.service.VerificationCompanyInfoLocalService;
...
/**
 * Provides the base implementation for the verification company info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoLocalServiceImpl
 * @generated
 */
public abstract class VerificationCompanyInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VerificationCompanyInfoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.VerificationCompanyInfoLocalServiceUtil</code>.
	 */
	...
	@Override
	public VerificationCompanyInfo addVerificationCompanyInfo(
		VerificationCompanyInfo verificationCompanyInfo) {

		verificationCompanyInfo.setNew(true);

		return verificationCompanyInfoPersistence.update(
	...
	public VerificationCompanyInfo createVerificationCompanyInfo(
		long verificationCompanyInfoId) {

		return verificationCompanyInfoPersistence.create(
	...
	@Override
	public VerificationCompanyInfo deleteVerificationCompanyInfo(
			long verificationCompanyInfoId)
		throws PortalException {

		return verificationCompanyInfoPersistence.remove(
			verificationCompanyInfoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return verificationCompanyInfoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			VerificationCompanyInfo.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return verificationCompanyInfoPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return verificationCompanyInfoPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public VerificationCompanyInfo fetchVerificationCompanyInfo(
		long verificationCompanyInfoId) {

		return verificationCompanyInfoPersistence.fetchByPrimaryKey(
			verificationCompanyInfoId);
	}
	 ...
	 */
	@Override
	public VerificationCompanyInfo getVerificationCompanyInfo(
			long verificationCompanyInfoId)
		throws PortalException {

		return verificationCompanyInfoPersistence.findByPrimaryKey(
			verificationCompanyInfoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(VerificationCompanyInfo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement VerificationCompanyInfoLocalServiceImpl#deleteVerificationCompanyInfo(VerificationCompanyInfo) to avoid orphaned data");
		}

		return verificationCompanyInfoLocalService.
			deleteVerificationCompanyInfo(
				(VerificationCompanyInfo)persistedModel);
	}

	@Override
	public BasePersistence<VerificationCompanyInfo> getBasePersistence() {
		return verificationCompanyInfoPersistence;
	}
	 ...
	 */
	@Override
	public List<VerificationCompanyInfo> getVerificationCompanyInfos(
		int start, int end) {

		return verificationCompanyInfoPersistence.findAll(start, end);
	}
	...
	public int getVerificationCompanyInfosCount() {
		return verificationCompanyInfoPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VerificationCompanyInfo updateVerificationCompanyInfo(
		VerificationCompanyInfo verificationCompanyInfo) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VerificationCompanyInfoLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		verificationCompanyInfoLocalService =
			(VerificationCompanyInfoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return VerificationCompanyInfoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				verificationCompanyInfoPersistence.getDataSource();
	...
	protected VerificationCompanyInfoLocalService
		verificationCompanyInfoLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VerificationCompanyInfoLocalServiceBaseImpl.class);
