...
import com.nbp.osi.insolvency.application.form.services.service.base.AssetsUsedAsSecurityLocalServiceBaseImpl;
 ...
 */
@Component(
	property = "model.class.name=com.nbp.osi.insolvency.application.form.services.model.AssetsUsedAsSecurity",
	service = AopService.class
)
public class AssetsUsedAsSecurityLocalServiceImpl
	extends AssetsUsedAsSecurityLocalServiceBaseImpl {
	public List<AssetsUsedAsSecurity> getOsiById(long osiInsolvencyId) throws NoSuchAssetsUsedAsSecurityException{
		return assetsUsedAsSecurityPersistence.findBygetOsiById(osiInsolvencyId);
	}
	public void deleteBY_Id(long applicationId) {
		assetsUsedAsSecurityPersistence.removeBygetOsiById(applicationId);
		}
}