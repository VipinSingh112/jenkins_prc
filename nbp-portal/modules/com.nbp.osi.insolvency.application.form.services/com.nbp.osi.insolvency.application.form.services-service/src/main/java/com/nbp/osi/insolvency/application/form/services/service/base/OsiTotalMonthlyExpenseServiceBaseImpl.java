...
import com.nbp.osi.insolvency.application.form.services.service.OsiTotalMonthlyExpenseService;
...
/**
 * Provides the base implementation for the osi total monthly expense remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiTotalMonthlyExpenseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiTotalMonthlyExpenseServiceImpl
 * @generated
 */
public abstract class OsiTotalMonthlyExpenseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiTotalMonthlyExpenseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiTotalMonthlyExpenseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiTotalMonthlyExpenseServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiTotalMonthlyExpenseService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiTotalMonthlyExpenseService = (OsiTotalMonthlyExpenseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiTotalMonthlyExpenseService.class.getName();
	}
	...
	protected OsiTotalMonthlyExpenseService osiTotalMonthlyExpenseService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiTotalMonthlyExpenseServiceBaseImpl.class);
