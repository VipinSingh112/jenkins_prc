...
import com.nbp.osi.insolvency.application.form.services.service.base.CompanyDetailsServiceBaseImpl;
...
@Component(
	property = {
		...
		"json.web.service.context.path=CompanyDetails"
	},
	service = AopService.class
)
public class CompanyDetailsServiceImpl extends CompanyDetailsServiceBaseImpl {
