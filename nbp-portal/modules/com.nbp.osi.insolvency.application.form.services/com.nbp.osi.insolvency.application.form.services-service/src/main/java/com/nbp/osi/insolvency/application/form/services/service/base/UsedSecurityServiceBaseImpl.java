...
import com.nbp.osi.insolvency.application.form.services.service.UsedSecurityService;
...
/**
 * Provides the base implementation for the used security remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.UsedSecurityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.UsedSecurityServiceImpl
 * @generated
 */
public abstract class UsedSecurityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UsedSecurityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UsedSecurityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.UsedSecurityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UsedSecurityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		usedSecurityService = (UsedSecurityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UsedSecurityService.class.getName();
	}
	...
	protected UsedSecurityService usedSecurityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UsedSecurityServiceBaseImpl.class);
