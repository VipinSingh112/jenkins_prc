...
import com.nbp.osi.insolvency.application.form.services.service.DirectorsFormLocalService;
...
/**
 * Provides the base implementation for the directors form local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.DirectorsFormLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.DirectorsFormLocalServiceImpl
 * @generated
 */
public abstract class DirectorsFormLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DirectorsFormLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DirectorsFormLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.DirectorsFormLocalServiceUtil</code>.
	 */
	...
	@Override
	public DirectorsForm addDirectorsForm(DirectorsForm directorsForm) {
		directorsForm.setNew(true);

		return directorsFormPersistence.update(directorsForm);
	}
	...
	public DirectorsForm createDirectorsForm(long directorsFormId) {
		return directorsFormPersistence.create(directorsFormId);
	}
	...
	@Override
	public DirectorsForm deleteDirectorsForm(long directorsFormId)
		throws PortalException {

		return directorsFormPersistence.remove(directorsFormId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DirectorsForm deleteDirectorsForm(DirectorsForm directorsForm) {
		return directorsFormPersistence.remove(directorsForm);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return directorsFormPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DirectorsForm.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return directorsFormPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return directorsFormPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return directorsFormPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return directorsFormPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DirectorsForm fetchDirectorsForm(long directorsFormId) {
		return directorsFormPersistence.fetchByPrimaryKey(directorsFormId);
	}
	 ...
	 */
	@Override
	public DirectorsForm getDirectorsForm(long directorsFormId)
		throws PortalException {

		return directorsFormPersistence.findByPrimaryKey(directorsFormId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(directorsFormLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DirectorsForm.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("directorsFormId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			directorsFormLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DirectorsForm.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return directorsFormPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DirectorsFormLocalServiceImpl#deleteDirectorsForm(DirectorsForm) to avoid orphaned data");
		}

		return directorsFormLocalService.deleteDirectorsForm(
			(DirectorsForm)persistedModel);
	}

	@Override
	public BasePersistence<DirectorsForm> getBasePersistence() {
		return directorsFormPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return directorsFormPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DirectorsForm> getDirectorsForms(int start, int end) {
		return directorsFormPersistence.findAll(start, end);
	}
	...
	public int getDirectorsFormsCount() {
		return directorsFormPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DirectorsForm updateDirectorsForm(DirectorsForm directorsForm) {
		return directorsFormPersistence.update(directorsForm);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DirectorsFormLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		directorsFormLocalService = (DirectorsFormLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DirectorsFormLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return DirectorsForm.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = directorsFormPersistence.getDataSource();
	...
	protected DirectorsFormLocalService directorsFormLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DirectorsFormLocalServiceBaseImpl.class);
