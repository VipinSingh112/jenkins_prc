...
import com.nbp.osi.insolvency.application.form.services.service.AssessmentIndividualPersonalDetailsLocalService;
...
/**
 * Provides the base implementation for the assessment individual personal details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.AssessmentIndividualPersonalDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.AssessmentIndividualPersonalDetailsLocalServiceImpl
 * @generated
 */
public abstract class AssessmentIndividualPersonalDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AssessmentIndividualPersonalDetailsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssessmentIndividualPersonalDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.AssessmentIndividualPersonalDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public AssessmentIndividualPersonalDetails
		...
		return assessmentIndividualPersonalDetailsPersistence.update(
			assessmentIndividualPersonalDetails);
	}
	...
	public AssessmentIndividualPersonalDetails
		...
		return assessmentIndividualPersonalDetailsPersistence.create(
			assessmentDetailsId);
	}
	...
	public AssessmentIndividualPersonalDetails
		...
		return assessmentIndividualPersonalDetailsPersistence.remove(
			assessmentDetailsId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return assessmentIndividualPersonalDetailsPersistence.dslQuery(
			dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AssessmentIndividualPersonalDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assessmentIndividualPersonalDetailsPersistence.
	...
	public AssessmentIndividualPersonalDetails
		...
		return assessmentIndividualPersonalDetailsPersistence.fetchByPrimaryKey(
			assessmentDetailsId);
	}
	...
	public AssessmentIndividualPersonalDetails
		...
		return assessmentIndividualPersonalDetailsPersistence.findByPrimaryKey(
			assessmentDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("assessmentDetailsId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AssessmentIndividualPersonalDetailsLocalServiceImpl#deleteAssessmentIndividualPersonalDetails(AssessmentIndividualPersonalDetails) to avoid orphaned data");
		}

		return assessmentIndividualPersonalDetailsLocalService.
			deleteAssessmentIndividualPersonalDetails(
				(AssessmentIndividualPersonalDetails)persistedModel);
	}

	@Override
	public BasePersistence<AssessmentIndividualPersonalDetails>
		getBasePersistence() {
	 ...
	 */
	@Override
	public List<AssessmentIndividualPersonalDetails>
		getAssessmentIndividualPersonalDetailses(int start, int end) {

		return assessmentIndividualPersonalDetailsPersistence.findAll(
			start, end);
	}
	...
	public int getAssessmentIndividualPersonalDetailsesCount() {
		return assessmentIndividualPersonalDetailsPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		assessmentIndividualPersonalDetailsLocalService =
			(AssessmentIndividualPersonalDetailsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssessmentIndividualPersonalDetailsLocalService.class.getName();
	}
	...
	protected AssessmentIndividualPersonalDetailsLocalService
		assessmentIndividualPersonalDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssessmentIndividualPersonalDetailsLocalServiceBaseImpl.class);
