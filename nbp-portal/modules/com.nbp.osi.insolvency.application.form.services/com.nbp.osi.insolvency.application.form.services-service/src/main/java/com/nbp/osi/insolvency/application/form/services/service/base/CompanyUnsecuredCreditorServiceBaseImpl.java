...
import com.nbp.osi.insolvency.application.form.services.service.CompanyUnsecuredCreditorService;
...
/**
 * Provides the base implementation for the company unsecured creditor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanyUnsecuredCreditorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanyUnsecuredCreditorServiceImpl
 * @generated
 */
public abstract class CompanyUnsecuredCreditorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanyUnsecuredCreditorService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyUnsecuredCreditorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanyUnsecuredCreditorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyUnsecuredCreditorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companyUnsecuredCreditorService =
			(CompanyUnsecuredCreditorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyUnsecuredCreditorService.class.getName();
	}
	...
	protected CompanyUnsecuredCreditorService companyUnsecuredCreditorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanyUnsecuredCreditorServiceBaseImpl.class);
