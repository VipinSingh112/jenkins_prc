...
import com.nbp.osi.insolvency.application.form.services.service.FinancialPositionService;
...
/**
 * Provides the base implementation for the financial position remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.FinancialPositionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.FinancialPositionServiceImpl
 * @generated
 */
public abstract class FinancialPositionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FinancialPositionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FinancialPositionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.FinancialPositionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FinancialPositionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		financialPositionService = (FinancialPositionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FinancialPositionService.class.getName();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FinancialPositionServiceBaseImpl.class);
