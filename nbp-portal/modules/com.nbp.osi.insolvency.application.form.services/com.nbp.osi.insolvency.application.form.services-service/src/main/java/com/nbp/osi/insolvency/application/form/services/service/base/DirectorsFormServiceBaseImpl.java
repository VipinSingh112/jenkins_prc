...
import com.nbp.osi.insolvency.application.form.services.service.DirectorsFormService;
...
/**
 * Provides the base implementation for the directors form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.DirectorsFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.DirectorsFormServiceImpl
 * @generated
 */
public abstract class DirectorsFormServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DirectorsFormService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DirectorsFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.DirectorsFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DirectorsFormService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		directorsFormService = (DirectorsFormService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return DirectorsFormService.class.getName();
	}
	...
	protected DirectorsFormService directorsFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DirectorsFormServiceBaseImpl.class);
