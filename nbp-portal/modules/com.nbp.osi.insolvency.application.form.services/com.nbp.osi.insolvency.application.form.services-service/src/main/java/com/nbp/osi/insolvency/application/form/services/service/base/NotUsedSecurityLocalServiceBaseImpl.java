...
import com.nbp.osi.insolvency.application.form.services.service.NotUsedSecurityLocalService;
...
/**
 * Provides the base implementation for the not used security local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.NotUsedSecurityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.NotUsedSecurityLocalServiceImpl
 * @generated
 */
public abstract class NotUsedSecurityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   NotUsedSecurityLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NotUsedSecurityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.NotUsedSecurityLocalServiceUtil</code>.
	 */
	...
	public NotUsedSecurity addNotUsedSecurity(NotUsedSecurity notUsedSecurity) {
		...
		return notUsedSecurityPersistence.update(notUsedSecurity);
	}
	...
	public NotUsedSecurity createNotUsedSecurity(long notUsedSecurityId) {
		return notUsedSecurityPersistence.create(notUsedSecurityId);
	}
	...
	public NotUsedSecurity deleteNotUsedSecurity(long notUsedSecurityId)
		...
		return notUsedSecurityPersistence.remove(notUsedSecurityId);
	}
	...
	public NotUsedSecurity deleteNotUsedSecurity(
		...
		return notUsedSecurityPersistence.remove(notUsedSecurity);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return notUsedSecurityPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NotUsedSecurity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return notUsedSecurityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return notUsedSecurityPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return notUsedSecurityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return notUsedSecurityPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public NotUsedSecurity fetchNotUsedSecurity(long notUsedSecurityId) {
		return notUsedSecurityPersistence.fetchByPrimaryKey(notUsedSecurityId);
	}
	...
	public NotUsedSecurity getNotUsedSecurity(long notUsedSecurityId)
		...
		return notUsedSecurityPersistence.findByPrimaryKey(notUsedSecurityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(notUsedSecurityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(NotUsedSecurity.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("notUsedSecurityId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(NotUsedSecurity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return notUsedSecurityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement NotUsedSecurityLocalServiceImpl#deleteNotUsedSecurity(NotUsedSecurity) to avoid orphaned data");
		}

		return notUsedSecurityLocalService.deleteNotUsedSecurity(
			(NotUsedSecurity)persistedModel);
	}

	@Override
	public BasePersistence<NotUsedSecurity> getBasePersistence() {
		return notUsedSecurityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return notUsedSecurityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NotUsedSecurity> getNotUsedSecurities(int start, int end) {
		return notUsedSecurityPersistence.findAll(start, end);
	}
	...
	public int getNotUsedSecuritiesCount() {
		return notUsedSecurityPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NotUsedSecurityLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		notUsedSecurityLocalService = (NotUsedSecurityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotUsedSecurityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = notUsedSecurityPersistence.getDataSource();
	...
	protected NotUsedSecurityLocalService notUsedSecurityLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NotUsedSecurityLocalServiceBaseImpl.class);
