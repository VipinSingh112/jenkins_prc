...
import com.nbp.osi.insolvency.application.form.services.service.NotUsedSecurityService;
...
/**
 * Provides the base implementation for the not used security remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.NotUsedSecurityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.NotUsedSecurityServiceImpl
 * @generated
 */
public abstract class NotUsedSecurityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, NotUsedSecurityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NotUsedSecurityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.NotUsedSecurityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NotUsedSecurityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		notUsedSecurityService = (NotUsedSecurityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotUsedSecurityService.class.getName();
	}
	...
	protected NotUsedSecurityService notUsedSecurityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		NotUsedSecurityServiceBaseImpl.class);
