...
import com.nbp.osi.insolvency.application.form.services.service.SecuredCreditorService;
...
/**
 * Provides the base implementation for the secured creditor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.SecuredCreditorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.SecuredCreditorServiceImpl
 * @generated
 */
public abstract class SecuredCreditorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SecuredCreditorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SecuredCreditorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.SecuredCreditorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SecuredCreditorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		securedCreditorService = (SecuredCreditorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SecuredCreditorService.class.getName();
	}
	...
	protected SecuredCreditorService securedCreditorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SecuredCreditorServiceBaseImpl.class);
