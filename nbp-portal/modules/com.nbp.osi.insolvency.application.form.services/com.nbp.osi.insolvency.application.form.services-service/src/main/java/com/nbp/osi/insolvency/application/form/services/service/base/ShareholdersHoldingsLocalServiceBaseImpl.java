...
import com.nbp.osi.insolvency.application.form.services.service.ShareholdersHoldingsLocalService;
...
/**
 * Provides the base implementation for the shareholders holdings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.ShareholdersHoldingsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.ShareholdersHoldingsLocalServiceImpl
 * @generated
 */
public abstract class ShareholdersHoldingsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ShareholdersHoldingsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.ShareholdersHoldingsLocalServiceUtil</code>.
	 */
	...
	@Override
	public ShareholdersHoldings addShareholdersHoldings(
		ShareholdersHoldings shareholdersHoldings) {

		shareholdersHoldings.setNew(true);

		return shareholdersHoldingsPersistence.update(shareholdersHoldings);
	}
	...
	public ShareholdersHoldings createShareholdersHoldings(
		long shareholdersHoldingsId) {

		return shareholdersHoldingsPersistence.create(shareholdersHoldingsId);
	}
	...
	@Override
	public ShareholdersHoldings deleteShareholdersHoldings(
			long shareholdersHoldingsId)
		throws PortalException {

		return shareholdersHoldingsPersistence.remove(shareholdersHoldingsId);
	}
	...
	public ShareholdersHoldings deleteShareholdersHoldings(
		...
		return shareholdersHoldingsPersistence.remove(shareholdersHoldings);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return shareholdersHoldingsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ShareholdersHoldings.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return shareholdersHoldingsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return shareholdersHoldingsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ShareholdersHoldings fetchShareholdersHoldings(
		long shareholdersHoldingsId) {

		return shareholdersHoldingsPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public ShareholdersHoldings getShareholdersHoldings(
			long shareholdersHoldingsId)
		throws PortalException {

		return shareholdersHoldingsPersistence.findByPrimaryKey(
			shareholdersHoldingsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ShareholdersHoldings.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return shareholdersHoldingsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ShareholdersHoldingsLocalServiceImpl#deleteShareholdersHoldings(ShareholdersHoldings) to avoid orphaned data");
		}

		return shareholdersHoldingsLocalService.deleteShareholdersHoldings(
			(ShareholdersHoldings)persistedModel);
	}

	@Override
	public BasePersistence<ShareholdersHoldings> getBasePersistence() {
		return shareholdersHoldingsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return shareholdersHoldingsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ShareholdersHoldings> getShareholdersHoldingses(
		int start, int end) {

		return shareholdersHoldingsPersistence.findAll(start, end);
	}
	...
	public int getShareholdersHoldingsesCount() {
		return shareholdersHoldingsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ShareholdersHoldings updateShareholdersHoldings(
		ShareholdersHoldings shareholdersHoldings) {
	...
	public void setAopProxy(Object aopProxy) {
		shareholdersHoldingsLocalService =
			(ShareholdersHoldingsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ShareholdersHoldingsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				shareholdersHoldingsPersistence.getDataSource();
	...
	protected ShareholdersHoldingsLocalService shareholdersHoldingsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ShareholdersHoldingsLocalServiceBaseImpl.class);
