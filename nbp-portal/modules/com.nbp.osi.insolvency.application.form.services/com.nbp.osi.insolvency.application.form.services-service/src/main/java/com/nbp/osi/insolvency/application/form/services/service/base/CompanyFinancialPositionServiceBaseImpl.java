...
import com.nbp.osi.insolvency.application.form.services.service.CompanyFinancialPositionService;
...
/**
 * Provides the base implementation for the company financial position remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanyFinancialPositionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanyFinancialPositionServiceImpl
 * @generated
 */
public abstract class CompanyFinancialPositionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanyFinancialPositionService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyFinancialPositionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanyFinancialPositionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyFinancialPositionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companyFinancialPositionService =
			(CompanyFinancialPositionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyFinancialPositionService.class.getName();
	}
	...
	protected CompanyFinancialPositionService companyFinancialPositionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanyFinancialPositionServiceBaseImpl.class);
