...
import com.nbp.osi.insolvency.application.form.services.service.AssetsNotUsedAsSecurityService;
...
/**
 * Provides the base implementation for the assets not used as security remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.AssetsNotUsedAsSecurityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.AssetsNotUsedAsSecurityServiceImpl
 * @generated
 */
public abstract class AssetsNotUsedAsSecurityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AssetsNotUsedAsSecurityService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssetsNotUsedAsSecurityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.AssetsNotUsedAsSecurityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AssetsNotUsedAsSecurityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		assetsNotUsedAsSecurityService =
			(AssetsNotUsedAsSecurityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetsNotUsedAsSecurityService.class.getName();
	}
	...
	protected com.nbp.osi.insolvency.application.form.services.service.
		AssetsNotUsedAsSecurityLocalService assetsNotUsedAsSecurityLocalService;

	protected AssetsNotUsedAsSecurityService assetsNotUsedAsSecurityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssetsNotUsedAsSecurityServiceBaseImpl.class);
