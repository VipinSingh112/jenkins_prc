...
import com.nbp.osi.insolvency.application.form.services.service.VerificationCompanyInfoService;
...
/**
 * Provides the base implementation for the verification company info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoServiceImpl
 * @generated
 */
public abstract class VerificationCompanyInfoServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VerificationCompanyInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.VerificationCompanyInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VerificationCompanyInfoService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		verificationCompanyInfoService =
			(VerificationCompanyInfoService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return VerificationCompanyInfoService.class.getName();
	}
	...
	protected com.nbp.osi.insolvency.application.form.services.service.
		VerificationCompanyInfoLocalService verificationCompanyInfoLocalService;

	protected VerificationCompanyInfoService verificationCompanyInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VerificationCompanyInfoServiceBaseImpl.class);
