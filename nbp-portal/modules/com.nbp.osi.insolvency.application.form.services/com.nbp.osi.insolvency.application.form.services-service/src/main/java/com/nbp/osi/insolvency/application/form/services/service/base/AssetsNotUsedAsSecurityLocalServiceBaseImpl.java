...
import com.nbp.osi.insolvency.application.form.services.service.AssetsNotUsedAsSecurityLocalService;
...
/**
 * Provides the base implementation for the assets not used as security local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.AssetsNotUsedAsSecurityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.AssetsNotUsedAsSecurityLocalServiceImpl
 * @generated
 */
public abstract class AssetsNotUsedAsSecurityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AssetsNotUsedAsSecurityLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssetsNotUsedAsSecurityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.AssetsNotUsedAsSecurityLocalServiceUtil</code>.
	 */
	...
	@Override
	public AssetsNotUsedAsSecurity addAssetsNotUsedAsSecurity(
		AssetsNotUsedAsSecurity assetsNotUsedAsSecurity) {

		assetsNotUsedAsSecurity.setNew(true);

		return assetsNotUsedAsSecurityPersistence.update(
	...
	public AssetsNotUsedAsSecurity createAssetsNotUsedAsSecurity(
		long assetsNotUsedAsSecurityId) {

		return assetsNotUsedAsSecurityPersistence.create(
	...
	@Override
	public AssetsNotUsedAsSecurity deleteAssetsNotUsedAsSecurity(
			long assetsNotUsedAsSecurityId)
		throws PortalException {

		return assetsNotUsedAsSecurityPersistence.remove(
			assetsNotUsedAsSecurityId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return assetsNotUsedAsSecurityPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AssetsNotUsedAsSecurity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assetsNotUsedAsSecurityPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return assetsNotUsedAsSecurityPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AssetsNotUsedAsSecurity fetchAssetsNotUsedAsSecurity(
		long assetsNotUsedAsSecurityId) {

		return assetsNotUsedAsSecurityPersistence.fetchByPrimaryKey(
			assetsNotUsedAsSecurityId);
	}
	 ...
	 */
	@Override
	public AssetsNotUsedAsSecurity getAssetsNotUsedAsSecurity(
			long assetsNotUsedAsSecurityId)
		throws PortalException {

		return assetsNotUsedAsSecurityPersistence.findByPrimaryKey(
			assetsNotUsedAsSecurityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(AssetsNotUsedAsSecurity.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AssetsNotUsedAsSecurityLocalServiceImpl#deleteAssetsNotUsedAsSecurity(AssetsNotUsedAsSecurity) to avoid orphaned data");
		}

		return assetsNotUsedAsSecurityLocalService.
			deleteAssetsNotUsedAsSecurity(
				(AssetsNotUsedAsSecurity)persistedModel);
	}

	@Override
	public BasePersistence<AssetsNotUsedAsSecurity> getBasePersistence() {
		return assetsNotUsedAsSecurityPersistence;
	}
	 ...
	 */
	@Override
	public List<AssetsNotUsedAsSecurity> getAssetsNotUsedAsSecurities(
		int start, int end) {

		return assetsNotUsedAsSecurityPersistence.findAll(start, end);
	}
	...
	public int getAssetsNotUsedAsSecuritiesCount() {
		return assetsNotUsedAsSecurityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetsNotUsedAsSecurity updateAssetsNotUsedAsSecurity(
		AssetsNotUsedAsSecurity assetsNotUsedAsSecurity) {
	...
	public void setAopProxy(Object aopProxy) {
		assetsNotUsedAsSecurityLocalService =
			(AssetsNotUsedAsSecurityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetsNotUsedAsSecurityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				assetsNotUsedAsSecurityPersistence.getDataSource();
	...
	protected AssetsNotUsedAsSecurityLocalService
		assetsNotUsedAsSecurityLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssetsNotUsedAsSecurityLocalServiceBaseImpl.class);
