...
import com.nbp.osi.insolvency.application.form.services.service.ShareholdersHoldingsService;
...
/**
 * Provides the base implementation for the shareholders holdings remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.ShareholdersHoldingsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.ShareholdersHoldingsServiceImpl
 * @generated
 */
public abstract class ShareholdersHoldingsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ShareholdersHoldingsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.ShareholdersHoldingsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ShareholdersHoldingsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		shareholdersHoldingsService = (ShareholdersHoldingsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ShareholdersHoldingsService.class.getName();
	}
	...
	protected ShareholdersHoldingsService shareholdersHoldingsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ShareholdersHoldingsServiceBaseImpl.class);
