...
import com.nbp.osi.insolvency.application.form.services.service.MonthlyExpensesService;
...
/**
 * Provides the base implementation for the monthly expenses remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyExpensesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyExpensesServiceImpl
 * @generated
 */
public abstract class MonthlyExpensesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MonthlyExpensesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MonthlyExpensesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.MonthlyExpensesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MonthlyExpensesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		monthlyExpensesService = (MonthlyExpensesService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MonthlyExpensesService.class.getName();
	}
	...
	protected MonthlyExpensesService monthlyExpensesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MonthlyExpensesServiceBaseImpl.class);
