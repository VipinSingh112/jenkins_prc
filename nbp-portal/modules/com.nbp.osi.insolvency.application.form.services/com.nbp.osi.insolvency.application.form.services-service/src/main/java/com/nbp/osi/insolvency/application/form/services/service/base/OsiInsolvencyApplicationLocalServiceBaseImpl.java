...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationLocalService;
...
/**
 * Provides the base implementation for the osi insolvency application local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationLocalServiceImpl
 * @generated
 */
public abstract class OsiInsolvencyApplicationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvencyApplicationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationLocalServiceUtil</code>.
	 */
	...
	@Override
	public OsiInsolvencyApplication addOsiInsolvencyApplication(
		OsiInsolvencyApplication osiInsolvencyApplication) {

		osiInsolvencyApplication.setNew(true);

		return osiInsolvencyApplicationPersistence.update(
	...
	public OsiInsolvencyApplication createOsiInsolvencyApplication(
		long osiInsolvencyId) {

		return osiInsolvencyApplicationPersistence.create(osiInsolvencyId);
	}
	...
	@Override
	public OsiInsolvencyApplication deleteOsiInsolvencyApplication(
			long osiInsolvencyId)
		throws PortalException {

		return osiInsolvencyApplicationPersistence.remove(osiInsolvencyId);
	}
	...
	public OsiInsolvencyApplication deleteOsiInsolvencyApplication(
		...
		return osiInsolvencyApplicationPersistence.remove(
			osiInsolvencyApplication);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiInsolvencyApplicationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OsiInsolvencyApplication.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiInsolvencyApplicationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiInsolvencyApplicationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OsiInsolvencyApplication fetchOsiInsolvencyApplication(
		long osiInsolvencyId) {

		return osiInsolvencyApplicationPersistence.fetchByPrimaryKey(
			osiInsolvencyId);
	}
	 ...
	 */
	@Override
	public OsiInsolvencyApplication getOsiInsolvencyApplication(
			long osiInsolvencyId)
		throws PortalException {

		return osiInsolvencyApplicationPersistence.findByPrimaryKey(
			osiInsolvencyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OsiInsolvencyApplication.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("osiInsolvencyId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			OsiInsolvencyApplication.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return osiInsolvencyApplicationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OsiInsolvencyApplicationLocalServiceImpl#deleteOsiInsolvencyApplication(OsiInsolvencyApplication) to avoid orphaned data");
		}

		return osiInsolvencyApplicationLocalService.
			deleteOsiInsolvencyApplication(
				(OsiInsolvencyApplication)persistedModel);
	}

	@Override
	public BasePersistence<OsiInsolvencyApplication> getBasePersistence() {
		return osiInsolvencyApplicationPersistence;
	}
	 ...
	 */
	@Override
	public List<OsiInsolvencyApplication> getOsiInsolvencyApplications(
		int start, int end) {

		return osiInsolvencyApplicationPersistence.findAll(start, end);
	}
	...
	public int getOsiInsolvencyApplicationsCount() {
		return osiInsolvencyApplicationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OsiInsolvencyApplication updateOsiInsolvencyApplication(
		OsiInsolvencyApplication osiInsolvencyApplication) {
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolvencyApplicationLocalService =
			(OsiInsolvencyApplicationLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvencyApplicationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				osiInsolvencyApplicationPersistence.getDataSource();
	...
	protected OsiInsolvencyApplicationLocalService
		osiInsolvencyApplicationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvencyApplicationLocalServiceBaseImpl.class);
