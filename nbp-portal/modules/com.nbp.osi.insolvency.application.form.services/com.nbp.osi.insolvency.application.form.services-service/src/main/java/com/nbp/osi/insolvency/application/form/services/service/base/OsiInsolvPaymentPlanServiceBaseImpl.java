...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvPaymentPlanService;
...
/**
 * Provides the base implementation for the osi insolv payment plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvPaymentPlanServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvPaymentPlanServiceImpl
 * @generated
 */
public abstract class OsiInsolvPaymentPlanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiInsolvPaymentPlanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvPaymentPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvPaymentPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiInsolvPaymentPlanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiInsolvPaymentPlanService = (OsiInsolvPaymentPlanService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvPaymentPlanService.class.getName();
	}
	...
	protected OsiInsolvPaymentPlanService osiInsolvPaymentPlanService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvPaymentPlanServiceBaseImpl.class);
