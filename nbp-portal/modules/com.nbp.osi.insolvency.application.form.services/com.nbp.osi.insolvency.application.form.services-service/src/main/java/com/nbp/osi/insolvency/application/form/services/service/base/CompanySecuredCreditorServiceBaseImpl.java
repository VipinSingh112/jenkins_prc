...
import com.nbp.osi.insolvency.application.form.services.service.CompanySecuredCreditorService;
...
/**
 * Provides the base implementation for the company secured creditor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecuredCreditorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecuredCreditorServiceImpl
 * @generated
 */
public abstract class CompanySecuredCreditorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanySecuredCreditorService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanySecuredCreditorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanySecuredCreditorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanySecuredCreditorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companySecuredCreditorService = (CompanySecuredCreditorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanySecuredCreditorService.class.getName();
	}
	...
	protected CompanySecuredCreditorService companySecuredCreditorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanySecuredCreditorServiceBaseImpl.class);
