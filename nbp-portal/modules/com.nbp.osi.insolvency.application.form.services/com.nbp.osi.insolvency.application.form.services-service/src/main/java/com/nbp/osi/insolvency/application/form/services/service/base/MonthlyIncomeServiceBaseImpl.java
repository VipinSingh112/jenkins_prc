...
import com.nbp.osi.insolvency.application.form.services.service.MonthlyIncomeService;
...
/**
 * Provides the base implementation for the monthly income remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyIncomeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyIncomeServiceImpl
 * @generated
 */
public abstract class MonthlyIncomeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MonthlyIncomeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MonthlyIncomeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.MonthlyIncomeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MonthlyIncomeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		monthlyIncomeService = (MonthlyIncomeService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return MonthlyIncomeService.class.getName();
	}
	...
	protected MonthlyIncomeService monthlyIncomeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		MonthlyIncomeServiceBaseImpl.class);
