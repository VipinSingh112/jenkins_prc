...
import com.nbp.osi.insolvency.application.form.services.service.CompanyDetailsService;
...
/**
 * Provides the base implementation for the company details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanyDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanyDetailsServiceImpl
 * @generated
 */
public abstract class CompanyDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanyDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanyDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companyDetailsService = (CompanyDetailsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyDetailsService.class.getName();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanyDetailsServiceBaseImpl.class);
