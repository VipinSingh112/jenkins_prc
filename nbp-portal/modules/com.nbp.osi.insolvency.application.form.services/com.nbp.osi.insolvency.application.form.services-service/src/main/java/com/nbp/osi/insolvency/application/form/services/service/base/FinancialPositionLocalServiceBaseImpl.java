...
import com.nbp.osi.insolvency.application.form.services.service.FinancialPositionLocalService;
...
/**
 * Provides the base implementation for the financial position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.FinancialPositionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.FinancialPositionLocalServiceImpl
 * @generated
 */
public abstract class FinancialPositionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FinancialPositionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FinancialPositionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.FinancialPositionLocalServiceUtil</code>.
	 */
	...
	public FinancialPosition addFinancialPosition(
		...
		return financialPositionPersistence.update(financialPosition);
	}
	...
	public FinancialPosition createFinancialPosition(long financialPositionId) {
		return financialPositionPersistence.create(financialPositionId);
	}
	...
	public FinancialPosition deleteFinancialPosition(long financialPositionId)
		...
		return financialPositionPersistence.remove(financialPositionId);
	}
	...
	public FinancialPosition deleteFinancialPosition(
		...
		return financialPositionPersistence.remove(financialPosition);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return financialPositionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FinancialPosition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return financialPositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return financialPositionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return financialPositionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return financialPositionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FinancialPosition fetchFinancialPosition(long financialPositionId) {
		return financialPositionPersistence.fetchByPrimaryKey(
			financialPositionId);
	}
	...
	public FinancialPosition getFinancialPosition(long financialPositionId)
		...
		return financialPositionPersistence.findByPrimaryKey(
			financialPositionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			financialPositionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FinancialPosition.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("financialPositionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FinancialPosition.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return financialPositionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FinancialPositionLocalServiceImpl#deleteFinancialPosition(FinancialPosition) to avoid orphaned data");
		}

		return financialPositionLocalService.deleteFinancialPosition(
			(FinancialPosition)persistedModel);
	}

	@Override
	public BasePersistence<FinancialPosition> getBasePersistence() {
		return financialPositionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return financialPositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FinancialPosition> getFinancialPositions(int start, int end) {
		return financialPositionPersistence.findAll(start, end);
	}
	...
	public int getFinancialPositionsCount() {
		return financialPositionPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FinancialPositionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		financialPositionLocalService = (FinancialPositionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FinancialPositionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				financialPositionPersistence.getDataSource();
	...
	protected FinancialPositionLocalService financialPositionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FinancialPositionLocalServiceBaseImpl.class);
