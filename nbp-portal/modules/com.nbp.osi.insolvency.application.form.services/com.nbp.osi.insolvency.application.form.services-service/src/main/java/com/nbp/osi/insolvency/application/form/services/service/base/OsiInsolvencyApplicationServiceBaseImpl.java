...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationService;
...
/**
 * Provides the base implementation for the osi insolvency application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationServiceImpl
 * @generated
 */
public abstract class OsiInsolvencyApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiInsolvencyApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvencyApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiInsolvencyApplicationService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolvencyApplicationService =
			(OsiInsolvencyApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvencyApplicationService.class.getName();
	}
	...
	protected OsiInsolvencyApplicationService osiInsolvencyApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvencyApplicationServiceBaseImpl.class);
