...
import com.nbp.osi.insolvency.application.form.services.service.AssetsUsedAsSecurityLocalService;
...
/**
 * Provides the base implementation for the assets used as security local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.AssetsUsedAsSecurityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.AssetsUsedAsSecurityLocalServiceImpl
 * @generated
 */
public abstract class AssetsUsedAsSecurityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AssetsUsedAsSecurityLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssetsUsedAsSecurityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.AssetsUsedAsSecurityLocalServiceUtil</code>.
	 */
	...
	@Override
	public AssetsUsedAsSecurity addAssetsUsedAsSecurity(
		AssetsUsedAsSecurity assetsUsedAsSecurity) {

		assetsUsedAsSecurity.setNew(true);

		return assetsUsedAsSecurityPersistence.update(assetsUsedAsSecurity);
	}
	...
	public AssetsUsedAsSecurity createAssetsUsedAsSecurity(
		long assetsUsedAsSecurityId) {

		return assetsUsedAsSecurityPersistence.create(assetsUsedAsSecurityId);
	}
	...
	@Override
	public AssetsUsedAsSecurity deleteAssetsUsedAsSecurity(
			long assetsUsedAsSecurityId)
		throws PortalException {

		return assetsUsedAsSecurityPersistence.remove(assetsUsedAsSecurityId);
	}
	...
	public AssetsUsedAsSecurity deleteAssetsUsedAsSecurity(
		...
		return assetsUsedAsSecurityPersistence.remove(assetsUsedAsSecurity);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return assetsUsedAsSecurityPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AssetsUsedAsSecurity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return assetsUsedAsSecurityPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return assetsUsedAsSecurityPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public AssetsUsedAsSecurity fetchAssetsUsedAsSecurity(
		long assetsUsedAsSecurityId) {

		return assetsUsedAsSecurityPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public AssetsUsedAsSecurity getAssetsUsedAsSecurity(
			long assetsUsedAsSecurityId)
		throws PortalException {

		return assetsUsedAsSecurityPersistence.findByPrimaryKey(
			assetsUsedAsSecurityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			assetsUsedAsSecurityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AssetsUsedAsSecurity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return assetsUsedAsSecurityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AssetsUsedAsSecurityLocalServiceImpl#deleteAssetsUsedAsSecurity(AssetsUsedAsSecurity) to avoid orphaned data");
		}

		return assetsUsedAsSecurityLocalService.deleteAssetsUsedAsSecurity(
			(AssetsUsedAsSecurity)persistedModel);
	}

	@Override
	public BasePersistence<AssetsUsedAsSecurity> getBasePersistence() {
		return assetsUsedAsSecurityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return assetsUsedAsSecurityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AssetsUsedAsSecurity> getAssetsUsedAsSecurities(
		int start, int end) {

		return assetsUsedAsSecurityPersistence.findAll(start, end);
	}
	...
	public int getAssetsUsedAsSecuritiesCount() {
		return assetsUsedAsSecurityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public AssetsUsedAsSecurity updateAssetsUsedAsSecurity(
		AssetsUsedAsSecurity assetsUsedAsSecurity) {
	...
	public void setAopProxy(Object aopProxy) {
		assetsUsedAsSecurityLocalService =
			(AssetsUsedAsSecurityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetsUsedAsSecurityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				assetsUsedAsSecurityPersistence.getDataSource();
	...
	protected AssetsUsedAsSecurityLocalService assetsUsedAsSecurityLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssetsUsedAsSecurityLocalServiceBaseImpl.class);
