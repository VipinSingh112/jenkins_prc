...
import com.nbp.osi.insolvency.application.form.services.service.SecuredCreditorLocalService;
...
/**
 * Provides the base implementation for the secured creditor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.SecuredCreditorLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.SecuredCreditorLocalServiceImpl
 * @generated
 */
public abstract class SecuredCreditorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SecuredCreditorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SecuredCreditorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.SecuredCreditorLocalServiceUtil</code>.
	 */
	...
	@Override
	public SecuredCreditor addSecuredCreditor(SecuredCreditor securedCreditor) {
		securedCreditor.setNew(true);

		return securedCreditorPersistence.update(securedCreditor);
	}
	...
	public SecuredCreditor createSecuredCreditor(long securedCreditorId) {
		return securedCreditorPersistence.create(securedCreditorId);
	}
	...
	@Override
	public SecuredCreditor deleteSecuredCreditor(long securedCreditorId)
		throws PortalException {

		return securedCreditorPersistence.remove(securedCreditorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SecuredCreditor deleteSecuredCreditor(
		SecuredCreditor securedCreditor) {

		return securedCreditorPersistence.remove(securedCreditor);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return securedCreditorPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SecuredCreditor.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return securedCreditorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return securedCreditorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return securedCreditorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return securedCreditorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SecuredCreditor fetchSecuredCreditor(long securedCreditorId) {
		return securedCreditorPersistence.fetchByPrimaryKey(securedCreditorId);
	}
	 ...
	 */
	@Override
	public SecuredCreditor getSecuredCreditor(long securedCreditorId)
		throws PortalException {

		return securedCreditorPersistence.findByPrimaryKey(securedCreditorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(securedCreditorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SecuredCreditor.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("securedCreditorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SecuredCreditor.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return securedCreditorPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SecuredCreditorLocalServiceImpl#deleteSecuredCreditor(SecuredCreditor) to avoid orphaned data");
		}

		return securedCreditorLocalService.deleteSecuredCreditor(
			(SecuredCreditor)persistedModel);
	}

	@Override
	public BasePersistence<SecuredCreditor> getBasePersistence() {
		return securedCreditorPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return securedCreditorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SecuredCreditor> getSecuredCreditors(int start, int end) {
		return securedCreditorPersistence.findAll(start, end);
	}
	...
	public int getSecuredCreditorsCount() {
		return securedCreditorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SecuredCreditor updateSecuredCreditor(
		SecuredCreditor securedCreditor) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SecuredCreditorLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		securedCreditorLocalService = (SecuredCreditorLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SecuredCreditorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = securedCreditorPersistence.getDataSource();
	...
	protected SecuredCreditorLocalService securedCreditorLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SecuredCreditorLocalServiceBaseImpl.class);
