...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyCurrentStageLocalService;
...
/**
 * Provides the base implementation for the osi insolvency current stage local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyCurrentStageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyCurrentStageLocalServiceImpl
 * @generated
 */
public abstract class OsiInsolvencyCurrentStageLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvencyCurrentStageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyCurrentStageLocalServiceUtil</code>.
	 */
	...
	@Override
	public OsiInsolvencyCurrentStage addOsiInsolvencyCurrentStage(
		OsiInsolvencyCurrentStage osiInsolvencyCurrentStage) {

		osiInsolvencyCurrentStage.setNew(true);

		return osiInsolvencyCurrentStagePersistence.update(
	...
	public OsiInsolvencyCurrentStage createOsiInsolvencyCurrentStage(
		long osiInsolvencyCurrentStageId) {

		return osiInsolvencyCurrentStagePersistence.create(
	...
	@Override
	public OsiInsolvencyCurrentStage deleteOsiInsolvencyCurrentStage(
			long osiInsolvencyCurrentStageId)
		throws PortalException {

		return osiInsolvencyCurrentStagePersistence.remove(
			osiInsolvencyCurrentStageId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiInsolvencyCurrentStagePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OsiInsolvencyCurrentStage.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiInsolvencyCurrentStagePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiInsolvencyCurrentStagePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OsiInsolvencyCurrentStage fetchOsiInsolvencyCurrentStage(
		long osiInsolvencyCurrentStageId) {

		return osiInsolvencyCurrentStagePersistence.fetchByPrimaryKey(
			osiInsolvencyCurrentStageId);
	}
	 ...
	 */
	@Override
	public OsiInsolvencyCurrentStage getOsiInsolvencyCurrentStage(
			long osiInsolvencyCurrentStageId)
		throws PortalException {

		return osiInsolvencyCurrentStagePersistence.findByPrimaryKey(
			osiInsolvencyCurrentStageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OsiInsolvencyCurrentStage.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			OsiInsolvencyCurrentStage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OsiInsolvencyCurrentStageLocalServiceImpl#deleteOsiInsolvencyCurrentStage(OsiInsolvencyCurrentStage) to avoid orphaned data");
		}

		return osiInsolvencyCurrentStageLocalService.
			deleteOsiInsolvencyCurrentStage(
				(OsiInsolvencyCurrentStage)persistedModel);
	}

	@Override
	public BasePersistence<OsiInsolvencyCurrentStage> getBasePersistence() {
		return osiInsolvencyCurrentStagePersistence;
	}
	 ...
	 */
	@Override
	public List<OsiInsolvencyCurrentStage> getOsiInsolvencyCurrentStages(
		int start, int end) {

		return osiInsolvencyCurrentStagePersistence.findAll(start, end);
	}
	...
	public int getOsiInsolvencyCurrentStagesCount() {
		return osiInsolvencyCurrentStagePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OsiInsolvencyCurrentStage updateOsiInsolvencyCurrentStage(
		OsiInsolvencyCurrentStage osiInsolvencyCurrentStage) {
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolvencyCurrentStageLocalService =
			(OsiInsolvencyCurrentStageLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvencyCurrentStageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				osiInsolvencyCurrentStagePersistence.getDataSource();
	...
	protected OsiInsolvencyCurrentStageLocalService
		osiInsolvencyCurrentStageLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvencyCurrentStageLocalServiceBaseImpl.class);
