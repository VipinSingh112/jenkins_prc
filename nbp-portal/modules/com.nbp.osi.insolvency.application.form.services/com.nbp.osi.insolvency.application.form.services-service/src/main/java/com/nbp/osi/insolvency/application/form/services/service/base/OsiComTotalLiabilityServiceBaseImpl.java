...
import com.nbp.osi.insolvency.application.form.services.service.OsiComTotalLiabilityService;
...
/**
 * Provides the base implementation for the osi com total liability remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiComTotalLiabilityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiComTotalLiabilityServiceImpl
 * @generated
 */
public abstract class OsiComTotalLiabilityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   OsiComTotalLiabilityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiComTotalLiabilityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiComTotalLiabilityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiComTotalLiabilityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		osiComTotalLiabilityService = (OsiComTotalLiabilityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiComTotalLiabilityService.class.getName();
	}
	...
	protected OsiComTotalLiabilityService osiComTotalLiabilityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiComTotalLiabilityServiceBaseImpl.class);
