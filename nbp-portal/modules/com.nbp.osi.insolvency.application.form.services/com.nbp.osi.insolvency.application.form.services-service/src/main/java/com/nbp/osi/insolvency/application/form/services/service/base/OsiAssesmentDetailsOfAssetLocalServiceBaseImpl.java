...
import com.nbp.osi.insolvency.application.form.services.service.OsiAssesmentDetailsOfAssetLocalService;
...
/**
 * Provides the base implementation for the osi assesment details of asset local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiAssesmentDetailsOfAssetLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiAssesmentDetailsOfAssetLocalServiceImpl
 * @generated
 */
public abstract class OsiAssesmentDetailsOfAssetLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiAssesmentDetailsOfAssetLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiAssesmentDetailsOfAssetLocalServiceUtil</code>.
	 */
	...
	@Override
	public OsiAssesmentDetailsOfAsset addOsiAssesmentDetailsOfAsset(
		OsiAssesmentDetailsOfAsset osiAssesmentDetailsOfAsset) {

		osiAssesmentDetailsOfAsset.setNew(true);

		return osiAssesmentDetailsOfAssetPersistence.update(
	...
	public OsiAssesmentDetailsOfAsset createOsiAssesmentDetailsOfAsset(
		long osiAssetDetailsId) {

		return osiAssesmentDetailsOfAssetPersistence.create(osiAssetDetailsId);
	}
	...
	@Override
	public OsiAssesmentDetailsOfAsset deleteOsiAssesmentDetailsOfAsset(
			long osiAssetDetailsId)
		throws PortalException {

		return osiAssesmentDetailsOfAssetPersistence.remove(osiAssetDetailsId);
	}
	...
	public OsiAssesmentDetailsOfAsset deleteOsiAssesmentDetailsOfAsset(
		...
		return osiAssesmentDetailsOfAssetPersistence.remove(
			osiAssesmentDetailsOfAsset);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiAssesmentDetailsOfAssetPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OsiAssesmentDetailsOfAsset.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiAssesmentDetailsOfAssetPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiAssesmentDetailsOfAssetPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OsiAssesmentDetailsOfAsset fetchOsiAssesmentDetailsOfAsset(
		long osiAssetDetailsId) {

		return osiAssesmentDetailsOfAssetPersistence.fetchByPrimaryKey(
			osiAssetDetailsId);
	}
	 ...
	 */
	@Override
	public OsiAssesmentDetailsOfAsset getOsiAssesmentDetailsOfAsset(
			long osiAssetDetailsId)
		throws PortalException {

		return osiAssesmentDetailsOfAssetPersistence.findByPrimaryKey(
			osiAssetDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(OsiAssesmentDetailsOfAsset.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("osiAssetDetailsId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			OsiAssesmentDetailsOfAsset.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return osiAssesmentDetailsOfAssetPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OsiAssesmentDetailsOfAssetLocalServiceImpl#deleteOsiAssesmentDetailsOfAsset(OsiAssesmentDetailsOfAsset) to avoid orphaned data");
		}

		return osiAssesmentDetailsOfAssetLocalService.
			deleteOsiAssesmentDetailsOfAsset(
				(OsiAssesmentDetailsOfAsset)persistedModel);
	}

	@Override
	public BasePersistence<OsiAssesmentDetailsOfAsset> getBasePersistence() {
		return osiAssesmentDetailsOfAssetPersistence;
	}
	 ...
	 */
	@Override
	public List<OsiAssesmentDetailsOfAsset> getOsiAssesmentDetailsOfAssets(
		int start, int end) {

		return osiAssesmentDetailsOfAssetPersistence.findAll(start, end);
	}
	...
	public int getOsiAssesmentDetailsOfAssetsCount() {
		return osiAssesmentDetailsOfAssetPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OsiAssesmentDetailsOfAsset updateOsiAssesmentDetailsOfAsset(
		OsiAssesmentDetailsOfAsset osiAssesmentDetailsOfAsset) {
	...
	public void setAopProxy(Object aopProxy) {
		osiAssesmentDetailsOfAssetLocalService =
			(OsiAssesmentDetailsOfAssetLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiAssesmentDetailsOfAssetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				osiAssesmentDetailsOfAssetPersistence.getDataSource();
	...
	protected OsiAssesmentDetailsOfAssetLocalService
		osiAssesmentDetailsOfAssetLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiAssesmentDetailsOfAssetLocalServiceBaseImpl.class);
