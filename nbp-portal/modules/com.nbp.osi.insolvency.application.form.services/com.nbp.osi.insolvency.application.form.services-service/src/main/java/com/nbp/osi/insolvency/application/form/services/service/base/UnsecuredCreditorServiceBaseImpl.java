...
import com.nbp.osi.insolvency.application.form.services.service.UnsecuredCreditorService;
...
/**
 * Provides the base implementation for the unsecured creditor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.UnsecuredCreditorServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.UnsecuredCreditorServiceImpl
 * @generated
 */
public abstract class UnsecuredCreditorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, UnsecuredCreditorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UnsecuredCreditorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.UnsecuredCreditorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UnsecuredCreditorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		unsecuredCreditorService = (UnsecuredCreditorService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UnsecuredCreditorService.class.getName();
	}
	...
	protected UnsecuredCreditorService unsecuredCreditorService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UnsecuredCreditorServiceBaseImpl.class);
