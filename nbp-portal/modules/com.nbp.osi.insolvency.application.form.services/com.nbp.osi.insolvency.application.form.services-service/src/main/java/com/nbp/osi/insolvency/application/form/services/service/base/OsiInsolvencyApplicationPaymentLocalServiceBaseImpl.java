...
import com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationPaymentLocalService;
...
/**
 * Provides the base implementation for the osi insolvency application payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationPaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationPaymentLocalServiceImpl
 * @generated
 */
public abstract class OsiInsolvencyApplicationPaymentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OsiInsolvencyApplicationPaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.OsiInsolvencyApplicationPaymentLocalServiceUtil</code>.
	 */
	...
	@Override
	public OsiInsolvencyApplicationPayment addOsiInsolvencyApplicationPayment(
		OsiInsolvencyApplicationPayment osiInsolvencyApplicationPayment) {

		osiInsolvencyApplicationPayment.setNew(true);

		return osiInsolvencyApplicationPaymentPersistence.update(
	...
	public OsiInsolvencyApplicationPayment
		createOsiInsolvencyApplicationPayment(
			long osiInsolveApplicationPaymentId) {

		return osiInsolvencyApplicationPaymentPersistence.create(
	...
	public OsiInsolvencyApplicationPayment
		...
		return osiInsolvencyApplicationPaymentPersistence.remove(
			osiInsolveApplicationPaymentId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return osiInsolvencyApplicationPaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OsiInsolvencyApplicationPayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return osiInsolvencyApplicationPaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return osiInsolvencyApplicationPaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public OsiInsolvencyApplicationPayment fetchOsiInsolvencyApplicationPayment(
		long osiInsolveApplicationPaymentId) {

		return osiInsolvencyApplicationPaymentPersistence.fetchByPrimaryKey(
			osiInsolveApplicationPaymentId);
	}
	 ...
	 */
	@Override
	public OsiInsolvencyApplicationPayment getOsiInsolvencyApplicationPayment(
			long osiInsolveApplicationPaymentId)
		throws NoSuchOsiInsolvencyApplicationPaymentException, PortalException {

		return osiInsolvencyApplicationPaymentPersistence.findByPrimaryKey(
			osiInsolveApplicationPaymentId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OsiInsolvencyApplicationPaymentLocalServiceImpl#deleteOsiInsolvencyApplicationPayment(OsiInsolvencyApplicationPayment) to avoid orphaned data");
		}

		return osiInsolvencyApplicationPaymentLocalService.
			deleteOsiInsolvencyApplicationPayment(
				(OsiInsolvencyApplicationPayment)persistedModel);
	}

	@Override
	public BasePersistence<OsiInsolvencyApplicationPayment>
		getBasePersistence() {

		return osiInsolvencyApplicationPaymentPersistence;
	}
	 ...
	 */
	@Override
	public List<OsiInsolvencyApplicationPayment>
		getOsiInsolvencyApplicationPayments(int start, int end) {

		return osiInsolvencyApplicationPaymentPersistence.findAll(start, end);
	}
	...
	public int getOsiInsolvencyApplicationPaymentsCount() {
		return osiInsolvencyApplicationPaymentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OsiInsolvencyApplicationPaymentLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		osiInsolvencyApplicationPaymentLocalService =
			(OsiInsolvencyApplicationPaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return OsiInsolvencyApplicationPaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				osiInsolvencyApplicationPaymentPersistence.getDataSource();
	...
	protected OsiInsolvencyApplicationPaymentLocalService
		osiInsolvencyApplicationPaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OsiInsolvencyApplicationPaymentLocalServiceBaseImpl.class);
