...
import com.nbp.osi.insolvency.application.form.services.service.CompanyTotalLiabilityService;
...
/**
 * Provides the base implementation for the company total liability remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanyTotalLiabilityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanyTotalLiabilityServiceImpl
 * @generated
 */
public abstract class CompanyTotalLiabilityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanyTotalLiabilityService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyTotalLiabilityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanyTotalLiabilityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyTotalLiabilityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companyTotalLiabilityService = (CompanyTotalLiabilityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyTotalLiabilityService.class.getName();
	}
	...
	protected CompanyTotalLiabilityService companyTotalLiabilityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanyTotalLiabilityServiceBaseImpl.class);
