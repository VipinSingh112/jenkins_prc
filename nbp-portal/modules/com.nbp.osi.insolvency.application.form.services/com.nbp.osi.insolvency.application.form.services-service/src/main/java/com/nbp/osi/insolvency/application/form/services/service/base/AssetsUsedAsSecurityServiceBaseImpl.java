...
import com.nbp.osi.insolvency.application.form.services.service.AssetsUsedAsSecurityService;
...
/**
 * Provides the base implementation for the assets used as security remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.AssetsUsedAsSecurityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.AssetsUsedAsSecurityServiceImpl
 * @generated
 */
public abstract class AssetsUsedAsSecurityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, AssetsUsedAsSecurityService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AssetsUsedAsSecurityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.AssetsUsedAsSecurityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AssetsUsedAsSecurityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		assetsUsedAsSecurityService = (AssetsUsedAsSecurityService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AssetsUsedAsSecurityService.class.getName();
	}
	...
	protected AssetsUsedAsSecurityService assetsUsedAsSecurityService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AssetsUsedAsSecurityServiceBaseImpl.class);
