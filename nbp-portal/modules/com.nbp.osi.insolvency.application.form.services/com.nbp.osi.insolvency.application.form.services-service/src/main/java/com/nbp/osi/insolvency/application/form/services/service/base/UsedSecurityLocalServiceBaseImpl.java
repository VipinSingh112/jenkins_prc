...
import com.nbp.osi.insolvency.application.form.services.service.UsedSecurityLocalService;
...
/**
 * Provides the base implementation for the used security local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.UsedSecurityLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.UsedSecurityLocalServiceImpl
 * @generated
 */
public abstract class UsedSecurityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, UsedSecurityLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UsedSecurityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.UsedSecurityLocalServiceUtil</code>.
	 */
	...
	public UsedSecurity addUsedSecurity(UsedSecurity usedSecurity) {
		...
		return usedSecurityPersistence.update(usedSecurity);
	}
	...
	public UsedSecurity createUsedSecurity(long usedSecurityId) {
		return usedSecurityPersistence.create(usedSecurityId);
	}
	...
	public UsedSecurity deleteUsedSecurity(long usedSecurityId)
		...
		return usedSecurityPersistence.remove(usedSecurityId);
	}
	...
	public UsedSecurity deleteUsedSecurity(UsedSecurity usedSecurity) {
		return usedSecurityPersistence.remove(usedSecurity);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return usedSecurityPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			UsedSecurity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return usedSecurityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return usedSecurityPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return usedSecurityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return usedSecurityPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public UsedSecurity fetchUsedSecurity(long usedSecurityId) {
		return usedSecurityPersistence.fetchByPrimaryKey(usedSecurityId);
	}
	...
	public UsedSecurity getUsedSecurity(long usedSecurityId)
		...
		return usedSecurityPersistence.findByPrimaryKey(usedSecurityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(usedSecurityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UsedSecurity.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("usedSecurityId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			usedSecurityLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UsedSecurity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return usedSecurityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement UsedSecurityLocalServiceImpl#deleteUsedSecurity(UsedSecurity) to avoid orphaned data");
		}

		return usedSecurityLocalService.deleteUsedSecurity(
			(UsedSecurity)persistedModel);
	}

	@Override
	public BasePersistence<UsedSecurity> getBasePersistence() {
		return usedSecurityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return usedSecurityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<UsedSecurity> getUsedSecurities(int start, int end) {
		return usedSecurityPersistence.findAll(start, end);
	}
	...
	public int getUsedSecuritiesCount() {
		return usedSecurityPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UsedSecurityLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		usedSecurityLocalService = (UsedSecurityLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return UsedSecurityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = usedSecurityPersistence.getDataSource();
	...
	protected UsedSecurityLocalService usedSecurityLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UsedSecurityLocalServiceBaseImpl.class);
