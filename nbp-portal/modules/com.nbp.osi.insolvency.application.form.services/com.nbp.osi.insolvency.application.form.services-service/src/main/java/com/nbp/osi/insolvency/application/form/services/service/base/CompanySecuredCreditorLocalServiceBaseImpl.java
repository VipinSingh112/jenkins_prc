...
import com.nbp.osi.insolvency.application.form.services.service.CompanySecuredCreditorLocalService;
...
/**
 * Provides the base implementation for the company secured creditor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecuredCreditorLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecuredCreditorLocalServiceImpl
 * @generated
 */
public abstract class CompanySecuredCreditorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CompanySecuredCreditorLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanySecuredCreditorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.osi.insolvency.application.form.services.service.CompanySecuredCreditorLocalServiceUtil</code>.
	 */
	...
	@Override
	public CompanySecuredCreditor addCompanySecuredCreditor(
		CompanySecuredCreditor companySecuredCreditor) {

		companySecuredCreditor.setNew(true);

		return companySecuredCreditorPersistence.update(companySecuredCreditor);
	}
	...
	public CompanySecuredCreditor createCompanySecuredCreditor(
		long companySecuredCreditorId) {

		return companySecuredCreditorPersistence.create(
	...
	@Override
	public CompanySecuredCreditor deleteCompanySecuredCreditor(
			long companySecuredCreditorId)
		throws PortalException {

		return companySecuredCreditorPersistence.remove(
			companySecuredCreditorId);
	}
	...
	public CompanySecuredCreditor deleteCompanySecuredCreditor(
		...
		return companySecuredCreditorPersistence.remove(companySecuredCreditor);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return companySecuredCreditorPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CompanySecuredCreditor.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return companySecuredCreditorPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return companySecuredCreditorPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public CompanySecuredCreditor fetchCompanySecuredCreditor(
		long companySecuredCreditorId) {

		return companySecuredCreditorPersistence.fetchByPrimaryKey(
			companySecuredCreditorId);
	}
	 ...
	 */
	@Override
	public CompanySecuredCreditor getCompanySecuredCreditor(
			long companySecuredCreditorId)
		throws PortalException {

		return companySecuredCreditorPersistence.findByPrimaryKey(
			companySecuredCreditorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(CompanySecuredCreditor.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CompanySecuredCreditorLocalServiceImpl#deleteCompanySecuredCreditor(CompanySecuredCreditor) to avoid orphaned data");
		}

		return companySecuredCreditorLocalService.deleteCompanySecuredCreditor(
			(CompanySecuredCreditor)persistedModel);
	}

	@Override
	public BasePersistence<CompanySecuredCreditor> getBasePersistence() {
		return companySecuredCreditorPersistence;
	}
	 ...
	 */
	@Override
	public List<CompanySecuredCreditor> getCompanySecuredCreditors(
		int start, int end) {

		return companySecuredCreditorPersistence.findAll(start, end);
	}
	...
	public int getCompanySecuredCreditorsCount() {
		return companySecuredCreditorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CompanySecuredCreditor updateCompanySecuredCreditor(
		CompanySecuredCreditor companySecuredCreditor) {
	...
	public void setAopProxy(Object aopProxy) {
		companySecuredCreditorLocalService =
			(CompanySecuredCreditorLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanySecuredCreditorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				companySecuredCreditorPersistence.getDataSource();
	...
	protected CompanySecuredCreditorLocalService
		companySecuredCreditorLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompanySecuredCreditorLocalServiceBaseImpl.class);
