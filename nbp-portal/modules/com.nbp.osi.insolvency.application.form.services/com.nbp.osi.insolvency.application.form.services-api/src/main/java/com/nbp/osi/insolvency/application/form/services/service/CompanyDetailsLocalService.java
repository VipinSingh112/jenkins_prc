...
/**
 * Provides the local service interface for CompanyDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CompanyDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CompanyDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the company details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CompanyDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CompanyDetails createCompanyDetails(long companyDetailsId);
	...
	public CompanyDetails deleteCompanyDetails(CompanyDetails companyDetails);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public CompanyDetails deleteCompanyDetails(long companyDetailsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompanyDetails fetchCompanyDetails(long companyDetailsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompanyDetails getCompanyDetails(long companyDetailsId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CompanyDetails> getCompanyDetailses(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompanyDetails getOsiInsolvencyById(long osiInsolvencyId)
