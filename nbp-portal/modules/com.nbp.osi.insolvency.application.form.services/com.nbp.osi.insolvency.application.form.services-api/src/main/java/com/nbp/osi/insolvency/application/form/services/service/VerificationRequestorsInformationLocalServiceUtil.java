...
/**
 * Provides the local service utility for VerificationRequestorsInformation. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationRequestorsInformationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class VerificationRequestorsInformationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationRequestorsInformationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static VerificationRequestorsInformation
		addVerificationRequestorsInformation(
			VerificationRequestorsInformation
				verificationRequestorsInformation) {

		return getService().addVerificationRequestorsInformation(
			verificationRequestorsInformation);
	}
	...
	public static VerificationRequestorsInformation
		...
		return getService().createVerificationRequestorsInformation(
			verificationRequestorsInformationPK);
	}
	...
	public static VerificationRequestorsInformation
		...
		return getService().deleteVerificationRequestorsInformation(
			verificationRequestorsInformation);
	}
	...
	public static VerificationRequestorsInformation
		...
		return getService().fetchVerificationRequestorsInformation(
			verificationRequestorsInformationPK);
	}
	...
	public static VerificationRequestorsInformation
		...
		return getService().getVerificationRequestorsInformation(
			verificationRequestorsInformationPK);
	}
	 ...
	 */
	public static List<VerificationRequestorsInformation>
		getVerificationRequestorsInformations(int start, int end) {

		return getService().getVerificationRequestorsInformations(start, end);
	}
	 ...
	 */
	public static int getVerificationRequestorsInformationsCount() {
		return getService().getVerificationRequestorsInformationsCount();
	}
	...
	public static VerificationRequestorsInformation
		...
		return getService().updateVerificationRequestorsInformation(
			verificationRequestorsInformation);
	}

	public static VerificationRequestorsInformationLocalService getService() {
		return _service;
	}

	private static volatile VerificationRequestorsInformationLocalService
		_service;
