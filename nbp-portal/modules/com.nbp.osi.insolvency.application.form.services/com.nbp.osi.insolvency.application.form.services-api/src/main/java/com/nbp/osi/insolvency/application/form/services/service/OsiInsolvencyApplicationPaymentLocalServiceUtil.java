...
/**
 * Provides the local service utility for OsiInsolvencyApplicationPayment. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationPaymentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OsiInsolvencyApplicationPaymentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationPaymentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OsiInsolvencyApplicationPayment
		addOsiInsolvencyApplicationPayment(
			OsiInsolvencyApplicationPayment osiInsolvencyApplicationPayment) {

		return getService().addOsiInsolvencyApplicationPayment(
	...
	public static OsiInsolvencyApplicationPayment
		...
		return getService().createOsiInsolvencyApplicationPayment(
	...
	public static OsiInsolvencyApplicationPayment
		...
		return getService().deleteOsiInsolvencyApplicationPayment(
			osiInsolveApplicationPaymentId);
	}
	...
	public static OsiInsolvencyApplicationPayment
		...
		return getService().fetchOsiInsolvencyApplicationPayment(
			osiInsolveApplicationPaymentId);
	}
	 ...
	 */
	public static OsiInsolvencyApplicationPayment
			getOsiInsolvencyApplicationPayment(
				long osiInsolveApplicationPaymentId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchOsiInsolvencyApplicationPaymentException,
			   PortalException {

		return getService().getOsiInsolvencyApplicationPayment(
			osiInsolveApplicationPaymentId);
	}
	 ...
	 */
	public static List<OsiInsolvencyApplicationPayment>
		getOsiInsolvencyApplicationPayments(int start, int end) {

		return getService().getOsiInsolvencyApplicationPayments(start, end);
	}
	 ...
	 */
	public static int getOsiInsolvencyApplicationPaymentsCount() {
		return getService().getOsiInsolvencyApplicationPaymentsCount();
	}
	...
	public static OsiInsolvencyApplicationPayment
		...
		return getService().updateOsiInsolvencyApplicationPayment(
			osiInsolvencyApplicationPayment);
	}

	public static OsiInsolvencyApplicationPaymentLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OsiInsolvencyApplicationPaymentLocalService>
		_serviceSnapshot = new Snapshot<>(
			OsiInsolvencyApplicationPaymentLocalServiceUtil.class,
