 ...
 * @see OsiInsolvencyApplicationPaymentPersistence
 * @generated
 */
public class OsiInsolvencyApplicationPaymentUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(osiInsolvencyApplicationPayment);
	}
	 ...
	 */
	public static Map<Serializable, OsiInsolvencyApplicationPayment>
	 ...
	 */
	public static List<OsiInsolvencyApplicationPayment> findWithDynamicQuery(
	 ...
	 */
	public static OsiInsolvencyApplicationPayment update(
		OsiInsolvencyApplicationPayment osiInsolvencyApplicationPayment) {

		return getPersistence().update(osiInsolvencyApplicationPayment);
	}
	...
	public static OsiInsolvencyApplicationPayment update(
		...
		return getPersistence().update(
			osiInsolvencyApplicationPayment, serviceContext);
	}
	 ...
	 */
	public static OsiInsolvencyApplicationPayment findBygetOIP_OII(
	 ...
	 */
	public static OsiInsolvencyApplicationPayment fetchBygetOIP_OII(
		long osiInsolvencyId) {
	 ...
	 */
	public static OsiInsolvencyApplicationPayment removeBygetOIP_OII(
			long osiInsolvencyId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchOsiInsolvencyApplicationPaymentException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(osiInsolvencyApplicationPayment);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(osiInsolvencyApplicationPayments);
	}
	 ...
	 */
	public static OsiInsolvencyApplicationPayment create(
		long osiInsolveApplicationPaymentId) {

		return getPersistence().create(osiInsolveApplicationPaymentId);
	}
	 ...
	 */
	public static OsiInsolvencyApplicationPayment remove(
			long osiInsolveApplicationPaymentId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchOsiInsolvencyApplicationPaymentException {

		return getPersistence().remove(osiInsolveApplicationPaymentId);
	}

	public static OsiInsolvencyApplicationPayment updateImpl(
		OsiInsolvencyApplicationPayment osiInsolvencyApplicationPayment) {

		return getPersistence().updateImpl(osiInsolvencyApplicationPayment);
	}
	 ...
	 * @throws NoSuchOsiInsolvencyApplicationPaymentException if a osi insolvency application payment with the primary key could not be found
	 */
	public static OsiInsolvencyApplicationPayment findByPrimaryKey(
			long osiInsolveApplicationPaymentId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchOsiInsolvencyApplicationPaymentException {
	 ...
	 */
	public static OsiInsolvencyApplicationPayment fetchByPrimaryKey(
		long osiInsolveApplicationPaymentId) {
	 ...
	 */
	public static List<OsiInsolvencyApplicationPayment> findAll() {
	...
	public static OsiInsolvencyApplicationPaymentPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		OsiInsolvencyApplicationPaymentPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile OsiInsolvencyApplicationPaymentPersistence
		_persistence;
