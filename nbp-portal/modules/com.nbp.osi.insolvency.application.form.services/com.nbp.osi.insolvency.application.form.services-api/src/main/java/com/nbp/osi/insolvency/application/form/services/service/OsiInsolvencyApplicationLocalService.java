...
/**
 * Provides the local service interface for OsiInsolvencyApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiInsolvencyApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiInsolvencyApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvencyApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi insolvency application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiInsolvencyApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiInsolvencyApplication> getOsiInsolvencyApplicationByS_U(
		int status, long userId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiInsolvencyApplication> getOsiInsolvencyApplicationByS_UId(
		long userId, int status);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiInsolvencyApplication> getOsiInsolvencyApplicationByStatus(
		int status);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiInsolvencyApplication getOsiInsolvencyByAppNum(
			String applicationNumber)
		throws NoSuchOsiInsolvencyApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiInsolvencyApplication getOsiInsolvencyByCaseId(String caseId)
		throws NoSuchOsiInsolvencyApplicationException;
