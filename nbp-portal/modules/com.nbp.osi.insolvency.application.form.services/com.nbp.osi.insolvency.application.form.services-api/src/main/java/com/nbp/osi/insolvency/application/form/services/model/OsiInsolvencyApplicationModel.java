...
/**
 * The base model interface for the OsiInsolvencyApplication service. Represents a row in the &quot;nbp_osi_insolv_application&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.insolvency.application.form.services.model.impl.OsiInsolvencyApplicationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.insolvency.application.form.services.model.impl.OsiInsolvencyApplicationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface OsiInsolvencyApplicationModel
	extends BaseModel<OsiInsolvencyApplication>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a osi insolvency application model instance should use the {@link OsiInsolvencyApplication} interface instead.
	 */
