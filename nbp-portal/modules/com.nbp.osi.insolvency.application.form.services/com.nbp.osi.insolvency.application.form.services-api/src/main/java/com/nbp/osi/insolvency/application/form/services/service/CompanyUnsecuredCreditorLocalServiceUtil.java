...
/**
 * Provides the local service utility for CompanyUnsecuredCreditor. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyUnsecuredCreditorLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CompanyUnsecuredCreditorLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyUnsecuredCreditorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CompanyUnsecuredCreditor addCompanyUnsecuredCreditor(
		CompanyUnsecuredCreditor companyUnsecuredCreditor) {

		return getService().addCompanyUnsecuredCreditor(
	 ...
	 */
	public static CompanyUnsecuredCreditor createCompanyUnsecuredCreditor(
		long companyUnsecuredCreditorId) {

		return getService().createCompanyUnsecuredCreditor(
	 ...
	 */
	public static CompanyUnsecuredCreditor deleteCompanyUnsecuredCreditor(
		CompanyUnsecuredCreditor companyUnsecuredCreditor) {

		return getService().deleteCompanyUnsecuredCreditor(
			companyUnsecuredCreditor);
	}
	...
	public static CompanyUnsecuredCreditor fetchCompanyUnsecuredCreditor(
		long companyUnsecuredCreditorId) {

		return getService().fetchCompanyUnsecuredCreditor(
			companyUnsecuredCreditorId);
	}
	 ...
	 * @throws PortalException if a company unsecured creditor with the primary key could not be found
	 */
	public static CompanyUnsecuredCreditor getCompanyUnsecuredCreditor(
			long companyUnsecuredCreditorId)
		throws PortalException {

		return getService().getCompanyUnsecuredCreditor(
			companyUnsecuredCreditorId);
	}
	 ...
	 */
	public static List<CompanyUnsecuredCreditor> getCompanyUnsecuredCreditors(
		int start, int end) {

		return getService().getCompanyUnsecuredCreditors(start, end);
	}
	 ...
	 */
	public static int getCompanyUnsecuredCreditorsCount() {
		return getService().getCompanyUnsecuredCreditorsCount();
	}
	...
	public static List<CompanyUnsecuredCreditor> getOsiById(
	 ...
	 */
	public static CompanyUnsecuredCreditor updateCompanyUnsecuredCreditor(
		CompanyUnsecuredCreditor companyUnsecuredCreditor) {

		return getService().updateCompanyUnsecuredCreditor(
			companyUnsecuredCreditor);
	}

	public static CompanyUnsecuredCreditorLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CompanyUnsecuredCreditorLocalService>
		_serviceSnapshot = new Snapshot<>(
			CompanyUnsecuredCreditorLocalServiceUtil.class,
