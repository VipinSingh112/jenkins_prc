...
/**
 * The base model interface for the CompanyTotalLiability service. Represents a row in the &quot;nbp_osi_insolv_total_liab&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.insolvency.application.form.services.model.impl.CompanyTotalLiabilityModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.insolvency.application.form.services.model.impl.CompanyTotalLiabilityImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CompanyTotalLiabilityModel
	extends BaseModel<CompanyTotalLiability>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a company total liability model instance should use the {@link CompanyTotalLiability} interface instead.
	 */
