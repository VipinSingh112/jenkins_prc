...
/**
 * The base model interface for the OsiInsolvencyCurrentStage service. Represents a row in the &quot;nbp_osi_insolv_current_stage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.insolvency.application.form.services.model.impl.OsiInsolvencyCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.insolvency.application.form.services.model.impl.OsiInsolvencyCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface OsiInsolvencyCurrentStageModel
	extends AuditedModel, BaseModel<OsiInsolvencyCurrentStage>, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a osi insolvency current stage model instance should use the {@link OsiInsolvencyCurrentStage} interface instead.
	 */
