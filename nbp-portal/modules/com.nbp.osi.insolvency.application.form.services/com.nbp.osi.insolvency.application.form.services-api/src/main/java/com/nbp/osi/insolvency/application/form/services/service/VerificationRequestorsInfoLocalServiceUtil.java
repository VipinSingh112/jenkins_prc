...
/**
 * Provides the local service utility for VerificationRequestorsInfo. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationRequestorsInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class VerificationRequestorsInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationRequestorsInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static VerificationRequestorsInfo addVerificationRequestorsInfo(
		VerificationRequestorsInfo verificationRequestorsInfo) {

		return getService().addVerificationRequestorsInfo(
	 ...
	 */
	public static VerificationRequestorsInfo createVerificationRequestorsInfo(
		long requestorInformationId) {

		return getService().createVerificationRequestorsInfo(
	 ...
	 */
	public static VerificationRequestorsInfo deleteVerificationRequestorsInfo(
			long requestorInformationId)
		throws PortalException {

		return getService().deleteVerificationRequestorsInfo(
			requestorInformationId);
	}
	...
	public static VerificationRequestorsInfo fetchVerificationRequestorsInfo(
		long requestorInformationId) {

		return getService().fetchVerificationRequestorsInfo(
			requestorInformationId);
	}
	...
	public static VerificationRequestorsInfo getOsiById(long osiInsolvencyId)
	 ...
	 * @throws PortalException if a verification requestors info with the primary key could not be found
	 */
	public static VerificationRequestorsInfo getVerificationRequestorsInfo(
			long requestorInformationId)
		throws PortalException {

		return getService().getVerificationRequestorsInfo(
			requestorInformationId);
	}
	 ...
	 */
	public static List<VerificationRequestorsInfo>
		getVerificationRequestorsInfos(int start, int end) {

		return getService().getVerificationRequestorsInfos(start, end);
	}
	 ...
	 */
	public static int getVerificationRequestorsInfosCount() {
		return getService().getVerificationRequestorsInfosCount();
	}
	 ...
	 */
	public static VerificationRequestorsInfo updateVerificationRequestorsInfo(
		VerificationRequestorsInfo verificationRequestorsInfo) {

		return getService().updateVerificationRequestorsInfo(
			verificationRequestorsInfo);
	}

	public static VerificationRequestorsInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<VerificationRequestorsInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			VerificationRequestorsInfoLocalServiceUtil.class,
