...
/**
 * Provides the local service utility for CompanyTotalLiability. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyTotalLiabilityLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CompanyTotalLiabilityLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyTotalLiabilityLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CompanyTotalLiability addCompanyTotalLiability(
		CompanyTotalLiability companyTotalLiability) {

		return getService().addCompanyTotalLiability(companyTotalLiability);
	}
	 ...
	 */
	public static CompanyTotalLiability createCompanyTotalLiability(
		long companyTotalLiabilityId) {

		return getService().createCompanyTotalLiability(
	 ...
	 */
	public static CompanyTotalLiability deleteCompanyTotalLiability(
		CompanyTotalLiability companyTotalLiability) {

		return getService().deleteCompanyTotalLiability(companyTotalLiability);
	}
	...
	public static CompanyTotalLiability deleteCompanyTotalLiability(
		...
		return getService().deleteCompanyTotalLiability(
			companyTotalLiabilityId);
	}
	...
	public static CompanyTotalLiability fetchCompanyTotalLiability(
		long companyTotalLiabilityId) {

		return getService().fetchCompanyTotalLiability(companyTotalLiabilityId);
	}
	 ...
	 */
	public static List<CompanyTotalLiability> getCompanyTotalLiabilities(
		int start, int end) {

		return getService().getCompanyTotalLiabilities(start, end);
	}
	 ...
	 */
	public static int getCompanyTotalLiabilitiesCount() {
		return getService().getCompanyTotalLiabilitiesCount();
	}
	 ...
	 * @throws PortalException if a company total liability with the primary key could not be found
	 */
	public static CompanyTotalLiability getCompanyTotalLiability(
			long companyTotalLiabilityId)
		throws PortalException {

		return getService().getCompanyTotalLiability(companyTotalLiabilityId);
	}
	 ...
	 */
	public static CompanyTotalLiability updateCompanyTotalLiability(
		CompanyTotalLiability companyTotalLiability) {

		return getService().updateCompanyTotalLiability(companyTotalLiability);
	}

	public static CompanyTotalLiabilityLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CompanyTotalLiabilityLocalService>
		_serviceSnapshot = new Snapshot<>(
			CompanyTotalLiabilityLocalServiceUtil.class,
