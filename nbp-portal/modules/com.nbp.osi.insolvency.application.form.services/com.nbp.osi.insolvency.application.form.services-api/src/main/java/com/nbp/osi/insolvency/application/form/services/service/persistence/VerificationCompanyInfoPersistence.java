...
/**
 * The persistence interface for the verification company info service.
 *
 * <p>
 ...
 * @see VerificationCompanyInfoUtil
 * @generated
 */
@ProviderType
public interface VerificationCompanyInfoPersistence
	extends BasePersistence<VerificationCompanyInfo> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VerificationCompanyInfoUtil} to access the verification company info persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<VerificationCompanyInfo> verificationCompanyInfos);
	 ...
	 */
	public java.util.List<VerificationCompanyInfo> findAll();
	 ...
	 */
	public java.util.List<VerificationCompanyInfo> findAll(int start, int end);
	...
	public java.util.List<VerificationCompanyInfo> findAll(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<VerificationCompanyInfo> orderByComparator);
