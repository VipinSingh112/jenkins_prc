...
/**
 * The persistence interface for the subject data service.
 *
 * <p>
 ...
 */
@ProviderType
public interface SubjectDataPersistence extends BasePersistence<SubjectData> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubjectDataUtil} to access the subject data persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<SubjectData> subjectDatas);
	 ...
	 */
	public java.util.List<SubjectData> findAll();
	 ...
	 */
	public java.util.List<SubjectData> findAll(int start, int end);
	...
	public java.util.List<SubjectData> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<SubjectData>
			orderByComparator);
