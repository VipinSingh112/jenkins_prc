...
/**
 * The persistence utility for the company secretary service. This utility wraps <code>com.nbp.osi.insolvency.application.form.services.service.persistence.impl.CompanySecretaryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see CompanySecretaryPersistence
 * @generated
 */
public class CompanySecretaryUtil {
	 ...
	 */
	public static void clearCache(CompanySecretary companySecretary) {
		getPersistence().clearCache(companySecretary);
	}
	 ...
	 */
	public static Map<Serializable, CompanySecretary> fetchByPrimaryKeys(
	 ...
	 */
	public static List<CompanySecretary> findWithDynamicQuery(
	 ...
	 */
	public static CompanySecretary update(CompanySecretary companySecretary) {
		return getPersistence().update(companySecretary);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static CompanySecretary update(
		CompanySecretary companySecretary, ServiceContext serviceContext) {

		return getPersistence().update(companySecretary, serviceContext);
	}
	 ...
	 */
	public static List<CompanySecretary> findBygetOsiById(
	 ...
	 */
	public static CompanySecretary findBygetOsiById_First(
			long osiInsolvencyId,
			OrderByComparator<CompanySecretary> orderByComparator)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchCompanySecretaryException {
	 ...
	 */
	public static CompanySecretary fetchBygetOsiById_First(
		long osiInsolvencyId,
		OrderByComparator<CompanySecretary> orderByComparator) {
	 ...
	 * @throws NoSuchCompanySecretaryException if a matching company secretary could not be found
	 */
	public static CompanySecretary findBygetOsiById_Last(
			long osiInsolvencyId,
			OrderByComparator<CompanySecretary> orderByComparator)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchCompanySecretaryException {
	 ...
	 */
	public static CompanySecretary fetchBygetOsiById_Last(
		long osiInsolvencyId,
		OrderByComparator<CompanySecretary> orderByComparator) {
	 ...
	 */
	public static CompanySecretary[] findBygetOsiById_PrevAndNext(
		...
		return getPersistence().findBygetOsiById_PrevAndNext(
			companySecretaryId, osiInsolvencyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(CompanySecretary companySecretary) {
		getPersistence().cacheResult(companySecretary);
	}
	 ...
	 */
	public static void cacheResult(List<CompanySecretary> companySecretaries) {
		getPersistence().cacheResult(companySecretaries);
	}
	 ...
	 */
	public static CompanySecretary create(long companySecretaryId) {
		return getPersistence().create(companySecretaryId);
	}
	 ...
	 * @throws NoSuchCompanySecretaryException if a company secretary with the primary key could not be found
	 */
	public static CompanySecretary remove(long companySecretaryId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchCompanySecretaryException {

		return getPersistence().remove(companySecretaryId);
	}

	public static CompanySecretary updateImpl(
		CompanySecretary companySecretary) {

		return getPersistence().updateImpl(companySecretary);
	}
	 ...
	 * @throws NoSuchCompanySecretaryException if a company secretary with the primary key could not be found
	 */
	public static CompanySecretary findByPrimaryKey(long companySecretaryId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchCompanySecretaryException {

		return getPersistence().findByPrimaryKey(companySecretaryId);
	}
	 ...
	 */
	public static CompanySecretary fetchByPrimaryKey(long companySecretaryId) {
		return getPersistence().fetchByPrimaryKey(companySecretaryId);
	}
	 ...
	 */
	public static List<CompanySecretary> findAll() {
	 ...
	 */
	public static List<CompanySecretary> findAll(int start, int end) {
	...
	public static CompanySecretaryPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(CompanySecretaryPersistence persistence) {
		_persistence = persistence;
	}

	private static volatile CompanySecretaryPersistence _persistence;
