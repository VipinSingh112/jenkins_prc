...
/**
 * Provides the local service interface for MonthlyIncome. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MonthlyIncomeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MonthlyIncomeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyIncomeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the monthly income local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MonthlyIncomeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MonthlyIncome addMonthlyIncome(MonthlyIncome monthlyIncome);
	...
	public MonthlyIncome createMonthlyIncome(long monthlyIncomeId);
	...
	public MonthlyIncome deleteMonthlyIncome(long monthlyIncomeId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MonthlyIncome deleteMonthlyIncome(MonthlyIncome monthlyIncome);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyIncome fetchMonthlyIncome(long monthlyIncomeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyIncome getMonthlyIncome(long monthlyIncomeId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MonthlyIncome> getMonthlyIncomes(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyIncome getOsiById(long osiInsolvencyId)
