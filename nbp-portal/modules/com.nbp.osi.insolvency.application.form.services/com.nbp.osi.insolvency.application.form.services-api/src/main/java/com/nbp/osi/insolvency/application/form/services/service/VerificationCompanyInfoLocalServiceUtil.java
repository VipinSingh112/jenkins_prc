...
/**
 * Provides the local service utility for VerificationCompanyInfo. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class VerificationCompanyInfoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.VerificationCompanyInfoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static VerificationCompanyInfo addVerificationCompanyInfo(
		VerificationCompanyInfo verificationCompanyInfo) {

		return getService().addVerificationCompanyInfo(verificationCompanyInfo);
	}
	 ...
	 */
	public static VerificationCompanyInfo createVerificationCompanyInfo(
		long verificationCompanyInfoId) {

		return getService().createVerificationCompanyInfo(
	 ...
	 */
	public static VerificationCompanyInfo deleteVerificationCompanyInfo(
			long verificationCompanyInfoId)
		throws PortalException {

		return getService().deleteVerificationCompanyInfo(
			verificationCompanyInfoId);
	}
	...
	public static VerificationCompanyInfo fetchVerificationCompanyInfo(
		long verificationCompanyInfoId) {

		return getService().fetchVerificationCompanyInfo(
			verificationCompanyInfoId);
	}
	...
	public static VerificationCompanyInfo getOsiInsolvencyById(
	 ...
	 * @throws PortalException if a verification company info with the primary key could not be found
	 */
	public static VerificationCompanyInfo getVerificationCompanyInfo(
			long verificationCompanyInfoId)
		throws PortalException {

		return getService().getVerificationCompanyInfo(
			verificationCompanyInfoId);
	}
	 ...
	 */
	public static List<VerificationCompanyInfo> getVerificationCompanyInfos(
		int start, int end) {

		return getService().getVerificationCompanyInfos(start, end);
	}
	 ...
	 */
	public static int getVerificationCompanyInfosCount() {
		return getService().getVerificationCompanyInfosCount();
	}
	 ...
	 */
	public static VerificationCompanyInfo updateVerificationCompanyInfo(
		VerificationCompanyInfo verificationCompanyInfo) {

		return getService().updateVerificationCompanyInfo(
			verificationCompanyInfo);
	}

	public static VerificationCompanyInfoLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<VerificationCompanyInfoLocalService>
		_serviceSnapshot = new Snapshot<>(
			VerificationCompanyInfoLocalServiceUtil.class,
