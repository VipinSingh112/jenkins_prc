...
/**
 * The base model interface for the PreferredCreditor service. Represents a row in the &quot;nbp_osi_preferred_detail&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.osi.insolvency.application.form.services.model.impl.PreferredCreditorModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.osi.insolvency.application.form.services.model.impl.PreferredCreditorImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface PreferredCreditorModel
	extends BaseModel<PreferredCreditor>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a preferred creditor model instance should use the {@link PreferredCreditor} interface instead.
	 */
