...
/**
 * Provides the local service interface for OsiComSecurityTotal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OsiComSecurityTotalLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OsiComSecurityTotalLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiComSecurityTotalLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the osi com security total local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OsiComSecurityTotalLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OsiComSecurityTotal addOsiComSecurityTotal(
	...
	public OsiComSecurityTotal createOsiComSecurityTotal(
	...
	public OsiComSecurityTotal deleteOsiComSecurityTotal(
			long osiComSecurityTotalId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiComSecurityTotal fetchOsiComSecurityTotal(
		long osiComSecurityTotalId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiComSecurityTotal getOsiById(long osiInsolvencyId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OsiComSecurityTotal getOsiComSecurityTotal(
			long osiComSecurityTotalId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OsiComSecurityTotal> getOsiComSecurityTotals(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OsiComSecurityTotal updateOsiComSecurityTotal(
		OsiComSecurityTotal osiComSecurityTotal);
