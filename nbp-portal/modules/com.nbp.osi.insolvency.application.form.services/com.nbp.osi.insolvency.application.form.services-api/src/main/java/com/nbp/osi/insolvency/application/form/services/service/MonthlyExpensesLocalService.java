...
/**
 * Provides the local service interface for MonthlyExpenses. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MonthlyExpensesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MonthlyExpensesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.MonthlyExpensesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the monthly expenses local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MonthlyExpensesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MonthlyExpenses addMonthlyExpenses(MonthlyExpenses monthlyExpenses);
	...
	public MonthlyExpenses createMonthlyExpenses(long monthlyExpensesId);
	...
	public MonthlyExpenses deleteMonthlyExpenses(long monthlyExpensesId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MonthlyExpenses deleteMonthlyExpenses(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyExpenses fetchMonthlyExpenses(long monthlyExpensesId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MonthlyExpenses getMonthlyExpenses(long monthlyExpensesId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MonthlyExpenses> getMonthlyExpenseses(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MonthlyExpenses> getOsiById(long osiInsolvencyId)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MonthlyExpenses updateMonthlyExpenses(
		MonthlyExpenses monthlyExpenses);
