...
/**
 * Provides the local service utility for OsiInsolvPaymentPlan. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvPaymentPlanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class OsiInsolvPaymentPlanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.OsiInsolvPaymentPlanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static OsiInsolvPaymentPlan addOsiInsolvPaymentPlan(
		OsiInsolvPaymentPlan osiInsolvPaymentPlan) {

		return getService().addOsiInsolvPaymentPlan(osiInsolvPaymentPlan);
	}
	 ...
	 */
	public static OsiInsolvPaymentPlan createOsiInsolvPaymentPlan(
		long osiInsolvPaymentPlanId) {

		return getService().createOsiInsolvPaymentPlan(osiInsolvPaymentPlanId);
	}
	 ...
	 */
	public static OsiInsolvPaymentPlan deleteOsiInsolvPaymentPlan(
			long osiInsolvPaymentPlanId)
		throws PortalException {

		return getService().deleteOsiInsolvPaymentPlan(osiInsolvPaymentPlanId);
	}
	...
	public static OsiInsolvPaymentPlan deleteOsiInsolvPaymentPlan(
		...
		return getService().deleteOsiInsolvPaymentPlan(osiInsolvPaymentPlan);
	}
	...
	public static OsiInsolvPaymentPlan fetchOsiInsolvPaymentPlan(
		long osiInsolvPaymentPlanId) {

		return getService().fetchOsiInsolvPaymentPlan(osiInsolvPaymentPlanId);
	}
	 ...
	 * @throws PortalException if a osi insolv payment plan with the primary key could not be found
	 */
	public static OsiInsolvPaymentPlan getOsiInsolvPaymentPlan(
			long osiInsolvPaymentPlanId)
		throws PortalException {

		return getService().getOsiInsolvPaymentPlan(osiInsolvPaymentPlanId);
	}

	public static OsiInsolvPaymentPlan getOsiInsolvPaymentPlanById(
			long osiInsolvencyId)
		throws com.nbp.osi.insolvency.application.form.services.exception.
			NoSuchOsiInsolvencyApplicationPaymentException {

		return getService().getOsiInsolvPaymentPlanById(osiInsolvencyId);
	}
	 ...
	 */
	public static List<OsiInsolvPaymentPlan> getOsiInsolvPaymentPlans(
		int start, int end) {

		return getService().getOsiInsolvPaymentPlans(start, end);
	}
	 ...
	 */
	public static int getOsiInsolvPaymentPlansCount() {
		return getService().getOsiInsolvPaymentPlansCount();
	}
	 ...
	 */
	public static OsiInsolvPaymentPlan updateOsiInsolvPaymentPlan(
		OsiInsolvPaymentPlan osiInsolvPaymentPlan) {

		return getService().updateOsiInsolvPaymentPlan(osiInsolvPaymentPlan);
	}

	public static OsiInsolvPaymentPlanLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<OsiInsolvPaymentPlanLocalService>
		_serviceSnapshot = new Snapshot<>(
			OsiInsolvPaymentPlanLocalServiceUtil.class,
