...
/**
 * Provides the local service interface for CompanyTotalLiability. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CompanyTotalLiabilityLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CompanyTotalLiabilityLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanyTotalLiabilityLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the company total liability local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CompanyTotalLiabilityLocalServiceUtil} if injection and service tracking are not available.
	 */
