...
/**
 * Provides the local service utility for CompanySecretary. This utility wraps
 * <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecretaryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CompanySecretaryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.osi.insolvency.application.form.services.service.impl.CompanySecretaryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CompanySecretary addCompanySecretary(
		CompanySecretary companySecretary) {

		return getService().addCompanySecretary(companySecretary);
	}
	 ...
	 */
	public static CompanySecretary createCompanySecretary(
		long companySecretaryId) {

		return getService().createCompanySecretary(companySecretaryId);
	}
	 ...
	 */
	public static CompanySecretary deleteCompanySecretary(
		CompanySecretary companySecretary) {

		return getService().deleteCompanySecretary(companySecretary);
	}
	...
	public static CompanySecretary deleteCompanySecretary(
		...
		return getService().deleteCompanySecretary(companySecretaryId);
	}
	...
	public static CompanySecretary fetchCompanySecretary(
		long companySecretaryId) {

		return getService().fetchCompanySecretary(companySecretaryId);
	}
	 ...
	 */
	public static List<CompanySecretary> getCompanySecretaries(
		int start, int end) {

		return getService().getCompanySecretaries(start, end);
	}
	 ...
	 */
	public static int getCompanySecretariesCount() {
		return getService().getCompanySecretariesCount();
	}
	 ...
	 * @throws PortalException if a company secretary with the primary key could not be found
	 */
	public static CompanySecretary getCompanySecretary(long companySecretaryId)
		throws PortalException {

		return getService().getCompanySecretary(companySecretaryId);
	}
	...
	public static List<CompanySecretary> getOsiById(long osiInsolvencyId)
	 ...
	 */
	public static CompanySecretary updateCompanySecretary(
		CompanySecretary companySecretary) {

		return getService().updateCompanySecretary(companySecretary);
	}

	public static CompanySecretaryLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<CompanySecretaryLocalService>
		_serviceSnapshot = new Snapshot<>(
			CompanySecretaryLocalServiceUtil.class,
			CompanySecretaryLocalService.class);
