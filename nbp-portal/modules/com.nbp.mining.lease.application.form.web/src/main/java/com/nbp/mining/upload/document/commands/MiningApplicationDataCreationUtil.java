...
public class MiningApplicationDataCreationUtil {
public static String getApplicationRenewUrl(String licenseNumber,ThemeDisplay themeDisplay, String typeOfApplicant,String typeOfTransaction) {
	...
	miningApplicationRenewalProcess.setProspectingRightNumber(typeOfTransaction);
