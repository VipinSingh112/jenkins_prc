...
public class MiningGenericDocumentsResourceCommand implements MVCResourceCommand {
	private static long PARENT_FOLDER_ID = DLFolderConstants.DEFAULT_PARENT_FOLDER_ID;
	private static String ROOT_FOLDER_NAME = "Mining Supported Documents";
	private static Log _log = LogFactoryUtil.getLog(MiningGenericDocumentsResourceCommand.class);
@Override
