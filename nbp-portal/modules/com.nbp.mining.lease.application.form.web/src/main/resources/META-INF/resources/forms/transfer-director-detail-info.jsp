<%
String transferDirectorDetailVal="";
transferDirectorDetailVal = (String)request.getAttribute("transferDirectorDetailVal");
%>
<tr class="director-detail-row<%=transferDirectorDetailVal%>">
	<td class="sub_heading_content text-nowrap transferCompanyDirectorName<%=transferDirectorDetailVal%>"></td>
	<td class="sub_heading_content text-nowrap transferCompanyDirectorNationality<%=transferDirectorDetailVal%>"></td>
	<td class="sub_heading_content text-nowrap transferCompanyDirectorPartnership<%=transferDirectorDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="transferDirectorDetailId<%=transferDirectorDetailVal%>" name="transferDirectorDetailId<%=transferDirectorDetailVal%>" value="">
</tr>
