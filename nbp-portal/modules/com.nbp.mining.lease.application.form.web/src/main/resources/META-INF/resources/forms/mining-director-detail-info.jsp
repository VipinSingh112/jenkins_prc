<%
String miningDirectorDetailVal="";
miningDirectorDetailVal = (String)request.getAttribute("miningDirectorDetailVal");
%>
<tr class="mining-director-detail-row<%=miningDirectorDetailVal%>">
	<td class="sub_heading_content text-nowrap miningCompanyDirectorName<%=miningDirectorDetailVal%>"></td>
	<td class="sub_heading_content text-nowrap miningCompanyDirectorNationality<%=miningDirectorDetailVal%>"></td>
	<td class="sub_heading_content text-nowrap miningCompanyDirectorPartnership<%=miningDirectorDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <input type="hidden" id="miningDirectorDetailId<%=miningDirectorDetailVal%>" name="miningDirectorDetailId<%=miningDirectorDetailVal%>" value="">
</tr>
