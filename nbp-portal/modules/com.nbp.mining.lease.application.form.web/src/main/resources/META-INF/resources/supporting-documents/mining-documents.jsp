...
<fieldset class="wizard-fieldset" id="miningSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<input type="hidden" id="miningDocumentCounter"
								name="miningDocumentCounter">
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="miningGenericUpload" onchange="attachDetailed(this.id)" multiple="multiple"
				name="<portlet:namespace/>miningGenericUpload" 
				hidden=""> <label class="custom-upload"
				for="miningGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="miningGenericFileChosen"></span>
		</div>
		...
		try{
		supportingDocumentsParentFolderGeneric=GettingDocumentData.getDocumentLibraryParentAndSubFolder(themeDisplay.getScopeGroupId(), miningApplicationId);
		...
		if(miningApplicationId>0 && dlFileEntriesGeneric!=null){
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="miningEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>miningEnrollDocuments">
