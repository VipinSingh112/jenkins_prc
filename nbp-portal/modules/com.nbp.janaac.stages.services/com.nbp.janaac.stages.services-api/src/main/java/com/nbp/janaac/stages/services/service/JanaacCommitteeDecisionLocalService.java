...
/**
 * Provides the local service interface for JanaacCommitteeDecision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JanaacCommitteeDecisionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JanaacCommitteeDecisionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.janaac.stages.services.service.impl.JanaacCommitteeDecisionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the janaac committee decision local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JanaacCommitteeDecisionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JanaacCommitteeDecision getJanaac_by_caseId(String caseId)
	...
	public JanaacCommitteeDecision updateJanaacApplicationCommitteeDecision(
