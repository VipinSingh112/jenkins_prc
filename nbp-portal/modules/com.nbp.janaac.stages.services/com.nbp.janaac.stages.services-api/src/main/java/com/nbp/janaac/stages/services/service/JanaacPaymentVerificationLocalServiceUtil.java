...
/**
 * Provides the local service utility for JanaacPaymentVerification. This utility wraps
 * <code>com.nbp.janaac.stages.services.service.impl.JanaacPaymentVerificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class JanaacPaymentVerificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.stages.services.service.impl.JanaacPaymentVerificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static JanaacPaymentVerification addJanaacPaymentVerification(
		JanaacPaymentVerification janaacPaymentVerification) {

		return getService().addJanaacPaymentVerification(
	 ...
	 */
	public static JanaacPaymentVerification createJanaacPaymentVerification(
		long janaacPaymentVerificationId) {

		return getService().createJanaacPaymentVerification(
	 ...
	 */
	public static JanaacPaymentVerification deleteJanaacPaymentVerification(
		JanaacPaymentVerification janaacPaymentVerification) {

		return getService().deleteJanaacPaymentVerification(
			janaacPaymentVerification);
	}
	...
	public static JanaacPaymentVerification fetchJanaacPaymentVerification(
		long janaacPaymentVerificationId) {

		return getService().fetchJanaacPaymentVerification(
			janaacPaymentVerificationId);
	}
	...
	public static List<JanaacPaymentVerification> getJanaacPayConfBy_CI(
		String caseId) {

		return getService().getJanaacPayConfBy_CI(caseId);
	}

	public static JanaacPaymentVerification getJanaacPaymentBy_CI(String caseId)
		throws com.nbp.janaac.stages.services.exception.
			NoSuchJanaacPaymentVerificationException {

		return getService().getJanaacPaymentBy_CI(caseId);
	}
	 ...
	 * @throws PortalException if a janaac payment verification with the primary key could not be found
	 */
	public static JanaacPaymentVerification getJanaacPaymentVerification(
			long janaacPaymentVerificationId)
		throws PortalException {

		return getService().getJanaacPaymentVerification(
			janaacPaymentVerificationId);
	}
	 ...
	 */
	public static List<JanaacPaymentVerification> getJanaacPaymentVerifications(
		int start, int end) {

		return getService().getJanaacPaymentVerifications(start, end);
	}
	 ...
	 */
	public static int getJanaacPaymentVerificationsCount() {
		return getService().getJanaacPaymentVerificationsCount();
	}
	 ...
	 */
	public static JanaacPaymentVerification updateJanaacPaymentVerification(
		JanaacPaymentVerification janaacPaymentVerification) {

		return getService().updateJanaacPaymentVerification(
			janaacPaymentVerification);
	}
	...
	public static JanaacPaymentVerificationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<JanaacPaymentVerificationLocalService>
		_serviceSnapshot = new Snapshot<>(
			JanaacPaymentVerificationLocalServiceUtil.class,
