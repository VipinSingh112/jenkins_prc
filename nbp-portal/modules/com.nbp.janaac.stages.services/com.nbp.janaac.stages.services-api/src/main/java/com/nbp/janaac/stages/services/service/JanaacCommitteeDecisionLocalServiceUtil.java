...
/**
 * Provides the local service utility for JanaacCommitteeDecision. This utility wraps
 * <code>com.nbp.janaac.stages.services.service.impl.JanaacCommitteeDecisionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class JanaacCommitteeDecisionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.janaac.stages.services.service.impl.JanaacCommitteeDecisionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static JanaacCommitteeDecision addJanaacCommitteeDecision(
		JanaacCommitteeDecision janaacCommitteeDecision) {

		return getService().addJanaacCommitteeDecision(janaacCommitteeDecision);
	}
	 ...
	 */
	public static JanaacCommitteeDecision createJanaacCommitteeDecision(
		long janaacCommitteeDecisionId) {

		return getService().createJanaacCommitteeDecision(
	 ...
	 */
	public static JanaacCommitteeDecision deleteJanaacCommitteeDecision(
		JanaacCommitteeDecision janaacCommitteeDecision) {

		return getService().deleteJanaacCommitteeDecision(
	...
	public static JanaacCommitteeDecision fetchJanaacCommitteeDecision(
		long janaacCommitteeDecisionId) {

		return getService().fetchJanaacCommitteeDecision(
			janaacCommitteeDecisionId);
	}
	...
	public static JanaacCommitteeDecision getJanaac_by_caseId(String caseId)
	 ...
	 * @throws PortalException if a janaac committee decision with the primary key could not be found
	 */
	public static JanaacCommitteeDecision getJanaacCommitteeDecision(
			long janaacCommitteeDecisionId)
		throws PortalException {

		return getService().getJanaacCommitteeDecision(
			janaacCommitteeDecisionId);
	}
	 ...
	 */
	public static List<JanaacCommitteeDecision> getJanaacCommitteeDecisions(
		int start, int end) {

		return getService().getJanaacCommitteeDecisions(start, end);
	}
	 ...
	 */
	public static int getJanaacCommitteeDecisionsCount() {
		return getService().getJanaacCommitteeDecisionsCount();
	}
	 ...
	 */
	public static JanaacCommitteeDecision updateJanaacCommitteeDecision(
		JanaacCommitteeDecision janaacCommitteeDecision) {

		return getService().updateJanaacCommitteeDecision(
			janaacCommitteeDecision);
	}

	public static JanaacCommitteeDecisionLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<JanaacCommitteeDecisionLocalService>
		_serviceSnapshot = new Snapshot<>(
			JanaacCommitteeDecisionLocalServiceUtil.class,
