...
import com.nbp.jtb.application.stage.services.service.JtbAppBoardDecisionService;
...
/**
 * Provides the base implementation for the jtb app board decision remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.jtb.application.stage.services.service.impl.JtbAppBoardDecisionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.jtb.application.stage.services.service.impl.JtbAppBoardDecisionServiceImpl
 * @generated
 */
public abstract class JtbAppBoardDecisionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JtbAppBoardDecisionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JtbAppBoardDecisionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.jtb.application.stage.services.service.JtbAppBoardDecisionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JtbAppBoardDecisionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jtbAppBoardDecisionService = (JtbAppBoardDecisionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return JtbAppBoardDecisionService.class.getName();
	}
	...
	protected JtbAppBoardDecisionService jtbAppBoardDecisionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JtbAppBoardDecisionServiceBaseImpl.class);
