...
/**
 * The base model interface for the JTBLicenceCertificate service. Represents a row in the &quot;nbp_jtb_licence_certificate&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.jtb.application.stage.services.model.impl.JTBLicenceCertificateModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.jtb.application.stage.services.model.impl.JTBLicenceCertificateImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface JTBLicenceCertificateModel
	extends BaseModel<JTBLicenceCertificate>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a jtb licence certificate model instance should use the {@link JTBLicenceCertificate} interface instead.
	 */
