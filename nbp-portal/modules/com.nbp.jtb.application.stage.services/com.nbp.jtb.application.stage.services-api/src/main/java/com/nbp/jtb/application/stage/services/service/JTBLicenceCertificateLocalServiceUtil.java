...
/**
 * Provides the local service utility for JTBLicenceCertificate. This utility wraps
 * <code>com.nbp.jtb.application.stage.services.service.impl.JTBLicenceCertificateLocalServiceImpl</code> and
 ...
 * @generated
 */
public class JTBLicenceCertificateLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.jtb.application.stage.services.service.impl.JTBLicenceCertificateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static JTBLicenceCertificate addJTBLicenceCertificate(
		JTBLicenceCertificate jtbLicenceCertificate) {

		return getService().addJTBLicenceCertificate(jtbLicenceCertificate);
	}
	 ...
	 */
	public static JTBLicenceCertificate createJTBLicenceCertificate(
		long jTBLicenceCertificateId) {

		return getService().createJTBLicenceCertificate(
	 ...
	 */
	public static JTBLicenceCertificate deleteJTBLicenceCertificate(
		JTBLicenceCertificate jtbLicenceCertificate) {

		return getService().deleteJTBLicenceCertificate(jtbLicenceCertificate);
	}
	...
	public static JTBLicenceCertificate deleteJTBLicenceCertificate(
		...
		return getService().deleteJTBLicenceCertificate(
			jTBLicenceCertificateId);
	}
	...
	public static JTBLicenceCertificate fetchJTBLicenceCertificate(
		long jTBLicenceCertificateId) {

		return getService().fetchJTBLicenceCertificate(jTBLicenceCertificateId);
	}
	...
	public static JTBLicenceCertificate getJtbLicenceCertiBy_CI(String caseId)
		throws com.nbp.jtb.application.stage.services.exception.
			NoSuchJTBLicenceCertificateException {

		return getService().getJtbLicenceCertiBy_CI(caseId);
	}
	 ...
	 * @throws PortalException if a jtb licence certificate with the primary key could not be found
	 */
	public static JTBLicenceCertificate getJTBLicenceCertificate(
			long jTBLicenceCertificateId)
		throws PortalException {

		return getService().getJTBLicenceCertificate(jTBLicenceCertificateId);
	}
	 ...
	 */
	public static List<JTBLicenceCertificate> getJTBLicenceCertificates(
		int start, int end) {

		return getService().getJTBLicenceCertificates(start, end);
	}
	 ...
	 */
	public static int getJTBLicenceCertificatesCount() {
		return getService().getJTBLicenceCertificatesCount();
	}
	 ...
	 */
	public static JTBLicenceCertificate updateJTBLicenceCertificate(
		JTBLicenceCertificate jtbLicenceCertificate) {

		return getService().updateJTBLicenceCertificate(jtbLicenceCertificate);
	}
	...
	public static JTBLicenceCertificate updateJTBLicenceCertificate(
		...
		return getService().updateJTBLicenceCertificate(
			caseId, licenceCertificate, category, issueDate, expirationDate,
			status);
	}

	public static JTBLicenceCertificateLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<JTBLicenceCertificateLocalService>
		_serviceSnapshot = new Snapshot<>(
			JTBLicenceCertificateLocalServiceUtil.class,
