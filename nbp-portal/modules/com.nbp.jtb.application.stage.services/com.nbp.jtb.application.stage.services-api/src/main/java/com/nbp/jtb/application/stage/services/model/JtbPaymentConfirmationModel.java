...
/**
 * The base model interface for the JtbPaymentConfirmation service. Represents a row in the &quot;nbp_jtb_payment_confirm&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.jtb.application.stage.services.model.impl.JtbPaymentConfirmationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.jtb.application.stage.services.model.impl.JtbPaymentConfirmationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface JtbPaymentConfirmationModel
	extends BaseModel<JtbPaymentConfirmation>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a jtb payment confirmation model instance should use the {@link JtbPaymentConfirmation} interface instead.
	 */
