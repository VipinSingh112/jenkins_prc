...
/**
 * The base model interface for the CreativeDeskVerification service. Represents a row in the &quot;nbp_creative_desk_veri&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.creative.stages.services.model.impl.CreativeDeskVerificationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.creative.stages.services.model.impl.CreativeDeskVerificationImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface CreativeDeskVerificationModel
	extends BaseModel<CreativeDeskVerification>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a creative desk verification model instance should use the {@link CreativeDeskVerification} interface instead.
	 */
