...
/**
 * Provides the local service interface for CreativeApplicationStages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreativeApplicationStagesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreativeApplicationStagesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.creative.stages.services.service.impl.CreativeApplicationStagesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the creative application stages local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreativeApplicationStagesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeApplicationStages getCAS_CAI(long creativeApplicationId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeApplicationStages getCAS_CaseIdAndStatus(
			String caseId, String stageStatus)
		throws NoSuchCreativeApplicationStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeApplicationStages getCAS_CaseIdStageName(
			String caseId, String stageName)
		throws NoSuchCreativeApplicationStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreativeApplicationStages getCAS_CaseIdStageStatus(
			String caseId, String stageName, String stageStatus)
		throws NoSuchCreativeApplicationStagesException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CreativeApplicationStages> getCAS_SNAndSS(
