...
import com.agriculture.application.form.service.service.AgricultureFarmService;
...
/**
 * Provides the base implementation for the agriculture farm remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureFarmServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureFarmServiceImpl
 * @generated
 */
public abstract class AgricultureFarmServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureFarmService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureFarmService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureFarmServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureFarmService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureFarmService = (AgricultureFarmService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureFarmService.class.getName();
	}
	...
	protected AgricultureFarmService agricultureFarmService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureFarmServiceBaseImpl.class);
