...
import com.agriculture.application.form.service.service.AgricultureBuildingService;
...
/**
 * Provides the base implementation for the agriculture building remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureBuildingServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureBuildingServiceImpl
 * @generated
 */
public abstract class AgricultureBuildingServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureBuildingService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureBuildingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureBuildingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureBuildingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureBuildingService = (AgricultureBuildingService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureBuildingService.class.getName();
	}
	...
	protected AgricultureBuildingService agricultureBuildingService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureBuildingServiceBaseImpl.class);
