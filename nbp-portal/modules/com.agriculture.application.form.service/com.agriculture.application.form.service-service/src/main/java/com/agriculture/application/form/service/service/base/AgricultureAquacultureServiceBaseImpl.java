...
import com.agriculture.application.form.service.service.AgricultureAquacultureService;
...
/**
 * Provides the base implementation for the agriculture aquaculture remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureAquacultureServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureAquacultureServiceImpl
 * @generated
 */
public abstract class AgricultureAquacultureServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureAquacultureService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureAquacultureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureAquacultureServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureAquacultureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureAquacultureService = (AgricultureAquacultureService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureAquacultureService.class.getName();
	}
	...
	protected AgricultureAquacultureService agricultureAquacultureService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureAquacultureServiceBaseImpl.class);
