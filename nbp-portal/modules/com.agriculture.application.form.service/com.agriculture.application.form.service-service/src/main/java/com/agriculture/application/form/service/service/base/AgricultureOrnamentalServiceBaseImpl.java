...
import com.agriculture.application.form.service.service.AgricultureOrnamentalService;
...
/**
 * Provides the base implementation for the agriculture ornamental remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureOrnamentalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureOrnamentalServiceImpl
 * @generated
 */
public abstract class AgricultureOrnamentalServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureOrnamentalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureOrnamentalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureOrnamentalServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureOrnamentalService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureOrnamentalService = (AgricultureOrnamentalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureOrnamentalService.class.getName();
	}
	...
	protected AgricultureOrnamentalService agricultureOrnamentalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureOrnamentalServiceBaseImpl.class);
