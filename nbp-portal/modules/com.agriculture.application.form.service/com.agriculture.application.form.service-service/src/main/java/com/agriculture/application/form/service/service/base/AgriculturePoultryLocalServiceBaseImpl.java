...
import com.agriculture.application.form.service.service.AgriculturePoultryLocalService;
...
/**
 * Provides the base implementation for the agriculture poultry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgriculturePoultryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgriculturePoultryLocalServiceImpl
 * @generated
 */
public abstract class AgriculturePoultryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AgriculturePoultryLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgriculturePoultryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgriculturePoultryLocalServiceUtil</code>.
	 */
	...
	public AgriculturePoultry addAgriculturePoultry(
		...
		return agriculturePoultryPersistence.update(agriculturePoultry);
	}
	...
	public AgriculturePoultry createAgriculturePoultry(
		...
		return agriculturePoultryPersistence.create(agriculturePoultryId);
	}
	...
	public AgriculturePoultry deleteAgriculturePoultry(
		...
		return agriculturePoultryPersistence.remove(agriculturePoultryId);
	}
	...
	public AgriculturePoultry deleteAgriculturePoultry(
		...
		return agriculturePoultryPersistence.remove(agriculturePoultry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return agriculturePoultryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AgriculturePoultry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return agriculturePoultryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return agriculturePoultryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return agriculturePoultryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public AgriculturePoultry fetchAgriculturePoultry(
		...
		return agriculturePoultryPersistence.fetchByPrimaryKey(
	...
	public AgriculturePoultry getAgriculturePoultry(long agriculturePoultryId)
		...
		return agriculturePoultryPersistence.findByPrimaryKey(
			agriculturePoultryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			agriculturePoultryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AgriculturePoultry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AgriculturePoultry.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return agriculturePoultryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AgriculturePoultryLocalServiceImpl#deleteAgriculturePoultry(AgriculturePoultry) to avoid orphaned data");
		}

		return agriculturePoultryLocalService.deleteAgriculturePoultry(
			(AgriculturePoultry)persistedModel);
	}

	@Override
	public BasePersistence<AgriculturePoultry> getBasePersistence() {
		return agriculturePoultryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return agriculturePoultryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AgriculturePoultry> getAgriculturePoultries(
		int start, int end) {

		return agriculturePoultryPersistence.findAll(start, end);
	}
	...
	public int getAgriculturePoultriesCount() {
		return agriculturePoultryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgriculturePoultryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		agriculturePoultryLocalService =
			(AgriculturePoultryLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgriculturePoultryLocalService.class.getName();
	}
	...
	protected AgriculturePoultryLocalService agriculturePoultryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgriculturePoultryLocalServiceBaseImpl.class);
