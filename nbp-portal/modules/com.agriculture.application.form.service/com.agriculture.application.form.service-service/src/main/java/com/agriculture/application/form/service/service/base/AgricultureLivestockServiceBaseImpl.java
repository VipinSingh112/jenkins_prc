...
import com.agriculture.application.form.service.service.AgricultureLivestockService;
...
/**
 * Provides the base implementation for the agriculture livestock remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureLivestockServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureLivestockServiceImpl
 * @generated
 */
public abstract class AgricultureLivestockServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureLivestockService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureLivestockService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureLivestockServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureLivestockService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureLivestockService = (AgricultureLivestockService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureLivestockService.class.getName();
	}
	...
	protected AgricultureLivestockService agricultureLivestockService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureLivestockServiceBaseImpl.class);
