...
import com.agriculture.application.form.service.service.AgricultureApplicationService;
...
/**
 * Provides the base implementation for the agriculture application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultureApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultureApplicationServiceImpl
 * @generated
 */
public abstract class AgricultureApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AgricultureApplicationService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultureApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultureApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultureApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agricultureApplicationService = (AgricultureApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultureApplicationService.class.getName();
	}
	...
	protected AgricultureApplicationService agricultureApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultureApplicationServiceBaseImpl.class);
