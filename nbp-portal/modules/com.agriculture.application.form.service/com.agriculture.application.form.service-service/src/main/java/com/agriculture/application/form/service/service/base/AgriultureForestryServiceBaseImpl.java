...
import com.agriculture.application.form.service.service.AgriultureForestryService;
...
/**
 * Provides the base implementation for the agriulture forestry remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgriultureForestryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgriultureForestryServiceImpl
 * @generated
 */
public abstract class AgriultureForestryServiceBaseImpl
	extends BaseServiceImpl
	implements AgriultureForestryService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgriultureForestryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgriultureForestryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgriultureForestryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		agriultureForestryService = (AgriultureForestryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgriultureForestryService.class.getName();
	}
	...
	protected AgriultureForestryService agriultureForestryService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgriultureForestryServiceBaseImpl.class);
