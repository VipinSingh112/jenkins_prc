...
import com.agriculture.application.form.service.service.AgricultueFarmerLocalService;
...
/**
 * Provides the base implementation for the agricultue farmer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.agriculture.application.form.service.service.impl.AgricultueFarmerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.agriculture.application.form.service.service.impl.AgricultueFarmerLocalServiceImpl
 * @generated
 */
public abstract class AgricultueFarmerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AgricultueFarmerLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AgricultueFarmerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.agriculture.application.form.service.service.AgricultueFarmerLocalServiceUtil</code>.
	 */
	...
	public AgricultueFarmer addAgricultueFarmer(
		...
		return agricultueFarmerPersistence.update(agricultueFarmer);
	}
	...
	public AgricultueFarmer createAgricultueFarmer(long agricultueFarmerId) {
		return agricultueFarmerPersistence.create(agricultueFarmerId);
	}
	...
	public AgricultueFarmer deleteAgricultueFarmer(long agricultueFarmerId)
		...
		return agricultueFarmerPersistence.remove(agricultueFarmerId);
	}
	...
	public AgricultueFarmer deleteAgricultueFarmer(
		...
		return agricultueFarmerPersistence.remove(agricultueFarmer);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return agricultueFarmerPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AgricultueFarmer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return agricultueFarmerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return agricultueFarmerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return agricultueFarmerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return agricultueFarmerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AgricultueFarmer fetchAgricultueFarmer(long agricultueFarmerId) {
		return agricultueFarmerPersistence.fetchByPrimaryKey(
			agricultueFarmerId);
	}
	...
	public AgricultueFarmer getAgricultueFarmer(long agricultueFarmerId)
		...
		return agricultueFarmerPersistence.findByPrimaryKey(agricultueFarmerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			agricultueFarmerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AgricultueFarmer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("agricultueFarmerId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(AgricultueFarmer.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return agricultueFarmerPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AgricultueFarmerLocalServiceImpl#deleteAgricultueFarmer(AgricultueFarmer) to avoid orphaned data");
		}

		return agricultueFarmerLocalService.deleteAgricultueFarmer(
			(AgricultueFarmer)persistedModel);
	}

	@Override
	public BasePersistence<AgricultueFarmer> getBasePersistence() {
		return agricultueFarmerPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return agricultueFarmerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AgricultueFarmer> getAgricultueFarmers(int start, int end) {
		return agricultueFarmerPersistence.findAll(start, end);
	}
	...
	public int getAgricultueFarmersCount() {
		return agricultueFarmerPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AgricultueFarmerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		agricultueFarmerLocalService = (AgricultueFarmerLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return AgricultueFarmerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = agricultueFarmerPersistence.getDataSource();
	...
	protected AgricultueFarmerLocalService agricultueFarmerLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AgricultueFarmerLocalServiceBaseImpl.class);
