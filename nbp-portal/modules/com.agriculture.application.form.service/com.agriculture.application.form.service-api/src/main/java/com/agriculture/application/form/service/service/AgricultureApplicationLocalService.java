...
/**
 * Provides the local service interface for AgricultureApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AgricultureApplicationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgricultureApplicationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgricultureApplicationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agriculture application local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgricultureApplicationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureApplication> getAgricultureApplicationByS_U(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureApplication getAgricultureBy_CI(String caseId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureApplication getAgricultureBy_RT_AppNo(
			String expiredAppLicenseNumber, String requestType)
		throws NoSuchAgricultureApplicationException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureApplication getAgricultureByAppNo(
