...
/**
 * The persistence utility for the agriculture poultry service. This utility wraps <code>com.agriculture.application.form.service.service.persistence.impl.AgriculturePoultryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see AgriculturePoultryPersistence
 * @generated
 */
public class AgriculturePoultryUtil {
	 ...
	 */
	public static void clearCache(AgriculturePoultry agriculturePoultry) {
		getPersistence().clearCache(agriculturePoultry);
	}
	 ...
	 */
	public static Map<Serializable, AgriculturePoultry> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AgriculturePoultry> findWithDynamicQuery(
	 ...
	 */
	public static AgriculturePoultry update(
		AgriculturePoultry agriculturePoultry) {

		return getPersistence().update(agriculturePoultry);
	}
	 ...
	 */
	public static AgriculturePoultry update(
		AgriculturePoultry agriculturePoultry, ServiceContext serviceContext) {

		return getPersistence().update(agriculturePoultry, serviceContext);
	}
	 ...
	 */
	public static AgriculturePoultry findBygetAgricultureById(
	 ...
	 */
	public static AgriculturePoultry fetchBygetAgricultureById(
		long agricultureApplicationId) {
	 ...
	 */
	public static AgriculturePoultry removeBygetAgricultureById(
			long agricultureApplicationId)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {
	 ...
	 */
	public static List<AgriculturePoultry> findBygetAP_by_AAI(
		long agricultureApplicationId) {

		return getPersistence().findBygetAP_by_AAI(agricultureApplicationId);
	}
	...
	public static List<AgriculturePoultry> findBygetAP_by_AAI(
		...
		return getPersistence().findBygetAP_by_AAI(
	 ...
	 * @throws NoSuchAgriculturePoultryException if a matching agriculture poultry could not be found
	 */
	public static AgriculturePoultry findBygetAP_by_AAI_First(
			long agricultureApplicationId,
			OrderByComparator<AgriculturePoultry> orderByComparator)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {

		return getPersistence().findBygetAP_by_AAI_First(
	 ...
	 */
	public static AgriculturePoultry fetchBygetAP_by_AAI_First(
		long agricultureApplicationId,
		OrderByComparator<AgriculturePoultry> orderByComparator) {

		return getPersistence().fetchBygetAP_by_AAI_First(
			agricultureApplicationId, orderByComparator);
	}
	 ...
	 * @throws NoSuchAgriculturePoultryException if a matching agriculture poultry could not be found
	 */
	public static AgriculturePoultry findBygetAP_by_AAI_Last(
			long agricultureApplicationId,
			OrderByComparator<AgriculturePoultry> orderByComparator)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {

		return getPersistence().findBygetAP_by_AAI_Last(
			agricultureApplicationId, orderByComparator);
	}
	 ...
	 */
	public static AgriculturePoultry fetchBygetAP_by_AAI_Last(
		long agricultureApplicationId,
		OrderByComparator<AgriculturePoultry> orderByComparator) {

		return getPersistence().fetchBygetAP_by_AAI_Last(
			agricultureApplicationId, orderByComparator);
	}
	 ...
	 */
	public static AgriculturePoultry[] findBygetAP_by_AAI_PrevAndNext(
			long agriculturePoultryId, long agricultureApplicationId,
			OrderByComparator<AgriculturePoultry> orderByComparator)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {

		return getPersistence().findBygetAP_by_AAI_PrevAndNext(
			agriculturePoultryId, agricultureApplicationId, orderByComparator);
	}
	 ...
	 * @param agricultureApplicationId the agriculture application ID
	 */
	public static void removeBygetAP_by_AAI(long agricultureApplicationId) {
		getPersistence().removeBygetAP_by_AAI(agricultureApplicationId);
	}
	 ...
	 * @return the number of matching agriculture poultries
	 */
	public static int countBygetAP_by_AAI(long agricultureApplicationId) {
		return getPersistence().countBygetAP_by_AAI(agricultureApplicationId);
	}
	 ...
	 */
	public static void cacheResult(AgriculturePoultry agriculturePoultry) {
		getPersistence().cacheResult(agriculturePoultry);
	}
	...
	public static void cacheResult(
		List<AgriculturePoultry> agriculturePoultries) {

		getPersistence().cacheResult(agriculturePoultries);
	}
	 ...
	 */
	public static AgriculturePoultry create(long agriculturePoultryId) {
		return getPersistence().create(agriculturePoultryId);
	}
	 ...
	 * @throws NoSuchAgriculturePoultryException if a agriculture poultry with the primary key could not be found
	 */
	public static AgriculturePoultry remove(long agriculturePoultryId)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {

		return getPersistence().remove(agriculturePoultryId);
	}

	public static AgriculturePoultry updateImpl(
		AgriculturePoultry agriculturePoultry) {

		return getPersistence().updateImpl(agriculturePoultry);
	}
	 ...
	 * @throws NoSuchAgriculturePoultryException if a agriculture poultry with the primary key could not be found
	 */
	public static AgriculturePoultry findByPrimaryKey(long agriculturePoultryId)
		throws com.agriculture.application.form.service.exception.
			NoSuchAgriculturePoultryException {

		return getPersistence().findByPrimaryKey(agriculturePoultryId);
	}
	 ...
	 */
	public static AgriculturePoultry fetchByPrimaryKey(
		long agriculturePoultryId) {

		return getPersistence().fetchByPrimaryKey(agriculturePoultryId);
	}
	 ...
	 */
	public static List<AgriculturePoultry> findAll() {
	 ...
	 */
	public static List<AgriculturePoultry> findAll(int start, int end) {
	...
	public static AgriculturePoultryPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		AgriculturePoultryPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile AgriculturePoultryPersistence _persistence;
