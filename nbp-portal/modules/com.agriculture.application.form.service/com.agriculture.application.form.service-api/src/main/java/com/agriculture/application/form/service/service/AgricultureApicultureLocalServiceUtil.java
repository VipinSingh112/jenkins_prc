...
/**
 * Provides the local service utility for AgricultureApiculture. This utility wraps
 * <code>com.agriculture.application.form.service.service.impl.AgricultureApicultureLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AgricultureApicultureLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgricultureApicultureLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AgricultureApiculture addAgricultureApiculture(
		AgricultureApiculture agricultureApiculture) {

		return getService().addAgricultureApiculture(agricultureApiculture);
	}
	 ...
	 */
	public static AgricultureApiculture createAgricultureApiculture(
		long agricultureApicultureId) {

		return getService().createAgricultureApiculture(
	...
	public static void deleteAgriApicultureById(long applicationId) {
		getService().deleteAgriApicultureById(applicationId);
	}
	 ...
	 */
	public static AgricultureApiculture deleteAgricultureApiculture(
		AgricultureApiculture agricultureApiculture) {

		return getService().deleteAgricultureApiculture(agricultureApiculture);
	}
	...
	public static AgricultureApiculture deleteAgricultureApiculture(
		...
		return getService().deleteAgricultureApiculture(
			agricultureApicultureId);
	}
	...
	public static AgricultureApiculture fetchAgricultureApiculture(
		long agricultureApicultureId) {

		return getService().fetchAgricultureApiculture(agricultureApicultureId);
	}

	public static List<AgricultureApiculture> getAApi_by_AAI(
		long agricultureApplicationId) {

		return getService().getAApi_by_AAI(agricultureApplicationId);
	}
	 ...
	 * @throws PortalException if a agriculture apiculture with the primary key could not be found
	 */
	public static AgricultureApiculture getAgricultureApiculture(
			long agricultureApicultureId)
		throws PortalException {

		return getService().getAgricultureApiculture(agricultureApicultureId);
	}
	 ...
	 */
	public static List<AgricultureApiculture> getAgricultureApicultures(
		int start, int end) {

		return getService().getAgricultureApicultures(start, end);
	}
	 ...
	 */
	public static int getAgricultureApiculturesCount() {
		return getService().getAgricultureApiculturesCount();
	}

	public static AgricultureApiculture getAgricultureById(long ApplicationId)
	 ...
	 */
	public static AgricultureApiculture updateAgricultureApiculture(
		AgricultureApiculture agricultureApiculture) {

		return getService().updateAgricultureApiculture(agricultureApiculture);
	}

	public static AgricultureApicultureLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AgricultureApicultureLocalService>
		_serviceSnapshot = new Snapshot<>(
			AgricultureApicultureLocalServiceUtil.class,
