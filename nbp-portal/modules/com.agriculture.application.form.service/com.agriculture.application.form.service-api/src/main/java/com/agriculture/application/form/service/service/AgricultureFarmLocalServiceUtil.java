...
/**
 * Provides the local service utility for AgricultureFarm. This utility wraps
 * <code>com.agriculture.application.form.service.service.impl.AgricultureFarmLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AgricultureFarmLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgricultureFarmLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AgricultureFarm addAgricultureFarm(
		AgricultureFarm agricultureFarm) {

		return getService().addAgricultureFarm(agricultureFarm);
	}
	 ...
	 */
	public static AgricultureFarm createAgricultureFarm(
		long agricultureFarmId) {

		return getService().createAgricultureFarm(agricultureFarmId);
	}
	 ...
	 */
	public static AgricultureFarm deleteAgricultureFarm(
		AgricultureFarm agricultureFarm) {

		return getService().deleteAgricultureFarm(agricultureFarm);
	}
	 ...
	 */
	public static AgricultureFarm deleteAgricultureFarm(long agricultureFarmId)
		throws PortalException {

		return getService().deleteAgricultureFarm(agricultureFarmId);
	}

	public static void deleteAgriFarmerById(long applicationId) {
		getService().deleteAgriFarmerById(applicationId);
	}
	...
	public static AgricultureFarm fetchAgricultureFarm(long agricultureFarmId) {
		return getService().fetchAgricultureFarm(agricultureFarmId);
	}
	...
	public static List<AgricultureFarm> getAFa_by_AAI(
		long agricultureApplicationId) {

		return getService().getAFa_by_AAI(agricultureApplicationId);
	}

	public static AgricultureFarm getAgricultureById(long ApplicationId)
	 ...
	 * @throws PortalException if a agriculture farm with the primary key could not be found
	 */
	public static AgricultureFarm getAgricultureFarm(long agricultureFarmId)
		throws PortalException {

		return getService().getAgricultureFarm(agricultureFarmId);
	}
	 ...
	 */
	public static List<AgricultureFarm> getAgricultureFarms(
		int start, int end) {

		return getService().getAgricultureFarms(start, end);
	}
	 ...
	 */
	public static int getAgricultureFarmsCount() {
		return getService().getAgricultureFarmsCount();
	}
	 ...
	 */
	public static AgricultureFarm updateAgricultureFarm(
		AgricultureFarm agricultureFarm) {

		return getService().updateAgricultureFarm(agricultureFarm);
	}

	public static AgricultureFarmLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AgricultureFarmLocalService>
		_serviceSnapshot = new Snapshot<>(
			AgricultureFarmLocalServiceUtil.class,
			AgricultureFarmLocalService.class);
