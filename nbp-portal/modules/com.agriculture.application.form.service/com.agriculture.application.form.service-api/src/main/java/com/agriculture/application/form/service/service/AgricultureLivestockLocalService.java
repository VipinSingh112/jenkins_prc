...
/**
 * Provides the local service interface for AgricultureLivestock. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AgricultureLivestockLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgricultureLivestockLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgricultureLivestockLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agriculture livestock local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgricultureLivestockLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureLivestock getAgricultureById(long ApplicationId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureLivestock> getAL_by_AAI(
