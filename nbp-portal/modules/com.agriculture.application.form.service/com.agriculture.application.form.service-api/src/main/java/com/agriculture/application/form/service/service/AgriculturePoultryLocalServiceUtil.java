...
/**
 * Provides the local service utility for AgriculturePoultry. This utility wraps
 * <code>com.agriculture.application.form.service.service.impl.AgriculturePoultryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AgriculturePoultryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgriculturePoultryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AgriculturePoultry addAgriculturePoultry(
		AgriculturePoultry agriculturePoultry) {

		return getService().addAgriculturePoultry(agriculturePoultry);
	}
	 ...
	 */
	public static AgriculturePoultry createAgriculturePoultry(
		long agriculturePoultryId) {

		return getService().createAgriculturePoultry(agriculturePoultryId);
	}
	 ...
	 */
	public static AgriculturePoultry deleteAgriculturePoultry(
		AgriculturePoultry agriculturePoultry) {

		return getService().deleteAgriculturePoultry(agriculturePoultry);
	}
	...
	public static AgriculturePoultry deleteAgriculturePoultry(
		...
		return getService().deleteAgriculturePoultry(agriculturePoultryId);
	}

	public static void deleteAgriPoultryById(long applicationId) {
		getService().deleteAgriPoultryById(applicationId);
	}
	...
	public static AgriculturePoultry fetchAgriculturePoultry(
		long agriculturePoultryId) {

		return getService().fetchAgriculturePoultry(agriculturePoultryId);
	}
	...
	public static AgriculturePoultry getAgricultureById(long ApplicationId)
	 ...
	 */
	public static List<AgriculturePoultry> getAgriculturePoultries(
		int start, int end) {

		return getService().getAgriculturePoultries(start, end);
	}
	 ...
	 */
	public static int getAgriculturePoultriesCount() {
		return getService().getAgriculturePoultriesCount();
	}
	 ...
	 * @throws PortalException if a agriculture poultry with the primary key could not be found
	 */
	public static AgriculturePoultry getAgriculturePoultry(
			long agriculturePoultryId)
		throws PortalException {

		return getService().getAgriculturePoultry(agriculturePoultryId);
	}

	public static List<AgriculturePoultry> getAP_by_AAI(
		long agricultureApplicationId) {

		return getService().getAP_by_AAI(agricultureApplicationId);
	}
	 ...
	 */
	public static AgriculturePoultry updateAgriculturePoultry(
		AgriculturePoultry agriculturePoultry) {

		return getService().updateAgriculturePoultry(agriculturePoultry);
	}

	public static AgriculturePoultryLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<AgriculturePoultryLocalService>
		_serviceSnapshot = new Snapshot<>(
			AgriculturePoultryLocalServiceUtil.class,
			AgriculturePoultryLocalService.class);
