...
/**
 * Provides the local service interface for AgricultureBuilding. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AgricultureBuildingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgricultureBuildingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.agriculture.application.form.service.service.impl.AgricultureBuildingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agriculture building local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgricultureBuildingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AgricultureBuilding> getAB_by_AAI(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AgricultureBuilding getAgricultureById(long ApplicationId)
