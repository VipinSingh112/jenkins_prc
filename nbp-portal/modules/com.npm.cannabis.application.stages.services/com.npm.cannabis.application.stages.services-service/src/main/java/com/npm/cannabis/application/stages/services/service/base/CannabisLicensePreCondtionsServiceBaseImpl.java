...
import com.npm.cannabis.application.stages.services.service.CannabisLicensePreCondtionsService;
...
/**
 * Provides the base implementation for the cannabis license pre condtions remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePreCondtionsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePreCondtionsServiceImpl
 * @generated
 */
public abstract class CannabisLicensePreCondtionsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisLicensePreCondtionsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisLicensePreCondtionsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisLicensePreCondtionsServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		cannabisLicensePreCondtionsService =
			(CannabisLicensePreCondtionsService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisLicensePreCondtionsService.class.getName();
	}
	...
	protected CannabisLicensePreCondtionsService
		cannabisLicensePreCondtionsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisLicensePreCondtionsServiceBaseImpl.class);
