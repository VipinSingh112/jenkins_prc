...
import com.npm.cannabis.application.stages.services.service.CannabisLicenseService;
...
/**
 * Provides the base implementation for the cannabis license remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisLicenseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisLicenseServiceImpl
 * @generated
 */
public abstract class CannabisLicenseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisLicenseService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisLicenseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisLicenseServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CannabisLicenseService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cannabisLicenseService = (CannabisLicenseService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisLicenseService.class.getName();
	}
	...
	protected CannabisLicenseService cannabisLicenseService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisLicenseServiceBaseImpl.class);
