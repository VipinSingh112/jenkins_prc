...
import com.npm.cannabis.application.stages.services.service.CannabisInspectionService;
...
/**
 * Provides the base implementation for the cannabis inspection remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisInspectionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisInspectionServiceImpl
 * @generated
 */
public abstract class CannabisInspectionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisInspectionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisInspectionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisInspectionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CannabisInspectionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cannabisInspectionService = (CannabisInspectionService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisInspectionService.class.getName();
	}
	...
	protected CannabisInspectionService cannabisInspectionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisInspectionServiceBaseImpl.class);
