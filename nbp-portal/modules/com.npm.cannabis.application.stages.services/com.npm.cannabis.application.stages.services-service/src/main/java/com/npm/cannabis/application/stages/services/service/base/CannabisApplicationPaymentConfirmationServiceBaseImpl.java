...
import com.npm.cannabis.application.stages.services.service.CannabisApplicationPaymentConfirmationService;
...
/**
 * Provides the base implementation for the cannabis application payment confirmation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisApplicationPaymentConfirmationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisApplicationPaymentConfirmationServiceImpl
 * @generated
 */
public abstract class CannabisApplicationPaymentConfirmationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisApplicationPaymentConfirmationService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisApplicationPaymentConfirmationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisApplicationPaymentConfirmationServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		cannabisApplicationPaymentConfirmationService =
			(CannabisApplicationPaymentConfirmationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisApplicationPaymentConfirmationService.class.getName();
	}
	...
	protected CannabisApplicationPaymentConfirmationService
		cannabisApplicationPaymentConfirmationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisApplicationPaymentConfirmationServiceBaseImpl.class);
