...
import com.npm.cannabis.application.stages.services.service.CannabisLicensePaymentLocalService;
...
/**
 * Provides the base implementation for the cannabis license payment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePaymentLocalServiceImpl
 * @generated
 */
public abstract class CannabisLicensePaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CannabisLicensePaymentLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisLicensePaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisLicensePaymentLocalServiceUtil</code>.
	 */
	...
	public CannabisLicensePayment addCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.update(cannabisLicensePayment);
	}
	...
	public CannabisLicensePayment createCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.create(
	...
	public CannabisLicensePayment deleteCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.remove(
			cannabisLicensePaymentId);
	}
	...
	public CannabisLicensePayment deleteCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.remove(cannabisLicensePayment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return cannabisLicensePaymentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CannabisLicensePayment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return cannabisLicensePaymentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return cannabisLicensePaymentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public CannabisLicensePayment fetchCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.fetchByPrimaryKey(
			cannabisLicensePaymentId);
	}
	...
	public CannabisLicensePayment getCannabisLicensePayment(
		...
		return cannabisLicensePaymentPersistence.findByPrimaryKey(
			cannabisLicensePaymentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(CannabisLicensePayment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CannabisLicensePaymentLocalServiceImpl#deleteCannabisLicensePayment(CannabisLicensePayment) to avoid orphaned data");
		}

		return cannabisLicensePaymentLocalService.deleteCannabisLicensePayment(
			(CannabisLicensePayment)persistedModel);
	}

	@Override
	public BasePersistence<CannabisLicensePayment> getBasePersistence() {
		return cannabisLicensePaymentPersistence;
	}
	...
	public List<CannabisLicensePayment> getCannabisLicensePayments(
		...
		return cannabisLicensePaymentPersistence.findAll(start, end);
	}
	...
	public int getCannabisLicensePaymentsCount() {
		return cannabisLicensePaymentPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		cannabisLicensePaymentLocalService =
			(CannabisLicensePaymentLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisLicensePaymentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				cannabisLicensePaymentPersistence.getDataSource();
	...
	protected CannabisLicensePaymentLocalService
		cannabisLicensePaymentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisLicensePaymentLocalServiceBaseImpl.class);
