...
import com.npm.cannabis.application.stages.services.service.CannabisLicensePaymentService;
...
/**
 * Provides the base implementation for the cannabis license payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePaymentServiceImpl
 * @generated
 */
public abstract class CannabisLicensePaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CannabisLicensePaymentService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CannabisLicensePaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.npm.cannabis.application.stages.services.service.CannabisLicensePaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CannabisLicensePaymentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cannabisLicensePaymentService = (CannabisLicensePaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CannabisLicensePaymentService.class.getName();
	}
	...
	protected CannabisLicensePaymentService cannabisLicensePaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CannabisLicensePaymentServiceBaseImpl.class);
