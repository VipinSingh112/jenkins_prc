...
/**
 * Provides the local service utility for CannabisDeskVerification. This utility wraps
 * <code>com.npm.cannabis.application.stages.services.service.impl.CannabisDeskVerificationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CannabisDeskVerificationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.npm.cannabis.application.stages.services.service.impl.CannabisDeskVerificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CannabisDeskVerification addCannabisDeskVerification(
		CannabisDeskVerification cannabisDeskVerification) {

		return getService().addCannabisDeskVerification(
	 ...
	 */
	public static CannabisDeskVerification createCannabisDeskVerification(
		long cannabisDeskVerificationId) {

		return getService().createCannabisDeskVerification(
	 ...
	 */
	public static CannabisDeskVerification deleteCannabisDeskVerification(
		CannabisDeskVerification cannabisDeskVerification) {

		return getService().deleteCannabisDeskVerification(
			cannabisDeskVerification);
	}
	...
	public static CannabisDeskVerification fetchCannabisDeskVerification(
		long cannabisDeskVerificationId) {

		return getService().fetchCannabisDeskVerification(
			cannabisDeskVerificationId);
	}
	 ...
	 * @throws PortalException if a cannabis desk verification with the primary key could not be found
	 */
	public static CannabisDeskVerification getCannabisDeskVerification(
			long cannabisDeskVerificationId)
		throws PortalException {

		return getService().getCannabisDeskVerification(
			cannabisDeskVerificationId);
	}
	 ...
	 */
	public static List<CannabisDeskVerification> getCannabisDeskVerifications(
		int start, int end) {

		return getService().getCannabisDeskVerifications(start, end);
	}
	 ...
	 */
	public static int getCannabisDeskVerificationsCount() {
		return getService().getCannabisDeskVerificationsCount();
	}
	 ...
	 */
	public static CannabisDeskVerification updateCannabisDeskVerification(
		CannabisDeskVerification cannabisDeskVerification) {

		return getService().updateCannabisDeskVerification(
			cannabisDeskVerification);
	}

	public static CannabisDeskVerificationLocalService getService() {
		return _service;
	}

	private static volatile CannabisDeskVerificationLocalService _service;
