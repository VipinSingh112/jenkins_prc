...
/**
 * Provides the local service interface for CannabisConditionalLicensePreCondtions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CannabisConditionalLicensePreCondtionsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CannabisConditionalLicensePreCondtionsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.npm.cannabis.application.stages.services.service.impl.CannabisConditionalLicensePreCondtionsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cannabis conditional license pre condtions local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CannabisConditionalLicensePreCondtionsLocalServiceUtil} if injection and service tracking are not available.
	 */
