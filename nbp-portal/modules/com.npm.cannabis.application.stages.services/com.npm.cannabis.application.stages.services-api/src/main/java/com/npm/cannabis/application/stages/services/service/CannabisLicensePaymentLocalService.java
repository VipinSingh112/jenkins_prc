...
/**
 * Provides the local service interface for CannabisLicensePayment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CannabisLicensePaymentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CannabisLicensePaymentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.npm.cannabis.application.stages.services.service.impl.CannabisLicensePaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cannabis license payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CannabisLicensePaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CannabisLicensePayment addCannabisLicensePayment(
	...
	public CannabisLicensePayment createCannabisLicensePayment(
	...
	public CannabisLicensePayment deleteCannabisLicensePayment(
		CannabisLicensePayment cannabisLicensePayment);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CannabisLicensePayment fetchCannabisLicensePayment(
		long cannabisLicensePaymentId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CannabisLicensePayment getCannabisLicenceByPayment(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CannabisLicensePayment getCannabisLicensePayment(
			long cannabisLicensePaymentId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CannabisLicensePayment> getCannabisLicensePayments(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public CannabisLicensePayment updateCannabisLicensePayment(
		CannabisLicensePayment cannabisLicensePayment);
