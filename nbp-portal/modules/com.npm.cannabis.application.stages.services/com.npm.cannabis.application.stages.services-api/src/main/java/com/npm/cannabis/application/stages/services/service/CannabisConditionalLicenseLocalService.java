...
/**
 * Provides the local service interface for CannabisConditionalLicense. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CannabisConditionalLicenseLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CannabisConditionalLicenseLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.npm.cannabis.application.stages.services.service.impl.CannabisConditionalLicenseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cannabis conditional license local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CannabisConditionalLicenseLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CannabisConditionalLicense getCannabisConditionalLicenseByCaseId(
			String caseId)
	...
	public CannabisConditionalLicense updateCannabisConditionalLicense(
		String caseId, String numberOfextension, Date issueDate,
		Date expirationDate, String listOfPreConditions, long licenseFileId);
