...
/**
 * Provides the local service interface for HSRAPaymentConfirmation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HSRAPaymentConfirmationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HSRAPaymentConfirmationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.stage.services.service.impl.HSRAPaymentConfirmationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hsra payment confirmation local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HSRAPaymentConfirmationLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HSRAPaymentConfirmation> getHSRAPaymentConfirmations_List_By_CI(
		String caseId);
	...
	public HSRAPaymentConfirmation updateHSRAPaymentConfirmationData(
