...
/**
 * Provides the local service interface for HsraInspection. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HsraInspectionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HsraInspectionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.hsra.stage.services.service.impl.HsraInspectionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the hsra inspection local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link HsraInspectionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HsraInspection> getHsra_CaseIdApplicationId(
		String status, long hsraApplicationId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HsraInspection> getHsra_CaseIdStatus(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<HsraInspection> getHsra_StatusApplicationId(
		String status, long hsraApplicationId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HsraInspection getHsraInspectionBy_CI(String caseId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public HsraInspection getInspectionByStatus_SlotBoooked_ApplicationId(
