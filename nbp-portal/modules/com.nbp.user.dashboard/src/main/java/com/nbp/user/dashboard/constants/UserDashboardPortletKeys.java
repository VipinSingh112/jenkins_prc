package com.nbp.user.dashboard.constants;

/**
 * @author hp
 */
public class UserDashboardPortletKeys {

	public static final String USERDASHBOARD =
		"com_nbp_user_dashboard_UserDashboardPortlet";
	...
	public static final String COLLEBORATION_FACTORIES_REGISTRATION = "Factories Registration";
