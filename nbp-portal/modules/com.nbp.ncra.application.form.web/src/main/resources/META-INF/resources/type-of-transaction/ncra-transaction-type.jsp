<fieldset class="wizard-fieldset" id="ncraTransactionFieldset" name="TYPE OF TRANSACTION">
    <div class="row">
        <div class="col-md-12 pt-3">
            <p class="common-section-small-heading">Type of Transaction</p>
        </div>
        <div class="col-md-12" id="ncra-type-option-box">
            <div class="row wizard-cards-list">
                <div class="col-lg-6">
	                <div class="wizard-card" id="ncraNewBtn">
	                    <a href="javascript:;">
	                        ...
	                        <div class="wizard-card-content-box">
	                            <p class="wizard-title f2">New Request</p>
	                        </div>
	                    </a>
	                </div>
	            </div>
                <div class="col-lg-6" id="ncraRenewBtn">
                    <div class="wizard-card">
                        <a href="javascript:;">
                            ...
                            <div class="wizard-card-content-box">
                                <p class="wizard-title f2">Request for Re-Verification</p>
                            </div>
                        </a>
                    </div>
                    <input type="hidden" id="ncra-type-of-tenure-value" name="ncra-type-of-tenure-value">  
                </div>
           </div>
        </div>
    </div>
    <section class="hide" id="ncraRenewSection"> 
		<hr> 
        	<div class="row"> 
          		<div class="col-md-12"> 
             				...
             				<div class="row"> 
              					<div class="col-md-12"> 
              						<div class="form-group"> 
						                ...
						                <input type="text" class="form-control" id="renew-licence-number" 
						                 placeholder="Transaction Number" value="" oninput="this.value = this.value.replace(/[^0-9\/]/g, '').replace(/(\..*)\./g, '$1');"> 
								...
								<div class="col-md-12">
              					...
              					<div class="col-md-12"> 
              						<div class="form-group"> 
						                <p class="tab-form-main-heading">Please Enter Certificate Number</p> 
						                <input type="text" class="form-control" id="renew-permit-number"  placeholder="Certificate Number" value="" oninput="this.value = this.value.replace(/[^0-9\/]/g, '').replace(/(\..*)\./g, '$1');"> 
									</div> 
								</div> 
								<div class="col-md-2"> 
 									<button class="btn common-green-bg w-100" onclick="renewLicense();" id="fire-renew-btn"  type="button">Submit</button> 
      							</div> 
     						</div> 
    					</div> 
   					</div> 
