...
<div class="uploaded-info" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
	...
	<div class="right">
		...
		<a class="uploaded-delete" href="javascript:;"  onclick="opendelNcraDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=counterOfDocuments%>')">
...
<div class="modal fade commonsavepopup" id="ncraDeletepopup<%=uploadedFile.getFileEntryId()%>" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display:none;">
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="deleteNcraUploadedDocumentForGeneric('<%=uploadedFile.getFileEntryId()%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
