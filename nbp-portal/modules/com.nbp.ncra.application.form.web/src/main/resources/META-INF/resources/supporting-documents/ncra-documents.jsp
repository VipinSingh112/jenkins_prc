...
<fieldset class="wizard-fieldset" id="ncraSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<input type="hidden" id="ncraDocumentCounter"
								name="ncraDocumentCounter"> 
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="ncraGenericUpload" multiple="multiple"
				name="<portlet:namespace/>ncraGenericUpload" onchange="attachDetailed(this.id)"
				hidden=""> <label class="custom-upload"
				for="ncraGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="ncraGenericFileChosen"></span>
		</div>
		<div id="uploaded-documents-container">
		   ...
		   <!-- <a class="uploaded-delete mr-2" href="#" style="display: none;">
			...
			<%int genericCounter=50;
			
			FileEntry fileEntryForGeneric = null;
			if (genericFileEntry != null) {
				for (DLFileEntry uploadedFile : genericFileEntry) {
					try {
		...
		%>
		<div class="supporting-document-card mb-2"
			id="genericSupportingDocuments<%=genericCounter%>">
			<div class="row">
				<div class="col-md-12"
					id="uploadedFormResult<%=genericCounter%>">
					<%
					...
					<div class="modal-footer border-0 d-flex justify-content-end">
						<div>
							<a href="javascript:;"
								...
								onclick="uploadDocumentInNcra();"> Submit<span class="ml-2">
							</span>
							</a>
						</div>
					</div>
