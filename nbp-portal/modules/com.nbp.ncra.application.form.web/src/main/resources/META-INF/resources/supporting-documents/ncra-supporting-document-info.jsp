...
<div class="uploaded-info" id="unpload-info-card<%=fileEntryId%>">
	...
	<div class="right">
		...
		<%-- <a class="uploaded-actionlink" href="javascript:;"  onclick="manuPreviewDocument('<%=fileEntryId%>')">
			<span class="mr-2"> 
		...
		<a class="uploaded-delete" href="javascript:void();"  onclick="opendelNcraDocPopup('<%=fileEntryId%>','<%=documentuploadCounter%>')">
...
<div class="modal fade commonsavepopup" id="ncraDeletepopup<%=fileEntryId%>" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" style="display:none;">
    <div class="modal-dialog modal-dialog-centered my-0 modal-dialog-sm">
        <div class="modal-content">
      		<div class="modal-pic">
            ...
            <div class="modal-footer border-0 d-flex justify-content-end">
                <a href="javascript:;" class="common-yellow-bg text-dark common-nav-links text-white popup-dashboard" onClick="deleteNcraUploadedDocument('<%=fileEntryId%>','<%=title%>');">
                    Yes<span class="ml-2">
                    </span>
                </a>
