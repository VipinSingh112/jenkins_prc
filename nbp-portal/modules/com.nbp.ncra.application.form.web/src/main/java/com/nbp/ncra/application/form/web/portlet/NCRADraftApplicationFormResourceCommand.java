...
@Component(
		...
		property = { "javax.portlet.name="+ NCRAApplicationFormPortletKeys.NCRAAPPLICATIONFORM,
				"mvc.command.name=draft/Application/Ncra" }, service = MVCResourceCommand.class)

public class NCRADraftApplicationFormResourceCommand implements MVCResourceCommand{

	@Override
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
			throws PortletException {
			System.out.println(" Draft Called");
		...
		//private static Log _log = LogFactoryUtil.getLog(NCRAPendingApplicationFormResourceCommand.class.getName());
			...
			System.out.println("Application -----Id--"+ncraApplicationId);
			...
			System.out.println("Draft end--"+application.getNcraApplicationId());
			try {
