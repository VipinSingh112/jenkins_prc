			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="testingApplicantName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getNameOfApplicant())?labMedicalAppliInfo.getNameOfApplicant():""%>" placeholder="Applicant Name" />
						<p class="tab-form-sub-heading fieldAlert hide" id="testingApplicantNameValidation" style="color: red;">Please enter Name of Applicant</p>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<p class="tab-form-main-heading"><span class="tab-form-highlghtme-link pr-2">2.</span> Applicant's Address</p>
						<textarea rows="3" class="mt-3 form-control" maxlength="255" id="testingApplicantAddress" placeholder="Address" style="border-radius: 5px; width: 100%"><%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getApplicantAddress())?labMedicalAppliInfo.getApplicantAddress():""%></textarea>
					</div>
				</div>
				<div class="col-md-12"> 
				...
				<div class="col-md-4"> 
					<div class="form-group mt-2"> 
					 ...
					 <input type="text" class="form-control" id="testingApplicantTelephone" placeholder="+1 876-876-1234" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAppliTelephoneNo())?labMedicalAppliInfo.getAppliTelephoneNo():""%>" oninput="this.value = this.value.replace(/[^0-9\-\+]+/g, '').replace(/(\..*)\./g, '$1');"> 
					</div> 
				</div>
				<div class="col-md-4"> 
					<div class="form-group mt-2"> 
					 <p class="tab-form-sub-heading">Fax No.</p> 
					 <input type="text" class="form-control" id="testingApplicantFax" placeholder="" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAppliFaxNo())?labMedicalAppliInfo.getAppliFaxNo():""%>"
				...
				<div class="col-md-4"> 
					<div class="form-group mt-2"> 
					 ...
					 <input type="text" class="form-control" id="testingApplicantWebsite" placeholder="" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAppliWebsite())?labMedicalAppliInfo.getAppliWebsite():""%>"> 
					</div> 
				</div>
				<div class="col-md-12">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="testingLaboratoryName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getLaboratoryName())?labMedicalAppliInfo.getLaboratoryName():""%>" placeholder="" aria-describedby="laboratorySeekingName"/>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<p class="tab-form-main-heading"><span class="tab-form-highlghtme-link pr-2">5.</span> Address of Laboratory Seeking Accreditation  (If different from Applicant's Address)
						</p>
						<textarea rows="3" class="mt-3 form-control" maxlength="255" id="testingLaboratoryAddress" placeholder="Address" style="border-radius: 5px; width: 100%" aria-describedby="laboratorySeekingAddress"><%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getLaboratoryAddress())?labMedicalAppliInfo.getLaboratoryAddress():""%></textarea>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="row">
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getNameOfIncharge())?labMedicalAppliInfo.getNameOfIncharge():""%>" placeholder="Name"/>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelEmail" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getEmailOfIncharge())?labMedicalAppliInfo.getEmailOfIncharge():""%>" placeholder="info@companyname.jm"/>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="row">
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelQMName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getPersonnelQMName())?labMedicalAppliInfo.getPersonnelQMName():""%>" placeholder="Name"/>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelQMEmail" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getPersonnelQMEmail())?labMedicalAppliInfo.getPersonnelQMEmail():""%>" placeholder="info@companyname.jm"/>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="row">
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingDeputyName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getDeputyInchargeName())?labMedicalAppliInfo.getDeputyInchargeName():""%>" placeholder="Name"/>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingDeputyEmail" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getDeputyInchargeEmail())?labMedicalAppliInfo.getDeputyInchargeEmail():""%>" placeholder="info@companyname.jm"/>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<p class="tab-form-main-heading"><span class="tab-form-highlghtme-link pr-2">9.</span> Name & Email Address of Personnel with Responsibility for
					Financial Matters</p>
						<div class="row">
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelFMName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getPersonnelFMName())?labMedicalAppliInfo.getPersonnelFMName():""%>" placeholder="Name"/>
							</div>
							<div class="col-md-6">
								<input type="text" class="form-control" id="testingPersonnelFMEmail" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getPersonnelFMEmail())?labMedicalAppliInfo.getPersonnelFMEmail():""%>" placeholder="info@companyname.jm"/>
							</div>
						</div>
				...
				<div class="col-md-12">
					<input id="personnelResponsibleTestingVal" type="hidden" name="personnelResponsibleTestingVal" value="1">
					<div class="">
						<div class="accordion secured-accordian"
							id="personnelResponsibleTestingDetailBox">
							<div class="accordion__header is-active"
								id="personnelResponsibleTestingDetail" onclick="expandDetails(this.id)">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control"
												id="technicalPersonnelNameTesting" value="" placeholder="">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control"
												id="technicalPersonnelEmailTesting" value="" placeholder="">
										</div>
									</div>
									<div class="col-md-12 d-flex justify-content-end py-4">
										<a href="javascript:void(0);" class="add-more-employee" id="addPersonnelResponsibleTestingDetail" onclick="addPersonnelResponsibleTestingDetail();"> 
											<span>+ 1</span>
											Add More
										</a>
									</div>
				...
				<div class="col-12 table-responsive hide addPersonnelResponsibleTestingDetailTableBox">
...
<td> 
	<span> 
		<a href="javascript:void(0)" id="testingSpecimenCollectionEditTab" onclick="testingSpecimenCollectionEditTab('<%=LabMedicalAppliInfoAddCounter%>');"> 
   ...
   <td> 
<span> 
	<a href="javascript:void(0)" id="testingSpecimenCollectionDeleteDataTab" onclick="testingSpecimenCollectionDeleteData('<%=LabMedicalAppliInfoAddCounter%>');"> 
     ...
     <input type="hidden" id="testingSpecimenCollectionId<%=LabMedicalAppliInfoAddCounter%>" name="testingSpecimenCollectionId<%=LabMedicalAppliInfoAddCounter%>" value="<%=labAppliInfo.getAddLabAppliInfoId()%>">
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="wizard-form-radio d-block">
							<input value="1st Accreditation" type="radio"<%=labMedicalAppliInfo!=null &&labMedicalAppliInfo.getAccRequestType().equals("1st Accreditation")? "checked":StringPool.BLANK%> name="testingAccreditationRequest">
							<label for="testingAccreditationRequest">1st Accreditation</label>
						</div>
						<div class="wizard-form-radio d-block">
							<input value="Extension of Scope" type="radio"<%=labMedicalAppliInfo!=null &&labMedicalAppliInfo.getAccRequestType().equals("Extension of Scope")? "checked":StringPool.BLANK%> name="testingAccreditationRequest">
							<label for="testingAccreditationRequest">Extension of Scope</label>
						</div>

					</div>
				</div>
				<div class="col-md-12"> 
					<p class="tab-form-main-heading">We hereby apply for accreditation for the testing activity detailed in the attached documents.</p> 
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="testingAuthorizedPersonnelName" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAuthorizedPersonnelName())?labMedicalAppliInfo.getAuthorizedPersonnelName():""%>" placeholder=""/>
						<p class="tab-form-sub-heading fieldAlert hide" id="testingAuthorizedPersonnelNameValidation" style="color: red;">Please enter Name of Authorized Personnel</p>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<p class="tab-form-main-heading">Position</p>
						<input type="text" class="form-control" id="testingAuthorizedPersonnelPosition" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAuthorizedPosition())?labMedicalAppliInfo.getAuthorizedPosition():""%>" placeholder=""/>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<p class="tab-form-main-heading">Date</p>
						<input type="date" class="form-control" id="testingAuthorizedPersonnelDate" value="<%=Validator.isNotNull(labMedicalAppliInfo)&&Validator.isNotNull(labMedicalAppliInfo.getAuthorizedPersonnelDate())?new SimpleDateFormat("yyyy-MM-dd").format(labMedicalAppliInfo.getAuthorizedPersonnelDate()):""%>" placeholder=""/>
					</div>
				</div>
				<div class="col-md-12">
					<p class="pt-2 common-para"><span class="tab-form-highlghtme-link pr-2">13.</span> Signature of Authorized Personnel</p>
					<div class="signature_texarea mb-2" id="authorizedPersonnelTestingImageHolder">
					<%if(Validator.isNotNull(signAuthPersonnelTest)){ %>
							<img src="<%=signAuthPersonnelTest%>"  width="100" height="100"/>
							<%} %></div>
					<input type="file" id="authorizedPersonnelTestingBtn" hidden="" name="<portlet:namespace/>authorizedPersonnelTestingBtn">
					<label for="authorizedPersonnelTestingBtn" class="choose-sign-btn">
				...
				<div class="col-md-12">
					...
					<div class="signature_texarea mb-2" id="companyStampTestingImageHolder">
					<%if(Validator.isNotNull(companyStampTest)){ %>
							<img src="<%=companyStampTest%>"  width="100" height="100"/>
							<%} %></div>
					<input type="file" id="companyStampTestingBtn" hidden="" name="<portlet:namespace/>companyStampTestingBtn">
					<label for="companyStampTestingBtn" class="choose-sign-btn">
						<span class="mr-2"> <svg width="14" height="17"
								viewBox="0 0 14 17" fill="none"
								xmlns="http://www.w3.org/2000/svg"> 
								<path
				...
				<div class="col-md-12">
					...
					<p class="tab-form-main-heading">
						<b>
							If, at any point during the application or initial assessment process there is evidence of fraudulent 
							behaviour, or if the CAB intentionally provides false information or conceals information, JANAAC shall 
							reject the application or terminate the assessment process.
						</b>
					</p>
				</div>
			</div>
	...
	<button type="button" id="saveName" onclick="accMediLabTestingApplicationInfo(false);"
			...
			<div class="row">
				<div class="col-md-12"> 
					<ul class="list-group tab-form-sub-heading mb-3"> 
						...
						Assessment Body Accreditation - JANAAC/DOC/33; JANAAC Requirements for Measurement Uncertainty-JANAAC/DOC/23 and Requirements 
						for Measurement Traceability-JANAAC/DOC/24 on the JANAAC website or in your information package) and standards that pertain to 
						their facilities and the accreditation being sought, and ensure that these are understood and fulfilled to the best of the applicant's
						 ability, before submitting the completed Application Form and Questionnaire for Accreditation of Testing Laboratories. Applicants 
						 should review the relevant requirements (please see the General Criteria for Conformity Assessment Body Accreditation - JANAAC/DOC/33; 
						 JANAAC Requirements for Measurement Uncertainty-JANAAC/DOC/23 and Requirements for Measurement Traceability-JANAAC/DOC/24 on 
						 the JANAAC website or in your information package) and standards that pertain to their facilities and the accreditation being sought, 
						 and ensure that these are understood and fulfilled to the best of the applicant's ability, before submitting the completed Application 
						 Form and Questionnaire for Accreditation of Testing Laboratories.</li> 
						...
						may be submitted, but must be clearly titled as appendices and referenced to specific questions on your application form and questionnaire.</li> 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="checkbox-form-group second-custom-checkbox">
							<input type="checkbox" id="testingClinicalActivity1" value="Main Laboratory"<%=labMedicalTestDesc!=null &&labMedicalTestDesc.getTestClinicalActivity().contains("Main Laboratory")? "checked":StringPool.BLANK%> name="testingClinicalActivity"> 
							<label for="testingClinicalActivity1" class="mb-0">
						...
						<div class="checkbox-form-group second-custom-checkbox">
							<input type="checkbox" id="testingClinicalActivity2" value="Branch Laboratory"<%=labMedicalTestDesc!=null &&labMedicalTestDesc.getTestClinicalActivity().contains("Branch Laboratory")? "checked":StringPool.BLANK%> name="testingClinicalActivity"> 
							<label for="testingClinicalActivity2" class="mb-0">
						...
						<div class="checkbox-form-group second-custom-checkbox">
							<input type="checkbox" id="testingClinicalActivity3" value="Satellite"<%=labMedicalTestDesc!=null &&labMedicalTestDesc.getTestClinicalActivity().contains("Satellite")? "checked":StringPool.BLANK%> name="testingClinicalActivity"> 
							<label for="testingClinicalActivity3" class="mb-0">
						...
						<div class="checkbox-form-group second-custom-checkbox">
							<input type="checkbox" id="testingClinicalActivity4" value="Mobile"<%=labMedicalTestDesc!=null &&labMedicalTestDesc.getTestClinicalActivity().contains("Mobile")? "checked":StringPool.BLANK%> name="testingClinicalActivity"> 
							<label for="testingClinicalActivity4" class="mb-0">
				...
				<div class="col-md-12"> 
					<div class="form-group"> 
						...
						<input type="text" class="form-control" id="testingLaboratoryWorkShifts" placeholder="" value="<%=Validator.isNotNull(labMedicalTestDesc)&&Validator.isNotNull(labMedicalTestDesc.getTestLabShiftWork())?labMedicalTestDesc.getTestLabShiftWork():""%>" name="testingLaboratoryWorkShifts"> 
						<p class="tab-form-sub-heading">Separate values with Enter</p>
					</div> 
				</div>
				<div class="col-md-12">
					<input id="testingSpecimenCollectionVal" type="hidden"
						name="testingSpecimenCollectionVal" value="1">
					<div class="accordion secured-accordian"
						id="testingSpecimenCollectionDetailBox">
						<div class="accordion__header is-active"
							id="testingSpecimenCollectionDetail" onclick="expandDetails(this.id)">
							<div class="d-flex align-items-center">
								<div class="d-flex align-items-center">
									<div>
										<span class="accordion__toggle"></span>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control"
											id="testingSpecimenCollectionNumber" value="" placeholder="Number"
										oninput="this.value = this.value.replace(/[^0-9\-\+]+/g, '').replace(/(\..*)\./g, '$1');">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea rows="3" class="mt-3 form-control" maxlength="255"
											id="testingSpecimenCollectionLocation" placeholder="location"
											style="border-radius: 5px; width: 100%"></textarea>
									</div>
								</div>
								<div class="col-md-12 d-flex justify-content-end py-4">
									<a href="javascript:void(0);" class="add-more-employee"
										id="addTestingSpecimenCollectionDetail"
										onclick="addTestingSpecimenCollectionDetail();"> <span>+
											1</span> Add More
									</a>
								</div>
							</div>
				...
				<div
					class="col-12 table-responsive hide addTestingSpecimenCollectionDetailTableBox">
					<table class="table table-bordered mb-3">
...
<td> 
	<span> 
		<a href="javascript:void(0)" id="testingSpecimenCollectionEditTab" onclick="testingSpecimenCollectionEditTab('<%=LabMedicalDecOfActivityCounter%>');"> 
        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg"> 
         <path d="M0 15.2498V18.9998H3.75L14.81 7.93984L11.06 4.18984L0 15.2498ZM18.41 4.33984L14.66 0.589844L12.13 3.12984L15.88 6.87984L18.41 4.33984V4.33984Z" fill="#047247"></path> 
        </svg>
      </a> 
   ...
   <td> 
<span> 
	<a href="javascript:void(0)" id="testingSpecimenCollectionDeleteDataTab" onclick="testingSpecimenCollectionDeleteData('<%=LabMedicalDecOfActivityCounter%>');"> 
		        <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
		        <path d="M1 18H13V4H1V18ZM3.46 8.88L4.87 7.47L7 9.59L9.12 7.47L10.53 8.88L8.41 11L10.53 13.12L9.12 14.53L7 12.41L4.88 14.53L3.47 13.12L5.59 11L3.46 8.88ZM10.5 1L9.5 0H4.5L3.5 1H0V3H14V1H10.5Z" fill="#047247"></path>
		        </svg>
		      </a> 
  ...
  <input type="hidden" id="testingSpecimenCollectionId<%=LabMedicalDecOfActivityCounter%>" name="testingSpecimenCollectionId<%=LabMedicalDecOfActivityCounter%>" value="<%=labMedicalDecOfActivityInfo.getAddLabDescOfActivityId()%>">
	...
	<button type="button" id="saveName" onclick="accMediLabTestingActivityDesc(false);"
		class="btn btn-primary common-yellow-bg text-dark common-nav-links next-step float-right">
		Continue to the next form section <span class="ml-2"> <svg
				width="18" height="14" viewBox="0 0 18 14" fill="none"
				xmlns="http://www.w3.org/2000/svg"> 
