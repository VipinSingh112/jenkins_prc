<%
String patientCountVal="";
patientCountVal = (String)request.getAttribute("patientCountVal");
%>
<tr class="patient-row<%=patientCountVal%>">
	<td class="sub_heading_content maternityPatientNum<%=patientCountVal%>"></td>
	<td class="sub_heading_content otherPatientNum<%=patientCountVal%>"></td>
	<td> 
		<span> 
     ...
     <td>
		<span> <a href="javascript:void(0)" id="patientCountDeleteDataTab" onclick="patientCountDeleteData('<%=patientCountVal%>');">
...
<input type="hidden" id="patientCount<%=patientCountVal%>" name="patientCount<%=patientCountVal%>" value="">