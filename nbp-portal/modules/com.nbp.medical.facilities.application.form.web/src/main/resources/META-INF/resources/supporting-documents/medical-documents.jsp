...
<fieldset class="wizard-fieldset" id="medicalSupportingDocumentFieldset" name="SUPPORTING DOCUMENTS">
	...
	<input type="hidden" id="counterForGenericDoc" name="counterForGenericDoc">
	<div class="generic-document">
		...
		<div class="right text-nowrap">
			<input type="file" id="medicalGenericUpload" multiple="multiple"
				name="<portlet:namespace/>medicalGenericUpload" onchange="attachDetailed(this.id)"
				hidden=""> <label class="custom-upload"
				for="medicalGenericUpload"> <span class="mr-2"> <svg
			...
			<span id="medicalGenericFileChosen">or drag and drop from your computer</span>
		</div>
	...
	<% String fileUrl="";
		...
		try{
		supportingDocumentsParentFolderGeneric=GettingDocumentData.getDocumentLibraryParentAndSubFolder(themeDisplay.getScopeGroupId(), medicalApplicationId);
		...
		if(medicalApplicationId>0 && dlFileEntriesGeneric!=null){
			try{
			int docOfmediAdditionalCounter=1001;
		...
		%>
		<div class="supporting-document-card mb-2 generic-document-list" id="genericSupportingDocuments<%=docOfmediAdditionalCounter%>">
			<div class="row">
					<div class="col-md-12" id="uploadedFormResult<%=docOfmediAdditionalCounter%>">
						<%
						%>
						<div class="uploaded-info generic-doc" id="unpload-info-card<%=uploadedFile.getFileEntryId()%>">
							...
							<div class="right">
								...
								<a class="uploaded-delete" href="javascript:;"  onclick="opendelDocPopup('<%=uploadedFile.getFileEntryId()%>','<%=docOfmediAdditionalCounter%>')">
								...
								<div class="row">
									...
									<div class="col-md-6 mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="medicalEnrollDocuments" onchange="attachDetailed(this.id)"
												name="<portlet:namespace/>medicalEnrollDocuments">
