...
<tr class="company-row<%=companyDetailVal%>">
	<td class="sub_heading_content comFullName<%=companyDetailVal%>"></td>
	<td class="sub_heading_content comAddress<%=companyDetailVal%>"></td>
	<td class="sub_heading_content comOffice<%=companyDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <td> 
		<span> 
			<a href="javascript:void(0)" id="companyDetailDeleteDataTab" onclick="companyDetailDeleteData('<%=companyDetailVal%>');"> 
...
<input type="hidden" id="medicalFacilitiesComDetailId<%=companyDetailVal%>" name="medicalFacilitiesComDetailId<%=companyDetailVal%>" value="">