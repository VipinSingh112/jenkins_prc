<%
String nursingStaffDetailVal="";
nursingStaffDetailVal = (String)request.getAttribute("nursingStaffDetailVal");
%>
<tr class="nursing-row<%=nursingStaffDetailVal%>">
	<td class="sub_heading_content nursingStaffName<%=nursingStaffDetailVal%>"></td>
	<td class="sub_heading_content nursingStaffQualifications<%=nursingStaffDetailVal%>"></td>
	<td> 
		<span> 
     ...
     <td>
		<span> <a href="javascript:void(0)"
			...
			onclick="nursingStaffDetailDeleteData('<%=nursingStaffDetailVal%>');">
...
<input type="hidden" id="medicalFacilitiesNurseDetailId<%=nursingStaffDetailVal%>" name="medicalFacilitiesNurseDetailId<%=nursingStaffDetailVal%>" value="">