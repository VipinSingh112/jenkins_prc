...
/**
 * Provides the local service utility for DirectorDetailsAdd. This utility wraps
 * <code>com.nbp.quary.application.form.service.service.impl.DirectorDetailsAddLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DirectorDetailsAddLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.quary.application.form.service.service.impl.DirectorDetailsAddLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DirectorDetailsAdd addDirectorDetailsAdd(
		DirectorDetailsAdd directorDetailsAdd) {

		return getService().addDirectorDetailsAdd(directorDetailsAdd);
	}
	 ...
	 */
	public static DirectorDetailsAdd createDirectorDetailsAdd(
		long directorDetailsAddId) {

		return getService().createDirectorDetailsAdd(directorDetailsAddId);
	}
	 ...
	 */
	public static DirectorDetailsAdd deleteDirectorDetailsAdd(
		DirectorDetailsAdd directorDetailsAdd) {

		return getService().deleteDirectorDetailsAdd(directorDetailsAdd);
	}
	...
	public static DirectorDetailsAdd deleteDirectorDetailsAdd(
		...
		return getService().deleteDirectorDetailsAdd(directorDetailsAddId);
	}
	...
	public static DirectorDetailsAdd fetchDirectorDetailsAdd(
		long directorDetailsAddId) {

		return getService().fetchDirectorDetailsAdd(directorDetailsAddId);
	}
	 ...
	 * @throws PortalException if a director details add with the primary key could not be found
	 */
	public static DirectorDetailsAdd getDirectorDetailsAdd(
			long directorDetailsAddId)
		throws PortalException {

		return getService().getDirectorDetailsAdd(directorDetailsAddId);
	}
	 ...
	 */
	public static List<DirectorDetailsAdd> getDirectorDetailsAdds(
		int start, int end) {

		return getService().getDirectorDetailsAdds(start, end);
	}
	 ...
	 */
	public static int getDirectorDetailsAddsCount() {
		return getService().getDirectorDetailsAddsCount();
	}
	...
	public static List<DirectorDetailsAdd> getQuarry_ById(
		long quarryApplicationId) {

		return getService().getQuarry_ById(quarryApplicationId);
	}
	 ...
	 */
	public static DirectorDetailsAdd updateDirectorDetailsAdd(
		DirectorDetailsAdd directorDetailsAdd) {

		return getService().updateDirectorDetailsAdd(directorDetailsAdd);
	}

	public static DirectorDetailsAddLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<DirectorDetailsAddLocalService>
		_serviceSnapshot = new Snapshot<>(
			DirectorDetailsAddLocalServiceUtil.class,
			DirectorDetailsAddLocalService.class);
