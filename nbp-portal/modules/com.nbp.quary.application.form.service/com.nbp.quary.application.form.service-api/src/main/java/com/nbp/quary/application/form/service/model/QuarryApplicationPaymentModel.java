...
/**
 * The base model interface for the QuarryApplicationPayment service. Represents a row in the &quot;nbp_quarry_app_payment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.quary.application.form.service.model.impl.QuarryApplicationPaymentModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.quary.application.form.service.model.impl.QuarryApplicationPaymentImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface QuarryApplicationPaymentModel
	extends BaseModel<QuarryApplicationPayment>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a quarry application payment model instance should use the {@link QuarryApplicationPayment} interface instead.
	 */
