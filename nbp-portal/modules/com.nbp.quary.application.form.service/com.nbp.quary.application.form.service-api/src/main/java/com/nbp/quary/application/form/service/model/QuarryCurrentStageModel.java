...
/**
 * The base model interface for the QuarryCurrentStage service. Represents a row in the &quot;nbp_quarry_stage&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.nbp.quary.application.form.service.model.impl.QuarryCurrentStageModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.nbp.quary.application.form.service.model.impl.QuarryCurrentStageImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface QuarryCurrentStageModel
	extends BaseModel<QuarryCurrentStage>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a quarry current stage model instance should use the {@link QuarryCurrentStage} interface instead.
	 */
