...
/**
 * Provides the local service interface for DirectorDetailsAdd. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DirectorDetailsAddLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DirectorDetailsAddLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.nbp.quary.application.form.service.service.impl.DirectorDetailsAddLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the director details add local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DirectorDetailsAddLocalServiceUtil} if injection and service tracking are not available.
	 */
