...
/**
 * The persistence utility for the quarry transfer applicant info service. This utility wraps <code>com.nbp.quary.application.form.service.service.persistence.impl.QuarryTransferApplicantInfoPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see QuarryTransferApplicantInfoPersistence
 * @generated
 */
public class QuarryTransferApplicantInfoUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(quarryTransferApplicantInfo);
	}
	 ...
	 */
	public static Map<Serializable, QuarryTransferApplicantInfo>
	 ...
	 */
	public static List<QuarryTransferApplicantInfo> findWithDynamicQuery(
	 ...
	 */
	public static QuarryTransferApplicantInfo update(
		QuarryTransferApplicantInfo quarryTransferApplicantInfo) {

		return getPersistence().update(quarryTransferApplicantInfo);
	}
	...
	public static QuarryTransferApplicantInfo update(
		...
		return getPersistence().update(
			quarryTransferApplicantInfo, serviceContext);
	}
	 ...
	 */
	public static QuarryTransferApplicantInfo findBygetQuarry_ById(
	 ...
	 */
	public static QuarryTransferApplicantInfo fetchBygetQuarry_ById(
		long quarryApplicationId) {
	 ...
	 */
	public static QuarryTransferApplicantInfo removeBygetQuarry_ById(
			long quarryApplicationId)
		throws com.nbp.quary.application.form.service.exception.
			NoSuchQuarryTransferApplicantInfoException {
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(quarryTransferApplicantInfo);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(quarryTransferApplicantInfos);
	}
	 ...
	 */
	public static QuarryTransferApplicantInfo create(
		long quarryTransferInfoId) {

		return getPersistence().create(quarryTransferInfoId);
	}
	 ...
	 */
	public static QuarryTransferApplicantInfo remove(long quarryTransferInfoId)
		throws com.nbp.quary.application.form.service.exception.
			NoSuchQuarryTransferApplicantInfoException {

		return getPersistence().remove(quarryTransferInfoId);
	}

	public static QuarryTransferApplicantInfo updateImpl(
		QuarryTransferApplicantInfo quarryTransferApplicantInfo) {

		return getPersistence().updateImpl(quarryTransferApplicantInfo);
	}
	 ...
	 * @throws NoSuchQuarryTransferApplicantInfoException if a quarry transfer applicant info with the primary key could not be found
	 */
	public static QuarryTransferApplicantInfo findByPrimaryKey(
			long quarryTransferInfoId)
		throws com.nbp.quary.application.form.service.exception.
			NoSuchQuarryTransferApplicantInfoException {

		return getPersistence().findByPrimaryKey(quarryTransferInfoId);
	}
	 ...
	 */
	public static QuarryTransferApplicantInfo fetchByPrimaryKey(
		long quarryTransferInfoId) {

		return getPersistence().fetchByPrimaryKey(quarryTransferInfoId);
	}
	 ...
	 */
	public static List<QuarryTransferApplicantInfo> findAll() {
	...
	public static QuarryTransferApplicantInfoPersistence getPersistence() {
		return _persistence;
	}

	public static void setPersistence(
		QuarryTransferApplicantInfoPersistence persistence) {

		_persistence = persistence;
	}

	private static volatile QuarryTransferApplicantInfoPersistence _persistence;
