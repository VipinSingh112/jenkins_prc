...
/**
 * Provides the local service utility for QuarryGeneralInformation. This utility wraps
 * <code>com.nbp.quary.application.form.service.service.impl.QuarryGeneralInformationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class QuarryGeneralInformationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.nbp.quary.application.form.service.service.impl.QuarryGeneralInformationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static QuarryGeneralInformation addQuarryGeneralInformation(
		QuarryGeneralInformation quarryGeneralInformation) {

		return getService().addQuarryGeneralInformation(
	 ...
	 */
	public static QuarryGeneralInformation createQuarryGeneralInformation(
		long generalInfoId) {

		return getService().createQuarryGeneralInformation(generalInfoId);
	}
	 ...
	 */
	public static QuarryGeneralInformation deleteQuarryGeneralInformation(
			long generalInfoId)
		throws PortalException {

		return getService().deleteQuarryGeneralInformation(generalInfoId);
	}
	...
	public static QuarryGeneralInformation deleteQuarryGeneralInformation(
		...
		return getService().deleteQuarryGeneralInformation(
			quarryGeneralInformation);
	}
	...
	public static QuarryGeneralInformation fetchQuarryGeneralInformation(
		long generalInfoId) {

		return getService().fetchQuarryGeneralInformation(generalInfoId);
	}
	 ...
	 * @throws PortalException if a quarry general information with the primary key could not be found
	 */
	public static QuarryGeneralInformation getQuarryGeneralInformation(
			long generalInfoId)
		throws PortalException {

		return getService().getQuarryGeneralInformation(generalInfoId);
	}

	public static QuarryGeneralInformation getQuarryGeneralInformationBy_Id(
			long quarryAppId)
		throws com.nbp.quary.application.form.service.exception.
			NoSuchQuarryGeneralInformationException {

		return getService().getQuarryGeneralInformationBy_Id(quarryAppId);
	}
	 ...
	 */
	public static List<QuarryGeneralInformation> getQuarryGeneralInformations(
		int start, int end) {

		return getService().getQuarryGeneralInformations(start, end);
	}
	 ...
	 */
	public static int getQuarryGeneralInformationsCount() {
		return getService().getQuarryGeneralInformationsCount();
	}
	 ...
	 */
	public static QuarryGeneralInformation updateQuarryGeneralInformation(
		QuarryGeneralInformation quarryGeneralInformation) {

		return getService().updateQuarryGeneralInformation(
			quarryGeneralInformation);
	}

	public static QuarryGeneralInformationLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<QuarryGeneralInformationLocalService>
		_serviceSnapshot = new Snapshot<>(
			QuarryGeneralInformationLocalServiceUtil.class,
