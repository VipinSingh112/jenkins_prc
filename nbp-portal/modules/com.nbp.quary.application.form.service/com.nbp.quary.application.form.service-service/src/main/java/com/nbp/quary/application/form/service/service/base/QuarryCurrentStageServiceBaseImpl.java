...
import com.nbp.quary.application.form.service.service.QuarryCurrentStageService;
...
/**
 * Provides the base implementation for the quarry current stage remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.quary.application.form.service.service.impl.QuarryCurrentStageServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.quary.application.form.service.service.impl.QuarryCurrentStageServiceImpl
 * @generated
 */
public abstract class QuarryCurrentStageServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuarryCurrentStageService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuarryCurrentStageService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.quary.application.form.service.service.QuarryCurrentStageServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuarryCurrentStageService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quarryCurrentStageService = (QuarryCurrentStageService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuarryCurrentStageService.class.getName();
	}
	...
	protected QuarryCurrentStageService quarryCurrentStageService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuarryCurrentStageServiceBaseImpl.class);
