...
import com.nbp.quary.application.form.service.service.QuarryApplicationService;
...
/**
 * Provides the base implementation for the quarry application remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.quary.application.form.service.service.impl.QuarryApplicationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.quary.application.form.service.service.impl.QuarryApplicationServiceImpl
 * @generated
 */
public abstract class QuarryApplicationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QuarryApplicationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuarryApplicationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.quary.application.form.service.service.QuarryApplicationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuarryApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		quarryApplicationService = (QuarryApplicationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuarryApplicationService.class.getName();
	}
	...
	protected QuarryApplicationService quarryApplicationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuarryApplicationServiceBaseImpl.class);
