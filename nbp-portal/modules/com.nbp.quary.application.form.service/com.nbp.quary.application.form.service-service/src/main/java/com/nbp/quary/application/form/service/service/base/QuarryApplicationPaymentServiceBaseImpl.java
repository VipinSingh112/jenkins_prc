...
import com.nbp.quary.application.form.service.service.QuarryApplicationPaymentService;
...
/**
 * Provides the base implementation for the quarry application payment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.quary.application.form.service.service.impl.QuarryApplicationPaymentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.quary.application.form.service.service.impl.QuarryApplicationPaymentServiceImpl
 * @generated
 */
public abstract class QuarryApplicationPaymentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuarryApplicationPaymentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuarryApplicationPaymentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.quary.application.form.service.service.QuarryApplicationPaymentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuarryApplicationPaymentService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		quarryApplicationPaymentService =
			(QuarryApplicationPaymentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuarryApplicationPaymentService.class.getName();
	}
	...
	protected QuarryApplicationPaymentService quarryApplicationPaymentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuarryApplicationPaymentServiceBaseImpl.class);
