...
import com.nbp.quary.application.form.service.service.QuarryGeneralInformationService;
...
/**
 * Provides the base implementation for the quarry general information remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nbp.quary.application.form.service.service.impl.QuarryGeneralInformationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.nbp.quary.application.form.service.service.impl.QuarryGeneralInformationServiceImpl
 * @generated
 */
public abstract class QuarryGeneralInformationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   QuarryGeneralInformationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuarryGeneralInformationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.nbp.quary.application.form.service.service.QuarryGeneralInformationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuarryGeneralInformationService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		quarryGeneralInformationService =
			(QuarryGeneralInformationService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuarryGeneralInformationService.class.getName();
	}
	...
	protected QuarryGeneralInformationService quarryGeneralInformationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QuarryGeneralInformationServiceBaseImpl.class);
